...
test('Constructor throws', function (t) ***REMOVED***
  [index, safer, dangerous].forEach(function (impl) ***REMOVED***
    t.throws(function () ***REMOVED*** impl.Buffer() })
    t.throws(function () ***REMOVED*** impl.Buffer(0) })
    t.throws(function () ***REMOVED*** impl.Buffer('a') })
    t.throws(function () ***REMOVED*** impl.Buffer('a', 'utf-8') })
    t.throws(function () ***REMOVED*** return new impl.Buffer() })
    t.throws(function () ***REMOVED*** return new impl.Buffer(0) })
    t.throws(function () ***REMOVED*** return new impl.Buffer('a') })
    t.throws(function () ***REMOVED*** return new impl.Buffer('a', 'utf-8') })
***REMOVED***)
  t.end()
})
...
test('Invalid calls throw', function (t) ***REMOVED***
  [index, safer, dangerous].forEach(function (impl) ***REMOVED***
    t.throws(function () ***REMOVED*** impl.Buffer.from(0) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(10) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(10, 'utf-8') })
    t.throws(function () ***REMOVED*** impl.Buffer.from('string', 'invalid encoding') })
    t.throws(function () ***REMOVED*** impl.Buffer.from(-10) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(1e90) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(Infinity) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(-Infinity) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(NaN) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(null) })
    t.throws(function () ***REMOVED*** impl.Buffer.from(undefined) })
    t.throws(function () ***REMOVED*** impl.Buffer.from() })
    t.throws(function () ***REMOVED*** impl.Buffer.from(***REMOVED***}) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc('') })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc('string') })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc('string', 'utf-8') })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc('b25ldHdvdGhyZWU=', 'base64') })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(-10) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(1e90) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(2 * (1 << 30)) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(Infinity) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(-Infinity) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(null) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(undefined) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc() })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc([]) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc([0, 42, 3]) })
    t.throws(function () ***REMOVED*** impl.Buffer.alloc(***REMOVED***}) })
***REMOVED***);
  ['allocUnsafe', 'allocUnsafeSlow'].forEach(function (method) ***REMOVED***
    t.throws(function () ***REMOVED*** dangerous.Buffer[method]('') })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method]('string') })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method]('string', 'utf-8') })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method](2 * (1 << 30)) })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method](Infinity) })
  ...
  ***REMOVED*** else ***REMOVED***
      t.throws(function () ***REMOVED*** dangerous.Buffer[method](-10) })
      t.throws(function () ***REMOVED*** dangerous.Buffer[method](-1e90) })
      t.throws(function () ***REMOVED*** dangerous.Buffer[method](-Infinity) })
  ***REMOVED***
    t.throws(function () ***REMOVED*** dangerous.Buffer[method](null) })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method](undefined) })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method]() })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method]([]) })
    t.throws(function () ***REMOVED*** dangerous.Buffer[method]([0, 42, 3]) })
