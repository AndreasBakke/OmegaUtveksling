...
export interface CommentBlock extends BaseComment ***REMOVED***
  type: "CommentBlock";
}

export interface CommentLine extends BaseComment ***REMOVED***
  type: "CommentLine";
}

export type Comment = CommentBlock | CommentLine;

export interface SourceLocation ***REMOVED***
  start: ***REMOVED***
    line: number;
    column: number;
***REMOVED***;
...
export interface ArrayExpression extends BaseNode ***REMOVED***
  type: "ArrayExpression";
  elements: Array<null | Expression | SpreadElement>;
}

export interface AssignmentExpression extends BaseNode ***REMOVED***
...
export interface BinaryExpression extends BaseNode ***REMOVED***
...
export interface InterpreterDirective extends BaseNode ***REMOVED***
  type: "InterpreterDirective";
  value: string;
}

export interface Directive extends BaseNode ***REMOVED***
  type: "Directive";
  value: DirectiveLiteral;
}

export interface DirectiveLiteral extends BaseNode ***REMOVED***
  type: "DirectiveLiteral";
  value: string;
}

export interface BlockStatement extends BaseNode ***REMOVED***
  type: "BlockStatement";
  body: Array<Statement>;
  directives: Array<Directive>;
}

export interface BreakStatement extends BaseNode ***REMOVED***
  type: "BreakStatement";
  label: Identifier | null;
}

export interface CallExpression extends BaseNode ***REMOVED***
  type: "CallExpression";
...
export interface CatchClause extends BaseNode ***REMOVED***
  type: "CatchClause";
  param: Identifier | ArrayPattern | ObjectPattern | null;
  body: BlockStatement;
}

export interface ConditionalExpression extends BaseNode ***REMOVED***
...
export interface ContinueStatement extends BaseNode ***REMOVED***
  type: "ContinueStatement";
  label: Identifier | null;
}

export interface DebuggerStatement extends BaseNode ***REMOVED***
  type: "DebuggerStatement";
}

export interface DoWhileStatement extends BaseNode ***REMOVED***
  type: "DoWhileStatement";
  test: Expression;
  body: Statement;
}

export interface EmptyStatement extends BaseNode ***REMOVED***
  type: "EmptyStatement";
}

export interface ExpressionStatement extends BaseNode ***REMOVED***
  type: "ExpressionStatement";
  expression: Expression;
}

export interface File extends BaseNode ***REMOVED***
  type: "File";
  program: Program;
...
export interface ForInStatement extends BaseNode ***REMOVED***
  type: "ForInStatement";
...
export interface ForStatement extends BaseNode ***REMOVED***
  type: "ForStatement";
...
export interface FunctionDeclaration extends BaseNode ***REMOVED***
...
export interface FunctionExpression extends BaseNode ***REMOVED***
...
export interface Identifier extends BaseNode ***REMOVED***
  type: "Identifier";
  name: string;
...
export interface IfStatement extends BaseNode ***REMOVED***
  type: "IfStatement";
  test: Expression;
...
export interface LabeledStatement extends BaseNode ***REMOVED***
  type: "LabeledStatement";
  label: Identifier;
  body: Statement;
}

export interface StringLiteral extends BaseNode ***REMOVED***
  type: "StringLiteral";
  value: string;
}

export interface NumericLiteral extends BaseNode ***REMOVED***
  type: "NumericLiteral";
  value: number;
}

export interface NullLiteral extends BaseNode ***REMOVED***
  type: "NullLiteral";
}

export interface BooleanLiteral extends BaseNode ***REMOVED***
  type: "BooleanLiteral";
  value: boolean;
}

export interface RegExpLiteral extends BaseNode ***REMOVED***
  type: "RegExpLiteral";
  pattern: string;
  flags: string;
}

export interface LogicalExpression extends BaseNode ***REMOVED***
...
export interface MemberExpression extends BaseNode ***REMOVED***
...
export interface NewExpression extends BaseNode ***REMOVED***
  type: "NewExpression";
  callee: Expression | Super | V8IntrinsicIdentifier;
  arguments: Array<Expression | SpreadElement | JSXNamespacedName | ArgumentPlaceholder>;
  optional: true | false | null;
...
export interface Program extends BaseNode ***REMOVED***
  type: "Program";
  body: Array<Statement>;
  directives: Array<Directive>;
...
export interface ObjectExpression extends BaseNode ***REMOVED***
  type: "ObjectExpression";
  properties: Array<ObjectMethod | ObjectProperty | SpreadElement>;
}

export interface ObjectMethod extends BaseNode ***REMOVED***
  type: "ObjectMethod";
  kind: "method" | "get" | "set";
...
export interface ObjectProperty extends BaseNode ***REMOVED***
  type: "ObjectProperty";
...
export interface RestElement extends BaseNode ***REMOVED***
  type: "RestElement";
  argument: LVal;
  decorators: Array<Decorator> | null;
  optional: boolean | null;
...
export interface ReturnStatement extends BaseNode ***REMOVED***
  type: "ReturnStatement";
  argument: Expression | null;
}

export interface SequenceExpression extends BaseNode ***REMOVED***
  type: "SequenceExpression";
  expressions: Array<Expression>;
}

export interface ParenthesizedExpression extends BaseNode ***REMOVED***
  type: "ParenthesizedExpression";
  expression: Expression;
}

export interface SwitchCase extends BaseNode ***REMOVED***
  type: "SwitchCase";
  test: Expression | null;
  consequent: Array<Statement>;
}

export interface SwitchStatement extends BaseNode ***REMOVED***
  type: "SwitchStatement";
  discriminant: Expression;
  cases: Array<SwitchCase>;
}

export interface ThisExpression extends BaseNode ***REMOVED***
  type: "ThisExpression";
}

export interface ThrowStatement extends BaseNode ***REMOVED***
  type: "ThrowStatement";
  argument: Expression;
}

export interface TryStatement extends BaseNode ***REMOVED***
  type: "TryStatement";
...
export interface UnaryExpression extends BaseNode ***REMOVED***
...
export interface UpdateExpression extends BaseNode ***REMOVED***
...
export interface VariableDeclaration extends BaseNode ***REMOVED***
...
export interface VariableDeclarator extends BaseNode ***REMOVED***
...
export interface WhileStatement extends BaseNode ***REMOVED***
  type: "WhileStatement";
  test: Expression;
  body: Statement;
}

export interface WithStatement extends BaseNode ***REMOVED***
  type: "WithStatement";
  object: Expression;
  body: Statement;
}

export interface AssignmentPattern extends BaseNode ***REMOVED***
...
export interface ArrayPattern extends BaseNode ***REMOVED***
  type: "ArrayPattern";
...
export interface ArrowFunctionExpression extends BaseNode ***REMOVED***
...
export interface ClassBody extends BaseNode ***REMOVED***
  type: "ClassBody";
...
export interface ClassExpression extends BaseNode ***REMOVED***
...
export interface ClassDeclaration extends BaseNode ***REMOVED***
...
export interface ExportAllDeclaration extends BaseNode ***REMOVED***
...
export interface ExportDefaultDeclaration extends BaseNode ***REMOVED***
  type: "ExportDefaultDeclaration";
  declaration: TSDeclareFunction | FunctionDeclaration | ClassDeclaration | Expression;
  exportKind: "value" | null;
}

export interface ExportNamedDeclaration extends BaseNode ***REMOVED***
...
export interface ExportSpecifier extends BaseNode ***REMOVED***
...
export interface ForOfStatement extends BaseNode ***REMOVED***
  type: "ForOfStatement";
  left: VariableDeclaration | LVal;
  right: Expression;
  body: Statement;
...
export interface ImportDeclaration extends BaseNode ***REMOVED***
...
export interface ImportDefaultSpecifier extends BaseNode ***REMOVED***
  type: "ImportDefaultSpecifier";
  local: Identifier;
}

export interface ImportNamespaceSpecifier extends BaseNode ***REMOVED***
  type: "ImportNamespaceSpecifier";
  local: Identifier;
}

export interface ImportSpecifier extends BaseNode ***REMOVED***
...
export interface MetaProperty extends BaseNode ***REMOVED***
  type: "MetaProperty";
  meta: Identifier;
  property: Identifier;
}

export interface ClassMethod extends BaseNode ***REMOVED***
  type: "ClassMethod";
...
export interface ObjectPattern extends BaseNode ***REMOVED***
  type: "ObjectPattern";
...
export interface SpreadElement extends BaseNode ***REMOVED***
  type: "SpreadElement";
  argument: Expression;
}

export interface Super extends BaseNode ***REMOVED***
  type: "Super";
}

export interface TaggedTemplateExpression extends BaseNode ***REMOVED***
...
export interface TemplateElement extends BaseNode ***REMOVED***
  type: "TemplateElement";
  value: ***REMOVED*** raw: string, cooked?: string };
  tail: boolean;
}

export interface TemplateLiteral extends BaseNode ***REMOVED***
  type: "TemplateLiteral";
  quasis: Array<TemplateElement>;
  expressions: Array<Expression | TSType>;
}

export interface YieldExpression extends BaseNode ***REMOVED***
  type: "YieldExpression";
  argument: Expression | null;
  delegate: boolean;
}

export interface AwaitExpression extends BaseNode ***REMOVED***
  type: "AwaitExpression";
  argument: Expression;
}

export interface Import extends BaseNode ***REMOVED***
  type: "Import";
}

export interface BigIntLiteral extends BaseNode ***REMOVED***
  type: "BigIntLiteral";
  value: string;
}

export interface ExportNamespaceSpecifier extends BaseNode ***REMOVED***
  type: "ExportNamespaceSpecifier";
  exported: Identifier;
}

export interface OptionalMemberExpression extends BaseNode ***REMOVED***
...
export interface OptionalCallExpression extends BaseNode ***REMOVED***
...
export interface ClassProperty extends BaseNode ***REMOVED***
  type: "ClassProperty";
  key: Identifier | StringLiteral | NumericLiteral | BigIntLiteral | Expression;
...
export interface ClassAccessorProperty extends BaseNode ***REMOVED***
...
export interface ClassPrivateProperty extends BaseNode ***REMOVED***
...
export interface ClassPrivateMethod extends BaseNode ***REMOVED***
...
export interface PrivateName extends BaseNode ***REMOVED***
  type: "PrivateName";
  id: Identifier;
}

export interface StaticBlock extends BaseNode ***REMOVED***
  type: "StaticBlock";
  body: Array<Statement>;
}

export interface AnyTypeAnnotation extends BaseNode ***REMOVED***
  type: "AnyTypeAnnotation";
}

export interface ArrayTypeAnnotation extends BaseNode ***REMOVED***
  type: "ArrayTypeAnnotation";
  elementType: FlowType;
}

export interface BooleanTypeAnnotation extends BaseNode ***REMOVED***
  type: "BooleanTypeAnnotation";
}

export interface BooleanLiteralTypeAnnotation extends BaseNode ***REMOVED***
  type: "BooleanLiteralTypeAnnotation";
  value: boolean;
}

export interface NullLiteralTypeAnnotation extends BaseNode ***REMOVED***
  type: "NullLiteralTypeAnnotation";
}

export interface ClassImplements extends BaseNode ***REMOVED***
  type: "ClassImplements";
  id: Identifier;
  typeParameters: TypeParameterInstantiation | null;
}

export interface DeclareClass extends BaseNode ***REMOVED***
  type: "DeclareClass";
  id: Identifier;
...
export interface DeclareFunction extends BaseNode ***REMOVED***
  type: "DeclareFunction";
  id: Identifier;
  predicate: DeclaredPredicate | null;
}

export interface DeclareInterface extends BaseNode ***REMOVED***
...
export interface DeclareModule extends BaseNode ***REMOVED***
  type: "DeclareModule";
...
export interface DeclareModuleExports extends BaseNode ***REMOVED***
  type: "DeclareModuleExports";
  typeAnnotation: TypeAnnotation;
}

export interface DeclareTypeAlias extends BaseNode ***REMOVED***
...
export interface DeclareOpaqueType extends BaseNode ***REMOVED***
...
export interface DeclareVariable extends BaseNode ***REMOVED***
  type: "DeclareVariable";
  id: Identifier;
}

export interface DeclareExportDeclaration extends BaseNode ***REMOVED***
...
export interface DeclareExportAllDeclaration extends BaseNode ***REMOVED***
  type: "DeclareExportAllDeclaration";
  source: StringLiteral;
  exportKind: "type" | "value" | null;
}

export interface DeclaredPredicate extends BaseNode ***REMOVED***
  type: "DeclaredPredicate";
  value: Flow;
}

export interface ExistsTypeAnnotation extends BaseNode ***REMOVED***
  type: "ExistsTypeAnnotation";
}

export interface FunctionTypeAnnotation extends BaseNode ***REMOVED***
...
export interface FunctionTypeParam extends BaseNode ***REMOVED***
...
export interface GenericTypeAnnotation extends BaseNode ***REMOVED***
  type: "GenericTypeAnnotation";
  id: Identifier | QualifiedTypeIdentifier;
  typeParameters: TypeParameterInstantiation | null;
}

export interface InferredPredicate extends BaseNode ***REMOVED***
  type: "InferredPredicate";
}

export interface InterfaceExtends extends BaseNode ***REMOVED***
  type: "InterfaceExtends";
  id: Identifier | QualifiedTypeIdentifier;
  typeParameters: TypeParameterInstantiation | null;
}

export interface InterfaceDeclaration extends BaseNode ***REMOVED***
...
export interface InterfaceTypeAnnotation extends BaseNode ***REMOVED***
  type: "InterfaceTypeAnnotation";
  extends: Array<InterfaceExtends> | null;
  body: ObjectTypeAnnotation;
}

export interface IntersectionTypeAnnotation extends BaseNode ***REMOVED***
  type: "IntersectionTypeAnnotation";
  types: Array<FlowType>;
}

export interface MixedTypeAnnotation extends BaseNode ***REMOVED***
  type: "MixedTypeAnnotation";
}

export interface EmptyTypeAnnotation extends BaseNode ***REMOVED***
  type: "EmptyTypeAnnotation";
}

export interface NullableTypeAnnotation extends BaseNode ***REMOVED***
  type: "NullableTypeAnnotation";
  typeAnnotation: FlowType;
}

export interface NumberLiteralTypeAnnotation extends BaseNode ***REMOVED***
  type: "NumberLiteralTypeAnnotation";
  value: number;
}

export interface NumberTypeAnnotation extends BaseNode ***REMOVED***
  type: "NumberTypeAnnotation";
}

export interface ObjectTypeAnnotation extends BaseNode ***REMOVED***
...
export interface ObjectTypeInternalSlot extends BaseNode ***REMOVED***
...
export interface ObjectTypeCallProperty extends BaseNode ***REMOVED***
  type: "ObjectTypeCallProperty";
  value: FlowType;
  static: boolean;
}

export interface ObjectTypeIndexer extends BaseNode ***REMOVED***
...
export interface ObjectTypeProperty extends BaseNode ***REMOVED***
...
export interface ObjectTypeSpreadProperty extends BaseNode ***REMOVED***
  type: "ObjectTypeSpreadProperty";
  argument: FlowType;
}

export interface OpaqueType extends BaseNode ***REMOVED***
  type: "OpaqueType";
  id: Identifier;
  typeParameters: TypeParameterDeclaration | null;
  supertype: FlowType | null;
...
export interface QualifiedTypeIdentifier extends BaseNode ***REMOVED***
  type: "QualifiedTypeIdentifier";
  id: Identifier;
  qualification: Identifier | QualifiedTypeIdentifier;
}

export interface StringLiteralTypeAnnotation extends BaseNode ***REMOVED***
  type: "StringLiteralTypeAnnotation";
  value: string;
}

export interface StringTypeAnnotation extends BaseNode ***REMOVED***
  type: "StringTypeAnnotation";
}

export interface SymbolTypeAnnotation extends BaseNode ***REMOVED***
  type: "SymbolTypeAnnotation";
}

export interface ThisTypeAnnotation extends BaseNode ***REMOVED***
  type: "ThisTypeAnnotation";
}

export interface TupleTypeAnnotation extends BaseNode ***REMOVED***
  type: "TupleTypeAnnotation";
  types: Array<FlowType>;
}

export interface TypeofTypeAnnotation extends BaseNode ***REMOVED***
  type: "TypeofTypeAnnotation";
  argument: FlowType;
}

export interface TypeAlias extends BaseNode ***REMOVED***
  type: "TypeAlias";
  id: Identifier;
  typeParameters: TypeParameterDeclaration | null;
  right: FlowType;
...
export interface TypeAnnotation extends BaseNode ***REMOVED***
  type: "TypeAnnotation";
  typeAnnotation: FlowType;
}

export interface TypeCastExpression extends BaseNode ***REMOVED***
  type: "TypeCastExpression";
  expression: Expression;
  typeAnnotation: TypeAnnotation;
}

export interface TypeParameter extends BaseNode ***REMOVED***
  type: "TypeParameter";
...
export interface TypeParameterDeclaration extends BaseNode ***REMOVED***
  type: "TypeParameterDeclaration";
  params: Array<TypeParameter>;
}

export interface TypeParameterInstantiation extends BaseNode ***REMOVED***
  type: "TypeParameterInstantiation";
  params: Array<FlowType>;
}

export interface UnionTypeAnnotation extends BaseNode ***REMOVED***
  type: "UnionTypeAnnotation";
  types: Array<FlowType>;
}

export interface Variance extends BaseNode ***REMOVED***
  type: "Variance";
  kind: "minus" | "plus";
}

export interface VoidTypeAnnotation extends BaseNode ***REMOVED***
  type: "VoidTypeAnnotation";
}

export interface EnumDeclaration extends BaseNode ***REMOVED***
  type: "EnumDeclaration";
  id: Identifier;
  body: EnumBooleanBody | EnumNumberBody | EnumStringBody | EnumSymbolBody;
}

export interface EnumBooleanBody extends BaseNode ***REMOVED***
...
export interface EnumNumberBody extends BaseNode ***REMOVED***
  type: "EnumNumberBody";
...
export interface EnumStringBody extends BaseNode ***REMOVED***
  type: "EnumStringBody";
...
export interface EnumSymbolBody extends BaseNode ***REMOVED***
  type: "EnumSymbolBody";
  members: Array<EnumDefaultedMember>;
  hasUnknownMembers: boolean;
}

export interface EnumBooleanMember extends BaseNode ***REMOVED***
  type: "EnumBooleanMember";
  id: Identifier;
  init: BooleanLiteral;
}

export interface EnumNumberMember extends BaseNode ***REMOVED***
  type: "EnumNumberMember";
  id: Identifier;
  init: NumericLiteral;
}

export interface EnumStringMember extends BaseNode ***REMOVED***
  type: "EnumStringMember";
  id: Identifier;
  init: StringLiteral;
}

export interface EnumDefaultedMember extends BaseNode ***REMOVED***
  type: "EnumDefaultedMember";
  id: Identifier;
}

export interface IndexedAccessType extends BaseNode ***REMOVED***
  type: "IndexedAccessType";
  objectType: FlowType;
  indexType: FlowType;
}

export interface OptionalIndexedAccessType extends BaseNode ***REMOVED***
...
export interface JSXAttribute extends BaseNode ***REMOVED***
  type: "JSXAttribute";
  name: JSXIdentifier | JSXNamespacedName;
  value: JSXElement | JSXFragment | StringLiteral | JSXExpressionContainer | null;
}

export interface JSXClosingElement extends BaseNode ***REMOVED***
  type: "JSXClosingElement";
  name: JSXIdentifier | JSXMemberExpression | JSXNamespacedName;
}

export interface JSXElement extends BaseNode ***REMOVED***
  type: "JSXElement";
...
export interface JSXEmptyExpression extends BaseNode ***REMOVED***
  type: "JSXEmptyExpression";
}

export interface JSXExpressionContainer extends BaseNode ***REMOVED***
  type: "JSXExpressionContainer";
  expression: Expression | JSXEmptyExpression;
}

export interface JSXSpreadChild extends BaseNode ***REMOVED***
  type: "JSXSpreadChild";
  expression: Expression;
}

export interface JSXIdentifier extends BaseNode ***REMOVED***
  type: "JSXIdentifier";
  name: string;
}

export interface JSXMemberExpression extends BaseNode ***REMOVED***
  type: "JSXMemberExpression";
  object: JSXMemberExpression | JSXIdentifier;
  property: JSXIdentifier;
}

export interface JSXNamespacedName extends BaseNode ***REMOVED***
  type: "JSXNamespacedName";
  namespace: JSXIdentifier;
  name: JSXIdentifier;
}

export interface JSXOpeningElement extends BaseNode ***REMOVED***
...
export interface JSXSpreadAttribute extends BaseNode ***REMOVED***
  type: "JSXSpreadAttribute";
  argument: Expression;
}

export interface JSXText extends BaseNode ***REMOVED***
  type: "JSXText";
  value: string;
}

export interface JSXFragment extends BaseNode ***REMOVED***
  type: "JSXFragment";
...
export interface JSXOpeningFragment extends BaseNode ***REMOVED***
  type: "JSXOpeningFragment";
}

export interface JSXClosingFragment extends BaseNode ***REMOVED***
  type: "JSXClosingFragment";
}

export interface Noop extends BaseNode ***REMOVED***
  type: "Noop";
}

export interface Placeholder extends BaseNode ***REMOVED***
  type: "Placeholder";
  expectedNode: "Identifier" | "StringLiteral" | "Expression" | "Statement" | "Declaration" | "BlockStatement" | "ClassBody" | "Pattern";
  name: Identifier;
}

export interface V8IntrinsicIdentifier extends BaseNode ***REMOVED***
  type: "V8IntrinsicIdentifier";
  name: string;
}

export interface ArgumentPlaceholder extends BaseNode ***REMOVED***
  type: "ArgumentPlaceholder";
}

export interface BindExpression extends BaseNode ***REMOVED***
  type: "BindExpression";
  object: Expression;
  callee: Expression;
}

export interface ImportAttribute extends BaseNode ***REMOVED***
  type: "ImportAttribute";
  key: Identifier | StringLiteral;
  value: StringLiteral;
}

export interface Decorator extends BaseNode ***REMOVED***
  type: "Decorator";
  expression: Expression;
}

export interface DoExpression extends BaseNode ***REMOVED***
  type: "DoExpression";
  body: BlockStatement;
  async: boolean;
}

export interface ExportDefaultSpecifier extends BaseNode ***REMOVED***
  type: "ExportDefaultSpecifier";
  exported: Identifier;
}

export interface RecordExpression extends BaseNode ***REMOVED***
  type: "RecordExpression";
  properties: Array<ObjectProperty | SpreadElement>;
}

export interface TupleExpression extends BaseNode ***REMOVED***
  type: "TupleExpression";
  elements: Array<Expression | SpreadElement>;
}

export interface DecimalLiteral extends BaseNode ***REMOVED***
  type: "DecimalLiteral";
  value: string;
}

export interface ModuleExpression extends BaseNode ***REMOVED***
  type: "ModuleExpression";
  body: Program;
}

export interface TopicReference extends BaseNode ***REMOVED***
  type: "TopicReference";
}

export interface PipelineTopicExpression extends BaseNode ***REMOVED***
  type: "PipelineTopicExpression";
  expression: Expression;
}

export interface PipelineBareFunction extends BaseNode ***REMOVED***
  type: "PipelineBareFunction";
  callee: Expression;
}

export interface PipelinePrimaryTopicReference extends BaseNode ***REMOVED***
  type: "PipelinePrimaryTopicReference";
}

export interface TSParameterProperty extends BaseNode ***REMOVED***
...
export interface TSDeclareFunction extends BaseNode ***REMOVED***
...
export interface TSDeclareMethod extends BaseNode ***REMOVED***
...
export interface TSQualifiedName extends BaseNode ***REMOVED***
  type: "TSQualifiedName";
  left: TSEntityName;
  right: Identifier;
}

export interface TSCallSignatureDeclaration extends BaseNode ***REMOVED***
...
export interface TSConstructSignatureDeclaration extends BaseNode ***REMOVED***
...
export interface TSPropertySignature extends BaseNode ***REMOVED***
...
export interface TSMethodSignature extends BaseNode ***REMOVED***
...
export interface TSIndexSignature extends BaseNode ***REMOVED***
...
export interface TSAnyKeyword extends BaseNode ***REMOVED***
  type: "TSAnyKeyword";
}

export interface TSBooleanKeyword extends BaseNode ***REMOVED***
  type: "TSBooleanKeyword";
}

export interface TSBigIntKeyword extends BaseNode ***REMOVED***
  type: "TSBigIntKeyword";
}

export interface TSIntrinsicKeyword extends BaseNode ***REMOVED***
  type: "TSIntrinsicKeyword";
}

export interface TSNeverKeyword extends BaseNode ***REMOVED***
  type: "TSNeverKeyword";
}

export interface TSNullKeyword extends BaseNode ***REMOVED***
  type: "TSNullKeyword";
}

export interface TSNumberKeyword extends BaseNode ***REMOVED***
  type: "TSNumberKeyword";
}

export interface TSObjectKeyword extends BaseNode ***REMOVED***
  type: "TSObjectKeyword";
}

export interface TSStringKeyword extends BaseNode ***REMOVED***
  type: "TSStringKeyword";
}

export interface TSSymbolKeyword extends BaseNode ***REMOVED***
  type: "TSSymbolKeyword";
}

export interface TSUndefinedKeyword extends BaseNode ***REMOVED***
  type: "TSUndefinedKeyword";
}

export interface TSUnknownKeyword extends BaseNode ***REMOVED***
  type: "TSUnknownKeyword";
}

export interface TSVoidKeyword extends BaseNode ***REMOVED***
  type: "TSVoidKeyword";
}

export interface TSThisType extends BaseNode ***REMOVED***
  type: "TSThisType";
}

export interface TSFunctionType extends BaseNode ***REMOVED***
  type: "TSFunctionType";
  typeParameters: TSTypeParameterDeclaration | null;
  parameters: Array<Identifier | RestElement>;
  typeAnnotation: TSTypeAnnotation | null;
...
export interface TSConstructorType extends BaseNode ***REMOVED***
...
export interface TSTypeReference extends BaseNode ***REMOVED***
  type: "TSTypeReference";
  typeName: TSEntityName;
  typeParameters: TSTypeParameterInstantiation | null;
}

export interface TSTypePredicate extends BaseNode ***REMOVED***
...
export interface TSTypeQuery extends BaseNode ***REMOVED***
  type: "TSTypeQuery";
  exprName: TSEntityName | TSImportType;
  typeParameters: TSTypeParameterInstantiation | null;
}

export interface TSTypeLiteral extends BaseNode ***REMOVED***
  type: "TSTypeLiteral";
  members: Array<TSTypeElement>;
}

export interface TSArrayType extends BaseNode ***REMOVED***
  type: "TSArrayType";
  elementType: TSType;
}

export interface TSTupleType extends BaseNode ***REMOVED***
  type: "TSTupleType";
  elementTypes: Array<TSType | TSNamedTupleMember>;
}

export interface TSOptionalType extends BaseNode ***REMOVED***
  type: "TSOptionalType";
  typeAnnotation: TSType;
}

export interface TSRestType extends BaseNode ***REMOVED***
  type: "TSRestType";
  typeAnnotation: TSType;
}

export interface TSNamedTupleMember extends BaseNode ***REMOVED***
...
export interface TSUnionType extends BaseNode ***REMOVED***
  type: "TSUnionType";
  types: Array<TSType>;
}

export interface TSIntersectionType extends BaseNode ***REMOVED***
  type: "TSIntersectionType";
  types: Array<TSType>;
}

export interface TSConditionalType extends BaseNode ***REMOVED***
...
export interface TSInferType extends BaseNode ***REMOVED***
  type: "TSInferType";
  typeParameter: TSTypeParameter;
}

export interface TSParenthesizedType extends BaseNode ***REMOVED***
  type: "TSParenthesizedType";
  typeAnnotation: TSType;
}

export interface TSTypeOperator extends BaseNode ***REMOVED***
  type: "TSTypeOperator";
  typeAnnotation: TSType;
  operator: string;
}

export interface TSIndexedAccessType extends BaseNode ***REMOVED***
  type: "TSIndexedAccessType";
  objectType: TSType;
  indexType: TSType;
}

export interface TSMappedType extends BaseNode ***REMOVED***
  type: "TSMappedType";
  typeParameter: TSTypeParameter;
...
export interface TSLiteralType extends BaseNode ***REMOVED***
  type: "TSLiteralType";
  literal: NumericLiteral | StringLiteral | BooleanLiteral | BigIntLiteral | TemplateLiteral | UnaryExpression;
}

export interface TSExpressionWithTypeArguments extends BaseNode ***REMOVED***
  type: "TSExpressionWithTypeArguments";
  expression: TSEntityName;
  typeParameters: TSTypeParameterInstantiation | null;
}

export interface TSInterfaceDeclaration extends BaseNode ***REMOVED***
...
export interface TSInterfaceBody extends BaseNode ***REMOVED***
  type: "TSInterfaceBody";
  body: Array<TSTypeElement>;
}

export interface TSTypeAliasDeclaration extends BaseNode ***REMOVED***
...
export interface TSInstantiationExpression extends BaseNode ***REMOVED***
  type: "TSInstantiationExpression";
  expression: Expression;
  typeParameters: TSTypeParameterInstantiation | null;
}

export interface TSAsExpression extends BaseNode ***REMOVED***
  type: "TSAsExpression";
  expression: Expression;
  typeAnnotation: TSType;
}

export interface TSSatisfiesExpression extends BaseNode ***REMOVED***
  type: "TSSatisfiesExpression";
  expression: Expression;
  typeAnnotation: TSType;
}

export interface TSTypeAssertion extends BaseNode ***REMOVED***
  type: "TSTypeAssertion";
  typeAnnotation: TSType;
  expression: Expression;
}

export interface TSEnumDeclaration extends BaseNode ***REMOVED***
...
export interface TSEnumMember extends BaseNode ***REMOVED***
  type: "TSEnumMember";
  id: Identifier | StringLiteral;
  initializer: Expression | null;
}

export interface TSModuleDeclaration extends BaseNode ***REMOVED***
...
export interface TSModuleBlock extends BaseNode ***REMOVED***
  type: "TSModuleBlock";
  body: Array<Statement>;
}

export interface TSImportType extends BaseNode ***REMOVED***
  type: "TSImportType";
...
export interface TSImportEqualsDeclaration extends BaseNode ***REMOVED***
...
export interface TSExternalModuleReference extends BaseNode ***REMOVED***
  type: "TSExternalModuleReference";
  expression: StringLiteral;
}

export interface TSNonNullExpression extends BaseNode ***REMOVED***
  type: "TSNonNullExpression";
  expression: Expression;
}

export interface TSExportAssignment extends BaseNode ***REMOVED***
  type: "TSExportAssignment";
  expression: Expression;
}

export interface TSNamespaceExportDeclaration extends BaseNode ***REMOVED***
  type: "TSNamespaceExportDeclaration";
  id: Identifier;
}

export interface TSTypeAnnotation extends BaseNode ***REMOVED***
  type: "TSTypeAnnotation";
  typeAnnotation: TSType;
}

export interface TSTypeParameterInstantiation extends BaseNode ***REMOVED***
  type: "TSTypeParameterInstantiation";
  params: Array<TSType>;
}

export interface TSTypeParameterDeclaration extends BaseNode ***REMOVED***
  type: "TSTypeParameterDeclaration";
  params: Array<TSTypeParameter>;
}

export interface TSTypeParameter extends BaseNode ***REMOVED***
...
export interface Aliases ***REMOVED***
...
export ***REMOVED*** _super as super}
export function taggedTemplateExpression(tag: Expression, quasi: TemplateLiteral): TaggedTemplateExpression;
export function templateElement(value: ***REMOVED*** raw: string, cooked?: string }, tail?: boolean): TemplateElement;
...
export ***REMOVED*** _import as import}
...
export function buildChildren(node: ***REMOVED*** children: ReadonlyArray<JSXText | JSXExpressionContainer | JSXSpreadChild | JSXElement | JSXFragment | JSXEmptyExpression> }): JSXElement['children']
...
export function ensureBlock(node: Extract<Node, ***REMOVED*** body: BlockStatement | Statement | Expression }>): BlockStatement
export function ensureBlock<K extends keyof Extract<Node, ***REMOVED*** body: BlockStatement | Statement | Expression }> = 'body'>(node: Extract<Node, Record<K, BlockStatement | Statement | Expression>>, key: K): BlockStatement
export function toBindingIdentifierName(name: ***REMOVED*** toString(): string } | null | undefined): string
export function toBlock(node: Statement | Expression, parent?: Function | null): BlockStatement
export function toComputedKey<T extends Extract<Node, ***REMOVED*** computed: boolean | null }>>(node: T, key?: Expression | Identifier): Expression
...
export function toIdentifier(name: ***REMOVED*** toString(): string } | null | undefined): string
export function toKeyAlias(node: Method | Property, key?: Node): string
export function toSequenceExpression(nodes: ReadonlyArray<Node>, scope: ***REMOVED*** push(value: ***REMOVED*** id: LVal; kind: 'var'; init?: Expression}): void; buildUndefinedNode(): Node }): SequenceExpression | undefined
...
export function removeProperties(
  n: Node,
  opts?: ***REMOVED*** preserveComments: boolean } | null
): void;
...
export type TraversalAncestors = ReadonlyArray<***REMOVED***
  node: Node,
  key: string,
  index?: number,
}>;
...
export type TraversalHandlers<T> = ***REMOVED***
...
export function is<T extends Node['type']>(type: T, n: Node | null | undefined, required?: undefined): n is Extract<Node, ***REMOVED*** type: T }>
export function is<T extends Node['type'], P extends Extract<Node, ***REMOVED*** type: T }>>(type: T, n: Node | null | undefined, required: Partial<P>): n is P
