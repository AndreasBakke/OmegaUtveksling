...
export declare class DatabaseError extends Error implements NoticeOrError ***REMOVED***
...
export declare class CopyDataMessage ***REMOVED***
    readonly length: number;
    readonly chunk: Buffer;
    readonly name = "copyData";
    constructor(length: number, chunk: Buffer);
}
export declare class CopyResponse ***REMOVED***
    readonly length: number;
    readonly name: MessageName;
...
export declare class Field ***REMOVED***
...
export declare class RowDescriptionMessage ***REMOVED***
    readonly length: number;
...
export declare class ParameterDescriptionMessage ***REMOVED***
    readonly length: number;
...
export declare class ParameterStatusMessage ***REMOVED***
    readonly length: number;
...
export declare class AuthenticationMD5Password implements BackendMessage ***REMOVED***
    readonly length: number;
    readonly salt: Buffer;
    readonly name: MessageName;
    constructor(length: number, salt: Buffer);
}
export declare class BackendKeyDataMessage ***REMOVED***
    readonly length: number;
...
export declare class NotificationResponseMessage ***REMOVED***
    readonly length: number;
    readonly processId: number;
...
export declare class ReadyForQueryMessage ***REMOVED***
    readonly length: number;
    readonly status: string;
    readonly name: MessageName;
    constructor(length: number, status: string);
}
export declare class CommandCompleteMessage ***REMOVED***
    readonly length: number;
    readonly text: string;
    readonly name: MessageName;
    constructor(length: number, text: string);
}
export declare class DataRowMessage ***REMOVED***
    length: number;
    fields: any[];
    readonly fieldCount: number;
    readonly name: MessageName;
...
export declare class NoticeMessage implements BackendMessage, NoticeOrError ***REMOVED***
    readonly length: number;
