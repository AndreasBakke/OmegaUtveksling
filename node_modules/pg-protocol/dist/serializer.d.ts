...
declare type ParseOpts = ***REMOVED***
    name?: string;
    types?: number[];
    text: string;
};
declare type ValueMapper = (param: any, index: number) => any;
declare type BindOpts = ***REMOVED***
    portal?: string;
    binary?: boolean;
    statement?: string;
    values?: any[];
...
declare type ExecOpts = ***REMOVED***
    portal?: string;
    rows?: number;
};
declare type PortalOpts = ***REMOVED***
    type: 'S' | 'P';
    name?: string;
};
declare const serialize: ***REMOVED***
