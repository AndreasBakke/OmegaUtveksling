import ***REMOVED*** ResultBase, IParamsBase } from './util';
interface IMemoizedSync<T1, T2, T3, T4, T5, T6, TResult> extends ResultBase ***REMOVED***
    (arg1: T1): TResult;
...
interface IMemoizableFunctionSync<T1, T2, T3, T4, T5, T6, TResult> ***REMOVED***
    (): TResult;
    (arg1: T1): TResult;
    (arg1: T1, arg2: T2): TResult;
    (arg1: T1, arg2: T2, arg3: T3): TResult;
...
export interface SyncParams<T1, T2, T3, T4, T5, T6, TResult> extends IParamsBase<T1, T2, T3, T4, T5, T6, TResult> ***REMOVED***
    /**
