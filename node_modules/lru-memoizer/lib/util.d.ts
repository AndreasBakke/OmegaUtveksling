...
export interface ResultBase ***REMOVED***
    /**
...
export interface IHashingFunction<T1, T2, T3, T4, T5, T6> ***REMOVED***
    (): string;
    (arg1: T1): string;
...
export interface IBypassFunction<T1, T2, T3, T4, T5, T6> ***REMOVED***
    (): boolean;
    (arg1: T1): boolean;
...
export interface IMaxAgeFunction<T1, T2, T3, T4, T5, T6, TResult> ***REMOVED***
    (res: TResult): number;
...
export interface IParamsBase<T1, T2, T3, T4, T5, T6, TResult> extends LRU.Options<string, any> ***REMOVED***
    /**
