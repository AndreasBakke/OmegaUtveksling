...
function warnIfStringRefCannotBeAutoConverted(config, self) ***REMOVED***
  ***REMOVED***
    if (typeof config.ref === 'string' && ReactCurrentOwner.current && self && ReactCurrentOwner.current.stateNode !== self) ***REMOVED***
 ...
 * @param ***REMOVED****} type
 * @param ***REMOVED***object} props
 * @param ***REMOVED***string} key
 */

function jsxDEV(type, config, maybeKey, source, self) ***REMOVED***
  ***REMOVED***
    ...
    // issue if key is also explicitly declared (ie. <div ***REMOVED***...props} key="Hi" />
    // or <div key="Hi" ***REMOVED***...props} /> ). We want to deprecate key spread,
    // but as an intermediary step, we will use jsxDEV for everything except
    // <div ***REMOVED***...props} key="Hi" />, because we aren't currently able to tell if
    // key is explicitly declared to be undefined or not.

    if (maybeKey !== undefined) ***REMOVED***
      ***REMOVED***
...
function getDeclarationErrorAddendum() ***REMOVED***
  ***REMOVED***
    if (ReactCurrentOwner$1.current) ***REMOVED***
...
function validateExplicitKey(element, parentType) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (element && element._owner && element._owner !== ReactCurrentOwner$1.current) ***REMOVED***
...
function jsxWithValidation(type, props, key, isStaticChildren, source, self) ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED*** // Skip key warning if the type isn't valid since our key validation logic
    ...
    if (validType) ***REMOVED***
      ...
      if (children !== undefined) ***REMOVED***
        if (isStaticChildren) ***REMOVED***
...
function jsxWithValidationStatic(type, props, key) ***REMOVED***
  ***REMOVED***
    return jsxWithValidation(type, props, key, true);
***REMOVED***
}
function jsxWithValidationDynamic(type, props, key) ***REMOVED***
  ***REMOVED***
