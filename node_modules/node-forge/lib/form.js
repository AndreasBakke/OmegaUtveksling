 ...
 */
var _parseName = function(name) ***REMOVED***
  var rval = [];

  var matches;
  while(!!(matches = _regex.exec(name))) ***REMOVED***
    if(matches[1].length > 0) ***REMOVED***
      rval.push(matches[1]);
  ***REMOVED***
    if(matches.length >= 2) ***REMOVED***
      rval.push(matches[2]);
  ***REMOVED***
***REMOVED***
 ...
 */
var _addField = function(obj, names, value, dict) ***REMOVED***
...
***REMOVED***
  ...
  var tmp = [];
  $.each(names, function(n, name) ***REMOVED***
...
***REMOVED***);
  ...
  $.each(names, function(n, name) ***REMOVED***
    ...
    if(dict && name.length !== 0 && name in dict) ***REMOVED***
       name = dict[name];
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    if(obj[name]) ***REMOVED***
      ...
      if(n == names.length - 1) ***REMOVED***
        // more than one value, so convert into an array
        if(!$.isArray(obj[name])) ***REMOVED***
          obj[name] = [obj[name]];
      ***REMOVED***
        obj[name].push(value);
    ***REMOVED*** else ***REMOVED***
        ...
        obj = obj[name];
    ***REMOVED***
  ***REMOVED*** else if(n == names.length - 1) ***REMOVED***
 ...
 */
form.serialize = function(input, sep, dict) ***REMOVED***
  var rval = ***REMOVED***};

  // add all fields in the form to the object
  sep = sep || '.';
  $.each(input.serializeArray(), function() ***REMOVED***
