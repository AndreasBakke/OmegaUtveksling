 ...
 */
forge.tls.wrapSocket = function(options) ***REMOVED***
  // get raw socket
  var socket = options.socket;

  // create TLS socket
  var tlsSocket = ***REMOVED***
    id: socket.id,
    // set handlers
...
***REMOVED***;
  ...
  var c = forge.tls.createConnection(***REMOVED***
    server: false,
    ...
    connected: function(c) ***REMOVED***
      // first handshake complete, call handler
      if(c.handshakes === 1) ***REMOVED***
        tlsSocket.connected(***REMOVED***
          id: socket.id,
          type: 'connect',
    ...
    ***REMOVED***
  ***REMOVED***,
    tlsDataReady: function(c) ***REMOVED***
      // send TLS data over socket
      return socket.send(c.tlsData.getBytes());
  ***REMOVED***,
    dataReady: function(c) ***REMOVED***
      // indicate application data is ready
      tlsSocket.data(***REMOVED***
        id: socket.id,
        type: 'socketData',
        bytesAvailable: c.data.length()
    ***REMOVED***);
  ***REMOVED***,
    closed: function(c) ***REMOVED***
      // close socket
      socket.close();
  ***REMOVED***,
    error: function(c, e) ***REMOVED***
      // send error, close socket
      tlsSocket.error(***REMOVED***
        id: socket.id,
        type: 'tlsError',
        message: e.message,
        bytesAvailable: 0,
...
***REMOVED***;
  ...
  socket.closed = function(e) ***REMOVED***
    if(c.open && c.handshaking) ***REMOVED***
      // error
      tlsSocket.error(***REMOVED***
        id: socket.id,
        type: 'ioError',
...
***REMOVED***;
  ...
  ***REMOVED*** else ***REMOVED***
      ...
      // process a record
      if(e.bytesAvailable >= _requiredBytes) ***REMOVED***
...
***REMOVED***;
   ...
   */
  tlsSocket.destroy = function() ***REMOVED***
    socket.destroy();
***REMOVED***;
   ...
   */
  tlsSocket.setSessionCache = function(cache) ***REMOVED***
...
***REMOVED***;
   ...
   */
  tlsSocket.connect = function(options) ***REMOVED***
...
***REMOVED***;
   ...
   * Closes this socket.
   */
  tlsSocket.close = function() ***REMOVED***
    c.close();
***REMOVED***;
   ...
   */
  tlsSocket.isConnected = function() ***REMOVED***
...
***REMOVED***;
   ...
   */
  tlsSocket.send = function(bytes) ***REMOVED***
...
***REMOVED***;
   ...
   */
  tlsSocket.receive = function(count) ***REMOVED***
...
***REMOVED***;
   ...
   */
  tlsSocket.bytesAvailable = function() ***REMOVED***
