 ...
 */
net.createSocketPool = function(options) ***REMOVED***
  // set default
  ...
  api.init(***REMOVED***marshallExceptions: !options.msie});
...
***REMOVED***;
  ...
  if(options.msie === true) ***REMOVED***
    sp.handler = function(e) ***REMOVED***
      if(e.id in sp.sockets) ***REMOVED***
      ...
      ***REMOVED***
        ...
        setTimeout(function() ***REMOVED***sp.sockets[e.id][f](e);}, 0);
    ***REMOVED***
  ***REMOVED***;
...
***REMOVED***
   ...
   * up via net.cleanup().
   */
  sp.destroy = function() ***REMOVED***
    delete net.socketPools[options.flashId];
    for(var id in sp.sockets) ***REMOVED***
...
***REMOVED***;
   ...
   */
   sp.createSocket = function(options) ***REMOVED***
   ...
   ***REMOVED***;
      ...
      */
     socket.destroy = function() ***REMOVED***
       api.destroy(id);
   ...
   ***REMOVED***;
      ...
      */
     socket.connect = function(options) ***REMOVED***
       ...
       var policyPort = 0;
       if(policyUrl === null && options.policyPort !== 0) ***REMOVED***
   ...
   ***REMOVED***;
      ...
      * Closes this socket.
      */
     socket.close = function() ***REMOVED***
       api.close(id);
       socket.closed(***REMOVED***
         id: socket.id,
         type: 'close',
         bytesAvailable: 0
     ***REMOVED***);
   ***REMOVED***;
      ...
      */
     socket.isConnected = function() ***REMOVED***
   ...
   ***REMOVED***;
      ...
      */
     socket.send = function(bytes) ***REMOVED***
   ...
   ***REMOVED***;
      ...
      */
     socket.receive = function(count) ***REMOVED***
   ...
   ***REMOVED***;
      ...
      */
     socket.bytesAvailable = function() ***REMOVED***
 ...
 *          flashId: the dom ID for the flash object element.
 */
net.destroySocketPool = function(options) ***REMOVED***
  if(options.flashId in net.socketPools) ***REMOVED***
 ...
 */
net.createSocket = function(options) ***REMOVED***
  var socket = null;
  if(options.flashId in net.socketPools) ***REMOVED***
