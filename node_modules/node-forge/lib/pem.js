...
***REMOVED***
  if(msg.contentDomain) ***REMOVED***
    header = ***REMOVED***name: 'Content-Domain', values: [msg.contentDomain]};
    rval += foldHeader(header);
***REMOVED***
  if(msg.dekInfo) ***REMOVED***
    header = ***REMOVED***name: 'DEK-Info', values: [msg.dekInfo.algorithm]};
...
pem.decode = function(str) ***REMOVED***
  ...
  ***REMOVED***
    ...
    var type = match[1];
    if(type === 'NEW CERTIFICATE REQUEST') ***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      if(match) ***REMOVED***
        var header = ***REMOVED***name: match[1], values: []};
      ...
      ***REMOVED***
        ...
        ***REMOVED***
          msg.procType = ***REMOVED***version: values[0], type: values[1]};
      ...
      ***REMOVED*** else if(!msg.dekInfo && header.name === 'DEK-Info') ***REMOVED***
        ...
        ***REMOVED***
          msg.dekInfo = ***REMOVED***algorithm: values[0], parameters: values[1] || null};
