...
import ***REMOVED*** Action as HistoryAction } from "./history";
import type ***REMOVED*** AgnosticDataRouteMatch, AgnosticDataRouteObject, FormEncType, FormMethod, RouteData, AgnosticRouteObject, AgnosticRouteMatch } from "./utils";
import ***REMOVED*** DeferredData } from "./utils";
/**
...
export interface StaticHandler ***REMOVED***
    ...
    query(request: Request, opts?: ***REMOVED***
        requestContext?: unknown;
  ***REMOVED***): Promise<StaticHandlerContext | Response>;
    queryRoute(request: Request, opts?: ***REMOVED***
        routeId?: string;
        requestContext?: unknown;
  ***REMOVED***): Promise<any>;
}
 ...
 */
declare type LinkNavigateOptions = ***REMOVED***
    replace?: boolean;
    state?: any;
    preventScrollReset?: boolean;
};
 ...
 */
declare type SubmissionNavigateOptions = ***REMOVED***
    replace?: boolean;
    state?: any;
    preventScrollReset?: boolean;
 ...
 */
export declare type NavigationStates = ***REMOVED***
    Idle: ***REMOVED***
        state: "idle";
        location: undefined;
 ...
 */
declare type FetcherStates<TData = any> = ***REMOVED***
    Idle: ***REMOVED***
        state: "idle";
        formMethod: undefined;
        formAction: undefined;
...
export declare type BlockerFunction = (args: ***REMOVED***
...
export declare function createStaticHandler(routes: AgnosticRouteObject[], opts?: ***REMOVED***
    basename?: string;
}): StaticHandler;
/**
