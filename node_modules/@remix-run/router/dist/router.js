...
***REMOVED*** // Complete a navigation returning the state.navigation back to the IDLE_NAVIGATION
  ...
  ***REMOVED***));
    ...
    if (isUninterruptedRevalidation) ; else if (pendingAction === Action.Pop) ; else if (pendingAction === Action.Push) ***REMOVED***
      init.history.push(location, location.state);
  ***REMOVED*** else if (pendingAction === Action.Replace) ***REMOVED***
