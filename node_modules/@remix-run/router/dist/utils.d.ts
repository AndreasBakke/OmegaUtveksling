import type ***REMOVED*** Location, Path, To } from "./history";
/**
 * Map of routeId -> data returned from a loader/action/error
 */
export interface RouteData ***REMOVED***
    [routeId: string]: any;
}
export declare enum ResultType ***REMOVED***
    data = "data",
    deferred = "deferred",
    redirect = "redirect",
    error = "error"
 ...
 */
export interface SuccessResult ***REMOVED***
 ...
 */
export interface DeferredResult ***REMOVED***
 ...
 */
export interface RedirectResult ***REMOVED***
 ...
 */
export interface ErrorResult ***REMOVED***
 ...
 */
export interface Submission ***REMOVED***
 ...
 */
interface DataFunctionArgs ***REMOVED***
    request: Request;
    params: Params;
    context?: any;
}
 ...
 */
export interface LoaderFunctionArgs extends DataFunctionArgs ***REMOVED***
}
/**
 * Arguments passed to action functions
 */
export interface ActionFunctionArgs extends DataFunctionArgs ***REMOVED***
}
/**
 * Route loader function signature
 */
export interface LoaderFunction ***REMOVED***
    (args: LoaderFunctionArgs): Promise<Response> | Response | Promise<any> | any;
}
/**
 * Route action function signature
 */
export interface ActionFunction ***REMOVED***
 ...
 */
export interface ShouldRevalidateFunction ***REMOVED***
    (args: ***REMOVED***
        currentUrl: URL;
 ...
 */
declare type AgnosticBaseRouteObject = ***REMOVED***
 ...
 */
export declare type AgnosticIndexRouteObject = AgnosticBaseRouteObject & ***REMOVED***
    children?: undefined;
    index: true;
};
/**
 ...
 */
export declare type AgnosticNonIndexRouteObject = AgnosticBaseRouteObject & ***REMOVED***
...
export declare type AgnosticDataIndexRouteObject = AgnosticIndexRouteObject & ***REMOVED***
    id: string;
};
export declare type AgnosticDataNonIndexRouteObject = AgnosticNonIndexRouteObject & ***REMOVED***
...
declare type _PathParam<Path extends string> = Path extends `$***REMOVED***infer L}/$***REMOVED***infer R}` ? _PathParam<L> | _PathParam<R> : Path extends `:$***REMOVED***infer Param}` ? Param extends `$***REMOVED***infer Optional}?` ? Optional : Param : never;
/**
 * Examples:
 * "/a/b/*" -> "*"
 * ":a" -> "a"
 ...
 * "/:a/b/:c/*" -> "a" | "c" | "*"
 */
declare type PathParam<Path extends string> = Path extends "*" ? "*" : Path extends `$***REMOVED***infer Rest}/*` ? "*" | _PathParam<Rest> : _PathParam<Path>;
 ...
 */
export declare type Params<Key extends string = string> = ***REMOVED***
    readonly [key in Key]: string | undefined;
};
/**
 * A RouteMatch contains info about how a route matched a URL.
 */
export interface AgnosticRouteMatch<ParamKey extends string = string, RouteObjectType extends AgnosticRouteObject = AgnosticRouteObject> ***REMOVED***
    /**
...
export interface AgnosticDataRouteMatch extends AgnosticRouteMatch<string, AgnosticDataRouteObject> ***REMOVED***
}
 ...
 */
export declare function generatePath<Path extends string>(originalPath: Path, params?: ***REMOVED***
    [key in PathParam<Path>]: string | null;
}): string;
/**
 * A PathPattern is used to match on some portion of a URL pathname.
 */
export interface PathPattern<Path extends string = string> ***REMOVED***
    /**
 ...
 */
export interface PathMatch<ParamKey extends string = string> ***REMOVED***
    /**
     * The names and values of dynamic parameters in the URL.
     */
    params: Params<ParamKey>;
...
export interface TrackedPromise extends Promise<any> ***REMOVED***
    _tracked?: boolean;
    _data?: any;
    _error?: any;
}
export declare class AbortedDeferredError extends Error ***REMOVED***
}
export declare class DeferredData ***REMOVED***
 ...
 */
export declare class ErrorResponse ***REMOVED***
    status: number;
    statusText: string;
    data: any;
    error?: Error;
