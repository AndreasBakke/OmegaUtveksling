...
let router = createRouter(***REMOVED***
  // Routes array
  routes: ,
  // History instance
  history,
...
router.navigate("/page", ***REMOVED*** replace: true });
