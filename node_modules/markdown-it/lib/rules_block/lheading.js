...
module.exports = function lheading(state, startLine, endLine/*, silent*/) ***REMOVED***
  ...
  for (; nextLine < endLine && !state.isEmpty(nextLine); nextLine++) ***REMOVED***
    ...
    //
    if (state.sCount[nextLine] >= state.blkIndent) ***REMOVED***
      ...
      if (pos < max) ***REMOVED***
        ...
        if (marker === 0x2D/* - */ || marker === 0x3D/* = */) ***REMOVED***
