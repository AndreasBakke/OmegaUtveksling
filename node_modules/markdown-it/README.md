...
var md = require('markdown-it')(***REMOVED***
  ...
  highlight: function (/*str, lang*/) ***REMOVED*** return ''; }
});
```
...
var md = require('markdown-it')(***REMOVED***
  highlight: function (str, lang) ***REMOVED***
    if (lang && hljs.getLanguage(lang)) ***REMOVED***
      try ***REMOVED***
        return hljs.highlight(str, ***REMOVED*** language: lang }).value;
...
```js
md.linkify.set(***REMOVED*** fuzzyEmail: false });  // disables converting email to link
```
...
// Enable everything
md = require('markdown-it')(***REMOVED***
  html: true,
  linkify: true,
  typographer: true,
});
