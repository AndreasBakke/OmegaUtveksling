const ***REMOVED*** Query } = require('./query.js')
const ***REMOVED*** Errors } = require('./errors.js')

const types = module.exports.types = ***REMOVED***
  string: ***REMOVED***
    to: 25,
...
const Identifier = module.exports.Identifier = class Identifier extends NotTagged ***REMOVED***
...
const Parameter = module.exports.Parameter = class Parameter extends NotTagged ***REMOVED***
...
const Builder = module.exports.Builder = class Builder extends NotTagged ***REMOVED***
...
module.exports.handleValue = handleValue;function handleValue(x, parameters, types, options) ***REMOVED***
...
module.exports.stringify = stringify;function stringify(q, string, value, parameters, types, options) ***REMOVED*** // eslint-disable-line
...
const END = module.exports.END = ***REMOVED***}
...
const mergeUserTypes = module.exports.mergeUserTypes = function(types) ***REMOVED***
...
const escapeIdentifier = module.exports.escapeIdentifier = function escape(str) ***REMOVED***
  return '"' + str.replace(/"/g, '""').replace(/\./g, '"."') + '"'
}

const inferType = module.exports.inferType = function inferType(x) ***REMOVED***
  return (
...
const arraySerializer = module.exports.arraySerializer = function arraySerializer(xs, serializer, options) ***REMOVED***
...
const arrayParser = module.exports.arrayParser = function arrayParser(x, parser) ***REMOVED***
...
const toCamel = module.exports.toCamel = x => ***REMOVED***
  let str = x[0]
...
const toPascal = module.exports.toPascal = x => ***REMOVED***
...
const camel = module.exports.camel = ***REMOVED*** ...toCamel }
...
const pascal = module.exports.pascal = ***REMOVED*** ...toPascal }
...
const kebab = module.exports.kebab = ***REMOVED*** ...toKebab }
