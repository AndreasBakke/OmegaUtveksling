...
import ***REMOVED*** Options } from './util';
import Long = require('long');
export ***REMOVED*** Options, Long };
/**
 ...
 *
 * ```ts
 * if (isAnyExtension(message)) ***REMOVED***
 ...
 * ```
 */
export interface AnyExtension ***REMOVED***
    /**
...
declare module 'protobufjs' ***REMOVED***
  ...
  ***REMOVED***
    interface RootConstructor ***REMOVED***
...
export interface MessageTypeDefinition extends ProtobufTypeDefinition ***REMOVED***
    format: 'Protocol Buffer 3 DescriptorProto';
}
export interface EnumTypeDefinition extends ProtobufTypeDefinition ***REMOVED***
    format: 'Protocol Buffer 3 EnumDescriptorProto';
}
export interface MethodDefinition<RequestType, ResponseType, OutputRequestType = RequestType, OutputResponseType = ResponseType> ***REMOVED***
    path: string;
