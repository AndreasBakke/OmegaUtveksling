...
import ***REMOVED*** isIP } from "net";

export interface TcpSubchannelAddress ***REMOVED***
  port: number;
  host: string;
}

export interface IpcSubchannelAddress ***REMOVED***
  path: string;
}
/**
...
): address is TcpSubchannelAddress ***REMOVED***
...
export function subchannelAddressEqual(
  ...
  if (isTcpSubchannelAddress(address1)) ***REMOVED***
    return (
...
export function subchannelAddressToString(address: SubchannelAddress): string ***REMOVED***
...
export function stringToSubchannelAddress(addressString: string, port?: number): SubchannelAddress ***REMOVED***
  if (isIP(addressString)) ***REMOVED***
    return ***REMOVED***
      host: addressString,
