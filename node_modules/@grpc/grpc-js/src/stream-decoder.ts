...
enum ReadState ***REMOVED***
  NO_DATA,
  READING_SIZE,
  READING_MESSAGE,
}

export class StreamDecoder ***REMOVED***
  ...
  write(data: Buffer): Buffer[] ***REMOVED***
    let readHead = 0;
    let toRead: number;
    const result: Buffer[] = [];

    while (readHead < data.length) ***REMOVED***
      switch (this.readState) ***REMOVED***
        ...
        case ReadState.READING_SIZE:
          ...
          if (this.readSizeRemaining === 0) ***REMOVED***
            this.readMessageSize = this.readPartialSize.readUInt32BE(0);
            this.readMessageRemaining = this.readMessageSize;
            if (this.readMessageRemaining > 0) ***REMOVED***
