...
export interface IntermediateObjectReadable<T> extends Readable ***REMOVED***
  read(size?: number): any & T;
}

export type ObjectReadable<T> = ***REMOVED***
  read(size?: number): T;
} & EmitterAugmentation1<'data', T> &
  IntermediateObjectReadable<T>;

export interface IntermediateObjectWritable<T> extends Writable ***REMOVED***
...
export interface ObjectWritable<T> extends IntermediateObjectWritable<T> ***REMOVED***
