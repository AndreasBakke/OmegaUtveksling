 ...
 */
export interface ChannelControlHelper ***REMOVED***
  /**
 ...
 * @param overrides 
 */
export function createChildChannelControlHelper(parent: ChannelControlHelper, overrides: Partial<ChannelControlHelper>): ChannelControlHelper ***REMOVED***
  return ***REMOVED***
 ...
 */
export interface LoadBalancer ***REMOVED***
  /**
...
export interface LoadBalancerConstructor ***REMOVED***
  new (channelControlHelper: ChannelControlHelper): LoadBalancer;
}

export interface LoadBalancingConfig ***REMOVED***
  getLoadBalancerName(): string;
  toJsonObject(): object;
}

export interface LoadBalancingConfigConstructor ***REMOVED***
...
const registeredLoadBalancerTypes: ***REMOVED***
  [name: string]: ***REMOVED***
...
export function registerLoadBalancerType(
  ...
  registeredLoadBalancerTypes[typeName] = ***REMOVED***
    LoadBalancer: loadBalancerType,
    LoadBalancingConfig: loadBalancingConfigType,
***REMOVED***;
}

export function registerDefaultLoadBalancerType(typeName: string) ***REMOVED***
...
): LoadBalancer | null ***REMOVED***
  const typeName = config.getLoadBalancerName();
  if (typeName in registeredLoadBalancerTypes) ***REMOVED***
...
export function isLoadBalancerNameRegistered(typeName: string): boolean ***REMOVED***
...
): LoadBalancingConfig | null ***REMOVED***
  for (const config of configs) ***REMOVED***
    if (config.getLoadBalancerName() in registeredLoadBalancerTypes) ***REMOVED***
      return config;
  ***REMOVED***
***REMOVED***
  if (fallbackTodefault) ***REMOVED***
    if (defaultLoadBalancerType) ***REMOVED***
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function validateLoadBalancingConfig(obj: any): LoadBalancingConfig ***REMOVED***
...
***REMOVED*** else ***REMOVED***
    throw new Error(`Unrecognized load balancing config name $***REMOVED***typeName}`);
***REMOVED***
}
