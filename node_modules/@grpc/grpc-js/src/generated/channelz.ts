...
import type ***REMOVED*** MessageTypeDefinition } from '@grpc/proto-loader';

import type ***REMOVED*** ChannelzClient as _grpc_channelz_v1_ChannelzClient, ChannelzDefinition as _grpc_channelz_v1_ChannelzDefinition } from './grpc/channelz/v1/Channelz';

type SubtypeConstructor<Constructor extends new (...args: any) => any, Subtype> = ***REMOVED***
  new(...args: ConstructorParameters<Constructor>): Subtype;
};

export interface ProtoGrpcType ***REMOVED***
  google: ***REMOVED***
    protobuf: ***REMOVED***
  ...
  grpc: ***REMOVED***
    channelz: ***REMOVED***
      v1: ***REMOVED***
         ...
         * information.
         */
        Channelz: SubtypeConstructor<typeof grpc.Client, _grpc_channelz_v1_ChannelzClient> & ***REMOVED*** service: _grpc_channelz_v1_ChannelzDefinition }
