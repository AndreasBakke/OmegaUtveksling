...
import ***REMOVED*** Duration } from './duration';
import ***REMOVED***
  LoadBalancingConfig,
  validateLoadBalancingConfig,
} from './load-balancer';

export interface MethodConfigName ***REMOVED***
  service: string;
  method?: string;
}
...
export interface ServiceConfigCanaryConfig ***REMOVED***
...
function validateName(obj: any): MethodConfigName ***REMOVED***
  if (!('service' in obj) || typeof obj.service !== 'string') ***REMOVED***
    throw new Error('Invalid method config name: invalid service');
***REMOVED***
  const result: MethodConfigName = ***REMOVED***
    service: obj.service,
***REMOVED***;
...
function validateMethodConfig(obj: any): MethodConfig ***REMOVED***
  const result: MethodConfig = ***REMOVED***
    name: [],
***REMOVED***;
...
export function validateServiceConfig(obj: any): ServiceConfig ***REMOVED***
  const result: ServiceConfig = ***REMOVED***
    loadBalancingConfig: [],
    methodConfig: [],
***REMOVED***;
    ...
    for (const name of methodConfig.name) ***REMOVED***
      for (const seenName of seenMethodNames) ***REMOVED***
        if (
          ...
          throw new Error(
            `Invalid service config: duplicate name $***REMOVED***name.service}/$***REMOVED***name.method}`
          );
      ***REMOVED***
    ***REMOVED***
...
function validateCanaryConfig(obj: any): ServiceConfigCanaryConfig ***REMOVED***
  if (!('serviceConfig' in obj)) ***REMOVED***
    throw new Error('Invalid service config choice: missing service config');
***REMOVED***
  const result: ServiceConfigCanaryConfig = ***REMOVED***
...
***REMOVED***
  ...
  for (const field in obj) ***REMOVED***
    if (!allowedFields.includes(field)) ***REMOVED***
      throw new Error(
        `Invalid service config choice: unexpected field $***REMOVED***field}`
      );
  ***REMOVED***
***REMOVED***
  return result;
