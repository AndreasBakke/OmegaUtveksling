...
protoLoader.load(protoFileName, options).then(packageDefinition => ***REMOVED***
...
import ***REMOVED*** ProtoGrpcType } from './proto/example';
import ***REMOVED*** ExampleHandlers } from './proto/example_package/Example';

const exampleServer: ExampleHandlers = ***REMOVED***
