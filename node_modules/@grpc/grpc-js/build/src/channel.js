...
function getNewCallNumber() ***REMOVED***
...
function restrictControlPlaneStatusCode(code, details) ***REMOVED***
    if (INAPPROPRIATE_CONTROL_PLANE_CODES.includes(code)) ***REMOVED***
        return ***REMOVED***
            code: constants_1.Status.INTERNAL,
            details: `Invalid status from control plane: $***REMOVED***code} $***REMOVED***constants_1.Status[code]} $***REMOVED***details}`
      ***REMOVED***;
  ***REMOVED***
    else ***REMOVED***
...
class ChannelImplementation ***REMOVED***
    constructor(target, credentials, options) ***REMOVED***
      ...
      ***REMOVED***
        ...
        const channelControlHelper = ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***;
        this.resolvingLoadBalancer = new resolving_load_balancer_1.ResolvingLoadBalancer(this.target, channelControlHelper, options, (configSelector) => ***REMOVED***
            if (this.channelzEnabled) ***REMOVED***
      ...
      ***REMOVED***, (status) => ***REMOVED***
          ...
          ***REMOVED***
            if (this.configSelector === null) ***REMOVED***
                this.currentResolutionError = Object.assign(Object.assign(***REMOVED***}, restrictControlPlaneStatusCode(status.code, status.details)), ***REMOVED*** metadata: status.metadata });
          ***REMOVED***
            const localQueue = this.configSelectionQueue;
            this.configSelectionQueue = [];
            this.callRefTimerUnref();
  ...
  ***REMOVED***
    callRefTimerUnref() ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    pushPick(callStream, callMetadata, callConfig, dynamicFilters) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @param callMetadata
     */
    tryPick(callStream, callMetadata, callConfig, dynamicFilters) ***REMOVED***
        var _a, _b;
      ...
      ***REMOVED***);
        ...
        switch (pickResult.pickResultType) ***REMOVED***
            case picker_1.PickResultType.COMPLETE:
              ...
              ***REMOVED***
                    ...
                    if (pickResult.subchannel.getConnectivityState() !==
                        connectivity_state_1.ConnectivityState.READY) ***REMOVED***
                  ...
                  ***REMOVED***
                    ...
                    callStream.filterStack
                        ...
                        if (subchannelState === connectivity_state_1.ConnectivityState.READY) ***REMOVED***
                            try ***REMOVED***
                          ...
                          ***REMOVED***
                                ...
                                if (errorCode === 'ERR_HTTP2_GOAWAY_SESSION' ||
                                    errorCode === 'ERR_HTTP2_INVALID_SESSION') ***REMOVED***
                              ...
                              ***REMOVED***
                                    ...
                                    callStream.cancelWithStatus(constants_1.Status.INTERNAL, `Failed to start HTTP/2 stream with error: $***REMOVED***error.message}`);
                              ***REMOVED***
                          ***REMOVED***
                      ***REMOVED***
                        else ***REMOVED***
                  ...
                  ***REMOVED***, (error) => ***REMOVED***
                        ...
                        const ***REMOVED*** code, details } = restrictControlPlaneStatusCode(typeof error.code === 'number' ? error.code : constants_1.Status.UNKNOWN, `Getting metadata from plugin failed with error: $***REMOVED***error.message}`);
            ...
            case picker_1.PickResultType.DROP:
                ...
                break;
            default:
                throw new Error(`Invalid state: unknown pickResultType $***REMOVED***pickResult.pickResultType}`);
      ***REMOVED***
  ***REMOVED***
  ...
  ***REMOVED***
    updateState(newState) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    tryGetConfig(stream, metadata) ***REMOVED***
      ...
      ***REMOVED***
            ...
            if (callConfig.status === constants_1.Status.OK) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    _startCallStream(stream, metadata) ***REMOVED***
