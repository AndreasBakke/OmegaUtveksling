...
export interface OldOAuth2Client ***REMOVED***
    getRequestMetadata: (url: string, callback: (err: Error | null, headers?: ***REMOVED***
        [index: string]: string;
  ***REMOVED***) => void) => void;
}
export interface CurrentOAuth2Client ***REMOVED***
    getRequestHeaders: (url?: string) => Promise<***REMOVED***
        [index: string]: string;
  ***REMOVED***>;
}
 ...
 */
export declare abstract class CallCredentials ***REMOVED***
    /**
