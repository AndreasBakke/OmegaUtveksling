 ...
 */
export declare type SurfaceCall = ***REMOVED***
 ...
 */
export declare type ClientReadableStream<ResponseType> = ***REMOVED***
    deserialize: (chunk: Buffer) => ResponseType;
} & SurfaceCall & ObjectReadable<ResponseType>;
/**
 * A type representing the return value of a client stream method call.
 */
export declare type ClientWritableStream<RequestType> = ***REMOVED***
...
export declare class ClientUnaryCallImpl extends EventEmitter implements ClientUnaryCall ***REMOVED***
    call?: InterceptingCallInterface;
    constructor();
    cancel(): void;
    getPeer(): string;
}
export declare class ClientReadableStreamImpl<ResponseType> extends Readable implements ClientReadableStream<ResponseType> ***REMOVED***
...
export declare class ClientWritableStreamImpl<RequestType> extends Writable implements ClientWritableStream<RequestType> ***REMOVED***
...
export declare class ClientDuplexStreamImpl<RequestType, ResponseType> extends Duplex implements ClientDuplexStream<RequestType, ResponseType> ***REMOVED***
    readonly serialize: (value: RequestType) => Buffer;
    readonly deserialize: (chunk: Buffer) => ResponseType;
    call?: InterceptingCallInterface;
