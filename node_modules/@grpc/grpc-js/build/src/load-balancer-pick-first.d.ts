import ***REMOVED*** LoadBalancer, ChannelControlHelper, LoadBalancingConfig } from './load-balancer';
import ***REMOVED*** SubchannelAddress } from './subchannel-address';
export declare class PickFirstLoadBalancingConfig implements LoadBalancingConfig ***REMOVED***
    getLoadBalancerName(): string;
    constructor();
    toJsonObject(): object;
    static createFromJson(obj: any): PickFirstLoadBalancingConfig;
}
export declare class PickFirstLoadBalancer implements LoadBalancer ***REMOVED***
