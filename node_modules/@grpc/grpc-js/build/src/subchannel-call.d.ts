...
import ***REMOVED*** InterceptingListener, MessageContext, StatusObject } from './call-interface';
export interface SubchannelCall ***REMOVED***
...
export interface StatusObjectWithRstCode extends StatusObject ***REMOVED***
    rstCode?: number;
}
export interface SubchannelCallInterceptingListener extends InterceptingListener ***REMOVED***
    onReceiveStatus(status: StatusObjectWithRstCode): void;
}
export declare class Http2SubchannelCall implements SubchannelCall ***REMOVED***
