...
export declare type ServerSurfaceCall = ***REMOVED***
    cancelled: boolean;
...
export declare type ServerUnaryCall<RequestType, ResponseType> = ServerSurfaceCall & ***REMOVED***
    request: RequestType;
};
export declare type ServerReadableStream<RequestType, ResponseType> = ServerSurfaceCall & ObjectReadable<RequestType>;
export declare type ServerWritableStream<RequestType, ResponseType> = ServerSurfaceCall & ObjectWritable<ResponseType> & ***REMOVED***
    request: RequestType;
    end: (metadata?: Metadata) => void;
};
export declare type ServerDuplexStream<RequestType, ResponseType> = ServerSurfaceCall & ObjectReadable<RequestType> & ObjectWritable<ResponseType> & ***REMOVED***
    end: (metadata?: Metadata) => void;
};
export declare class ServerUnaryCallImpl<RequestType, ResponseType> extends EventEmitter implements ServerUnaryCall<RequestType, ResponseType> ***REMOVED***
    private call;
    metadata: Metadata;
    request: RequestType;
    cancelled: boolean;
...
export declare class ServerReadableStreamImpl<RequestType, ResponseType> extends Readable implements ServerReadableStream<RequestType, ResponseType> ***REMOVED***
    private call;
    metadata: Metadata;
...
export declare class ServerWritableStreamImpl<RequestType, ResponseType> extends Writable implements ServerWritableStream<RequestType, ResponseType> ***REMOVED***
    private call;
    metadata: Metadata;
...
export declare class ServerDuplexStreamImpl<RequestType, ResponseType> extends Duplex implements ServerDuplexStream<RequestType, ResponseType> ***REMOVED***
    private call;
    metadata: Metadata;
    serialize: Serialize<ResponseType>;
    deserialize: Deserialize<RequestType>;
...
export declare class Http2ServerCallStream<RequestType, ResponseType> extends EventEmitter ***REMOVED***
    private stream;
    private handler;
    private options;
    cancelled: boolean;
