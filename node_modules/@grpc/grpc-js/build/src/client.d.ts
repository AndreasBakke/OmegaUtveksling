...
import ***REMOVED*** ClientDuplexStream, ClientReadableStream, ClientUnaryCall, ClientWritableStream, ServiceError, SurfaceCall } from './call';
import ***REMOVED*** CallCredentials } from './call-credentials';
import ***REMOVED*** Deadline } from './call-stream';
...
import ***REMOVED*** Interceptor, InterceptorProvider } from './client-interceptors';
import ***REMOVED*** ServerUnaryCall, ServerReadableStream, ServerWritableStream, ServerDuplexStream } from './server-call';
...
export declare type ClientOptions = Partial<ChannelOptions> & ***REMOVED***
 ...
 * clients.
 */
export declare class Client ***REMOVED***
