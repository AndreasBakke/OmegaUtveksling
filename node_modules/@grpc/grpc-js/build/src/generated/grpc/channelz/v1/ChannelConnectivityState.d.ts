export declare enum _grpc_channelz_v1_ChannelConnectivityState_State ***REMOVED***
    UNKNOWN = 0,
    IDLE = 1,
    CONNECTING = 2,
    READY = 3,
 ...
 */
export interface ChannelConnectivityState ***REMOVED***
 ...
 * https://github.com/grpc/grpc/blob/master/doc/connectivity-semantics-and-api.md
 */
export interface ChannelConnectivityState__Output ***REMOVED***
