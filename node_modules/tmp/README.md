...
tmp.file(***REMOVED*** mode: 0o644, prefix: 'prefix-', postfix: '.txt' }, function _tempFileCreated(err, path, fd) ***REMOVED***
  if (err) throw err;
...
const tmpobj = tmp.fileSync(***REMOVED*** mode: 0o644, prefix: 'prefix-', postfix: '.txt' });
console.log('File: ', tmpobj.name);
console.log('Filedescriptor: ', tmpobj.fd);
```
...
tmp.file(***REMOVED*** discardDescriptor: true }, function _tempFileCreated(err, path, fd, cleanupCallback) ***REMOVED***
  if (err) throw err;
...
tmp.file(***REMOVED*** detachDescriptor: true }, function _tempFileCreated(err, path, fd, cleanupCallback) ***REMOVED***
  if (err) throw err;
...
tmp.dir(***REMOVED*** mode: 0o750, prefix: 'myTmpDir_' }, function _tempDirCreated(err, path) ***REMOVED***
  if (err) throw err;
...
const tmpobj = tmp.dirSync(***REMOVED*** mode: 0750, prefix: 'myTmpDir_' });
console.log('Dir: ', tmpobj.name);
```
...
tmp.dir(***REMOVED*** template: 'tmp-XXXXXX' }, function _tempDirCreated(err, path) ***REMOVED***
  if (err) throw err;
...
const tmpobj = tmp.dirSync(***REMOVED*** template: 'tmp-XXXXXX' });
console.log('Dir: ', tmpobj.name);
```
...
tmp.tmpName(options, function _tempNameGenerated(err, path) ***REMOVED***
    if (err) throw err;
