...
function print(t) ***REMOVED***
  console.log(util.inspect(printTree(t.root), ***REMOVED***depth:12}))
}
...
***REMOVED***
  for(var i=-20; i<0; ++i) ***REMOVED***
    ...
    checkTree(u, t)
    checkTree(next, t)
    arr.sort(function(a,b) ***REMOVED*** return a-b })
    var ptr = 0
...
***REMOVED***)
  ...
  zipped.sort(function(a,b) ***REMOVED***
    if(a[0] < b[0]) ***REMOVED*** return -1 }
    if(a[0] > b[0]) ***REMOVED*** return 1 }
    return 0
***REMOVED***)

  var keys = zipped.map(function(v) ***REMOVED*** return v[0] })
  var values = zipped.map(function(v) ***REMOVED*** return v[1] })
