    ...
    return update(appConfig, function (oldEntry) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (hasAuthTokenRequestTimedOut(oldAuthToken)) ***REMOVED***
            return tslib.__assign(tslib.__assign(***REMOVED***}, oldEntry), ***REMOVED*** authToken: ***REMOVED*** requestStatus: 0 /* RequestStatus.NOT_STARTED */ } });
      ***REMOVED***
        return oldEntry;
  ***REMOVED***);
}
    ...
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                    authToken = _a.sent();
                    updatedInstallationEntry = tslib.__assign(tslib.__assign(***REMOVED***}, installationEntry), ***REMOVED*** authToken: authToken });
                ...
                case 4:
                    ...
                    return [3 /*break*/, 7];
                case 5:
                    updatedInstallationEntry = tslib.__assign(tslib.__assign(***REMOVED***}, installationEntry), ***REMOVED*** authToken: ***REMOVED*** requestStatus: 0 /* RequestStatus.NOT_STARTED */ } });
                    return [4 /*yield*/, set(installations.appConfig, updatedInstallationEntry)];
                case 6:
                    _a.sent();
                    _a.label = 7;
...
function makeAuthTokenRequestInProgressEntry(oldEntry) ***REMOVED***
  ...
  ***REMOVED***;
    return tslib.__assign(tslib.__assign(***REMOVED***}, oldEntry), ***REMOVED*** authToken: inProgressAuthToken });
}
 ...
 * @public
 */
function getInstallations(app$1) ***REMOVED***
