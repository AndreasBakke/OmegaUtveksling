...
import ***REMOVED*** CompletedAuthToken, RegisteredInstallationEntry } from '../interfaces/installation-entry';
import ***REMOVED*** AppConfig } from '../interfaces/installation-impl';
export declare function getInstallationsEndpoint(***REMOVED*** projectId }: AppConfig): string;
...
export declare function getHeaders(***REMOVED*** apiKey }: AppConfig): Headers;
export declare function getHeadersWithAuth(appConfig: AppConfig, ***REMOVED*** refreshToken }: RegisteredInstallationEntry): Headers;
