...
export declare const enum RequestStatus ***REMOVED***
    NOT_STARTED = 0,
    IN_PROGRESS = 1,
    COMPLETED = 2
}
export interface NotStartedAuthToken ***REMOVED***
    readonly requestStatus: RequestStatus.NOT_STARTED;
}
export interface InProgressAuthToken ***REMOVED***
...
export interface CompletedAuthToken ***REMOVED***
...
export interface RegisteredInstallationEntry ***REMOVED***
    /** Status of the Firebase Installation registration on the server. */
