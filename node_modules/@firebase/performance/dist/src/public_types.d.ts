 ...
 * @public
 */
export interface PerformanceSettings ***REMOVED***
 ...
 * @public
 */
export interface FirebasePerformance ***REMOVED***
    /**
     * The ***REMOVED***@link @firebase/app#FirebaseApp} this `FirebasePerformance` instance is associated with.
     */
    app: FirebaseApp;
    /**
 ...
 * @public
 */
export interface PerformanceTrace ***REMOVED***
    /**
     ...
     * custom attributes.
     */
    record(startTime: number, duration: number, options?: ***REMOVED***
        metrics?: ***REMOVED***
            [key: string]: number;
      ***REMOVED***;
        attributes?: ***REMOVED***
