...
const ERROR_DESCRIPTION_MAP = ***REMOVED***
    ["trace started" /* ErrorCode.TRACE_STARTED_BEFORE */]: 'Trace ***REMOVED***$traceName} was started before.',
    ["trace stopped" /* ErrorCode.TRACE_STOPPED_BEFORE */]: 'Trace ***REMOVED***$traceName} is not running.',
    ["nonpositive trace startTime" /* ErrorCode.NONPOSITIVE_TRACE_START_TIME */]: 'Trace ***REMOVED***$traceName} startTime should be positive.',
    ["nonpositive trace duration" /* ErrorCode.NONPOSITIVE_TRACE_DURATION */]: 'Trace ***REMOVED***$traceName} duration should be positive.',
    ...
    ["invalid attribute name" /* ErrorCode.INVALID_ATTRIBUTE_NAME */]: 'Attribute name ***REMOVED***$attributeName} is invalid.',
    ["invalid attribute value" /* ErrorCode.INVALID_ATTRIBUTE_VALUE */]: 'Attribute value ***REMOVED***$attributeValue} is invalid.',
    ["invalid custom metric name" /* ErrorCode.INVALID_CUSTOM_METRIC_NAME */]: 'Custom metric name ***REMOVED***$customMetricName} is invalid',
  ...
  ***REMOVED***
    requiredApisAvailable() ***REMOVED***
      ...
      ***REMOVED***
        return true;
  ***REMOVED***
    setupObserver(entryType, callback) ***REMOVED***
        if (!this.PerformanceObserver) ***REMOVED***
            return;
      ***REMOVED***
        const observer = new this.PerformanceObserver(list => ***REMOVED***
            for (const entry of list.getEntries()) ***REMOVED***
...
function getIidPromise(installationsService) ***REMOVED***
    ...
    iidPromise.then((iidVal) => ***REMOVED***
        iid = iidVal;
  ***REMOVED***);
    return iidPromise;
}
...
function getAuthTokenPromise(installationsService) ***REMOVED***
    ...
    // eslint-disable-next-line @typescript-eslint/no-floating-promises
    authTokenPromise.then((authTokenVal) => ***REMOVED***
  ***REMOVED***);
...
function mergeStrings(part1, part2) ***REMOVED***
  ...
  ***REMOVED***
    const resultArray = [];
    for (let i = 0; i < part1.length; i++) ***REMOVED***
...
function getRemoteConfig(performanceController, iid) ***REMOVED***
    ...
    return getAuthTokenPromise(performanceController.installations)
        .then(authToken => ***REMOVED***
        const projectId = getProjectId(performanceController.app);
        const apiKey = getApiKey(performanceController.app);
        const configEndPoint = `https://firebaseremoteconfig.googleapis.com/v1/projects/$***REMOVED***projectId}/namespaces/fireperf:fetch?key=$***REMOVED***apiKey}`;
        const request = new Request(configEndPoint, ***REMOVED***
            method: 'POST',
            headers: ***REMOVED*** Authorization: `$***REMOVED***FIS_AUTH_PREFIX} $***REMOVED***authToken}` },
      ...
      ***REMOVED***);
        return fetch(request).then(response => ***REMOVED***
...
function dispatchQueueEvents() ***REMOVED***
    ...
    const log_event = staged.map(evt => (***REMOVED***
  ...
  ***REMOVED***;
    /* eslint-enable camelcase */
    sendEventsToFl(data, staged).catch(() => ***REMOVED***
        // If the request fails for some reason, add the events that were attempted
        // back to the primary queue to retry later.
        queue = [...staged, ...queue];
        remainingTries--;
        consoleLogger.info(`Tries left: $***REMOVED***remainingTries}.`);
...
function serializeNetworkRequest(networkRequest) ***REMOVED***
    const networkRequestMetric = ***REMOVED***
...
function convertMetricValueToInteger(providedValue) ***REMOVED***
    ...
    if (valueAsInteger < providedValue) ***REMOVED***
        consoleLogger.info(`Metric value should be an Integer, setting the value as : $***REMOVED***valueAsInteger}.`);
  ***REMOVED***
...
class Trace ***REMOVED***
     ...
     */
    constructor(performanceController, name, isAuto = false, traceMeasureName) ***REMOVED***
        ...
        if (!this.isAuto) ***REMOVED***
            this.traceStartMark = `$***REMOVED***TRACE_START_MARK_PREFIX}-$***REMOVED***this.randomId}-$***REMOVED***this.name}`;
            this.traceStopMark = `$***REMOVED***TRACE_STOP_MARK_PREFIX}-$***REMOVED***this.randomId}-$***REMOVED***this.name}`;
            this.traceMeasure =
                traceMeasureName ||
                    `$***REMOVED***TRACE_MEASURE_PREFIX}-$***REMOVED***this.randomId}-$***REMOVED***this.name}`;
  ...
  ***REMOVED***
     ...
     */
    record(startTime, duration, options) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (options && options.attributes) ***REMOVED***
            this.customAttributes = Object.assign(***REMOVED***}, options.attributes);
      ***REMOVED***
        if (options && options.metrics) ***REMOVED***
            for (const metricName of Object.keys(options.metrics)) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    incrementMetric(counter, numAsInteger = 1) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    putMetric(counter, numAsInteger) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @param value
     */
    putAttribute(attr, value) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @param attr
     */
    getAttribute(attr) ***REMOVED***
        return this.customAttributes[attr];
  ***REMOVED***
    removeAttribute(attr) ***REMOVED***
        if (this.customAttributes[attr] === undefined) ***REMOVED***
            return;
      ***REMOVED***
        delete this.customAttributes[attr];
  ***REMOVED***
    getAttributes() ***REMOVED***
        return Object.assign(***REMOVED***}, this.customAttributes);
  ***REMOVED***
    setStartTime(startTime) ***REMOVED***
        this.startTimeUs = startTime;
  ***REMOVED***
    setDuration(duration) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    static createOobTrace(performanceController, navigationTimings, paintTimings, firstInputDelay) ***REMOVED***
      ...
      ***REMOVED***
        logTrace(trace);
  ***REMOVED***
    static createUserTimingTrace(performanceController, measureName) ***REMOVED***
...
function setupNetworkRequests(performanceController) ***REMOVED***
    ...
    for (const resource of resources) ***REMOVED***
...
function setupUserTimingTraces(performanceController) ***REMOVED***
    ...
    for (const measure of measures) ***REMOVED***
 ...
 * limitations under the License.
 */
class PerformanceController ***REMOVED***
    constructor(app, installations) ***REMOVED***
        this.app = app;
    ...
    _init(settings) ***REMOVED***
      ...
      ***REMOVED***
        if (Api.getInstance().requiredApisAvailable()) ***REMOVED***
          ...
          ***REMOVED***)
                .catch(error => ***REMOVED***
                consoleLogger.info(`Environment doesn't support IndexedDB: $***REMOVED***error}`);
          ***REMOVED***);
      ***REMOVED***
        else ***REMOVED***
 ...
 * @public
 */
function getPerformance(app = getApp()) ***REMOVED***
...
function initializePerformance(app, settings) ***REMOVED***
    ...
    if (provider.isInitialized()) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    const perfInstance = provider.initialize(***REMOVED***
        options: settings
  ***REMOVED***);
    return perfInstance;
}
...
const factory = (container, ***REMOVED*** options: settings }) => ***REMOVED***
    // Dependencies
