...
var Api = /** @class */ (function () ***REMOVED***
  ...
  ***REMOVED***;
    Api.prototype.requiredApisAvailable = function () ***REMOVED***
        if (!fetch || !Promise || !util.areCookiesEnabled()) ***REMOVED***
...
var Trace = /** @class */ (function () ***REMOVED***
    ...
    Trace.prototype.record = function (startTime, duration, options) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (options && options.attributes) ***REMOVED***
            this.customAttributes = tslib.__assign(***REMOVED***}, options.attributes);
      ***REMOVED***
  ...
  ***REMOVED***;
    Trace.prototype.getAttributes = function () ***REMOVED***
        return tslib.__assign(***REMOVED***}, this.customAttributes);
  ***REMOVED***;
 ...
 * @public
 */
function getPerformance(app$1) ***REMOVED***
 ...
 * @public
 */
function initializePerformance(app$1, settings) ***REMOVED***
    app$1 = util.getModularInstance(app$1);
    var provider = app._getProvider(app$1, 'performance');
    ...
    if (provider.isInitialized()) ***REMOVED***
        ...
        if (util.deepEqual(initialSettings, settings !== null && settings !== void 0 ? settings : ***REMOVED***})) ***REMOVED***
