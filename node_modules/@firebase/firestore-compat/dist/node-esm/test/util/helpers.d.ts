...
export declare function toDataMap(docSet: firestore.QuerySnapshot): ***REMOVED***
...
export declare function withTestCollectionSettings(persistence: boolean, settings: firestore.Settings, docs: ***REMOVED***
    [key: string]: firestore.DocumentData;
}, fn: (collection: firestore.CollectionReference) => Promise<void>): Promise<void>;
export ***REMOVED***};
