...
function validateSetOptions(methodName, options) ***REMOVED***
  ...
  ***REMOVED***
    if (options.mergeFields !== undefined && options.merge !== undefined) ***REMOVED***
        throw new FirestoreError('invalid-argument', `Invalid options passed to function $***REMOVED***methodName}(): You cannot ` +
...
class IndexedDbPersistenceProvider ***REMOVED***
    enableIndexedDbPersistence(firestore, forceOwnership) ***REMOVED***
        return enableIndexedDbPersistence(firestore._delegate, ***REMOVED*** forceOwnership });
  ***REMOVED***
    enableMultiTabIndexedDbPersistence(firestore) ***REMOVED***
        return enableMultiTabIndexedDbPersistence(firestore._delegate);
  ***REMOVED***
    clearIndexedDbPersistence(firestore) ***REMOVED***
...
class Firestore ***REMOVED***
    constructor(databaseIdOrApp, _delegate, _persistenceProvider) ***REMOVED***
      ...
      ***REMOVED***;
        if (!(databaseIdOrApp instanceof _DatabaseId)) ***REMOVED***
  ...
  ***REMOVED***
    namedQuery(name) ***REMOVED***
        return namedQuery(this._delegate, name).then(expQuery => ***REMOVED***
            if (!expQuery) ***REMOVED***
                return null;
          ***REMOVED***
...
class UserDataWriter extends AbstractUserDataWriter ***REMOVED***
...
class DocumentReference ***REMOVED***
  ...
  ***REMOVED***
    static forPath(path, firestore, converter) ***REMOVED***
  ...
  ***REMOVED***
    static forKey(key, firestore, converter) ***REMOVED***
  ...
  ***REMOVED***
    isEqual(other) ***REMOVED***
        ...
        if (!(other instanceof DocumentReference$1)) ***REMOVED***
            return false;
      ***REMOVED***
...
class FieldPath ***REMOVED***
  ...
  ***REMOVED***
    isEqual(other) ***REMOVED***
        other = getModularInstance(other);
        if (!(other instanceof FieldPath$1)) ***REMOVED***
            return false;
      ***REMOVED***
...
function configureForFirebase(firebase, firestoreFactory) ***REMOVED***
    firebase.INTERNAL.registerComponent(new Component('firestore-compat', container => ***REMOVED***
...
export ***REMOVED*** registerFirestore };
