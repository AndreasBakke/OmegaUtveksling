 ...
 */
export interface PersistenceProvider ***REMOVED***
 ...
 */
export declare class IndexedDbPersistenceProvider implements PersistenceProvider ***REMOVED***
    enableIndexedDbPersistence(firestore: Firestore, forceOwnership: boolean): Promise<void>;
    enableMultiTabIndexedDbPersistence(firestore: Firestore): Promise<void>;
    clearIndexedDbPersistence(firestore: Firestore): Promise<void>;
}
 ...
 */
export declare class Firestore implements PublicFirestore, FirebaseService, Compat<ExpFirestore> ***REMOVED***
    ...
    useEmulator(host: string, port: number, options?: ***REMOVED***
...
export declare class UserDataWriter extends AbstractUserDataWriter ***REMOVED***
 ...
 */
export declare class Transaction implements PublicTransaction, Compat<ExpTransaction> ***REMOVED***
...
export declare class WriteBatch implements PublicWriteBatch, Compat<ExpWriteBatch> ***REMOVED***
 ...
 */
export declare class DocumentReference<T = PublicDocumentData> implements PublicDocumentReference<T>, Compat<ExpDocumentReference<T>> ***REMOVED***
 ...
 * DocumentSnapshots.
 */
export interface SnapshotOptions extends PublicSnapshotOptions ***REMOVED***
}
export declare class DocumentSnapshot<T = PublicDocumentData> implements PublicDocumentSnapshot<T>, Compat<ExpDocumentSnapshot<T>> ***REMOVED***
    private readonly _firestore;
...
export declare class QueryDocumentSnapshot<T = PublicDocumentData> extends DocumentSnapshot<T> implements PublicQueryDocumentSnapshot<T> ***REMOVED***
    data(options?: PublicSnapshotOptions): T;
}
export declare class Query<T = PublicDocumentData> implements PublicQuery<T>, Compat<ExpQuery<T>> ***REMOVED***
    readonly firestore: Firestore;
...
export declare class DocumentChange<T = PublicDocumentData> implements PublicDocumentChange<T>, Compat<ExpDocumentChange<T>> ***REMOVED***
    private readonly _firestore;
...
export declare class QuerySnapshot<T = PublicDocumentData> implements PublicQuerySnapshot<T>, Compat<ExpQuerySnapshot<T>> ***REMOVED***
...
export declare class CollectionReference<T = PublicDocumentData> extends Query<T> implements PublicCollectionReference<T> ***REMOVED***
    readonly firestore: Firestore;
