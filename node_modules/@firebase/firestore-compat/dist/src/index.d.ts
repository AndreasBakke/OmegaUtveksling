 ...
 */
import type ***REMOVED*** FirebaseNamespace } from '@firebase/app-types';
...
declare module "@firebase/firestore" ***REMOVED***
    ...
    function connectFirestoreEmulator(firestore: types.FirebaseFirestore, host: string, port: number, options?: ***REMOVED***
  ...
  ***REMOVED***): void;
    ...
    function getCountFromServer(query: types.Query<unknown>): Promise<AggregateQuerySnapshot<***REMOVED***
  ...
  ***REMOVED***>>;
    ...
    function onSnapshot<T>(reference: types.DocumentReference<T>, observer: ***REMOVED***
        next?: (snapshot: DocumentSnapshot<T>) => void;
        error?: (error: FirestoreError) => void;
        complete?: () => void;
  ***REMOVED***): Unsubscribe;
    function onSnapshot<T>(reference: types.DocumentReference<T>, options: SnapshotListenOptions, observer: ***REMOVED***
        next?: (snapshot: DocumentSnapshot<T>) => void;
        error?: (error: FirestoreError) => void;
        complete?: () => void;
  ***REMOVED***): Unsubscribe;
    ...
    function onSnapshot<T>(query: types.Query<T>, observer: ***REMOVED***
        next?: (snapshot: QuerySnapshot<T>) => void;
        error?: (error: FirestoreError) => void;
        complete?: () => void;
  ***REMOVED***): Unsubscribe;
    function onSnapshot<T>(query: types.Query<T>, options: SnapshotListenOptions, observer: ***REMOVED***
        next?: (snapshot: QuerySnapshot<T>) => void;
        error?: (error: FirestoreError) => void;
        complete?: () => void;
  ***REMOVED***): Unsubscribe;
    ...
    function onSnapshotsInSync(firestore: types.FirebaseFirestore, observer: ***REMOVED***
