...
import ***REMOVED*** httpsCallable, httpsCallableFromURL, connectFunctionsEmulator } from '@firebase/functions';
...
class FunctionsService ***REMOVED***
  ...
  ***REMOVED***
    httpsCallable(name, options) ***REMOVED***
        return httpsCallable(this._delegate, name, options);
  ***REMOVED***
    httpsCallableFromURL(url, options) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @deprecated
     */
    useFunctionsEmulator(origin) ***REMOVED***
...
const factory = (container, ***REMOVED*** instanceIdentifier: regionOrCustomDomain }) => ***REMOVED***
    ...
    const functionsServiceExp = container.getProvider('functions').getImmediate(***REMOVED***
...
function registerFunctions() ***REMOVED***
