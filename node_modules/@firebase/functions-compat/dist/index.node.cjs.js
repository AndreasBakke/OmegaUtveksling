...
var FunctionsService = /** @class */ (function () ***REMOVED***
    function FunctionsService(app, _delegate) ***REMOVED***
        this.app = app;
        this._delegate = _delegate;
        this._region = this._delegate.region;
        this._customDomain = this._delegate.customDomain;
  ***REMOVED***
    FunctionsService.prototype.httpsCallable = function (name, options) ***REMOVED***
        return functions.httpsCallable(this._delegate, name, options);
  ***REMOVED***;
    FunctionsService.prototype.httpsCallableFromURL = function (url, options) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @deprecated
     */
    FunctionsService.prototype.useFunctionsEmulator = function (origin) ***REMOVED***
  ...
  ***REMOVED***;
    FunctionsService.prototype.useEmulator = function (host, port) ***REMOVED***
...
var factory = function (container, _a) ***REMOVED***
    ...
    var functionsServiceExp = container.getProvider('functions').getImmediate(***REMOVED***
