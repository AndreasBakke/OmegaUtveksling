 ...
 */
import ***REMOVED*** FirebaseFunctions, HttpsCallable } from '@firebase/functions-types';
import ***REMOVED*** HttpsCallableOptions, Functions as FunctionsServiceExp } from '@firebase/functions';
import ***REMOVED*** FirebaseApp, _FirebaseService } from '@firebase/app-compat';
export declare class FunctionsService implements FirebaseFunctions, _FirebaseService ***REMOVED***
    app: FirebaseApp;
