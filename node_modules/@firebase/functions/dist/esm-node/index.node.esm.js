import ***REMOVED*** _registerComponent, registerVersion, _getProvider, getApp } from '@firebase/app';
import ***REMOVED*** FirebaseError, getModularInstance, getDefaultEmulatorHostnameAndPort } from '@firebase/util';
 ...
 */
class FunctionsError extends FirebaseError ***REMOVED***
    constructor(
    /**
     ...
     */
    details) ***REMOVED***
        super(`$***REMOVED***FUNCTIONS_TYPE}/$***REMOVED***code}`, message || '');
...
function _errorForResponse(status, bodyJSON) ***REMOVED***
    ...
    try ***REMOVED***
        ...
        if (errorJSON) ***REMOVED***
            ...
            if (typeof status === 'string') ***REMOVED***
                if (!errorCodeMap[status]) ***REMOVED***
 ...
 * @internal
 */
class ContextProvider ***REMOVED***
    constructor(authProvider, messagingProvider, appCheckProvider) ***REMOVED***
        this.auth = null;
        this.messaging = null;
        this.appCheck = null;
      ...
      ***REMOVED***);
        if (!this.auth) ***REMOVED***
            authProvider.get().then(auth => (this.auth = auth), () => ***REMOVED***
                /* get() never rejects */
          ***REMOVED***);
      ***REMOVED***
        if (!this.messaging) ***REMOVED***
            messagingProvider.get().then(messaging => (this.messaging = messaging), () => ***REMOVED***
                /* get() never rejects */
          ***REMOVED***);
      ***REMOVED***
        if (!this.appCheck) ***REMOVED***
            appCheckProvider.get().then(appCheck => (this.appCheck = appCheck), () => ***REMOVED***
                /* get() never rejects */
          ***REMOVED***);
      ***REMOVED***
  ***REMOVED***
    async getAuthToken() ***REMOVED***
        if (!this.auth) ***REMOVED***
            return undefined;
      ***REMOVED***
        try ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    async getMessagingToken() ***REMOVED***
        if (!this.messaging ||
      ...
      ***REMOVED***
  ***REMOVED***
    async getAppCheckToken() ***REMOVED***
        if (this.appCheck) ***REMOVED***
      ...
      ***REMOVED***
        return null;
  ***REMOVED***
    async getContext() ***REMOVED***
        const authToken = await this.getAuthToken();
        const messagingToken = await this.getMessagingToken();
        const appCheckToken = await this.getAppCheckToken();
        return ***REMOVED*** authToken, messagingToken, appCheckToken };
  ***REMOVED***
}
...
function failAfter(millis) ***REMOVED***
    ...
    let timer = null;
    return ***REMOVED***
        promise: new Promise((_, reject) => ***REMOVED***
 ...
 * @internal
 */
class FunctionsService ***REMOVED***
    /**
     * Creates a new Functions service for the given app.
     * @param app - The FirebaseApp to use.
     */
    constructor(app, authProvider, messagingProvider, appCheckProvider, regionOrCustomDomain = DEFAULT_REGION, fetchImpl) ***REMOVED***
        this.app = app;
        this.fetchImpl = fetchImpl;
        this.emulatorOrigin = null;
        this.contextProvider = new ContextProvider(authProvider, messagingProvider, appCheckProvider);
        // Cancels all ongoing requests when resolved.
        this.cancelAllRequests = new Promise(resolve => ***REMOVED***
            this.deleteService = () => ***REMOVED***
  ...
  ***REMOVED***
    ...
    _url(name) ***REMOVED***
        ...
        if (this.emulatorOrigin !== null) ***REMOVED***
            ...
            return `$***REMOVED***origin}/$***REMOVED***projectId}/$***REMOVED***this.region}/$***REMOVED***name}`;
      ***REMOVED***
        if (this.customDomain !== null) ***REMOVED***
            return `$***REMOVED***this.customDomain}/$***REMOVED***name}`;
      ***REMOVED***
        return `https://$***REMOVED***this.region}-$***REMOVED***projectId}.cloudfunctions.net/$***REMOVED***name}`;
  ***REMOVED***
}
/**
...
function connectFunctionsEmulator$1(functionsInstance, host, port) ***REMOVED***
    functionsInstance.emulatorOrigin = `http://$***REMOVED***host}:$***REMOVED***port}`;
}
/**
 ...
 */
async function postJSON(url, body, headers, fetchImpl) ***REMOVED***
    headers['Content-Type'] = 'application/json';
    let response;
    try ***REMOVED***
        response = await fetchImpl(url, ***REMOVED***
            method: 'POST',
 ...
 * @param data The data to pass as params to the function.s
 */
async function callAtURL(functionsInstance, url, data, options) ***REMOVED***
    // Encode any special types, such as dates, in the input data.
    data = encode(data);
    const body = ***REMOVED*** data };
  ...
  ***REMOVED***
    ...
    return ***REMOVED*** data: decodedData };
}
...
function registerFunctions(fetchImpl, variant) ***REMOVED***
    const factory = (container, ***REMOVED*** instanceIdentifier: regionOrCustomDomain }) => ***REMOVED***
        // Dependencies
 ...
 * @public
 */
function getFunctions(app = getApp(), regionOrCustomDomain = DEFAULT_REGION) ***REMOVED***
    // Dependencies
    const functionsProvider = _getProvider(getModularInstance(app), FUNCTIONS_TYPE);
    const functionsInstance = functionsProvider.getImmediate(***REMOVED***
...
export ***REMOVED*** connectFunctionsEmulator, getFunctions, httpsCallable, httpsCallableFromURL };
