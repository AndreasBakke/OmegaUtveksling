 ...
 * @public
 */
export declare interface Functions ***REMOVED***
    /**
     * The ***REMOVED***@link @firebase/app#FirebaseApp} this `Functions` instance is associated with.
     */
    app: FirebaseApp;
    /**
 ...
 * @public
 */
export declare interface FunctionsError extends FirebaseError ***REMOVED***
    /**
 ...
 * @public
 */
export declare type FunctionsErrorCode = `functions/$***REMOVED***FunctionsErrorCodeCore}`;

/**
 * Functions error code string appended after "functions/" product prefix.
 * See ***REMOVED***@link FunctionsErrorCode} for full documentation of codes.
 * @public
 */
 ...
 * @public
 */
export declare interface HttpsCallableOptions ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface HttpsCallableResult<ResponseData = unknown> ***REMOVED***
    /**
