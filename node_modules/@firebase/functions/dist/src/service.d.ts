...
import ***REMOVED*** HttpsCallable, HttpsCallableOptions } from './public-types';
import ***REMOVED*** ContextProvider } from './context';
import ***REMOVED*** Provider } from '@firebase/component';
import ***REMOVED*** FirebaseAuthInternalName } from '@firebase/auth-interop-types';
import ***REMOVED*** MessagingInternalComponentName } from '@firebase/messaging-interop-types';
 ...
 * It makes functions that would otherwise take ***REMOVED***} able to access the
 * possible elements in the body more easily
 */
export interface HttpResponseBody ***REMOVED***
    data?: unknown;
    result?: unknown;
    error?: ***REMOVED***
        message?: unknown;
 ...
 * @internal
 */
export declare class FunctionsService implements _FirebaseService ***REMOVED***
