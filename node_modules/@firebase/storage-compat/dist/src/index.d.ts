 ...
 */
import ***REMOVED*** _FirebaseNamespace } from '@firebase/app-types/private';
...
import ***REMOVED*** type EmulatorMockTokenOptions, type FullMetadata, type FirebaseStorage, type ListOptions, type ListResult, type StorageReference, type SettableMetadata, type UploadMetadata, type UploadResult, type UploadTask, type StringFormat } from "@firebase/storage";
declare module "@firebase/storage" ***REMOVED***
    function connectStorageEmulator(storage: types.FirebaseStorage, host: string, port: number, options?: ***REMOVED***
