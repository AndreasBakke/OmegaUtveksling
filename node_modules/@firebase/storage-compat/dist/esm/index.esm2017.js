...
import ***REMOVED*** _getChild, uploadBytesResumable, _dataFromString, _UploadTask, _FbsBlob, StringFormat, listAll, list, getMetadata, updateMetadata, getDownloadURL, deleteObject, _invalidRootOperation, _invalidArgument, ref, _Location, connectStorageEmulator, _TaskState, _TaskEvent } from '@firebase/storage';
 ...
 */
class UploadTaskSnapshotCompat ***REMOVED***
    constructor(_delegate, task, ref) ***REMOVED***
        this._delegate = _delegate;
        this.task = task;
        this.ref = ref;
  ***REMOVED***
    get bytesTransferred() ***REMOVED***
 ...
 * limitations under the License.
 */
class UploadTaskCompat ***REMOVED***
    constructor(_delegate, _ref) ***REMOVED***
        this._delegate = _delegate;
        this._ref = _ref;
  ...
  ***REMOVED***
    then(onFulfilled, onRejected) ***REMOVED***
        return this._delegate.then(snapshot => ***REMOVED***
...
class ListResultCompat ***REMOVED***
    constructor(_delegate, _service) ***REMOVED***
        this._delegate = _delegate;
        this._service = _service;
  ***REMOVED***
    get prefixes() ***REMOVED***
 ...
 * limitations under the License.
 */
class ReferenceCompat ***REMOVED***
    constructor(_delegate, storage) ***REMOVED***
        this._delegate = _delegate;
  ...
  ***REMOVED***
     ...
     * observe the upload.
     */
    putString(value, format = StringFormat.RAW, metadata) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    updateMetadata(metadata) ***REMOVED***
 ...
 */
class StorageServiceCompat ***REMOVED***
  ...
  ***REMOVED***
    setMaxUploadRetryTime(time) ***REMOVED***
        this._delegate.maxUploadRetryTime = time;
  ***REMOVED***
    setMaxOperationRetryTime(time) ***REMOVED***
