 ...
 */
import ***REMOVED*** StorageReference, StringFormat } from '@firebase/storage';
import ***REMOVED*** StorageServiceCompat } from './service';
import * as types from '@firebase/storage-types';
import ***REMOVED*** Compat } from '@firebase/util';
export declare class ReferenceCompat implements types.Reference, Compat<StorageReference> ***REMOVED***
