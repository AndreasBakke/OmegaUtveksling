...
import ***REMOVED*** ComponentContainer } from '@firebase/component';
import ***REMOVED*** FirebaseError } from '@firebase/util';
import ***REMOVED*** LogCallback } from '@firebase/logger';
import ***REMOVED*** LogLevelString } from '@firebase/logger';
import ***REMOVED*** LogOptions } from '@firebase/logger';
import ***REMOVED*** Name } from '@firebase/component';
...
/**
 * A ***REMOVED***@link @firebase/app#FirebaseApp} holds the initialization information for a collection of
 * services.
 *
 * Do not call this constructor directly. Instead, use
 * ***REMOVED***@link (initializeApp:1) | initializeApp()} to create an app.
 *
 * @public
 */
export declare interface FirebaseApp ***REMOVED***
    /**
     ...
     * parameters given in ***REMOVED***@link (initializeApp:1) | initializeApp()}.
     *
     * @example
     * ```javascript
 ...
 * @internal
 */
export declare interface _FirebaseAppInternal extends FirebaseApp ***REMOVED***
 ...
 * @public
 *
 * Configuration options given to ***REMOVED***@link (initializeApp:1) | initializeApp()}
 */
export declare interface FirebaseAppSettings ***REMOVED***
    /**
 ...
 * ***REMOVED***@link https://firebase.google.com/docs/web/setup#config-object | Learn about the Firebase config object}.
 */
export declare interface FirebaseOptions ***REMOVED***
    /**
 ...
 * @internal
 */
export declare interface _FirebaseService ***REMOVED***
    app: FirebaseApp;
    /**
     * Delete the service and free it's resources - called from
     * ***REMOVED***@link @firebase/app#deleteApp | deleteApp()}
     */
...
/**
 * Creates and initializes a ***REMOVED***@link @firebase/app#FirebaseApp} instance.
 *
 * See
 * ***REMOVED***@link
 ...
 * const otherApp = initializeApp(***REMOVED***
