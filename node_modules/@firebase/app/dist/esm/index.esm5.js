import ***REMOVED*** Component, ComponentContainer } from '@firebase/component';
import ***REMOVED*** __values, __assign, __awaiter, __generator, __spreadArray, __read } from 'tslib';
import ***REMOVED*** Logger, setUserLogHandler, setLogLevel as setLogLevel$1 } from '@firebase/logger';
import ***REMOVED*** ErrorFactory, getDefaultAppConfig, deepEqual, FirebaseError, base64urlEncodeWithoutPadding, isIndexedDBAvailable, validateIndexedDBOpenable } from '@firebase/util';
export ***REMOVED*** FirebaseError } from '@firebase/util';
 ...
 */
var PlatformLoggerServiceImpl = /** @class */ (function () ***REMOVED***
    function PlatformLoggerServiceImpl(container) ***REMOVED***
        this.container = container;
  ***REMOVED***
    // In initial implementation, this will be called by installations on
    // auth token refresh, and installations will send this string.
    PlatformLoggerServiceImpl.prototype.getPlatformInfoString = function () ***REMOVED***
        var providers = this.container.getProviders();
        // Loop through providers and get library/version pairs from any that are
        // version components.
        return providers
            .map(function (provider) ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***)
            .filter(function (logString) ***REMOVED*** return logString; })
            .join(' ');
  ***REMOVED***;
...
var PLATFORM_LOG_STRING = (_a$1 = ***REMOVED***},
...
function _registerComponent(component) ***REMOVED***
  ...
  ***REMOVED***
    ...
    try ***REMOVED***
        ...
        for (var _b = __values(_apps.values()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
            var app = _c.value;
 ...
 * @internal
 */
function _removeServiceInstance(app, name, instanceIdentifier) ***REMOVED***
    if (instanceIdentifier === void 0) ***REMOVED*** instanceIdentifier = DEFAULT_ENTRY_NAME; }
...
var ERRORS = (_a = ***REMOVED***},
    _a["no-app" /* AppError.NO_APP */] = "No Firebase App '***REMOVED***$appName}' has been created - " +
        'call Firebase App.initializeApp()',
    _a["bad-app-name" /* AppError.BAD_APP_NAME */] = "Illegal App name: '***REMOVED***$appName}",
    _a["duplicate-app" /* AppError.DUPLICATE_APP */] = "Firebase App named '***REMOVED***$appName}' already exists with different options or config",
    _a["app-deleted" /* AppError.APP_DELETED */] = "Firebase App named '***REMOVED***$appName}' already deleted",
    _a["no-options" /* AppError.NO_OPTIONS */] = 'Need to provide options, when not being deployed to hosting via source.',
    _a["invalid-app-argument" /* AppError.INVALID_APP_ARGUMENT */] = 'firebase.***REMOVED***$appName}() takes either no argument or a ' +
        'Firebase App instance.',
    _a["invalid-log-argument" /* AppError.INVALID_LOG_ARGUMENT */] = 'First argument to `onLog` must be null or a function.',
    _a["idb-open" /* AppError.IDB_OPEN */] = 'Error thrown when opening IndexedDB. Original error: ***REMOVED***$originalErrorMessage}.',
    _a["idb-get" /* AppError.IDB_GET */] = 'Error thrown when reading from IndexedDB. Original error: ***REMOVED***$originalErrorMessage}.',
    _a["idb-set" /* AppError.IDB_WRITE */] = 'Error thrown when writing to IndexedDB. Original error: ***REMOVED***$originalErrorMessage}.',
    _a["idb-delete" /* AppError.IDB_DELETE */] = 'Error thrown when deleting from IndexedDB. Original error: ***REMOVED***$originalErrorMessage}.',
    _a);
...
var FirebaseAppImpl = /** @class */ (function () ***REMOVED***
    function FirebaseAppImpl(options, config, container) ***REMOVED***
        var _this = this;
        this._isDeleted = false;
        this._options = __assign(***REMOVED***}, options);
        this._config = __assign(***REMOVED***}, config);
        this._name = config.name;
        this._automaticDataCollectionEnabled =
            config.automaticDataCollectionEnabled;
        this._container = container;
        this.container.addComponent(new Component('app', function () ***REMOVED*** return _this; }, "PUBLIC" /* ComponentType.PUBLIC */));
  ***REMOVED***
  ...
  ***REMOVED***);
    Object.defineProperty(FirebaseAppImpl.prototype, "options", ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    Object.defineProperty(FirebaseAppImpl.prototype, "config", ***REMOVED***
        get: function () ***REMOVED***
            this.checkDestroyed();
            return this._config;
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    Object.defineProperty(FirebaseAppImpl.prototype, "container", ***REMOVED***
        get: function () ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    Object.defineProperty(FirebaseAppImpl.prototype, "isDeleted", ***REMOVED***
        get: function () ***REMOVED***
  ...
  ***REMOVED***);
     ...
     */
    FirebaseAppImpl.prototype.checkDestroyed = function () ***REMOVED***
...
function initializeApp(_options, rawConfig) ***REMOVED***
    var e_1, _a;
    if (rawConfig === void 0) ***REMOVED*** rawConfig = ***REMOVED***}; }
    var options = _options;
    if (typeof rawConfig !== 'object') ***REMOVED***
        var name_1 = rawConfig;
        rawConfig = ***REMOVED*** name: name_1 };
  ***REMOVED***
    var config = __assign(***REMOVED*** name: DEFAULT_ENTRY_NAME, automaticDataCollectionEnabled: false }, rawConfig);
  ...
  ***REMOVED***
    ...
    try ***REMOVED***
        for (var _b = __values(_components.values()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
 ...
 * @public
 */
function getApp(name) ***REMOVED***
    if (name === void 0) ***REMOVED*** name = DEFAULT_ENTRY_NAME; }
            ...
            switch (_a.label) ***REMOVED***
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(app.container
                            .getProviders()
                            .map(function (provider) ***REMOVED*** return provider.delete(); }))];
                case 1:
                    _a.sent();
                    app.isDeleted = true;
                    _a.label = 2;
  ...
  ***REMOVED***
    ...
    if (libraryMismatch || versionMismatch) ***REMOVED***
      ...
      ***REMOVED***
        ...
        return;
  ***REMOVED***
    _registerComponent(new Component("".concat(library, "-version"), function () ***REMOVED*** return (***REMOVED*** library: library, version: version }); }, "VERSION" /* ComponentType.VERSION */));
}
/**
...
function readHeartbeatsFromIndexedDB(app) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            switch (_a.label) ***REMOVED***
                ...
                case 2:
                  ...
                  ***REMOVED***
                        ...
                        idbGetError = ERROR_FACTORY.create("idb-get" /* AppError.IDB_GET */, ***REMOVED***
...
function writeHeartbeatsToIndexedDB(app, heartbeatObject) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 3:
                    e_2 = _a.sent();
                    if (e_2 instanceof FirebaseError) ***REMOVED***
                        logger.warn(e_2.message);
                  ***REMOVED***
                    else ***REMOVED***
                        idbGetError = ERROR_FACTORY.create("idb-set" /* AppError.IDB_WRITE */, ***REMOVED***
...
var HeartbeatServiceImpl = /** @class */ (function () ***REMOVED***
    function HeartbeatServiceImpl(container) ***REMOVED***
        var _this = this;
        this.container = container;
        /**
        ...
        this._heartbeatsCachePromise = this._storage.read().then(function (result) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    HeartbeatServiceImpl.prototype.triggerHeartbeat = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
                ...
                switch (_b.label) ***REMOVED***
                    ...
                    case 2:
                        ...
                        if (this._heartbeatsCache.lastSentHeartbeatDate === date ||
                            this._heartbeatsCache.heartbeats.some(function (singleDateHeartbeat) ***REMOVED*** return singleDateHeartbeat.date === date; })) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        else ***REMOVED***
                            // There is no entry for this date. Create one.
                            this._heartbeatsCache.heartbeats.push(***REMOVED*** date: date, agent: agent });
                      ***REMOVED***
                        // Remove entries older than 30 days.
                        this._heartbeatsCache.heartbeats = this._heartbeatsCache.heartbeats.filter(function (singleDateHeartbeat) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    HeartbeatServiceImpl.prototype.getHeartbeatsHeader = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
                ...
                switch (_b.label) ***REMOVED***
                    ...
                    case 2:
                      ...
                      ***REMOVED***
                        ...
                        headerString = base64urlEncodeWithoutPadding(JSON.stringify(***REMOVED*** version: 2, heartbeats: heartbeatsToSend }));
...
function extractHeartbeatsForHeader(heartbeatsCache, maxSize) ***REMOVED***
    var e_1, _a;
    if (maxSize === void 0) ***REMOVED*** maxSize = MAX_HEADER_BYTES; }
    // Heartbeats grouped by user agent in the standard format to be sent in
    // the header.
    var heartbeatsToSend = [];
    // Single date format heartbeats that are not sent.
    var unsentEntries = heartbeatsCache.slice();
    var _loop_1 = function (singleDateHeartbeat) ***REMOVED***
        // Look for an existing entry with the same user agent.
        var heartbeatEntry = heartbeatsToSend.find(function (hb) ***REMOVED*** return hb.agent === singleDateHeartbeat.agent; });
  ...
  ***REMOVED***;
    try ***REMOVED***
        for (var heartbeatsCache_1 = __values(heartbeatsCache), heartbeatsCache_1_1 = heartbeatsCache_1.next(); !heartbeatsCache_1_1.done; heartbeatsCache_1_1 = heartbeatsCache_1.next()) ***REMOVED***
...
var HeartbeatStorageImpl = /** @class */ (function () ***REMOVED***
    function HeartbeatStorageImpl(app) ***REMOVED***
        this.app = app;
        this._canUseIndexedDBPromise = this.runIndexedDBEnvironmentCheck();
  ***REMOVED***
    HeartbeatStorageImpl.prototype.runIndexedDBEnvironmentCheck = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
              ...
              ***REMOVED***
                    ...
                    return [2 /*return*/, validateIndexedDBOpenable()
                            ...
                            .catch(function () ***REMOVED*** return false; })];
              ***REMOVED***
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***;
     ...
     * Read all heartbeats.
     */
    HeartbeatStorageImpl.prototype.read = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, ***REMOVED*** heartbeats: [] }];
                    case 2: return [4 /*yield*/, readHeartbeatsFromIndexedDB(this.app)];
                    case 3:
                        idbHeartbeatObject = _a.sent();
                        return [2 /*return*/, idbHeartbeatObject || ***REMOVED*** heartbeats: [] }];
              ***REMOVED***
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***;
    // overwrite the storage with the provided heartbeats
    HeartbeatStorageImpl.prototype.overwrite = function (heartbeatsObject) ***REMOVED***
        var _a;
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, writeHeartbeatsToIndexedDB(this.app, ***REMOVED***
  ...
  ***REMOVED***;
    // add heartbeats
    HeartbeatStorageImpl.prototype.add = function (heartbeatsObject) ***REMOVED***
        var _a;
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var canUseIndexedDB, existingHeartbeatsObject;
            return __generator(this, function (_b) ***REMOVED***
...
function registerCoreComponents(variant) ***REMOVED***
    _registerComponent(new Component('platform-logger', function (container) ***REMOVED*** return new PlatformLoggerServiceImpl(container); }, "PRIVATE" /* ComponentType.PRIVATE */));
    _registerComponent(new Component('heartbeat', function (container) ***REMOVED*** return new HeartbeatServiceImpl(container); }, "PRIVATE" /* ComponentType.PRIVATE */));
...
export ***REMOVED*** SDK_VERSION, DEFAULT_ENTRY_NAME as _DEFAULT_ENTRY_NAME, _addComponent, _addOrOverwriteComponent, _apps, _clearComponents, _components, _getProvider, _registerComponent, _removeServiceInstance, deleteApp, getApp, getApps, initializeApp, onLog, registerVersion, setLogLevel };
