...
function _registerComponent(component) ***REMOVED***
  ...
  ***REMOVED***
    ...
    try ***REMOVED***
        ...
        for (var _b = tslib.__values(_apps.values()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
            var app = _c.value;
...
var FirebaseAppImpl = /** @class */ (function () ***REMOVED***
    function FirebaseAppImpl(options, config, container) ***REMOVED***
        ...
        this._options = tslib.__assign(***REMOVED***}, options);
        this._config = tslib.__assign(***REMOVED***}, config);
        this._name = config.name;
        this._automaticDataCollectionEnabled =
            config.automaticDataCollectionEnabled;
        this._container = container;
        this.container.addComponent(new component.Component('app', function () ***REMOVED*** return _this; }, "PUBLIC" /* ComponentType.PUBLIC */));
  ***REMOVED***
...
function initializeApp(_options, rawConfig) ***REMOVED***
  ...
  ***REMOVED***
    var config = tslib.__assign(***REMOVED*** name: DEFAULT_ENTRY_NAME, automaticDataCollectionEnabled: false }, rawConfig);
  ...
  ***REMOVED***
    ...
    if (existingApp) ***REMOVED***
        ...
        if (util.deepEqual(options, existingApp.options) &&
            util.deepEqual(config, existingApp.config)) ***REMOVED***
            return existingApp;
      ***REMOVED***
        else ***REMOVED***
  ...
  ***REMOVED***
    ...
    try ***REMOVED***
        for (var _b = tslib.__values(_components.values()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (libraryMismatch || versionMismatch) ***REMOVED***
      ...
      ***REMOVED***
        ...
        return;
  ***REMOVED***
    _registerComponent(new component.Component("".concat(library, "-version"), function () ***REMOVED*** return (***REMOVED*** library: library, version: version }); }, "VERSION" /* ComponentType.VERSION */));
}
/**
...
function getDbPromise() ***REMOVED***
    if (!dbPromise) ***REMOVED***
        dbPromise = idb.openDB(DB_NAME, DB_VERSION, ***REMOVED***
    ...
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 3:
                    e_2 = _a.sent();
                    if (e_2 instanceof util.FirebaseError) ***REMOVED***
                ...
                switch (_b.label) ***REMOVED***
                    ...
                    case 2:
                      ...
                      ***REMOVED***
                        ...
                        headerString = util.base64urlEncodeWithoutPadding(JSON.stringify(***REMOVED*** version: 2, heartbeats: heartbeatsToSend }));
...
function extractHeartbeatsForHeader(heartbeatsCache, maxSize) ***REMOVED***
  ...
  ***REMOVED***;
    try ***REMOVED***
        for (var heartbeatsCache_1 = tslib.__values(heartbeatsCache), heartbeatsCache_1_1 = heartbeatsCache_1.next(); !heartbeatsCache_1_1.done; heartbeatsCache_1_1 = heartbeatsCache_1.next()) ***REMOVED***
...
function registerCoreComponents(variant) ***REMOVED***
    _registerComponent(new component.Component('platform-logger', function (container) ***REMOVED*** return new PlatformLoggerServiceImpl(container); }, "PRIVATE" /* ComponentType.PRIVATE */));
    _registerComponent(new component.Component('heartbeat', function (container) ***REMOVED*** return new HeartbeatServiceImpl(container); }, "PRIVATE" /* ComponentType.PRIVATE */));
...
Object.defineProperty(exports, 'FirebaseError', ***REMOVED***
  enumerable: true,
  get: function () ***REMOVED*** return util.FirebaseError; }
});
