 ...
 */
export declare interface FirebaseApp extends _FirebaseApp ***REMOVED***
}

declare interface _FirebaseApp ***REMOVED***
    /**
...
declare interface FirebaseAppConfig ***REMOVED***
    name?: string;
    automaticDataCollectionEnabled?: boolean;
}

declare interface FirebaseAppContructor ***REMOVED***
    new (): FirebaseApp;
}

export declare interface FirebaseNamespace ***REMOVED***
    /**
...
export declare interface _FirebaseNamespace extends FirebaseNamespace ***REMOVED***
    INTERNAL: ***REMOVED***
        /**
...
declare interface FirebaseOptions ***REMOVED***
    apiKey?: string;
    authDomain?: string;
    databaseURL?: string;
    projectId?: string;
...
export declare interface _FirebaseService extends Compat<unknown> ***REMOVED***
    app: FirebaseApp;
    INTERNAL?: FirebaseServiceInternals;
}

declare interface FirebaseServiceInternals ***REMOVED***
    /**
 ...
 */
declare interface FirebaseServiceNamespace<T extends _FirebaseService> ***REMOVED***
    (app?: FirebaseApp): T;
}
