 ...
 */
import ***REMOVED*** FirebaseApp, FirebaseNamespace } from './public-types';
...
export interface _FirebaseService extends Compat<unknown> ***REMOVED***
    app: FirebaseApp;
 ...
 */
export interface FirebaseServiceNamespace<T extends _FirebaseService> ***REMOVED***
    (app?: FirebaseApp): T;
}
