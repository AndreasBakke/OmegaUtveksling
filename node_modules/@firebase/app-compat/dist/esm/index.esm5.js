import ***REMOVED*** ErrorFactory, contains, deepExtend, createSubscribe, isBrowser } from '@firebase/util';
import ***REMOVED*** __assign } from 'tslib';
import ***REMOVED*** Component } from '@firebase/component';
import * as modularAPIs from '@firebase/app';
import ***REMOVED*** deleteApp, _addComponent, _addOrOverwriteComponent, _DEFAULT_ENTRY_NAME, registerVersion } from '@firebase/app';
...
var FirebaseAppImpl = /** @class */ (function () ***REMOVED***
    function FirebaseAppImpl(_delegate, firebase) ***REMOVED***
        var _this = this;
        this._delegate = _delegate;
        this.firebase = firebase;
        // add itself to container
        _addComponent(_delegate, new Component('app-compat', function () ***REMOVED*** return _this; }, "PUBLIC" /* ComponentType.PUBLIC */));
  ...
  ***REMOVED***;
    ...
    FirebaseAppImpl.prototype._getService = function (name, instanceIdentifier) ***REMOVED***
        var _a;
        if (instanceIdentifier === void 0) ***REMOVED*** instanceIdentifier = _DEFAULT_ENTRY_NAME; }
        this._delegate.checkDestroyed();
        // Initialize instance if InstatiationMode is `EXPLICIT`.
        var provider = this._delegate.container.getProvider(name);
        if (!provider.isInitialized() &&
            ((_a = provider.getComponent()) === null || _a === void 0 ? void 0 : _a.instantiationMode) === "EXPLICIT" /* InstantiationMode.EXPLICIT */) ***REMOVED***
            provider.initialize();
      ***REMOVED***
        // getImmediate will always succeed because _getService is only called for registered components.
        return provider.getImmediate(***REMOVED***
...
function createFirebaseNamespaceCore(firebaseAppImpl) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    function initializeAppCompat(options, rawConfig) ***REMOVED***
  ...
  ***REMOVED***
    ...
    function getApps() ***REMOVED***
        ...
        return Object.keys(apps).map(function (name) ***REMOVED*** return apps[name]; });
  ***REMOVED***
    function registerComponentCompat(component) ***REMOVED***
        ...
        if (modularAPIs._registerComponent(component) &&
            ...
            var serviceNamespace = function (appArg) ***REMOVED***
                if (appArg === void 0) ***REMOVED*** appArg = app(); }
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
function createFirebaseNamespace() ***REMOVED***
    ...
    namespace.INTERNAL = __assign(__assign(***REMOVED***}, namespace.INTERNAL), ***REMOVED*** createFirebaseNamespace: createFirebaseNamespace, extendNamespace: extendNamespace, createSubscribe: createSubscribe, ErrorFactory: ErrorFactory, deepExtend: deepExtend });
    /**
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
if (isBrowser() && self.firebase !== undefined) ***REMOVED***
