import ***REMOVED*** _getProvider, getApp, _registerComponent, registerVersion, SDK_VERSION } from '@firebase/app';
 ...
 * @public
 */
class StorageError extends FirebaseError ***REMOVED***
    /**
...
function missingPolyFill(polyFill) ***REMOVED***
    return new StorageError("unsupported-environment" /* StorageErrorCode.UNSUPPORTED_ENVIRONMENT */, `$***REMOVED***polyFill} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`);
}
/**
 * @internal
 */
 ...
 */
class XhrConnection ***REMOVED***
    constructor() ***REMOVED***
        this.sent_ = false;
        this.xhr_ = new XMLHttpRequest();
        this.initXhr();
        this.errorCode_ = ErrorCode.NO_ERROR;
        this.sendPromise_ = new Promise(resolve => ***REMOVED***
            this.xhr_.addEventListener('abort', () => ***REMOVED***
                this.errorCode_ = ErrorCode.ABORT;
                resolve();
          ***REMOVED***);
            this.xhr_.addEventListener('error', () => ***REMOVED***
                this.errorCode_ = ErrorCode.NETWORK_ERROR;
                resolve();
          ***REMOVED***);
            this.xhr_.addEventListener('load', () => ***REMOVED***
                resolve();
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
    send(url, method, body, headers) ***REMOVED***
...
class XhrTextConnection extends XhrConnection ***REMOVED***
    initXhr() ***REMOVED***
...
class XhrBytesConnection extends XhrConnection ***REMOVED***
    initXhr() ***REMOVED***
...
class XhrBlobConnection extends XhrConnection ***REMOVED***
    initXhr() ***REMOVED***
 ...
 */
function getStorage(app = getApp(), bucketUrl) ***REMOVED***
