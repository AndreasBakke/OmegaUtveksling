 ...
 */
import ***REMOVED*** ErrorCode, Headers, Connection } from '../../src/implementation/connection';
...
export declare enum State ***REMOVED***
    START = 0,
    SENT = 1,
    DONE = 2
}
export declare class TestingConnection implements Connection<string> ***REMOVED***
    private state;
    private sendPromise;
    private resolve;
    private sendHook;
    ...
    simulateResponse(status: number, body: string, headers: ***REMOVED***
        [key: string]: string;
  ***REMOVED***): void;
