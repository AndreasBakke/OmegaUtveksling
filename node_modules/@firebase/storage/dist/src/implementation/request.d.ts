...
import ***REMOVED*** Connection, Headers, ConnectionType } from './connection';
export interface Request<T> ***REMOVED***
 ...
 */
export declare class RequestEndStatus<I extends ConnectionType> ***REMOVED***
