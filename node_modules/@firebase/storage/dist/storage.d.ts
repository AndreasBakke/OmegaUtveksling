...
import ***REMOVED*** Subscribe } from '@firebase/util';
 ...
 */
declare interface Connection<T extends ConnectionType> ***REMOVED***
    /**
 ...
 * @public
 */
export declare function connectStorageEmulator(storage: FirebaseStorage, host: string, port: number, options?: ***REMOVED***
 ...
 */
declare enum ErrorCode ***REMOVED***
    NO_ERROR = 0,
    NETWORK_ERROR = 1,
    ABORT = 2
}
 ...
 * @internal
 */
export declare class _FbsBlob ***REMOVED***
    private data_;
    private size_;
    private type_;
 ...
 * @public
 */
export declare interface FirebaseStorage extends _FirebaseService ***REMOVED***
    /**
     * The ***REMOVED***@link @firebase/app#FirebaseApp} associated with this `FirebaseStorage` instance.
     */
 ...
 * @internal
 */
export declare class _FirebaseStorageImpl implements FirebaseStorage ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface FullMetadata extends UploadMetadata ***REMOVED***
    /**
     ...
     * ***REMOVED***@link https://cloud.google.com/storage/docs/metadata#generation-number}
     */
    generation: string;
    /**
 ...
 */
declare const enum InternalTaskState ***REMOVED***
    RUNNING = "running",
    PAUSING = "pausing",
    PAUSED = "paused",
    SUCCESS = "success",
 ...
 * @public
 */
export declare interface ListOptions ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface ListResult ***REMOVED***
    /**
 ...
 * @internal
 */
export declare class _Location ***REMOVED***
 ...
 * The full set of object metadata, including read-only properties.
 */
declare interface Metadata extends FullMetadata ***REMOVED***
    [prop: string]: unknown;
}
...
/**
 * Returns a ***REMOVED***@link StorageReference} for the given url.
 * @param storage - ***REMOVED***@link FirebaseStorage} instance.
...
/**
 * Returns a ***REMOVED***@link StorageReference} for the given path in the
 * default bucket.
 * @param storageOrRef - ***REMOVED***@link FirebaseStorage} or ***REMOVED***@link StorageReference}.
 * @param pathOrUrlStorage - path. If empty, returns root reference (if ***REMOVED***@link FirebaseStorage}
 * instance provided) or returns same reference (if ***REMOVED***@link StorageReference} provided).
 * @public
 */
 ...
 */
export declare class _Reference ***REMOVED***
    private _service;
    _location: _Location;
...
declare interface Request_2<T> ***REMOVED***
 ...
 * @param O - the output response type used by the rest of the SDK.
 */
declare class RequestInfo_2<I extends ConnectionType, O> ***REMOVED***
    url: string;
    method: string;
    /**
 ...
 * @public
 */
export declare interface SettableMetadata ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface StorageError extends FirebaseError ***REMOVED***
    /**
 ...
 * @public
 */
declare class StorageError_2 extends FirebaseError ***REMOVED***
    private status_;
 ...
 */
declare const enum StorageErrorCode ***REMOVED***
    UNKNOWN = "unknown",
 ...
 * @public
 */
export declare interface StorageObserver<T> ***REMOVED***
    next?: NextFn<T> | null;
 ...
 */
declare interface StorageObserver_2<T> ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface StorageReference ***REMOVED***
    /**
    ...
    name: string;
    /**
     * The ***REMOVED***@link FirebaseStorage} instance associated with this reference.
     */
...
declare class StringData ***REMOVED***
    data: Uint8Array;
 ...
 * @public
 */
export declare const StringFormat: ***REMOVED***
    /**
 ...
 * @internal
 */
export declare const _TaskEvent: ***REMOVED***
    /**
     * For this event,
     * <ul>
 ...
 * @internal
 */
export declare const _TaskState: ***REMOVED***
 ...
 * @public
 */
export declare interface UploadMetadata extends SettableMetadata ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface UploadResult ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface UploadTask ***REMOVED***
    /**
 ...
 * @internal
 */
export declare class _UploadTask ***REMOVED***
    private _ref;
    /**
 ...
 * @public
 */
export declare interface UploadTaskSnapshot ***REMOVED***
    /**
 ...
 */
declare interface UrlParams ***REMOVED***
