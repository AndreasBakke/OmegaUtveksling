...
import ***REMOVED*** Connection, ConnectionType, ErrorCode, Headers } from '../../implementation/connection';
/**
 * Network layer for browsers. We use this instead of goog.net.XhrIo because
 * goog.net.XhrIo is hyuuuuge and doesn't work in React Native on Android.
 */
declare abstract class XhrConnection<T extends ConnectionType> implements Connection<T> ***REMOVED***
...
export declare class XhrTextConnection extends XhrConnection<string> ***REMOVED***
    initXhr(): void;
}
export declare function newTextConnection(): Connection<string>;
export declare class XhrBytesConnection extends XhrConnection<ArrayBuffer> ***REMOVED***
    private data_?;
    initXhr(): void;
}
export declare function newBytesConnection(): Connection<ArrayBuffer>;
export declare class XhrBlobConnection extends XhrConnection<Blob> ***REMOVED***
    initXhr(): void;
}
