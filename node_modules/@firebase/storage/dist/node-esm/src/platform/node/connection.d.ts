...
import ***REMOVED*** Connection, ConnectionType, ErrorCode } from '../../implementation/connection';
import nodeFetch, ***REMOVED*** Headers } from 'node-fetch';
/**
 ...
 */
declare abstract class FetchConnection<T extends ConnectionType> implements Connection<T> ***REMOVED***
...
export declare class FetchTextConnection extends FetchConnection<string> ***REMOVED***
    getResponse(): string;
}
export declare function newTextConnection(): Connection<string>;
export declare class FetchBytesConnection extends FetchConnection<ArrayBuffer> ***REMOVED***
    getResponse(): ArrayBuffer;
}
export declare function newBytesConnection(): Connection<ArrayBuffer>;
export declare class FetchStreamConnection extends FetchConnection<NodeJS.ReadableStream> ***REMOVED***
    private stream_;
    send(url: string, method: string, body?: ArrayBufferView | Blob | string, headers?: Record<string, string>): Promise<void>;
