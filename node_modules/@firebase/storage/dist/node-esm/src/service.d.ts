 ...
 */
import ***REMOVED*** Location } from './implementation/location';
import ***REMOVED*** Request } from './implementation/request';
import ***REMOVED*** RequestInfo } from './implementation/requestinfo';
...
import ***REMOVED*** FirebaseStorage } from './public-types';
import ***REMOVED*** EmulatorMockTokenOptions } from '@firebase/util';
import ***REMOVED*** Connection, ConnectionType } from './implementation/connection';
...
export declare function connectStorageEmulator(storage: FirebaseStorageImpl, host: string, port: number, options?: ***REMOVED***
 ...
 * @internal
 */
export declare class FirebaseStorageImpl implements FirebaseStorage ***REMOVED***
    /**
