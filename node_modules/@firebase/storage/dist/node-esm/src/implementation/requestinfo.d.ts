...
import ***REMOVED*** Headers, Connection, ConnectionType } from './connection';
/**
 * Type for url params stored in RequestInfo.
 */
export interface UrlParams ***REMOVED***
 ...
 * @param O - the output response type used by the rest of the SDK.
 */
export declare class RequestInfo<I extends ConnectionType, O> ***REMOVED***
    url: string;
    method: string;
    /**
