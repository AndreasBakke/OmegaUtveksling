 ...
 */
import ***REMOVED*** ControlParams, EventParams, CustomParams, ConsentSettings } from './public-types';
/**
 ...
 */
export interface DynamicConfig ***REMOVED***
    projectId: string;
    appId: string;
    databaseURL: string;
...
export interface MinimalDynamicConfig ***REMOVED***
    appId: string;
    measurementId: string;
}
/**
