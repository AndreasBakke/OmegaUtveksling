 ...
 */
export declare function wrapOrCreateGtag(initializationPromisesMap: ***REMOVED***
    [appId: string]: Promise<string>;
}, dynamicConfigPromisesList: Array<Promise<DynamicConfig | MinimalDynamicConfig>>, measurementIdToAppId: ***REMOVED***
    [measurementId: string]: string;
}, dataLayerName: string, gtagFunctionName: string): ***REMOVED***
    gtagCore: Gtag;
    wrappedGtag: Gtag;
};
/**
