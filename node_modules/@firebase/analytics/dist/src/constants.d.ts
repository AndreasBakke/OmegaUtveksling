...
export declare const DYNAMIC_CONFIG_URL = "https://firebase.googleapis.com/v1alpha/projects/-/apps/***REMOVED***app-id}/webConfig";
export declare const GTAG_URL = "https://www.googletagmanager.com/gtag/js";
export declare const enum GtagCommand ***REMOVED***
    EVENT = "event",
    SET = "set",
    CONFIG = "config",
    CONSENT = "consent"
