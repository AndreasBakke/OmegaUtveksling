...
var DYNAMIC_CONFIG_URL = 'https://firebase.googleapis.com/v1alpha/projects/-/apps/***REMOVED***app-id}/webConfig';
...
function promiseAllSettled(promises) ***REMOVED***
    return Promise.all(promises.map(function (promise) ***REMOVED*** return promise.catch(function (e) ***REMOVED*** return e; }); }));
}
/**
 ...
 */
function gtagOnConfig(gtagCore, initializationPromisesMap, dynamicConfigPromisesList, measurementIdToAppId, measurementId, gtagParams) ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 4:
                    ...
                    foundConfig = dynamicConfigResults.find(function (config) ***REMOVED*** return config.measurementId === measurementId; });
 ...
 */
function gtagOnEvent(gtagCore, initializationPromisesMap, dynamicConfigPromisesList, measurementId, gtagParams) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                    dynamicConfigResults = _a.sent();
                    _loop_1 = function (sendToId) ***REMOVED***
                        // Any fetched dynamic measurement ID that matches this 'send_to' ID
                        var foundConfig = dynamicConfigResults.find(function (config) ***REMOVED*** return config.measurementId === sendToId; });
                      ...
                      ***REMOVED***
                  ***REMOVED***;
                    for (_i = 0, gaSendToList_1 = gaSendToList; _i < gaSendToList_1.length; _i++) ***REMOVED***
...
measurementIdToAppId) ***REMOVED***
     ...
     */
    function gtagWrapper(command, idOrNameOrParams, gtagParams) ***REMOVED***
        return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
            var e_3;
            return tslib.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 5];
                    case 4:
                        if (command === "consent" /* GtagCommand.CONSENT */) ***REMOVED***
                            // If CONFIG, second arg must be measurementId.
...
function findGtagScriptOnPage(dataLayerName) ***REMOVED***
    ...
    for (var _i = 0, _a = Object.values(scriptTags); _i < _a.length; _i++) ***REMOVED***
        var tag = _a[_i];
        if (tag.src &&
...
var ERRORS = (_a = ***REMOVED***},
    _a["already-exists" /* AnalyticsError.ALREADY_EXISTS */] = 'A Firebase Analytics instance with the appId ***REMOVED***$id} ' +
        ' already exists. ' +
    ...
    _a["interop-component-reg-failed" /* AnalyticsError.INTEROP_COMPONENT_REG_FAILED */] = 'Firebase Analytics Interop Component failed to instantiate: ***REMOVED***$reason}',
    ...
    _a["config-fetch-failed" /* AnalyticsError.CONFIG_FETCH_FAILED */] = 'Dynamic config fetch failed: [***REMOVED***$httpStatus}] ***REMOVED***$responseMessage}',
 ...
 */
var RetryData = /** @class */ (function () ***REMOVED***
    function RetryData(throttleMetadata, intervalMillis) ***REMOVED***
        if (throttleMetadata === void 0) ***REMOVED*** throttleMetadata = ***REMOVED***}; }
        if (intervalMillis === void 0) ***REMOVED*** intervalMillis = BASE_INTERVAL_MILLIS; }
        this.throttleMetadata = throttleMetadata;
        this.intervalMillis = intervalMillis;
  ***REMOVED***
    RetryData.prototype.getThrottleMetadata = function (appId) ***REMOVED***
        return this.throttleMetadata[appId];
  ***REMOVED***;
    RetryData.prototype.setThrottleMetadata = function (appId, metadata) ***REMOVED***
        this.throttleMetadata[appId] = metadata;
  ***REMOVED***;
    RetryData.prototype.deleteThrottleMetadata = function (appId) ***REMOVED***
 ...
 */
function fetchDynamicConfig(appFields) ***REMOVED***
    var _a;
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                  ...
                  ***REMOVED***;
                    appUrl = DYNAMIC_CONFIG_URL.replace('***REMOVED***app-id}', appId);
                ...
                case 4:
                    _b.sent();
                    return [3 /*break*/, 5];
                case 5: throw ERROR_FACTORY.create("config-fetch-failed" /* AnalyticsError.CONFIG_FETCH_FAILED */, ***REMOVED***
...
retryData, timeoutMillis) ***REMOVED***
    if (retryData === void 0) ***REMOVED*** retryData = defaultRetryData; }
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) ***REMOVED***
          ...
          ***REMOVED***
            throttleMetadata = retryData.getThrottleMetadata(appId) || ***REMOVED***
                backoffCount: 0,
          ...
          ***REMOVED***); }, timeoutMillis !== undefined ? timeoutMillis : FETCH_TIMEOUT_MILLIS);
            return [2 /*return*/, attemptFetchDynamicConfigWithRetry(***REMOVED*** appId: appId, apiKey: apiKey, measurementId: measurementId }, throttleMetadata, signal, retryData)];
      ***REMOVED***);
  ***REMOVED***);
}
/**
            ...
            switch (_c.label) ***REMOVED***
                ...
                case 3:
                    ...
                    if (measurementId) ***REMOVED***
                        ...
                        return [2 /*return*/, ***REMOVED*** appId: appId, measurementId: measurementId }];
                  ***REMOVED***
                    throw e_1;
                case 4:
                    _c.trys.push([4, 6, , 7]);
 ...
 */
var AnalyticsAbortSignal = /** @class */ (function () ***REMOVED***
    function AnalyticsAbortSignal() ***REMOVED***
        this.listeners = [];
  ***REMOVED***
    AnalyticsAbortSignal.prototype.addEventListener = function (listener) ***REMOVED***
        this.listeners.push(listener);
  ***REMOVED***;
    AnalyticsAbortSignal.prototype.abort = function () ***REMOVED***
 ...
 */
function logEvent$1(gtagFunction, initializationPromise, eventName, eventParams, options) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 2:
                    ...
                    params = tslib.__assign(tslib.__assign(***REMOVED***}, eventParams), ***REMOVED*** 'send_to': measurementId });
 ...
 */
function setCurrentScreen$1(gtagFunction, initializationPromise, screenName, options) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var measurementId;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 */
function setUserId$1(gtagFunction, initializationPromise, id, options) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var measurementId;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 */
function setUserProperties$1(gtagFunction, initializationPromise, properties, options) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                    if (!(options && options.global)) return [3 /*break*/, 1];
                    flatProperties = ***REMOVED***};
                    for (_i = 0, _a = Object.keys(properties); _i < _a.length; _i++) ***REMOVED***
                        key = _a[_i];
 ...
 */
function setAnalyticsCollectionEnabled$1(initializationPromise, enabled) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var measurementId;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 * limitations under the License.
 */
function validateIndexedDB() ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var e_1;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 */
function _initializeAnalytics(app, dynamicConfigPromisesList, measurementIdToAppId, installations, gtagCore, dataLayerName, options) ***REMOVED***
    var _a;
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            switch (_c.label) ***REMOVED***
                case 0:
                    ...
                    dynamicConfigPromise
                      ...
                      ***REMOVED***
                  ***REMOVED***)
                        .catch(function (e) ***REMOVED*** return logger.error(e); });
                    // Add to list to track state of all dynamic config promises.
                    dynamicConfigPromisesList.push(dynamicConfigPromise);
                    fidPromise = validateIndexedDB().then(function (envIsValid) ***REMOVED***
                ...
                case 1:
                  ...
                  ***REMOVED***
                    ...
                    configProperties = (_a = options === null || options === void 0 ? void 0 : options.config) !== null && _a !== void 0 ? _a : ***REMOVED***};
 ...
 */
var AnalyticsService = /** @class */ (function () ***REMOVED***
    function AnalyticsService(app) ***REMOVED***
        this.app = app;
  ***REMOVED***
    AnalyticsService.prototype._delete = function () ***REMOVED***
 ...
 */
var initializationPromisesMap = ***REMOVED***};
/**
 ...
 */
var measurementIdToAppId = ***REMOVED***};
/**
...
function warnOnBrowserContextMismatch() ***REMOVED***
    ...
    if (util.isBrowserExtension()) ***REMOVED***
        mismatchedEnvMessages.push('This is a browser extension environment.');
  ***REMOVED***
    if (!util.areCookiesEnabled()) ***REMOVED***
        mismatchedEnvMessages.push('Cookies are not available.');
  ***REMOVED***
    if (mismatchedEnvMessages.length > 0) ***REMOVED***
        var details = mismatchedEnvMessages
            .map(function (message, index) ***REMOVED*** return "(".concat(index + 1, ") ").concat(message); })
            .join(' ');
        var err = ERROR_FACTORY.create("invalid-analytics-context" /* AnalyticsError.INVALID_ANALYTICS_CONTEXT */, ***REMOVED***
            errorInfo: details
      ***REMOVED***);
 ...
 */
function getAnalytics(app$1) ***REMOVED***
 ...
 * @param app - The ***REMOVED***@link @firebase/app#FirebaseApp} to use.
 */
function initializeAnalytics(app$1, options) ***REMOVED***
    if (options === void 0) ***REMOVED*** options = ***REMOVED***}; }
    // Dependencies
    var analyticsProvider = app._getProvider(app$1, ANALYTICS_TYPE);
    if (analyticsProvider.isInitialized()) ***REMOVED***
        var existingInstance = analyticsProvider.getImmediate();
        if (util.deepEqual(options, analyticsProvider.getOptions())) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    var analyticsInstance = analyticsProvider.initialize(***REMOVED*** options: options });
    return analyticsInstance;
}
/**
...
function setCurrentScreen(analyticsInstance, screenName, options) ***REMOVED***
    ...
    setCurrentScreen$1(wrappedGtagFunction, initializationPromisesMap[analyticsInstance.app.options.appId], screenName, options).catch(function (e) ***REMOVED*** return logger.error(e); });
}
/**
...
function setUserId(analyticsInstance, id, options) ***REMOVED***
    analyticsInstance = util.getModularInstance(analyticsInstance);
    setUserId$1(wrappedGtagFunction, initializationPromisesMap[analyticsInstance.app.options.appId], id, options).catch(function (e) ***REMOVED*** return logger.error(e); });
}
/**
...
function setUserProperties(analyticsInstance, properties, options) ***REMOVED***
    analyticsInstance = util.getModularInstance(analyticsInstance);
    setUserProperties$1(wrappedGtagFunction, initializationPromisesMap[analyticsInstance.app.options.appId], properties, options).catch(function (e) ***REMOVED*** return logger.error(e); });
}
/**
...
function setAnalyticsCollectionEnabled(analyticsInstance, enabled) ***REMOVED***
    analyticsInstance = util.getModularInstance(analyticsInstance);
    setAnalyticsCollectionEnabled$1(initializationPromisesMap[analyticsInstance.app.options.appId], enabled).catch(function (e) ***REMOVED*** return logger.error(e); });
}
/**
...
function logEvent(analyticsInstance, eventName, eventParams, options) ***REMOVED***
    analyticsInstance = util.getModularInstance(analyticsInstance);
    logEvent$1(wrappedGtagFunction, initializationPromisesMap[analyticsInstance.app.options.appId], eventName, eventParams, options).catch(function (e) ***REMOVED*** return logger.error(e); });
}
/**
...
function registerAnalytics() ***REMOVED***
    app._registerComponent(new component.Component(ANALYTICS_TYPE, function (container, _a) ***REMOVED***
  ...
  ***REMOVED***, "PUBLIC" /* ComponentType.PUBLIC */));
    ...
    function internalFactory(container) ***REMOVED***
        try ***REMOVED***
            ...
            return ***REMOVED***
                logEvent: function (eventName, eventParams, options) ***REMOVED*** return logEvent(analytics_1, eventName, eventParams, options); }
          ***REMOVED***;
      ***REMOVED***
        catch (e) ***REMOVED***
