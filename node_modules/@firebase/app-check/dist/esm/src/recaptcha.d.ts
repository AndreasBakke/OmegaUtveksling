...
export interface GreCAPTCHATopLevel extends GreCAPTCHA ***REMOVED***
    enterprise: GreCAPTCHA;
}
export interface GreCAPTCHA ***REMOVED***
    ready: (callback: () => void) => void;
    execute: (siteKey: string, options: ***REMOVED***
        action: string;
  ***REMOVED***) => Promise<string>;
    render: (container: string | HTMLElement, parameters: GreCAPTCHARenderOption) => string;
}
export interface GreCAPTCHARenderOption ***REMOVED***
    sitekey: string;
    size: 'invisible';
}
