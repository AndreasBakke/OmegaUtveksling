...
import ***REMOVED*** AppCheckProvider, AppCheckTokenInternal, AppCheckTokenObserver } from './types';
import ***REMOVED*** Refresher } from './proactive-refresh';
import ***REMOVED*** Deferred } from '@firebase/util';
import ***REMOVED*** GreCAPTCHA } from './recaptcha';
export interface AppCheckState ***REMOVED***
    activated: boolean;
...
export interface ReCAPTCHAState ***REMOVED***
    initialized: Deferred<GreCAPTCHA>;
    widgetId?: string;
}
export interface DebugState ***REMOVED***
    initialized: boolean;
    enabled: boolean;
