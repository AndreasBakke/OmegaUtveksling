...
import ***REMOVED*** AppCheckTokenResult, AppCheckTokenInternal, ListenerType } from './types';
import ***REMOVED*** AppCheckTokenListener } from './public-types';
import ***REMOVED*** AppCheckService } from './factory';
export declare const defaultTokenErrorData: ***REMOVED***
    error: string;
};
/**
