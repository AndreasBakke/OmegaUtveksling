 ...
 */
import ***REMOVED*** AppCheck } from './public-types';
import ***REMOVED*** FirebaseApp, _FirebaseService } from '@firebase/app';
import ***REMOVED*** FirebaseAppCheckInternal } from './types';
import ***REMOVED*** Provider } from '@firebase/component';
/**
 * AppCheck Service class.
 */
export declare class AppCheckService implements AppCheck, _FirebaseService ***REMOVED***
    app: FirebaseApp;
