...
import ***REMOVED*** Observer, Subscribe } from '@firebase/util';
import ***REMOVED*** FirebaseError, ErrorFactory } from '@firebase/util';
import ***REMOVED*** Component, ComponentContainer, Name } from '@firebase/component';
...
export interface FirebaseServiceFactory ***REMOVED***
  (
    app: FirebaseApp,
    extendApp?: (props: ***REMOVED*** [prop: string]: any }) => void,
    instanceString?: string
  ): FirebaseService;
}

export interface PlatformLoggerService ***REMOVED***
...
export interface FirebaseAppInternals ***REMOVED***
  ...
  analytics: ***REMOVED***
    logEvent: (
      ...
      options?: ***REMOVED*** global: boolean }
    ) => void;
***REMOVED***;
}
...
export interface _FirebaseNamespace extends FirebaseNamespace ***REMOVED***
  INTERNAL: ***REMOVED***
     ...
     *   namespace.
     */
    extendNamespace(props: ***REMOVED*** [prop: string]: any }): void;
