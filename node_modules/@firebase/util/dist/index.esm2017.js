 ...
 */
const assert = function (assertion, message) ***REMOVED***
 ...
 */
const assertionError = function (message) ***REMOVED***
 ...
 * @public
 */
const getDefaultEmulatorHost = (productName) => ***REMOVED*** var _a, _b; return (_b = (_a = getDefaults()) === null || _a === void 0 ? void 0 : _a.emulatorHosts) === null || _b === void 0 ? void 0 : _b[productName]; };
/**
 ...
 * @public
 */
const getDefaultEmulatorHostnameAndPort = (productName) => ***REMOVED***
 ...
 * @public
 */
const getExperimentalSetting = (name) => ***REMOVED*** var _a; return (_a = getDefaults()) === null || _a === void 0 ? void 0 : _a[`_$***REMOVED***name}`]; };
 ...
 * limitations under the License.
 */
function createMockUserToken(token, projectId) ***REMOVED***
  ...
  ***REMOVED***
    const payload = Object.assign(***REMOVED*** 
        // Set all required fields to decent defaults
        iss: `https://securetoken.google.com/$***REMOVED***project}`, aud: project, iat, exp: iat + 3600, auth_time: iat, sub, user_id: sub, firebase: ***REMOVED***
...
function isNode() ***REMOVED***
    ...
    if (forceEnvironment === 'node') ***REMOVED***
        return true;
  ***REMOVED***
    else if (forceEnvironment === 'browser') ***REMOVED***
        return false;
  ***REMOVED***
    try ***REMOVED***
 ...
 */
const decode = function (token) ***REMOVED***
    let header = ***REMOVED***}, claims = ***REMOVED***}, data = ***REMOVED***}, signature = '';
    try ***REMOVED***
 ...
 * - Doesn't check if the token is actually valid.
 */
const isValidTimestamp = function (token) ***REMOVED***
 ...
 * - Doesn't check if the token is actually valid.
 */
const issuedAtTime = function (token) ***REMOVED***
    const claims = decode(token).claims;
 ...
 * - Doesn't check if the token is actually valid.
 */
const isValidFormat = function (token) ***REMOVED***
 ...
 * - Doesn't check if the token is actually valid.
 */
const isAdmin = function (token) ***REMOVED***
    const claims = decode(token).claims;
 ...
 * @internal
 */
function promiseWithTimeout(promise, timeInMS = 2000) ***REMOVED***
 ...
 * function.
 */
class ObserverProxy ***REMOVED***
    /**
     * @param executor Function which can make calls to a single Observer
     *     as a proxy.
     * @param onNoObservers Callback when count of Observers goes to zero.
     */
    constructor(executor, onNoObservers) ***REMOVED***
        this.observers = [];
        this.unsubscribes = [];
  ...
  ***REMOVED***
    next(value) ***REMOVED***
        this.forEachObserver((observer) => ***REMOVED***
            observer.next(value);
      ***REMOVED***);
  ***REMOVED***
    error(error) ***REMOVED***
  ...
  ***REMOVED***
     ...
     *   call to subscribe().
     */
    subscribe(nextOrObserver, error, complete) ***REMOVED***
        let observer;
 ...
 */
const validateArgCount = function (fnName, minCount, maxCount, argCount) ***REMOVED***
    let argError;
 ...
 */
const stringLength = function (str) ***REMOVED***
    let p = 0;
    for (let i = 0; i < str.length; i++) ***REMOVED***
 ...
 * @public
 */
const uuidv4 = function () ***REMOVED***
    return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, c => ***REMOVED***
 ...
 */
function calculateBackoffMillis(backoffCount, intervalMillis = DEFAULT_INTERVAL_MILLIS, backoffFactor = DEFAULT_BACKOFF_FACTOR) ***REMOVED***
