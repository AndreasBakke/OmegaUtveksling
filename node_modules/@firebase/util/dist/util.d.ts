 ...
 */
declare interface Base64 ***REMOVED***
    byteToCharMap_: ***REMOVED***
        [key: number]: string;
  ***REMOVED*** | null;
    charToByteMap_: ***REMOVED***
        [key: string]: number;
  ***REMOVED*** | null;
    byteToCharMapWebSafe_: ***REMOVED***
        [key: number]: string;
  ***REMOVED*** | null;
    charToByteMapWebSafe_: ***REMOVED***
        [key: string]: number;
  ***REMOVED*** | null;
 ...
 * limitations under the License.
 */
declare interface Claims ***REMOVED***
    [key: string]: ***REMOVED***};
}
 ...
 * limitations under the License.
 */
export declare interface Compat<T> ***REMOVED***
    _delegate: T;
}
...
declare interface DecodedToken ***REMOVED***
    header: object;
    claims: Claims;
    data: object;
    signature: string;
...
export declare type EmulatorMockTokenOptions = (***REMOVED***
    user_id: string;
} | ***REMOVED***
    sub: string;
}) & Partial<FirebaseIdToken>;

export declare interface ErrorData ***REMOVED***
    [key: string]: unknown;
}

export declare class ErrorFactory<ErrorCode extends string, ErrorParams extends ***REMOVED***
 ...
 * ***REMOVED***
 */
export declare type ErrorMap<ErrorCode extends string> = ***REMOVED***
 ...
 * @public
 */
export declare interface FirebaseDefaults ***REMOVED***
...
export declare class FirebaseError extends Error ***REMOVED***
...
declare interface FirebaseIdToken ***REMOVED***
    iss: string;
    aud: string;
    sub: string;
    iat: number;
 ...
 * @public
 */
export declare const getExperimentalSetting: <T extends ExperimentalKey>(name: T) => FirebaseDefaults[`_$***REMOVED***T}`];
...
export declare function isEmpty(obj: object): obj is ***REMOVED***};
...
export declare function map<K extends string, V, U>(obj: ***REMOVED***
    [key in K]: V;
}, fn: (value: V, key: K, obj: ***REMOVED***
    [key in K]: V;
}) => U, contextObj?: unknown): ***REMOVED***
    [key in K]: U;
};
...
export declare interface Observable<T> ***REMOVED***
    subscribe: Subscribe<T>;
}

export declare interface Observer<T> ***REMOVED***
    next: NextFn<T>;
    error: ErrorFn;
    complete: CompleteFn;
}
 ...
 */
export declare function querystring(querystringParams: ***REMOVED***
 ...
 * @struct
 */
export declare class Sha1 ***REMOVED***
    /**
...
export declare interface StringLike ***REMOVED***
    toString(): string;
}
 ...
 */
export declare interface Subscribe<T> ***REMOVED***
