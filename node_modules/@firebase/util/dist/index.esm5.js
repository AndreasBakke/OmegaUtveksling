import ***REMOVED*** __assign, __extends } from 'tslib';
 ...
 */
var base64urlEncodeWithoutPadding = function (str) ***REMOVED***
 ...
 * limitations under the License.
 */
var getDefaultsFromGlobal = function () ***REMOVED***
 ...
 */
var getDefaultsFromEnvVariable = function () ***REMOVED***
...
var getDefaultsFromCookie = function () ***REMOVED***
 ...
 * @public
 */
var getDefaults = function () ***REMOVED***
    try ***REMOVED***
 ...
 * @public
 */
var getDefaultEmulatorHost = function (productName) ***REMOVED*** var _a, _b; return (_b = (_a = getDefaults()) === null || _a === void 0 ? void 0 : _a.emulatorHosts) === null || _b === void 0 ? void 0 : _b[productName]; };
/**
 ...
 * @public
 */
var getDefaultEmulatorHostnameAndPort = function (productName) ***REMOVED***
 ...
 * @public
 */
var getDefaultAppConfig = function () ***REMOVED*** var _a; return (_a = getDefaults()) === null || _a === void 0 ? void 0 : _a.config; };
/**
 * Returns an experimental setting on the __FIREBASE_DEFAULTS__ object (properties
 * prefixed by "_")
 * @public
 */
var getExperimentalSetting = function (name) ***REMOVED*** var _a; return (_a = getDefaults()) === null || _a === void 0 ? void 0 : _a["_".concat(name)]; };
...
function createMockUserToken(token, projectId) ***REMOVED***
  ...
  ***REMOVED***
    var payload = __assign(***REMOVED*** 
        // Set all required fields to decent defaults
        iss: "https://securetoken.google.com/".concat(project), aud: project, iat: iat, exp: iat + 3600, auth_time: iat, sub: sub, user_id: sub, firebase: ***REMOVED***
...
var FirebaseError = /** @class */ (function (_super) ***REMOVED***
...
function deepEqual(a, b) ***REMOVED***
  ...
  ***REMOVED***
    ...
    for (var _i = 0, aKeys_1 = aKeys; _i < aKeys_1.length; _i++) ***REMOVED***
        var k = aKeys_1[_i];
      ...
      ***REMOVED***
  ***REMOVED***
    for (var _a = 0, bKeys_1 = bKeys; _a < bKeys_1.length; _a++) ***REMOVED***
        var k = bKeys_1[_a];
 ...
 * @internal
 */
function promiseWithTimeout(promise, timeInMS) ***REMOVED***
    if (timeInMS === void 0) ***REMOVED*** timeInMS = 2000; }
    var deferredPromise = new Deferred();
    setTimeout(function () ***REMOVED*** return deferredPromise.reject('timeout!'); }, timeInMS);
 ...
 * @struct
 */
var Sha1 = /** @class */ (function () ***REMOVED***
 ...
 * @public
 */
var uuidv4 = function () ***REMOVED***
    return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) ***REMOVED***
...
function calculateBackoffMillis(backoffCount, intervalMillis, backoffFactor) ***REMOVED***
    if (intervalMillis === void 0) ***REMOVED*** intervalMillis = DEFAULT_INTERVAL_MILLIS; }
    if (backoffFactor === void 0) ***REMOVED*** backoffFactor = DEFAULT_BACKOFF_FACTOR; }
