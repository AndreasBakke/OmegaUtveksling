...
export interface FirebaseAnalytics ***REMOVED***
  app: FirebaseApp;
  ...
  ***REMOVED***,
   ...
   */
  setUserProperties(
    properties: ***REMOVED*** [key: string]: any },
    options?: AnalyticsCallOptions
  ): void;
 ...
 */
interface DynamicConfig ***REMOVED***
  projectId: string;
  appId: string;
  databaseURL: string;
...
interface MinimalDynamicConfig ***REMOVED***
  appId: string;
  measurementId: string;
}
