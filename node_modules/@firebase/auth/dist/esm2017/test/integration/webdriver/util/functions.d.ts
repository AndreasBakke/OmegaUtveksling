...
export declare enum PopupFunction ***REMOVED***
...
export declare enum PersistenceFunction ***REMOVED***
...
export declare enum MiddlewareFunction ***REMOVED***
...
export declare enum UiFunction ***REMOVED***
    LOAD = "ui.loadUiCode",
    START = "ui.startUi"
}
