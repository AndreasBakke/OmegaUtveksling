import ***REMOVED*** __awaiter, __generator, __spreadArray, __assign, __rest, __extends } from 'tslib';
import ***REMOVED*** ErrorFactory, deepEqual, isBrowserExtension, isMobileCordova, isReactNative, FirebaseError, querystring, getModularInstance, base64Decode, isIE, getUA, createSubscribe, querystringDecode, extractQuerystring, isEmpty } from '@firebase/util';
import ***REMOVED*** SDK_VERSION, _getProvider, _registerComponent, registerVersion } from '@firebase/app';
 ...
 */
function _allSettled(promises) ***REMOVED***
    var _this = this;
    return Promise.all(promises.map(function (promise) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
        var value, reason_1;
 ...
 *
 */
var Receiver = /** @class */ (function () ***REMOVED***
    function Receiver(eventTarget) ***REMOVED***
        this.eventTarget = eventTarget;
        this.handlersMap = ***REMOVED***};
  ...
  ***REMOVED***
     ...
     */
    Receiver._getInstance = function (eventTarget) ***REMOVED***
        // The results are stored in an array since objects can't be keys for other
        // objects. In addition, setting a unique property on an event target as a
        // hash map key may not be allowed due to CORS restrictions.
        var existingInstance = this.receivers.find(function (receiver) ***REMOVED***
      ...
      ***REMOVED***
        ...
        return newInstance;
  ***REMOVED***;
    Receiver.prototype.isListeningto = function (eventTarget) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     *
     * @remarks
     * Sends an ***REMOVED***@link Status.ACK} upon receipt and a ***REMOVED***@link Status.DONE} once all handlers have
     * finished processing.
     *
     * @param event - The MessageEvent.
     *
     */
    Receiver.prototype.handleEvent = function (event) ***REMOVED***
            ...
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
                        ...
                        if (!(handlers === null || handlers === void 0 ? void 0 : handlers.size)) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        messageEvent.ports[0].postMessage(***REMOVED***
                            status: "ack" /* _Status.ACK */,
                            eventId: eventId,
                            eventType: eventType
                      ***REMOVED***);
                        promises = Array.from(handlers).map(function (handler) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED*** return __generator(this, function (_a) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     *
     */
    Receiver.prototype._subscribe = function (eventType, eventHandler) ***REMOVED***
        if (Object.keys(this.handlersMap).length === 0) ***REMOVED***
            this.eventTarget.addEventListener('message', this.boundEventHandler);
      ***REMOVED***
        if (!this.handlersMap[eventType]) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     *
     */
    Receiver.prototype._unsubscribe = function (eventType, eventHandler) ***REMOVED***
        if (this.handlersMap[eventType] && eventHandler) ***REMOVED***
            this.handlersMap[eventType].delete(eventHandler);
      ***REMOVED***
        if (!eventHandler || this.handlersMap[eventType].size === 0) ***REMOVED***
 ...
 * limitations under the License.
 */
function _generateEventId(prefix, digits) ***REMOVED***
    if (prefix === void 0) ***REMOVED*** prefix = ''; }
    if (digits === void 0) ***REMOVED*** digits = 10; }
    var random = '';
    for (var i = 0; i < digits; i++) ***REMOVED***
 ...
 *
 */
var Sender = /** @class */ (function () ***REMOVED***
    function Sender(target) ***REMOVED***
        this.target = target;
  ...
  ***REMOVED***
     ...
     */
    Sender.prototype.removeMessageHandler = function (handler) ***REMOVED***
        if (handler.messageChannel) ***REMOVED***
  ...
  ***REMOVED***;
    /**
     * Send a message to the Receiver located at ***REMOVED***@link target}.
     *
     * @remarks
     ...
     */
    Sender.prototype._send = function (eventType, data, timeout) ***REMOVED***
        if (timeout === void 0) ***REMOVED*** timeout = 50 /* _TimeoutDuration.ACK */; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var messageChannel, completionTimer, handler;
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                messageChannel = typeof MessageChannel !== 'undefined' ? new MessageChannel() : null;
                if (!messageChannel) ***REMOVED***
                    throw new Error("connection_unavailable" /* _MessageError.CONNECTION_UNAVAILABLE */);
              ***REMOVED***
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var eventId = _generateEventId('', 20);
                        messageChannel.port1.start();
                        var ackTimer = setTimeout(function () ***REMOVED***
                            reject(new Error("unsupported_event" /* _MessageError.UNSUPPORTED_EVENT */));
                      ***REMOVED***, timeout);
                        handler = ***REMOVED***
                            messageChannel: messageChannel,
                            onMessage: function (event) ***REMOVED***
                                var messageEvent = event;
                                if (messageEvent.data.eventId !== eventId) ***REMOVED***
                                    return;
                              ***REMOVED***
                                switch (messageEvent.data.status) ***REMOVED***
                                    case "ack" /* _Status.ACK */:
                                        // The receiver should ACK first.
                                        clearTimeout(ackTimer);
                                        completionTimer = setTimeout(function () ***REMOVED***
                                            reject(new Error("timeout" /* _MessageError.TIMEOUT */));
                                      ***REMOVED***, 3000 /* _TimeoutDuration.COMPLETION */);
                                        break;
                      ...
                      ***REMOVED***;
                        ...
                        _this.target.postMessage(***REMOVED***
                            eventType: eventType,
                            eventId: eventId,
                            data: data
                      ***REMOVED***, [messageChannel.port2]);
 ...
 */
function _window() ***REMOVED***
    return window;
}
function _setWindowLocation(url) ***REMOVED***
...
function _getActiveServiceWorker() ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var registration;
        return __generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
...
function _getServiceWorkerController() ***REMOVED***
    var _a;
    return ((_a = navigator === null || navigator === void 0 ? void 0 : navigator.serviceWorker) === null || _a === void 0 ? void 0 : _a.controller) || null;
}
function _getWorkerGlobalScope() ***REMOVED***
 ...
 *
 */
var DBPromise = /** @class */ (function () ***REMOVED***
    function DBPromise(request) ***REMOVED***
        this.request = request;
  ***REMOVED***
    DBPromise.prototype.toPromise = function () ***REMOVED***
        var _this = this;
        return new Promise(function (resolve, reject) ***REMOVED***
            _this.request.addEventListener('success', function () ***REMOVED***
                resolve(_this.request.result);
          ***REMOVED***);
            _this.request.addEventListener('error', function () ***REMOVED***
...
function getObjectStore(db, isReadWrite) ***REMOVED***
    return db
        .transaction([DB_OBJECTSTORE_NAME], isReadWrite ? 'readwrite' : 'readonly')
        .objectStore(DB_OBJECTSTORE_NAME);
}
function _deleteDatabase() ***REMOVED***
    var request = indexedDB.deleteDatabase(DB_NAME);
    return new DBPromise(request).toPromise();
}
function _openDatabase() ***REMOVED***
    var _this = this;
    var request = indexedDB.open(DB_NAME, DB_VERSION);
    return new Promise(function (resolve, reject) ***REMOVED***
        request.addEventListener('error', function () ***REMOVED***
            reject(request.error);
      ***REMOVED***);
        request.addEventListener('upgradeneeded', function () ***REMOVED***
            var db = request.result;
            try ***REMOVED***
                db.createObjectStore(DB_OBJECTSTORE_NAME, ***REMOVED*** keyPath: DB_DATA_KEYPATH });
          ***REMOVED***
            catch (e) ***REMOVED***
                reject(e);
          ***REMOVED***
      ***REMOVED***);
        request.addEventListener('success', function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            var db, _a;
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
...
function _putObject(db, key, value) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var request;
        var _a;
        return __generator(this, function (_b) ***REMOVED***
            request = getObjectStore(db, true).put((_a = ***REMOVED***},
...
function getObject(db, key) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var request, data;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
function _deleteObject(db, key) ***REMOVED***
    var request = getObjectStore(db, true).delete(key);
    return new DBPromise(request).toPromise();
}
var _POLLING_INTERVAL_MS$1 = 800;
var _TRANSACTION_RETRY_COUNT = 3;
var IndexedDBLocalPersistence = /** @class */ (function () ***REMOVED***
    function IndexedDBLocalPersistence() ***REMOVED***
        ...
        this._workerInitializationPromise =
            this.initializeServiceWorkerMessaging().then(function () ***REMOVED*** }, function () ***REMOVED*** });
  ***REMOVED***
    IndexedDBLocalPersistence.prototype._openDb = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _a;
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._withRetries = function (op) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 5:
                        e_1 = _a.sent();
                        if (numAttempts++ > _TRANSACTION_RETRY_COUNT) ***REMOVED***
                            throw e_1;
                      ***REMOVED***
                        if (this.db) ***REMOVED***
                            this.db.close();
  ...
  ***REMOVED***;
     ...
     */
    IndexedDBLocalPersistence.prototype.initializeServiceWorkerMessaging = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    IndexedDBLocalPersistence.prototype.initializeReceiver = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                this.receiver = Receiver._getInstance(_getWorkerGlobalScope());
                // Refresh from persistence if we receive a KeyChanged message.
                this.receiver._subscribe("keyChanged" /* _EventType.KEY_CHANGED */, function (_origin, data) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                    var keys;
                    return __generator(this, function (_a) ***REMOVED***
                        switch (_a.label) ***REMOVED***
              ...
              ***REMOVED***); });
                ...
                this.receiver._subscribe("ping" /* _EventType.PING */, function (_origin, _data) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                    return __generator(this, function (_a) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     *
     * @remarks
     * ***REMOVED***@link https://developer.mozilla.org/en-US/docs/Web/API/ServiceWorkerContainer/ready | ServiceWorkerContainer.ready}
     * may not resolve.
     */
    IndexedDBLocalPersistence.prototype.initializeSender = function () ***REMOVED***
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _c, results;
            return __generator(this, function (_d) ***REMOVED***
                switch (_d.label) ***REMOVED***
                    ...
                    case 1:
                        ...
                        if (!this.activeServiceWorker) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        this.sender = new Sender(this.activeServiceWorker);
                        return [4 /*yield*/, this.sender._send("ping" /* _EventType.PING */, ***REMOVED***}, 800 /* _TimeoutDuration.LONG_ACK */)];
                    case 2:
                        results = _d.sent();
                        if (!results) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        if (((_a = results[0]) === null || _a === void 0 ? void 0 : _a.fulfilled) &&
                            ((_b = results[0]) === null || _b === void 0 ? void 0 : _b.value.includes("keyChanged" /* _EventType.KEY_CHANGED */))) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    IndexedDBLocalPersistence.prototype.notifyServiceWorker = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
                        if (!this.sender ||
                            ...
                            _getServiceWorkerController() !== this.activeServiceWorker) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.sender._send("keyChanged" /* _EventType.KEY_CHANGED */, ***REMOVED*** key: key }, 
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._isAvailable = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var db;
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._withPendingWrite = function (write) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._set = function (key, value) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this._withPendingWrite(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                        return __generator(this, function (_a) ***REMOVED***
                            switch (_a.label) ***REMOVED***
                                case 0: return [4 /*yield*/, this._withRetries(function (db) ***REMOVED*** return _putObject(db, key, value); })];
                                case 1:
                                    _a.sent();
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._get = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var obj;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0: return [4 /*yield*/, this._withRetries(function (db) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._remove = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this._withPendingWrite(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                        return __generator(this, function (_a) ***REMOVED***
                            switch (_a.label) ***REMOVED***
                                case 0: return [4 /*yield*/, this._withRetries(function (db) ***REMOVED*** return _deleteObject(db, key); })];
                                case 1:
                                    _a.sent();
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._poll = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
                ...
                switch (_d.label) ***REMOVED***
                    ...
                    case 1:
                      ...
                      ***REMOVED***
                        ...
                        if (this.pendingWrites !== 0) ***REMOVED***
                            return [2 /*return*/, []];
                      ***REMOVED***
                        keys = [];
                        keysInResult = new Set();
                        for (_i = 0, result_1 = result; _i < result_1.length; _i++) ***REMOVED***
                            _a = result_1[_i], key = _a.fbase_key, value = _a.value;
                            keysInResult.add(key);
                            if (JSON.stringify(this.localCache[key]) !== JSON.stringify(value)) ***REMOVED***
                                this.notifyListeners(key, value);
                                keys.push(key);
                          ***REMOVED***
                      ***REMOVED***
                        for (_b = 0, _c = Object.keys(this.localCache); _b < _c.length; _b++) ***REMOVED***
                            localKey = _c[_b];
                            if (this.localCache[localKey] && !keysInResult.has(localKey)) ***REMOVED***
                                // Deleted
      ...
      ***REMOVED***);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype.notifyListeners = function (key, newValue) ***REMOVED***
        this.localCache[key] = newValue;
        var listeners = this.listeners[key];
        if (listeners) ***REMOVED***
            for (var _i = 0, _a = Array.from(listeners); _i < _a.length; _i++) ***REMOVED***
                var listener = _a[_i];
                listener(newValue);
          ***REMOVED***
      ***REMOVED***
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype.startPolling = function () ***REMOVED***
        var _this = this;
        this.stopPolling();
        this.pollTimer = setInterval(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED*** return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, this._poll()];
      ***REMOVED***); }); }, _POLLING_INTERVAL_MS$1);
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype.stopPolling = function () ***REMOVED***
        if (this.pollTimer) ***REMOVED***
            clearInterval(this.pollTimer);
            this.pollTimer = null;
      ***REMOVED***
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._addListener = function (key, listener) ***REMOVED***
  ...
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._removeListener = function (key, listener) ***REMOVED***
        if (this.listeners[key]) ***REMOVED***
...
/**
 * An implementation of ***REMOVED***@link Persistence} of type `LOCAL` using `indexedDB`
 ...
 * limitations under the License.
 */
function _debugErrorMap() ***REMOVED***
    var _a;
    return _a = ***REMOVED***},
        ...
        _a["login-blocked" /* AuthErrorCode.LOGIN_BLOCKED */] = 'Login blocked by user-provided method: ***REMOVED***$originalMessage}',
...
function _prodErrorMap() ***REMOVED***
    var _a;
 ...
 *
 * See discussion at ***REMOVED***@link AuthErrorMap}
 *
 * @public
 */
 ...
 * @public
 */
var AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = ***REMOVED***
...
function _logError(msg) ***REMOVED***
    var args = [];
 ...
 * limitations under the License.
 */
function _fail(authOrCode) ***REMOVED***
    var rest = [];
    for (var _i = 1; _i < arguments.length; _i++) ***REMOVED***
...
function _createError(authOrCode) ***REMOVED***
    var rest = [];
    for (var _i = 1; _i < arguments.length; _i++) ***REMOVED***
        rest[_i - 1] = arguments[_i];
  ***REMOVED***
...
function _errorWithCustomMessage(auth, code, message) ***REMOVED***
    var _a;
    var errorMap = __assign(__assign(***REMOVED***}, prodErrorMap()), (_a = ***REMOVED***}, _a[code] = message, _a));
    var factory = new ErrorFactory('auth', 'Firebase', errorMap);
    return factory.create(code, ***REMOVED***
        appName: auth.name
  ***REMOVED***);
}
function _assertInstanceOf(auth, object, instance) ***REMOVED***
    var constructorInstance = instance;
    if (!(object instanceof constructorInstance)) ***REMOVED***
        if (constructorInstance.name !== object.constructor.name) ***REMOVED***
...
function createErrorInternal(authOrCode) ***REMOVED***
    var _a;
    var rest = [];
    for (var _i = 1; _i < arguments.length; _i++) ***REMOVED***
        rest[_i - 1] = arguments[_i];
  ***REMOVED***
    if (typeof authOrCode !== 'string') ***REMOVED***
        var code = rest[0];
        var fullParams = __spreadArray([], rest.slice(1), true);
        if (fullParams[0]) ***REMOVED***
...
function _assert(assertion, authOrCode) ***REMOVED***
    var rest = [];
 ...
 * @throws Error
 */
function debugFail(failure) ***REMOVED***
 ...
 * @param message
 */
function debugAssert(assertion, message) ***REMOVED***
    if (!assertion) ***REMOVED***
        debugFail(message);
  ***REMOVED***
}
...
function _getInstance(cls) ***REMOVED***
 ...
 */
/**
 * Initializes an ***REMOVED***@link Auth} instance with fine-grained control over
 * ***REMOVED***@link Dependencies}.
 *
 * @remarks
 *
 * This function allows more control over the ***REMOVED***@link Auth} instance than
 * ***REMOVED***@link getAuth}. `getAuth` uses platform-specific defaults to supply
 * the ***REMOVED***@link Dependencies}. In general, `getAuth` is the easiest way to
 ...
 *
 * ```js
 * const auth = initializeAuth(app, ***REMOVED***
 ...
 * @public
 */
function initializeAuth(app, deps) ***REMOVED***
    ...
    if (provider.isInitialized()) ***REMOVED***
        ...
        if (deepEqual(initialOptions, deps !== null && deps !== void 0 ? deps : ***REMOVED***})) ***REMOVED***
            return auth_1;
      ***REMOVED***
        else ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    var auth = provider.initialize(***REMOVED*** options: deps });
    return auth;
}
function _initializeAuthInstance(auth, deps) ***REMOVED***
    ...
    if (deps === null || deps === void 0 ? void 0 : deps.errorMap) ***REMOVED***
 ...
 * limitations under the License.
 */
function _getCurrentUrl() ***REMOVED***
    var _a;
...
function _isOnline() ***REMOVED***
    if (typeof navigator !== 'undefined' &&
        ...
        (_isHttpOrHttps() || isBrowserExtension() || 'connection' in navigator)) ***REMOVED***
        return navigator.onLine;
  ***REMOVED***
    // If we can't determine the state, assume it is online.
    return true;
}
function _getUserLanguage() ***REMOVED***
 ...
 */
var Delay = /** @class */ (function () ***REMOVED***
    function Delay(shortDelay, longDelay) ***REMOVED***
  ...
  ***REMOVED***
    Delay.prototype.get = function () ***REMOVED***
        if (!_isOnline()) ***REMOVED***
 ...
 * limitations under the License.
 */
function _emulatorUrl(config, path) ***REMOVED***
 ...
 * limitations under the License.
 */
var FetchProvider = /** @class */ (function () ***REMOVED***
    function FetchProvider() ***REMOVED***
  ***REMOVED***
    FetchProvider.initialize = function (fetchImpl, headersImpl, responseImpl) ***REMOVED***
        this.fetchImpl = fetchImpl;
        if (headersImpl) ***REMOVED***
            this.headersImpl = headersImpl;
      ***REMOVED***
        if (responseImpl) ***REMOVED***
            this.responseImpl = responseImpl;
      ***REMOVED***
  ***REMOVED***;
    FetchProvider.fetch = function () ***REMOVED***
        if (this.fetchImpl) ***REMOVED***
            return this.fetchImpl;
      ***REMOVED***
        if (typeof self !== 'undefined' && 'fetch' in self) ***REMOVED***
            return self.fetch;
      ***REMOVED***
        debugFail('Could not find fetch implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill');
  ***REMOVED***;
    FetchProvider.headers = function () ***REMOVED***
        if (this.headersImpl) ***REMOVED***
            return this.headersImpl;
      ***REMOVED***
        if (typeof self !== 'undefined' && 'Headers' in self) ***REMOVED***
            return self.Headers;
      ***REMOVED***
        debugFail('Could not find Headers implementation, make sure you call FetchProvider.initialize() with an appropriate polyfill');
  ***REMOVED***;
    FetchProvider.response = function () ***REMOVED***
        if (this.responseImpl) ***REMOVED***
            return this.responseImpl;
      ***REMOVED***
        if (typeof self !== 'undefined' && 'Response' in self) ***REMOVED***
 ...
 */
var SERVER_ERROR_MAP = (_a$1 = ***REMOVED***},
    // Custom token errors.
...
function _addTidIfNecessary(auth, request) ***REMOVED***
    if (auth.tenantId && !request.tenantId) ***REMOVED***
        return __assign(__assign(***REMOVED***}, request), ***REMOVED*** tenantId: auth.tenantId });
  ***REMOVED***
    return request;
}
function _performApiRequest(auth, method, path, request, customErrorMap) ***REMOVED***
    if (customErrorMap === void 0) ***REMOVED*** customErrorMap = ***REMOVED***}; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var _this = this;
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, _performFetchWithErrorHandling(auth, customErrorMap, function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                    ...
                    return __generator(this, function (_a) ***REMOVED***
                        switch (_a.label) ***REMOVED***
                            case 0:
                                ...
                                params = ***REMOVED***};
                                if (request) ***REMOVED***
                                    if (method === "GET" /* HttpMethod.GET */) ***REMOVED***
                                        params = request;
                                  ***REMOVED***
                                    else ***REMOVED***
                                        body = ***REMOVED***
                                  ...
                                  ***REMOVED***
                              ***REMOVED***
                                query = querystring(__assign(***REMOVED*** key: auth.config.apiKey }, params)).slice(1);
                                return [4 /*yield*/, auth._getAdditionalHeaders()];
                            case 1:
                                headers = _a.sent();
                                headers["Content-Type" /* HttpHeader.CONTENT_TYPE */] = 'application/json';
                                if (auth.languageCode) ***REMOVED***
                                    headers["X-Firebase-Locale" /* HttpHeader.X_FIREBASE_LOCALE */] = auth.languageCode;
                              ***REMOVED***
                                return [2 /*return*/, FetchProvider.fetch()(_getFinalTarget(auth, auth.config.apiHost, path, query), __assign(***REMOVED*** method: method, headers: headers, referrerPolicy: 'no-referrer' }, body))];
                      ***REMOVED***
                  ***REMOVED***);
              ***REMOVED***); })];
      ***REMOVED***);
...
function _performFetchWithErrorHandling(auth, customErrorMap, fetchFn) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                    ...
                    errorMap = __assign(__assign(***REMOVED***}, SERVER_ERROR_MAP), customErrorMap);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 4, , 5]);
                ...
                case 3:
                    json = _b.sent();
                    if ('needConfirmation' in json) ***REMOVED***
                        throw _makeTaggedError(auth, "account-exists-with-different-credential" /* AuthErrorCode.NEED_CONFIRMATION */, json);
                  ***REMOVED***
                    if (response.ok && !('errorMessage' in json)) ***REMOVED***
                  ...
                  ***REMOVED***
                        ...
                        if (serverErrorCode === "FEDERATED_USER_ID_ALREADY_LINKED" /* ServerError.FEDERATED_USER_ID_ALREADY_LINKED */) ***REMOVED***
                            throw _makeTaggedError(auth, "credential-already-in-use" /* AuthErrorCode.CREDENTIAL_ALREADY_IN_USE */, json);
                      ***REMOVED***
                        else if (serverErrorCode === "EMAIL_EXISTS" /* ServerError.EMAIL_EXISTS */) ***REMOVED***
                            throw _makeTaggedError(auth, "email-already-in-use" /* AuthErrorCode.EMAIL_EXISTS */, json);
                      ***REMOVED***
                        else if (serverErrorCode === "USER_DISABLED" /* ServerError.USER_DISABLED */) ***REMOVED***
                ...
                case 4:
                    e_1 = _b.sent();
                    if (e_1 instanceof FirebaseError) ***REMOVED***
                        throw e_1;
                  ***REMOVED***
...
function _performSignInRequest(auth, method, path, request, customErrorMap) ***REMOVED***
    if (customErrorMap === void 0) ***REMOVED*** customErrorMap = ***REMOVED***}; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var serverResponse;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                    ...
                    if ('mfaPendingCredential' in serverResponse) ***REMOVED***
                        _fail(auth, "multi-factor-auth-required" /* AuthErrorCode.MFA_REQUIRED */, ***REMOVED***
...
function _getFinalTarget(auth, host, path, query) ***REMOVED***
...
var NetworkTimeout = /** @class */ (function () ***REMOVED***
    function NetworkTimeout(auth) ***REMOVED***
        var _this = this;
        this.auth = auth;
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        this.timer = null;
        this.promise = new Promise(function (_, reject) ***REMOVED***
            _this.timer = setTimeout(function () ***REMOVED***
                return reject(_createError(_this.auth, "network-request-failed" /* AuthErrorCode.NETWORK_REQUEST_FAILED */));
          ***REMOVED***, DEFAULT_API_TIMEOUT_MS.get());
      ***REMOVED***);
  ***REMOVED***
    NetworkTimeout.prototype.clearNetworkTimeout = function () ***REMOVED***
        clearTimeout(this.timer);
  ***REMOVED***;
    return NetworkTimeout;
}());
function _makeTaggedError(auth, code, response) ***REMOVED***
    var errorParams = ***REMOVED***
        appName: auth.name
  ***REMOVED***;
    if (response.email) ***REMOVED***
        errorParams.email = response.email;
  ***REMOVED***
    if (response.phoneNumber) ***REMOVED***
 ...
 * limitations under the License.
 */
function deleteAccount(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function deleteLinkedAccounts(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function getAccountInfo(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * limitations under the License.
 */
function utcTimestampToDateString(utcTimestamp) ***REMOVED***
    if (!utcTimestamp) ***REMOVED***
        return undefined;
  ***REMOVED***
    try ***REMOVED***
 ...
 * @public
 */
function getIdToken(user, forceRefresh) ***REMOVED***
 ...
 * @public
 */
function getIdTokenResult(user, forceRefresh) ***REMOVED***
    if (forceRefresh === void 0) ***REMOVED*** forceRefresh = false; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
...
function secondsStringToMilliseconds(seconds) ***REMOVED***
    return Number(seconds) * 1000;
}
function _parseToken(token) ***REMOVED***
 ...
 */
function _tokenExpiresIn(token) ***REMOVED***
 ...
 * limitations under the License.
 */
function _logoutIfInvalidated(user, promise, bypassAuthState) ***REMOVED***
    if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var e_1;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
                    if (bypassAuthState) ***REMOVED***
...
function isUserInvalidated(_a) ***REMOVED***
    var code = _a.code;
 ...
 * limitations under the License.
 */
var ProactiveRefresh = /** @class */ (function () ***REMOVED***
    function ProactiveRefresh(user) ***REMOVED***
        this.user = user;
  ...
  ***REMOVED***
    ProactiveRefresh.prototype._start = function () ***REMOVED***
      ...
      ***REMOVED***
        ...
        this.schedule();
  ***REMOVED***;
    ProactiveRefresh.prototype._stop = function () ***REMOVED***
        if (!this.isRunning) ***REMOVED***
            return;
      ***REMOVED***
        this.isRunning = false;
        if (this.timerId !== null) ***REMOVED***
            clearTimeout(this.timerId);
      ***REMOVED***
  ***REMOVED***;
    ProactiveRefresh.prototype.getInterval = function (wasError) ***REMOVED***
        var _a;
        if (wasError) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    ProactiveRefresh.prototype.schedule = function (wasError) ***REMOVED***
        var _this = this;
        if (wasError === void 0) ***REMOVED*** wasError = false; }
        if (!this.isRunning) ***REMOVED***
            // Just in case...
            return;
      ***REMOVED***
        var interval = this.getInterval(wasError);
        this.timerId = setTimeout(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***); }, interval);
  ***REMOVED***;
    ProactiveRefresh.prototype.iteration = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var e_1;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 2:
                        ...
                        if ((e_1 === null || e_1 === void 0 ? void 0 : e_1.code) ===
                            "auth/".concat("network-request-failed" /* AuthErrorCode.NETWORK_REQUEST_FAILED */)) ***REMOVED***
...
var UserMetadata = /** @class */ (function () ***REMOVED***
    function UserMetadata(createdAt, lastLoginAt) ***REMOVED***
        this.createdAt = createdAt;
        this.lastLoginAt = lastLoginAt;
        this._initializeTime();
  ***REMOVED***
    UserMetadata.prototype._initializeTime = function () ***REMOVED***
        this.lastSignInTime = utcTimestampToDateString(this.lastLoginAt);
        this.creationTime = utcTimestampToDateString(this.createdAt);
  ***REMOVED***;
    UserMetadata.prototype._copy = function (metadata) ***REMOVED***
 ...
 * limitations under the License.
 */
function _reloadWithoutSaving(user) ***REMOVED***
    var _a;
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                ...
                case 1:
                    idToken = _b.sent();
                    return [4 /*yield*/, _logoutIfInvalidated(user, getAccountInfo(auth, ***REMOVED*** idToken: idToken }))];
                case 2:
                    response = _b.sent();
...
function mergeProviderData(original, newData) ***REMOVED***
    var deduped = original.filter(function (o) ***REMOVED*** return !newData.some(function (n) ***REMOVED*** return n.providerId === o.providerId; }); });
    return __spreadArray(__spreadArray([], deduped, true), newData, true);
}
function extractProviderData(providers) ***REMOVED***
    return providers.map(function (_a) ***REMOVED***
 ...
 * limitations under the License.
 */
function requestStsToken(auth, refreshToken) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var response;
        var _this = this;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, _performFetchWithErrorHandling(auth, ***REMOVED***}, function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                        var body, _a, tokenApiHost, apiKey, url, headers;
                        return __generator(this, function (_b) ***REMOVED***
                            switch (_b.label) ***REMOVED***
                                case 0:
                                    body = querystring(***REMOVED***
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, FetchProvider.fetch()(url, ***REMOVED***
 ...
 * @internal
 */
var StsTokenManager = /** @class */ (function () ***REMOVED***
    function StsTokenManager() ***REMOVED***
        this.refreshToken = null;
        this.accessToken = null;
        this.expirationTime = null;
  ***REMOVED***
    Object.defineProperty(StsTokenManager.prototype, "isExpired", ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    StsTokenManager.prototype.updateFromServerResponse = function (response) ***REMOVED***
  ...
  ***REMOVED***;
    StsTokenManager.prototype.getToken = function (auth, forceRefresh) ***REMOVED***
        if (forceRefresh === void 0) ***REMOVED*** forceRefresh = false; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        ...
                        if (!forceRefresh && this.accessToken && !this.isExpired) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    StsTokenManager.prototype.clearRefreshToken = function () ***REMOVED***
        this.refreshToken = null;
  ***REMOVED***;
    StsTokenManager.prototype.refresh = function (auth, oldToken) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    StsTokenManager.prototype.updateTokensAndExpiration = function (accessToken, refreshToken, expiresInSec) ***REMOVED***
        this.refreshToken = refreshToken || null;
        this.accessToken = accessToken || null;
        this.expirationTime = Date.now() + expiresInSec * 1000;
  ***REMOVED***;
    StsTokenManager.fromJSON = function (appName, object) ***REMOVED***
        ...
        if (refreshToken) ***REMOVED***
            _assert(typeof refreshToken === 'string', "internal-error" /* AuthErrorCode.INTERNAL_ERROR */, ***REMOVED***
                appName: appName
          ***REMOVED***);
            manager.refreshToken = refreshToken;
      ***REMOVED***
        if (accessToken) ***REMOVED***
            _assert(typeof accessToken === 'string', "internal-error" /* AuthErrorCode.INTERNAL_ERROR */, ***REMOVED***
                appName: appName
          ***REMOVED***);
            manager.accessToken = accessToken;
      ***REMOVED***
        if (expirationTime) ***REMOVED***
            _assert(typeof expirationTime === 'number', "internal-error" /* AuthErrorCode.INTERNAL_ERROR */, ***REMOVED***
                appName: appName
          ***REMOVED***);
      ...
      ***REMOVED***
        return manager;
  ***REMOVED***;
    StsTokenManager.prototype.toJSON = function () ***REMOVED***
        return ***REMOVED***
      ...
      ***REMOVED***;
  ***REMOVED***;
    StsTokenManager.prototype._assign = function (stsTokenManager) ***REMOVED***
        this.accessToken = stsTokenManager.accessToken;
        this.refreshToken = stsTokenManager.refreshToken;
        this.expirationTime = stsTokenManager.expirationTime;
  ***REMOVED***;
    StsTokenManager.prototype._clone = function () ***REMOVED***
        return Object.assign(new StsTokenManager(), this.toJSON());
  ***REMOVED***;
    StsTokenManager.prototype._performRefresh = function () ***REMOVED***
 ...
 * limitations under the License.
 */
function assertStringOrUndefined(assertion, appName) ***REMOVED***
    _assert(typeof assertion === 'string' || typeof assertion === 'undefined', "internal-error" /* AuthErrorCode.INTERNAL_ERROR */, ***REMOVED*** appName: appName });
}
var UserImpl = /** @class */ (function () ***REMOVED***
    function UserImpl(_a) ***REMOVED***
  ...
  ***REMOVED***
    UserImpl.prototype.getIdToken = function (forceRefresh) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var accessToken;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    UserImpl.prototype.getIdTokenResult = function (forceRefresh) ***REMOVED***
        return getIdTokenResult(this, forceRefresh);
  ***REMOVED***;
    UserImpl.prototype.reload = function () ***REMOVED***
        return reload(this);
  ***REMOVED***;
    UserImpl.prototype._assign = function (user) ***REMOVED***
        if (this === user) ***REMOVED***
            return;
      ***REMOVED***
        ...
        this.providerData = user.providerData.map(function (userInfo) ***REMOVED*** return (__assign(***REMOVED***}, userInfo)); });
        this.metadata._copy(user.metadata);
        this.stsTokenManager._assign(user.stsTokenManager);
  ***REMOVED***;
    UserImpl.prototype._clone = function (auth) ***REMOVED***
        return new UserImpl(__assign(__assign(***REMOVED***}, this), ***REMOVED*** auth: auth, stsTokenManager: this.stsTokenManager._clone() }));
  ***REMOVED***;
    UserImpl.prototype._onReload = function (callback) ***REMOVED***
        // There should only ever be one listener, and that is a single instance of MultiFactorUser
        _assert(!this.reloadListener, this.auth, "internal-error" /* AuthErrorCode.INTERNAL_ERROR */);
        this.reloadListener = callback;
        if (this.reloadUserInfo) ***REMOVED***
            this._notifyReloadListener(this.reloadUserInfo);
            this.reloadUserInfo = null;
      ***REMOVED***
  ***REMOVED***;
    UserImpl.prototype._notifyReloadListener = function (userInfo) ***REMOVED***
        if (this.reloadListener) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    UserImpl.prototype._startProactiveRefresh = function () ***REMOVED***
        this.proactiveRefresh._start();
  ***REMOVED***;
    UserImpl.prototype._stopProactiveRefresh = function () ***REMOVED***
        this.proactiveRefresh._stop();
  ***REMOVED***;
    UserImpl.prototype._updateTokensIfNecessary = function (response, reload) ***REMOVED***
        if (reload === void 0) ***REMOVED*** reload = false; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var tokensRefreshed;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        ...
                        if (response.idToken &&
                            response.idToken !== this.stsTokenManager.accessToken) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    UserImpl.prototype.delete = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var idToken;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        idToken = _a.sent();
                        return [4 /*yield*/, _logoutIfInvalidated(this, deleteAccount(this.auth, ***REMOVED*** idToken: idToken }))];
                    case 2:
                        _a.sent();
      ...
      ***REMOVED***);
  ***REMOVED***;
    UserImpl.prototype.toJSON = function () ***REMOVED***
        return __assign(__assign(***REMOVED*** uid: this.uid, email: this.email || undefined, emailVerified: this.emailVerified, displayName: this.displayName || undefined, isAnonymous: this.isAnonymous, photoURL: this.photoURL || undefined, phoneNumber: this.phoneNumber || undefined, tenantId: this.tenantId || undefined, providerData: this.providerData.map(function (userInfo) ***REMOVED*** return (__assign(***REMOVED***}, userInfo)); }), stsTokenManager: this.stsTokenManager.toJSON(), 
            // Redirect event ID must be maintained in case there is a pending
            // redirect event.
            _redirectEventId: this._redirectEventId }, this.metadata.toJSON()), ***REMOVED*** 
            // Required for compatibility with the legacy SDK (go/firebase-auth-sdk-persistence-parsing):
            apiKey: this.auth.config.apiKey, appName: this.auth.name });
  ***REMOVED***;
    Object.defineProperty(UserImpl.prototype, "refreshToken", ***REMOVED***
        get: function () ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    UserImpl._fromJSON = function (auth, object) ***REMOVED***
      ...
      ***REMOVED***);
        if (providerData && Array.isArray(providerData)) ***REMOVED***
            user.providerData = providerData.map(function (userInfo) ***REMOVED*** return (__assign(***REMOVED***}, userInfo)); });
      ***REMOVED***
        if (_redirectEventId) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    UserImpl._fromIdTokenResponse = function (auth, idTokenResponse, isAnonymous) ***REMOVED***
        if (isAnonymous === void 0) ***REMOVED*** isAnonymous = false; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 * limitations under the License.
 */
var InMemoryPersistence = /** @class */ (function () ***REMOVED***
    function InMemoryPersistence() ***REMOVED***
        this.type = "NONE" /* PersistenceType.NONE */;
        this.storage = ***REMOVED***};
  ***REMOVED***
    InMemoryPersistence.prototype._isAvailable = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, true];
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***;
    InMemoryPersistence.prototype._set = function (key, value) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    InMemoryPersistence.prototype._get = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var value;
            return __generator(this, function (_a) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    InMemoryPersistence.prototype._remove = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    InMemoryPersistence.prototype._addListener = function (_key, _listener) ***REMOVED***
        // Listeners are not supported for in-memory storage since it cannot be shared across windows/workers
        return;
  ***REMOVED***;
    InMemoryPersistence.prototype._removeListener = function (_key, _listener) ***REMOVED***
        // Listeners are not supported for in-memory storage since it cannot be shared across windows/workers
        return;
  ***REMOVED***;
...
/**
 * An implementation of ***REMOVED***@link Persistence} of type 'NONE'.
 *
 * @public
 */
 ...
 * limitations under the License.
 */
function _persistenceKeyName(key, apiKey, appName) ***REMOVED***
    return "".concat("firebase" /* Namespace.PERSISTENCE */, ":").concat(key, ":").concat(apiKey, ":").concat(appName);
}
var PersistenceUserManager = /** @class */ (function () ***REMOVED***
    function PersistenceUserManager(persistence, auth, userKey) ***REMOVED***
  ...
  ***REMOVED***
    PersistenceUserManager.prototype.setCurrentUser = function (user) ***REMOVED***
        return this.persistence._set(this.fullUserKey, user.toJSON());
  ***REMOVED***;
    PersistenceUserManager.prototype.getCurrentUser = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var blob;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    PersistenceUserManager.prototype.removeCurrentUser = function () ***REMOVED***
        return this.persistence._remove(this.fullUserKey);
  ***REMOVED***;
    PersistenceUserManager.prototype.savePersistenceForRedirect = function () ***REMOVED***
        return this.persistence._set(this.fullPersistenceKey, this.persistence.type);
  ***REMOVED***;
    PersistenceUserManager.prototype.setPersistence = function (newPersistence) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var currentUser;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        if (this.persistence === newPersistence) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    PersistenceUserManager.prototype.delete = function () ***REMOVED***
        this.persistence._removeListener(this.fullUserKey, this.boundEventHandler);
  ***REMOVED***;
    PersistenceUserManager.create = function (auth, persistenceHierarchy, userKey) ***REMOVED***
        if (userKey === void 0) ***REMOVED*** userKey = "authUser" /* KeyName.AUTH_USER */; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
                        if (!persistenceHierarchy.length) ***REMOVED***
                            return [2 /*return*/, new PersistenceUserManager(_getInstance(inMemoryPersistence), auth, userKey)];
                      ***REMOVED***
                        return [4 /*yield*/, Promise.all(persistenceHierarchy.map(function (persistence) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                                return __generator(this, function (_a) ***REMOVED***
                                    switch (_a.label) ***REMOVED***
                          ...
                          ***REMOVED***); }))];
                    case 1:
                        availablePersistences = (_b.sent()).filter(function (persistence) ***REMOVED*** return persistence; });
                    ...
                    case 4:
                        ...
                        if (blob) ***REMOVED***
                            ...
                            if (persistence !== selectedPersistence) ***REMOVED***
                                userToMigrate = user;
                          ***REMOVED***
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 2];
                    case 7:
                        migrationHierarchy = availablePersistences.filter(function (p) ***REMOVED*** return p._shouldAllowMigration; });
                        // If the persistence does _not_ allow migration, just finish off here
                        if (!selectedPersistence._shouldAllowMigration ||
                            !migrationHierarchy.length) ***REMOVED***
 ...
 */
function _getBrowserName(userAgent) ***REMOVED***
    var ua = userAgent.toLowerCase();
    if (ua.includes('opera/') || ua.includes('opr/') || ua.includes('opios/')) ***REMOVED***
        return "Opera" /* BrowserName.OPERA */;
  ***REMOVED***
    else if (_isIEMobile(ua)) ***REMOVED***
        // Windows phone IEMobile browser.
        return "IEMobile" /* BrowserName.IEMOBILE */;
  ***REMOVED***
    else if (ua.includes('msie') || ua.includes('trident/')) ***REMOVED***
        return "IE" /* BrowserName.IE */;
  ***REMOVED***
    else if (ua.includes('edge/')) ***REMOVED***
        return "Edge" /* BrowserName.EDGE */;
  ***REMOVED***
    else if (_isFirefox(ua)) ***REMOVED***
        return "Firefox" /* BrowserName.FIREFOX */;
  ***REMOVED***
    else if (ua.includes('silk/')) ***REMOVED***
        return "Silk" /* BrowserName.SILK */;
  ***REMOVED***
    else if (_isBlackBerry(ua)) ***REMOVED***
        // Blackberry browser.
        return "Blackberry" /* BrowserName.BLACKBERRY */;
  ***REMOVED***
    else if (_isWebOS(ua)) ***REMOVED***
        // WebOS default browser.
        return "Webos" /* BrowserName.WEBOS */;
  ***REMOVED***
    else if (_isSafari(ua)) ***REMOVED***
        return "Safari" /* BrowserName.SAFARI */;
  ***REMOVED***
    else if ((ua.includes('chrome/') || _isChromeIOS(ua)) &&
        !ua.includes('edge/')) ***REMOVED***
        return "Chrome" /* BrowserName.CHROME */;
  ***REMOVED***
    else if (_isAndroid(ua)) ***REMOVED***
  ...
  ***REMOVED***
        ...
        if ((matches === null || matches === void 0 ? void 0 : matches.length) === 2) ***REMOVED***
            return matches[1];
      ***REMOVED***
  ***REMOVED***
    return "Other" /* BrowserName.OTHER */;
}
function _isFirefox(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return /firefox\//i.test(ua);
}
function _isSafari(userAgent) ***REMOVED***
    if (userAgent === void 0) ***REMOVED*** userAgent = getUA(); }
    var ua = userAgent.toLowerCase();
...
function _isChromeIOS(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return /crios\//i.test(ua);
}
function _isIEMobile(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return /iemobile/i.test(ua);
}
function _isAndroid(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return /android/i.test(ua);
}
function _isBlackBerry(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return /blackberry/i.test(ua);
}
function _isWebOS(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return /webos/i.test(ua);
}
function _isIOS(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return (/iphone|ipad|ipod/i.test(ua) ||
        (/macintosh/i.test(ua) && /mobile/i.test(ua)));
}
function _isIOS7Or8(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return (/(iPad|iPhone|iPod).*OS 7_\d/i.test(ua) ||
        /(iPad|iPhone|iPod).*OS 8_\d/i.test(ua));
}
function _isIOSStandalone(ua) ***REMOVED***
    var _a;
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
    return _isIOS(ua) && !!((_a = window.navigator) === null || _a === void 0 ? void 0 : _a.standalone);
}
function _isIE10() ***REMOVED***
    return isIE() && document.documentMode === 10;
}
function _isMobileBrowser(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = getUA(); }
 ...
 */
function _getClientVersion(clientPlatform, frameworks) ***REMOVED***
    if (frameworks === void 0) ***REMOVED*** frameworks = []; }
    var reportedPlatform;
    switch (clientPlatform) ***REMOVED***
 ...
 * limitations under the License.
 */
var AuthMiddlewareQueue = /** @class */ (function () ***REMOVED***
    function AuthMiddlewareQueue(auth) ***REMOVED***
        this.auth = auth;
        this.queue = [];
  ***REMOVED***
    AuthMiddlewareQueue.prototype.pushCallback = function (callback, onAbort) ***REMOVED***
        var _this = this;
        // The callback could be sync or async. Wrap it into a
        // function that is always async.
        var wrappedCallback = function (user) ***REMOVED***
            return new Promise(function (resolve, reject) ***REMOVED***
                try ***REMOVED***
      ...
      ***REMOVED***;
        ...
        return function () ***REMOVED***
            ...
            _this.queue[index] = function () ***REMOVED*** return Promise.resolve(); };
      ***REMOVED***;
  ***REMOVED***;
    AuthMiddlewareQueue.prototype.runMiddleware = function (nextUser) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_c) ***REMOVED***
                switch (_c.label) ***REMOVED***
                    case 0:
                        if (this.auth.currentUser === nextUser) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        onAbortStack = [];
                        _c.label = 1;
                    ...
                    case 3:
                        ...
                        if (beforeStateCallback.onAbort) ***REMOVED***
                    ...
                    case 6:
                        ...
                        for (_b = 0, onAbortStack_1 = onAbortStack; _b < onAbortStack_1.length; _b++) ***REMOVED***
                          ...
                          ***REMOVED***
                      ***REMOVED***
                        throw this.auth._errorFactory.create("login-blocked" /* AuthErrorCode.LOGIN_BLOCKED */, ***REMOVED***
 ...
 * limitations under the License.
 */
var AuthImpl = /** @class */ (function () ***REMOVED***
    function AuthImpl(app, heartbeatServiceProvider, config) ***REMOVED***
        this.app = app;
        ...
        this.tenantId = null;
        this.settings = ***REMOVED*** appVerificationDisabledForTesting: false };
        this.frameworks = [];
        this.name = app.name;
        this.clientVersion = config.sdkClientVersion;
  ***REMOVED***
    AuthImpl.prototype._initializeWithPersistence = function (persistenceHierarchy, popupRedirectResolver) ***REMOVED***
        var _this = this;
        if (popupRedirectResolver) ***REMOVED***
            this._popupRedirectResolver = _getInstance(popupRedirectResolver);
      ***REMOVED***
        // Have to check for app deletion throughout initialization (after each
        // promise resolution)
        this._initializationPromise = this.queue(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            var _a;
            var _b, _c;
            return __generator(this, function (_d) ***REMOVED***
                switch (_d.label) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    AuthImpl.prototype._onStorageEvent = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var user;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        user = _a.sent();
                        if (!this.currentUser && !user) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.initializeCurrentUser = function (popupRedirectResolver) ***REMOVED***
        var _a;
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
                ...
                switch (_b.label) ***REMOVED***
                    ...
                    case 3:
                        ...
                        if ((!redirectUserEventId || redirectUserEventId === storedUserEventId) &&
                            (result === null || result === void 0 ? void 0 : result.user)) ***REMOVED***
                    ...
                    case 7:
                        ...
                        this._popupRedirectResolver._overrideRedirectResult(this, function () ***REMOVED***
                    ...
                    case 10:
                        ...
                        if (this.redirectUser &&
                            this.redirectUser._redirectEventId === futureCurrentUser._redirectEventId) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.tryRedirectSignIn = function (redirectResolver) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var result;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.reloadAndSetCurrentUserOrClear = function (user) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var e_4;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.useDeviceLanguage = function () ***REMOVED***
        this.languageCode = _getUserLanguage();
  ***REMOVED***;
    AuthImpl.prototype._delete = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                this._deleted = true;
                return [2 /*return*/];
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.updateCurrentUser = function (userExtern) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var user;
            return __generator(this, function (_a) ***REMOVED***
                user = userExtern
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype._updateCurrentUser = function (user, skipBeforeStateCallbacks) ***REMOVED***
        if (skipBeforeStateCallbacks === void 0) ***REMOVED*** skipBeforeStateCallbacks = false; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, this.queue(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                            return __generator(this, function (_a) ***REMOVED***
                                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.signOut = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0: 
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.setPersistence = function (persistence) ***REMOVED***
        var _this = this;
        return this.queue(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***); });
  ***REMOVED***;
    AuthImpl.prototype._getPersistence = function () ***REMOVED***
        return this.assertedPersistence.persistence.type;
  ***REMOVED***;
    AuthImpl.prototype._updateErrorMap = function (errorMap) ***REMOVED***
        this._errorFactory = new ErrorFactory('auth', 'Firebase', errorMap());
  ***REMOVED***;
    AuthImpl.prototype.onAuthStateChanged = function (nextOrObserver, error, completed) ***REMOVED***
        return this.registerStateListener(this.authStateSubscription, nextOrObserver, error, completed);
  ***REMOVED***;
    AuthImpl.prototype.beforeAuthStateChanged = function (callback, onAbort) ***REMOVED***
        return this.beforeStateQueue.pushCallback(callback, onAbort);
  ***REMOVED***;
    AuthImpl.prototype.onIdTokenChanged = function (nextOrObserver, error, completed) ***REMOVED***
        return this.registerStateListener(this.idTokenSubscription, nextOrObserver, error, completed);
  ***REMOVED***;
    AuthImpl.prototype.toJSON = function () ***REMOVED***
        var _a;
        return ***REMOVED***
      ...
      ***REMOVED***;
  ***REMOVED***;
    AuthImpl.prototype._setRedirectUser = function (user, popupRedirectResolver) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var redirectManager;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.getOrInitRedirectPersistenceManager = function (popupRedirectResolver) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var resolver, _a, _b;
            return __generator(this, function (_c) ***REMOVED***
                switch (_c.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype._redirectUserForId = function (id) ***REMOVED***
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_c) ***REMOVED***
                switch (_c.label) ***REMOVED***
                    case 0:
                        ...
                        return [4 /*yield*/, this.queue(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED*** return __generator(this, function (_a) ***REMOVED***
                                return [2 /*return*/];
                          ***REMOVED***); }); })];
                    case 1:
                        _c.sent();
                        _c.label = 2;
                    case 2:
                        if (((_a = this._currentUser) === null || _a === void 0 ? void 0 : _a._redirectEventId) === id) ***REMOVED***
                            return [2 /*return*/, this._currentUser];
                      ***REMOVED***
                        if (((_b = this.redirectUser) === null || _b === void 0 ? void 0 : _b._redirectEventId) === id) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype._persistUserIfCurrent = function (user) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                if (user === this.currentUser) ***REMOVED***
                    return [2 /*return*/, this.queue(function () ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED*** return __generator(this, function (_a) ***REMOVED***
  ...
  ***REMOVED***;
    ...
    AuthImpl.prototype._notifyListenersIfCurrent = function (user) ***REMOVED***
        if (user === this.currentUser) ***REMOVED***
            this.notifyAuthListeners();
      ***REMOVED***
  ***REMOVED***;
    AuthImpl.prototype._key = function () ***REMOVED***
        return "".concat(this.config.authDomain, ":").concat(this.config.apiKey, ":").concat(this.name);
  ***REMOVED***;
    AuthImpl.prototype._startProactiveRefresh = function () ***REMOVED***
        this.isProactiveRefreshEnabled = true;
        if (this.currentUser) ***REMOVED***
            this._currentUser._startProactiveRefresh();
      ***REMOVED***
  ***REMOVED***;
    AuthImpl.prototype._stopProactiveRefresh = function () ***REMOVED***
        this.isProactiveRefreshEnabled = false;
        if (this.currentUser) ***REMOVED***
            this._currentUser._stopProactiveRefresh();
      ***REMOVED***
  ***REMOVED***;
    Object.defineProperty(AuthImpl.prototype, "_currentUser", ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    AuthImpl.prototype.notifyAuthListeners = function () ***REMOVED***
        var _a, _b;
      ...
      ***REMOVED***
        ...
        if (this.lastNotifiedUid !== currentUid) ***REMOVED***
            this.lastNotifiedUid = currentUid;
            this.authStateSubscription.next(this.currentUser);
      ***REMOVED***
  ***REMOVED***;
    AuthImpl.prototype.registerStateListener = function (subscription, nextOrObserver, error, completed) ***REMOVED***
        var _this = this;
        if (this._deleted) ***REMOVED***
            return function () ***REMOVED*** };
      ***REMOVED***
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        promise.then(function () ***REMOVED*** return cb(_this.currentUser); });
  ...
  ***REMOVED***;
     ...
     */
    AuthImpl.prototype.directlySetCurrentUser = function (user) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        if (this.currentUser && this.currentUser !== user) ***REMOVED***
                            this._currentUser._stopProactiveRefresh();
                      ***REMOVED***
                        if (user && this.isProactiveRefreshEnabled) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AuthImpl.prototype.queue = function (action) ***REMOVED***
        // In case something errors, the callback still should be called in order
        // to keep the promise chain alive
        this.operations = this.operations.then(action, action);
        return this.operations;
  ***REMOVED***;
    Object.defineProperty(AuthImpl.prototype, "assertedPersistence", ***REMOVED***
        get: function () ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: true
  ***REMOVED***);
    AuthImpl.prototype._logFramework = function (framework) ***REMOVED***
        if (!framework || this.frameworks.includes(framework)) ***REMOVED***
            return;
      ***REMOVED***
  ...
  ***REMOVED***;
    AuthImpl.prototype._getFrameworks = function () ***REMOVED***
        return this.frameworks;
  ***REMOVED***;
    AuthImpl.prototype._getAdditionalHeaders = function () ***REMOVED***
        var _a;
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
                ...
                switch (_c.label) ***REMOVED***
                    case 0:
                        headers = (_b = ***REMOVED***},
                            ...
                            _b);
                        if (this.app.options.appId) ***REMOVED***
                            headers["X-Firebase-gmpid" /* HttpHeader.X_FIREBASE_GMPID */] = this.app.options.appId;
                      ***REMOVED***
                        return [4 /*yield*/, ((_a = this.heartbeatServiceProvider
                                .getImmediate(***REMOVED***
                                optional: true
                          ***REMOVED***)) === null || _a === void 0 ? void 0 : _a.getHeartbeatsHeader())];
                    case 1:
 ...
 */
function _castAuth(auth) ***REMOVED***
    return getModularInstance(auth);
}
/** Helper class to wrap subscriber logic */
var Subscription = /** @class */ (function () ***REMOVED***
    function Subscription(auth) ***REMOVED***
        var _this = this;
        this.auth = auth;
        this.observer = null;
        this.addObserver = createSubscribe(function (observer) ***REMOVED*** return (_this.observer = observer); });
  ***REMOVED***
    Object.defineProperty(Subscription.prototype, "next", ***REMOVED***
        get: function () ***REMOVED***
...
/**
 * Changes the ***REMOVED***@link Auth} instance to communicate with the Firebase Auth Emulator, instead of production
 * Firebase Auth services.
 *
 * @remarks
 * This must be called synchronously immediately following the first call to
 * ***REMOVED***@link initializeAuth}.  Do not use with production credentials as emulator
 * traffic is not encrypted.
 *
 *
 * @example
 * ```javascript
 * connectAuthEmulator(auth, 'http://127.0.0.1:9099', ***REMOVED*** disableWarnings: true });
 * ```
 *
 ...
 * @public
 */
function connectAuthEmulator(auth, url, options) ***REMOVED***
    ...
    authInternal.config.emulator = ***REMOVED*** url: "".concat(protocol, "//").concat(host).concat(portStr, "/") };
    authInternal.settings.appVerificationDisabledForTesting = true;
    authInternal.emulatorConfig = Object.freeze(***REMOVED***
        host: host,
        port: port,
        protocol: protocol.replace(':', ''),
        options: Object.freeze(***REMOVED*** disableWarnings: disableWarnings })
  ***REMOVED***);
    if (!disableWarnings) ***REMOVED***
        emitEmulatorWarning();
  ***REMOVED***
}
function extractProtocol(url) ***REMOVED***
    var protocolEnd = url.indexOf(':');
    return protocolEnd < 0 ? '' : url.substr(0, protocolEnd + 1);
}
function extractHostAndPort(url) ***REMOVED***
    var protocol = extractProtocol(url);
    var authority = /(\/\/)?([^?#/]+)/.exec(url.substr(protocol.length)); // Between // and /, ? or #.
    if (!authority) ***REMOVED***
        return ***REMOVED*** host: '', port: null };
  ***REMOVED***
    var hostAndPort = authority[2].split('@').pop() || ''; // Strip out "username:password@".
    var bracketedIPv6 = /^(\[[^\]]+\])(:|$)/.exec(hostAndPort);
    if (bracketedIPv6) ***REMOVED***
        var host = bracketedIPv6[1];
        return ***REMOVED*** host: host, port: parsePort(hostAndPort.substr(host.length + 1)) };
  ***REMOVED***
    else ***REMOVED***
        var _a = hostAndPort.split(':'), host = _a[0], port = _a[1];
        return ***REMOVED*** host: host, port: parsePort(port) };
  ***REMOVED***
}
function parsePort(portStr) ***REMOVED***
    if (!portStr) ***REMOVED***
        return null;
  ***REMOVED***
    var port = Number(portStr);
    if (isNaN(port)) ***REMOVED***
        return null;
  ***REMOVED***
    return port;
}
function emitEmulatorWarning() ***REMOVED***
    function attachBanner() ***REMOVED***
  ...
  ***REMOVED***
    if (typeof console !== 'undefined' && typeof console.info === 'function') ***REMOVED***
        console.info('WARNING: You are using the Auth Emulator,' +
            ' which is intended for local testing only.  Do not use with' +
            ' production credentials.');
  ***REMOVED***
    if (typeof window !== 'undefined' && typeof document !== 'undefined') ***REMOVED***
 ...
 */
/**
 * Interface that represents the credentials returned by an ***REMOVED***@link AuthProvider}.
 *
 * @remarks
 ...
 * @public
 */
var AuthCredential = /** @class */ (function () ***REMOVED***
    /** @internal */
     ...
     *
     * @remarks
     * For example, ***REMOVED***@link SignInMethod}.EMAIL_PASSWORD, or
     * ***REMOVED***@link SignInMethod}.EMAIL_LINK. This corresponds to the sign-in method
     * identifier as returned in ***REMOVED***@link fetchSignInMethodsForEmail}.
     */
    signInMethod) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @returns a JSON-serializable representation of this object.
     */
    AuthCredential.prototype.toJSON = function () ***REMOVED***
        return debugFail('not implemented');
  ***REMOVED***;
    /** @internal */
    AuthCredential.prototype._getIdTokenResponse = function (_auth) ***REMOVED***
        return debugFail('not implemented');
  ***REMOVED***;
    /** @internal */
    AuthCredential.prototype._linkToIdToken = function (_auth, _idToken) ***REMOVED***
        return debugFail('not implemented');
  ***REMOVED***;
    /** @internal */
    AuthCredential.prototype._getReauthenticationResolver = function (_auth) ***REMOVED***
        return debugFail('not implemented');
  ***REMOVED***;
 ...
 * limitations under the License.
 */
function resetPassword(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function updateEmailPassword(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:update" /* Endpoint.SET_ACCOUNT_INFO */, request)];
      ***REMOVED***);
...
function applyActionCode$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * limitations under the License.
 */
function signInWithPassword(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function sendOobCode(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function sendEmailVerification$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function sendPasswordResetEmail$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, sendOobCode(auth, request)];
      ***REMOVED***);
...
function sendSignInLinkToEmail$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, sendOobCode(auth, request)];
      ***REMOVED***);
...
function verifyAndChangeEmail(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, sendOobCode(auth, request)];
      ***REMOVED***);
 ...
 * limitations under the License.
 */
function signInWithEmailLink$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function signInWithEmailLinkForLinking(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithEmailLink" /* Endpoint.SIGN_IN_WITH_EMAIL_LINK */, _addTidIfNecessary(auth, request))];
      ***REMOVED***);
 ...
 */
/**
 * Interface that represents the credentials returned by ***REMOVED***@link EmailAuthProvider} for
 * ***REMOVED***@link ProviderId}.PASSWORD
 *
 * @remarks
 * Covers both ***REMOVED***@link SignInMethod}.EMAIL_PASSWORD and
 * ***REMOVED***@link SignInMethod}.EMAIL_LINK.
 *
 * @public
 */
var EmailAuthCredential = /** @class */ (function (_super) ***REMOVED***
    ...
    /** @internal */
    _tenantId) ***REMOVED***
        if (_tenantId === void 0) ***REMOVED*** _tenantId = null; }
  ...
  ***REMOVED***
    /** @internal */
    EmailAuthCredential._fromEmailAndPassword = function (email, password) ***REMOVED***
        return new EmailAuthCredential(email, password, "password" /* SignInMethod.EMAIL_PASSWORD */);
  ***REMOVED***;
    /** @internal */
    EmailAuthCredential._fromEmailAndCode = function (email, oobCode, tenantId) ***REMOVED***
        if (tenantId === void 0) ***REMOVED*** tenantId = null; }
        return new EmailAuthCredential(email, oobCode, "emailLink" /* SignInMethod.EMAIL_LINK */, tenantId);
  ***REMOVED***;
    /** ***REMOVED***@inheritdoc AuthCredential.toJSON} */
    EmailAuthCredential.prototype.toJSON = function () ***REMOVED***
        return ***REMOVED***
            email: this._email,
  ...
  ***REMOVED***;
    /**
     * Static method to deserialize a JSON representation of an object into an ***REMOVED***@link  AuthCredential}.
     *
     * @param json - Either `object` or the stringified representation of the object. When string is
     * provided, `JSON.parse` would be called first.
     *
     * @returns If the JSON input does not represent an ***REMOVED***@link AuthCredential}, null is returned.
     */
    EmailAuthCredential.fromJSON = function (json) ***REMOVED***
        var obj = typeof json === 'string' ? JSON.parse(json) : json;
        if ((obj === null || obj === void 0 ? void 0 : obj.email) && (obj === null || obj === void 0 ? void 0 : obj.password)) ***REMOVED***
            if (obj.signInMethod === "password" /* SignInMethod.EMAIL_PASSWORD */) ***REMOVED***
                return this._fromEmailAndPassword(obj.email, obj.password);
          ***REMOVED***
            else if (obj.signInMethod === "emailLink" /* SignInMethod.EMAIL_LINK */) ***REMOVED***
  ...
  ***REMOVED***;
    /** @internal */
    EmailAuthCredential.prototype._getIdTokenResponse = function (auth) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (this.signInMethod) ***REMOVED***
                    case "password" /* SignInMethod.EMAIL_PASSWORD */:
                        return [2 /*return*/, signInWithPassword(auth, ***REMOVED***
                                returnSecureToken: true,
                                email: this._email,
                                password: this._password
                          ***REMOVED***)];
                    case "emailLink" /* SignInMethod.EMAIL_LINK */:
                        return [2 /*return*/, signInWithEmailLink$1(auth, ***REMOVED***
                                email: this._email,
  ...
  ***REMOVED***;
    /** @internal */
    EmailAuthCredential.prototype._linkToIdToken = function (auth, idToken) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (this.signInMethod) ***REMOVED***
                    case "password" /* SignInMethod.EMAIL_PASSWORD */:
                        return [2 /*return*/, updateEmailPassword(auth, ***REMOVED***
                                idToken: idToken,
                                returnSecureToken: true,
                                email: this._email,
                                password: this._password
                          ***REMOVED***)];
                    case "emailLink" /* SignInMethod.EMAIL_LINK */:
                        return [2 /*return*/, signInWithEmailLinkForLinking(auth, ***REMOVED***
                                idToken: idToken,
                                email: this._email,
                                oobCode: this._password
                          ***REMOVED***)];
  ...
  ***REMOVED***;
    /** @internal */
    EmailAuthCredential.prototype._getReauthenticationResolver = function (auth) ***REMOVED***
 ...
 * limitations under the License.
 */
function signInWithIdp(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
/**
 * Represents the OAuth credentials returned by an ***REMOVED***@link OAuthProvider}.
 *
 * @remarks
 * Implementations specify the details about each auth provider's credential requirements.
 *
 * @public
 */
var OAuthCredential = /** @class */ (function (_super) ***REMOVED***
    __extends(OAuthCredential, _super);
    function OAuthCredential() ***REMOVED***
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.pendingToken = null;
        return _this;
  ***REMOVED***
    /** @internal */
    OAuthCredential._fromParams = function (params) ***REMOVED***
        var cred = new OAuthCredential(params.providerId, params.signInMethod);
        if (params.idToken || params.accessToken) ***REMOVED***
            // OAuth 2 and either ID token or access token.
            if (params.idToken) ***REMOVED***
                cred.idToken = params.idToken;
          ***REMOVED***
            if (params.accessToken) ***REMOVED***
                cred.accessToken = params.accessToken;
          ***REMOVED***
            // Add nonce if available and no pendingToken is present.
            if (params.nonce && !params.pendingToken) ***REMOVED***
                cred.nonce = params.nonce;
          ***REMOVED***
            if (params.pendingToken) ***REMOVED***
                cred.pendingToken = params.pendingToken;
          ***REMOVED***
      ***REMOVED***
        else if (params.oauthToken && params.oauthTokenSecret) ***REMOVED***
  ...
  ***REMOVED***;
    /** ***REMOVED***@inheritdoc AuthCredential.toJSON}  */
    OAuthCredential.prototype.toJSON = function () ***REMOVED***
        return ***REMOVED***
  ...
  ***REMOVED***;
    /** @internal */
    OAuthCredential.prototype._getIdTokenResponse = function (auth) ***REMOVED***
        var request = this.buildRequest();
        return signInWithIdp(auth, request);
  ***REMOVED***;
    /** @internal */
    OAuthCredential.prototype._linkToIdToken = function (auth, idToken) ***REMOVED***
        var request = this.buildRequest();
        request.idToken = idToken;
        return signInWithIdp(auth, request);
  ***REMOVED***;
    /** @internal */
    OAuthCredential.prototype._getReauthenticationResolver = function (auth) ***REMOVED***
        var request = this.buildRequest();
        request.autoCreate = false;
        return signInWithIdp(auth, request);
  ***REMOVED***;
    OAuthCredential.prototype.buildRequest = function () ***REMOVED***
        var request = ***REMOVED***
            requestUri: IDP_REQUEST_URI$1,
            returnSecureToken: true
      ***REMOVED***;
        if (this.pendingToken) ***REMOVED***
            request.pendingToken = this.pendingToken;
      ***REMOVED***
        else ***REMOVED***
            var postBody = ***REMOVED***};
            if (this.idToken) ***REMOVED***
                postBody['id_token'] = this.idToken;
          ***REMOVED***
            if (this.accessToken) ***REMOVED***
                postBody['access_token'] = this.accessToken;
          ***REMOVED***
            if (this.secret) ***REMOVED***
                postBody['oauth_token_secret'] = this.secret;
          ***REMOVED***
            postBody['providerId'] = this.providerId;
            if (this.nonce && !this.pendingToken) ***REMOVED***
 ...
 */
var _a;
function sendPhoneVerificationCode(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function signInWithPhoneNumber(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
function linkWithPhoneNumber(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var response;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                    response = _a.sent();
                    if (response.temporaryProof) ***REMOVED***
...
var VERIFY_PHONE_NUMBER_FOR_EXISTING_ERROR_MAP_ = (_a = ***REMOVED***},
    _a["USER_NOT_FOUND" /* ServerError.USER_NOT_FOUND */] = "user-not-found" /* AuthErrorCode.USER_DELETED */,
    _a);
function verifyPhoneNumberForExisting(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var apiRequest;
        return __generator(this, function (_a) ***REMOVED***
            apiRequest = __assign(__assign(***REMOVED***}, request), ***REMOVED*** operation: 'REAUTH' });
 ...
 */
/**
 * Represents the credentials returned by ***REMOVED***@link PhoneAuthProvider}.
 *
 * @public
 */
var PhoneAuthCredential = /** @class */ (function (_super) ***REMOVED***
    __extends(PhoneAuthCredential, _super);
    function PhoneAuthCredential(params) ***REMOVED***
        var _this = _super.call(this, "phone" /* ProviderId.PHONE */, "phone" /* SignInMethod.PHONE */) || this;
        _this.params = params;
        return _this;
  ***REMOVED***
    /** @internal */
    PhoneAuthCredential._fromVerification = function (verificationId, verificationCode) ***REMOVED***
        return new PhoneAuthCredential(***REMOVED*** verificationId: verificationId, verificationCode: verificationCode });
  ***REMOVED***;
    /** @internal */
    PhoneAuthCredential._fromTokenResponse = function (phoneNumber, temporaryProof) ***REMOVED***
        return new PhoneAuthCredential(***REMOVED*** phoneNumber: phoneNumber, temporaryProof: temporaryProof });
  ***REMOVED***;
    /** @internal */
    PhoneAuthCredential.prototype._getIdTokenResponse = function (auth) ***REMOVED***
        return signInWithPhoneNumber(auth, this._makeVerificationRequest());
  ***REMOVED***;
    /** @internal */
    PhoneAuthCredential.prototype._linkToIdToken = function (auth, idToken) ***REMOVED***
        return linkWithPhoneNumber(auth, __assign(***REMOVED*** idToken: idToken }, this._makeVerificationRequest()));
  ***REMOVED***;
    /** @internal */
    PhoneAuthCredential.prototype._getReauthenticationResolver = function (auth) ***REMOVED***
        return verifyPhoneNumberForExisting(auth, this._makeVerificationRequest());
  ***REMOVED***;
    /** @internal */
    PhoneAuthCredential.prototype._makeVerificationRequest = function () ***REMOVED***
        ...
        if (temporaryProof && phoneNumber) ***REMOVED***
            return ***REMOVED*** temporaryProof: temporaryProof, phoneNumber: phoneNumber };
      ***REMOVED***
        return ***REMOVED***
  ...
  ***REMOVED***;
    /** ***REMOVED***@inheritdoc AuthCredential.toJSON} */
    PhoneAuthCredential.prototype.toJSON = function () ***REMOVED***
        var obj = ***REMOVED***
            providerId: this.providerId
      ***REMOVED***;
        if (this.params.phoneNumber) ***REMOVED***
            obj.phoneNumber = this.params.phoneNumber;
      ***REMOVED***
        if (this.params.temporaryProof) ***REMOVED***
            obj.temporaryProof = this.params.temporaryProof;
      ***REMOVED***
        if (this.params.verificationCode) ***REMOVED***
            obj.verificationCode = this.params.verificationCode;
      ***REMOVED***
        if (this.params.verificationId) ***REMOVED***
            obj.verificationId = this.params.verificationId;
      ***REMOVED***
        return obj;
  ***REMOVED***;
    /** Generates a phone credential based on a plain object or a JSON string. */
    PhoneAuthCredential.fromJSON = function (json) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (!verificationCode &&
            !verificationId &&
            !phoneNumber &&
            !temporaryProof) ***REMOVED***
            return null;
      ***REMOVED***
        return new PhoneAuthCredential(***REMOVED***
 ...
 * @param mode
 */
function parseMode(mode) ***REMOVED***
    switch (mode) ***REMOVED***
        case 'recoverEmail':
 ...
 * @param url
 */
function parseDeepLink(url) ***REMOVED***
 ...
 * @public
 */
var ActionCodeURL = /** @class */ (function () ***REMOVED***
    /**
     * @param actionLink - The link from which to extract the URL.
     * @returns The ***REMOVED***@link ActionCodeURL} object, or null if the link is invalid.
     *
     * @internal
     */
    function ActionCodeURL(actionLink) ***REMOVED***
  ...
  ***REMOVED***
    /**
     * Parses the email action link string and returns an ***REMOVED***@link ActionCodeURL} if the link is valid,
     ...
     * @public
     */
    ActionCodeURL.parseLink = function (link) ***REMOVED***
...
/**
 * Parses the email action link string and returns an ***REMOVED***@link ActionCodeURL} if
 * the link is valid, otherwise returns null.
 *
 * @public
 */
function parseActionCodeURL(link) ***REMOVED***
 ...
 */
/**
 * Provider for generating ***REMOVED***@link EmailAuthCredential}.
 *
 * @public
 */
var EmailAuthProvider = /** @class */ (function () ***REMOVED***
    function EmailAuthProvider() ***REMOVED***
        /**
         * Always set to ***REMOVED***@link ProviderId}.PASSWORD, even for email link.
         */
        this.providerId = EmailAuthProvider.PROVIDER_ID;
  ***REMOVED***
    /**
     * Initialize an ***REMOVED***@link AuthCredential} using an email and password.
     *
     * @example
     * ```javascript
     ...
     */
    EmailAuthProvider.credential = function (email, password) ***REMOVED***
        return EmailAuthCredential._fromEmailAndPassword(email, password);
  ***REMOVED***;
    /**
     * Initialize an ***REMOVED***@link AuthCredential} using an email and an email link after a sign in with
     ...
     * ```
     *
     * @param auth - The ***REMOVED***@link Auth} instance used to verify the link.
     * @param email - Email address.
     * @param emailLink - Sign-in email link.
     * @returns - The auth provider credential.
     */
    EmailAuthProvider.credentialWithLink = function (email, emailLink) ***REMOVED***
  ...
  ***REMOVED***;
    ...
    /**
     * Always set to ***REMOVED***@link SignInMethod}.EMAIL_PASSWORD.
     */
    EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD = "password" /* SignInMethod.EMAIL_PASSWORD */;
    /**
     * Always set to ***REMOVED***@link SignInMethod}.EMAIL_LINK.
     */
 ...
 * @public
 */
var FederatedAuthProvider = /** @class */ (function () ***REMOVED***
    /**
     * Constructor for generic OAuth providers.
     *
     * @param providerId - Provider for which credentials should be generated.
     */
    function FederatedAuthProvider(providerId) ***REMOVED***
        this.providerId = providerId;
        /** @internal */
        this.defaultLanguageCode = null;
        /** @internal */
        this.customParameters = ***REMOVED***};
  ***REMOVED***
    /**
     ...
     */
    FederatedAuthProvider.prototype.setDefaultLanguage = function (languageCode) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    FederatedAuthProvider.prototype.setCustomParameters = function (customOAuthParameters) ***REMOVED***
        this.customParameters = customOAuthParameters;
        return this;
  ***REMOVED***;
    /**
     * Retrieve the current list of ***REMOVED***@link CustomParameters}.
     */
    FederatedAuthProvider.prototype.getCustomParameters = function () ***REMOVED***
 ...
 * ***REMOVED***@link OAuthProvider} so that child providers (like
 * ***REMOVED***@link GoogleAuthProvider}) don't inherit the `credential` instance method.
 * Instead, they rely on a static `credential` method.
 */
var BaseOAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(BaseOAuthProvider, _super);
    function BaseOAuthProvider() ***REMOVED***
        var _this = _super !== null && _super.apply(this, arguments) || this;
        /** @internal */
        _this.scopes = [];
        return _this;
  ***REMOVED***
     ...
     */
    BaseOAuthProvider.prototype.addScope = function (scope) ***REMOVED***
        // If not already added, add scope to list.
        if (!this.scopes.includes(scope)) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    BaseOAuthProvider.prototype.getScopes = function () ***REMOVED***
        return __spreadArray([], this.scopes, true);
  ***REMOVED***;
    return BaseOAuthProvider;
}(FederatedAuthProvider));
/**
 * Provider for generating generic ***REMOVED***@link OAuthCredential}.
 *
 * @example
 * ```javascript
 ...
 * @public
 */
var OAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(OAuthProvider, _super);
    function OAuthProvider() ***REMOVED***
        return _super !== null && _super.apply(this, arguments) || this;
  ***REMOVED***
    /**
     * Creates an ***REMOVED***@link OAuthCredential} from a JSON string or a plain object.
     * @param json - A plain object or a JSON string
     */
    OAuthProvider.credentialFromJSON = function (json) ***REMOVED***
        var obj = typeof json === 'string' ? JSON.parse(json) : json;
        _assert('providerId' in obj && 'signInMethod' in obj, "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
        return OAuthCredential._fromParams(obj);
  ***REMOVED***;
    /**
     * Creates a ***REMOVED***@link OAuthCredential} from a generic OAuth provider's access token or ID token.
     *
     * @remarks
     ...
     * const provider = new OAuthProvider('google.com');
     * const credential = provider.credential(***REMOVED***
     ...
     */
    OAuthProvider.prototype.credential = function (params) ***REMOVED***
        return this._credential(__assign(__assign(***REMOVED***}, params), ***REMOVED*** nonce: params.rawNonce }));
  ***REMOVED***;
    /** An internal credential method that accepts more permissive options */
    OAuthProvider.prototype._credential = function (params) ***REMOVED***
        _assert(params.idToken || params.accessToken, "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
        // For OAuthCredential, sign in method is same as providerId.
        return OAuthCredential._fromParams(__assign(__assign(***REMOVED***}, params), ***REMOVED*** providerId: this.providerId, signInMethod: this.providerId }));
  ***REMOVED***;
    /**
     * Used to extract the underlying ***REMOVED***@link OAuthCredential} from a ***REMOVED***@link UserCredential}.
     *
     * @param userCredential - The user credential.
     */
    OAuthProvider.credentialFromResult = function (userCredential) ***REMOVED***
        return OAuthProvider.oauthCredentialFromTaggedObject(userCredential);
  ***REMOVED***;
    /**
     * Used to extract the underlying ***REMOVED***@link OAuthCredential} from a ***REMOVED***@link AuthError} which was
     * thrown during a sign-in, link, or reauthenticate operation.
     *
     * @param userCredential - The user credential.
     */
    OAuthProvider.credentialFromError = function (error) ***REMOVED***
        return OAuthProvider.oauthCredentialFromTaggedObject((error.customData || ***REMOVED***}));
  ***REMOVED***;
    OAuthProvider.oauthCredentialFromTaggedObject = function (_a) ***REMOVED***
      ...
      ***REMOVED***
        try ***REMOVED***
            return new OAuthProvider(providerId)._credential(***REMOVED***
 ...
 */
/**
 * Provider for generating an ***REMOVED***@link OAuthCredential} for ***REMOVED***@link ProviderId}.FACEBOOK.
 *
 * @example
 * ```javascript
 * // Sign in using a redirect.
 ...
 * @public
 */
var FacebookAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(FacebookAuthProvider, _super);
    function FacebookAuthProvider() ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    FacebookAuthProvider.credential = function (accessToken) ***REMOVED***
        return OAuthCredential._fromParams(***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    FacebookAuthProvider.credentialFromResult = function (userCredential) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    FacebookAuthProvider.credentialFromError = function (error) ***REMOVED***
        return FacebookAuthProvider.credentialFromTaggedObject((error.customData || ***REMOVED***}));
  ***REMOVED***;
    FacebookAuthProvider.credentialFromTaggedObject = function (_a) ***REMOVED***
        var tokenResponse = _a._tokenResponse;
        if (!tokenResponse || !('oauthAccessToken' in tokenResponse)) ***REMOVED***
            return null;
      ***REMOVED***
        if (!tokenResponse.oauthAccessToken) ***REMOVED***
            return null;
      ***REMOVED***
        try ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    /** Always set to ***REMOVED***@link SignInMethod}.FACEBOOK. */
    FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD = "facebook.com" /* SignInMethod.FACEBOOK */;
    /** Always set to ***REMOVED***@link ProviderId}.FACEBOOK. */
 ...
 */
/**
 * Provider for generating an an ***REMOVED***@link OAuthCredential} for ***REMOVED***@link ProviderId}.GOOGLE.
 *
 * @example
 * ```javascript
 * // Sign in using a redirect.
 ...
 * @public
 */
var GoogleAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(GoogleAuthProvider, _super);
    function GoogleAuthProvider() ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    GoogleAuthProvider.credential = function (idToken, accessToken) ***REMOVED***
        return OAuthCredential._fromParams(***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    GoogleAuthProvider.credentialFromResult = function (userCredential) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    GoogleAuthProvider.credentialFromError = function (error) ***REMOVED***
        return GoogleAuthProvider.credentialFromTaggedObject((error.customData || ***REMOVED***}));
  ***REMOVED***;
    GoogleAuthProvider.credentialFromTaggedObject = function (_a) ***REMOVED***
        var tokenResponse = _a._tokenResponse;
        if (!tokenResponse) ***REMOVED***
            return null;
      ***REMOVED***
        var _b = tokenResponse, oauthIdToken = _b.oauthIdToken, oauthAccessToken = _b.oauthAccessToken;
        if (!oauthIdToken && !oauthAccessToken) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    /** Always set to ***REMOVED***@link SignInMethod}.GOOGLE. */
    GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD = "google.com" /* SignInMethod.GOOGLE */;
    /** Always set to ***REMOVED***@link ProviderId}.GOOGLE. */
 ...
 */
/**
 * Provider for generating an ***REMOVED***@link OAuthCredential} for ***REMOVED***@link ProviderId}.GITHUB.
 *
 * @remarks
 * GitHub requires an OAuth 2.0 redirect, so you can either handle the redirect directly, or use
 * the ***REMOVED***@link signInWithPopup} handler:
 *
 * @example
 * ```javascript
 * // Sign in using a redirect.
 ...
 * @public
 */
var GithubAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(GithubAuthProvider, _super);
    function GithubAuthProvider() ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    GithubAuthProvider.credential = function (accessToken) ***REMOVED***
        return OAuthCredential._fromParams(***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    GithubAuthProvider.credentialFromResult = function (userCredential) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    GithubAuthProvider.credentialFromError = function (error) ***REMOVED***
        return GithubAuthProvider.credentialFromTaggedObject((error.customData || ***REMOVED***}));
  ***REMOVED***;
    GithubAuthProvider.credentialFromTaggedObject = function (_a) ***REMOVED***
        var tokenResponse = _a._tokenResponse;
        if (!tokenResponse || !('oauthAccessToken' in tokenResponse)) ***REMOVED***
            return null;
      ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    /** Always set to ***REMOVED***@link SignInMethod}.GITHUB. */
    GithubAuthProvider.GITHUB_SIGN_IN_METHOD = "github.com" /* SignInMethod.GITHUB */;
    /** Always set to ***REMOVED***@link ProviderId}.GITHUB. */
 ...
 * @public
 */
var SAMLAuthCredential = /** @class */ (function (_super) ***REMOVED***
    __extends(SAMLAuthCredential, _super);
    /** @internal */
    function SAMLAuthCredential(providerId, pendingToken) ***REMOVED***
        var _this = _super.call(this, providerId, providerId) || this;
        _this.pendingToken = pendingToken;
        return _this;
  ***REMOVED***
    /** @internal */
    SAMLAuthCredential.prototype._getIdTokenResponse = function (auth) ***REMOVED***
        var request = this.buildRequest();
        return signInWithIdp(auth, request);
  ***REMOVED***;
    /** @internal */
    SAMLAuthCredential.prototype._linkToIdToken = function (auth, idToken) ***REMOVED***
        var request = this.buildRequest();
        request.idToken = idToken;
        return signInWithIdp(auth, request);
  ***REMOVED***;
    /** @internal */
    SAMLAuthCredential.prototype._getReauthenticationResolver = function (auth) ***REMOVED***
        var request = this.buildRequest();
        request.autoCreate = false;
        return signInWithIdp(auth, request);
  ***REMOVED***;
    /** ***REMOVED***@inheritdoc AuthCredential.toJSON}  */
    SAMLAuthCredential.prototype.toJSON = function () ***REMOVED***
        return ***REMOVED***
            signInMethod: this.signInMethod,
            providerId: this.providerId,
            pendingToken: this.pendingToken
  ...
  ***REMOVED***;
     ...
     * @internal
     */
    SAMLAuthCredential._create = function (providerId, pendingToken) ***REMOVED***
        return new SAMLAuthCredential(providerId, pendingToken);
  ***REMOVED***;
    SAMLAuthCredential.prototype.buildRequest = function () ***REMOVED***
        return ***REMOVED***
...
/**
 * An ***REMOVED***@link AuthProvider} for SAML.
 *
 * @public
 */
var SAMLAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(SAMLAuthProvider, _super);
    /**
     * Constructor. The providerId must start with "saml."
     * @param providerId - SAML provider ID.
     */
    function SAMLAuthProvider(providerId) ***REMOVED***
        _assert(providerId.startsWith(SAML_PROVIDER_PREFIX), "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
        return _super.call(this, providerId) || this;
  ***REMOVED***
    /**
     * Generates an ***REMOVED***@link AuthCredential} from a ***REMOVED***@link UserCredential} after a
     * successful SAML flow completes.
     *
     * @remarks
     *
     * For example, to get an ***REMOVED***@link AuthCredential}, you could write the
     * following code:
     *
     * ```js
     ...
     * @param userCredential - The user credential.
     */
    SAMLAuthProvider.credentialFromResult = function (userCredential) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    SAMLAuthProvider.credentialFromError = function (error) ***REMOVED***
        return SAMLAuthProvider.samlCredentialFromTaggedObject((error.customData || ***REMOVED***}));
  ***REMOVED***;
    /**
     * Creates an ***REMOVED***@link AuthCredential} from a JSON string or a plain object.
     * @param json - A plain object or a JSON string
     */
    SAMLAuthProvider.credentialFromJSON = function (json) ***REMOVED***
        var credential = SAMLAuthCredential.fromJSON(json);
        _assert(credential, "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
        return credential;
  ***REMOVED***;
    SAMLAuthProvider.samlCredentialFromTaggedObject = function (_a) ***REMOVED***
        var tokenResponse = _a._tokenResponse;
        if (!tokenResponse) ***REMOVED***
            return null;
      ***REMOVED***
        var _b = tokenResponse, pendingToken = _b.pendingToken, providerId = _b.providerId;
        if (!pendingToken || !providerId) ***REMOVED***
            return null;
      ***REMOVED***
        try ***REMOVED***
 ...
 */
/**
 * Provider for generating an ***REMOVED***@link OAuthCredential} for ***REMOVED***@link ProviderId}.TWITTER.
 *
 * @example
 * ```javascript
 * // Sign in using a redirect.
 ...
 * @public
 */
var TwitterAuthProvider = /** @class */ (function (_super) ***REMOVED***
    __extends(TwitterAuthProvider, _super);
    function TwitterAuthProvider() ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    TwitterAuthProvider.credential = function (token, secret) ***REMOVED***
        return OAuthCredential._fromParams(***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    TwitterAuthProvider.credentialFromResult = function (userCredential) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     * @param userCredential - The user credential.
     */
    TwitterAuthProvider.credentialFromError = function (error) ***REMOVED***
        return TwitterAuthProvider.credentialFromTaggedObject((error.customData || ***REMOVED***}));
  ***REMOVED***;
    TwitterAuthProvider.credentialFromTaggedObject = function (_a) ***REMOVED***
        var tokenResponse = _a._tokenResponse;
        if (!tokenResponse) ***REMOVED***
            return null;
      ***REMOVED***
        var _b = tokenResponse, oauthAccessToken = _b.oauthAccessToken, oauthTokenSecret = _b.oauthTokenSecret;
        if (!oauthAccessToken || !oauthTokenSecret) ***REMOVED***
            return null;
      ***REMOVED***
        try ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    /** Always set to ***REMOVED***@link SignInMethod}.TWITTER. */
    TwitterAuthProvider.TWITTER_SIGN_IN_METHOD = "twitter.com" /* SignInMethod.TWITTER */;
    /** Always set to ***REMOVED***@link ProviderId}.TWITTER. */
 ...
 * limitations under the License.
 */
function signUp(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * limitations under the License.
 */
var UserCredentialImpl = /** @class */ (function () ***REMOVED***
    function UserCredentialImpl(params) ***REMOVED***
        this.user = params.user;
        this.providerId = params.providerId;
        this._tokenResponse = params._tokenResponse;
        this.operationType = params.operationType;
  ***REMOVED***
    UserCredentialImpl._fromIdTokenResponse = function (auth, operationType, idTokenResponse, isAnonymous) ***REMOVED***
        if (isAnonymous === void 0) ***REMOVED*** isAnonymous = false; }
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        ...
                        userCred = new UserCredentialImpl(***REMOVED***
                            user: user,
                            providerId: providerId,
      ...
      ***REMOVED***);
  ***REMOVED***;
    UserCredentialImpl._forOperation = function (user, operationType, response) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var providerId;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new UserCredentialImpl(***REMOVED***
                                user: user,
                                providerId: providerId,
...
function providerIdForResponse(response) ***REMOVED***
    if (response.providerId) ***REMOVED***
        return response.providerId;
  ***REMOVED***
    if ('phoneNumber' in response) ***REMOVED***
 ...
 * @public
 */
function signInAnonymously(auth) ***REMOVED***
    var _a;
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                ...
                case 1:
                    _b.sent();
                    if ((_a = authInternal.currentUser) === null || _a === void 0 ? void 0 : _a.isAnonymous) ***REMOVED***
                        ...
                        return [2 /*return*/, new UserCredentialImpl(***REMOVED***
                          ...
                          ***REMOVED***)];
                  ***REMOVED***
                    return [4 /*yield*/, signUp(authInternal, ***REMOVED***
                            returnSecureToken: true
                      ***REMOVED***)];
                case 2:
                    response = _b.sent();
 ...
 * limitations under the License.
 */
var MultiFactorError = /** @class */ (function (_super) ***REMOVED***
    __extends(MultiFactorError, _super);
    function MultiFactorError(auth, error, operationType, user) ***REMOVED***
        var _this = this;
        var _a;
      ...
      ***REMOVED***;
        return _this;
  ***REMOVED***
    MultiFactorError._fromErrorAndOperation = function (auth, error, operationType, user) ***REMOVED***
        return new MultiFactorError(auth, error, operationType, user);
  ***REMOVED***;
    return MultiFactorError;
}(FirebaseError));
function _processCredentialSavingMfaContextIfNecessary(auth, operationType, credential, user) ***REMOVED***
    var idTokenProvider = operationType === "reauthenticate" /* OperationType.REAUTHENTICATE */
        ? credential._getReauthenticationResolver(auth)
        : credential._getIdTokenResponse(auth);
    return idTokenProvider.catch(function (error) ***REMOVED***
        if (error.code === "auth/".concat("multi-factor-auth-required" /* AuthErrorCode.MFA_REQUIRED */)) ***REMOVED***
 ...
 */
function providerDataAsNames(providerData) ***REMOVED***
    return new Set(providerData
        .map(function (_a) ***REMOVED***
        var providerId = _a.providerId;
        return providerId;
  ***REMOVED***)
        .filter(function (pid) ***REMOVED*** return !!pid; }));
}
 ...
 * @public
 */
function unlink(user, providerId) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_d) ***REMOVED***
            switch (_d.label) ***REMOVED***
                ...
                case 3:
                    ...
                    userInternal.providerData = userInternal.providerData.filter(function (pd) ***REMOVED***
                        return providersLeft.has(pd.providerId);
                  ***REMOVED***);
                    if (!providersLeft.has("phone" /* ProviderId.PHONE */)) ***REMOVED***
...
function _link$1(user, credential, bypassAuthState) ***REMOVED***
    if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
...
function _assertLinkedStatus(expected, user, provider) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 * limitations under the License.
 */
function _reauthenticate(user, credential, bypassAuthState) ***REMOVED***
    if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 3:
                    ...
                    if ((e_1 === null || e_1 === void 0 ? void 0 : e_1.code) === "auth/".concat("user-not-found" /* AuthErrorCode.USER_DELETED */)) ***REMOVED***
 ...
 * limitations under the License.
 */
function _signInWithCredential(auth, credential, bypassAuthState) ***REMOVED***
    if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 *
 * @remarks
 * An ***REMOVED***@link AuthProvider} can be used to generate the credential.
 *
 * @param auth - The ***REMOVED***@link Auth} instance.
 ...
 * @public
 */
function signInWithCredential(auth, credential) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * @public
 */
function linkWithCredential(user, credential) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var userInternal;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 *
 * @remarks
 * Use before operations such as ***REMOVED***@link updatePassword} that require tokens from recent sign-in
 ...
 * @public
 */
function reauthenticateWithCredential(user, credential) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * limitations under the License.
 */
function signInWithCustomToken$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * ***REMOVED***@link https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth#createcustomtoken | createCustomToken}
 * method in the ***REMOVED***@link https://firebase.google.com/docs/auth/admin | Admin SDK} .
 *
 ...
 * @public
 */
function signInWithCustomToken(auth, customToken) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
                    authInternal = _castAuth(auth);
                    return [4 /*yield*/, signInWithCustomToken$1(authInternal, ***REMOVED***
                            token: customToken,
                            returnSecureToken: true
                      ***REMOVED***)];
                case 1:
 ...
 * limitations under the License.
 */
var MultiFactorInfoImpl = /** @class */ (function () ***REMOVED***
    function MultiFactorInfoImpl(factorId, response) ***REMOVED***
        this.factorId = factorId;
        this.uid = response.mfaEnrollmentId;
        this.enrollmentTime = new Date(response.enrolledAt).toUTCString();
        this.displayName = response.displayName;
  ***REMOVED***
    MultiFactorInfoImpl._fromServerResponse = function (auth, enrollment) ***REMOVED***
        if ('phoneInfo' in enrollment) ***REMOVED***
...
var PhoneMultiFactorInfoImpl = /** @class */ (function (_super) ***REMOVED***
    __extends(PhoneMultiFactorInfoImpl, _super);
    function PhoneMultiFactorInfoImpl(response) ***REMOVED***
        var _this = _super.call(this, "phone" /* FactorId.PHONE */, response) || this;
        _this.phoneNumber = response.phoneInfo;
        return _this;
  ***REMOVED***
    PhoneMultiFactorInfoImpl._fromServerResponse = function (_auth, enrollment) ***REMOVED***
 ...
 * limitations under the License.
 */
function _setActionCodeSettingsOnRequest(auth, request, actionCodeSettings) ***REMOVED***
    var _a;
    ...
    if (actionCodeSettings.iOS) ***REMOVED***
        _assert(actionCodeSettings.iOS.bundleId.length > 0, auth, "missing-ios-bundle-id" /* AuthErrorCode.MISSING_IOS_BUNDLE_ID */);
        request.iOSBundleId = actionCodeSettings.iOS.bundleId;
  ***REMOVED***
    if (actionCodeSettings.android) ***REMOVED***
 ...
 *
 * @remarks
 * To complete the password reset, call ***REMOVED***@link confirmPasswordReset} with the code supplied in
 * the email sent to the user, along with the new password specified by the user.
 *
 * @example
 * ```javascript
 * const actionCodeSettings = ***REMOVED***
 ...
 * @param actionCodeSettings - The ***REMOVED***@link ActionCodeSettings}.
 *
 * @public
 */
function sendPasswordResetEmail(auth, email, actionCodeSettings) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 * @public
 */
function confirmPasswordReset(auth, oobCode, newPassword) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, resetPassword(getModularInstance(auth), ***REMOVED***
                        oobCode: oobCode,
 ...
 * @public
 */
function applyActionCode(auth, oobCode) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, applyActionCode$1(getModularInstance(auth), ***REMOVED*** oobCode: oobCode })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
          ***REMOVED***
 ...
 * @public
 */
function checkActionCode(auth, oobCode) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
                    authModular = getModularInstance(auth);
                    return [4 /*yield*/, resetPassword(authModular, ***REMOVED*** oobCode: oobCode })];
                case 1:
                    response = _a.sent();
 ...
 * @public
 */
function verifyPasswordResetCode(auth, code) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var data;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 * @public
 */
function createUserWithEmailAndPassword(auth, email, password) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var authInternal, response, userCredential;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 * the user's account in your Firebase project. See also: ***REMOVED***@link createUserWithEmailAndPassword}.
 *
 * @param auth - The ***REMOVED***@link Auth} instance.
 ...
 * @public
 */
function signInWithEmailAndPassword(auth, email, password) ***REMOVED***
 ...
 *
 * To complete sign in with the email link, call ***REMOVED***@link signInWithEmailLink} with the email
 ...
 * if(isSignInWithEmailLink(auth, emailLink)) ***REMOVED***
 *   await signInWithEmailLink(auth, 'user@example.com', emailLink);
 * }
 * ```
 *
 * @param authInternal - The ***REMOVED***@link Auth} instance.
 * @param email - The user's email address.
 * @param actionCodeSettings - The ***REMOVED***@link ActionCodeSettings}.
 *
 * @public
 */
function sendSignInLinkToEmail(auth, email, actionCodeSettings) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var authModular, request;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
/**
 * Checks if an incoming link is a sign-in with email link suitable for ***REMOVED***@link signInWithEmailLink}.
 *
 * @param auth - The ***REMOVED***@link Auth} instance.
 ...
 * @public
 */
function isSignInWithEmailLink(auth, emailLink) ***REMOVED***
    var actionCodeUrl = ActionCodeURL.parseLink(emailLink);
 ...
 * @public
 */
function signInWithEmailLink(auth, email, emailLink) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 * limitations under the License.
 */
function createAuthUri(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 * ***REMOVED***@link EmailAuthProvider} which has 2 methods of sign-in,
 * ***REMOVED***@link SignInMethod}.EMAIL_PASSWORD and
 * ***REMOVED***@link SignInMethod}.EMAIL_LINK.
 *
 * @param auth - The ***REMOVED***@link Auth} instance.
 * @param email - The user's email address.
 ...
 * @public
 */
function fetchSignInMethodsForEmail(auth, email) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 *
 * @remarks
 * The verification process is completed by calling ***REMOVED***@link applyActionCode}.
 *
 * @example
 * ```javascript
 * const actionCodeSettings = ***REMOVED***
 ...
 * @public
 */
function sendEmailVerification(user, actionCodeSettings) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 * @public
 */
function verifyBeforeUpdateEmail(user, newEmail, actionCodeSettings) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var userInternal, idToken, request, email;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
 ...
 * limitations under the License.
 */
function updateProfile$1(auth, request) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:update" /* Endpoint.SET_ACCOUNT_INFO */, request)];
      ***REMOVED***);
 ...
 * @public
 */
function updateProfile(user, _a) ***REMOVED***
    ...
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return __generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                    if (displayName === undefined && photoUrl === undefined) ***REMOVED***
                        return [2 /*return*/];
                  ***REMOVED***
                    userInternal = getModularInstance(user);
                    return [4 /*yield*/, userInternal.getIdToken()];
                ...
                case 2:
                    ...
                    passwordProvider = userInternal.providerData.find(function (_a) ***REMOVED***
                        var providerId = _a.providerId;
                        return providerId === "password" /* ProviderId.PASSWORD */;
                  ***REMOVED***);
                    if (passwordProvider) ***REMOVED***
 ...
 * @public
 */
function updateEmail(user, newEmail) ***REMOVED***
 ...
 * @public
 */
function updatePassword(user, newPassword) ***REMOVED***
    return updateEmailOrPassword(getModularInstance(user), null, newPassword);
}
function updateEmailOrPassword(user, email, password) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 *
 */
function _fromIdTokenResponse(idTokenResponse) ***REMOVED***
    var _a, _b;
    if (!idTokenResponse) ***REMOVED***
        return null;
  ***REMOVED***
    ...
    if (!providerId && (idTokenResponse === null || idTokenResponse === void 0 ? void 0 : idTokenResponse.idToken)) ***REMOVED***
...
var GenericAdditionalUserInfo = /** @class */ (function () ***REMOVED***
    function GenericAdditionalUserInfo(isNewUser, providerId, profile) ***REMOVED***
        if (profile === void 0) ***REMOVED*** profile = ***REMOVED***}; }
...
var FederatedAdditionalUserInfoWithUsername = /** @class */ (function (_super) ***REMOVED***
    __extends(FederatedAdditionalUserInfoWithUsername, _super);
    function FederatedAdditionalUserInfoWithUsername(isNewUser, providerId, profile, username) ***REMOVED***
...
var FacebookAdditionalUserInfo = /** @class */ (function (_super) ***REMOVED***
    __extends(FacebookAdditionalUserInfo, _super);
    function FacebookAdditionalUserInfo(isNewUser, profile) ***REMOVED***
        return _super.call(this, isNewUser, "facebook.com" /* ProviderId.FACEBOOK */, profile) || this;
  ***REMOVED***
    return FacebookAdditionalUserInfo;
}(GenericAdditionalUserInfo));
var GithubAdditionalUserInfo = /** @class */ (function (_super) ***REMOVED***
    __extends(GithubAdditionalUserInfo, _super);
    function GithubAdditionalUserInfo(isNewUser, profile) ***REMOVED***
...
var GoogleAdditionalUserInfo = /** @class */ (function (_super) ***REMOVED***
    __extends(GoogleAdditionalUserInfo, _super);
    function GoogleAdditionalUserInfo(isNewUser, profile) ***REMOVED***
        return _super.call(this, isNewUser, "google.com" /* ProviderId.GOOGLE */, profile) || this;
  ***REMOVED***
    return GoogleAdditionalUserInfo;
}(GenericAdditionalUserInfo));
var TwitterAdditionalUserInfo = /** @class */ (function (_super) ***REMOVED***
    __extends(TwitterAdditionalUserInfo, _super);
    function TwitterAdditionalUserInfo(isNewUser, profile, screenName) ***REMOVED***
        return _super.call(this, isNewUser, "twitter.com" /* ProviderId.TWITTER */, profile, screenName) || this;
  ***REMOVED***
    return TwitterAdditionalUserInfo;
}(FederatedAdditionalUserInfoWithUsername));
/**
 * Extracts provider specific ***REMOVED***@link AdditionalUserInfo} for the given credential.
 *
 * @param userCredential - The user credential.
 *
 * @public
 */
function getAdditionalUserInfo(userCredential) ***REMOVED***
    var _a = userCredential, user = _a.user, _tokenResponse = _a._tokenResponse;
    if (user.isAnonymous && !_tokenResponse) ***REMOVED***
 ...
 * @public
 */
function setPersistence(auth, persistence) ***REMOVED***
 ...
 * @public
 */
function onIdTokenChanged(auth, nextOrObserver, error, completed) ***REMOVED***
 ...
 */
function beforeAuthStateChanged(auth, callback, onAbort) ***REMOVED***
 ...
 * @public
 */
function onAuthStateChanged(auth, nextOrObserver, error, completed) ***REMOVED***
 ...
 * @public
 */
function useDeviceLanguage(auth) ***REMOVED***
 ...
 * @public
 */
function updateCurrentUser(auth, user) ***REMOVED***
 ...
 * @public
 */
function deleteUser(user) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
var MultiFactorSessionImpl = /** @class */ (function () ***REMOVED***
    function MultiFactorSessionImpl(type, credential, auth) ***REMOVED***
        this.type = type;
        this.credential = credential;
        this.auth = auth;
  ***REMOVED***
    MultiFactorSessionImpl._fromIdtoken = function (idToken, auth) ***REMOVED***
        return new MultiFactorSessionImpl("enroll" /* MultiFactorSessionType.ENROLL */, idToken, auth);
  ***REMOVED***;
    MultiFactorSessionImpl._fromMfaPendingCredential = function (mfaPendingCredential) ***REMOVED***
        return new MultiFactorSessionImpl("signin" /* MultiFactorSessionType.SIGN_IN */, mfaPendingCredential);
  ***REMOVED***;
    MultiFactorSessionImpl.prototype.toJSON = function () ***REMOVED***
        var _a;
        var key = this.type === "enroll" /* MultiFactorSessionType.ENROLL */
            ? 'idToken'
            : 'pendingCredential';
        return ***REMOVED***
            multiFactorSession: (_a = ***REMOVED***},
                _a[key] = this.credential,
                _a)
      ***REMOVED***;
  ***REMOVED***;
    MultiFactorSessionImpl.fromJSON = function (obj) ***REMOVED***
        var _a, _b;
        if (obj === null || obj === void 0 ? void 0 : obj.multiFactorSession) ***REMOVED***
            if ((_a = obj.multiFactorSession) === null || _a === void 0 ? void 0 : _a.pendingCredential) ***REMOVED***
                return MultiFactorSessionImpl._fromMfaPendingCredential(obj.multiFactorSession.pendingCredential);
          ***REMOVED***
            else if ((_b = obj.multiFactorSession) === null || _b === void 0 ? void 0 : _b.idToken) ***REMOVED***
 ...
 * limitations under the License.
 */
var MultiFactorResolverImpl = /** @class */ (function () ***REMOVED***
    function MultiFactorResolverImpl(session, hints, signInResolver) ***REMOVED***
        this.session = session;
        this.hints = hints;
        this.signInResolver = signInResolver;
  ***REMOVED***
    /** @internal */
    MultiFactorResolverImpl._fromError = function (authExtern, error) ***REMOVED***
        var _this = this;
        var auth = _castAuth(authExtern);
        var serverResponse = error.customData._serverResponse;
        var hints = (serverResponse.mfaInfo || []).map(function (enrollment) ***REMOVED***
      ...
      ***REMOVED***);
        ...
        return new MultiFactorResolverImpl(session, hints, function (assertion) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    ...
                    case 1:
                        ...
                        idTokenResponse = __assign(__assign(***REMOVED***}, serverResponse), ***REMOVED*** idToken: mfaResponse.idToken, refreshToken: mfaResponse.refreshToken });
      ...
      ***REMOVED***); });
  ***REMOVED***;
    MultiFactorResolverImpl.prototype.resolveSignIn = function (assertionExtern) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var assertion;
            return __generator(this, function (_a) ***REMOVED***
...
/**
 * Provides a ***REMOVED***@link MultiFactorResolver} suitable for completion of a
 * multi-factor flow.
 *
 * @param auth - The ***REMOVED***@link Auth} instance.
 * @param error - The ***REMOVED***@link MultiFactorError} raised during a sign-in, or
 * reauthentication operation.
 *
 * @public
 */
function getMultiFactorResolver(auth, error) ***REMOVED***
    var _a;
 ...
 * limitations under the License.
 */
function startEnrollPhoneMfa(auth, request) ***REMOVED***
    return _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v2/accounts/mfaEnrollment:start" /* Endpoint.START_MFA_ENROLLMENT */, _addTidIfNecessary(auth, request));
}
function finalizeEnrollPhoneMfa(auth, request) ***REMOVED***
    return _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v2/accounts/mfaEnrollment:finalize" /* Endpoint.FINALIZE_MFA_ENROLLMENT */, _addTidIfNecessary(auth, request));
}
function withdrawMfa(auth, request) ***REMOVED***
    return _performApiRequest(auth, "POST" /* HttpMethod.POST */, "/v2/accounts/mfaEnrollment:withdraw" /* Endpoint.WITHDRAW_MFA */, _addTidIfNecessary(auth, request));
}

var MultiFactorUserImpl = /** @class */ (function () ***REMOVED***
    function MultiFactorUserImpl(user) ***REMOVED***
        var _this = this;
        this.user = user;
        this.enrolledFactors = [];
        user._onReload(function (userInfo) ***REMOVED***
            if (userInfo.mfaInfo) ***REMOVED***
                _this.enrolledFactors = userInfo.mfaInfo.map(function (enrollment) ***REMOVED***
                    return MultiFactorInfoImpl._fromServerResponse(user.auth, enrollment);
              ***REMOVED***);
          ***REMOVED***
      ***REMOVED***);
  ***REMOVED***
    MultiFactorUserImpl._fromUser = function (user) ***REMOVED***
        return new MultiFactorUserImpl(user);
  ***REMOVED***;
    MultiFactorUserImpl.prototype.getSession = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var _a, _b;
            return __generator(this, function (_c) ***REMOVED***
                switch (_c.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    MultiFactorUserImpl.prototype.enroll = function (assertionExtern, displayName) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    MultiFactorUserImpl.prototype.unenroll = function (infoOrUid) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        idToken = _a.sent();
                        return [4 /*yield*/, _logoutIfInvalidated(this.user, withdrawMfa(this.user.auth, ***REMOVED***
                                idToken: idToken,
                    ...
                    case 2:
                        ...
                        this.enrolledFactors = this.enrolledFactors.filter(function (_a) ***REMOVED***
                            var uid = _a.uid;
                    ...
                    case 6:
                        e_1 = _a.sent();
                        if ((e_1 === null || e_1 === void 0 ? void 0 : e_1.code) !== "auth/".concat("user-token-expired" /* AuthErrorCode.TOKEN_EXPIRED */)) ***REMOVED***
                            throw e_1;
                      ***REMOVED***
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
...
/**
 * The ***REMOVED***@link MultiFactorUser} corresponding to the user.
 *
 * @remarks
 ...
 * @public
 */
function multiFactor(user) ***REMOVED***
    var userModular = getModularInstance(user);
    if (!multiFactorUserCache.has(userModular)) ***REMOVED***
 ...
 * limitations under the License.
 */
var AuthInterop = /** @class */ (function () ***REMOVED***
    function AuthInterop(auth) ***REMOVED***
        this.auth = auth;
        this.internalListeners = new Map();
  ***REMOVED***
    AuthInterop.prototype.getUid = function () ***REMOVED***
        var _a;
        this.assertAuthConfigured();
        return ((_a = this.auth.currentUser) === null || _a === void 0 ? void 0 : _a.uid) || null;
  ***REMOVED***;
    AuthInterop.prototype.getToken = function (forceRefresh) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var accessToken;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        _a.sent();
                        if (!this.auth.currentUser) ***REMOVED***
                            return [2 /*return*/, null];
                      ***REMOVED***
                        return [4 /*yield*/, this.auth.currentUser.getIdToken(forceRefresh)];
                    case 2:
                        accessToken = _a.sent();
                        return [2 /*return*/, ***REMOVED*** accessToken: accessToken }];
              ***REMOVED***
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***;
    AuthInterop.prototype.addAuthTokenListener = function (listener) ***REMOVED***
        this.assertAuthConfigured();
        if (this.internalListeners.has(listener)) ***REMOVED***
            return;
      ***REMOVED***
        var unsubscribe = this.auth.onIdTokenChanged(function (user) ***REMOVED***
            listener((user === null || user === void 0 ? void 0 : user.stsTokenManager.accessToken) || null);
      ***REMOVED***);
        this.internalListeners.set(listener, unsubscribe);
        this.updateProactiveRefresh();
  ***REMOVED***;
    AuthInterop.prototype.removeAuthTokenListener = function (listener) ***REMOVED***
        this.assertAuthConfigured();
      ...
      ***REMOVED***
        ...
        this.updateProactiveRefresh();
  ***REMOVED***;
    AuthInterop.prototype.assertAuthConfigured = function () ***REMOVED***
        _assert(this.auth._initializationPromise, "dependent-sdk-initialized-before-auth" /* AuthErrorCode.DEPENDENT_SDK_INIT_BEFORE_AUTH */);
  ***REMOVED***;
    AuthInterop.prototype.updateProactiveRefresh = function () ***REMOVED***
        if (this.internalListeners.size > 0) ***REMOVED***
 ...
 * limitations under the License.
 */
function getVersionForPlatform(clientPlatform) ***REMOVED***
    switch (clientPlatform) ***REMOVED***
...
/** @internal */
function registerAuth(clientPlatform) ***REMOVED***
    _registerComponent(new Component("auth" /* _ComponentName.AUTH */, function (container, _a) ***REMOVED***
        var deps = _a.options;
        ...
        return (function (app, heartbeatServiceProvider) ***REMOVED***
            _assert(apiKey && !apiKey.includes(':'), "invalid-api-key" /* AuthErrorCode.INVALID_API_KEY */, ***REMOVED*** appName: app.name });
            // Auth domain is optional if IdP sign in isn't being used
            _assert(!(authDomain === null || authDomain === void 0 ? void 0 : authDomain.includes(':')), "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */, ***REMOVED***
                appName: app.name
          ***REMOVED***);
            var config = ***REMOVED***
                apiKey: apiKey,
          ...
          ***REMOVED***;
            ...
            return authInstance;
      ***REMOVED***)(app, heartbeatServiceProvider);
  ***REMOVED***, "PUBLIC" /* ComponentType.PUBLIC */)
         ...
         */
        .setInstanceCreatedCallback(function (container, _instanceIdentifier, _instance) ***REMOVED***
        var authInternalProvider = container.getProvider("auth-internal" /* _ComponentName.AUTH_INTERNAL */);
        authInternalProvider.initialize();
  ***REMOVED***));
    _registerComponent(new Component("auth-internal" /* _ComponentName.AUTH_INTERNAL */, function (container) ***REMOVED***
        var auth = _castAuth(container.getProvider("auth" /* _ComponentName.AUTH */).getImmediate());
        return (function (auth) ***REMOVED*** return new AuthInterop(auth); })(auth);
  ***REMOVED***, "PRIVATE" /* ComponentType.PRIVATE */).setInstantiationMode("EXPLICIT" /* InstantiationMode.EXPLICIT */));
 ...
 * @public
 */
var ActionCodeOperation = ***REMOVED***
...
// object.
var BrowserPersistenceClass = /** @class */ (function () ***REMOVED***
    function BrowserPersistenceClass(storageRetriever, type) ***REMOVED***
        this.storageRetriever = storageRetriever;
        this.type = type;
  ***REMOVED***
    BrowserPersistenceClass.prototype._isAvailable = function () ***REMOVED***
        try ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    BrowserPersistenceClass.prototype._set = function (key, value) ***REMOVED***
        this.storage.setItem(key, JSON.stringify(value));
        return Promise.resolve();
  ***REMOVED***;
    BrowserPersistenceClass.prototype._get = function (key) ***REMOVED***
        var json = this.storage.getItem(key);
        return Promise.resolve(json ? JSON.parse(json) : null);
  ***REMOVED***;
    BrowserPersistenceClass.prototype._remove = function (key) ***REMOVED***
        this.storage.removeItem(key);
        return Promise.resolve();
  ***REMOVED***;
    Object.defineProperty(BrowserPersistenceClass.prototype, "storage", ***REMOVED***
        get: function () ***REMOVED***
...
var BrowserLocalPersistence = /** @class */ (function (_super) ***REMOVED***
    __extends(BrowserLocalPersistence, _super);
    function BrowserLocalPersistence() ***REMOVED***
        var _this = _super.call(this, function () ***REMOVED*** return window.localStorage; }, "LOCAL" /* PersistenceType.LOCAL */) || this;
        _this.boundEventHandler = function (event, poll) ***REMOVED*** return _this.onStorageEvent(event, poll); };
        _this.listeners = ***REMOVED***};
        _this.localCache = ***REMOVED***};
        // setTimeout return value is platform specific
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        ...
        return _this;
  ***REMOVED***
    BrowserLocalPersistence.prototype.forAllChangedKeys = function (cb) ***REMOVED***
        // Check all keys with listeners on them.
        for (var _i = 0, _a = Object.keys(this.listeners); _i < _a.length; _i++) ***REMOVED***
            var key = _a[_i];
      ...
      ***REMOVED***
  ***REMOVED***;
    BrowserLocalPersistence.prototype.onStorageEvent = function (event, poll) ***REMOVED***
        var _this = this;
        if (poll === void 0) ***REMOVED*** poll = false; }
        // Key would be null in some situations, like when localStorage is cleared
        if (!event.key) ***REMOVED***
            this.forAllChangedKeys(function (key, _oldValue, newValue) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (this.safariLocalStorageNotSynced) ***REMOVED***
            ...
            if (event.newValue !== storedValue_1) ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***
        var triggerListeners = function () ***REMOVED***
            // Keep local map up to date in case storage event is triggered before
            // poll.
            var storedValue = _this.storage.getItem(key);
            if (!poll && _this.localCache[key] === storedValue) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    BrowserLocalPersistence.prototype.notifyListeners = function (key, value) ***REMOVED***
        this.localCache[key] = value;
        var listeners = this.listeners[key];
        if (listeners) ***REMOVED***
            for (var _i = 0, _a = Array.from(listeners); _i < _a.length; _i++) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    BrowserLocalPersistence.prototype.startPolling = function () ***REMOVED***
        var _this = this;
        this.stopPolling();
        this.pollTimer = setInterval(function () ***REMOVED***
            _this.forAllChangedKeys(function (key, oldValue, newValue) ***REMOVED***
                _this.onStorageEvent(new StorageEvent('storage', ***REMOVED***
                    key: key,
                    oldValue: oldValue,
                    newValue: newValue
              ***REMOVED***), 
  ...
  ***REMOVED***;
    BrowserLocalPersistence.prototype.stopPolling = function () ***REMOVED***
        if (this.pollTimer) ***REMOVED***
            clearInterval(this.pollTimer);
            this.pollTimer = null;
      ***REMOVED***
  ***REMOVED***;
    BrowserLocalPersistence.prototype.attachListener = function () ***REMOVED***
        window.addEventListener('storage', this.boundEventHandler);
  ***REMOVED***;
    BrowserLocalPersistence.prototype.detachListener = function () ***REMOVED***
        window.removeEventListener('storage', this.boundEventHandler);
  ***REMOVED***;
    BrowserLocalPersistence.prototype._addListener = function (key, listener) ***REMOVED***
        if (Object.keys(this.listeners).length === 0) ***REMOVED***
      ...
      ***REMOVED***
        this.listeners[key].add(listener);
  ***REMOVED***;
    BrowserLocalPersistence.prototype._removeListener = function (key, listener) ***REMOVED***
        if (this.listeners[key]) ***REMOVED***
            this.listeners[key].delete(listener);
            if (this.listeners[key].size === 0) ***REMOVED***
                delete this.listeners[key];
  ...
  ***REMOVED***;
    ...
    BrowserLocalPersistence.prototype._set = function (key, value) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    BrowserLocalPersistence.prototype._get = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var value;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    BrowserLocalPersistence.prototype._remove = function (key) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
 ...
 * limitations under the License.
 */
var BrowserSessionPersistence = /** @class */ (function (_super) ***REMOVED***
    __extends(BrowserSessionPersistence, _super);
    function BrowserSessionPersistence() ***REMOVED***
        return _super.call(this, function () ***REMOVED*** return window.sessionStorage; }, "SESSION" /* PersistenceType.SESSION */) || this;
  ***REMOVED***
    BrowserSessionPersistence.prototype._addListener = function (_key, _listener) ***REMOVED***
        // Listeners are not supported for session storage since it cannot be shared across windows
        return;
  ***REMOVED***;
    BrowserSessionPersistence.prototype._removeListener = function (_key, _listener) ***REMOVED***
        // Listeners are not supported for session storage since it cannot be shared across windows
        return;
  ***REMOVED***;
 ...
 * limitations under the License.
 */
var IdpCredential = /** @class */ (function (_super) ***REMOVED***
    __extends(IdpCredential, _super);
    function IdpCredential(params) ***REMOVED***
        var _this = _super.call(this, "custom" /* ProviderId.CUSTOM */, "custom" /* ProviderId.CUSTOM */) || this;
        _this.params = params;
        return _this;
  ***REMOVED***
    IdpCredential.prototype._getIdTokenResponse = function (auth) ***REMOVED***
        return signInWithIdp(auth, this._buildIdpRequest());
  ***REMOVED***;
    IdpCredential.prototype._linkToIdToken = function (auth, idToken) ***REMOVED***
        return signInWithIdp(auth, this._buildIdpRequest(idToken));
  ***REMOVED***;
    IdpCredential.prototype._getReauthenticationResolver = function (auth) ***REMOVED***
        return signInWithIdp(auth, this._buildIdpRequest());
  ***REMOVED***;
    IdpCredential.prototype._buildIdpRequest = function (idToken) ***REMOVED***
        var request = ***REMOVED***
 ...
 * events
 */
var AbstractPopupRedirectOperation = /** @class */ (function () ***REMOVED***
    function AbstractPopupRedirectOperation(auth, filter, resolver, user, bypassAuthState) ***REMOVED***
        if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
        this.auth = auth;
  ...
  ***REMOVED***
    AbstractPopupRedirectOperation.prototype.execute = function () ***REMOVED***
        var _this = this;
        return new Promise(function (resolve, reject) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
                        this.pendingPromise = ***REMOVED*** resolve: resolve, reject: reject };
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        _a = this;
      ...
      ***REMOVED***); });
  ***REMOVED***;
    AbstractPopupRedirectOperation.prototype.onAuthEvent = function (event) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    AbstractPopupRedirectOperation.prototype.onError = function (error) ***REMOVED***
        this.reject(error);
  ***REMOVED***;
    AbstractPopupRedirectOperation.prototype.getIdpTask = function (type) ***REMOVED***
        switch (type) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    AbstractPopupRedirectOperation.prototype.resolve = function (cred) ***REMOVED***
        debugAssert(this.pendingPromise, 'Pending promise was never set');
        this.pendingPromise.resolve(cred);
        this.unregisterAndCleanUp();
  ***REMOVED***;
    AbstractPopupRedirectOperation.prototype.reject = function (error) ***REMOVED***
        debugAssert(this.pendingPromise, 'Pending promise was never set');
        this.pendingPromise.reject(error);
        this.unregisterAndCleanUp();
  ***REMOVED***;
    AbstractPopupRedirectOperation.prototype.unregisterAndCleanUp = function () ***REMOVED***
...
var RedirectAction = /** @class */ (function (_super) ***REMOVED***
    __extends(RedirectAction, _super);
    function RedirectAction(auth, resolver, bypassAuthState) ***REMOVED***
        if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
  ...
  ***REMOVED***
     ...
     * just return it.
     */
    RedirectAction.prototype.execute = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    ...
                    case 5:
                        result_1 = _a;
                        readyOutcome = function () ***REMOVED*** return Promise.resolve(result_1); };
                        return [3 /*break*/, 7];
                    case 6:
                        e_1 = _b.sent();
                        readyOutcome = function () ***REMOVED*** return Promise.reject(e_1); };
                        return [3 /*break*/, 7];
                    case 7:
                    ...
                    case 8:
                        ...
                        if (!this.bypassAuthState) ***REMOVED***
                            redirectOutcomeMap.set(this.auth._key(), function () ***REMOVED*** return Promise.resolve(null); });
                      ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    RedirectAction.prototype.onAuthEvent = function (event) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            var user;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    RedirectAction.prototype.onExecution = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED*** return __generator(this, function (_a) ***REMOVED***
            return [2 /*return*/];
      ***REMOVED***); });
  ***REMOVED***;
    RedirectAction.prototype.cleanUp = function () ***REMOVED*** };
    return RedirectAction;
}(AbstractPopupRedirectOperation));
function _getAndClearPendingRedirectStatus(resolver, auth) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
...
function _setPendingRedirectStatus(resolver, auth) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
 ...
 *
 * @remarks
 * To handle the results and errors for this operation, refer to ***REMOVED***@link getRedirectResult}.
 * Follow the [best practices](https://firebase.google.com/docs/auth/web/redirect-best-practices) when using ***REMOVED***@link signInWithRedirect}.
 *
 * @example
 * ```javascript
 * // Sign in using a redirect.
 ...
 * @public
 */
function signInWithRedirect(auth, provider, resolver) ***REMOVED***
    return _signInWithRedirect(auth, provider, resolver);
}
function _signInWithRedirect(auth, provider, resolver) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
...
/**
 * Reauthenticates the current user with the specified ***REMOVED***@link OAuthProvider} using a full-page redirect flow.
 * @remarks
 * To handle the results and errors for this operation, refer to ***REMOVED***@link getRedirectResult}.
 * Follow the [best practices](https://firebase.google.com/docs/auth/web/redirect-best-practices) when using ***REMOVED***@link reauthenticateWithRedirect}.
 *
 * @example
 * ```javascript
 * // Sign in using a redirect.
 ...
 * @public
 */
function reauthenticateWithRedirect(user, provider, resolver) ***REMOVED***
    return _reauthenticateWithRedirect(user, provider, resolver);
}
function _reauthenticateWithRedirect(user, provider, resolver) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
...
/**
 * Links the ***REMOVED***@link OAuthProvider} to the user account using a full-page redirect flow.
 * @remarks
 * To handle the results and errors for this operation, refer to ***REMOVED***@link getRedirectResult}.
 * Follow the [best practices](https://firebase.google.com/docs/auth/web/redirect-best-practices) when using ***REMOVED***@link linkWithRedirect}.
 *
 * @example
 * ```javascript
 ...
 * @public
 */
function linkWithRedirect(user, provider, resolver) ***REMOVED***
    return _linkWithRedirect(user, provider, resolver);
}
function _linkWithRedirect(user, provider, resolver) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var userInternal, resolverInternal, eventId;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
/**
 * Returns a ***REMOVED***@link UserCredential} from the redirect-based sign-in flow.
 *
 * @remarks
 ...
 * @public
 */
function getRedirectResult(auth, resolver) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
function _getRedirectResult(auth, resolverExtern, bypassAuthState) ***REMOVED***
    if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
...
function prepareUserForRedirect(user) ***REMOVED***
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        var eventId;
        return __generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
function _getRedirectUrl(auth, provider, authType, redirectUrl, eventId, additionalParams) ***REMOVED***
  ...
  ***REMOVED***;
    if (provider instanceof FederatedAuthProvider) ***REMOVED***
      ...
      ***REMOVED***
        ...
        for (var _i = 0, _a = Object.entries(additionalParams || ***REMOVED***}); _i < _a.length; _i++) ***REMOVED***
            var _b = _a[_i], key = _b[0], value = _b[1];
            params[key] = value;
      ***REMOVED***
  ***REMOVED***
    if (provider instanceof BaseOAuthProvider) ***REMOVED***
        var scopes = provider.getScopes().filter(function (scope) ***REMOVED*** return scope !== ''; });
  ...
  ***REMOVED***
    ...
    for (var _c = 0, _d = Object.keys(paramsDict); _c < _d.length; _c++) ***REMOVED***
        var key = _d[_c];
...
function getHandlerBase(_a) ***REMOVED***
 ...
 * limitations under the License.
 */
function _getProjectConfig(auth, request) ***REMOVED***
    if (request === void 0) ***REMOVED*** request = ***REMOVED***}; }
    return __awaiter(this, void 0, void 0, function () ***REMOVED***
        return __generator(this, function (_a) ***REMOVED***
...
var AuthEventManager = /** @class */ (function () ***REMOVED***
    function AuthEventManager(auth) ***REMOVED***
        this.auth = auth;
  ...
  ***REMOVED***
    AuthEventManager.prototype.registerConsumer = function (authEventConsumer) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***;
    AuthEventManager.prototype.unregisterConsumer = function (authEventConsumer) ***REMOVED***
        this.consumers.delete(authEventConsumer);
  ***REMOVED***;
    AuthEventManager.prototype.onEvent = function (event) ***REMOVED***
        var _this = this;
      ...
      ***REMOVED***
        var handled = false;
        this.consumers.forEach(function (consumer) ***REMOVED***
            if (_this.isEventForConsumer(event, consumer)) ***REMOVED***
                handled = true;
      ...
      ***REMOVED***
        return handled;
  ***REMOVED***;
    AuthEventManager.prototype.sendToConsumer = function (event, consumer) ***REMOVED***
        var _a;
      ...
      ***REMOVED***
  ***REMOVED***;
    AuthEventManager.prototype.isEventForConsumer = function (event, consumer) ***REMOVED***
        var eventIdMatches = consumer.eventId === null ||
            (!!event.eventId && event.eventId === consumer.eventId);
        return consumer.filter.includes(event.type) && eventIdMatches;
  ***REMOVED***;
    AuthEventManager.prototype.hasEventBeenHandled = function (event) ***REMOVED***
  ...
  ***REMOVED***;
    AuthEventManager.prototype.saveEventToCache = function (event) ***REMOVED***
...
function eventUid(e) ***REMOVED***
    return [e.type, e.eventId, e.sessionId, e.tenantId].filter(function (v) ***REMOVED*** return v; }).join('-');
}
function isNullRedirectEvent(_a) ***REMOVED***
