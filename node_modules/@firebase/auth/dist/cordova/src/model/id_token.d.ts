 ...
 *
 */
export interface ParsedIdToken ***REMOVED***
    iss: string;
    aud: string;
    exp: number;
    sub: string;
 ...
 * @internal
 */
export interface IdTokenResponse ***REMOVED***
    localId: string;
    idToken?: IdToken;
    refreshToken?: string;
    expiresIn?: string;
 ...
 * @internal
 */
export declare const enum IdTokenResponseKind ***REMOVED***
 ...
 * @internal
 */
export interface TaggedWithTokenResponse ***REMOVED***
