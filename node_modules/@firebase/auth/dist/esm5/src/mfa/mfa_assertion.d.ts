 ...
 */
import ***REMOVED*** FactorId, MultiFactorAssertion } from '../model/public_types';
import ***REMOVED*** MultiFactorSessionImpl } from './mfa_session';
import ***REMOVED*** FinalizeMfaResponse } from '../api/authentication/mfa';
import ***REMOVED*** AuthInternal } from '../model/auth';
export declare abstract class MultiFactorAssertionImpl implements MultiFactorAssertion ***REMOVED***
