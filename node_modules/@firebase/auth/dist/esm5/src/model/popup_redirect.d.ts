 ...
 */
import ***REMOVED*** Auth, AuthProvider, Persistence, PopupRedirectResolver, UserCredential } from './public_types';
import ***REMOVED*** FirebaseError } from '@firebase/util';
import ***REMOVED*** AuthPopup } from '../platform_browser/util/popup';
import ***REMOVED*** AuthInternal } from './auth';
import ***REMOVED*** UserCredentialInternal } from './user';
export declare const enum EventFilter ***REMOVED***
    POPUP = 0,
    REDIRECT = 1
}
export declare const enum GapiOutcome ***REMOVED***
    ACK = "ACK",
    ERROR = "ERROR"
}
export interface GapiAuthEvent extends gapi.iframes.Message ***REMOVED***
    authEvent: AuthEvent;
}
/**
 * @internal
 */
export declare const enum AuthEventType ***REMOVED***
...
export interface AuthEventError extends Error ***REMOVED***
    code: string;
    message: string;
}
/**
 * @internal
 */
export interface AuthEvent ***REMOVED***
    type: AuthEventType;
    eventId: string | null;
 ...
 * @internal
 */
export interface AuthEventConsumer ***REMOVED***
 ...
 * @internal
 */
export interface EventManager ***REMOVED***
 ...
 * @internal
 */
export interface PopupRedirectResolverInternal extends PopupRedirectResolver ***REMOVED***
