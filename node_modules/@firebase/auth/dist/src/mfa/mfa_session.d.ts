...
import ***REMOVED*** MultiFactorSession } from '../model/public_types';
export declare const enum MultiFactorSessionType ***REMOVED***
    ENROLL = "enroll",
    SIGN_IN = "signin"
}
interface SerializedMultiFactorSession ***REMOVED***
    multiFactorSession: ***REMOVED***
        idToken?: string;
        pendingCredential?: string;
  ***REMOVED***;
}
export declare class MultiFactorSessionImpl implements MultiFactorSession ***REMOVED***
