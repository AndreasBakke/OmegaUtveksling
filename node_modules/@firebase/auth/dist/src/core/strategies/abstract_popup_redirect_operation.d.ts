...
import ***REMOVED*** AuthEvent, AuthEventConsumer, AuthEventType, PopupRedirectResolverInternal } from '../../model/popup_redirect';
 ...
 * events
 */
export declare abstract class AbstractPopupRedirectOperation implements AuthEventConsumer ***REMOVED***
