 ...
 */
import ***REMOVED*** Auth, User, Persistence } from '@firebase/auth';
import ***REMOVED*** WebDriver } from 'selenium-webdriver';
export declare const START_FUNCTION = "startAuth";
/** Helper wraper around the WebDriver object */
export declare class AuthDriver ***REMOVED***
    webDriver: WebDriver;
    ...
    selectMainWindow(options?: ***REMOVED***
        noWait?: boolean;
