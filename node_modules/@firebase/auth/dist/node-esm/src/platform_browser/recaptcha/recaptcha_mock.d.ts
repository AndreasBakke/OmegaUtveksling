...
import ***REMOVED*** RecaptchaParameters } from '../../model/public_types';
...
export interface Widget ***REMOVED***
    getResponse: () => string | null;
    delete: () => void;
    execute: () => void;
}
export declare class MockReCaptcha implements Recaptcha ***REMOVED***
...
export declare class MockWidget ***REMOVED***
