 ...
 */
import ***REMOVED*** AuthEvent, AuthEventConsumer, EventManager } from '../../model/popup_redirect';
import ***REMOVED*** AuthInternal } from '../../model/auth';
export declare class AuthEventManager implements EventManager ***REMOVED***
