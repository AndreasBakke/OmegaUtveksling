 ...
 */
import ***REMOVED*** _FirebaseService, FirebaseApp } from '@firebase/app';
import ***REMOVED*** Provider } from '@firebase/component';
import ***REMOVED*** Auth, AuthErrorMap, AuthSettings, EmulatorConfig, NextOrObserver, Persistence, PopupRedirectResolver, User, CompleteFn, ErrorFn, Unsubscribe } from '../../model/public_types';
import ***REMOVED*** ErrorFactory } from '@firebase/util';
import ***REMOVED*** AuthInternal, ConfigInternal } from '../../model/auth';
import ***REMOVED*** PopupRedirectResolverInternal } from '../../model/popup_redirect';
import ***REMOVED*** UserInternal } from '../../model/user';
import ***REMOVED*** AuthErrorCode, AuthErrorParams } from '../errors';
import ***REMOVED*** PersistenceInternal } from '../persistence';
export declare const enum DefaultConfig ***REMOVED***
    TOKEN_API_HOST = "securetoken.googleapis.com",
    API_HOST = "identitytoolkit.googleapis.com",
    API_SCHEME = "https"
}
export declare class AuthImpl implements AuthInternal, _FirebaseService ***REMOVED***
