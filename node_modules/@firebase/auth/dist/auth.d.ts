...
import ***REMOVED*** CompleteFn } from '@firebase/util';
import ***REMOVED*** ErrorFactory } from '@firebase/util';
import ***REMOVED*** ErrorFn } from '@firebase/util';
import ***REMOVED*** FirebaseApp } from '@firebase/app';
import ***REMOVED*** FirebaseError } from '@firebase/util';
import ***REMOVED*** NextFn } from '@firebase/util';
import ***REMOVED*** Observer } from '@firebase/util';
import ***REMOVED*** Unsubscribe } from '@firebase/util';

/**
 * A response from ***REMOVED***@link checkActionCode}.
 *
 * @public
 */
export declare interface ActionCodeInfo ***REMOVED***
    /**
     * The data associated with the action code.
     *
     * @remarks
     * For the ***REMOVED***@link ActionCodeOperation}.PASSWORD_RESET, ***REMOVED***@link ActionCodeOperation}.VERIFY_EMAIL, and
     * ***REMOVED***@link ActionCodeOperation}.RECOVER_EMAIL actions, this object contains an email field with the address
     * the email was sent to.
     *
     * For the ***REMOVED***@link ActionCodeOperation}.RECOVER_EMAIL action, which allows a user to undo an email address
     ...
     *
     * For the ***REMOVED***@link ActionCodeOperation}.VERIFY_AND_CHANGE_EMAIL action, which allows a user to verify the
     ...
     *
     * For the ***REMOVED***@link ActionCodeOperation}.REVERT_SECOND_FACTOR_ADDITION action, which allows a user to
     ...
     * is a ***REMOVED***@link MultiFactorInfo} object, which contains the phone number.
     */
    data: ***REMOVED***
        email?: string | null;
 ...
 * @public
 */
export declare const ActionCodeOperation: ***REMOVED***
 ...
 * @public
 */
export declare interface ActionCodeSettings ***REMOVED***
    /**
 ...
 * @public
 */
export declare class ActionCodeURL ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface AdditionalUserInfo ***REMOVED***
    /**
...
declare interface APIUserInfo ***REMOVED***
    localId?: string;
    displayName?: string;
    photoUrl?: string;
    email?: string;
 ...
 *
 * @remarks
 * Currently, the only implementation is ***REMOVED***@link RecaptchaVerifier}.
 *
 * @public
 */
export declare interface ApplicationVerifier ***REMOVED***
    /**
...
declare interface ApplicationVerifierInternal extends ApplicationVerifier ***REMOVED***
    /**
     * @internal
     */
    _reset(): void;
 ...
 *
 * @remarks
 * See ***REMOVED***@link https://firebase.google.com/docs/auth/ | Firebase Authentication} for a full guide
 * on how to use the Firebase Auth service.
 *
 * @public
 */
export declare interface Auth ***REMOVED***
    /** The ***REMOVED***@link @firebase/app#FirebaseApp} associated with the `Auth` service instance. */
    readonly app: FirebaseApp;
    /** The name of the app associated with the `Auth` service instance. */
    readonly name: string;
    /** The ***REMOVED***@link Config} used to initialize this instance. */
    ...
    /**
     * The ***REMOVED***@link Auth} instance's language code.
     *
     * @remarks
    ...
    /**
     * The ***REMOVED***@link Auth} instance's tenant ID.
     *
     * @remarks
     * This is a readable/writable property. When you set the tenant ID of an ***REMOVED***@link Auth} instance, all
    ...
    /**
     * The ***REMOVED***@link Auth} instance's settings.
     *
     * @remarks
     ...
     *
     * @remarks
     * To keep the old behavior, see ***REMOVED***@link Auth.onIdTokenChanged}.
     *
    ...
    /**
     * Asynchronously sets the provided user as ***REMOVED***@link Auth.currentUser} on the ***REMOVED***@link Auth} instance.
     *
     * @remarks
     * A new instance copy of the user provided will be made and set as currentUser.
     *
     * This will trigger ***REMOVED***@link Auth.onAuthStateChanged} and ***REMOVED***@link Auth.onIdTokenChanged} listeners
 ...
 * @public
 */
export declare class AuthCredential ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface AuthError extends FirebaseError ***REMOVED***
    /** Details about the Firebase Auth error.  */
    readonly customData: ***REMOVED***
         ...
         *
         * @remarks
         * If you use ***REMOVED***@link signInWithRedirect} to sign in,
         * you have to set the tenant ID on the ***REMOVED***@link Auth} instance again as the tenant ID is not persisted
         * after redirection.
         */
 ...
 * @internal
 */
declare const enum AuthErrorCode ***REMOVED***
 ...
 * @public
 */
export declare const AuthErrorCodes: ***REMOVED***
 ...
 * compiled code. When deploying code in production, using ***REMOVED***@link prodErrorMap}
 * will save you roughly 10k compressed/gzipped over ***REMOVED***@link debugErrorMap}. You
 * can select the error map during initialization:
 *
 * ```javascript
 * initializeAuth(app, ***REMOVED***errorMap: debugErrorMap})
 * ```
 *
 * When initializing Auth, ***REMOVED***@link prodErrorMap} is default.
 *
 * @public
 */
export declare interface AuthErrorMap ***REMOVED***
}

/**
 * @internal
 */
declare interface AuthErrorParams extends GenericAuthErrorParams ***REMOVED***
    [AuthErrorCode.ARGUMENT_ERROR]: ***REMOVED***
        appName?: AppName;
  ***REMOVED***;
    [AuthErrorCode.DEPENDENT_SDK_INIT_BEFORE_AUTH]: ***REMOVED***
        appName?: AppName;
  ***REMOVED***;
    [AuthErrorCode.INTERNAL_ERROR]: ***REMOVED***
        appName?: AppName;
  ***REMOVED***;
    [AuthErrorCode.LOGIN_BLOCKED]: ***REMOVED***
        appName?: AppName;
        originalMessage?: string;
  ***REMOVED***;
    [AuthErrorCode.OPERATION_NOT_SUPPORTED]: ***REMOVED***
        appName?: AppName;
  ***REMOVED***;
    [AuthErrorCode.NO_AUTH_EVENT]: ***REMOVED***
        appName?: AppName;
  ***REMOVED***;
    [AuthErrorCode.MFA_REQUIRED]: ***REMOVED***
        appName: AppName;
        _serverResponse: IdTokenMfaResponse;
  ***REMOVED***;
    [AuthErrorCode.INVALID_CORDOVA_CONFIGURATION]: ***REMOVED***
        appName: AppName;
 ...
 * @internal
 */
declare interface AuthEvent ***REMOVED***
    type: AuthEventType;
    eventId: string | null;
 ...
 * @internal
 */
declare interface AuthEventConsumer ***REMOVED***
...
declare interface AuthEventError extends Error ***REMOVED***
    code: string;
    message: string;
}
 ...
 * @internal
 */
declare const enum AuthEventType ***REMOVED***
 ...
 * @internal
 */
declare interface AuthInternal extends Auth ***REMOVED***
...
declare class AuthPopup ***REMOVED***
...
/**
 * Interface that represents an auth provider, used to facilitate creating ***REMOVED***@link AuthCredential}.
 *
 * @public
 */
export declare interface AuthProvider ***REMOVED***
    /**
...
/**
 * Interface representing an ***REMOVED***@link Auth} instance's settings.
 *
 * @remarks Currently used for enabling/disabling app verification for phone Auth testing.
 *
 * @public
 */
export declare interface AuthSettings ***REMOVED***
    /**
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/auth/web/phone-auth#test-with-whitelisted-phone-numbers | whitelist your phone number}
 ...
 */
declare interface BaseMfaEnrollment ***REMOVED***
 ...
 */
declare abstract class BaseOAuthProvider extends FederatedAuthProvider implements AuthProvider ***REMOVED***
    /** @internal */
    private scopes;
    /**
 ...
 * @internal
 */
declare const enum ClientPlatform ***REMOVED***
    BROWSER = "Browser",
    NODE = "Node",
 ...
 * @public
 */
export declare interface Config ***REMOVED***
    /**
 ...
 * @internal
 */
declare interface ConfigInternal extends Config ***REMOVED***
    /**
     * @readonly
     */
    emulator?: ***REMOVED***
 ...
 * @public
 */
export declare interface ConfirmationResult ***REMOVED***
    /**
     ...
     * ***REMOVED***@link PhoneAuthCredential}.
     */
 ...
 * @public
 */
export declare function connectAuthEmulator(auth: Auth, url: string, options?: ***REMOVED***
...
/**
 * The dependencies that can be used to initialize an ***REMOVED***@link Auth} instance.
 *
 * @remarks
 *
 ...
 * ***REMOVED***@link browserPopupRedirectResolver} and
 * ***REMOVED***@link cordovaPopupRedirectResolver}. The dependencies object is how Auth is
 * configured to reduce bundle sizes.
 *
 * There are two ways to initialize an ***REMOVED***@link Auth} instance: ***REMOVED***@link getAuth} and
 * ***REMOVED***@link initializeAuth}. `getAuth` initializes everything using
 ...
 * @public
 */
export declare interface Dependencies ***REMOVED***
    /**
     * Which ***REMOVED***@link Persistence} to use. If this is an array, the first
     ...
     * ***REMOVED***@link inMemoryPersistence}.
     */
    persistence?: Persistence | Persistence[];
    /**
     * The ***REMOVED***@link PopupRedirectResolver} to use. This value depends on the
     * platform. Options are ***REMOVED***@link browserPopupRedirectResolver} and
     * ***REMOVED***@link cordovaPopupRedirectResolver}. This field is optional if neither
     * ***REMOVED***@link signInWithPopup} or ***REMOVED***@link signInWithRedirect} are being used.
     */
    popupRedirectResolver?: PopupRedirectResolver;
    /**
     * Which ***REMOVED***@link AuthErrorMap} to use.
     */
 ...
 * @public
 */
export declare class EmailAuthCredential extends AuthCredential ***REMOVED***
    /** @internal */
 ...
 * @public
 */
export declare class EmailAuthProvider implements AuthProvider ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface EmulatorConfig ***REMOVED***
    /**
...
export ***REMOVED*** ErrorFn }

/**
 * @internal
 */
declare interface EventManager ***REMOVED***
 ...
 * @public
 */
export declare class FacebookAuthProvider extends BaseOAuthProvider ***REMOVED***
 ...
 * @public
 */
export declare const FactorId: ***REMOVED***
 ...
 * @public
 */
declare abstract class FederatedAuthProvider implements AuthProvider ***REMOVED***
    readonly providerId: string;
    /** @internal */
...
declare interface FinalizeMfaResponse ***REMOVED***
    idToken: string;
    refreshToken: string;
}
 ...
 * @internal
 */
declare type GenericAuthErrorParams = ***REMOVED***
    [key in Exclude<AuthErrorCode, AuthErrorCode.ARGUMENT_ERROR | AuthErrorCode.DEPENDENT_SDK_INIT_BEFORE_AUTH | AuthErrorCode.INTERNAL_ERROR | AuthErrorCode.MFA_REQUIRED | AuthErrorCode.NO_AUTH_EVENT | AuthErrorCode.OPERATION_NOT_SUPPORTED>]: ***REMOVED***
        appName?: AppName;
        email?: string;
        phoneNumber?: string;
        message?: string;
 ...
 * @public
 */
export declare class GithubAuthProvider extends BaseOAuthProvider ***REMOVED***
 ...
 * @public
 */
export declare class GoogleAuthProvider extends BaseOAuthProvider ***REMOVED***
 ...
 * @internal
 */
declare interface IdTokenMfaResponse extends IdTokenResponse ***REMOVED***
 ...
 * @internal
 */
declare interface IdTokenResponse ***REMOVED***
    localId: string;
    idToken?: IdToken;
    refreshToken?: string;
    expiresIn?: string;
 ...
 * @internal
 */
declare const enum IdTokenResponseKind ***REMOVED***
...
/**
 * Interface representing ID token result obtained from ***REMOVED***@link User.getIdTokenResult}.
 *
 * @remarks
 ...
 * @public
 */
export declare interface IdTokenResult ***REMOVED***
    /**
 ...
 * @public
 */
export declare interface MultiFactorAssertion ***REMOVED***
 ...
 * @public
 */
export declare interface MultiFactorError extends AuthError ***REMOVED***
    /** Details about the MultiFactorError. */
    readonly customData: AuthError['customData'] & ***REMOVED***
        /**
 ...
 * @public
 */
export declare interface MultiFactorInfo ***REMOVED***
...
/**
 * The class used to facilitate recovery from ***REMOVED***@link MultiFactorError} when a user needs to
 ...
 * const phoneInfoOptions = ***REMOVED***
 ...
 * @public
 */
export declare interface MultiFactorResolver ***REMOVED***
    /**
     ...
     * ***REMOVED***@link MultiFactorAssertion} confirming the user successfully completed the second factor
     * challenge.
     *
     * @example
     * ```javascript
 ...
 * @public
 */
export declare interface MultiFactorSession ***REMOVED***
}

/**
 * An interface that defines the multi-factor related properties and operations pertaining
 * to a ***REMOVED***@link User}.
 *
 * @public
 */
export declare interface MultiFactorUser ***REMOVED***
     ...
     * ```
     *
     * @returns The promise that resolves with the ***REMOVED***@link MultiFactorSession}.
     */
    getSession(): Promise<MultiFactorSession>;
    /**
     *
     * Enrolls a second factor as identified by the ***REMOVED***@link MultiFactorAssertion} for the
     * user.
     *
     * @remarks
     ...
     *
     * @remarks
     * To specify the factor to remove, pass a ***REMOVED***@link MultiFactorInfo} object (retrieved from
     * ***REMOVED***@link MultiFactorUser.enrolledFactors}) or the
...
declare type MutableUserInfo = ***REMOVED***
    -readonly [K in keyof UserInfo]: UserInfo[K];
};
export ***REMOVED*** NextFn }
 ...
 * @public
 */
export declare class OAuthCredential extends AuthCredential ***REMOVED***
    /**
     ...
     * ***REMOVED***@link OAuthProvider}, such as `facebook.com`, `twitter.com`, etc.
     * @readonly
     */
    accessToken?: string;
    /**
...
/**
 * Defines the options for initializing an ***REMOVED***@link OAuthCredential}.
 *
 * @remarks
 ...
 * @public
 */
export declare interface OAuthCredentialOptions ***REMOVED***
    /**
     * The OAuth ID token used to initialize the ***REMOVED***@link OAuthCredential}.
     */
    idToken?: string;
    /**
     * The OAuth access token used to initialize the ***REMOVED***@link OAuthCredential}.
     */
    accessToken?: string;
    /**
...
declare interface OAuthCredentialParams ***REMOVED***
    idToken?: string | null;
 ...
 * @public
 */
export declare class OAuthProvider extends BaseOAuthProvider ***REMOVED***
    /**
 ...
 * @public
 */
export declare const OperationType: ***REMOVED***
 ...
 * @public
 */
export declare interface ParsedToken ***REMOVED***
 ...
 * @public
 */
export declare interface Persistence ***REMOVED***
    /**
     * Type of Persistence.
 ...
 * @public
 */
export declare class PhoneAuthCredential extends AuthCredential ***REMOVED***
 ...
 * @public
 */
export declare class PhoneAuthProvider ***REMOVED***
 ...
 */
declare interface PhoneMfaEnrollment extends BaseMfaEnrollment ***REMOVED***
    phoneInfo: string;
}

/**
 * The class for asserting ownership of a phone second factor. Provided by
 * ***REMOVED***@link PhoneMultiFactorGenerator.assertion}.
 *
 * @public
 */
export declare interface PhoneMultiFactorAssertion extends MultiFactorAssertion ***REMOVED***
}
 ...
 * @public
 */
export declare interface PhoneMultiFactorEnrollInfoOptions ***REMOVED***
    /** Phone number to send a verification code to. */
    phoneNumber: string;
    /** The ***REMOVED***@link MultiFactorSession} obtained via ***REMOVED***@link MultiFactorUser.getSession}. */
    session: MultiFactorSession;
}
 ...
 * @public
 */
export declare class PhoneMultiFactorGenerator ***REMOVED***
    private constructor();
    /**
...
/**
 * The subclass of the ***REMOVED***@link MultiFactorInfo} interface for phone number
 * second factors. The `factorId` of this second factor is ***REMOVED***@link FactorId}.PHONE.
 * @public
 */
export declare interface PhoneMultiFactorInfo extends MultiFactorInfo ***REMOVED***
 ...
 * @public
 */
export declare interface PhoneMultiFactorSignInInfoOptions ***REMOVED***
    /**
     * The ***REMOVED***@link MultiFactorInfo} obtained via ***REMOVED***@link MultiFactorResolver.hints}.
     *
    ...
    /** The ***REMOVED***@link MultiFactorSession} obtained via ***REMOVED***@link MultiFactorResolver.session}. */
    session: MultiFactorSession;
}
 ...
 * @public
 */
export declare interface PhoneSingleFactorInfoOptions ***REMOVED***
    /** Phone number to send a verification code to. */
    phoneNumber: string;
}

/**
 * A resolver used for handling DOM specific operations like ***REMOVED***@link signInWithPopup}
 * or ***REMOVED***@link signInWithRedirect}.
 *
 * @public
 */
export declare interface PopupRedirectResolver ***REMOVED***
}
 ...
 * @internal
 */
declare interface PopupRedirectResolverInternal extends PopupRedirectResolver ***REMOVED***
 ...
 * @public
 */
export declare const ProviderId: ***REMOVED***
 ...
 * @internal
 */
declare const enum ProviderId_2 ***REMOVED***
    /** @internal */
    ANONYMOUS = "anonymous",
    /** @internal */
    CUSTOM = "custom",
...
declare interface ProviderUserInfo ***REMOVED***
    providerId: string;
    rawId?: string;
    email?: string;
    displayName?: string;
 ...
 * @public
 */
export declare interface ReactNativeAsyncStorage ***REMOVED***
    /**
...
declare interface Recaptcha ***REMOVED***
 ...
 * @internal
 */
declare interface ReCaptchaLoader ***REMOVED***
 ...
 * @public
 */
export declare interface RecaptchaParameters ***REMOVED***
    [key: string]: any;
}
 ...
 * @public
 */
export declare class RecaptchaVerifier implements ApplicationVerifierInternal ***REMOVED***
 ...
 * @public
 */
export declare class SAMLAuthProvider extends FederatedAuthProvider ***REMOVED***
    /**
 ...
 * @public
 */
export declare const SignInMethod: ***REMOVED***
 ...
 * @internal
 */
declare interface SignInWithIdpResponse extends IdTokenResponse ***REMOVED***
 ...
 * @internal
 */
declare interface SignInWithPhoneNumberRequest ***REMOVED***
 ...
 * @internal
 */
declare interface SignInWithPhoneNumberResponse extends IdTokenResponse ***REMOVED***
    temporaryProof?: string;
    phoneNumber?: string;
}
 ...
 * @internal
 */
declare class StsTokenManager ***REMOVED***
 ...
 * @internal
 */
declare interface TaggedWithTokenResponse ***REMOVED***
 ...
 * @public
 */
export declare class TwitterAuthProvider extends BaseOAuthProvider ***REMOVED***
 ...
 * @public
 */
export declare function updateProfile(user: User, ***REMOVED*** displayName, photoURL: photoUrl }: ***REMOVED***
    displayName?: string | null;
    photoURL?: string | null;
}): Promise<void>;
 ...
 * @public
 */
export declare interface User extends UserInfo ***REMOVED***
    /**
     * Whether the email has been verified with ***REMOVED***@link sendEmailVerification} and
     * ***REMOVED***@link applyActionCode}.
     */
    readonly emailVerified: boolean;
    /**
     * Whether the user is authenticated using the ***REMOVED***@link ProviderId}.ANONYMOUS provider.
     */
     ...
     * ***REMOVED***@link User.getIdToken} to refresh the ID token instead.
     */
     ...
     * Important: this is a security-sensitive operation that requires the user to have recently
     * signed in. If this requirement isn't met, ask the user to authenticate again and then call
     * one of the reauthentication methods like ***REMOVED***@link reauthenticateWithCredential}.
     */
    delete(): Promise<void>;
    /**
     * Returns a JSON Web Token (JWT) used to identify the user to a Firebase service.
...
/**
 * A structure containing a ***REMOVED***@link User}, the ***REMOVED***@link OperationType}, and the provider ID.
 *
 * @remarks
 * `operationType` could be ***REMOVED***@link OperationType}.SIGN_IN for a sign-in operation,
 * ***REMOVED***@link OperationType}.LINK for a linking operation and ***REMOVED***@link OperationType}.REAUTHENTICATE for
 * a reauthentication operation.
 *
 * @public
 */
export declare interface UserCredential ***REMOVED***
    /**
 ...
 * @internal
 */
declare interface UserCredentialInternal extends UserCredential, TaggedWithTokenResponse ***REMOVED***
    user: UserInternal;
}
 ...
 * @public
 */
export declare interface UserInfo ***REMOVED***
    /**
 ...
 * @internal
 */
declare interface UserInternal extends User ***REMOVED***
    displayName: string | null;
    email: string | null;
 ...
 * @public
 */
export declare interface UserMetadata ***REMOVED***
...
declare class UserMetadata_2 implements UserMetadata ***REMOVED***
    private createdAt?;
    private lastLoginAt?;
    creationTime?: string;
...
/**
 * User profile used in ***REMOVED***@link AdditionalUserInfo}.
 *
 * @public
 */
