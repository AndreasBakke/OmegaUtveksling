...
function _logError(msg) ***REMOVED***
  ...
  ***REMOVED***
    if (logClient.logLevel <= logger.LogLevel.ERROR) ***REMOVED***
...
function _errorWithCustomMessage(auth, code, message) ***REMOVED***
    var _a;
    var errorMap = tslib.__assign(tslib.__assign(***REMOVED***}, prodErrorMap()), (_a = ***REMOVED***}, _a[code] = message, _a));
 ...
 * @public
 */
function initializeAuth(app$1, deps) ***REMOVED***
    ...
    if (provider.isInitialized()) ***REMOVED***
        ...
        if (util.deepEqual(initialOptions, deps !== null && deps !== void 0 ? deps : ***REMOVED***})) ***REMOVED***
            return auth_1;
      ***REMOVED***
        else ***REMOVED***
...
function _isOnline() ***REMOVED***
    if (typeof navigator !== 'undefined' &&
        ...
        (_isHttpOrHttps() || util.isBrowserExtension() || 'connection' in navigator)) ***REMOVED***
...
function _addTidIfNecessary(auth, request) ***REMOVED***
    if (auth.tenantId && !request.tenantId) ***REMOVED***
        return tslib.__assign(tslib.__assign(***REMOVED***}, request), ***REMOVED*** tenantId: auth.tenantId });
  ***REMOVED***
    return request;
}
function _performApiRequest(auth, method, path, request, customErrorMap) ***REMOVED***
    ...
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            return [2 /*return*/, _performFetchWithErrorHandling(auth, customErrorMap, function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                        ...
                        switch (_a.label) ***REMOVED***
                            case 0:
                                ...
                                if (request) ***REMOVED***
                                  ...
                                  ***REMOVED***
                              ***REMOVED***
                                query = util.querystring(tslib.__assign(***REMOVED*** key: auth.config.apiKey }, params)).slice(1);
                            ...
                            case 1:
                              ...
                              ***REMOVED***
                                return [2 /*return*/, FetchProvider.fetch()(_getFinalTarget(auth, auth.config.apiHost, path, query), tslib.__assign(***REMOVED*** method: method, headers: headers, referrerPolicy: 'no-referrer' }, body))];
                      ***REMOVED***
                  ***REMOVED***);
              ***REMOVED***); })];
      ***REMOVED***);
...
function _performFetchWithErrorHandling(auth, customErrorMap, fetchFn) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                    auth._canInitEmulator = false;
                    errorMap = tslib.__assign(tslib.__assign(***REMOVED***}, SERVER_ERROR_MAP), customErrorMap);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 4, , 5]);
                ...
                case 4:
                    e_1 = _b.sent();
                    if (e_1 instanceof util.FirebaseError) ***REMOVED***
                        throw e_1;
                  ***REMOVED***
  ...
  ***REMOVED***;
    ProactiveRefresh.prototype.schedule = function (wasError) ***REMOVED***
      ...
      ***REMOVED***
        ...
        this.timerId = setTimeout(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            return tslib.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
...
function requestStsToken(auth, refreshToken) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, _performFetchWithErrorHandling(auth, ***REMOVED***}, function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                        var body, _a, tokenApiHost, apiKey, url, headers;
                        return tslib.__generator(this, function (_b) ***REMOVED***
                            switch (_b.label) ***REMOVED***
                                case 0:
                                    body = util.querystring(***REMOVED***
...
var UserImpl = /** @class */ (function () ***REMOVED***
  ...
  ***REMOVED***;
    UserImpl.prototype._assign = function (user) ***REMOVED***
      ...
      ***REMOVED***
        ...
        this.providerData = user.providerData.map(function (userInfo) ***REMOVED*** return (tslib.__assign(***REMOVED***}, userInfo)); });
        this.metadata._copy(user.metadata);
        this.stsTokenManager._assign(user.stsTokenManager);
  ***REMOVED***;
    UserImpl.prototype._clone = function (auth) ***REMOVED***
        return new UserImpl(tslib.__assign(tslib.__assign(***REMOVED***}, this), ***REMOVED*** auth: auth, stsTokenManager: this.stsTokenManager._clone() }));
  ***REMOVED***;
  ...
  ***REMOVED***;
    UserImpl.prototype.toJSON = function () ***REMOVED***
        return tslib.__assign(tslib.__assign(***REMOVED*** uid: this.uid, email: this.email || undefined, emailVerified: this.emailVerified, displayName: this.displayName || undefined, isAnonymous: this.isAnonymous, photoURL: this.photoURL || undefined, phoneNumber: this.phoneNumber || undefined, tenantId: this.tenantId || undefined, providerData: this.providerData.map(function (userInfo) ***REMOVED*** return (tslib.__assign(***REMOVED***}, userInfo)); }), stsTokenManager: this.stsTokenManager.toJSON(), 
    ...
    UserImpl._fromJSON = function (auth, object) ***REMOVED***
      ...
      ***REMOVED***);
        if (providerData && Array.isArray(providerData)) ***REMOVED***
            user.providerData = providerData.map(function (userInfo) ***REMOVED*** return (tslib.__assign(***REMOVED***}, userInfo)); });
      ***REMOVED***
            ...
            return tslib.__generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
                      ...
                      ***REMOVED***
                        return [4 /*yield*/, Promise.all(persistenceHierarchy.map(function (persistence) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                                return tslib.__generator(this, function (_a) ***REMOVED***
                                    switch (_a.label) ***REMOVED***
...
function _isFirefox(ua) ***REMOVED***
    if (ua === void 0) ***REMOVED*** ua = util.getUA(); }
    return /firefox\//i.test(ua);
}
function _isSafari(userAgent) ***REMOVED***
    if (userAgent === void 0) ***REMOVED*** userAgent = util.getUA(); }
    var ua = userAgent.toLowerCase();
  ...
  ***REMOVED***;
    AuthMiddlewareQueue.prototype.runMiddleware = function (nextUser) ***REMOVED***
        return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib.__generator(this, function (_c) ***REMOVED***
...
var AuthImpl = /** @class */ (function () ***REMOVED***
  ...
  ***REMOVED***
    AuthImpl.prototype._initializeWithPersistence = function (persistenceHierarchy, popupRedirectResolver) ***REMOVED***
      ...
      ***REMOVED***
        ...
        // promise resolution)
        this._initializationPromise = this.queue(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            var _a;
            var _b, _c;
            return tslib.__generator(this, function (_d) ***REMOVED***
            ...
            return tslib.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/, this.queue(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                            return tslib.__generator(this, function (_a) ***REMOVED***
                                switch (_a.label) ***REMOVED***
  ...
  ***REMOVED***;
    AuthImpl.prototype.setPersistence = function (persistence) ***REMOVED***
        var _this = this;
        return this.queue(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            return tslib.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
            ...
            return tslib.__generator(this, function (_c) ***REMOVED***
                switch (_c.label) ***REMOVED***
                    case 0:
                        ...
                        return [4 /*yield*/, this.queue(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED*** return tslib.__generator(this, function (_a) ***REMOVED***
                                return [2 /*return*/];
                          ***REMOVED***); }); })];
                    case 1:
                        _c.sent();
        ...
        return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib.__generator(this, function (_a) ***REMOVED***
                if (user === this.currentUser) ***REMOVED***
                    return [2 /*return*/, this.queue(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED*** return tslib.__generator(this, function (_a) ***REMOVED***
...
var Subscription = /** @class */ (function () ***REMOVED***
    function Subscription(auth) ***REMOVED***
        ...
        this.auth = auth;
        this.observer = null;
        this.addObserver = util.createSubscribe(function (observer) ***REMOVED*** return (_this.observer = observer); });
  ***REMOVED***
...
function signInWithPhoneNumber$1(auth, request) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
...
function linkWithPhoneNumber$1(auth, request) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var response;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
function verifyPhoneNumberForExisting(auth, request) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var apiRequest;
        return tslib.__generator(this, function (_a) ***REMOVED***
            apiRequest = tslib.__assign(tslib.__assign(***REMOVED***}, request), ***REMOVED*** operation: 'REAUTH' });
...
var PhoneAuthCredential = /** @class */ (function (_super) ***REMOVED***
  ...
  ***REMOVED***;
    ...
    PhoneAuthCredential.prototype._linkToIdToken = function (auth, idToken) ***REMOVED***
        return linkWithPhoneNumber$1(auth, tslib.__assign(***REMOVED*** idToken: idToken }, this._makeVerificationRequest()));
  ***REMOVED***;
    /** @internal */
...
var OAuthProvider = /** @class */ (function (_super) ***REMOVED***
  ...
  ***REMOVED***;
    ...
    OAuthProvider.prototype.credential = function (params) ***REMOVED***
        return this._credential(tslib.__assign(tslib.__assign(***REMOVED***}, params), ***REMOVED*** nonce: params.rawNonce }));
  ***REMOVED***;
    /** An internal credential method that accepts more permissive options */
    OAuthProvider.prototype._credential = function (params) ***REMOVED***
        _assert(params.idToken || params.accessToken, "argument-error" /* AuthErrorCode.ARGUMENT_ERROR */);
        // For OAuthCredential, sign in method is same as providerId.
        return OAuthCredential._fromParams(tslib.__assign(tslib.__assign(***REMOVED***}, params), ***REMOVED*** providerId: this.providerId, signInMethod: this.providerId }));
  ***REMOVED***;
    /**
...
function _link(user, credential, bypassAuthState) ***REMOVED***
    if (bypassAuthState === void 0) ***REMOVED*** bypassAuthState = false; }
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var response, _a, _b, _c, _d, _e;
        return tslib.__generator(this, function (_f) ***REMOVED***
...
function confirmPasswordReset(auth, oobCode, newPassword) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, resetPassword(util.getModularInstance(auth), ***REMOVED***
                        oobCode: oobCode,
...
function applyActionCode(auth, oobCode) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, applyActionCode$1(util.getModularInstance(auth), ***REMOVED*** oobCode: oobCode })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
          ***REMOVED***
  ...
  ***REMOVED***
    ...
    MultiFactorResolverImpl._fromError = function (authExtern, error) ***REMOVED***
      ...
      ***REMOVED***);
        ...
        return new MultiFactorResolverImpl(session, hints, function (assertion) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib.__generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    ...
                    case 1:
                        ...
                        idTokenResponse = tslib.__assign(tslib.__assign(***REMOVED***}, serverResponse), ***REMOVED*** idToken: mfaResponse.idToken, refreshToken: mfaResponse.refreshToken });
...
function registerAuth(clientPlatform) ***REMOVED***
    app._registerComponent(new component.Component("auth" /* _ComponentName.AUTH */, function (container, _a) ***REMOVED***
        var deps = _a.options;
  ...
  ***REMOVED***));
    app._registerComponent(new component.Component("auth-internal" /* _ComponentName.AUTH_INTERNAL */, function (container) ***REMOVED***
          ...
          ***REMOVED***, NETWORK_TIMEOUT_DELAY.get());
            _window()[_JSLOAD_CALLBACK] = function () ***REMOVED***
              ...
              ***REMOVED***;
                ...
                resolve(recaptcha);
          ***REMOVED***;
            var url = "".concat(RECAPTCHA_BASE, "?").concat(util.querystring(***REMOVED***
...
var RecaptchaVerifier = /** @class */ (function () ***REMOVED***
    ...
    function RecaptchaVerifier(containerOrId, parameters, authExtern) ***REMOVED***
        if (parameters === void 0) ***REMOVED*** parameters = tslib.__assign(***REMOVED***}, DEFAULT_PARAMS); }
...
//# sourceMappingURL=phone-ec5655af.js.map
