 ...
 * be used in the persistence dependency field in ***REMOVED***@link initializeAuth}.
 *
 * @public
 */
function getReactNativePersistence(storage) ***REMOVED***
    var _a;
    ...
    return _a = /** @class */ (function () ***REMOVED***
            function class_1() ***REMOVED***
                this.type = "LOCAL" /* PersistenceType.LOCAL */;
          ***REMOVED***
            class_1.prototype._isAvailable = function () ***REMOVED***
              ...
              ***REMOVED***);
          ***REMOVED***;
            class_1.prototype._set = function (key, value) ***REMOVED***
                return storage.setItem(key, JSON.stringify(value));
          ***REMOVED***;
            class_1.prototype._get = function (key) ***REMOVED***
                return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
                    var json;
              ...
              ***REMOVED***);
          ***REMOVED***;
            class_1.prototype._remove = function (key) ***REMOVED***
                return storage.removeItem(key);
          ***REMOVED***;
            class_1.prototype._addListener = function (_key, _listener) ***REMOVED***
                // Listeners are not supported for React Native storage.
                return;
          ***REMOVED***;
            class_1.prototype._removeListener = function (_key, _listener) ***REMOVED***
                // Listeners are not supported for React Native storage.
                return;
          ***REMOVED***;
            return class_1;
 ...
 */
/**
 * An implementation of ***REMOVED***@link Persistence} of type 'LOCAL' for use in React
 * Native environments.
 *
 * @public
 */
var reactNativeLocalPersistence = getReactNativePersistence(***REMOVED***
    getItem: function () ***REMOVED***
        var _a;
        var args = [];
...
function getAuth(app$1) ***REMOVED***
  ...
  ***REMOVED***
    return phone.initializeAuth(app$1, ***REMOVED***
