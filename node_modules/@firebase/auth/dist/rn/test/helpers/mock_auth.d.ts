...
import ***REMOVED*** PopupRedirectResolver } from '../../src/model/public_types';
import ***REMOVED*** AuthImpl } from '../../src/core/auth/auth_impl';
import ***REMOVED*** PersistedBlob } from '../../src/core/persistence';
import ***REMOVED*** InMemoryPersistence } from '../../src/core/persistence/in_memory';
import ***REMOVED*** AuthInternal } from '../../src/model/auth';
import ***REMOVED*** UserInternal } from '../../src/model/user';
...
export interface TestAuth extends AuthImpl ***REMOVED***
    persistenceLayer: MockPersistenceLayer;
}
export declare const FAKE_HEARTBEAT_CONTROLLER: ***REMOVED***
    getHeartbeatsHeader: () => Promise<string>;
};
export declare const FAKE_HEARTBEAT_CONTROLLER_PROVIDER: Provider<'heartbeat'>;
export declare class MockPersistenceLayer extends InMemoryPersistence ***REMOVED***
