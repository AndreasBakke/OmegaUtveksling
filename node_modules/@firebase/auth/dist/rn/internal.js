...
function _allSettled(promises) ***REMOVED***
    var _this = this;
    return Promise.all(promises.map(function (promise) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
        var value, reason_1;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
                    ...
                    case 0:
                      ...
                      ***REMOVED***
                        messageEvent.ports[0].postMessage(***REMOVED***
                            ...
                            eventType: eventType
                      ***REMOVED***);
                        promises = Array.from(handlers).map(function (handler) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED*** return tslib.__generator(this, function (_a) ***REMOVED***
    ...
    return new Promise(function (resolve, reject) ***REMOVED***
      ...
      ***REMOVED***);
        request.addEventListener('upgradeneeded', function () ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***);
        request.addEventListener('success', function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            var db, _a;
            return tslib.__generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
...
var IndexedDBLocalPersistence = /** @class */ (function () ***REMOVED***
    ...
    IndexedDBLocalPersistence.prototype.initializeReceiver = function () ***REMOVED***
        return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib.__generator(this, function (_a) ***REMOVED***
                ...
                this.receiver._subscribe("keyChanged" /* _EventType.KEY_CHANGED */, function (_origin, data) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                    var keys;
                    return tslib.__generator(this, function (_a) ***REMOVED***
                        switch (_a.label) ***REMOVED***
              ...
              ***REMOVED***); });
                ...
                this.receiver._subscribe("ping" /* _EventType.PING */, function (_origin, _data) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                    return tslib.__generator(this, function (_a) ***REMOVED***
                ...
                switch (_b.label) ***REMOVED***
                    case 0:
                        if (!this.sender ||
                            ...
                            phone._getServiceWorkerController() !== this.activeServiceWorker) ***REMOVED***
                            return [2 /*return*/];
                      ***REMOVED***
                        _b.label = 1;
                    case 1:
  ...
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype._set = function (key, value) ***REMOVED***
        return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return tslib.__generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this._withPendingWrite(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                        return tslib.__generator(this, function (_a) ***REMOVED***
                            switch (_a.label) ***REMOVED***
  ...
  ***REMOVED***;
    IndexedDBLocalPersistence.prototype.startPolling = function () ***REMOVED***
        var _this = this;
        this.stopPolling();
        this.pollTimer = setInterval(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED*** return tslib.__generator(this, function (_a) ***REMOVED***
...
var AbstractPopupRedirectOperation = /** @class */ (function () ***REMOVED***
  ...
  ***REMOVED***
    AbstractPopupRedirectOperation.prototype.execute = function () ***REMOVED***
        var _this = this;
        return new Promise(function (resolve, reject) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            var _a, e_1;
            return tslib.__generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
...
var RedirectAction = /** @class */ (function (_super) ***REMOVED***
  ...
  ***REMOVED***;
    RedirectAction.prototype.onExecution = function () ***REMOVED***
        return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED*** return tslib.__generator(this, function (_a) ***REMOVED***
            return [2 /*return*/];
      ***REMOVED***); });
  ***REMOVED***;
...
function _validateOrigin$1(auth) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
...
function loadGapi(auth) ***REMOVED***
    return new Promise(function (resolve, reject) ***REMOVED***
        ...
        function loadGapiIframe() ***REMOVED***
          ...
          ***REMOVED***);
      ***REMOVED***
        if ((_b = (_a = phone._window().gapi) === null || _a === void 0 ? void 0 : _a.iframes) === null || _b === void 0 ? void 0 : _b.Iframe) ***REMOVED***
            // If gapi.iframes.Iframe available, resolve.
            resolve(gapi.iframes.getContext());
      ***REMOVED***
        else if (!!((_c = phone._window().gapi) === null || _c === void 0 ? void 0 : _c.load)) ***REMOVED***
      ...
      ***REMOVED***
            ...
            phone._window()[cbName] = function () ***REMOVED***
                                ...
                                return tslib.__generator(this, function (_a) ***REMOVED***
                                    switch (_a.label) ***REMOVED***
                                        ...
                                        case 1:
                                            ...
                                            networkErrorTimer = phone._window().setTimeout(function () ***REMOVED***
                                                reject(networkError);
...
function _open(auth, url, name, width, height) ***REMOVED***
    ...
    var target = '';
    var options = tslib.__assign(tslib.__assign(***REMOVED***}, BASE_POPUP_OPTIONS), ***REMOVED*** width: width.toString(), height: height.toString(), top: top, left: left });
  ...
  ***REMOVED***
    if (phone._isFirefox(ua)) ***REMOVED***
  ...
  ***REMOVED***, '');
    if (phone._isIOSStandalone(ua) && target !== '_self') ***REMOVED***
...
function _getRedirectUrl(auth, provider, authType, redirectUrl, eventId, additionalParams) ***REMOVED***
    ...
    var params = ***REMOVED***
        ...
        eventId: eventId
  ***REMOVED***;
    if (provider instanceof phone.FederatedAuthProvider) ***REMOVED***
        provider.setDefaultLanguage(auth.languageCode);
        params.providerId = provider.providerId || '';
        if (!util.isEmpty(provider.getCustomParameters())) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    if (provider instanceof phone.BaseOAuthProvider) ***REMOVED***
...
var mintCookieFactory = function (url) ***REMOVED*** return function (user) ***REMOVED*** return tslib.__awaiter(void 0, void 0, void 0, function () ***REMOVED***
...
function getAuth(app$1) ***REMOVED***
  ...
  ***REMOVED***
    var auth = phone.initializeAuth(app$1, ***REMOVED***
  ...
  ***REMOVED***);
    ...
    if (authTokenSyncUrl) ***REMOVED***
        ...
        phone.beforeAuthStateChanged(auth, mintCookie_1, function () ***REMOVED***
            return mintCookie_1(auth.currentUser);
      ***REMOVED***);
        phone.onIdTokenChanged(auth, function (user) ***REMOVED*** return mintCookie_1(user); });
  ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                ...
                case 1:
                    ...
                    if (phone._isIOS()) ***REMOVED***
                        // iOS app identifier
                        additionalParams['ibi'] = BuildInfo.packageName;
                  ***REMOVED***
                    else if (phone._isAndroid()) ***REMOVED***
...
function _checkCordovaConfiguration(auth) ***REMOVED***
    ...
    phone._assert(typeof ((_a = win === null || win === void 0 ? void 0 : win.universalLinks) === null || _a === void 0 ? void 0 : _a.subscribe) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, ***REMOVED***
        missingPlugin: 'cordova-universal-links-plugin-fix'
  ***REMOVED***);
    // https://www.npmjs.com/package/cordova-plugin-buildinfo
    phone._assert(typeof ((_b = win === null || win === void 0 ? void 0 : win.BuildInfo) === null || _b === void 0 ? void 0 : _b.packageName) !== 'undefined', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, ***REMOVED***
        missingPlugin: 'cordova-plugin-buildInfo'
  ***REMOVED***);
    // https://github.com/google/cordova-plugin-browsertab
    phone._assert(typeof ((_e = (_d = (_c = win === null || win === void 0 ? void 0 : win.cordova) === null || _c === void 0 ? void 0 : _c.plugins) === null || _d === void 0 ? void 0 : _d.browsertab) === null || _e === void 0 ? void 0 : _e.openUrl) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, ***REMOVED***
        missingPlugin: 'cordova-plugin-browsertab'
  ***REMOVED***);
    phone._assert(typeof ((_h = (_g = (_f = win === null || win === void 0 ? void 0 : win.cordova) === null || _f === void 0 ? void 0 : _f.plugins) === null || _g === void 0 ? void 0 : _g.browsertab) === null || _h === void 0 ? void 0 : _h.isAvailable) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, ***REMOVED***
        missingPlugin: 'cordova-plugin-browsertab'
  ***REMOVED***);
    // https://cordova.apache.org/docs/en/latest/reference/cordova-plugin-inappbrowser/
    phone._assert(typeof ((_k = (_j = win === null || win === void 0 ? void 0 : win.cordova) === null || _j === void 0 ? void 0 : _j.InAppBrowser) === null || _k === void 0 ? void 0 : _k.open) === 'function', auth, "invalid-cordova-configuration" /* AuthErrorCode.INVALID_CORDOVA_CONFIGURATION */, ***REMOVED***
...
var CordovaPopupRedirectResolver = /** @class */ (function () ***REMOVED***
  ...
  ***REMOVED***;
    CordovaPopupRedirectResolver.prototype.attachCallbackListeners = function (auth, manager) ***REMOVED***
        ...
        var noEventTimeout = setTimeout(function () ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            return tslib.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0: 
      ...
      ***REMOVED***); }, INITIAL_EVENT_TIMEOUT_MS);
        var universalLinksCb = function (eventData) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
      ...
      ***REMOVED***
        ...
        _cordovaWindow().handleOpenURL = function (url) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
            return tslib.__generator(this, function (_a) ***REMOVED***
