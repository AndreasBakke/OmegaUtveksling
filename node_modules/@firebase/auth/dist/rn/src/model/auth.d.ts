 ...
 */
import ***REMOVED*** Auth, AuthSettings, Config, EmulatorConfig, PopupRedirectResolver, User } from './public_types';
import ***REMOVED*** ErrorFactory } from '@firebase/util';
import ***REMOVED*** AuthErrorCode, AuthErrorParams } from '../core/errors';
import ***REMOVED*** PopupRedirectResolverInternal } from './popup_redirect';
import ***REMOVED*** UserInternal } from './user';
import ***REMOVED*** ClientPlatform } from '../core/util/version';
 ...
 * @internal
 */
export interface ConfigInternal extends Config ***REMOVED***
    /**
     * @readonly
     */
    emulator?: ***REMOVED***
 ...
 * @internal
 */
export interface AuthInternal extends Auth ***REMOVED***
