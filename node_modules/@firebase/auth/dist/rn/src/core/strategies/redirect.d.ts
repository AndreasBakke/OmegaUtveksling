...
import ***REMOVED*** AuthEvent, PopupRedirectResolverInternal } from '../../model/popup_redirect';
import ***REMOVED*** UserCredentialInternal } from '../../model/user';
import ***REMOVED*** AbstractPopupRedirectOperation } from './abstract_popup_redirect_operation';
export declare class RedirectAction extends AbstractPopupRedirectOperation ***REMOVED***
    eventId: null;
