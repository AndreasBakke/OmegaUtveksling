...
import ***REMOVED*** getToken, deleteToken, onMessage } from '@firebase/messaging';
import ***REMOVED*** isIndexedDBAvailable, areCookiesEnabled } from '@firebase/util';
import ***REMOVED*** onBackgroundMessage } from '@firebase/messaging/sw';
 ...
 */
function isSwSupported() ***REMOVED***
...
var MessagingCompatImpl = /** @class */ (function () ***REMOVED***
    function MessagingCompatImpl(app, _delegate) ***REMOVED***
        this.app = app;
        this._delegate = _delegate;
        this.app = app;
        this._delegate = _delegate;
  ***REMOVED***
    MessagingCompatImpl.prototype.getToken = function (options) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    MessagingCompatImpl.prototype.deleteToken = function () ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
      ...
      ***REMOVED***);
  ***REMOVED***;
    MessagingCompatImpl.prototype.onMessage = function (nextOrObserver) ***REMOVED***
        return onMessage(this._delegate, nextOrObserver);
  ***REMOVED***;
    MessagingCompatImpl.prototype.onBackgroundMessage = function (nextOrObserver) ***REMOVED***
 ...
 * limitations under the License.
 */
var messagingCompatFactory = function (container) ***REMOVED***
    if (self && 'ServiceWorkerGlobalScope' in self) ***REMOVED***
        // in sw
...
var NAMESPACE_EXPORTS = ***REMOVED***
    isSupported: isSupported
};
function registerMessagingCompat() ***REMOVED***
