 ...
 * the License.
 */
export interface FcmEvent ***REMOVED***
 ...
 */
export interface LogRequest ***REMOVED***
    log_source: string;
    log_event: LogEvent[];
}
export interface LogEvent ***REMOVED***
    event_time_ms: string;
    source_extension_json_proto3: string;
}
export interface LogResponse ***REMOVED***
    nextRequestWaitMillis: number;
    logResponseDetails: LogResponseDetails[];
}
interface LogResponseDetails ***REMOVED***
    responseAction: UserResponse;
}
export declare const enum UserResponse ***REMOVED***
