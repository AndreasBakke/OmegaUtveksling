 ...
 */
import ***REMOVED*** ExtendableEvent } from '../../util/sw-types';
export declare function mockServiceWorker(): void;
export declare function restoreServiceWorker(): void;
export declare class FakeServiceWorkerRegistration implements ServiceWorkerRegistration ***REMOVED***
    active: null;
    installing: null;
    waiting: null;
    onupdatefound: null;
...
declare class FakePushManager implements PushManager ***REMOVED***
...
export declare class FakePushSubscription implements PushSubscription ***REMOVED***
    endpoint: string;
 ...
 * Event interface.
 */
export declare class FakeEvent implements ExtendableEvent ***REMOVED***
    type: string;
    NONE: number;
    AT_TARGET: number;
