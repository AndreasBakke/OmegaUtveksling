...
interface ErrorParams ***REMOVED***
    [ErrorCode.MISSING_APP_CONFIG_VALUES]: ***REMOVED***
        valueName: string;
  ***REMOVED***;
    [ErrorCode.FAILED_DEFAULT_REGISTRATION]: ***REMOVED***
        browserErrorMessage: string;
  ***REMOVED***;
    [ErrorCode.TOKEN_SUBSCRIBE_FAILED]: ***REMOVED***
        errorInfo: string;
  ***REMOVED***;
    [ErrorCode.TOKEN_UNSUBSCRIBE_FAILED]: ***REMOVED***
        errorInfo: string;
  ***REMOVED***;
    [ErrorCode.TOKEN_UPDATE_FAILED]: ***REMOVED***
        errorInfo: string;
  ***REMOVED***;
}
