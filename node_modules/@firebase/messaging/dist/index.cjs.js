...
var MessageType$1;
(function (MessageType) ***REMOVED***
    MessageType[MessageType["DATA_MESSAGE"] = 1] = "DATA_MESSAGE";
    MessageType[MessageType["DISPLAY_NOTIFICATION"] = 3] = "DISPLAY_NOTIFICATION";
})(MessageType$1 || (MessageType$1 = ***REMOVED***}));
 ...
 * limitations under the License.
 */
function arrayToBase64(array) ***REMOVED***
...
function base64ToArray(base64String) ***REMOVED***
    ...
    for (var i = 0; i < rawData.length; ++i) ***REMOVED***
...
function migrateOldDatabase(senderId) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                    databases = _a.sent();
                    dbNames = databases.map(function (db) ***REMOVED*** return db.name; });
                ...
                case 2:
                    tokenDetails = null;
                    return [4 /*yield*/, idb.openDB(OLD_DB_NAME, OLD_DB_VERSION, ***REMOVED***
                            upgrade: function (db, oldVersion, newVersion, upgradeTransaction) ***REMOVED*** return tslib.__awaiter(_this, void 0, void 0, function () ***REMOVED***
...
function checkTokenDetails(tokenDetails) ***REMOVED***
...
function getDbPromise() ***REMOVED***
    if (!dbPromise) ***REMOVED***
        dbPromise = idb.openDB(DATABASE_NAME, DATABASE_VERSION, ***REMOVED***
            upgrade: function (upgradeDb, oldVersion) ***REMOVED***
...
function dbGet(firebaseDependencies) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
...
function dbSet(firebaseDependencies, tokenDetails) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var key, db, tx;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
function dbRemove(firebaseDependencies) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var key, db, tx;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
...
var ERROR_MAP = (_a = ***REMOVED***},
    ...
    _a["failed-service-worker-registration" /* ErrorCode.FAILED_DEFAULT_REGISTRATION */] = 'We are unable to register the default service worker. ***REMOVED***$browserErrorMessage}',
    _a["token-subscribe-failed" /* ErrorCode.TOKEN_SUBSCRIBE_FAILED */] = 'A problem occurred while subscribing the user to FCM: ***REMOVED***$errorInfo}',
    ...
    _a["token-update-failed" /* ErrorCode.TOKEN_UPDATE_FAILED */] = 'A problem occurred while updating the user from FCM: ***REMOVED***$errorInfo}',
 ...
 * limitations under the License.
 */
function requestGetToken(firebaseDependencies, subscriptionOptions) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 5:
                    err_1 = _a.sent();
                    throw ERROR_FACTORY.create("token-subscribe-failed" /* ErrorCode.TOKEN_SUBSCRIBE_FAILED */, ***REMOVED***
...
function requestUpdateToken(firebaseDependencies, tokenDetails) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 5:
                    err_2 = _a.sent();
                    throw ERROR_FACTORY.create("token-update-failed" /* ErrorCode.TOKEN_UPDATE_FAILED */, ***REMOVED***
...
function requestDeleteToken(firebaseDependencies, token) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 4:
                    ...
                    if (responseData.error) ***REMOVED***
                        message = responseData.error.message;
                        throw ERROR_FACTORY.create("token-unsubscribe-failed" /* ErrorCode.TOKEN_UNSUBSCRIBE_FAILED */, ***REMOVED***
                            errorInfo: message
                      ***REMOVED***);
                  ***REMOVED***
                    return [3 /*break*/, 6];
...
function getEndpoint(_a) ***REMOVED***
    ...
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                ...
                case 1:
                    authToken = _b.sent();
                    return [2 /*return*/, new Headers(***REMOVED***
...
function getTokenInternal(messaging) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 8:
                    if (Date.now() >= tokenDetails.createTime + TOKEN_EXPIRATION_MS) ***REMOVED***
                        // Weekly token refresh
                        return [2 /*return*/, updateToken(messaging, ***REMOVED***
 ...
 */
function deleteTokenInternal(messaging) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
...
function updateToken(messaging, tokenDetails) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                    ...
                    updatedTokenDetails = tslib.__assign(tslib.__assign(***REMOVED***}, tokenDetails), ***REMOVED*** token: updatedToken, createTime: Date.now() });
...
function getNewToken(firebaseDependencies, subscriptionOptions) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
 ...
 */
function getPushSubscription(swRegistration, vapidKey) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var subscription;
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 1:
                  ...
                  ***REMOVED***
                    return [2 /*return*/, swRegistration.pushManager.subscribe(***REMOVED***
 ...
 */
function isTokenValid(dbOptions, currentOptions) ***REMOVED***
 ...
 * limitations under the License.
 */
function externalizePayload(internalPayload) ***REMOVED***
    var payload = ***REMOVED***
...
function propagateNotificationPayload(payload, messagePayloadInternal) ***REMOVED***
...
function propagateDataPayload(payload, messagePayloadInternal) ***REMOVED***
    if (!messagePayloadInternal.data) ***REMOVED***
        return;
  ***REMOVED***
    payload.data = messagePayloadInternal.data;
}
function propagateFcmOptions(payload, messagePayloadInternal) ***REMOVED***
    var _a, _b, _c, _d, _e;
    // fcmOptions.link value is written into notification.click_action. see more in b/232072111
    if (!messagePayloadInternal.fcmOptions &&
        !((_a = messagePayloadInternal.notification) === null || _a === void 0 ? void 0 : _a.click_action)) ***REMOVED***
        return;
  ***REMOVED***
 ...
 * limitations under the License.
 */
function isConsoleMessage(data) ***REMOVED***
...
function _mergeStrings(s1, s2) ***REMOVED***
    var resultArray = [];
    for (var i = 0; i < s1.length; i++) ***REMOVED***
...
function extractAppConfig(app) ***REMOVED***
  ...
  ***REMOVED***
    ...
    try ***REMOVED***
        for (var configKeys_1 = tslib.__values(configKeys), configKeys_1_1 = configKeys_1.next(); !configKeys_1_1.done; configKeys_1_1 = configKeys_1.next()) ***REMOVED***
 ...
 * limitations under the License.
 */
var MessagingService = /** @class */ (function () ***REMOVED***
    function MessagingService(app, installations, analyticsProvider) ***REMOVED***
      ...
      ***REMOVED***;
  ***REMOVED***
    MessagingService.prototype._delete = function () ***REMOVED***
 ...
 * limitations under the License.
 */
function registerDefaultSw(messaging) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var _a, e_1;
        return tslib.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = messaging;
                    return [4 /*yield*/, navigator.serviceWorker.register(DEFAULT_SW_PATH, ***REMOVED***
                ...
                case 1:
                    ...
                    messaging.swRegistration.update().catch(function () ***REMOVED***
                        /* it is non blocking and we don't care if it failed */
                  ***REMOVED***);
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _b.sent();
                    throw ERROR_FACTORY.create("failed-service-worker-registration" /* ErrorCode.FAILED_DEFAULT_REGISTRATION */, ***REMOVED***
 ...
 * limitations under the License.
 */
function updateSwReg(messaging, swRegistration) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
 ...
 * limitations under the License.
 */
function updateVapidKey(messaging, vapidKey) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            if (!!vapidKey) ***REMOVED***
                messaging.vapidKey = vapidKey;
          ***REMOVED***
            else if (!messaging.vapidKey) ***REMOVED***
 ...
 * limitations under the License.
 */
function getToken$1(messaging, options) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
 ...
 * limitations under the License.
 */
function logToScion(messaging, messageType, data) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
...
function getEventType(messageType) ***REMOVED***
 ...
 * limitations under the License.
 */
function messageEventListener(messaging, event) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
                ...
                case 0:
                  ...
                  ***REMOVED***
                    if (messaging.onMessageHandler &&
                        internalPayload.messageType === MessageType.PUSH_RECEIVED) ***REMOVED***
 ...
 * limitations under the License.
 */
var WindowMessagingFactory = function (container) ***REMOVED***
    ...
    navigator.serviceWorker.addEventListener('message', function (e) ***REMOVED***
        return messageEventListener(messaging, e);
  ***REMOVED***);
    return messaging;
};
var WindowMessagingInternalFactory = function (container) ***REMOVED***
    var messaging = container
        .getProvider('messaging')
        .getImmediate();
    var messagingInternal = ***REMOVED***
        getToken: function (options) ***REMOVED*** return getToken$1(messaging, options); }
  ***REMOVED***;
    return messagingInternal;
};
function registerMessagingInWindow() ***REMOVED***
 ...
 * @public
 */
function isWindowSupported() ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
 ...
 * limitations under the License.
 */
function deleteToken$1(messaging) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
 ...
 * limitations under the License.
 */
function onMessage$1(messaging, nextOrObserver) ***REMOVED***
    if (!navigator) ***REMOVED***
        throw ERROR_FACTORY.create("only-available-in-window" /* ErrorCode.AVAILABLE_IN_WINDOW */);
  ***REMOVED***
 ...
 * @public
 */
function getToken(messaging, options) ***REMOVED***
    return tslib.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib.__generator(this, function (_a) ***REMOVED***
 ...
 * @public
 */
function deleteToken(messaging) ***REMOVED***
    messaging = util.getModularInstance(messaging);
 ...
 * @public
 */
function onMessage(messaging, nextOrObserver) ***REMOVED***
    messaging = util.getModularInstance(messaging);
