 ...
 */
import ***REMOVED*** ComponentContainer } from './component_container';
export declare const enum InstantiationMode ***REMOVED***
    LAZY = "LAZY",
    EAGER = "EAGER",
    EXPLICIT = "EXPLICIT"
}
 ...
 */
export declare const enum ComponentType ***REMOVED***
    PUBLIC = "PUBLIC",
    PRIVATE = "PRIVATE",
    VERSION = "VERSION"
}
export interface InstanceFactoryOptions ***REMOVED***
 ...
 * ComponentContainer is the IOC container that provides ***REMOVED***@link Provider}
 * for dependencies.
 *
 * NOTE: The container only provides ***REMOVED***@link Provider} rather than the actual instances of dependencies.
...
export interface Dictionary ***REMOVED***
    [key: string]: unknown;
}
/**
 ...
 */
export interface NameServiceMapping ***REMOVED***
}
