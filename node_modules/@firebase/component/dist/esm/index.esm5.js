import ***REMOVED*** __values, __read, __awaiter, __generator, __spreadArray } from 'tslib';
    ...
    Provider.prototype.setComponent = function (component) ***REMOVED***
      ...
      ***REMOVED***
        try ***REMOVED***
            ...
            for (var _b = __values(this.instancesDeferred.entries()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
                ...
                switch (_a.label) ***REMOVED***
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all(__spreadArray(__spreadArray([], __read(services
                                ...
                                .map(function (service) ***REMOVED*** return service.INTERNAL.delete(); })), false), __read(services
    ...
    Provider.prototype.initialize = function (opts) ***REMOVED***
      ...
      ***REMOVED***);
        try ***REMOVED***
            ...
            for (var _c = __values(this.instancesDeferred.entries()), _d = _c.next(); !_d.done; _d = _c.next()) ***REMOVED***
