import ***REMOVED*** getApp, _getProvider, _registerComponent, registerVersion, SDK_VERSION as SDK_VERSION$1 } from '@firebase/app';
import ***REMOVED*** Component } from '@firebase/component';
import ***REMOVED*** __spreadArray, __read, __values, __extends, __awaiter, __generator, __assign } from 'tslib';
  ...
  ***REMOVED***);
    TransportManager.prototype.initTransports_ = function (repoInfo) ***REMOVED***
      ...
      ***REMOVED***
            ...
            try ***REMOVED***
                for (var _b = __values(TransportManager.ALL_TRANSPORTS), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
  ...
  ***REMOVED***;
    PersistentConnection.prototype.restoreState_ = function () ***REMOVED***
        ...
        try ***REMOVED***
            ...
            for (var _c = __values(this.listens.values()), _d = _c.next(); !_d.done; _d = _c.next()) ***REMOVED***
                var queries = _d.value;
                try ***REMOVED***
                    for (var _e = (e_2 = void 0, __values(queries.values())), _f = _e.next(); !_f.done; _f = _e.next()) ***REMOVED***
  ...
  ***REMOVED***;
    IndexMap.prototype.addIndex = function (indexDefinition, existingChildren) ***REMOVED***
      ...
      ***REMOVED***
        ...
        var newIndexSet = __assign(***REMOVED***}, this.indexSet_);
        newIndexSet[indexName] = indexDefinition;
        var newIndexes = __assign(***REMOVED***}, this.indexes_);
...
var StatsListener = /** @class */ (function () ***REMOVED***
  ...
  ***REMOVED***
    StatsListener.prototype.get = function () ***REMOVED***
        ...
        var delta = __assign(***REMOVED***}, newStats);
...
function syncPointApplyOperation(syncPoint, operation, writesCache, optCompleteServerCache) ***REMOVED***
  ...
  ***REMOVED***
        ...
        var events = [];
        try ***REMOVED***
            for (var _b = __values(syncPoint.views.values()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
                var view = _c.value;
...
function syncPointRemoveEventRegistration(syncPoint, query, eventRegistration, cancelError) ***REMOVED***
    ...
    if (queryId === 'default') ***REMOVED***
        try ***REMOVED***
            ...
            for (var _b = __values(syncPoint.views.entries()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
...
function treeSubTree(tree, pathObj) ***REMOVED***
    ...
    while (next !== null) ***REMOVED***
        var childNode = safeGet(child.node.children, next) || ***REMOVED***
            children: ***REMOVED***},
            childCount: 0
      ***REMOVED***;
...
function repoOnDataUpdate(repo, pathString, data, isMerge, tag) ***REMOVED***
    ...
    if (tag) ***REMOVED***
        if (isMerge) ***REMOVED***
            var taggedChildren = map(data, function (raw) ***REMOVED*** return nodeFromJSON(raw); });
  ...
  ***REMOVED***
        ...
        var changedChildren = map(data, function (raw) ***REMOVED*** return nodeFromJSON(raw); });
...
function decodeQuery(queryString) ***REMOVED***
  ...
  ***REMOVED***
    try ***REMOVED***
        for (var _b = __values(queryString.split('&')), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
...
function query(query) ***REMOVED***
  ...
  ***REMOVED***
    ...
    try ***REMOVED***
        for (var queryConstraints_1 = __values(queryConstraints), queryConstraints_1_1 = queryConstraints_1.next(); !queryConstraints_1_1.done; queryConstraints_1_1 = queryConstraints_1.next()) ***REMOVED***
 ...
 */
function getDatabase(app, url) ***REMOVED***
    if (app === void 0) ***REMOVED*** app = getApp(); }
    var db = _getProvider(app, 'database').getImmediate(***REMOVED***
        identifier: url
  ***REMOVED***);
...
function registerDatabase(variant) ***REMOVED***
    ...
    _registerComponent(new Component('database', function (container, _a) ***REMOVED***
