...
import ***REMOVED*** SparseSnapshotTree } from './SparseSnapshotTree';
import ***REMOVED*** StatsCollection } from './stats/StatsCollection';
import ***REMOVED*** StatsListener } from './stats/StatsListener';
import ***REMOVED*** StatsReporter } from './stats/StatsReporter';
import ***REMOVED*** SyncTree } from './SyncTree';
import ***REMOVED*** Indexable } from './util/misc';
import ***REMOVED*** Path } from './util/Path';
import ***REMOVED*** Tree } from './util/Tree';
import ***REMOVED*** EventQueue } from './view/EventQueue';
...
export declare function repoUpdate(repo: Repo, path: Path, childrenToMerge: ***REMOVED***
    [k: string]: unknown;
...
export declare function repoOnDisconnectUpdate(repo: Repo, path: Path, childrenToMerge: ***REMOVED***
    [k: string]: unknown;
}, onComplete: ((status: Error | null, errorReason?: string) => void) | null): void;
