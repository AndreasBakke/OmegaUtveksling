 ...
 */
export declare class FirebaseAuthTokenProvider implements AuthTokenProvider ***REMOVED***
    private appName_;
...
export declare class EmulatorTokenProvider implements AuthTokenProvider ***REMOVED***
    private accessToken;
