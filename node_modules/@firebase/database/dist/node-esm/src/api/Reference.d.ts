...
import ***REMOVED*** QueryContext } from '../core/view/EventRegistration';
/**
 * @license
 ...
 */
export interface Query extends QueryContext ***REMOVED***
 ...
 */
export interface DatabaseReference extends Query ***REMOVED***
    /**
 ...
 */
export interface ThenableReference extends DatabaseReference, Pick<Promise<DatabaseReference>, 'then' | 'catch'> ***REMOVED***
}
