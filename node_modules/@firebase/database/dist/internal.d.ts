...
import ***REMOVED*** AppCheckTokenListener } from '@firebase/app-check-interop-types';
import ***REMOVED*** AppCheckTokenResult } from '@firebase/app-check-interop-types';
 ...
 */
declare class AppCheckTokenProvider ***REMOVED***
    private appName_;
...
declare interface AuthTokenProvider ***REMOVED***
 ...
 */
declare class CacheNode ***REMOVED***
    private node_;
...
declare class CancelEvent implements Event_2 ***REMOVED***
...
declare interface Change ***REMOVED***
...
declare class ChildChangeAccumulator ***REMOVED***
 ...
 * @interface
 */
declare interface CompleteChildSource ***REMOVED***
 ...
 */
declare class CompoundWrite ***REMOVED***
 ...
 */
export declare function connectDatabaseEmulator(db: Database, host: string, port: number, options?: ***REMOVED***
 ...
 */
export declare class Database implements _FirebaseService ***REMOVED***
    _repoInternal: Repo;
 ...
 * `on*()` method. See ***REMOVED***@link
 * https://firebase.google.com/docs/database/web/read-and-write}
 */
export declare interface DatabaseReference extends Query ***REMOVED***
    /**
 ...
 */
export declare class DataSnapshot ***REMOVED***
 ...
 * @interface
 */
declare interface Event_2 ***REMOVED***
    getPath(): Path;
    getEventType(): string;
    getEventRunner(): () => void;
    toString(): string;
 ...
 *
 */
declare class EventGenerator ***REMOVED***
    query_: QueryContext;
    index_: Index;
    constructor(query_: QueryContext);
}

declare interface EventList ***REMOVED***
    events: Event_2[];
    path: Path;
}
 ...
 *
 */
declare class EventQueue ***REMOVED***
 ...
 */
declare interface EventRegistration ***REMOVED***
    /**
 ...
 */
declare class ImmutableTree<T> ***REMOVED***
    readonly value: T | null;
    readonly children: SortedMap<string, ImmutableTree<T>>;
    static fromObject<T>(obj: ***REMOVED***
        [k: string]: T;
  ***REMOVED***): ImmutableTree<T>;
     ...
     */
    findRootMostMatchingPathAndValue(relativePath: Path, predicate: (a: T) => boolean): ***REMOVED***
        path: Path;
        value: T;
  ***REMOVED*** | null;
    /**
     ...
     * value in the tree
     */
    findRootMostValueAndPath(relativePath: Path): ***REMOVED***
        path: Path;
        value: T;
  ***REMOVED*** | null;
    /**
     ...
     */
    fold<V>(fn: (path: Path, value: T, children: ***REMOVED***
        [k: string]: V;
  ***REMOVED***) => V): V;
    /**
...
declare abstract class Index ***REMOVED***
...
export declare interface ListenOptions ***REMOVED***
    /** Whether to remove the listener after its first invocation. */
    readonly onlyOnce?: boolean;
}

declare interface ListenProvider ***REMOVED***
...
declare class NamedNode ***REMOVED***
    name: string;
    node: Node_2;
 ...
 * @interface
 */
declare interface Node_2 ***REMOVED***
    /**
 ...
 * @interface
 */
declare interface NodeFilter_2 ***REMOVED***
    /**
 ...
 */
declare class PersistentConnection extends ServerActions ***REMOVED***
    private repoInfo_;
...
declare class PriorityIndex extends Index ***REMOVED***
 ...
 *
 * See ***REMOVED***@link https://firebase.google.com/docs/database/web/lists-of-data#sorting_and_filtering_data}
 * for more information.
 */
export declare interface Query extends QueryContext ***REMOVED***
...
declare interface QueryContext ***REMOVED***
 ...
 * @internal
 */
export declare class _QueryImpl implements Query, QueryContext ***REMOVED***
    readonly _repo: Repo;
    readonly _path: Path;
    readonly _queryParams: _QueryParams;
 ...
 * @internal
 */
export declare class _QueryParams ***REMOVED***
    limitSet_: boolean;
    startSet_: boolean;
 ...
 * @internal
 */
export declare class _ReferenceImpl extends _QueryImpl implements DatabaseReference ***REMOVED***
    /** @hideconstructor */
 ...
 */
declare class RepoInfo ***REMOVED***
 ...
 * @interface
 */
declare abstract class ServerActions ***REMOVED***
 ...
 */
declare class SnapshotHolder ***REMOVED***
    private rootNode_;
 ...
 */
declare class SortedMapIterator<K, V, T> ***REMOVED***
    private isReverse_;
 ...
 */
declare interface SparseSnapshotTree ***REMOVED***
    value: Node_2 | null;
 ...
 */
declare class StatsCollection ***REMOVED***
    private counters_;
 ...
 */
declare class StatsListener ***REMOVED***
    private collection_;
    private last_;
...
declare class StatsReporter ***REMOVED***
    private server_;
    private statsListener_;
    statsToReport_: ***REMOVED***
        [k: string]: boolean;
  ***REMOVED***;
 ...
 */
declare class SyncPoint ***REMOVED***
    /**
 ...
 *
 */
declare class SyncTree ***REMOVED***
 ...
 * ***REMOVED***@link push}. The reference is available immediately and the `Promise` resolves
 * as the write to the backend completes.
 */
export declare interface ThenableReference extends DatabaseReference, Pick<Promise<DatabaseReference>, 'then' | 'catch'> ***REMOVED***
}

declare interface Transaction ***REMOVED***
    path: Path;
...
declare const enum TransactionStatus ***REMOVED***
    RUN = 0,
    SENT = 1,
    COMPLETED = 2,
    SENT_NEEDS_ABORT = 3,
 ...
 * Node in a Tree.
 */
declare interface TreeNode<T> ***REMOVED***
 ...
 * @internal
 */
export declare interface _UserCallback ***REMOVED***
 ...
 */
declare interface ViewCache ***REMOVED***
    readonly eventCache: CacheNode;
    readonly serverCache: CacheNode;
}

declare interface ViewProcessor ***REMOVED***
 ...
 */
declare interface WriteRecord ***REMOVED***
    writeId: number;
    path: Path;
    snap?: Node_2 | null;
    children?: ***REMOVED***
 ...
 */
declare interface WriteTree ***REMOVED***
    /**
