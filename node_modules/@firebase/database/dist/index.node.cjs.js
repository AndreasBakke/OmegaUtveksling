 ...
 */
function getDatabase(app$1, url) ***REMOVED***
    if (app$1 === void 0) ***REMOVED*** app$1 = app.getApp(); }
    var db = app._getProvider(app$1, 'database').getImmediate(***REMOVED***
        identifier: url
  ***REMOVED***);
...
function registerDatabase(variant) ***REMOVED***
    ...
    app._registerComponent(new component.Component('database', function (container, _a) ***REMOVED***
