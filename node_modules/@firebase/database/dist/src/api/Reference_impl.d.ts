 ...
 */
import ***REMOVED*** Repo } from '../core/Repo';
...
import ***REMOVED*** CallbackContext, EventRegistration, QueryContext } from '../core/view/EventRegistration';
import ***REMOVED*** QueryParams } from '../core/view/QueryParams';
import ***REMOVED*** Database } from './Database';
import ***REMOVED*** OnDisconnect } from './OnDisconnect';
import ***REMOVED*** ListenOptions, Query as Query, DatabaseReference, Unsubscribe, ThenableReference } from './Reference';
/**
 * @internal
 */
export declare class QueryImpl implements Query, QueryContext ***REMOVED***
    readonly _repo: Repo;
    readonly _path: Path;
 ...
 * @internal
 */
export declare class ReferenceImpl extends QueryImpl implements DatabaseReference ***REMOVED***
    /** @hideconstructor */
...
export interface ThenableReferenceImpl extends ReferenceImpl, Pick<Promise<ReferenceImpl>, 'then' | 'catch'> ***REMOVED***
}
/**
 ...
 */
export declare class ValueEventRegistration implements EventRegistration ***REMOVED***
 ...
 */
export declare class ChildEventRegistration implements EventRegistration ***REMOVED***
    private eventType;
    private callbackContext;
