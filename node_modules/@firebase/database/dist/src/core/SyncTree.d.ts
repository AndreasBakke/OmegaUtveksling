...
import ***REMOVED*** SyncPoint } from './SyncPoint';
...
import ***REMOVED*** WriteTree } from './WriteTree';
 ...
 * @returns Events to raise.
 */
export declare function syncTreeApplyUserMerge(syncTree: SyncTree, path: Path, changedChildren: ***REMOVED***
    [k: string]: Node;
 ...
 * @returns Events to raise.
 */
export declare function syncTreeApplyServerMerge(syncTree: SyncTree, path: Path, changedChildren: ***REMOVED***
    [k: string]: Node;
}): Event[];
/**
 ...
 * @returns Events to raise.
 */
export declare function syncTreeApplyTaggedQueryMerge(syncTree: SyncTree, path: Path, changedChildren: ***REMOVED***
    [k: string]: Node;
}, tag: number): Event[];
/**
