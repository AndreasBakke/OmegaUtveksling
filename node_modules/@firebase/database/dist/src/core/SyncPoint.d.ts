...
import ***REMOVED*** View } from './view/View';
 ...
 */
export declare function syncPointRemoveEventRegistration(syncPoint: SyncPoint, query: QueryContext, eventRegistration: EventRegistration | null, cancelError?: Error): ***REMOVED***
