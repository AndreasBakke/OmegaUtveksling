...
var AnalyticsService = /** @class */ (function () ***REMOVED***
    function AnalyticsService(app, _delegate) ***REMOVED***
        this.app = app;
        this._delegate = _delegate;
  ***REMOVED***
    AnalyticsService.prototype.logEvent = function (eventName, eventParams, options) ***REMOVED***
  ...
  ***REMOVED***;
     ...
     */
    AnalyticsService.prototype.setCurrentScreen = function (screenName, options) ***REMOVED***
        analytics.setCurrentScreen(this._delegate, screenName, options);
  ***REMOVED***;
    AnalyticsService.prototype.setUserId = function (id, options) ***REMOVED***
        analytics.setUserId(this._delegate, id, options);
  ***REMOVED***;
    AnalyticsService.prototype.setUserProperties = function (properties, options) ***REMOVED***
        analytics.setUserProperties(this._delegate, properties, options);
  ***REMOVED***;
    AnalyticsService.prototype.setAnalyticsCollectionEnabled = function (enabled) ***REMOVED***
 ...
 * limitations under the License.
 */
var factory = function (container) ***REMOVED***
    // Dependencies
