...
import ***REMOVED*** logEvent, setCurrentScreen, setUserId, setUserProperties, setAnalyticsCollectionEnabled, settings, isSupported } from '@firebase/analytics';
...
class AnalyticsService ***REMOVED***
  ...
  ***REMOVED***
    logEvent(eventName, eventParams, options) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    setCurrentScreen(screenName, options) ***REMOVED***
        setCurrentScreen(this._delegate, screenName, options);
  ***REMOVED***
    setUserId(id, options) ***REMOVED***
        setUserId(this._delegate, id, options);
  ***REMOVED***
    setUserProperties(properties, options) ***REMOVED***
        setUserProperties(this._delegate, properties, options);
  ***REMOVED***
    setAnalyticsCollectionEnabled(enabled) ***REMOVED***
 ...
 * limitations under the License.
 */
const factory = (container) => ***REMOVED***
    // Dependencies
...
export ***REMOVED*** registerAnalytics };
