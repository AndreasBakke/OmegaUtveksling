declare class Pl ***REMOVED***
    convertValue(t: any, e?: string): any;
    convertObject(t: any, e: any): ***REMOVED***};
 ...
 */
declare class Sa ***REMOVED***
    /** A type string to uniquely identify instances of this class. */
    type: string;
}
/**
 * The results of executing an aggregation query.
 */ declare class Da ***REMOVED***
    /** @hideconstructor */
 ...
 */ declare class Ia extends pa ***REMOVED***
    _path: any;
 ...
 */ declare class Dl extends Yh ***REMOVED***
 ...
 */
declare class ih extends ma ***REMOVED***
    _queue: th;
    _persistenceKey: any;
    _terminate(): any;
}
/** An error returned by a Firestore operation. */ declare class L extends c ***REMOVED***
    /** @hideconstructor */
    constructor(t: any, e: any);
    code: any;
    message: any;
...
declare class nh ***REMOVED***
    _progressObserver: ***REMOVED***};
    _taskCompletionResolver: q;
    _lastProgress: ***REMOVED***
        taskState: string;
        totalBytes: number;
 ...
 */ declare class ol extends el ***REMOVED***
 ...
 */ declare class nl extends el ***REMOVED***
}
/**
 ...
 * 'undefined'.
 */ declare class Cl extends Dl ***REMOVED***
}
/**
 ...
 */ declare class gl extends nl ***REMOVED***
 ...
 */ declare class il extends nl ***REMOVED***
 ...
 */ declare class ll extends nl ***REMOVED***
 ...
 * the query result.
 */ declare class al extends nl ***REMOVED***
 ...
 */ declare class _l extends nl ***REMOVED***
...
declare const ef_base: ***REMOVED***
    new (t: any, e: any): ***REMOVED***
        _firestore: any;
        _transaction: any;
        _dataReader: Dh;
        /**
 ...
 * ***REMOVED***@link runTransaction}.
 */
declare class ef extends ef_base ***REMOVED***
}
/**
 * @license
 * Copyright 2020 Google LLC
 ...
 * @internal
 */ declare class ut extends it ***REMOVED***
    /**
 ...
 * Security Rules.
 */ declare function ga(t: any, e: any, n: any, s?: ***REMOVED***}): void;
/**
...
import ***REMOVED*** FirebaseError as c } from "@firebase/util/dist/src/errors";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 */ declare class el ***REMOVED***
}
declare class Re extends Ae ***REMOVED***
    /**
...
/** Filter that matches on key fields within an array. */ declare class Oe extends Re ***REMOVED***
    constructor(t: any, e: any);
    keys: any;
    matches(t: any): any;
}
/** A Filter that implements the array-contains-any operator. */ declare class qe extends Re ***REMOVED***
    constructor(t: any, e: any);
    matches(t: any): any;
}
/**
...
declare class Fh extends Ah ***REMOVED***
    constructor(t: any, e: any);
    _a: any;
    _toFieldTransform(t: any): Un;
    isEqual(t: any): boolean;
}
declare class Mh extends Ah ***REMOVED***
    constructor(t: any, e: any);
    _a: any;
    _toFieldTransform(t: any): Un;
    isEqual(t: any): boolean;
}
declare class Nh extends Ah ***REMOVED***
    _toFieldTransform(t: any): null;
    isEqual(t: any): boolean;
}
declare class $h extends Ah ***REMOVED***
    constructor(t: any, e: any);
    wa: any;
    _toFieldTransform(t: any): Un;
    isEqual(t: any): boolean;
}
declare class Oh extends Ah ***REMOVED***
    _toFieldTransform(t: any): Un;
    isEqual(t: any): boolean;
}
/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ declare class Ae ***REMOVED***
}
/** Filter that matches on key fields not present within an array. */ declare class Me extends Re ***REMOVED***
    constructor(t: any, e: any);
    keys: any;
    matches(t: any): boolean;
}
/** A "context" object passed around while parsing user data. */ declare class Sh ***REMOVED***
    /**
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ declare class Un ***REMOVED***
    constructor(t: any, e: any);
    field: any;
    transform: any;
}
