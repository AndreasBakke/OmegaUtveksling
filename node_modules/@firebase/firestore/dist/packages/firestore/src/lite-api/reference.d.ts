 ...
 */
import ***REMOVED*** Query as InternalQuery } from '../core/query';
import ***REMOVED*** DocumentKey } from '../model/document_key';
import ***REMOVED*** ResourcePath } from '../model/path';
import ***REMOVED*** Firestore } from './database';
import ***REMOVED*** FieldPath } from './field_path';
import ***REMOVED*** FieldValue } from './field_value';
import ***REMOVED*** FirestoreDataConverter } from './snapshot';
import ***REMOVED*** NestedUpdateFields, Primitive } from './types';
/**
 * Document data (for use with ***REMOVED***@link @firebase/firestore/lite#(setDoc:1)}) consists of fields mapped to
 * values.
 */
export interface DocumentData ***REMOVED***
