...
import ***REMOVED*** Document, MutableDocument } from './document';
import ***REMOVED*** DocumentKey } from './document_key';
import ***REMOVED*** FieldMask } from './field_mask';
import ***REMOVED*** ObjectValue } from './object_value';
import ***REMOVED*** FieldPath } from './path';
import ***REMOVED*** TransformOperation } from './transform_operation';
...
export declare const enum MutationType ***REMOVED***
    Set = 0,
    Patch = 1,
    Delete = 2,
    Verify = 3
 ...
 */
export declare class VerifyMutation extends Mutation ***REMOVED***
    readonly key: DocumentKey;
    readonly precondition: Precondition;
    constructor(key: DocumentKey, precondition: Precondition);
    readonly type: MutationType;
