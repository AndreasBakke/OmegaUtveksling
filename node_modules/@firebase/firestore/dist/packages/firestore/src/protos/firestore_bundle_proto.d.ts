 ...
 */
import ***REMOVED*** StructuredQuery, Timestamp, Document } from './firestore_proto_api';
/** Properties of a BundledQuery. */
export interface BundledQuery ***REMOVED***
    /** BundledQuery parent */
    parent?: string | null;
...
export interface NamedQuery ***REMOVED***
    /** NamedQuery name */
    name?: string | null;
...
export interface BundledDocumentMetadata ***REMOVED***
...
export interface BundleMetadata ***REMOVED***
    /** BundleMetadata id */
    id?: string | null;
...
export interface BundleElement ***REMOVED***
