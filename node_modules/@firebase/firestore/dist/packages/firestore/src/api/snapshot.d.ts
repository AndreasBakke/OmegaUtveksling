 ...
 */
import ***REMOVED*** ChangeType, ViewSnapshot } from '../core/view_snapshot';
import ***REMOVED*** FieldPath } from '../lite-api/field_path';
import ***REMOVED*** DocumentData, PartialWithFieldValue, Query, SetOptions, WithFieldValue } from '../lite-api/reference';
import ***REMOVED*** DocumentSnapshot as LiteDocumentSnapshot, FirestoreDataConverter as LiteFirestoreDataConverter } from '../lite-api/snapshot';
import ***REMOVED*** UntypedFirestoreDataConverter } from '../lite-api/user_data_reader';
import ***REMOVED*** AbstractUserDataWriter } from '../lite-api/user_data_writer';
...
import ***REMOVED*** SnapshotListenOptions } from './reference_impl';
/**
 ...
 * ```
 */
export interface FirestoreDataConverter<T> extends LiteFirestoreDataConverter<T> ***REMOVED***
    /**
 ...
 */
export declare class DocumentSnapshot<T = DocumentData> extends LiteDocumentSnapshot<T> ***REMOVED***
