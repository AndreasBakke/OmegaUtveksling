...
import ***REMOVED*** FieldPath } from '../model/path';
import ***REMOVED*** Value as ProtoValue } from '../protos/firestore_proto_api';
export declare const enum Operator ***REMOVED***
    LESS_THAN = "<",
    LESS_THAN_OR_EQUAL = "<=",
    EQUAL = "==",
    NOT_EQUAL = "!=",
...
export declare const enum CompositeOperator ***REMOVED***
    OR = "or",
    AND = "and"
}
export declare abstract class Filter ***REMOVED***
    abstract matches(doc: Document): boolean;
    abstract getFlattenedFilters(): readonly FieldFilter[];
    abstract getFilters(): Filter[];
    abstract getFirstInequalityField(): FieldPath | null;
}
export declare class FieldFilter extends Filter ***REMOVED***
...
export declare class CompositeFilter extends Filter ***REMOVED***
...
export declare class KeyFieldFilter extends FieldFilter ***REMOVED***
    private readonly key;
    constructor(field: FieldPath, op: Operator, value: ProtoValue);
    matches(doc: Document): boolean;
}
/** Filter that matches on key fields within an array. */
export declare class KeyFieldInFilter extends FieldFilter ***REMOVED***
    private readonly keys;
    constructor(field: FieldPath, value: ProtoValue);
    matches(doc: Document): boolean;
}
/** Filter that matches on key fields not present within an array. */
export declare class KeyFieldNotInFilter extends FieldFilter ***REMOVED***
    private readonly keys;
    constructor(field: FieldPath, value: ProtoValue);
    matches(doc: Document): boolean;
}
/** A Filter that implements the array-contains operator. */
export declare class ArrayContainsFilter extends FieldFilter ***REMOVED***
    constructor(field: FieldPath, value: ProtoValue);
    matches(doc: Document): boolean;
}
/** A Filter that implements the IN operator. */
export declare class InFilter extends FieldFilter ***REMOVED***
    constructor(field: FieldPath, value: ProtoValue);
    matches(doc: Document): boolean;
}
/** A Filter that implements the not-in operator. */
export declare class NotInFilter extends FieldFilter ***REMOVED***
    constructor(field: FieldPath, value: ProtoValue);
    matches(doc: Document): boolean;
}
/** A Filter that implements the array-contains-any operator. */
export declare class ArrayContainsAnyFilter extends FieldFilter ***REMOVED***
    constructor(field: FieldPath, value: ProtoValue);
    matches(doc: Document): boolean;
}
