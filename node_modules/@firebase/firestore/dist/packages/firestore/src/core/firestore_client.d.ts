 ...
 */
import ***REMOVED*** GetOptions } from '@firebase/firestore-types';
import ***REMOVED*** AbstractUserDataWriter, AggregateField, AggregateQuerySnapshot } from '../api';
import ***REMOVED*** LoadBundleTask } from '../api/bundle';
import ***REMOVED*** CredentialsProvider } from '../api/credentials';
import ***REMOVED*** User } from '../auth/user';
import ***REMOVED*** Query as LiteQuery } from '../lite-api/reference';
...
import ***REMOVED*** NamedQuery } from './bundle';
import ***REMOVED*** ComponentConfiguration, OfflineComponentProvider, OnlineComponentProvider } from './component_provider';
import ***REMOVED*** DatabaseId, DatabaseInfo } from './database_info';
import ***REMOVED*** EventManager, ListenOptions, Observer } from './event_manager';
import ***REMOVED*** Query } from './query';
import ***REMOVED*** SyncEngine } from './sync_engine';
import ***REMOVED*** Transaction } from './transaction';
import ***REMOVED*** TransactionOptions } from './transaction_options';
...
export declare function firestoreClientRunCountQuery(client: FirestoreClient, query: LiteQuery<unknown>, userDataWriter: AbstractUserDataWriter): Promise<AggregateQuerySnapshot<***REMOVED***
