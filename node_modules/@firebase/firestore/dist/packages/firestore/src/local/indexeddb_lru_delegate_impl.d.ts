...
import ***REMOVED*** ActiveTargets, LruGarbageCollector, LruParams } from './lru_garbage_collector';
...
export declare class IndexedDbLruDelegateImpl implements IndexedDbLruDelegate ***REMOVED***
    private readonly db;
