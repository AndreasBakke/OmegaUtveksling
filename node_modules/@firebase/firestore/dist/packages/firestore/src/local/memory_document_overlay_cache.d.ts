 ...
 */
import ***REMOVED*** DocumentKeySet, MutationMap, OverlayMap } from '../model/collections';
 ...
 */
export declare class MemoryDocumentOverlayCache implements DocumentOverlayCache ***REMOVED***
    private overlays;
