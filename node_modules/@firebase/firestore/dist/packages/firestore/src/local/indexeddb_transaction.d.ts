 ...
 */
import ***REMOVED*** ListenSequenceNumber } from '../core/types';
import ***REMOVED*** PersistenceTransaction } from './persistence_transaction';
import ***REMOVED*** SimpleDbStore, SimpleDbTransaction } from './simple_db';
export declare class IndexedDbTransaction extends PersistenceTransaction ***REMOVED***
