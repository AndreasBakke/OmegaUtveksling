...
import ***REMOVED*** BatchId, ListenSequenceNumber, MutationBatchState, OnlineState, TargetId } from '../core/types';
import ***REMOVED*** TargetIdSet } from '../model/collections';
import ***REMOVED*** AsyncQueue } from '../util/async_queue';
import ***REMOVED*** FirestoreError } from '../util/error';
import ***REMOVED*** SortedSet } from '../util/sorted_set';
import ***REMOVED*** WindowLike } from '../util/types';
import ***REMOVED*** QueryTargetState, SharedClientStateSyncer } from './shared_client_state_syncer';
/**
 ...
 */
export interface SharedClientState ***REMOVED***
 ...
 */
export declare class MutationMetadata ***REMOVED***
    readonly user: User;
 ...
 */
export declare class QueryTargetMetadata ***REMOVED***
 ...
 * listening to.
 */
export interface ClientState ***REMOVED***
 ...
 */
export declare class SharedOnlineState ***REMOVED***
 ...
 * `toWebStorageJSON()`.
 */
export declare class LocalClientState implements ClientState ***REMOVED***
 ...
 */
export declare class WebStorageSharedClientState implements SharedClientState ***REMOVED***
 ...
 */
export declare class MemorySharedClientState implements SharedClientState ***REMOVED***
    private localState;
    private queryState;
    onlineStateHandler: ((onlineState: OnlineState) => void) | null;
    sequenceNumberHandler: ((sequenceNumber: ListenSequenceNumber) => void) | null;
