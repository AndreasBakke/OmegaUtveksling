 ...
 */
import ***REMOVED*** BatchId, ListenSequenceNumber, TargetId } from '../core/types';
import ***REMOVED*** IndexKind } from '../model/field_index';
import ***REMOVED*** BundledQuery } from '../protos/firestore_bundle_proto';
import ***REMOVED*** Document as ProtoDocument, DocumentsTarget as ProtoDocumentsTarget, QueryTarget as ProtoQueryTarget, Write as ProtoWrite } from '../protos/firestore_proto_api';
import ***REMOVED*** EncodedResourcePath } from './encoded_resource_path';
import ***REMOVED*** DbTimestampKey } from './indexeddb_sentinels';
/**
 ...
 */
export interface DbTimestamp ***REMOVED***
    seconds: number;
    nanoseconds: number;
}
/**
 ...
 */
export interface DbPrimaryClient ***REMOVED***
    ownerId: string;
 ...
 */
export interface DbMutationQueue ***REMOVED***
    /**
 ...
 * with a new batchId.
 */
export interface DbMutationBatch ***REMOVED***
    /**
 ...
 */
export interface DbDocumentMutation ***REMOVED***
}
/**
 * Represents the known absence of a document at a particular version.
 * Stored in IndexedDb as part of a DbRemoteDocument object.
 */
export interface DbNoDocument ***REMOVED***
    path: string[];
 ...
 * Stored in IndexedDb as part of a DbRemoteDocument object.
 */
export interface DbUnknownDocument ***REMOVED***
    path: string[];
    version: DbTimestamp;
}
/**
 ...
 */
export interface DbRemoteDocument ***REMOVED***
 ...
 */
export interface DbRemoteDocumentGlobal ***REMOVED***
    /**
 ...
 */
export interface DbTarget ***REMOVED***
    /**
 ...
 * of this store.
 */
export interface DbTargetDocument ***REMOVED***
    /**
 ...
 */
export interface DbTargetGlobal ***REMOVED***
    /**
 ...
 */
export interface DbCollectionParent ***REMOVED***
    /**
 ...
 */
export interface DbClientMetadata ***REMOVED***
...
export interface DbBundle ***REMOVED***
...
export interface DbNamedQuery ***REMOVED***
...
export interface DbIndexConfiguration ***REMOVED***
    /**
 ...
 * index.
 */
export interface DbIndexState ***REMOVED***
     ...
     * index. Set to `***REMOVED***seconds: 0, nanos: 0}` if no documents have been indexed.
     */
    readTime: DbTimestamp;
    /**
...
export interface DbIndexEntry ***REMOVED***
    /** The index id for this entry. */
    indexId: number;
    /** The user id for this entry. */
    uid: string;
 ...
 */
export interface DbDocumentOverlay ***REMOVED***
