 ...
 */
import ***REMOVED*** CredentialsProvider, Token } from '../api/credentials';
import ***REMOVED*** User } from '../auth/user';
import ***REMOVED*** SnapshotVersion } from '../core/snapshot_version';
import ***REMOVED*** TargetId } from '../core/types';
import ***REMOVED*** TargetData } from '../local/target_data';
import ***REMOVED*** Mutation, MutationResult } from '../model/mutation';
import ***REMOVED*** ListenRequest as ProtoListenRequest, ListenResponse as ProtoListenResponse, WriteRequest as ProtoWriteRequest, WriteResponse as ProtoWriteResponse } from '../protos/firestore_proto_api';
import ***REMOVED*** AsyncQueue, TimerId } from '../util/async_queue';
import ***REMOVED*** FirestoreError } from '../util/error';
import ***REMOVED*** ExponentialBackoff } from './backoff';
import ***REMOVED*** Connection, Stream } from './connection';
import ***REMOVED*** JsonProtoSerializer } from './serializer';
import ***REMOVED*** WatchChange } from './watch_change';
export interface WriteRequest extends ProtoWriteRequest ***REMOVED***
    database?: string;
}
/**
 ...
 */
export declare class PersistentListenStream extends PersistentStream<ProtoListenRequest, ProtoListenResponse, WatchStreamListener> ***REMOVED***
    private serializer;
 ...
 */
export declare class PersistentWriteStream extends PersistentStream<ProtoWriteRequest, ProtoWriteResponse, WriteStreamListener> ***REMOVED***
    private serializer;
