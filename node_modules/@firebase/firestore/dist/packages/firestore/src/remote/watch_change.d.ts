...
import ***REMOVED*** ExistenceFilter } from './existence_filter';
import ***REMOVED*** RemoteEvent } from './remote_event';
/**
...
export declare const enum WatchTargetChangeState ***REMOVED***
    NoChange = 0,
    Added = 1,
    Removed = 2,
    Current = 3,
 ...
 */
export interface TargetMetadataProvider ***REMOVED***
    /**
