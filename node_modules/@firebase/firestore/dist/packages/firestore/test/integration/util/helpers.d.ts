 ...
 */
import ***REMOVED*** DocumentReference, Firestore, CollectionReference, DocumentData, QuerySnapshot, PrivateSettings, SnapshotListenOptions } from './firebase_export';
...
export declare function toDataMap(docSet: QuerySnapshot): ***REMOVED***
...
export declare function withTestCollection(persistence: boolean, docs: ***REMOVED***
...
export declare function withTestCollectionSettings(persistence: boolean, settings: PrivateSettings, docs: ***REMOVED***
    [key: string]: DocumentData;
}, fn: (collection: CollectionReference, db: Firestore) => Promise<void>): Promise<void>;
export ***REMOVED***};
