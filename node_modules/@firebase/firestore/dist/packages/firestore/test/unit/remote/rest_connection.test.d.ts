 ...
 */
import ***REMOVED*** Token } from '../../../src/api/credentials';
import ***REMOVED*** Stream } from '../../../src/remote/connection';
import ***REMOVED*** RestConnection } from '../../../src/remote/rest_connection';
import ***REMOVED*** StringMap } from '../../../src/util/types';
export declare class TestRestConnection extends RestConnection ***REMOVED***
    lastUrl: string;
