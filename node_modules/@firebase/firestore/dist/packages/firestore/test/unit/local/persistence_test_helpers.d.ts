 ...
 */
import ***REMOVED*** User } from '../../../src/auth/user';
import ***REMOVED*** DatabaseId } from '../../../src/core/database_info';
import ***REMOVED*** SequenceNumberSyncer } from '../../../src/core/listen_sequence';
import ***REMOVED*** BatchId, TargetId } from '../../../src/core/types';
import ***REMOVED*** IndexedDbPersistence } from '../../../src/local/indexeddb_persistence';
import ***REMOVED*** LocalSerializer } from '../../../src/local/local_serializer';
import ***REMOVED*** LruParams } from '../../../src/local/lru_garbage_collector';
import ***REMOVED*** MemoryPersistence } from '../../../src/local/memory_persistence';
import ***REMOVED*** ClientId } from '../../../src/local/shared_client_state';
import ***REMOVED*** JsonProtoSerializer } from '../../../src/remote/serializer';
import ***REMOVED*** AsyncQueue } from '../../../src/util/async_queue';
import ***REMOVED*** WindowLike } from '../../../src/util/types';
 ...
 */
export declare function testIndexedDbPersistence(options?: ***REMOVED***
