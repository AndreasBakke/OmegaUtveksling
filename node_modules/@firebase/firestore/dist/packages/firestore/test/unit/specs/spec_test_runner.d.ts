 ...
 */
import ***REMOVED*** IndexConfiguration } from '../../../src/api/index_configuration';
import ***REMOVED*** Query } from '../../../src/core/query';
import ***REMOVED*** TargetId } from '../../../src/core/types';
import ***REMOVED*** FieldIndex } from '../../../src/model/field_index';
import ***REMOVED*** JsonObject } from '../../../src/model/object_value';
import ***REMOVED*** TestSnapshotVersion } from '../../util/helpers';
import ***REMOVED*** ActiveTargetMap } from './spec_builder';
interface DocumentOptions ***REMOVED***
...
export interface SpecConfig ***REMOVED***
 ...
 */
export interface SpecStep ***REMOVED***
...
export interface SpecUserListen ***REMOVED***
    targetId: TargetId;
...
export interface SpecError ***REMOVED***
    code: number;
    message: string;
}
export interface SpecWatchRemove ***REMOVED***
    targetIds: TargetId[];
    cause?: SpecError;
}
export interface SpecWatchSnapshot ***REMOVED***
    version: TestSnapshotVersion;
    targetIds: TargetId[];
    resumeToken?: string;
}
export interface SpecWatchStreamClose ***REMOVED***
    error: SpecError;
    runBackoffTimer: boolean;
}
export interface SpecWriteAck ***REMOVED***
...
export interface SpecWriteFailure ***REMOVED***
...
export interface SpecWatchEntity ***REMOVED***
    key?: string;
    /** [<key>, <version>, <value>] */
    doc?: SpecDocument;
    /** [<key>, <version>, <value>][] */
...
export interface SpecClientState ***REMOVED***
 ...
 */
export interface SpecWatchFilter extends Array<TargetId[] | string | undefined> ***REMOVED***
    '0': TargetId[];
    '1': string | undefined;
}
 ...
 */
export interface SpecQuery ***REMOVED***
    path: string;
 ...
 */
export interface SpecDocument ***REMOVED***
    key: string;
    version: TestSnapshotVersion;
...
export interface SnapshotEvent ***REMOVED***
    query: SpecQuery;
    errorCode?: number;
    fromCache?: boolean;
...
export interface StateExpectation ***REMOVED***
