 ...
 */
import ***REMOVED*** DocumentReference, Firestore, Query, CollectionReference, QuerySnapshot, DocumentSnapshot } from '../../src';
 ...
 */
export declare function querySnapshot(path: string, oldDocs: ***REMOVED***
