 ...
 */
import ***REMOVED*** Firestore } from '../../src/lite-api/database';
import ***REMOVED*** DocumentData, CollectionReference, DocumentReference, SetOptions, PartialWithFieldValue } from '../../src/lite-api/reference';
import ***REMOVED*** FirestoreSettings } from '../../src/lite-api/settings';
import ***REMOVED*** QueryDocumentSnapshot } from '../../src/lite-api/snapshot';
...
export declare class Post ***REMOVED***
...
export declare const postConverter: ***REMOVED***
    toFirestore(post: Post): DocumentData;
    fromFirestore(snapshot: QueryDocumentSnapshot<DocumentData>): Post;
};
export declare const postConverterMerge: ***REMOVED***
