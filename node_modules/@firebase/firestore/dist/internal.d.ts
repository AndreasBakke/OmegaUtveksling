...
import ***REMOVED*** DocumentData as DocumentData_2 } from '@firebase/firestore-types';
import ***REMOVED*** EmulatorMockTokenOptions } from '@firebase/util';
import ***REMOVED*** FirebaseApp } from '@firebase/app';
import ***REMOVED*** FirebaseError } from '@firebase/util';
import ***REMOVED*** _FirebaseService } from '@firebase/app';
import ***REMOVED*** LogLevelString as LogLevel } from '@firebase/logger';
import ***REMOVED*** SetOptions as SetOptions_2 } from '@firebase/firestore-types';
 ...
 * @internal
 */
export declare abstract class AbstractUserDataWriter ***REMOVED***
 ...
 * to a dot.
 */
export declare type AddPrefixToKeys<Prefix extends string, T extends Record<string, unknown>> = ***REMOVED***
    [K in keyof T & string as `$***REMOVED***Prefix}.$***REMOVED***K}`]+?: T[K];
};

/**
 * Represents an aggregation that can be performed by Firestore.
 */
export declare class AggregateField<T> ***REMOVED***
 ...
 */
export declare class AggregateQuerySnapshot<T extends AggregateSpec> ***REMOVED***
 ...
 */
export declare interface AggregateSpec ***REMOVED***
 ...
 */
export declare type AggregateSpecData<T extends AggregateSpec> = ***REMOVED***
...
declare interface ApiClientObjectMap<T> ***REMOVED***
    [k: string]: T;
}
 ...
 */
declare abstract class AppliableConstraint ***REMOVED***
    /**
     * Takes the provided ***REMOVED***@link Query} and returns a copy of the ***REMOVED***@link Query} with this
     * ***REMOVED***@link AppliableConstraint} applied.
     */
...
declare interface AsyncQueue ***REMOVED***
 ...
 */
declare abstract class BasePath<B extends BasePath<B>> ***REMOVED***
    private segments;
    private offset;
    private len;
 ...
 */
declare interface BundleCache ***REMOVED***
    /**
...
declare interface BundledQuery ***REMOVED***
    /** BundledQuery parent */
    parent?: string | null;
 ...
 */
declare interface BundleMetadata ***REMOVED***
    /**
...
declare interface BundleMetadata_2 ***REMOVED***
    /** BundleMetadata id */
    id?: string | null;
 ...
 */
export declare class Bytes ***REMOVED***
 ...
 * @internal
 */
export declare class _ByteString ***REMOVED***
 ...
 * ***REMOVED***@link Firestore} instance.
 */
 ...
 * @internal
 */
export declare function _cast<T>(obj: object, constructor: ***REMOVED***
    new (...args: any[]): T;
}): T | never;

declare const enum ChangeType ***REMOVED***
    Added = 0,
    Removed = 1,
    Modified = 2,
    Metadata = 3
 ...
 * to distribute union types such as `undefined | ***REMOVED***...}` (happens for optional
 * props) or `***REMOVED***a: A} | ***REMOVED***b: B}`.
 *
 ...
 */
export declare class CollectionReference<T = DocumentData> extends Query<T> ***REMOVED***
     ...
     * to use your own custom model objects with Firestore. When you call ***REMOVED***@link
...
declare interface ComponentConfiguration ***REMOVED***
...
declare const enum CompositeOperator ***REMOVED***
    OR = "or",
    AND = "and"
}
 ...
 * Security Rules.
 */
export declare function connectFirestoreEmulator(firestore: Firestore_2, host: string, port: number, options?: ***REMOVED***
 ...
 */
declare interface CredentialsProvider<T> ***REMOVED***
    /**
 ...
 * limitations under the License.
 */
declare class DatabaseInfo ***REMOVED***
 ...
 */
declare abstract class Datastore ***REMOVED***
 ...
 * IE.
 */
declare class DelayedOperation<T extends unknown> implements PromiseLike<T> ***REMOVED***
 ...
 */
declare const enum Direction ***REMOVED***
    ASCENDING = "asc",
    DESCENDING = "desc"
}
 ...
 */
declare interface Document_2 ***REMOVED***
 ...
 */
export declare interface DocumentChange<T = DocumentData> ***REMOVED***
...
/**
 * Document data (for use with ***REMOVED***@link @firebase/firestore/lite#(setDoc:1)}) consists of fields mapped to
 * values.
 */
export declare interface DocumentData ***REMOVED***
 ...
 * @internal
 */
export declare class _DocumentKey ***REMOVED***
 ...
 * been acknowledged.
 */
declare interface DocumentOverlayCache ***REMOVED***
    /**
 ...
 */
export declare class DocumentReference<T = DocumentData> ***REMOVED***
    /**
    ...
    /**
     * The ***REMOVED***@link Firestore} instance the document is in.
     ...
     * to use your own custom model objects with Firestore. When you call ***REMOVED***@link
     * @firebase/firestore/lite#(setDoc:1)}, ***REMOVED***@link @firebase/firestore/lite#getDoc}, etc. with the returned `DocumentReference`
 ...
 * the key.
 */
declare class DocumentSet ***REMOVED***
    /**
 ...
 */
export declare class DocumentSnapshot<T = DocumentData> extends DocumentSnapshot_2<T> ***REMOVED***
 ...
 * explicitly verify a document's existence.
 */
declare class DocumentSnapshot_2<T = DocumentData> ***REMOVED***
...
declare interface DocumentViewChange ***REMOVED***
    type: ChangeType;
    doc: Document_2;
}
 ...
 * @internal
 */
export declare class _EmptyAppCheckTokenProvider implements CredentialsProvider<string> ***REMOVED***
    getToken(): Promise<Token | null>;
    invalidateToken(): void;
 ...
 * @internal
 */
export declare class _EmptyAuthCredentialsProvider implements CredentialsProvider<User> ***REMOVED***
    getToken(): Promise<Token | null>;
    invalidateToken(): void;
    start(asyncQueue: AsyncQueue, changeListener: CredentialChangeListener<User>): void;
    shutdown(): void;
}
export ***REMOVED*** EmulatorMockTokenOptions }
...
/**
 * Creates a ***REMOVED***@link QueryEndAtConstraint} that modifies the result set to end at
 * the provided document (inclusive). The end position is relative to the order
 * of the query. The document must contain all of the fields provided in the
 * orderBy of the query.
 *
 * @param snapshot - The snapshot of the document to end at.
 * @returns A ***REMOVED***@link QueryEndAtConstraint} to pass to `query()`
 */
...
/**
 * Creates a ***REMOVED***@link QueryEndAtConstraint} that modifies the result set to end
...
declare interface Entry<K, V> ***REMOVED***
    key: K;
    value: V;
}
...
declare class FieldFilter extends Filter ***REMOVED***
 ...
 */
declare class FieldIndex ***REMOVED***
    /**
 ...
 *             containing foo
 */
declare class FieldMask ***REMOVED***
 ...
 */
export declare class FieldPath ***REMOVED***
 ...
 * @internal
 */
export declare class _FieldPath extends BasePath<_FieldPath> ***REMOVED***
...
declare class FieldTransform ***REMOVED***
    readonly field: _FieldPath;
 ...
 * or `update()`.
 */
export declare abstract class FieldValue ***REMOVED***
    _methodName: string;
    /**
...
declare abstract class Filter ***REMOVED***
 ...
 */
export declare class Firestore extends Firestore_2 ***REMOVED***
    /**
 ...
 * Do not call this constructor directly. Instead, use ***REMOVED***@link (getFirestore:1)}.
 */
declare class Firestore_2 implements FirestoreService ***REMOVED***
 ...
 */
declare class FirestoreClient ***REMOVED***
 ...
 *   toFirestore(post: WithFieldValue<Post>): DocumentData ***REMOVED***
 ...
 * ```
 */
export declare interface FirestoreDataConverter<T> extends FirestoreDataConverter_2<T> ***REMOVED***
    /**
     ...
     * ***REMOVED***@link (deleteField:1)} to be used as property values.
     */
    toFirestore(modelObject: WithFieldValue<T>): DocumentData;
    /**
     * Called by the Firestore SDK to convert a custom model object of type `T`
     * into a plain JavaScript object (suitable for writing directly to the
     * Firestore database). Used with ***REMOVED***@link (setDoc:1)}, ***REMOVED***@link (WriteBatch.set:1)}
     * and ***REMOVED***@link (Transaction.set:1)} with `merge:true` or `mergeFields`.
     *
     * The `PartialWithFieldValue<T>` type extends `Partial<T>` to allow
     * FieldValues such as ***REMOVED***@link (arrayUnion:1)} to be used as property values.
 ...
 *     return ***REMOVED***title: post.title, author: post.author};
 * ***REMOVED***,
 *   fromFirestore(snapshot: QueryDocumentSnapshot): Post ***REMOVED***
 *     const data = snapshot.data(options)!;
 *     return new Post(data.title, data.author);
 * ***REMOVED***
 * };
 ...
 * ```
 */
declare interface FirestoreDataConverter_2<T> ***REMOVED***
    /**
     * Called by the Firestore SDK to convert a custom model object of type `T`
     * into a plain Javascript object (suitable for writing directly to the
     * Firestore database). Used with ***REMOVED***@link @firebase/firestore/lite#(setDoc:1)}, ***REMOVED***@link @firebase/firestore/lite#(WriteBatch.set:1)}
     * and ***REMOVED***@link @firebase/firestore/lite#(Transaction.set:1)}.
     *
     * The `WithFieldValue<T>` type extends `T` to also allow FieldValues such as
     * ***REMOVED***@link (deleteField:1)} to be used as property values.
     */
     ...
     * into a plain Javascript object (suitable for writing directly to the
     * Firestore database). Used with ***REMOVED***@link @firebase/firestore/lite#(setDoc:1)}, ***REMOVED***@link @firebase/firestore/lite#(WriteBatch.set:1)}
     * and ***REMOVED***@link @firebase/firestore/lite#(Transaction.set:1)} with `merge:true` or `mergeFields`.
     *
     * The `PartialWithFieldValue<T>` type extends `Partial<T>` to allow
     * FieldValues such as ***REMOVED***@link (arrayUnion:1)} to be used as property values.
     * It also supports nested `Partial` by allowing nested fields to be
...
export declare class FirestoreError extends FirebaseError ***REMOVED***
    /**
 ...
 */
declare interface FirestoreService extends _FirebaseService ***REMOVED***
    _authCredentials: CredentialsProvider<User>;
    _appCheckCredentials: CredentialsProvider<string>;
 ...
 */
export declare interface FirestoreSettings extends FirestoreSettings_2 ***REMOVED***
    /**
 ...
 * You must set these before invoking any other methods.
 */
declare interface FirestoreSettings_2 ***REMOVED***
 ...
 */
declare class FirestoreSettingsImpl ***REMOVED***
    /** The hostname to connect to. */
    readonly host: string;
    /** Whether to use SSL when connecting. */
    readonly ssl: boolean;
...
declare namespace firestoreV1ApiClientInterfaces ***REMOVED***
    interface ArrayValue ***REMOVED***
        values?: Value[];
  ***REMOVED***
    interface BatchGetDocumentsRequest ***REMOVED***
        database?: string;
        documents?: string[];
        mask?: DocumentMask;
        transaction?: string;
        ...
        readTime?: string;
  ***REMOVED***
    interface BatchGetDocumentsResponse ***REMOVED***
        found?: Document;
        missing?: string;
        transaction?: string;
        readTime?: string;
  ***REMOVED***
    interface BeginTransactionRequest ***REMOVED***
        options?: TransactionOptions;
  ***REMOVED***
    interface BeginTransactionResponse ***REMOVED***
        transaction?: string;
  ***REMOVED***
    interface CollectionSelector ***REMOVED***
        collectionId?: string;
        allDescendants?: boolean;
  ***REMOVED***
    interface CommitRequest ***REMOVED***
        database?: string;
        writes?: Write[];
        transaction?: string;
  ***REMOVED***
    interface CommitResponse ***REMOVED***
        writeResults?: WriteResult[];
        commitTime?: string;
  ***REMOVED***
    interface CompositeFilter ***REMOVED***
        op?: CompositeFilterOp;
        filters?: Filter[];
  ***REMOVED***
    interface Cursor ***REMOVED***
        values?: Value[];
        before?: boolean;
  ***REMOVED***
    interface Document ***REMOVED***
        name?: string;
        fields?: ApiClientObjectMap<Value>;
        createTime?: Timestamp_2;
        updateTime?: Timestamp_2;
  ***REMOVED***
    interface DocumentChange ***REMOVED***
        document?: Document;
        targetIds?: number[];
        removedTargetIds?: number[];
  ***REMOVED***
    interface DocumentDelete ***REMOVED***
        document?: string;
        removedTargetIds?: number[];
        readTime?: Timestamp_2;
  ***REMOVED***
    interface DocumentMask ***REMOVED***
        fieldPaths?: string[];
  ***REMOVED***
    interface DocumentRemove ***REMOVED***
        document?: string;
        removedTargetIds?: number[];
        readTime?: string;
  ***REMOVED***
    interface DocumentTransform ***REMOVED***
        document?: string;
        fieldTransforms?: FieldTransform[];
  ***REMOVED***
    interface DocumentsTarget ***REMOVED***
        documents?: string[];
  ***REMOVED***
    interface Empty ***REMOVED***
  ***REMOVED***
    interface ExistenceFilter ***REMOVED***
        targetId?: number;
        count?: number;
  ***REMOVED***
    interface FieldFilter ***REMOVED***
        field?: FieldReference;
        op?: FieldFilterOp;
        value?: Value;
  ***REMOVED***
    interface FieldReference ***REMOVED***
        fieldPath?: string;
  ***REMOVED***
    interface FieldTransform ***REMOVED***
        fieldPath?: string;
        ...
        increment?: Value;
  ***REMOVED***
    interface Filter ***REMOVED***
        compositeFilter?: CompositeFilter;
        fieldFilter?: FieldFilter;
        unaryFilter?: UnaryFilter;
  ***REMOVED***
    interface Index ***REMOVED***
        name?: string;
        collectionId?: string;
        fields?: IndexField[];
        state?: IndexState;
  ***REMOVED***
    interface IndexField ***REMOVED***
        fieldPath?: string;
        mode?: IndexFieldMode;
  ***REMOVED***
    interface LatLng ***REMOVED***
        latitude?: number;
        longitude?: number;
  ***REMOVED***
    interface ListCollectionIdsRequest ***REMOVED***
        pageSize?: number;
        pageToken?: string;
  ***REMOVED***
    interface ListCollectionIdsResponse ***REMOVED***
        collectionIds?: string[];
        nextPageToken?: string;
  ***REMOVED***
    interface ListDocumentsResponse ***REMOVED***
        documents?: Document[];
        nextPageToken?: string;
  ***REMOVED***
    interface ListIndexesResponse ***REMOVED***
        indexes?: Index[];
        nextPageToken?: string;
  ***REMOVED***
    interface ListenRequest ***REMOVED***
        addTarget?: Target;
        removeTarget?: number;
        labels?: ApiClientObjectMap<string>;
  ***REMOVED***
    interface ListenResponse ***REMOVED***
  ...
  ***REMOVED***
    interface MapValue ***REMOVED***
        fields?: ApiClientObjectMap<Value>;
  ***REMOVED***
    interface Operation ***REMOVED***
        name?: string;
  ...
  ***REMOVED***
    interface Precondition ***REMOVED***
        exists?: boolean;
        updateTime?: Timestamp_2;
  ***REMOVED***
    interface Projection ***REMOVED***
        fields?: FieldReference[];
  ***REMOVED***
    interface QueryTarget ***REMOVED***
        parent?: string;
        structuredQuery?: StructuredQuery;
  ***REMOVED***
    interface ReadOnly ***REMOVED***
        readTime?: string;
  ***REMOVED***
    interface ReadWrite ***REMOVED***
        retryTransaction?: string;
  ***REMOVED***
    interface RollbackRequest ***REMOVED***
        transaction?: string;
  ***REMOVED***
    interface RunQueryRequest ***REMOVED***
        parent?: string;
        structuredQuery?: StructuredQuery;
        transaction?: string;
        newTransaction?: TransactionOptions;
        readTime?: string;
  ***REMOVED***
    interface RunQueryResponse ***REMOVED***
        transaction?: string;
        document?: Document;
        readTime?: string;
        skippedResults?: number;
  ***REMOVED***
    interface RunAggregationQueryRequest ***REMOVED***
        parent?: string;
        ...
        readTime?: string;
  ***REMOVED***
    interface RunAggregationQueryResponse ***REMOVED***
        result?: AggregationResult;
        transaction?: string;
        readTime?: string;
  ***REMOVED***
    interface AggregationResult ***REMOVED***
        aggregateFields?: ApiClientObjectMap<Value>;
  ***REMOVED***
    interface StructuredAggregationQuery ***REMOVED***
        structuredQuery?: StructuredQuery;
        aggregations?: Aggregation[];
  ***REMOVED***
    interface Aggregation ***REMOVED***
        count?: Count;
        alias?: string;
  ***REMOVED***
    interface Count ***REMOVED***
        upTo?: number;
  ***REMOVED***
  ...
  ***REMOVED***
    interface StructuredQuery ***REMOVED***
        select?: Projection;
  ...
  ***REMOVED***
    interface Target ***REMOVED***
        ...
        once?: boolean;
  ***REMOVED***
    interface TargetChange ***REMOVED***
        ...
        readTime?: Timestamp_2;
  ***REMOVED***
    interface TransactionOptions ***REMOVED***
        readOnly?: ReadOnly;
        readWrite?: ReadWrite;
  ***REMOVED***
    interface UnaryFilter ***REMOVED***
        op?: UnaryFilterOp;
        field?: FieldReference;
  ***REMOVED***
  ...
  ***REMOVED***
    interface WriteRequest ***REMOVED***
        streamId?: string;
        writes?: Write[];
        streamToken?: string | Uint8Array;
        labels?: ApiClientObjectMap<string>;
  ***REMOVED***
    interface WriteResponse ***REMOVED***
        streamId?: string;
        streamToken?: string | Uint8Array;
        writeResults?: WriteResult[];
        commitTime?: Timestamp_2;
  ***REMOVED***
    interface WriteResult ***REMOVED***
        updateTime?: Timestamp_2;
        transformResults?: Value[];
  ***REMOVED***
}

declare interface FirstPartyCredentialsSettings ***REMOVED***
    ['type']: 'gapi';
    ['client']: unknown;
    ['sessionIndex']: string;
 ...
 */
export declare function getCountFromServer(query: Query<unknown>): Promise<AggregateQuerySnapshot<***REMOVED***
...
/**
 * Returns the existing default ***REMOVED***@link Firestore} instance that is associated with the
 * provided ***REMOVED***@link @firebase/app#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 * @param app - The ***REMOVED***@link @firebase/app#FirebaseApp} instance that the returned ***REMOVED***@link Firestore}
 * instance is associated with.
 * @returns The ***REMOVED***@link Firestore} instance of the provided app.
 */
export declare function getFirestore(app: FirebaseApp): Firestore;

/**
 * Returns the existing ***REMOVED***@link Firestore} instance that is associated with the
 * default ***REMOVED***@link @firebase/app#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 ...
 * @beta
 */
export declare interface Index ***REMOVED***
 ...
 *
 * See ***REMOVED***@link https://firebase.google.com/docs/reference/firestore/indexes/#json_format | JSON Format}
 * for a description of the format of the index definition.
 * @beta
 */
export declare interface IndexConfiguration ***REMOVED***
 ...
 * @beta
 */
export declare interface IndexField ***REMOVED***
...
declare const enum IndexKind ***REMOVED***
    /**
 ...
 */
declare interface IndexManager ***REMOVED***
    /**
 ...
 * index.
 */
declare class IndexOffset ***REMOVED***
    /**
...
declare class IndexSegment ***REMOVED***
 ...
 * current user.
 */
declare class IndexState_2 ***REMOVED***
    /**
...
declare const enum IndexType ***REMOVED***
...
declare const enum LimitType ***REMOVED***
    First = "F",
    Last = "L"
}
...
declare class LLRBEmptyNode<K, V> ***REMOVED***
    get key(): never;
    get value(): never;
    get color(): never;
    get left(): never;
...
declare class LLRBNode<K, V> ***REMOVED***
    key: K;
    value: V;
 ...
 */
export declare class LoadBundleTask implements PromiseLike<LoadBundleTaskProgress> ***REMOVED***
 ...
 */
export declare interface LoadBundleTaskProgress ***REMOVED***
 ...
 */
declare class LocalDocumentsView ***REMOVED***
...
declare interface LocalStore ***REMOVED***
...
declare interface LocalWriteResult ***REMOVED***
    batchId: BatchId;
    changes: DocumentMap;
}
export ***REMOVED*** LogLevel }
...
declare interface LruGarbageCollector ***REMOVED***
...
declare class LruParams ***REMOVED***
 ...
 */
declare interface LruResults ***REMOVED***
 ...
 * from all views.
 */
declare class MutableDocument implements Document_2 ***REMOVED***
    readonly key: _DocumentKey;
 ...
 * example).
 */
declare abstract class Mutation ***REMOVED***
 ...
 */
declare class MutationBatch ***REMOVED***
    batchId: BatchId;
...
declare class MutationBatchResult ***REMOVED***
...
declare interface MutationQueue ***REMOVED***
...
declare class MutationResult ***REMOVED***
    /**
...
declare const enum MutationType ***REMOVED***
    Set = 0,
    Patch = 1,
    Delete = 2,
    Verify = 3
 ...
 */
declare interface NamedQuery ***REMOVED***
...
declare interface NamedQuery_2 ***REMOVED***
    /** NamedQuery name */
    name?: string | null;
...
/**
 * For each field (e.g. 'bar'), find all nested keys (e.g. ***REMOVED***'bar.baz': T1,
 * 'bar.qux': T2}). Intersect them together to make a single map containing
 * all possible keys that are all marked as optional
 */
export declare type NestedUpdateFields<T extends Record<string, unknown>> = UnionToIntersection<***REMOVED***
 ...
 */
declare class ObjectMap<KeyType, ValueType> ***REMOVED***
    private mapKeyFn;
    private equalsFn;
    /**
 ...
 */
declare class ObjectValue ***REMOVED***
    readonly value: ***REMOVED***
        mapValue: MapValue;
  ***REMOVED***;
 ...
 */
declare interface OfflineComponentProvider ***REMOVED***
 ...
 * network.
 */
declare class OnlineComponentProvider ***REMOVED***
 ...
 * WebStorage.
 */
declare const enum OnlineState ***REMOVED***
    /**
 ...
 */
export declare function onSnapshot<T>(reference: DocumentReference<T>, observer: ***REMOVED***
 ...
 * the snapshot listener.
 */
export declare function onSnapshot<T>(reference: DocumentReference<T>, options: SnapshotListenOptions, observer: ***REMOVED***
    next?: (snapshot: DocumentSnapshot<T>) => void;
    error?: (error: FirestoreError) => void;
    complete?: () => void;
}): Unsubscribe;
 ...
 * the snapshot listener.
 */
export declare function onSnapshot<T>(query: Query<T>, observer: ***REMOVED***
 ...
 * the snapshot listener.
 */
export declare function onSnapshot<T>(query: Query<T>, options: SnapshotListenOptions, observer: ***REMOVED***
    next?: (snapshot: QuerySnapshot<T>) => void;
    error?: (error: FirestoreError) => void;
    complete?: () => void;
}): Unsubscribe;
 ...
 * listener.
 */
export declare function onSnapshotsInSync(firestore: Firestore, observer: ***REMOVED***
...
declare const enum Operator ***REMOVED***
    LESS_THAN = "<",
    LESS_THAN_OR_EQUAL = "<=",
    EQUAL = "==",
    NOT_EQUAL = "!=",
...
/**
 * The direction of a ***REMOVED***@link orderBy} clause is specified as 'desc' or 'asc'
 ...
 * locally mutated.
 */
declare class OverlayedDocument ***REMOVED***
...
declare interface ParseContext ***REMOVED***
    readonly databaseId: _DatabaseId;
    readonly ignoreUndefinedProperties: boolean;
}

/** The result of parsing document data (e.g. for a setData call). */
declare class ParsedSetData ***REMOVED***
    readonly data: ObjectValue;
...
declare class ParsedUpdateData ***REMOVED***
    readonly data: ObjectValue;
 ...
 */
export declare type PartialWithFieldValue<T> = Partial<T> | (T extends Primitive ? T : T extends ***REMOVED***} ? ***REMOVED***
 ...
 * writes.
 */
declare interface Persistence ***REMOVED***
    /**
 ...
 * Promises.
 */
declare class PersistencePromise<T> ***REMOVED***
    ...
    static waitFor(all: ***REMOVED***
        forEach: (cb: (el: PersistencePromise<any>) => void) => void;
  ***REMOVED***): PersistencePromise<void>;
    /**
     ...
     * to resolve.
     */
    static forEach<R, S>(collection: ***REMOVED***
        forEach: (cb: (r: R, s: S) => void) => void;
  ***REMOVED***, f: ((r: R, s: S) => PersistencePromise<void>) | ((r: R) => PersistencePromise<void>)): PersistencePromise<void>;
    static forEach<R>(collection: ***REMOVED***
        forEach: (cb: (r: R) => void) => void;
  ***REMOVED***, f: (r: R) => PersistencePromise<void>): PersistencePromise<void>;
    /**
 ...
 */
export declare interface PersistenceSettings ***REMOVED***
    /**
 ...
 * on persistence.
 */
declare abstract class PersistenceTransaction ***REMOVED***
 ...
 */
declare class Precondition ***REMOVED***
...
declare interface PrivateSettings extends FirestoreSettings_2 ***REMOVED***
...
declare interface ProviderCredentialsSettings ***REMOVED***
    ['type']: 'provider';
 ...
 */
export declare class Query<T = DocumentData> ***REMOVED***
    /**
     * If provided, the `FirestoreDataConverter` associated with this instance.
     */
    readonly converter: FirestoreDataConverter_2<T> | null;
     ...
     * custom model objects with Firestore. When you call ***REMOVED***@link getDocs} with
...
/**
 * Creates a new immutable instance of ***REMOVED***@link Query} that is extended to also
 * include additional query constraints.
 *
 * @param query - The ***REMOVED***@link Query} instance to use as a base for the new
 * constraints.
 * @param compositeFilter - The ***REMOVED***@link QueryCompositeFilterConstraint} to
 * apply. Create ***REMOVED***@link QueryCompositeFilterConstraint} using ***REMOVED***@link and} or
 * ***REMOVED***@link or}.
 * @param queryConstraints - Additional ***REMOVED***@link QueryNonFilterConstraint}s to
 * apply (e.g. ***REMOVED***@link orderBy}, ***REMOVED***@link limit}).
 ...
 * @param query - The ***REMOVED***@link Query} instance to use as a base for the new
 * constraints.
 * @param queryConstraints - The list of ***REMOVED***@link QueryConstraint}s to apply.
 * @throws if any of the provided query constraints cannot be combined with the
 * existing or new constraints.
 */
 ...
 * and `queryToTarget`.
 */
declare interface Query_2 ***REMOVED***
    readonly path: _ResourcePath;
 ...
 * @internal TODO remove this internal tag with OR Query support in the server
 */
export declare class QueryCompositeFilterConstraint extends AppliableConstraint ***REMOVED***
 ...
 */
export declare abstract class QueryConstraint extends AppliableConstraint ***REMOVED***
    /** The type of this query constraint */
 ...
 * 'undefined'.
 */
export declare class QueryDocumentSnapshot<T = DocumentData> extends DocumentSnapshot<T> ***REMOVED***
    /**
 ...
 * 'undefined'.
 */
declare class QueryDocumentSnapshot_2<T = DocumentData> extends DocumentSnapshot_2<T> ***REMOVED***
    /**
     * Retrieves all fields in the document as an `Object`.
     *
     * @override
 ...
 */
export declare class QueryEndAtConstraint extends QueryConstraint ***REMOVED***
    /** The type of this query constraint */
 ...
 */
export declare class QueryFieldFilterConstraint extends QueryConstraint ***REMOVED***
 ...
 * ***REMOVED***@link QueryFieldFilterConstraint} and ***REMOVED***@link QueryCompositeFilterConstraint}.
 * `QueryFilterConstraint`s are created by invoking ***REMOVED***@link or} or ***REMOVED***@link and}
 * and can then be passed to ***REMOVED***@link query} to create a new query instance that
 ...
 */
export declare class QueryLimitConstraint extends QueryConstraint ***REMOVED***
    /** The type of this query constraint */
 ...
 * `QueryNonFilterConstraint`s are created by invoking ***REMOVED***@link orderBy},
 * ***REMOVED***@link startAt}, ***REMOVED***@link startAfter}, ***REMOVED***@link endBefore}, ***REMOVED***@link endAt},
 * ***REMOVED***@link limit} or ***REMOVED***@link limitToLast} and can then be passed to ***REMOVED***@link query}
 ...
 * the query result.
 */
export declare class QueryOrderByConstraint extends QueryConstraint ***REMOVED***
    private readonly _field;
    private _direction;
    /** The type of this query constraint */
 ...
 * properties.
 */
export declare class QuerySnapshot<T = DocumentData> ***REMOVED***
    readonly _firestore: Firestore;
 ...
 */
export declare class QueryStartAtConstraint extends QueryConstraint ***REMOVED***
    /** The type of this query constraint */
 ...
 */
declare interface ReferenceDelegate ***REMOVED***
 ...
 */
declare interface RemoteDocumentCache ***REMOVED***
     ...
     */
    newChangeBuffer(options?: ***REMOVED***
        trackRemovals: boolean;
  ***REMOVED***): RemoteDocumentChangeBuffer;
    /**
 ...
 */
declare abstract class RemoteDocumentChangeBuffer ***REMOVED***
 ...
 */
declare class RemoteEvent ***REMOVED***
    /**
 ...
 */
declare interface RemoteStore ***REMOVED***
    /**
 ...
 */
declare interface RemoteSyncer ***REMOVED***
    /**
 ...
 * @internal
 */
export declare class _ResourcePath extends BasePath<_ResourcePath> ***REMOVED***
 ...
 */
declare interface Scheduler ***REMOVED***
    readonly started: boolean;
    start(): void;
    stop(): void;
}
 ...
 *
 * @param firestore - The ***REMOVED***@link Firestore} instance to configure indexes for.
...
/**
 * An options object that configures the behavior of ***REMOVED***@link @firebase/firestore/lite#(setDoc:1)}, ***REMOVED***@link
 * @firebase/firestore/lite#(WriteBatch.set:1)} and ***REMOVED***@link @firebase/firestore/lite#(Transaction.set:1)} calls. These calls can be
 ...
 * nested fields are overwritten.
 */
export declare type SetOptions = ***REMOVED***
 ...
 */
declare interface SharedClientState ***REMOVED***
...
/**
 * An options object that can be passed to ***REMOVED***@link (onSnapshot:1)} and ***REMOVED***@link
 * QuerySnapshot.docChanges} to control which types of changes to include in the
 * result set.
 */
export declare interface SnapshotListenOptions ***REMOVED***
    /**
 ...
 */
export declare class SnapshotMetadata ***REMOVED***
    /**
 ...
 */
export declare interface SnapshotOptions ***REMOVED***
    /**
 ...
 */
declare class SnapshotVersion ***REMOVED***
    private timestamp;
...
declare class SortedMap<K, V> ***REMOVED***
...
declare class SortedMapIterator<K, V> ***REMOVED***
    private isReverse;
    private nodeStack;
 ...
 * be equal!
 */
declare class SortedSet<T> ***REMOVED***
    private comparator;
    private data;
...
declare class SortedSetIterator<T> ***REMOVED***
    private iter;
...
/**
 * Creates a ***REMOVED***@link QueryStartAtConstraint} that modifies the result set to
 * start after the provided document (exclusive). The starting position is
 * relative to the order of the query. The document must contain all of the
 * fields provided in the orderBy of the query.
 *
 * @param snapshot - The snapshot of the document to start after.
 * @returns A ***REMOVED***@link QueryStartAtConstraint} to pass to `query()`
 */
 ...
 */
declare interface SyncEngine ***REMOVED***
 ...
 * in persistence.
 */
declare interface Target ***REMOVED***
    readonly path: _ResourcePath;
    readonly collectionGroup: string | null;
 ...
 * instances.
 */
declare interface TargetCache ***REMOVED***
    /**
 ...
 */
declare class TargetChange ***REMOVED***
    /**
 ...
 */
declare class TargetData ***REMOVED***
...
declare const enum TargetPurpose ***REMOVED***
 ...
 */
declare const enum TimerId ***REMOVED***
...
declare type Timestamp_2 = string | ***REMOVED***
    seconds?: string | number;
    nanos?: number;
};

declare interface Token ***REMOVED***
    /** Type of token. */
    type: TokenType;
    /**
 ...
 */
export declare class Transaction extends Transaction_2 ***REMOVED***
 ...
 * ***REMOVED***@link runTransaction}.
 */
declare class Transaction_2 ***REMOVED***
    ...
    /**
     * Writes to the document referred to by the provided ***REMOVED***@link
    ...
    /**
     * Updates fields in the document referred to by the provided ***REMOVED***@link
 ...
 */
declare class Transaction_3 ***REMOVED***
    private datastore;
 ...
 */
export declare interface TransactionOptions ***REMOVED***
    /** Maximum number of attempts to commit, after which transaction fails. Default is 5. */
    readonly maxAttempts?: number;
}

/** Used to represent a field transform on a mutation. */
declare class TransformOperation ***REMOVED***
    private _;
}
 ...
 */
export declare interface Unsubscribe ***REMOVED***
 ...
 */
declare interface UntypedFirestoreDataConverter<T> ***REMOVED***
...
/**
 * Update data (for use with ***REMOVED***@link (updateDoc:1)}) that consists of field paths
 ...
 * as property values.
 */
export declare type UpdateData<T> = T extends Primitive ? T : T extends ***REMOVED***} ? ***REMOVED***
...
declare class ViewSnapshot ***REMOVED***
    readonly query: Query_2;
...
/**
 * Filter conditions in a ***REMOVED***@link where} clause are specified using the
 ...
 * type safety.
 */
export declare type WithFieldValue<T> = T | (T extends Primitive ? T : T extends ***REMOVED***} ? ***REMOVED***
 ...
 * called.
 */
export declare class WriteBatch ***REMOVED***
    ...
    /**
     * Updates fields in the document referred to by this ***REMOVED***@link
     * DocumentReference}. The update will fail if applied to a document that does
     * not exist.
     *
