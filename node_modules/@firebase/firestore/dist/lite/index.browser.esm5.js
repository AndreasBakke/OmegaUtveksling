...
import ***REMOVED*** SDK_VERSION as i, _registerComponent as o, registerVersion as a, _getProvider, getApp as u, _removeServiceInstance as s } from "@firebase/app";

import ***REMOVED*** Component as c } from "@firebase/component";

import ***REMOVED*** Logger as l, LogLevel as f } from "@firebase/logger";

import ***REMOVED*** FirebaseError as h, getModularInstance as p, getDefaultEmulatorHostnameAndPort as d, createMockUserToken as y, deepEqual as m } from "@firebase/util";
 ...
 *   </ul>
 */
function _(t) ***REMOVED***
    w.setLogLevel(t);
}

function b(t) ***REMOVED***
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    if (w.logLevel <= f.DEBUG) ***REMOVED***
        var i = e.map(k);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var F = "cancelled", V = "unknown", P = "invalid-argument", D = "deadline-exceeded", O = "not-found", N = "permission-denied", q = "unauthenticated", R = "resource-exhausted", C = "failed-precondition", x = "aborted", L = "out-of-range", j = "unimplemented", M = "internal", U = "unavailable", B = /** @class */ function(e) ***REMOVED***
    /** @hideconstructor */
    function n(
    /**
  ...
  ***REMOVED***, t;
    ...
    function t(t) ***REMOVED***
        var e = this;
        this.auth = null, t.onInit((function(t) ***REMOVED***
            e.auth = t;
      ***REMOVED***));
  ***REMOVED***
    return t.prototype.getToken = function() ***REMOVED***
        var t = this;
        return this.auth ? this.auth.getToken().then((function(e) ***REMOVED***
  ...
  ***REMOVED***
    return t.prototype.l = function() ***REMOVED***
  ...
  ***REMOVED***, t.prototype.shutdown = function() ***REMOVED***}, t.prototype.invalidateToken = function() ***REMOVED***}, 
    t;
}(), X = function(t) ***REMOVED***
    this.value = t, this.type = "AppCheck", this.headers = new Map, t && t.length > 0 && this.headers.set("x-firebase-appcheck", this.value);
}, J = /** @class */ function() ***REMOVED***
    function t(t) ***REMOVED***
        var e = this;
        this.m = t, this.appCheck = null, t.onInit((function(t) ***REMOVED***
            e.appCheck = t;
      ***REMOVED***));
  ***REMOVED***
    return t.prototype.getToken = function() ***REMOVED***
        return this.appCheck ? this.appCheck.getToken().then((function(t) ***REMOVED***
...
/**
     ...
     * XMLHTTPRequest
     */
function(t, e, n, r, i, o, a, u) ***REMOVED***
    ...
    n.fromString = function() ***REMOVED***
        ...
        // for legacy reasons and should not be used frequently).
            ...
            // Strip leading and traling slashed.
                        r.push.apply(r, a.split("/").filter((function(t) ***REMOVED***
                return t.length > 0;
          ***REMOVED***)));
      ***REMOVED***
        return new n(r);
  ***REMOVED***, n.emptyPath = function() ***REMOVED***
        return new n([]);
  ***REMOVED***, n;
}(tt), nt = /^[_a-zA-Z][_a-zA-Z0-9]*$/, rt = /** @class */ function(e) ***REMOVED***
    function n() ***REMOVED***
        return null !== e && e.apply(this, arguments) || this;
  ***REMOVED***
    return t(n, e), n.prototype.construct = function(t, e, r) ***REMOVED***
  ...
  ***REMOVED***, 
    ...
    n.fromServerFormat = function(t) ***REMOVED***
        for (var e = [], r = "", i = 0, o = function() ***REMOVED***
            ...
            e.push(r), r = "";
      ***REMOVED***, a = !1; i < t.length; ) ***REMOVED***
            var u = t[i];
            if ("\\" === u) ***REMOVED***
                ...
                r += s, i += 2;
          ***REMOVED*** else "`" === u ? (a = !a, i++) : "." !== u || a ? (r += u, i++) : (o(), i++);
      ***REMOVED***
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function st(t) ***REMOVED***
 ...
 */ function ft(t) ***REMOVED***
    return null == t;
}

/** Returns whether the value represents -0. */ function ht(t) ***REMOVED***
 ...
 */ (dt = pt || (pt = ***REMOVED***}))[dt.OK = 0] = "OK", dt[dt.CANCELLED = 1] = "CANCELLED", 
...
var vt = /** @class */ function(r) ***REMOVED***
    /**
  ...
  ***REMOVED***
     ...
     * HTTP).
     */
    return t(i, r), i.prototype.$ = function(t, e) ***REMOVED***
        throw new Error("Not supported by FetchConnection");
  ***REMOVED***, i.prototype.R = function(t, r, i, o) ***REMOVED***
        return e(this, void 0, void 0, (function() ***REMOVED***
            ...
            return n(this, (function(n) ***REMOVED***
                switch (n.label) ***REMOVED***
                  ...
                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.V(r, ***REMOVED***
                        method: "POST",
                        headers: i,
                        body: e
                  ***REMOVED***) ];
  ...
  ***REMOVED***
    return Object.defineProperty(t.prototype, "v", ***REMOVED***
        get: function() ***REMOVED***
      ...
      ***REMOVED***,
        enumerable: !1,
        configurable: !0
  ***REMOVED***), t.prototype.I = function(t, e, n, r, i) ***REMOVED***
        var o = this.T(t, e);
        b("RestConnection", "Sending: ", o, n);
        var a = ***REMOVED***};
        return this.A(a, r, i), this.R(t, o, a, n).then((function(t) ***REMOVED***
      ...
      ***REMOVED***), (function(e) ***REMOVED***
            ...
            e;
      ***REMOVED***));
  ***REMOVED***, t.prototype.P = function(t, e, n, r, i, o) ***REMOVED***
  ...
  ***REMOVED***, 
     ...
     */
    t.prototype.A = function(t, e, n) ***REMOVED***
      ...
      ***REMOVED***)), n && n.headers.forEach((function(e, n) ***REMOVED***
            return t[n] = e;
      ***REMOVED***));
  ***REMOVED***, t.prototype.T = function(t, e) ***REMOVED***
        var n = yt[t];
...
/** Helper to compare arrays using isEqual(). */ function bt(t, e, n) ***REMOVED***
...
var St = new RegExp(/^\d***REMOVED***4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
 ...
 */ function It(t) ***REMOVED***
    ...
    if (I(!!t), "string" == typeof t) ***REMOVED***
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function Ft(t) ***REMOVED***
...
/** Extracts the backend's type order for the provided value. */ function qt(t) ***REMOVED***
  ...
  ***REMOVED***(t) ? 9007199254740991 /* TypeOrder.MaxValue */ : 10 /* TypeOrder.ObjectValue */ : S();
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function Rt(t, e) ***REMOVED***
    if (t === e) return !0;
    var n = qt(t);
    if (n !== qt(e)) return !1;
    switch (n) ***REMOVED***
      ...
      case 10 /* TypeOrder.ObjectValue */ :
        return function(t, e) ***REMOVED***
            ...
            // canonical IDs are independent of insertion order.
                        r.sort(), o.sort();
            for (var a = 0; a < r.length && a < o.length; ++a) ***REMOVED***
                var u = _t(r[a], o[a]);
                if (0 !== u) return u;
...
/** Returns true if `value` is an ArrayValue. */ function Mt(t) ***REMOVED***
    return !!t && "arrayValue" in t;
}

/** Returns true if `value` is a NullValue. */ function Ut(t) ***REMOVED***
    return !!t && "nullValue" in t;
}

/** Returns true if `value` is NaN. */ function Bt(t) ***REMOVED***
    return !!t && "doubleValue" in t && isNaN(Number(t.doubleValue));
}

/** Returns true if `value` is a MapValue. */ function Gt(t) ***REMOVED***
    return !!t && "mapValue" in t;
}

/** Creates a deep copy of `source`. */ function Qt(t) ***REMOVED***
  ...
  ***REMOVED***;
    if (t.mapValue) ***REMOVED***
        var e = ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***;
        return Et(t.mapValue.fields, (function(t, n) ***REMOVED***
    ...
    if (t.arrayValue) ***REMOVED***
        for (var n = ***REMOVED***
            arrayValue: ***REMOVED***
                values: []
          ***REMOVED***
      ***REMOVED***, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Qt(t.arrayValue.values[r]);
        return n;
  ***REMOVED***
    return Object.assign(***REMOVED***}, t);
}

var zt = function(t, e) ***REMOVED***
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Wt = function() ***REMOVED***}, Ht = /** @class */ function(e) ***REMOVED***
  ...
  ***REMOVED***, n;
}(Wt), Yt = /** @class */ function(e) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */    return t(n, e), n.create = function(t, e) ***REMOVED***
        return new n(t, e);
  ***REMOVED***, n.prototype.matches = function(t) ***REMOVED***
        return "and" /* CompositeOperator.AND */ === this.op ? void 0 === this.filters.find((function(e) ***REMOVED***
            return !e.matches(t);
      ***REMOVED***)) : void 0 !== this.filters.find((function(e) ***REMOVED***
            return e.matches(t);
      ***REMOVED***));
  ***REMOVED***, n.prototype.getFlattenedFilters = function() ***REMOVED***
        return null !== this.D || (this.D = this.filters.reduce((function(t, e) ***REMOVED***
  ...
  ***REMOVED***, n.prototype.getFirstInequalityField = function() ***REMOVED***
        var t = this.F((function(t) ***REMOVED***
  ...
  ***REMOVED***, 
    ...
    // predicate.
    n.prototype.F = function(t) ***REMOVED***
...
function Xt(t, e) ***REMOVED***
    return t instanceof Ht ? function(t, e) ***REMOVED***
        return e instanceof Ht && t.op === e.op && t.field.isEqual(e.field) && Rt(t.value, e.value);
  ***REMOVED***(t, e) : t instanceof Yt ? function(t, e) ***REMOVED***
        return e instanceof Yt && t.op === e.op && t.filters.length === e.filters.length && t.filters.reduce((function(t, n, r) ***REMOVED***
            return t && Xt(n, e.filters[r]);
      ***REMOVED***), !0);
  ***REMOVED***(t, e) : void S();
}

var Jt = /** @class */ function(e) ***REMOVED***
    function n(t, n, r) ***REMOVED***
        var i = this;
  ...
  ***REMOVED***, n;
}(Ht), Zt = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
...
/** Filter that matches on key fields within an array. */ function te(t, e) ***REMOVED***
    var n;
...
/** A Filter that implements the array-contains operator. */ var ee = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
  ...
  ***REMOVED***, n;
}(Ht), ne = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
  ...
  ***REMOVED***, n;
}(Ht), re = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
  ...
  ***REMOVED***
    return t(n, e), n.prototype.matches = function(t) ***REMOVED***
      ...
      ***REMOVED***)) return !1;
        ...
        return null !== e && !Ct(this.value.arrayValue, e);
  ***REMOVED***, n;
}(Ht), ie = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        return e.call(this, t, "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ , n) || this;
  ***REMOVED***
    return t(n, e), n.prototype.matches = function(t) ***REMOVED***
        var e = this, n = t.data.field(this.field);
        return !(!Mt(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) ***REMOVED***
            return Ct(e.value.arrayValue, t);
      ***REMOVED***));
  ***REMOVED***, n;
}(Ht), oe = function(t, e /* Direction.ASCENDING */) ***REMOVED***
    void 0 === e && (e = "asc"), this.field = t, this.dir = e;
};

/** A Filter that implements the IN operator. */ function ae(t, e) ***REMOVED***
...
// end LLRBEmptyNode
le.EMPTY = new (/** @class */ function() ***REMOVED***
    function t() ***REMOVED***
        this.size = 0;
  ***REMOVED***
...
var fe = /** @class */ function() ***REMOVED***
  ...
  ***REMOVED***, 
    ...
    t.prototype.unionWith = function(e) ***REMOVED***
        for (var n = new fe(rt.comparator), r = 0, i = this.fields; r < i.length; r++) ***REMOVED***
            var o = i[r];
            n = n.add(o);
      ***REMOVED***
        for (var a = 0, u = e; a < u.length; a++) ***REMOVED***
            var s = u[a];
            n = n.add(s);
      ***REMOVED***
  ...
  ***REMOVED***, 
    ...
    t.prototype.covers = function(t) ***REMOVED***
      ...
      ***REMOVED***
        return !1;
  ***REMOVED***, t.prototype.isEqual = function(t) ***REMOVED***
        return bt(this.fields, t.fields, (function(t, e) ***REMOVED***
            return t.isEqual(e);
      ***REMOVED***));
  ***REMOVED***, t;
}(), de = /** @class */ function() ***REMOVED***
    function t(t) ***REMOVED***
        this.value = t;
  ***REMOVED***
    return t.empty = function() ***REMOVED***
  ...
  ***REMOVED***, 
    ...
    t.prototype.field = function(t) ***REMOVED***
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Gt(e = (e.mapValue.fields || ***REMOVED***})[t.get(n)])) return null;
    ...
    t.prototype.getFieldsMap = function(t) ***REMOVED***
      ...
      ***REMOVED***);
        for (var n = 0; n < t.length; ++n) ***REMOVED***
            ...
            Gt(r) && r.mapValue.fields || (r = ***REMOVED***
                mapValue: ***REMOVED***
                    fields: ***REMOVED***}
              ***REMOVED***
  ...
  ***REMOVED***, t;
    ...
    function t(t, e, n, r, i, o, a) ***REMOVED***
  ...
  ***REMOVED***, t;
}(), me = function(t, e, n, r, i, o, a) ***REMOVED***
 ...
 * property.
 */
function ve(t, e, n, r, i, o, a) ***REMOVED***
...
/**
     ...
     * Path must currently be empty if this is a collection group query.
     */
function(t, e, n, r, i, o /* LimitType.First */ , a, u) ***REMOVED***
    void 0 === e && (e = null), void 0 === n && (n = []), void 0 === r && (r = []), 
...
/** Creates a new Query for a query that matches all documents at `path` */ function we(t) ***REMOVED***
    return t.explicitOrderBy.length > 0 ? t.explicitOrderBy[0].field : null;
}

function _e(t) ***REMOVED***
 ...
 */ function Te(t) ***REMOVED***
    ...
    if (null === e.q) ***REMOVED***
        ...
        n.isKeyField() || e.q.push(new oe(n)), e.q.push(new oe(rt.keyField(), "asc" /* Direction.ASCENDING */)); else ***REMOVED***
            for (var i = !1, o = 0, a = e.explicitOrderBy; o < a.length; o++) ***REMOVED***
                var u = a[o];
 ...
 */ function Ee(t) ***REMOVED***
    var e = A(t);
    if (!e.O) if ("F" /* LimitType.First */ === e.limitType) e.O = ve(e.path, e.collectionGroup, Te(e), e.filters, e.limit, e.startAt, e.endAt); else ***REMOVED***
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Te(e); r < i.length; r++) ***REMOVED***
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var Ie = function() ***REMOVED***
    // Make sure that the structural type of `TransformOperation` is unique.
    // See https://github.com/microsoft/TypeScript/issues/5451
    this._ = void 0;
}, Ae = /** @class */ function(e) ***REMOVED***
    function n() ***REMOVED***
        return null !== e && e.apply(this, arguments) || this;
  ***REMOVED***
    return t(n, e), n;
}(Ie), Fe = /** @class */ function(e) ***REMOVED***
    function n(t) ***REMOVED***
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
  ***REMOVED***
    return t(n, e), n;
}(Ie), Ve = /** @class */ function(e) ***REMOVED***
    function n(t) ***REMOVED***
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
  ***REMOVED***
    return t(n, e), n;
}(Ie), Pe = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
        return (r = e.call(this) || this).C = t, r.L = n, r;
  ***REMOVED***
    return t(n, e), n;
}(Ie), De = function(t, e) ***REMOVED***
    this.field = t, this.transform = e;
}, Oe = /** @class */ function() ***REMOVED***
    function t(t, e) ***REMOVED***
  ...
  ***REMOVED***, t;
}(), Ne = function() ***REMOVED***}, qe = /** @class */ function(e) ***REMOVED***
  ...
  ***REMOVED***
    return t(n, e), n.prototype.getFieldMask = function() ***REMOVED***
        return null;
  ***REMOVED***, n;
}(Ne), Re = /** @class */ function(e) ***REMOVED***
  ...
  ***REMOVED***, n;
}(Ne), Ce = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
  ...
  ***REMOVED***
    return t(n, e), n.prototype.getFieldMask = function() ***REMOVED***
        return null;
  ***REMOVED***, n;
}(Ne), xe = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
 ...
 */
function Be(t, e) ***REMOVED***
    return t.k ? "".concat(new Date(1e3 * e.seconds).toISOString().replace(/\.\d*/, "").replace("Z", ""), ".").concat(("000000000" + e.nanoseconds).slice(-9), "Z") : ***REMOVED***
        seconds: "" + e.seconds,
        nanos: e.nanoseconds
  ***REMOVED***;
}
 ...
 *
 * Visible for testing.
 */ function Ge(t, e) ***REMOVED***
    return t.k ? e.toBase64() : e.toUint8Array();
}

function Qe(t, e) ***REMOVED***
    return Be(t, e.toTimestamp());
}

function ze(t) ***REMOVED***
    return I(!!t), ue.fromTimestamp(function(t) ***REMOVED***
        var e = It(t);
        return new Vt(e.seconds, e.nanos);
  ***REMOVED***(t));
}
...
function We(t, e) ***REMOVED***
    return Ke(t.databaseId, e.path);
}

function He(t, e) ***REMOVED***
    var n, r = function(t) ***REMOVED***
...
function Ze(t, e) ***REMOVED***
    // Dissect the path into parent, collectionId, and optional key filter.
    var n = ***REMOVED***
        structuredQuery: ***REMOVED***}
  ***REMOVED***, r = e.path;
    null !== e.collectionGroup ? (n.parent = Ye(t, r), n.structuredQuery.from = [ ***REMOVED***
        collectionId: e.collectionGroup,
        allDescendants: !0
  ***REMOVED*** ]) : (n.parent = Ye(t, r.popLast()), n.structuredQuery.from = [ ***REMOVED***
  ...
  ***REMOVED***(e.orderBy);
    ...
    var a, u = function(t, e) ***REMOVED***
        return t.k || ft(e) ? e : ***REMOVED***
            value: e
      ***REMOVED***;
  ***REMOVED***(t, e.limit);
    return null !== u && (n.structuredQuery.limit = u), e.startAt && (n.structuredQuery.startAt = ***REMOVED***
...
function rn(t) ***REMOVED***
    return t instanceof Ht ? function(t) ***REMOVED***
        if ("==" /* Operator.EQUAL */ === t.op) ***REMOVED***
            if (Bt(t.value)) return ***REMOVED***
                unaryFilter: ***REMOVED***
                    field: nn(t.field),
                    op: "IS_NAN"
              ***REMOVED***
          ***REMOVED***;
            if (Ut(t.value)) return ***REMOVED***
                unaryFilter: ***REMOVED***
                    field: nn(t.field),
                    op: "IS_NULL"
              ***REMOVED***
      ...
      ***REMOVED***
        return ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***;
  ***REMOVED***(t) : t instanceof Yt ? function(t) ***REMOVED***
 ...
 */ var sn = /** @class */ function() ***REMOVED***
  ...
  ***REMOVED***, 
     ...
     */
    t.prototype.Y = function() ***REMOVED***
        this.W = this.B;
  ***REMOVED***, 
    /**
     ...
     */
    t.prototype.H = function(t) ***REMOVED***
        var e = this;
        ...
        this.G = this.M.enqueueAfterDelay(this.timerId, i, (function() ***REMOVED***
            return e.K = Date.now(), t();
      ***REMOVED***)), 
        // Apply backoff factor to determine next delay and ensure it is within
        // bounds.
        this.W *= this.j, this.W < this.U && (this.W = this.U), this.W > this.B && (this.W = this.B);
  ***REMOVED***, t.prototype.X = function() ***REMOVED***
        null !== this.G && (this.G.skipDelay(), this.G = null);
  ***REMOVED***, t.prototype.cancel = function() ***REMOVED***
        null !== this.G && (this.G.cancel(), this.G = null);
  ***REMOVED***, 
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.J = function() ***REMOVED***
        return (Math.random() - .5) * this.W;
  ***REMOVED***, t;
}(), cn = /** @class */ function(e) ***REMOVED***
    function n(t, n, r, i) ***REMOVED***
        var o = this;
        return (o = e.call(this) || this).authCredentials = t, o.appCheckCredentials = n, 
        o.connection = r, o.C = i, o.Z = !1, o;
  ***REMOVED***
    return t(n, e), n.prototype.tt = function() ***REMOVED***
        if (this.Z) throw new B(C, "The client has already been terminated.");
  ***REMOVED***, 
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.I = function(t, e, n) ***REMOVED***
        var r = this;
        return this.tt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) ***REMOVED***
            var o = i[0], a = i[1];
      ...
      ***REMOVED***));
  ***REMOVED***, 
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ n.prototype.P = function(t, e, n, r) ***REMOVED***
        var i = this;
        return this.tt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(o) ***REMOVED***
            var a = o[0], u = o[1];
...
function ln(t, r) ***REMOVED***
    return e(this, void 0, void 0, (function() ***REMOVED***
        var e, i, o;
        return n(this, (function(n) ***REMOVED***
            switch (n.label) ***REMOVED***
              case 0:
                return e = A(t), i = Xe(e.C) + "/documents", o = ***REMOVED***
                    writes: r.map((function(t) ***REMOVED***
                        return function(t, e) ***REMOVED***
                            var n;
                            if (e instanceof qe) n = ***REMOVED***
                                update: Je(t, e.key, e.value)
                          ***REMOVED***; else if (e instanceof Ce) n = ***REMOVED***
                                delete: We(t, e.key)
                          ...
                          ***REMOVED***
                            return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map((function(t) ***REMOVED***
                                return function(t, e) ***REMOVED***
                                    var n = e.transform;
                                    if (n instanceof Ae) return ***REMOVED***
                                        fieldPath: e.field.canonicalString(),
                                        setToServerValue: "REQUEST_TIME"
                                  ***REMOVED***;
                                    if (n instanceof Fe) return ***REMOVED***
                                        fieldPath: e.field.canonicalString(),
                      ...
                      ***REMOVED***(e.C, t);
                  ***REMOVED***))
              ***REMOVED***, [ 4 /*yield*/ , e.I("Commit", i, o) ];
              ...
              case 0:
                return e = A(t), i = Xe(e.C) + "/documents", o = ***REMOVED***
                    documents: r.map((function(t) ***REMOVED***
                        return We(e.C, t);
                  ***REMOVED***))
              ***REMOVED***, [ 4 /*yield*/ , e.P("BatchGetDocuments", i, o, r.length) ];

              case 1:
                return a = n.sent(), u = new Map, a.forEach((function(t) ***REMOVED***
                    var n = function(t, e) ***REMOVED***
                        return "found" in e ? function(t, e) ***REMOVED***
                            I(!!e.found), e.found.name, e.found.updateTime;
                            var n = He(t, e.found.name), r = ze(e.found.updateTime), i = e.found.createTime ? ze(e.found.createTime) : ue.min(), o = new de(***REMOVED***
                                mapValue: ***REMOVED***
 ...
 */ function pn(t) ***REMOVED***
    ...
    if (!hn.has(t)) ***REMOVED***
        ...
        var e = function(t) ***REMOVED***
            return new vt(t, fetch.bind(null));
      ***REMOVED***((i = t._databaseId, o = t.app.options.appId || "", a = t._persistenceKey, u = t._freezeSettings(), 
        new Z(i, o, a, u.host, u.ssl, u.experimentalForceLongPolling, u.experimentalAutoDetectLongPolling, u.useFetchStreams))), n = un(t._databaseId), r = function(t, e, n, r) ***REMOVED***
            return new cn(t, e, n, r);
      ***REMOVED***(t._authCredentials, t._appCheckCredentials, e, n);
        hn.set(t, r);
  ***REMOVED***
    var i, o, a, u;
    /**
 ...
 */ var dn = /** @class */ function() ***REMOVED***
    function t(t) ***REMOVED***
      ...
      ***REMOVED***
        ...
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) ***REMOVED***
  ...
  ***REMOVED***, t;
    ...
    function t(t, e, n, r) ***REMOVED***
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new dn(***REMOVED***}), 
  ...
  ***REMOVED***), t.prototype._setSettings = function(t) ***REMOVED***
        ...
        this._settings = new dn(t), void 0 !== t.credentials && (this._authCredentials = function(t) ***REMOVED***
            if (!t) return new z;
...
function vn(t, e) ***REMOVED***
    var n = "object" == typeof t ? t : u(), i = "string" == typeof t ? t : e || "(default)", o = _getProvider(n, "firestore/lite").getImmediate(***REMOVED***
        identifier: i
  ***REMOVED***);
 ...
 */ function gn(t, e, n, r) ***REMOVED***
  ...
  ***REMOVED***)), r.mockUserToken) ***REMOVED***
        var a, u;
        if ("string" == typeof r.mockUserToken) a = r.mockUserToken, u = v.MOCK_USER; else ***REMOVED***
...
var _n = function() ***REMOVED***
    /** A type string to uniquely identify instances of this class. */
    this.type = "AggregateField";
}, bn = /** @class */ function() ***REMOVED***
    /** @hideconstructor */
    function t(t, e) ***REMOVED***
        this._data = e, 
        /** A type string to uniquely identify instances of this class. */
  ...
  ***REMOVED***
    return t.prototype.run = function() ***REMOVED***
        ...
        return function(t, r) ***REMOVED***
            return e(this, void 0, void 0, (function() ***REMOVED***
                ...
                return n(this, (function(n) ***REMOVED***
                    switch (n.label) ***REMOVED***
                      case 0:
                        return e = A(t), i = function(t, e) ***REMOVED***
                            var n = Ze(t, e);
                            return ***REMOVED***
                              ...
                              ***REMOVED***,
                                parent: n.parent
                          ***REMOVED***;
                      ***REMOVED***(e.C, Ee(r)), o = i.parent, e.connection.v || delete i.parent, [ 4 /*yield*/ , e.P("RunAggregationQuery", o, i, /*expectedResponseCount=*/ 1) ];
      ...
      ***REMOVED***(this.datastore, this.query._query).then((function(e) ***REMOVED***
          ...
          ***REMOVED***))[0];
            return I("number" == typeof n), Promise.resolve(new bn(t.query, ***REMOVED***
                count: n
          ***REMOVED***));
      ***REMOVED***));
  ***REMOVED***, t;
 ...
 */ function In(t, e) ***REMOVED***
    ...
    if (t = p(t), ot("collection", "path", e), t instanceof yn) ***REMOVED***
...
function Fn(t, e) ***REMOVED***
    for (var n = [], i = 2; i < arguments.length; i++) n[i - 2] = arguments[i];
    if (t = p(t), 
    // We allow omission of 'pathString' but explicitly prohibit passing in both
    // 'undefined' and 'null'.
    1 === arguments.length && (e = wt.N()), ot("doc", "path", e), t instanceof yn) ***REMOVED***
        var o = et.fromString.apply(et, r([ e ], n, !1));
...
function Pn(t, e) ***REMOVED***
    return t = p(t), e = p(e), t instanceof kn && e instanceof kn && t.firestore === e.firestore && function(t, e) ***REMOVED***
        return function(t, e) ***REMOVED***
      ...
      ***REMOVED***(Ee(t), Ee(e)) && t.limitType === e.limitType;
  ***REMOVED***(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
function(t) ***REMOVED***
  ...
  ***REMOVED***, t;
}(), Cn = /^__.*__$/, xn = /** @class */ function() ***REMOVED***
    function t(t, e, n) ***REMOVED***
...
/** A "context" object passed around while parsing user data. */ var Mn = /** @class */ function() ***REMOVED***
    /**
  ...
  ***REMOVED***
    return Object.defineProperty(t.prototype, "path", ***REMOVED***
      ...
      ***REMOVED***,
        enumerable: !1,
        configurable: !0
  ***REMOVED***), Object.defineProperty(t.prototype, "nt", ***REMOVED***
        get: function() ***REMOVED***
      ...
      ***REMOVED***,
        ...
        configurable: !0
  ***REMOVED***), 
    /** Returns a new context with the specified settings overwritten. */ t.prototype.rt = function(e) ***REMOVED***
        return new t(Object.assign(Object.assign(***REMOVED***}, this.settings), e), this.databaseId, this.C, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  ***REMOVED***, t.prototype.st = function(t) ***REMOVED***
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.rt(***REMOVED***
            path: n,
            it: !1
      ***REMOVED***);
        return r.ot(t), r;
  ***REMOVED***, t.prototype.ut = function(t) ***REMOVED***
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.rt(***REMOVED***
            path: n,
            it: !1
      ***REMOVED***);
        return r.et(), r;
  ***REMOVED***, t.prototype.ct = function(t) ***REMOVED***
        // TODO(b/34871131): We don't support array paths right now; so make path
        // undefined.
        return this.rt(***REMOVED***
            path: void 0,
            it: !0
      ***REMOVED***);
  ***REMOVED***, t.prototype.at = function(t) ***REMOVED***
  ...
  ***REMOVED***, t;
}(), Un = /** @class */ function() ***REMOVED***
    function t(t, e, n) ***REMOVED***
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.C = n || un(t)
        /** Creates a new top-level parse context. */;
  ***REMOVED***
    return t.prototype.ft = function(t, e, n, r) ***REMOVED***
        return void 0 === r && (r = !1), new Mn(***REMOVED***
            nt: t,
            methodName: e,
            lt: n,
            path: rt.emptyPath(),
            it: !1,
            ht: r
      ***REMOVED***, this.databaseId, this.C, this.ignoreUndefinedProperties);
  ***REMOVED***, t;
}();
...
/** Parse document data from a set() call. */ function Gn(t, e, n, r, i, o) ***REMOVED***
    void 0 === o && (o = ***REMOVED***});
    ...
    var u, s, c = tr(r, a);
    if (o.merge) u = new pe(a.fieldMask), s = a.fieldTransforms; else if (o.mergeFields) ***REMOVED***
        for (var l = [], f = 0, h = o.mergeFields; f < h.length; f++) ***REMOVED***
            var p = rr(e, h[f], n);
            if (!a.contains(p)) throw new B(P, "Field '".concat(p, "' is specified in your field mask but missing from your input data."));
            ur(l, p) || l.push(p);
      ***REMOVED***
        u = new pe(l), s = a.fieldTransforms.filter((function(t) ***REMOVED***
            return u.covers(t.field);
      ***REMOVED***));
  ***REMOVED*** else u = null, s = a.fieldTransforms;
    return new xn(new de(c), u, s);
}

var Qn = /** @class */ function(e) ***REMOVED***
    function n() ***REMOVED***
        return null !== e && e.apply(this, arguments) || this;
  ***REMOVED***
    return t(n, e), n.prototype._toFieldTransform = function(t) ***REMOVED***
        if (2 /* UserDataSource.MergeSet */ !== t.nt) throw 1 /* UserDataSource.Update */ === t.nt ? t.at("".concat(this._methodName, "() can only appear at the top level of your update data")) : t.at("".concat(this._methodName, "() cannot be used with set() unless you pass ***REMOVED***merge:true}"));
 ...
 */ function zn(t, e, n) ***REMOVED***
    return new Mn(***REMOVED***
        nt: 3 /* UserDataSource.Argument */ ,
        lt: e.settings.lt,
        methodName: t._methodName,
        it: n
  ***REMOVED***, e.databaseId, e.C, e.ignoreUndefinedProperties);
}
...
var Kn = /** @class */ function(e) ***REMOVED***
  ...
  ***REMOVED***, n.prototype.isEqual = function(t) ***REMOVED***
        return t instanceof n;
  ***REMOVED***, n;
}(qn), Wn = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
  ...
  ***REMOVED***
    return t(n, e), n.prototype._toFieldTransform = function(t) ***REMOVED***
        var e = zn(this, t, 
        /*array=*/ !0), n = this.dt.map((function(t) ***REMOVED***
            return $n(t, e);
      ***REMOVED***)), r = new Fe(n);
  ...
  ***REMOVED***, n.prototype.isEqual = function(t) ***REMOVED***
        ...
        return this === t;
  ***REMOVED***, n;
}(qn), Hn = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
        return (r = e.call(this, t) || this).dt = n, r;
  ***REMOVED***
  ...
  ***REMOVED***, n.prototype.isEqual = function(t) ***REMOVED***
        ...
        return this === t;
  ***REMOVED***, n;
}(qn), Yn = /** @class */ function(e) ***REMOVED***
    function n(t, n) ***REMOVED***
        var r = this;
...
/** Parse update data from an update() call. */ function Xn(t, e, n, r) ***REMOVED***
    var i = t.ft(1 /* UserDataSource.Update */ , e, n);
    nr("Data must be an object, but it was:", i, r);
    var o = [], a = de.empty();
    Et(r, (function(t, r) ***REMOVED***
        var u = or(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function Jn(t, e, n, r, i, o) ***REMOVED***
    ...
    for (var l = [], f = de.empty(), h = u.length - 1; h >= 0; --h) if (!ur(l, u[h])) ***REMOVED***
        var d = u[h], y = s[h];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        y = p(y);
    ...
    return function(t, e) ***REMOVED***
      ...
      ***REMOVED***
        if (t instanceof Vt) ***REMOVED***
          ...
          ***REMOVED***;
      ***REMOVED***
        if (t instanceof Rn) return ***REMOVED***
            geoPointValue: ***REMOVED***
                latitude: t.latitude,
                longitude: t.longitude
          ***REMOVED***
      ***REMOVED***;
        if (t instanceof Dn) return ***REMOVED***
            bytesValue: Ge(e.C, t._byteString)
      ***REMOVED***;
        if (t instanceof En) ***REMOVED***
...
function tr(t, e) ***REMOVED***
  ...
  ***REMOVED***(t) ? 
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Et(t, (function(t, r) ***REMOVED***
        var i = $n(r, e.st(t));
        null != i && (n[t] = i);
  ***REMOVED***)), ***REMOVED***
        mapValue: ***REMOVED***
...
function nr(t, e, n) ***REMOVED***
    if (!er(n) || !function(t) ***REMOVED***
 ...
 */ var pr = function() ***REMOVED***}, dr = /** @class */ function(e) ***REMOVED***
    function n() ***REMOVED***
        return null !== e && e.apply(this, arguments) || this;
  ***REMOVED***
    return t(n, e), n;
 ...
 */ function yr(t, e) ***REMOVED***
    ...
    var i = [];
    e instanceof pr && i.push(e), function(t) ***REMOVED***
  ...
  ***REMOVED***(i = i.concat(n));
    for (var o = 0, a = i; o < a.length; o++) ***REMOVED***
        var u = a[o];
        t = u._apply(t);
  ***REMOVED***
    return t;
 ...
 */ var mr = /** @class */ function(e) ***REMOVED***
    /**
     * @internal
     */
    function n(t, n, r) ***REMOVED***
  ...
  ***REMOVED***, n.prototype._parse = function(t) ***REMOVED***
        var e = Bn(t.firestore), n = function(t, e, n, r, i, o, a) ***REMOVED***
            var u;
            if (i.isKeyField()) ***REMOVED***
                ...
                if ("in" /* Operator.IN */ === o || "not-in" /* Operator.NOT_IN */ === o) ***REMOVED***
                    qr(a, o);
                    for (var s = [], c = 0, l = a; c < l.length; c++) ***REMOVED***
                        var f = l[c];
                        s.push(Nr(r, t, f));
                  ***REMOVED***
                    u = ***REMOVED***
                      ...
                      ***REMOVED***
                  ***REMOVED***;
              ***REMOVED*** else u = Nr(r, t, a);
          ***REMOVED*** else "in" /* Operator.IN */ !== o && "not-in" /* Operator.NOT_IN */ !== o && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ !== o || qr(a, o), 
            u = Zn(n, "where", a, 
 ...
 */ var gr = /** @class */ function(e) ***REMOVED***
    /**
     * @internal
     */
    function n(
  ...
  ***REMOVED***, n.prototype._apply = function(t) ***REMOVED***
        ...
        return 0 === e.getFilters().length ? t : (function(t, e) ***REMOVED***
            for (var n = t, r = 0, i = e.getFlattenedFilters(); r < i.length; r++) ***REMOVED***
                ...
                Rr(n, o), n = ke(n, o);
          ***REMOVED***
      ***REMOVED***(t._query, e), new kn(t.firestore, t.converter, ke(t._query, e)));
 ...
 */ function wr() ***REMOVED***
    ...
    // Only support QueryFilterConstraints
        ...
        return xr("or", t);
  ***REMOVED***)), gr._create("or" /* CompositeOperator.OR */ , t)
    /**
...
function _r() ***REMOVED***
    ...
    // Only support QueryFilterConstraints
        return t.forEach((function(t) ***REMOVED***
        return xr("and", t);
  ***REMOVED***)), gr._create("and" /* CompositeOperator.AND */ , t)
    /**
...
var br = /** @class */ function(e) ***REMOVED***
    /**
     * @internal
     */
    function n(t, n) ***REMOVED***
  ...
  ***REMOVED***, n.prototype._apply = function(t) ***REMOVED***
      ...
      ***REMOVED***(t._query, this._field, this._direction);
        return new kn(t.firestore, t.converter, function(t, e) ***REMOVED***
 ...
 */ var Er = /** @class */ function(e) ***REMOVED***
    /**
     * @internal
     */
    function n(
  ...
  ***REMOVED***
    return t(n, e), n._create = function(t, e, r) ***REMOVED***
        return new n(t, e, r);
  ***REMOVED***, n.prototype._apply = function(t) ***REMOVED***
        return new kn(t.firestore, t.converter, function(t, e, n) ***REMOVED***
            return new ge(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
      ***REMOVED***(t._query, this._limit, this._limitType));
  ***REMOVED***, n;
}(dr);
...
var Ir = /** @class */ function(e) ***REMOVED***
    /**
     * @internal
     */
    function n(
 ...
 */ var Vr = /** @class */ function(e) ***REMOVED***
    /**
     * @internal
     */
    function n(
...
/** Helper function to create a bound from a document or fields */ function Or(t, e, n, r) ***REMOVED***
    if (n[0] = p(n[0]), n[0] instanceof sr) return function(t, e, n, r, i) ***REMOVED***
        ...
        // results.
        for (var o = [], a = 0, u = Te(t); a < u.length; a++) ***REMOVED***
            var s = u[a];
            if (s.field.isKeyField()) o.push(jt(e, r.key)); else ***REMOVED***
  ...
  ***REMOVED***(t._query, t.firestore._databaseId, e, n[0]._document, r);
    ...
    return function(t, e, n, r, i, o) ***REMOVED***
        ...
        for (var u = [], s = 0; s < i.length; s++) ***REMOVED***
            var c = i[s];
            if (a[s].field.isKeyField()) ***REMOVED***
...
function Nr(t, e, n) ***REMOVED***
    if ("string" == typeof (n = p(n))) ***REMOVED***
...
var jr = /** @class */ function(e) ***REMOVED***
    function n(t) ***REMOVED***
        var n = this;
  ...
  ***REMOVED***, n;
    ...
    return t.prototype.convertValue = function(t, e) ***REMOVED***
        switch (void 0 === e && (e = "none"), qt(t)) ***REMOVED***
          case 0 /* TypeOrder.NullValue */ :
            return null;
  ...
  ***REMOVED***, t.prototype.convertObject = function(t, e) ***REMOVED***
        ...
        return Et(t.fields, (function(t, i) ***REMOVED***
 ...
 */ function Mr(t) ***REMOVED***
    ...
    return fn(e, [ t._key ]).then((function(e) ***REMOVED***
        I(1 === e.length);
        var r = e[0];
    ...
    return function(t, r) ***REMOVED***
        return e(this, void 0, void 0, (function() ***REMOVED***
            ...
            return n(this, (function(n) ***REMOVED***
                switch (n.label) ***REMOVED***
                  case 0:
                    return e = A(t), i = Ze(e.C, Ee(r)), [ 4 /*yield*/ , e.P("RunQuery", i.parent, ***REMOVED***
                  ...
                  ***REMOVED***)).map((function(t) ***REMOVED***
                        return function(t, e, n) ***REMOVED***
                            var r = He(t, e.name), i = ze(e.updateTime), o = e.createTime ? ze(e.createTime) : ue.min(), a = new de(***REMOVED***
                                mapValue: ***REMOVED***
                                    fields: e.fields
                              ***REMOVED***
                          ***REMOVED***);
                            return ye.newFoundDocument(r, i, o, a);
                      ***REMOVED***(e.C, t.document);
                  ***REMOVED***)) ];
              ***REMOVED***
          ***REMOVED***));
      ***REMOVED***));
  ***REMOVED***(r, t._query).then((function(e) ***REMOVED***
        var n = e.map((function(e) ***REMOVED***
 ...
 */ function zr(t, e) ***REMOVED***
    var n = Fn(t = ct(t, Sn)), r = Lr(t.converter, e), i = Gn(Bn(t.firestore), "addDoc", n._key, r, null !== n.converter, ***REMOVED***});
    return ln(pn(t.firestore), [ i.toMutation(n._key, Oe.exists(!1)) ]).then((function() ***REMOVED***
        return n;
  ***REMOVED***));
}
 ...
 */ function ei(t) ***REMOVED***
    var e = pn(t = ct(t, yn));
    return new $r(t, (function(t) ***REMOVED***
        return ln(e, t);
  ***REMOVED***));
}
 ...
 */ var ni = /** @class */ function() ***REMOVED***
        ...
        return e(this, void 0, void 0, (function() ***REMOVED***
            ...
            return n(this, (function(n) ***REMOVED***
                switch (n.label) ***REMOVED***
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((e = n.sent()).forEach((function(t) ***REMOVED***
        ...
        return e(this, void 0, void 0, (function() ***REMOVED***
            ...
            return n(this, (function(n) ***REMOVED***
                switch (n.label) ***REMOVED***
                  ...
                  ***REMOVED***)), [ 4 /*yield*/ , ln(this.datastore, this.mutations) ];
  ...
  ***REMOVED***
    return t.prototype.run = function() ***REMOVED***
        this.yt -= 1, this._t();
  ***REMOVED***, t.prototype._t = function() ***REMOVED***
        var t = this;
        this.gt.H((function() ***REMOVED***
            return e(t, void 0, void 0, (function() ***REMOVED***
                var t, e, r = this;
                return n(this, (function(n) ***REMOVED***
                    return t = new ni(this.datastore), (e = this.vt(t)) && e.then((function(e) ***REMOVED***
          ...
          ***REMOVED***));
      ***REMOVED***));
  ***REMOVED***, t.prototype.vt = function(t) ***REMOVED***
        try ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***, t.prototype.bt = function(t) ***REMOVED***
        var e = this;
        this.yt > 0 && this.Et(t) ? (this.yt -= 1, this.asyncQueue.enqueueAndForget((function() ***REMOVED***
            return e._t(), Promise.resolve();
      ***REMOVED***))) : this.deferred.reject(t);
  ***REMOVED***, t.prototype.Et = function(t) ***REMOVED***
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function oi() ***REMOVED***
 ...
 * IE.
 */ var ai, ui = /** @class */ function() ***REMOVED***
    function t(t, e, n, r, i) ***REMOVED***
  ...
  ***REMOVED***, t.prototype.enqueue = function(t) ***REMOVED***
        ...
        // advance the queue even when the operation is not run.
                var n = new G;
        return this.xt((function() ***REMOVED***
  ...
  ***REMOVED***, 
     ...
     */
    t.prototype.St = function() ***REMOVED***
        return e(this, void 0, void 0, (function() ***REMOVED***
            var t, e = this;
            return n(this, (function(n) ***REMOVED***
                switch (n.label) ***REMOVED***
          ...
          ***REMOVED***));
      ***REMOVED***));
  ***REMOVED***, t.prototype.xt = function(t) ***REMOVED***
        var e = this, n = this.It.then((function() ***REMOVED***
            return e.Vt = !0, t().catch((function(t) ***REMOVED***
                e.Pt = t, e.Vt = !1;
                var n = 
                /**
 ...
 */
  ...
  ***REMOVED***, t.prototype.enqueueAfterDelay = function(t, e, n) ***REMOVED***
        ...
        var i = ui.createAndSchedule(this, t, e, n, (function(t) ***REMOVED***
            return r.qt(t);
      ***REMOVED***));
  ...
  ***REMOVED***, t.prototype.verifyOperationInProgress = function() ***REMOVED***}, 
     ...
     */
    t.prototype.Ot = function() ***REMOVED***
        return e(this, void 0, void 0, (function() ***REMOVED***
            var t;
  ...
  ***REMOVED***, 
     ...
     * exists.
     */
    t.prototype.kt = function(t) ***REMOVED***
        for (var e = 0, n = this.Rt; e < n.length; e++) ***REMOVED***
  ...
  ***REMOVED***, 
    ...
    t.prototype.Ct = function(t) ***REMOVED***
        ...
        // Note that draining may generate more delayed ops, so we do that first.
                return this.Ot().then((function() ***REMOVED***
            // Run ops in the same order they'd run if they ran naturally.
            e.Rt.sort((function(t, e) ***REMOVED***
                return t.targetTimeMs - e.targetTimeMs;
          ***REMOVED***));
            for (var n = 0, r = e.Rt; n < r.length; n++) ***REMOVED***
                var i = r[n];
  ...
  ***REMOVED***, 
     ...
     */
    t.prototype.Lt = function(t) ***REMOVED***
        this.Nt.push(t);
  ***REMOVED***, 
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.qt = function(t) ***REMOVED***
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        var e = this.Rt.indexOf(t);
        this.Rt.splice(e, 1);
  ***REMOVED***, t;
}(), ci = /** @class */ function() ***REMOVED***
    /** @hideconstructor */
    function t(t, e) ***REMOVED***
 ...
 */
function li(t, e, n) ***REMOVED***
    var r = pn(t = ct(t, yn)), i = Object.assign(Object.assign(***REMOVED***}, ri), n);
    !function(t) ***REMOVED***
        if (t.maxAttempts < 1) throw new B(P, "Max attempts must be at least 1");
  ***REMOVED***(i);
    var o = new G;
    return new ii(new si, r, i, (function(n) ***REMOVED***
        return e(new ci(t, n));
  ***REMOVED***), o).run(), o.promise
    /**
 * Firestore Lite
 *
...
ai = "".concat(i, "_lite"), g = ai, o(new c("firestore/lite", (function(t, e) ***REMOVED***
    var n = e.instanceIdentifier, r = e.options, i = t.getProvider("app").getImmediate(), o = new yn(new W(t.getProvider("auth-internal")), new J(t.getProvider("app-check-internal")), function(t, e) ***REMOVED***
