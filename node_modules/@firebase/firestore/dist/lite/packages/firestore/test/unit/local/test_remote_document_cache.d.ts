...
import ***REMOVED*** IndexManager } from '../../../src/local/index_manager';
import ***REMOVED*** Persistence } from '../../../src/local/persistence';
import ***REMOVED*** RemoteDocumentChangeBuffer } from '../../../src/local/remote_document_change_buffer';
import ***REMOVED*** DocumentKeySet, MutableDocumentMap } from '../../../src/model/collections';
import ***REMOVED*** MutableDocument } from '../../../src/model/document';
import ***REMOVED*** DocumentKey } from '../../../src/model/document_key';
import ***REMOVED*** IndexOffset } from '../../../src/model/field_index';
import ***REMOVED*** ResourcePath } from '../../../src/model/path';
/**
 * A wrapper around a RemoteDocumentCache that automatically creates a
 * transaction around every operation to reduce test boilerplate.
 */
export declare class TestRemoteDocumentCache ***REMOVED***
