 ...
 */
import ***REMOVED*** Bytes, DocumentReference } from '../../src';
import ***REMOVED*** Bound } from '../../src/core/bound';
import ***REMOVED*** BundledDocuments } from '../../src/core/bundle';
import ***REMOVED*** DatabaseId } from '../../src/core/database_info';
import ***REMOVED*** FieldFilter, CompositeFilter, Filter } from '../../src/core/filter';
import ***REMOVED*** OrderBy } from '../../src/core/order_by';
import ***REMOVED*** Query } from '../../src/core/query';
import ***REMOVED*** SnapshotVersion } from '../../src/core/snapshot_version';
import ***REMOVED*** TargetId } from '../../src/core/types';
import ***REMOVED*** LimboDocumentChange, View, ViewChange } from '../../src/core/view';
import ***REMOVED*** UserDataReader } from '../../src/lite-api/user_data_reader';
import ***REMOVED*** LocalViewChanges } from '../../src/local/local_view_changes';
import ***REMOVED*** TargetData, TargetPurpose } from '../../src/local/target_data';
import ***REMOVED*** DocumentKeySet, DocumentMap } from '../../src/model/collections';
import ***REMOVED*** Document, MutableDocument } from '../../src/model/document';
import ***REMOVED*** DocumentComparator } from '../../src/model/document_comparator';
import ***REMOVED*** DocumentKey } from '../../src/model/document_key';
import ***REMOVED*** DocumentSet } from '../../src/model/document_set';
import ***REMOVED*** FieldIndex, IndexKind, IndexOffset } from '../../src/model/field_index';
import ***REMOVED*** FieldMask } from '../../src/model/field_mask';
import ***REMOVED*** DeleteMutation, MutationResult, PatchMutation, Precondition, SetMutation } from '../../src/model/mutation';
import ***REMOVED*** JsonObject, ObjectValue } from '../../src/model/object_value';
import ***REMOVED*** FieldPath, ResourcePath } from '../../src/model/path';
import ***REMOVED*** NamedQuery as ProtoNamedQuery, BundleMetadata as ProtoBundleMetadata, LimitType as ProtoLimitType } from '../../src/protos/firestore_bundle_proto';
import * as api from '../../src/protos/firestore_proto_api';
import ***REMOVED*** RemoteEvent, TargetChange } from '../../src/remote/remote_event';
import ***REMOVED*** ByteString } from '../../src/util/byte_string';
import ***REMOVED*** Code } from '../../src/util/error';
import ***REMOVED*** Dict } from '../../src/util/obj';
import ***REMOVED*** SortedMap } from '../../src/util/sorted_map';
import ***REMOVED*** SortedSet } from '../../src/util/sorted_set';
...
export declare function fieldIndex(collectionGroup: string, options?: ***REMOVED***
    id?: number;
...
export declare class TestBundledDocuments ***REMOVED***
...
export declare class TestNamedQuery ***REMOVED***
...
export declare function limboChanges(changes: ***REMOVED***
    added?: Document[];
    removed?: Document[];
}): LimboDocumentChange[];
export declare function localViewChanges(targetId: TargetId, fromCache: boolean, changes: ***REMOVED***
    added?: string[];
    removed?: string[];
}): LocalViewChanges;
/**
 ...
 */
export declare function mapAsArray<K, V>(sortedMap: SortedMap<K, V>): Array<***REMOVED***
    key: K;
    value: V;
}>;
/**
...
export declare class DocComparator ***REMOVED***
