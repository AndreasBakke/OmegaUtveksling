...
import ***REMOVED*** ListenSequenceNumber, TargetId } from '../core/types';
...
import ***REMOVED*** DocumentOverlayCache } from './document_overlay_cache';
import ***REMOVED*** IndexManager } from './index_manager';
import ***REMOVED*** ActiveTargets, LruDelegate, LruGarbageCollector, LruParams } from './lru_garbage_collector';
import ***REMOVED*** MemoryBundleCache } from './memory_bundle_cache';
import ***REMOVED*** MemoryIndexManager } from './memory_index_manager';
import ***REMOVED*** MemoryRemoteDocumentCache } from './memory_remote_document_cache';
import ***REMOVED*** MemoryTargetCache } from './memory_target_cache';
import ***REMOVED*** MutationQueue } from './mutation_queue';
import ***REMOVED*** Persistence, ReferenceDelegate } from './persistence';
import ***REMOVED*** PersistencePromise } from './persistence_promise';
import ***REMOVED*** PersistenceTransaction, PersistenceTransactionMode } from './persistence_transaction';
import ***REMOVED*** TargetData } from './target_data';
/**
 * A memory-backed instance of Persistence. Data is stored only in RAM and
 * not persisted across sessions.
 */
export declare class MemoryPersistence implements Persistence ***REMOVED***
    /**
 ...
 */
export declare class MemoryTransaction extends PersistenceTransaction ***REMOVED***
    readonly currentSequenceNumber: ListenSequenceNumber;
    constructor(currentSequenceNumber: ListenSequenceNumber);
}
export interface MemoryReferenceDelegate extends ReferenceDelegate ***REMOVED***
    documentSize(doc: Document): number;
    onTransactionStarted(): void;
    onTransactionCommitted(txn: PersistenceTransaction): PersistencePromise<void>;
}
export declare class MemoryEagerDelegate implements MemoryReferenceDelegate ***REMOVED***
...
export declare class MemoryLruDelegate implements ReferenceDelegate, LruDelegate ***REMOVED***
    private readonly persistence;
