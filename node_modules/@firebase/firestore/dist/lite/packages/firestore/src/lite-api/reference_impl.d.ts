 ...
 */
import ***REMOVED*** DocumentData as PublicDocumentData, SetOptions as PublicSetOptions } from '@firebase/firestore-types';
import ***REMOVED*** ByteString } from '../util/byte_string';
import ***REMOVED*** Bytes } from './bytes';
import ***REMOVED*** Firestore } from './database';
import ***REMOVED*** FieldPath } from './field_path';
import ***REMOVED*** CollectionReference, DocumentReference, PartialWithFieldValue, Query, SetOptions, UpdateData, WithFieldValue } from './reference';
...
export declare class LiteUserDataWriter extends AbstractUserDataWriter ***REMOVED***
