...
import ***REMOVED*** Serializer } from '../remote/number_serializer';
/** Used to represent a field transform on a mutation. */
export declare class TransformOperation ***REMOVED***
    private _;
}
/**
...
export declare class ServerTimestampTransform extends TransformOperation ***REMOVED***
}
/** Transforms an array value via a union operation. */
export declare class ArrayUnionTransformOperation extends TransformOperation ***REMOVED***
    readonly elements: ProtoValue[];
    constructor(elements: ProtoValue[]);
}
/** Transforms an array value via a remove operation. */
export declare class ArrayRemoveTransformOperation extends TransformOperation ***REMOVED***
    readonly elements: ProtoValue[];
    constructor(elements: ProtoValue[]);
}
/**
 ...
 */
export declare class NumericIncrementTransformOperation extends TransformOperation ***REMOVED***
