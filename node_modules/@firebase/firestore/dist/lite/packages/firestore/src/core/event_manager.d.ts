...
import ***REMOVED*** EventHandler } from '../util/misc';
 ...
 */
declare class QueryListenersInfo ***REMOVED***
...
export declare class EventManagerImpl implements EventManager ***REMOVED***
