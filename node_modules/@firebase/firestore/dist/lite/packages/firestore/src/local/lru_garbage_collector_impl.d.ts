...
import ***REMOVED*** LruDelegate, LruGarbageCollector, LruParams } from './lru_garbage_collector';
import ***REMOVED*** Scheduler } from './persistence';
export declare const LRU_MINIMUM_CACHE_SIZE_BYTES: number;
/**
 * This class is responsible for the scheduling of LRU garbage collection. It handles checking
 * whether or not GC is enabled, as well as which delay to use before the next run.
 */
export declare class LruScheduler implements Scheduler ***REMOVED***
