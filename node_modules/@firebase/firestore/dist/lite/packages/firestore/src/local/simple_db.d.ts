...
export interface SimpleDbSchemaConverter ***REMOVED***
...
export declare class IndexedDbTransactionError extends FirestoreError ***REMOVED***
    name: string;
 ...
 */
export declare class SimpleDbStore<KeyType extends IDBValidKey, ValueType extends unknown> ***REMOVED***
    private store;
