...
import ***REMOVED*** BatchId } from '../../../src/core/types';
import ***REMOVED*** MutationQueue } from '../../../src/local/mutation_queue';
import ***REMOVED*** Persistence } from '../../../src/local/persistence';
import ***REMOVED*** DocumentKeySet } from '../../../src/model/collections';
import ***REMOVED*** DocumentKey } from '../../../src/model/document_key';
import ***REMOVED*** Mutation } from '../../../src/model/mutation';
import ***REMOVED*** MutationBatch } from '../../../src/model/mutation_batch';
/**
 * A wrapper around a MutationQueue that automatically creates a
 * transaction around every operation to reduce test boilerplate.
 */
export declare class TestMutationQueue ***REMOVED***
