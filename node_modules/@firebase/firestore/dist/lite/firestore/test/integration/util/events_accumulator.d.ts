 ...
 */
import ***REMOVED*** DocumentSnapshot, QuerySnapshot } from './firebase_export';
/**
 ...
 */
export declare class EventsAccumulator<T extends DocumentSnapshot | QuerySnapshot> ***REMOVED***
    private events;
    private waitingFor;
    private deferred;
