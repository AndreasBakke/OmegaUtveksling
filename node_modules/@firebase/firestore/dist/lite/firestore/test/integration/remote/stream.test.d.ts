 ...
 */
import ***REMOVED*** EmptyAuthCredentialsProvider } from '../../../src/api/credentials';
import ***REMOVED*** SnapshotVersion } from '../../../src/core/snapshot_version';
import ***REMOVED*** MutationResult } from '../../../src/model/mutation';
import ***REMOVED*** PersistentListenStream, PersistentWriteStream, WatchStreamListener, WriteStreamListener } from '../../../src/remote/persistent_stream';
import ***REMOVED*** DocumentWatchChange, ExistenceFilterChange, WatchTargetChange } from '../../../src/remote/watch_change';
import ***REMOVED*** AsyncQueueImpl } from '../../../src/util/async_queue_impl';
import ***REMOVED*** FirestoreError } from '../../../src/util/error';
/**
...
declare class StreamStatusListener implements WatchStreamListener, WriteStreamListener ***REMOVED***
