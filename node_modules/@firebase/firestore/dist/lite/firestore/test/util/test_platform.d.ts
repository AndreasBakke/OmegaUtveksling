 ...
 */
import ***REMOVED*** DocumentLike, WindowLike } from '../../src/util/types';
/**
 * `Window` fake that implements the event and storage API that is used by
 * Firestore.
 */
export declare class FakeWindow implements WindowLike ***REMOVED***
 ...
 */
export declare class FakeDocument implements DocumentLike ***REMOVED***
 ...
 */
export declare class SharedFakeWebStorage ***REMOVED***
