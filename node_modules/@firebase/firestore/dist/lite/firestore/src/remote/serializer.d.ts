...
import ***REMOVED*** CompositeFilter, CompositeOperator, FieldFilter, Filter, Operator } from '../core/filter';
import ***REMOVED*** Direction, OrderBy } from '../core/order_by';
import ***REMOVED*** Query } from '../core/query';
import ***REMOVED*** SnapshotVersion } from '../core/snapshot_version';
import ***REMOVED*** Target } from '../core/target';
import ***REMOVED*** Timestamp } from '../lite-api/timestamp';
import ***REMOVED*** TargetData } from '../local/target_data';
import ***REMOVED*** MutableDocument } from '../model/document';
import ***REMOVED*** DocumentKey } from '../model/document_key';
import ***REMOVED*** FieldMask } from '../model/field_mask';
import ***REMOVED*** Mutation, MutationResult } from '../model/mutation';
import ***REMOVED*** ObjectValue } from '../model/object_value';
import ***REMOVED*** FieldPath, ResourcePath } from '../model/path';
import ***REMOVED*** ApiClientObjectMap as ProtoApiClientObjectMap, BatchGetDocumentsResponse as ProtoBatchGetDocumentsResponse, CompositeFilterOp as ProtoCompositeFilterOp, Document as ProtoDocument, DocumentMask as ProtoDocumentMask, DocumentsTarget as ProtoDocumentsTarget, FieldFilterOp as ProtoFieldFilterOp, FieldReference as ProtoFieldReference, Filter as ProtoFilter, ListenResponse as ProtoListenResponse, Order as ProtoOrder, OrderDirection as ProtoOrderDirection, QueryTarget as ProtoQueryTarget, RunAggregationQueryRequest as ProtoRunAggregationQueryRequest, Target as ProtoTarget, Timestamp as ProtoTimestamp, Write as ProtoWrite, WriteResult as ProtoWriteResult } from '../protos/firestore_proto_api';
import ***REMOVED*** ByteString } from '../util/byte_string';
import ***REMOVED*** Serializer } from './number_serializer';
import ***REMOVED*** WatchChange } from './watch_change';
/**
 ...
 */
export declare class JsonProtoSerializer implements Serializer ***REMOVED***
