 ...
 */
import ***REMOVED*** FirestoreError } from './error';
/**
 ...
 */
export declare const enum TimerId ***REMOVED***
 ...
 * IE.
 */
export declare class DelayedOperation<T extends unknown> implements PromiseLike<T> ***REMOVED***
...
export interface AsyncQueue ***REMOVED***
