 ...
 */
import ***REMOVED*** DocumentData, FieldPath as PublicFieldPath, SetOptions } from '@firebase/firestore-types';
import ***REMOVED*** Compat } from '@firebase/util';
import ***REMOVED*** ParseContext } from '../api/parse_context';
import ***REMOVED*** DatabaseId } from '../core/database_info';
import ***REMOVED*** DocumentKey } from '../model/document_key';
import ***REMOVED*** FieldMask } from '../model/field_mask';
import ***REMOVED*** FieldTransform, Mutation, Precondition } from '../model/mutation';
import ***REMOVED*** ObjectValue } from '../model/object_value';
import ***REMOVED*** FieldPath as InternalFieldPath } from '../model/path';
import ***REMOVED*** Value as ProtoValue } from '../protos/firestore_proto_api';
import ***REMOVED*** JsonProtoSerializer } from '../remote/serializer';
import ***REMOVED*** FirestoreError } from '../util/error';
import ***REMOVED*** Firestore } from './database';
import ***REMOVED*** FieldValue } from './field_value';
import ***REMOVED*** PartialWithFieldValue, WithFieldValue } from './reference';
/**
 * An untyped Firestore Data Converter interface that is shared between the
 * lite, firestore-exp and classic SDK.
 */
export interface UntypedFirestoreDataConverter<T> ***REMOVED***
...
export declare const enum UserDataSource ***REMOVED***
    Set = 0,
    Update = 1,
    MergeSet = 2,
    /**
...
interface ContextSettings ***REMOVED***
...
declare class ParseContextImpl implements ParseContext ***REMOVED***
 ...
 * classes.
 */
export declare class UserDataReader ***REMOVED***
...
export declare class DeleteFieldValueImpl extends FieldValue ***REMOVED***
    _toFieldTransform(context: ParseContextImpl): null;
    isEqual(other: FieldValue): boolean;
}
export declare class ServerTimestampFieldValueImpl extends FieldValue ***REMOVED***
    _toFieldTransform(context: ParseContextImpl): FieldTransform;
    isEqual(other: FieldValue): boolean;
}
export declare class ArrayUnionFieldValueImpl extends FieldValue ***REMOVED***
    private readonly _elements;
    constructor(methodName: string, _elements: unknown[]);
    _toFieldTransform(context: ParseContextImpl): FieldTransform;
    isEqual(other: FieldValue): boolean;
}
export declare class ArrayRemoveFieldValueImpl extends FieldValue ***REMOVED***
    readonly _elements: unknown[];
    constructor(methodName: string, _elements: unknown[]);
    _toFieldTransform(context: ParseContextImpl): FieldTransform;
    isEqual(other: FieldValue): boolean;
}
export declare class NumericIncrementFieldValueImpl extends FieldValue ***REMOVED***
