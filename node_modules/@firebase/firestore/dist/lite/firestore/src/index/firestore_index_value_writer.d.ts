 ...
 */
import ***REMOVED*** Value } from '../protos/firestore_proto_api';
import ***REMOVED*** DirectionalIndexByteEncoder } from './directional_index_byte_encoder';
/** Firestore index value writer.  */
export declare class FirestoreIndexValueWriter ***REMOVED***
