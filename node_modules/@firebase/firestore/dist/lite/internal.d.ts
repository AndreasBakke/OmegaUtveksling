 ...
 * @internal
 */
declare abstract class AbstractUserDataWriter ***REMOVED***
 ...
 * @internal
 */
declare class ByteString ***REMOVED***
 ...
 * Security Rules.
 */
export declare function connectFirestoreEmulator(firestore: Firestore, host: string, port: number, options?: ***REMOVED***
 ...
 * @internal
 */
declare class DatabaseId ***REMOVED***
 ...
 * @internal
 */
declare class DocumentKey ***REMOVED***
 ...
 */
export declare class DocumentSnapshot<T = DocumentData> ***REMOVED***
 ...
 * @internal
 */
declare class FieldPath_2 extends BasePath<FieldPath_2> ***REMOVED***
 ...
 */
export declare class Firestore implements FirestoreService ***REMOVED***
 ...
 * ```
 */
export declare interface FirestoreDataConverter<T> ***REMOVED***
    /**
 ...
 */
export declare function getCount(query: Query<unknown>): Promise<AggregateQuerySnapshot<***REMOVED***
 ...
 *
 * @param app - The ***REMOVED***@link @firebase/app#FirebaseApp} with which the `Firestore` instance will
 * be associated.
...
declare interface PrivateSettings extends Settings ***REMOVED***
...
export declare class QuerySnapshot<T = DocumentData> ***REMOVED***
    ...
    /**
     * The query on which you called ***REMOVED***@link getDocs} in order to get this
     * `QuerySnapshot`.
     */
 ...
 * @internal
 */
declare class ResourcePath extends BasePath<ResourcePath> ***REMOVED***
 ...
 */
export declare interface Settings ***REMOVED***
    /** The hostname to connect to. */
    host?: string;
    /** Whether to use SSL when connecting. */
    ssl?: boolean;
