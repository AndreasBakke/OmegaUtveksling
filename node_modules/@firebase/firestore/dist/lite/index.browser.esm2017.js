...
function y(t, ...e) ***REMOVED***
    if (m.logLevel <= LogLevel.DEBUG) ***REMOVED***
        const n = e.map(v);
        m.debug(`Firestore ($***REMOVED***w}): $***REMOVED***t}`, ...n);
  ***REMOVED***
}

function g(t, ...e) ***REMOVED***
    if (m.logLevel <= LogLevel.ERROR) ***REMOVED***
        const n = e.map(v);
        m.error(`Firestore ($***REMOVED***w}): $***REMOVED***t}`, ...n);
  ***REMOVED***
}

/**
 * @internal
 */ function _(t, ...e) ***REMOVED***
    if (m.logLevel <= LogLevel.WARN) ***REMOVED***
        const n = e.map(v);
        m.warn(`Firestore ($***REMOVED***w}): $***REMOVED***t}`, ...n);
  ***REMOVED***
}
 ...
 */ function b(t = "Unexpected state") ***REMOVED***
    // Log the failure in addition to throw an exception, just in case the
    // exception is swallowed.
    const e = `FIRESTORE ($***REMOVED***w}) INTERNAL ASSERTION FAILED: ` + t;
...
/** An error returned by a Firestore operation. */ class U extends FirebaseError ***REMOVED***
    /** @hideconstructor */
    constructor(
    /**
...
/** Credential provider for the Lite SDK. */ class W ***REMOVED***
    constructor(t) ***REMOVED***
        this.auth = null, t.onInit((t => ***REMOVED***
            this.auth = t;
      ***REMOVED***));
  ***REMOVED***
    getToken() ***REMOVED***
 ...
 */ class G ***REMOVED***
    constructor(t, e, n, r) ***REMOVED***
        this.t = t, this.i = e, this.o = n, this.u = r, this.type = "FirstParty", this.user = d.FIRST_PARTY, 
        this.h = new Map;
  ***REMOVED***
    /** Gets an authorization token, using a provided factory function, or falling back to First Party GAPI. */    l() ***REMOVED***
...
/** AppCheck token provider for the Lite SDK. */ class H ***REMOVED***
    constructor(t) ***REMOVED***
        this.m = t, this.appCheck = null, t.onInit((t => ***REMOVED***
            this.appCheck = t;
      ***REMOVED***));
  ***REMOVED***
    getToken() ***REMOVED***
...
class J ***REMOVED***
     ...
     * XMLHTTPRequest
     */
    constructor(t, e, n, r, s, i, o, u) ***REMOVED***
...
class Z ***REMOVED***
  ...
  ***REMOVED***
    child(t) ***REMOVED***
        ...
        return t instanceof Z ? t.forEach((t => ***REMOVED***
            e.push(t);
  ...
  ***REMOVED***
     ...
     */    static fromString(...t) ***REMOVED***
        ...
        for (const n of t) ***REMOVED***
            if (n.indexOf("//") >= 0) throw new U(P, `Invalid segment ($***REMOVED***n}). Paths must not contain // in them.`);
 ...
 */ class nt extends Z ***REMOVED***
  ...
  ***REMOVED***
     ...
     */    static fromServerFormat(t) ***REMOVED***
        ...
        let n = "", r = 0;
        const s = () => ***REMOVED***
            if (0 === n.length) throw new U(P, `Invalid field path ($***REMOVED***t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            e.push(n), n = "";
      ***REMOVED***;
        let i = !1;
        for (;r < t.length; ) ***REMOVED***
            const e = t[r];
            if ("\\" === e) ***REMOVED***
                ...
                n += e, r += 2;
          ***REMOVED*** else "`" === e ? (i = !i, r++) : "." !== e || i ? (n += e, r++) : (s(), r++);
      ***REMOVED***
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ function st(t, e, n) ***REMOVED***
    if (!n) throw new U(P, `Function $***REMOVED***t}() cannot be called with an empty $***REMOVED***e}.`);
}
...
function it(t) ***REMOVED***
    if (!rt.isDocumentKey(t)) throw new U(P, `Invalid document reference. Document references must have an even number of segments, but $***REMOVED***t} has $***REMOVED***t.length}.`);
}
 ...
 */ function ot(t) ***REMOVED***
    if (rt.isDocumentKey(t)) throw new U(P, `Invalid collection reference. Collection references must have an odd number of segments, but $***REMOVED***t} has $***REMOVED***t.length}.`);
}
...
e) ***REMOVED***
    ...
    t = t._delegate), !(t instanceof e)) ***REMOVED***
        ...
        ***REMOVED***
            const n = ut(t);
            throw new U(P, `Expected type '$***REMOVED***e.name}', but it was: $***REMOVED***n}`);
      ***REMOVED***
  ***REMOVED***
    return t;
}
...
function at(t, e) ***REMOVED***
    if (e <= 0) throw new U(P, `Function $***REMOVED***t}() requires a positive number, but it was: $***REMOVED***e}.`);
}
...
/** Returns whether the value represents -0. */ function lt(t) ***REMOVED***
 ...
 */ (wt = dt || (dt = ***REMOVED***}))[wt.OK = 0] = "OK", wt[wt.CANCELLED = 1] = "CANCELLED", 
...
class ***REMOVED***
  ...
  ***REMOVED***
    I(t, e, n, r, s) ***REMOVED***
        ...
        t)), (e => ***REMOVED***
            throw _("RestConnection", `$***REMOVED***t} failed with error: `, e, "url: ", i, "request:", n), 
            e;
      ***REMOVED***));
  ***REMOVED***
    P(t, e, n, r, s, i) ***REMOVED***
  ...
  ***REMOVED***
    T(t, e) ***REMOVED***
        const n = ft[t];
        return `$***REMOVED***this.p}/v1/$***REMOVED***e}:$***REMOVED***n}`;
  ***REMOVED***
} ***REMOVED***
    /**
  ...
  ***REMOVED***
    async R(t, e, n, r) ***REMOVED***
        var s;
        const i = JSON.stringify(r);
        let o;
        try ***REMOVED***
            o = await this.V(e, ***REMOVED***
                method: "POST",
                headers: n,
                body: i
          ***REMOVED***);
      ...
      ***REMOVED***
        if (!o.ok) ***REMOVED***
            ...
            throw new U(mt(o.status), `Request failed with error: $***REMOVED***null != e ? e : o.statusText}`);
      ***REMOVED***
        return o.json();
  ***REMOVED***
}
...
/** Helper to compare arrays using isEqual(). */ function vt(t, e, n) ***REMOVED***
...
const Tt = new RegExp(/^\d***REMOVED***4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
 ...
 */ function At(t) ***REMOVED***
    ...
    if (E(!!t), "string" == typeof t) ***REMOVED***
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function Pt(t) ***REMOVED***
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function St(t, e) ***REMOVED***
    if (t === e) return !0;
    const n = xt(t);
    if (n !== xt(e)) return !1;
    switch (n) ***REMOVED***
      ...
      ***REMOVED***(t, e);
      ...
      case 10 /* TypeOrder.ObjectValue */ :
        return function(t, e) ***REMOVED***
            const n = t.mapValue.fields || ***REMOVED***}, r = e.mapValue.fields || ***REMOVED***};
...
function qt(t, e) ***REMOVED***
    return void 0 !== (t.values || []).find((t => St(t, e)));
}

function Ot(t, e) ***REMOVED***
    if (t === e) return 0;
    const n = xt(t), r = xt(e);
      ...
      ***REMOVED***(t.bytesValue, e.bytesValue);
      ...
      case 7 /* TypeOrder.RefValue */ :
        return function(t, e) ***REMOVED***
            ...
            for (let t = 0; t < n.length && t < r.length; t++) ***REMOVED***
                const e = _t(n[t], r[t]);
                if (0 !== e) return e;
          ***REMOVED***
      ...
      ***REMOVED***(t.arrayValue, e.arrayValue);
      ...
      case 10 /* TypeOrder.ObjectValue */ :
        return function(t, e) ***REMOVED***
            ...
            if (t === Ft) return 1;
            if (e === Ft) return -1;
            const n = t.fields || ***REMOVED***}, r = Object.keys(n), s = e.fields || ***REMOVED***}, i = Object.keys(s);
            // Even though MapValues are likely sorted correctly based on their insertion
            // order (e.g. when received from the backend), local modifications can bring
            // elements out of order. We need to re-sort the elements to ensure that
            // canonical IDs are independent of insertion order.
            r.sort(), i.sort();
            for (let t = 0; t < r.length && t < i.length; ++t) ***REMOVED***
                const e = _t(r[t], i[t]);
                if (0 !== e) return e;
...
/** Returns true if `value` is an ArrayValue. */ function Lt(t) ***REMOVED***
    return !!t && "arrayValue" in t;
}

/** Returns true if `value` is a NullValue. */ function Mt(t) ***REMOVED***
    return !!t && "nullValue" in t;
}

/** Returns true if `value` is NaN. */ function Ut(t) ***REMOVED***
    return !!t && "doubleValue" in t && isNaN(Number(t.doubleValue));
}

/** Returns true if `value` is a MapValue. */ function jt(t) ***REMOVED***
    return !!t && "mapValue" in t;
}

/** Creates a deep copy of `source`. */ function Bt(t) ***REMOVED***
...
function Yt(t, e) ***REMOVED***
    return t instanceof Gt ? function(t, e) ***REMOVED***
        return e instanceof Gt && t.op === e.op && t.field.isEqual(e.field) && St(t.value, e.value);
  ***REMOVED***(t, e) : t instanceof Kt ? function(t, e) ***REMOVED***
        if (e instanceof Kt && t.op === e.op && t.filters.length === e.filters.length) ***REMOVED***
...
/** Filter that matches on key fields within an array. */ class Jt extends Gt ***REMOVED***
    constructor(t, e) ***REMOVED***
...
/** Filter that matches on key fields not present within an array. */ class Xt extends Gt ***REMOVED***
    constructor(t, e) ***REMOVED***
...
/** A Filter that implements the array-contains operator. */ class te extends Gt ***REMOVED***
    constructor(t, e) ***REMOVED***
...
/** A Filter that implements the IN operator. */ class ee extends Gt ***REMOVED***
    constructor(t, e) ***REMOVED***
...
/** A Filter that implements the not-in operator. */ class ne extends Gt ***REMOVED***
    constructor(t, e) ***REMOVED***
        super(t, "not-in" /* Operator.NOT_IN */ , e);
  ***REMOVED***
    matches(t) ***REMOVED***
        if (qt(this.value.arrayValue, ***REMOVED***
...
/** A Filter that implements the array-contains-any operator. */ class re extends Gt ***REMOVED***
    constructor(t, e) ***REMOVED***
...
class ae ***REMOVED***
  ...
  ***REMOVED***
    ...
    remove(t, e) ***REMOVED***
        ...
        r = r.copy(null, null, null, r.left.remove(t, e), null); else ***REMOVED***
 ...
 */ class de ***REMOVED***
  ...
  ***REMOVED***
     ...
     */    setAll(t) ***REMOVED***
        let e = nt.emptyPath(), n = ***REMOVED***}, r = [];
        t.forEach(((t, s) => ***REMOVED***
            if (!e.isImmediateParentOf(s)) ***REMOVED***
                // Insert the accumulated changes at this parent location
                const t = this.getFieldsMap(e);
                this.applyChanges(t, n, r), n = ***REMOVED***}, r = [], e = s.popLast();
          ***REMOVED***
     ...
     */    getFieldsMap(t) ***REMOVED***
      ...
      ***REMOVED***);
        for (let n = 0; n < t.length; ++n) ***REMOVED***
            ...
            jt(r) && r.mapValue.fields || (r = ***REMOVED***
                mapValue: ***REMOVED***
                    fields: ***REMOVED***}
              ***REMOVED***
 ...
 * from all views.
 */ class we ***REMOVED***
    constructor(t, e, n, r, s, i, o) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * given version.
     */    static newFoundDocument(t, e, n, r) ***REMOVED***
...
// Visible for testing
class me ***REMOVED***
    constructor(t, e = null, n = [], r = [], s = null, i = null, o = null) ***REMOVED***
 ...
 * property.
 */ function pe(t, e = null, n = [], r = [], s = null, i = null, o = null) ***REMOVED***
...
class ye ***REMOVED***
     ...
     * Path must currently be empty if this is a collection group query.
     */
    constructor(t, e = null, n = [], r = [], s = null, i = "F" /* LimitType.First */ , o = null, u = null) ***REMOVED***
...
/** Creates a new Query for a query that matches all documents at `path` */ function ge(t) ***REMOVED***
 ...
 */ function be(t) ***REMOVED***
    ...
    if (null === e.q) ***REMOVED***
        ...
        t.isKeyField() || e.q.push(new se(t)), e.q.push(new se(nt.keyField(), "asc" /* Direction.ASCENDING */)); else ***REMOVED***
            let t = !1;
 ...
 */ function Ee(t) ***REMOVED***
    const e = I(t);
    if (!e.O) if ("F" /* LimitType.First */ === e.limitType) e.O = pe(e.path, e.collectionGroup, be(e), e.filters, e.limit, e.startAt, e.endAt); else ***REMOVED***
        // Flip the orderBy directions since we want the last results
        const t = [];
        for (const n of be(e)) ***REMOVED***
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ class Re ***REMOVED***
    constructor() ***REMOVED***
...
/** Transforms a value into a server-generated timestamp. */ class Pe extends Re ***REMOVED***}

/** Transforms an array value via a union operation. */ class Ve extends Re ***REMOVED***
    constructor(t) ***REMOVED***
        super(), this.elements = t;
  ***REMOVED***
}

/** Transforms an array value via a remove operation. */ class $e extends Re ***REMOVED***
    constructor(t) ***REMOVED***
        super(), this.elements = t;
  ***REMOVED***
}
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ class De ***REMOVED***
    constructor(t, e) ***REMOVED***
...
/** A mutation that deletes the document at the given key. */ class Oe extends xe ***REMOVED***
    constructor(t, e) ***REMOVED***
...
function ze(t) ***REMOVED***
    return E(!!t), oe.fromTimestamp(function(t) ***REMOVED***
        const e = At(t);
        return new Vt(e.seconds, e.nanos);
  ***REMOVED***(t));
}
...
function Xe(t, e) ***REMOVED***
    return "found" in e ? function(t, e) ***REMOVED***
        ...
        const n = Ke(t, e.found.name), r = ze(e.found.updateTime), s = e.found.createTime ? ze(e.found.createTime) : oe.min(), i = new de(***REMOVED***
            mapValue: ***REMOVED***
...
function Ze(t, e) ***REMOVED***
    let n;
    if (e instanceof Se) n = ***REMOVED***
        update: Je(t, e.key, e.value)
  ***REMOVED***; else if (e instanceof Oe) n = ***REMOVED***
        delete: Ge(t, e.key)
  ***REMOVED***; else if (e instanceof qe) n = ***REMOVED***
    ...
    return e.fieldTransforms.length > 0 && (n.updateTransforms = e.fieldTransforms.map((t => function(t, e) ***REMOVED***
      ...
      ***REMOVED***;
        if (n instanceof Ve) return ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***;
        if (n instanceof $e) return ***REMOVED***
            fieldPath: e.field.canonicalString(),
            removeAllFromArray: ***REMOVED***
                values: n.elements
          ***REMOVED***
      ***REMOVED***;
        if (n instanceof Ne) return ***REMOVED***
            fieldPath: e.field.canonicalString(),
            increment: n.L
      ***REMOVED***;
        throw b();
...
function on(t) ***REMOVED***
    return t instanceof Gt ? function(t) ***REMOVED***
      ...
      ***REMOVED***
        return ***REMOVED***
          ...
          ***REMOVED***
      ***REMOVED***;
  ***REMOVED***(t) : t instanceof Kt ? function(t) ***REMOVED***
...
class hn ***REMOVED***
  ...
  ***REMOVED***
     ...
     */    H(t) ***REMOVED***
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                r > 0 && y("ExponentialBackoff", `Backing off for $***REMOVED***r} ms (base delay: $***REMOVED***this.W} ms, delay with jitter: $***REMOVED***e} ms, last attempt: $***REMOVED***n} ms ago)`), 
  ...
  ***REMOVED***
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */    J() ***REMOVED***
 ...
 * consumption.
 */
class ln extends class ***REMOVED***} ***REMOVED***
    constructor(t, e, n, r) ***REMOVED***
  ...
  ***REMOVED***
    /** Invokes the provided RPC with auth and AppCheck tokens. */    I(t, e, n) ***REMOVED***
        return this.tt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([r, s]) => this.connection.I(t, e, n, r, s))).catch((t => ***REMOVED***
      ...
      ***REMOVED***));
  ***REMOVED***
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */    P(t, e, n, r) ***REMOVED***
        return this.tt(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([s, i]) => this.connection.P(t, e, n, s, i, r))).catch((t => ***REMOVED***
            throw "FirebaseError" === t.name ? (t.code === F && (this.authCredentials.invalidateToken(), 
            this.appCheckCredentials.invalidateToken()), t) : new U(R, t.toString());
      ***REMOVED***));
  ***REMOVED***
...
async function fn(t, e) ***REMOVED***
    const n = I(t), r = He(n.C) + "/documents", s = ***REMOVED***
        writes: e.map((t => Ze(n.C, t)))
  ***REMOVED***;
    await n.I("Commit", r, s);
}

async function dn(t, e) ***REMOVED***
    const n = I(t), r = He(n.C) + "/documents", s = ***REMOVED***
        documents: e.map((t => Ge(n.C, t)))
  ***REMOVED***, i = await n.P("BatchGetDocuments", r, s, e.length), o = new Map;
    i.forEach((t => ***REMOVED***
        const e = Xe(n.C, t);
...
async function wn(t, e) ***REMOVED***
    const n = I(t), r = tn(n.C, Ee(e));
    return (await n.P("RunQuery", r.parent, ***REMOVED***
        structuredQuery: r.structuredQuery
  ***REMOVED***)).filter((t => !!t.document)).map((t => function(t, e, n) ***REMOVED***
        const r = Ke(t, e.name), s = ze(e.updateTime), i = e.createTime ? ze(e.createTime) : oe.min(), o = new de(***REMOVED***
            mapValue: ***REMOVED***
                fields: e.fields
          ***REMOVED***
      ***REMOVED***), u = we.newFoundDocument(r, s, i, o);
        return n && u.setHasCommittedMutations(), n ? u.setHasCommittedMutations() : u;
  ***REMOVED***(n.C, t.document, void 0)));
}

async function mn(t, e) ***REMOVED***
    const n = I(t), r = function(t, e) ***REMOVED***
        const n = tn(t, e);
        return ***REMOVED***
...
function yn(t) ***REMOVED***
    ...
    if (!pn.has(t)) ***REMOVED***
      ...
      ***REMOVED***((e = t._databaseId, n = t.app.options.appId || "", r = t._persistenceKey, s = t._freezeSettings(), 
        new J(e, n, r, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams))), o = an(t._databaseId), u = function(t, e, n, r) ***REMOVED***
            return new ln(t, e, n, r);
      ***REMOVED***(t._authCredentials, t._appCheckCredentials, i, o);
        pn.set(t, u);
  ***REMOVED***
    var e, n, r, s;
    /**
    ...
    constructor(t) ***REMOVED***
      ...
      ***REMOVED***
        ...
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) ***REMOVED***
            if (!0 === e && !0 === r) throw new U(P, `$***REMOVED***t} and $***REMOVED***n} cannot be used together.`);
      ***REMOVED***("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
  ***REMOVED***
    isEqual(t) ***REMOVED***
 ...
 */ class _n ***REMOVED***
    ...
    constructor(t, e, n, r) ***REMOVED***
         ...
         */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new gn(***REMOVED***}), 
  ...
  ***REMOVED***
    _setSettings(t) ***REMOVED***
        ...
        this._settings = new gn(t), void 0 !== t.credentials && (this._authCredentials = function(t) ***REMOVED***
            if (!t) return new Q;
...
function bn(e, n) ***REMOVED***
    const r = "object" == typeof e ? e : getApp(), s = "string" == typeof e ? e : n || "(default)", i = _getProvider(r, "firestore/lite").getImmediate(***REMOVED***
        identifier: s
  ***REMOVED***);
    if (!i._initialized) ***REMOVED***
 ...
 * Security Rules.
 */ function En(t, e, n, r = ***REMOVED***}) ***REMOVED***
    var s;
    ...
    t._setSettings(Object.assign(Object.assign(***REMOVED***}, i), ***REMOVED***
        host: `$***REMOVED***e}:$***REMOVED***n}`,
        ssl: !1
  ***REMOVED***)), r.mockUserToken) ***REMOVED***
        let e, n;
        if ("string" == typeof r.mockUserToken) e = r.mockUserToken, n = d.MOCK_USER; else ***REMOVED***
 ...
 */ class Rn ***REMOVED***
  ...
  ***REMOVED***
    run() ***REMOVED***
        return mn(this.datastore, this.query._query).then((t => ***REMOVED***
            E(void 0 !== t[0]);
            const e = Object.entries(t[0]).filter((([t, e]) => "count_alias" === t)).map((([t, e]) => this.userDataWriter.convertValue(e)))[0];
            return E("number" == typeof e), Promise.resolve(new An(this.query, ***REMOVED***
                count: e
          ***REMOVED***));
      ***REMOVED***));
  ***REMOVED***
...
function Nn(t, e, ...n) ***REMOVED***
    if (t = getModularInstance(t), st("collection", "path", e), t instanceof _n) ***REMOVED***
 ...
 */ function Dn(t, e) ***REMOVED***
    if (t = ct(t, _n), st("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new U(P, `Invalid collection ID '$***REMOVED***e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Vn(t, 
...
function Fn(t, e, ...n) ***REMOVED***
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = gt.N()), st("doc", "path", e), t instanceof _n) ***REMOVED***
        const r = tt.fromString(e, ...n);
...
/** The result of parsing document data (e.g. for a setData call). */ class Un ***REMOVED***
    constructor(t, e, n) ***REMOVED***
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class jn ***REMOVED***
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class Qn ***REMOVED***
    /**
     ...
     * compromised).
     */
    constructor(t, e, n, r, s, i) ***REMOVED***
  ...
  ***REMOVED***
    /** Returns a new context with the specified settings overwritten. */    rt(t) ***REMOVED***
        return new Qn(Object.assign(Object.assign(***REMOVED***}, this.settings), t), this.databaseId, this.C, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  ***REMOVED***
    st(t) ***REMOVED***
        var e;
        const n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.rt(***REMOVED***
            path: n,
            it: !1
      ***REMOVED***);
        return r.ot(t), r;
 ...
 */ class zn ***REMOVED***
  ...
  ***REMOVED***
    /** Creates a new top-level parse context. */    ft(t, e, n, r = !1) ***REMOVED***
        return new Qn(***REMOVED***
            nt: t,
            methodName: e,
            lt: n,
            path: nt.emptyPath(),
...
/** Parse document data from a set() call. */ function Gn(t, e, n, r, s, i = ***REMOVED***}) ***REMOVED***
    ...
    const u = sr(r, o);
    let c, a;
    if (i.merge) c = new fe(o.fieldMask), a = o.fieldTransforms; else if (i.mergeFields) ***REMOVED***
        const t = [];
        for (const r of i.mergeFields) ***REMOVED***
            const s = ur(e, r, n);
            if (!o.contains(s)) throw new U(P, `Field '$***REMOVED***s}' is specified in your field mask but missing from your input data.`);
            lr(t, s) || t.push(s);
      ***REMOVED***
...
class Kn extends Cn ***REMOVED***
    _toFieldTransform(t) ***REMOVED***
        if (2 /* UserDataSource.MergeSet */ !== t.nt) throw 1 /* UserDataSource.Update */ === t.nt ? t.at(`$***REMOVED***this._methodName}() can only appear at the top level of your update data`) : t.at(`$***REMOVED***this._methodName}() cannot be used with set() unless you pass ***REMOVED***merge:true}`);
...
/** Parse update data from an update() call. */ function tr(t, e, n, r) ***REMOVED***
...
/** Parse update data from a list of field/value arguments. */ function er(t, e, n, r, s, i) ***REMOVED***
    const o = t.ft(1 /* UserDataSource.Update */ , e, n), u = [ ur(e, r, n) ], c = [ s ];
    if (i.length % 2 != 0) throw new U(P, `Function $***REMOVED***e}() needs to be called with an even number of arguments that alternate between field names and values.`);
    for (let t = 0; t < i.length; t += 2) u.push(ur(e, i[t])), c.push(i[t + 1]);
    const a = [], h = de.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = u.length - 1; t >= 0; --t) if (!lr(a, u[t])) ***REMOVED***
        const e = u[t];
        let n = c[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */
    return function(t, e) ***REMOVED***
        ...
        if (!Bn(e.nt)) throw e.at(`$***REMOVED***t._methodName}() can only be used with update() and set()`);
        if (!e.path) throw e.at(`$***REMOVED***t._methodName}() is not currently supported inside arrays`);
    ...
    return function(t, e) ***REMOVED***
      ...
      ***REMOVED***
        if (t instanceof Vt) ***REMOVED***
          ...
          ***REMOVED***;
      ***REMOVED***
        if (t instanceof Ln) return ***REMOVED***
            geoPointValue: ***REMOVED***
                latitude: t.latitude,
                longitude: t.longitude
          ***REMOVED***
      ***REMOVED***;
        if (t instanceof qn) return ***REMOVED***
            bytesValue: Be(e.C, t._byteString)
      ***REMOVED***;
        if (t instanceof Pn) ***REMOVED***
            const n = e.databaseId, r = t.firestore._databaseId;
            if (!r.isEqual(n)) throw e.at(`Document reference is for database $***REMOVED***r.projectId}/$***REMOVED***r.database} but should be for database $***REMOVED***n.projectId}/$***REMOVED***n.database}`);
            return ***REMOVED***
                referenceValue: We(t.firestore._databaseId || e.databaseId, t._key.path)
          ***REMOVED***;
      ***REMOVED***
        throw e.at(`Unsupported field value: $***REMOVED***ut(t)}`);
  ***REMOVED***
    /**
 ...
 * limitations under the License.
 */
    /** Converts a Base64 encoded string to a binary string. */ (t) ? Et(t, ((t, r) => ***REMOVED***
        const s = rr(r, e.st(t));
        null != s && (n[t] = s);
  ***REMOVED***)) : 
    // If we encounter an empty object, we explicitly add it to the update
    // mask to ensure that the server creates a map entry.
    e.path && e.path.length > 0 && e.fieldMask.push(e.path), ***REMOVED***
        mapValue: ***REMOVED***
            fields: n
      ***REMOVED***
  ***REMOVED***;
 ...
 * evaluated.
 */ function ar(t, e, n) ***REMOVED***
    if (e.search(cr) >= 0) throw hr(`Invalid field path ($***REMOVED***e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try ***REMOVED***
        return new On(...e.split("."))._internalPath;
  ***REMOVED*** catch (r) ***REMOVED***
        throw hr(`Invalid field path ($***REMOVED***e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
  ***REMOVED***
}

function hr(t, e, n, r, s) ***REMOVED***
    const i = r && !r.isEmpty(), o = void 0 !== s;
    let u = `Function $***REMOVED***e}() called with invalid data`;
    n && (u += " (via `toFirestore()`)"), u += ". ";
    let c = "";
    return (i || o) && (c += " (found", i && (c += ` in field $***REMOVED***r}`), o && (c += ` in document $***REMOVED***s}`), 
    c += ")"), new U(P, u + t + c);
}

/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function lr(t, e) ***REMOVED***
 ...
 */ class gr extends yr ***REMOVED***}

function _r(t, e, ...n) ***REMOVED***
    let r = [];
    e instanceof yr && r.push(e), r = r.concat(n), function(t) ***REMOVED***
 ...
 */ class vr extends gr ***REMOVED***
  ...
  ***REMOVED***
    _parse(t) ***REMOVED***
        const e = Wn(t.firestore), n = function(t, e, n, r, s, i, o) ***REMOVED***
            let u;
            if (s.isKeyField()) ***REMOVED***
                if ("array-contains" /* Operator.ARRAY_CONTAINS */ === i || "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ === i) throw new U(P, `Invalid Query. You can't perform '$***REMOVED***i}' queries on documentId().`);
                if ("in" /* Operator.IN */ === i || "not-in" /* Operator.NOT_IN */ === i) ***REMOVED***
                    Cr(o, i);
                    const e = [];
                    ...
                    u = ***REMOVED***
                      ...
                      ***REMOVED***
                  ***REMOVED***;
              ***REMOVED*** else u = kr(r, t, o);
          ***REMOVED*** else "in" /* Operator.IN */ !== i && "not-in" /* Operator.NOT_IN */ !== i && "array-contains-any" /* Operator.ARRAY_CONTAINS_ANY */ !== i || Cr(o, i), 
            u = nr(n, e, o, 
 ...
 */ (t._query, this._field, this._direction);
        return new Vn(t.firestore, t.converter, function(t, e) ***REMOVED***
 ...
 */ class Pr extends gr ***REMOVED***
  ...
  ***REMOVED***
    _apply(t) ***REMOVED***
        return new Vn(t.firestore, t.converter, function(t, e, n) ***REMOVED***
...
/** Helper function to create a bound from a document or fields */ function Or(t, e, n, r) ***REMOVED***
    if (n[0] = getModularInstance(n[0]), n[0] instanceof fr) return function(t, e, n, r, s) ***REMOVED***
        if (!r) throw new U($, `Can't use a DocumentSnapshot that doesn't exist for $***REMOVED***n}().`);
        const i = [];
        ...
        // results.
                for (const n of be(t)) if (n.field.isKeyField()) i.push(Ct(e, r.key)); else ***REMOVED***
            ...
            if (null === t) ***REMOVED***
                ...
                throw new U(P, `Invalid query. You are trying to start or end a query using a document for which the field '$***REMOVED***t}' (used as the orderBy) does not exist.`);
          ***REMOVED***
            i.push(t);
      ***REMOVED***
        return new Qt(i, s);
 ...
 */ (t._query, t.firestore._databaseId, e, n[0]._document, r);
    ***REMOVED***
        ...
        return function(t, e, n, r, s, i) ***REMOVED***
            // Use explicit order by's because it has to match the query the user made
            const o = t.explicitOrderBy;
            if (s.length > o.length) throw new U(P, `Too many arguments provided to $***REMOVED***r}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
            const u = [];
            for (let i = 0; i < s.length; i++) ***REMOVED***
                const c = s[i];
                if (o[i].field.isKeyField()) ***REMOVED***
                    if ("string" != typeof c) throw new U(P, `Invalid query. Expected a string for document ID in $***REMOVED***r}(), but got a $***REMOVED***typeof c}`);
                    if (!ve(t) && -1 !== c.indexOf("/")) throw new U(P, `Invalid query. When querying a collection and ordering by documentId(), the value passed to $***REMOVED***r}() must be a plain document ID, but '$***REMOVED***c}' contains a slash.`);
                    const n = t.path.child(tt.fromString(c));
                    if (!rt.isDocumentKey(n)) throw new U(P, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to $***REMOVED***r}() must result in a valid document path, but '$***REMOVED***n}' is not because it contains an odd number of segments.`);
                    const s = new rt(n);
                    u.push(Ct(e, s));
              ***REMOVED*** else ***REMOVED***
                    const t = nr(n, r, c);
...
function kr(t, e, n) ***REMOVED***
    if ("string" == typeof (n = getModularInstance(n))) ***REMOVED***
        ...
        if (!ve(e) && -1 !== n.indexOf("/")) throw new U(P, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '$***REMOVED***n}' contains a '/' character.`);
        const r = e.path.child(tt.fromString(n));
        if (!rt.isDocumentKey(r)) throw new U(P, `Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '$***REMOVED***r}' is not because it has an odd number of segments ($***REMOVED***r.length}).`);
        return Ct(t, new rt(r));
  ***REMOVED***
    if (n instanceof Pn) return Ct(t, n._key);
    throw new U(P, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: $***REMOVED***ut(n)}.`);
}
 ...
 */ function Cr(t, e) ***REMOVED***
    if (!Array.isArray(t) || 0 === t.length) throw new U(P, `Invalid Query. A non-empty array is required for '$***REMOVED***e.toString()}' filters.`);
    if (t.length > 10) throw new U(P, `Invalid Query. '$***REMOVED***e.toString()}' filters support a maximum of 10 elements in the value array.`);
}
 ...
 */ function Lr(t, e) ***REMOVED***
    if (e.isInequality()) ***REMOVED***
        const n = _e(t), r = e.field;
        if (null !== n && !n.isEqual(r)) throw new U(P, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '$***REMOVED***n.toString()}' and '$***REMOVED***r.toString()}'`);
        const s = ge(t);
        null !== s && Mr(t, r, s);
  ***REMOVED***
  ...
  ***REMOVED***(e.op));
    ...
    throw n === e.op ? new U(P, `Invalid query. You cannot use more than one '$***REMOVED***e.op.toString()}' filter.`) : new U(P, `Invalid query. You cannot use '$***REMOVED***e.op.toString()}' filters with '$***REMOVED***n.toString()}' filters.`);
}

function Mr(t, e, n) ***REMOVED***
    if (!n.isEqual(e)) throw new U(P, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '$***REMOVED***e.toString()}' and so you must also use '$***REMOVED***e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '$***REMOVED***n.toString()}' instead.`);
}

function Ur(t, e) ***REMOVED***
    if (!(e instanceof vr || e instanceof Er)) throw new U(P, `Function $***REMOVED***t}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
}
...
class Br extends class ***REMOVED***
  ...
  ***REMOVED***
    convertObject(t, e) ***REMOVED***
        const n = ***REMOVED***};
        return Et(t.fields, ((t, r) => ***REMOVED***
  ...
  ***REMOVED***
    convertDocumentKey(t, e) ***REMOVED***
        ...
        g(`Document $***REMOVED***s} contains a document reference within a different database ($***REMOVED***r.projectId}/$***REMOVED***r.database}) which is not supported. It will be treated as a reference in the current database ($***REMOVED***e.projectId}/$***REMOVED***e.database}) instead.`), 
        s;
  ***REMOVED***
} ***REMOVED***
    constructor(t) ***REMOVED***
 ...
 */ function Qr(t) ***REMOVED***
    ...
    return dn(e, [ t._key ]).then((e => ***REMOVED***
        E(1 === e.length);
        const r = e[0];
 ...
 */ function zr(t) ***REMOVED***
  ...
  ***REMOVED***((t = ct(t, Vn))._query);
    const e = yn(t.firestore), n = new Br(t.firestore);
    return wn(e, t._query).then((e => ***REMOVED***
 ...
 */ function Yr(t, e) ***REMOVED***
    const n = Fn(t = ct(t, $n)), r = jr(t.converter, e), s = Gn(Wn(t.firestore), "addDoc", n._key, r, null !== n.converter, ***REMOVED***});
 ...
 */ class os ***REMOVED***
  ...
  ***REMOVED***
    async commit() ***REMOVED***
      ...
      ***REMOVED***)), await fn(this.datastore, this.mutations), this.committed = !0;
  ***REMOVED***
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function as() ***REMOVED***
 ...
 */ class hs ***REMOVED***
  ...
  ***REMOVED***
     ...
     */    static createAndSchedule(t, e, n, r, s) ***REMOVED***
 ...
 */ (t)) throw t;
  ...
  ***REMOVED***
    xt(t) ***REMOVED***
        const e = this.It.then((() => (this.Vt = !0, t().catch((t => ***REMOVED***
            this.Pt = t, this.Vt = !1;
            const e = 
            /**
 ...
 */ (t);
  ...
  ***REMOVED***
     ...
     */    Lt(t) ***REMOVED***
        this.Nt.push(t);
  ***REMOVED***
    /** Called once a DelayedOperation is run or canceled. */    qt(t) ***REMOVED***
 ...
 */ function ds(t, e, n) ***REMOVED***
    const r = yn(t = ct(t, _n)), s = Object.assign(Object.assign(***REMOVED***}, us), n);
    !function(t) ***REMOVED***
 ...
 */ !function(t) ***REMOVED***
    w = t;
}(`$***REMOVED***SDK_VERSION}_lite`), _registerComponent(new Component("firestore/lite", ((t, ***REMOVED***instanceIdentifier: e, options: n}) => ***REMOVED***
    const r = t.getProvider("app").getImmediate(), s = new _n(new W(t.getProvider("auth-internal")), new H(t.getProvider("app-check-internal")), function(t, e) ***REMOVED***
