...
function formatJSON(value) ***REMOVED***
    ...
    return util$1.inspect(value, ***REMOVED*** depth: 100 });
}
...
function logDebug(msg, ...obj) ***REMOVED***
    if (logClient.logLevel <= logger.LogLevel.DEBUG) ***REMOVED***
...
function logWarn(msg, ...obj) ***REMOVED***
    if (logClient.logLevel <= logger.LogLevel.WARN) ***REMOVED***
        const args = obj.map(argToString);
...
class FirestoreError extends util.FirebaseError ***REMOVED***
    /** @hideconstructor */
    constructor(
    /**
...
function initializeFirestore(app$1, settings, databaseId) ***REMOVED***
...
function getFirestore(appOrDatabaseId, optionalDatabaseId) ***REMOVED***
    ...
    const db = app._getProvider(app$1, 'firestore/lite').getImmediate(***REMOVED***
...
function registerFirestore() ***REMOVED***
    setSDKVersion(`$***REMOVED***app.SDK_VERSION}_lite`);
    app._registerComponent(new component.Component('firestore/lite', (container, ***REMOVED*** instanceIdentifier: databaseId, options: settings }) => ***REMOVED***
