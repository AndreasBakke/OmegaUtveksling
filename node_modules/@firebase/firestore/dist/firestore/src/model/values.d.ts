...
import ***REMOVED*** ArrayValue, MapValue, Value } from '../protos/firestore_proto_api';
import ***REMOVED*** DocumentKey } from './document_key';
import ***REMOVED*** TypeOrder } from './type_order';
...
export declare function isInteger(value?: Value | null): value is ***REMOVED***
    integerValue: string | number;
};
/** Returns true if `value` is a DoubleValue. */
export declare function isDouble(value?: Value | null): value is ***REMOVED***
    doubleValue: string | number;
};
/** Returns true if `value` is either an IntegerValue or a DoubleValue. */
export declare function isNumber(value?: Value | null): boolean;
/** Returns true if `value` is an ArrayValue. */
export declare function isArray(value?: Value | null): value is ***REMOVED***
    arrayValue: ArrayValue;
};
/** Returns true if `value` is a ReferenceValue. */
export declare function isReferenceValue(value?: Value | null): value is ***REMOVED***
    referenceValue: string;
};
/** Returns true if `value` is a NullValue. */
export declare function isNullValue(value?: Value | null): value is ***REMOVED***
    nullValue: 'NULL_VALUE';
};
/** Returns true if `value` is NaN. */
export declare function isNanValue(value?: Value | null): value is ***REMOVED***
    doubleValue: 'NaN' | number;
};
/** Returns true if `value` is a MapValue. */
export declare function isMapValue(value?: Value | null): value is ***REMOVED***
    mapValue: MapValue;
};
...
export declare function lowerBoundCompare(left: ***REMOVED***
    value: Value;
    inclusive: boolean;
}, right: ***REMOVED***
    value: Value;
...
export declare function upperBoundCompare(left: ***REMOVED***
    value: Value;
    inclusive: boolean;
}, right: ***REMOVED***
    value: Value;
