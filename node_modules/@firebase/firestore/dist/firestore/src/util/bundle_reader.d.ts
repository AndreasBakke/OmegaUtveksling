 ...
 */
import ***REMOVED*** BundleElement, BundleMetadata } from '../protos/firestore_bundle_proto';
import ***REMOVED*** JsonProtoSerializer } from '../remote/serializer';
/**
 * A complete element in the bundle stream, together with the byte length it
 * occupies in the stream.
 */
export declare class SizedBundleElement ***REMOVED***
 ...
 */
export interface BundleReader ***REMOVED***
