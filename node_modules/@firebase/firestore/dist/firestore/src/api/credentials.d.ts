...
export interface FirstPartyCredentialsSettings ***REMOVED***
    ['type']: 'gapi';
    ['client']: unknown;
    ['sessionIndex']: string;
...
export interface ProviderCredentialsSettings ***REMOVED***
    ['type']: 'provider';
...
export interface Token ***REMOVED***
    /** Type of token. */
    type: TokenType;
    /**
...
export declare class OAuthToken implements Token ***REMOVED***
    user: User;
    type: TokenType;
    headers: Map<any, any>;
 ...
 */
export interface CredentialsProvider<T> ***REMOVED***
    /**
 ...
 * @internal
 */
export declare class EmptyAuthCredentialsProvider implements CredentialsProvider<User> ***REMOVED***
    getToken(): Promise<Token | null>;
    invalidateToken(): void;
 ...
 */
export declare class EmulatorAuthCredentialsProvider implements CredentialsProvider<User> ***REMOVED***
    private token;
...
export declare class LiteAuthCredentialsProvider implements CredentialsProvider<User> ***REMOVED***
    private auth;
...
export declare class FirebaseAuthCredentialsProvider implements CredentialsProvider<User> ***REMOVED***
...
interface Gapi ***REMOVED***
    auth: ***REMOVED***
        getAuthHeaderValueForFirstParty: (userIdentifiers: Array<***REMOVED***
            [key: string]: string;
      ***REMOVED***>) => string | null;
  ***REMOVED***;
}
export declare class FirstPartyToken implements Token ***REMOVED***
...
export declare class FirstPartyAuthCredentialsProvider implements CredentialsProvider<User> ***REMOVED***
    private gapi;
...
export declare class AppCheckToken implements Token ***REMOVED***
    private value;
    type: TokenType;
    headers: Map<any, any>;
    constructor(value: string);
}
export declare class FirebaseAppCheckTokenProvider implements CredentialsProvider<string> ***REMOVED***
 ...
 * @internal
 */
export declare class EmptyAppCheckTokenProvider implements CredentialsProvider<string> ***REMOVED***
    getToken(): Promise<Token | null>;
    invalidateToken(): void;
    start(asyncQueue: AsyncQueue, changeListener: CredentialChangeListener<string>): void;
    shutdown(): void;
...
export declare class LiteAppCheckTokenProvider implements CredentialsProvider<string> ***REMOVED***
    private appCheckProvider;
    private appCheck;
    constructor(appCheckProvider: Provider<AppCheckInternalComponentName>);
    getToken(): Promise<Token | null>;
