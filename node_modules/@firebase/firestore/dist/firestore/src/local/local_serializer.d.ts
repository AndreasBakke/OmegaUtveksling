...
import ***REMOVED*** BundleMetadata, NamedQuery } from '../core/bundle';
...
import ***REMOVED*** FieldIndex, IndexOffset } from '../model/field_index';
import ***REMOVED*** MutationBatch } from '../model/mutation_batch';
import ***REMOVED*** Overlay } from '../model/overlay';
import ***REMOVED*** BundledQuery as ProtoBundledQuery, BundleMetadata as ProtoBundleMetadata, NamedQuery as ProtoNamedQuery } from '../protos/firestore_bundle_proto';
import ***REMOVED*** JsonProtoSerializer } from '../remote/serializer';
import ***REMOVED*** DbBundle, DbDocumentOverlay, DbIndexConfiguration, DbIndexState, DbMutationBatch, DbNamedQuery, DbRemoteDocument, DbTarget, DbTimestamp } from './indexeddb_schema';
import ***REMOVED*** DbDocumentOverlayKey, DbTimestampKey } from './indexeddb_sentinels';
import ***REMOVED*** TargetData } from './target_data';
/** Serializer for values stored in the LocalStore. */
export declare class LocalSerializer ***REMOVED***
