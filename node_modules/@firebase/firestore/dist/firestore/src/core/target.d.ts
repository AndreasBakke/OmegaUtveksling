...
import ***REMOVED*** Bound } from './bound';
import ***REMOVED*** Filter, FieldFilter } from './filter';
import ***REMOVED*** OrderBy } from './order_by';
/**
 ...
 * in persistence.
 */
export interface Target ***REMOVED***
...
export declare class TargetImpl implements Target ***REMOVED***
    readonly path: ResourcePath;
    readonly collectionGroup: string | null;
    readonly orderBy: OrderBy[];
    readonly filters: Filter[];
