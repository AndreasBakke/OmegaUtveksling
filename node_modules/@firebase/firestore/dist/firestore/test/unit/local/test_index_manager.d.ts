...
import ***REMOVED*** IndexManager, IndexType } from '../../../src/local/index_manager';
import ***REMOVED*** Persistence } from '../../../src/local/persistence';
import ***REMOVED*** DocumentMap } from '../../../src/model/collections';
import ***REMOVED*** DocumentKey } from '../../../src/model/document_key';
import ***REMOVED*** FieldIndex, IndexOffset } from '../../../src/model/field_index';
import ***REMOVED*** ResourcePath } from '../../../src/model/path';
/**
 * A wrapper around IndexManager that automatically creates a
 * transaction around every operation to reduce test boilerplate.
 */
export declare class TestIndexManager ***REMOVED***
