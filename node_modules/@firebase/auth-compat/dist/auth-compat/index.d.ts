...
declare module "@firebase/auth" ***REMOVED***
    ...
    function connectAuthEmulator(auth: types.FirebaseAuth, url: string, options?: ***REMOVED***
  ...
  ***REMOVED***): void;
    ...
    function updateProfile(user: types.User, ***REMOVED*** displayName, photoURL: photoUrl }: ***REMOVED***
