...
import ***REMOVED*** Wrapper } from './wrap';
export declare class Auth implements compat.FirebaseAuth, Wrapper<exp.Auth>, _FirebaseService ***REMOVED***
  ...
  ***REMOVED***;
    ...
    useEmulator(url: string, options?: ***REMOVED***
