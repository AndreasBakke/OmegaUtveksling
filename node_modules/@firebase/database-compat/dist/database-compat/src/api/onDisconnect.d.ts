 ...
 */
import ***REMOVED*** OnDisconnect as ModularOnDisconnect } from '@firebase/database';
import ***REMOVED*** Compat } from '@firebase/util';
export declare class OnDisconnect implements Compat<ModularOnDisconnect> ***REMOVED***
