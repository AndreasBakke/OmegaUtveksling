 ...
 */
import ***REMOVED*** FirebaseNamespace } from '@firebase/app-compat';
...
import ***REMOVED*** type DatabaseReference, type EmulatorMockTokenOptions, type DataSnapshot, type Database, type EventType, type Unsubscribe, type ListenOptions, type OnDisconnect, type ThenableReference, type QueryConstraint, type Query, type TransactionOptions, type TransactionResult } from "@firebase/database";
declare module "@firebase/database" ***REMOVED***
    function child(parent: types.Reference, path: string): DatabaseReference;
    function connectDatabaseEmulator(db: types.FirebaseDatabase, host: string, port: number, options?: ***REMOVED***
