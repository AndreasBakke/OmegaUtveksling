 ...
 */
import ***REMOVED*** DataSnapshot as ModularDataSnapshot, Query as ExpQuery, DatabaseReference as ModularReference } from '@firebase/database';
...
import ***REMOVED*** TransactionResult } from './TransactionResult';
/**
 * Class representing a firebase data snapshot.  It wraps a SnapshotNode and
 * surfaces the public methods (val, forEach, etc.) we want to expose.
 */
export declare class DataSnapshot implements Compat<ModularDataSnapshot> ***REMOVED***
...
export interface SnapshotCallback ***REMOVED***
 ...
 */
export declare class Query implements Compat<ExpQuery> ***REMOVED***
...
export declare class Reference extends Query implements Compat<ModularReference> ***REMOVED***
    readonly database: Database;
