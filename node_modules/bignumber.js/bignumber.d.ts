...
// Example:
//
//   import ***REMOVED***BigNumber} from "bignumber.js"
//   //import BigNumber from "bignumber.js"
//
//   let rm: BigNumber.RoundingMode = BigNumber.ROUND_UP;
//   let f: BigNumber.Format = ***REMOVED*** decimalSeparator: ',' };
//   let c: BigNumber.Config = ***REMOVED*** DECIMAL_PLACES: 4, ROUNDING_MODE: rm, FORMAT: f };
//   BigNumber.config(c);
//
...
export namespace BigNumber ***REMOVED***
  ...
  interface Config ***REMOVED***
     ...
     *
     * ```ts
     * BigNumber.config(***REMOVED*** DECIMAL_PLACES: 5 })
     * BigNumber.set(***REMOVED*** DECIMAL_PLACES: 5 })
     * ```
     */
     ...
     *
     * ```ts
     * BigNumber.config(***REMOVED*** ROUNDING_MODE: 0 })
     * BigNumber.set(***REMOVED*** ROUNDING_MODE: BigNumber.ROUND_UP })
     * ```
     */
     ...
     *
     * ```ts
     * BigNumber.config(***REMOVED*** EXPONENTIAL_AT: 2 })
     ...
     * BigNumber.config(***REMOVED*** EXPONENTIAL_AT: 0 })
     * ```
     *
     ...
     *
     * ```ts
     * BigNumber.config(***REMOVED*** RANGE: 500 })
     ...
     *
     * ```ts
     * BigNumber.config(***REMOVED*** MODULO_MODE: BigNumber.EUCLID })
     * BigNumber.set(***REMOVED*** MODULO_MODE: 9 })          // equivalent
     * ```
     */
     ...
     *
     * ```ts
     * BigNumber.config(***REMOVED*** POW_PRECISION: 100 })
     * ```
     */
...
export declare class BigNumber implements BigNumber.Instance ***REMOVED***
   ...
   *
   * ```ts
   * new BigNumber(***REMOVED*** s: 1, e: 2, c: [ 777, 12300000000000 ], _isBigNumber: true })    // '777.123'
   * ```
   *
   ...
   * ```
   *
   * @param ***REMOVED***BigNumber.RoundingMode} [rm] The roundng mode, an integer, 0 to 8.
   */
   ...
   * BN = BigNumber.clone()
   * BN.config(***REMOVED*** DECIMAL_PLACES: 9 })
   * ```
   *
   ...
   *
   * ```ts
   * BigNumber.config(***REMOVED*** DECIMAL_PLACES: 10 })
