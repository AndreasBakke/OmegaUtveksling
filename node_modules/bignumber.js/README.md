...
import ***REMOVED*** BigNumber } from "./node_modules/bignumber.js/bignumber.mjs";
```
...
```javascript
BigNumber.set(***REMOVED*** DECIMAL_PLACES: 10, ROUNDING_MODE: 4 })
...
BigNumber.set(***REMOVED*** DECIMAL_PLACES: 10 })

// Create another BigNumber constructor, optionally passing in a configuration object
BN = BigNumber.clone(***REMOVED*** DECIMAL_PLACES: 5 })
