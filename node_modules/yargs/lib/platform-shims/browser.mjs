...
import ***REMOVED***getProcessArgvBin} from '../../build/lib/utils/process-argv.js';
import ***REMOVED***YError} from '../../build/lib/yerror.js';
...
function sprintf(_str, ...args) ***REMOVED***
  ...
  split.forEach((token, i) => ***REMOVED***
    str += `$***REMOVED***token}$***REMOVED***split[i + 1] !== undefined && args[i] ? args[i] : ''}`;
***REMOVED***);
  return str;
}
