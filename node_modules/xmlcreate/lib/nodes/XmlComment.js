 ...
 *
 * A comment is structured as follows, where `***REMOVED***content}` is the text of the
 * comment:
 *
 * ```xml
 * <!--***REMOVED***content}-->
 * ```
 */
var XmlComment = /** @class */ (function () ***REMOVED***
    function XmlComment(parent, validation, options) ***REMOVED***
  ...
  ***REMOVED***
    Object.defineProperty(XmlComment.prototype, "charData", ***REMOVED***
        /**
      ...
      ***REMOVED***,
        ...
        set: function (charData) ***REMOVED***
          ...
          ***REMOVED***
            else if (this._validation && charData.indexOf("--") !== -1) ***REMOVED***
                throw new Error((0, error_1.getContext)(this.up()) + ": comment content"
                    + (" \"" + charData + "\" should not contain the string")
                    + " '--'");
          ***REMOVED***
            if (this._replaceInvalidCharsInCharData) ***REMOVED***
                if (charData.lastIndexOf("-") === charData.length - 1) ***REMOVED***
                    charData = charData.substr(0, charData.length - 1) + "\uFFFD";
              ***REMOVED***
          ***REMOVED***
            else if (this._validation
                && charData.lastIndexOf("-") === charData.length - 1) ***REMOVED***
                throw new Error((0, error_1.getContext)(this.up()) + ": comment content"
  ...
  ***REMOVED***);
     ...
     */
    XmlComment.prototype.toString = function () ***REMOVED***
        return "<!--" + this._charData + "-->";
  ***REMOVED***;
    /**
     * Returns the parent of this comment.
     */
    XmlComment.prototype.up = function () ***REMOVED***
        return this._parent;
  ***REMOVED***;
    return XmlComment;
}());
