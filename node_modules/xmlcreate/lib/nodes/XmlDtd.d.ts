 ...
 */
import ***REMOVED*** IStringOptions } from "../options";
import XmlComment, ***REMOVED*** IXmlCommentOptions } from "./XmlComment";
import XmlDtdAttlist, ***REMOVED*** IXmlDtdAttlistOptions } from "./XmlDtdAttlist";
import XmlDtdElement, ***REMOVED*** IXmlDtdElementOptions } from "./XmlDtdElement";
import XmlDtdEntity, ***REMOVED*** IXmlDtdEntityOptions } from "./XmlDtdEntity";
import XmlDtdNotation, ***REMOVED*** IXmlDtdNotationOptions } from "./XmlDtdNotation";
import ***REMOVED*** default as XmlDtdParamEntityRef, IXmlDtdParamEntityRefOptions } from "./XmlDtdParamEntityRef";
import XmlProcInst, ***REMOVED*** IXmlProcInstOptions } from "./XmlProcInst";
/**
 * The options used to create a new document type definition.
 */
export interface IXmlDtdOptions ***REMOVED***
    /**
     * The name of the DTD.
     */
    name: string;
 ...
 */
export default class XmlDtd<Parent> ***REMOVED***
