 ...
 */
export interface IXmlCharRefOptions ***REMOVED***
    /**
 ...
 *
 * A character reference is structured as follows, where `***REMOVED***dec}` is the
 ...
 * `***REMOVED***hex}` is the hexadecimal representation code point corresponding to a
 ...
 *
 * The `***REMOVED***dec}` and `***REMOVED***hex}` values are defined by the `char` and `hex`
 ...
 * should be used.
 */
export default class XmlCharRef<Parent> ***REMOVED***
