 ...
 */
export interface IXmlEntityRefOptions ***REMOVED***
    /**
 ...
 *
 * An entity reference is structured as follows, where `***REMOVED***name}` is the name of
 ...
 * ```
 */
export default class XmlEntityRef<Parent> ***REMOVED***
