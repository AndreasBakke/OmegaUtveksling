 ...
 *
 * An element declaration is structured as follows, where `***REMOVED***text}` is the
 ...
 * ```
 */
var XmlDtdElement = /** @class */ (function () ***REMOVED***
    function XmlDtdElement(parent, validation, options) ***REMOVED***
        this._validation = validation;
        this._parent = parent;
        this.charData = options.charData;
  ***REMOVED***
    Object.defineProperty(XmlDtdElement.prototype, "charData", ***REMOVED***
        /**
  ...
  ***REMOVED***);
     ...
     */
    XmlDtdElement.prototype.toString = function () ***REMOVED***
        return "<!ELEMENT " + this._charData + ">";
  ***REMOVED***;
    /**
     * Returns the parent of this element declaration.
     */
    XmlDtdElement.prototype.up = function () ***REMOVED***
        return this._parent;
  ***REMOVED***;
