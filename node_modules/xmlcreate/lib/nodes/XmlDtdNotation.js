 ...
 *
 * A notation declaration is structured as follows, where `***REMOVED***text}` is the
 * text of the declaration:
 *
 * ```xml
 * <!NOTATION ***REMOVED***text}>
 * ```
 */
var XmlDtdNotation = /** @class */ (function () ***REMOVED***
    function XmlDtdNotation(parent, validation, options) ***REMOVED***
        this._validation = validation;
        this._parent = parent;
        this.charData = options.charData;
  ***REMOVED***
    Object.defineProperty(XmlDtdNotation.prototype, "charData", ***REMOVED***
        /**
      ...
      ***REMOVED***,
        ...
        set: function (charData) ***REMOVED***
            if (this._validation && !(0, validate_1.validateChar)(charData)) ***REMOVED***
  ...
  ***REMOVED***);
     ...
     */
    XmlDtdNotation.prototype.toString = function () ***REMOVED***
        return "<!NOTATION " + this._charData + ">";
  ***REMOVED***;
    /**
     * Returns the parent of this notation declaration.
     */
    XmlDtdNotation.prototype.up = function () ***REMOVED***
        return this._parent;
  ***REMOVED***;
