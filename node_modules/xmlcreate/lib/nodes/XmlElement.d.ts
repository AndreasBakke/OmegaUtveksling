...
import ***REMOVED*** default as XmlAttribute, IXmlAttributeOptions as IXmlAttributeOptions } from "./XmlAttribute";
import XmlCdata, ***REMOVED*** IXmlCdataOptions } from "./XmlCdata";
import XmlCharData, ***REMOVED*** IXmlCharDataOptions } from "./XmlCharData";
import XmlCharRef, ***REMOVED*** IXmlCharRefOptions } from "./XmlCharRef";
import XmlComment, ***REMOVED*** IXmlCommentOptions } from "./XmlComment";
import XmlEntityRef, ***REMOVED*** IXmlEntityRefOptions } from "./XmlEntityRef";
import XmlProcInst, ***REMOVED*** IXmlProcInstOptions } from "./XmlProcInst";
/**
 * The options used to create a new element.
 */
export interface IXmlElementOptions ***REMOVED***
    /**
 ...
 * ```
 */
export default class XmlElement<Parent> ***REMOVED***
