 ...
 *
 * An attribute-list declaration is structured as follows, where `***REMOVED***text}`
 * is the text of the declaration:
 *
 * ```xml
 * <!ATTLIST ***REMOVED***text}>
 * ```
 */
var XmlDtdAttlist = /** @class */ (function () ***REMOVED***
    function XmlDtdAttlist(parent, validation, options) ***REMOVED***
        this._validation = validation;
        this._parent = parent;
        this.charData = options.charData;
  ***REMOVED***
    Object.defineProperty(XmlDtdAttlist.prototype, "charData", ***REMOVED***
        /**
  ...
  ***REMOVED***);
     ...
     */
    XmlDtdAttlist.prototype.toString = function () ***REMOVED***
        return "<!ATTLIST " + this._charData + ">";
  ***REMOVED***;
    /**
     * Returns the parent of this entity declaration.
     */
    XmlDtdAttlist.prototype.up = function () ***REMOVED***
        return this._parent;
  ***REMOVED***;
