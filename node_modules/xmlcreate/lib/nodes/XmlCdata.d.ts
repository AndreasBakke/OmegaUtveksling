 ...
 */
export interface IXmlCdataOptions ***REMOVED***
    /**
 ...
 *
 * A CDATA section is structured as follows, where `***REMOVED***data}` is the
 ...
 * ```
 */
export default class XmlCdata<Parent> ***REMOVED***
