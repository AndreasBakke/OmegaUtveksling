 ...
 */
export interface IXmlDtdParamEntityRefOptions ***REMOVED***
    /**
 ...
 *
 * A parameter entity reference is structured as follows, where `***REMOVED***entity}`
 ...
 * ```
 */
export default class XmlDtdParamEntityRef<Parent> ***REMOVED***
