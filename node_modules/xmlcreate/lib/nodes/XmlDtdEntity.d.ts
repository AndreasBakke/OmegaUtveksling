 ...
 */
export interface IXmlDtdEntityOptions ***REMOVED***
    /**
 ...
 *
 * An entity declaration is structured as follows, where `***REMOVED***text}` is the
 ...
 * ```
 */
export default class XmlDtdEntity<Parent> ***REMOVED***
