 ...
 */
function validateChar(str) ***REMOVED***
    for (var i = 0; i < str.length; i++) ***REMOVED***
        ...
        if (firstChar === 0x9 || firstChar === 0xA || firstChar === 0xD
            ...
            || (firstChar >= 0xE000 && firstChar <= 0xFFFD)) ***REMOVED***
            continue;
      ***REMOVED***
      ...
      ***REMOVED***
        ...
        if ((firstChar >= 0xD800 && firstChar <= 0xDBFF)
            && (secondChar >= 0xDC00 && secondChar <= 0xDFFF)) ***REMOVED***
            i++;
            continue;
      ***REMOVED***
        return false;
 ...
 */
function validateSingleChar(str) ***REMOVED***
 ...
 */
function validateName(str) ***REMOVED***
    if (str.length === 0) ***REMOVED***
        return false;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (!initialFirstCharMatch && !initialSecondCharMatch) ***REMOVED***
        return false;
  ***REMOVED***
    var start = initialSecondCharMatch ? 2 : 1;
    for (var i = start; i < str.length; i++) ***REMOVED***
        var firstChar = str.charCodeAt(i);
        if (firstChar === 0x3A
            || firstChar === 0x5F
            || firstChar === 0x2D
            ...
            || (firstChar >= 0xFDF0 && firstChar <= 0xFFFD)) ***REMOVED***
            continue;
      ***REMOVED***
        if (i + 1 === str.length) ***REMOVED***
            return false;
...
function fixName(str) ***REMOVED***
  ...
  ***REMOVED***
    ...
    var initialFirstCharMatch = (initialFirstChar === 0x3A
        ...
        || (initialFirstChar >= 0xFDF0 && initialFirstChar <= 0xFFFD));
    if (str.length === 1) ***REMOVED***
        if (initialFirstCharMatch) ***REMOVED***
            newStr = str[0];
      ***REMOVED***
        else ***REMOVED***
            newStr = "\uFFFD";
  ...
  ***REMOVED***
    ...
    var initialSecondCharMatch = ((initialFirstChar >= 0xD800 && initialFirstChar <= 0xDB7F)
        && (initialSecondChar >= 0xDC00 && initialSecondChar <= 0xDFFF));
    if (initialSecondCharMatch) ***REMOVED***
        newStr = str[0] + str[1];
  ***REMOVED***
    else if (initialFirstCharMatch) ***REMOVED***
        newStr = str[0];
  ***REMOVED***
    else ***REMOVED***
        newStr = "\uFFFD";
