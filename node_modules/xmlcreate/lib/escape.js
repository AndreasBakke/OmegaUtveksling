 ...
 */
function escapeAmpersands(str) ***REMOVED***
 ...
 * reference.
 */
function escapeLeftAngleBrackets(str) ***REMOVED***
    return str.replace(/</g, "&lt;");
}
 ...
 */
function escapeRightAngleBracketsInCdataTerminator(str) ***REMOVED***
    return str.replace(/]]>/g, "]]&gt;");
}
 ...
 */
function escapeSingleQuotes(str) ***REMOVED***
    return str.replace(/'/g, "&apos;");
}
 ...
 */
function escapeDoubleQuotes(str) ***REMOVED***
    return str.replace(/"/g, "&quot;");
}
