 ...
 */
function getContext(obj) ***REMOVED***
    if (obj instanceof XmlAttribute_1.default) ***REMOVED***
        return getContext(obj.up()) + (" > attribute \"" + obj.name + "\"");
  ***REMOVED***
    else if (obj instanceof XmlDocument_1.default) ***REMOVED***
        return "in XML document";
  ***REMOVED***
    else if (obj instanceof XmlDtd_1.default) ***REMOVED***
        return getContext(obj.up()) + " > DTD";
  ***REMOVED***
    else if (obj instanceof XmlElement_1.default) ***REMOVED***
