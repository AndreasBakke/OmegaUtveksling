 ...
 *
 * @param ***REMOVED***Object} params - the request header parameters.
 * @return ***REMOVED***string} the routing header value.
 */
export declare function fromParams(params: ***REMOVED***
