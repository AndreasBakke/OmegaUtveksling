...
})(Status = exports.Status || (exports.Status = ***REMOVED***}));
...
function rpcCodeFromHttpStatusCode(httpStatusCode) ***REMOVED***
    if (exports.HttpCodeToRpcCodeMap.has(httpStatusCode)) ***REMOVED***
        return exports.HttpCodeToRpcCodeMap.get(httpStatusCode);
  ***REMOVED***
    // All 2xx
    if (httpStatusCode >= 200 && httpStatusCode < 300) ***REMOVED***
        return Status.OK;
  ***REMOVED***
    // All other 4xx
    if (httpStatusCode >= 400 && httpStatusCode < 500) ***REMOVED***
        return Status.FAILED_PRECONDITION;
  ***REMOVED***
    // All other 5xx
    if (httpStatusCode >= 500 && httpStatusCode < 600) ***REMOVED***
