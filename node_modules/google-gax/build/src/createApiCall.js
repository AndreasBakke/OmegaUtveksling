...
_fallback // unused here, used in fallback.ts implementation
    ...
    return (request, callOptions, callback) => ***REMOVED***
        ...
        if (settings.isBundling && !thisSettings.isBundling) ***REMOVED***
