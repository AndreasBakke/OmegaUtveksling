 ...
 */
import ***REMOVED*** JSONObject, JSONValue } from 'proto3-json-serializer';
import ***REMOVED*** Field } from 'protobufjs';
import ***REMOVED*** google } from '../protos/http';
export interface TranscodedRequest ***REMOVED***
...
export declare type ParsedOptionsType = Array<***REMOVED***
    [httpOptionName]?: google.api.IHttpRule;
} & ***REMOVED***
    [option in allowedOptions]?: ***REMOVED***} | string | number;
}>;
