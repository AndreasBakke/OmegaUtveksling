 ...
 */
import ***REMOVED*** APICallback, GRPCCallResult, SimpleCallbackFunction } from '../apitypes';
export interface SubResponseInfo ***REMOVED***
    field: string;
    start?: number;
    end?: number;
}
export interface TaskData ***REMOVED***
    elements: ***REMOVED***}[];
    bytes: number;
    callback: TaskCallback;
    cancelled?: boolean;
}
export interface TaskCallback extends APICallback ***REMOVED***
    id?: string;
}
/**
...
export declare class Task ***REMOVED***
    _apiCall: SimpleCallbackFunction;
    _request: ***REMOVED***
        [index: string]: ***REMOVED***}[];
  ***REMOVED***;
     ...
     */
    extend(elements: ***REMOVED***}[], bytes: number, callback: TaskCallback): void;
    /**
