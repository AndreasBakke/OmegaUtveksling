 ...
 */
import ***REMOVED*** RequestType } from '../apitypes';
/**
 * Compute the identifier of the `obj`. The objects of the same ID
 * will be bundled together.
 *
 * @param ***REMOVED***RequestType} obj - The request object.
 * @param ***REMOVED***String[]} discriminatorFields - The array of field names.
 *   A field name may include '.' as a separator, which is used to
 *   indicate object traversal.
 * @return ***REMOVED***String|undefined} - the identifier string, or undefined if any
