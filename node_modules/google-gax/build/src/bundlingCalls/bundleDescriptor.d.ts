...
import ***REMOVED*** CallSettings } from '../gax';
import ***REMOVED*** NormalApiCaller } from '../normalCalls/normalApiCaller';
import ***REMOVED*** BundleApiCaller } from './bundleApiCaller';
/**
 * A descriptor for calls that can be bundled into one call.
 */
export declare class BundleDescriptor implements Descriptor ***REMOVED***
    bundledField: string;
     ...
     *
     * @property ***REMOVED***String} bundledField
     * @property ***REMOVED***String} requestDiscriminatorFields
     * @property ***REMOVED***String} subresponseField
     * @property ***REMOVED***Function} byteLengthFunction
     *
     * @param ***REMOVED***String} bundledField - the repeated field in the request message
     *   that will have its elements aggregated by bundling.
     * @param ***REMOVED***String} requestDiscriminatorFields - a list of fields in the
     *   target request message class that are used to detemrine which request
     *   messages should be bundled together.
     * @param ***REMOVED***String} subresponseField - an optional field, when present it
     ...
     * @param ***REMOVED***Function} byteLengthFunction - a function to obtain the byte
