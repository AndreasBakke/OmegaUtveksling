...
/// <reference types="node" />
import ***REMOVED*** AbortController as NodeAbortController } from 'abort-controller';
import ***REMOVED*** Transform } from 'stream';
export declare class StreamArrayParser extends Transform ***REMOVED***
    private _done;
    private _prevBlock;
    private _isInString;
    private _isSkipped;
     ...
     */
    constructor(rpc: protobuf.Method, options?: ***REMOVED***});
