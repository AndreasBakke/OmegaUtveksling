...
class PagedApiCaller ***REMOVED***
    /**
     * Creates an API caller that returns a stream to performs page-streaming.
     *
     * @private
     * @constructor
     * @param ***REMOVED***PageDescriptor} pageDescriptor - indicates the structure
     *   of page streaming to be performed.
     */
    constructor(pageDescriptor) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    generateParseResponseCallback(request, callback) ***REMOVED***
        ...
        return (err, response) => ***REMOVED***
          ...
          ***REMOVED***
            ...
            if (pageToken) ***REMOVED***
                nextPageRequest = Object.assign(***REMOVED***}, request);
  ...
  ***REMOVED***
    ...
    wrap(func) ***REMOVED***
        ...
        const self = this;
        return function wrappedCall(argument, metadata, options, callback) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    call(apiCall, request, settings, ongoingCall) ***REMOVED***
        request = Object.assign(***REMOVED***}, request);
  ...
  ***REMOVED***
    fail(ongoingCall, err) ***REMOVED***
        ongoingCall.callback(err);
  ***REMOVED***
    result(ongoingCall) ***REMOVED***
