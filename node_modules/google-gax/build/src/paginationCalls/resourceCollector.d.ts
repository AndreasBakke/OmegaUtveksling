 ...
 */
import ***REMOVED*** SimpleCallbackFunction, RequestType } from '../apitypes';
/**
 ...
 */
export declare class ResourceCollector ***REMOVED***
    apiCall: SimpleCallbackFunction;
    resources: Array<***REMOVED***}>;
    maxResults: number;
    resolveCallback?: (resources: Array<***REMOVED***}>) => void;
    rejectCallback?: (err: Error) => void;
    constructor(apiCall: SimpleCallbackFunction, maxResults?: number);
    private callback;
    processAllPages(firstRequest: RequestType): Promise<Array<***REMOVED***}>>;
}
