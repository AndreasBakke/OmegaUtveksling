...
message ConsumerQuotaMetric ***REMOVED***
...
message ConsumerQuotaLimit ***REMOVED***
  ...
  // `1/***REMOVED***project}/***REMOVED***region}`
  // Note that `***REMOVED***project}` and `***REMOVED***region}` are not placeholders in this example;
  // the literal characters `***REMOVED***` and `}` occur in the string.
  string unit = 2;
...
message QuotaOverride ***REMOVED***
  ...
  //
  // For example, an override on a limit with the unit `1/***REMOVED***project}/***REMOVED***region}`
  ...
  //     Any string appearing in `***REMOVED***brackets}` in the unit (besides `***REMOVED***project}`
  //     or
  //     `***REMOVED***user}`) is a defined key.
...
message OverrideInlineSource ***REMOVED***
...
message AdminQuotaPolicy ***REMOVED***
  ...
  // for dimensions defined in the limit unit.
  //
  // For example, an policy on a limit with the unit `1/***REMOVED***project}/***REMOVED***region}`
  // could contain an entry with the key `region` and the value `us-east-1`;
  ...
  // format is `***REMOVED***container_type}/***REMOVED***container_number}`
  string container = 6;
}

// Service identity for a service. This is the identity that service producer
// should use to access consumer resources.
message ServiceIdentity ***REMOVED***
