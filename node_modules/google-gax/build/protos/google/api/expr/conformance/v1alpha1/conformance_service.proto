...
// and other utilities.
service ConformanceService ***REMOVED***
  option (google.api.default_host) = "cel.googleapis.com";

  // Transforms CEL source text into a parsed representation.
  rpc Parse(ParseRequest) returns (ParseResponse) ***REMOVED***
***REMOVED***
...
***REMOVED***
  ...
  rpc Eval(EvalRequest) returns (EvalResponse) ***REMOVED***
***REMOVED***
}

// Request message for the Parse method.
message ParseRequest ***REMOVED***
