...
message Type ***REMOVED***
  ...
  message ListType ***REMOVED***
    // The element type.
    Type elem_type = 1;
***REMOVED***

  // Map type with parameterized key and value types, e.g. `map<string, int>`.
  message MapType ***REMOVED***
    // The type of the key.
    Type key_type = 1;
