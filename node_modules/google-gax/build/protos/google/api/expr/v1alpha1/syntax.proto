...
message Expr ***REMOVED***
  // An identifier expression. e.g. `request`.
  message Ident ***REMOVED***
...
***REMOVED***
  ...
  //
  // Maps are constructed as `***REMOVED***'key_name': 'value'}`. Message construction is
  // similar, but prefixed with a type name and composed of field ids:
  // `types.MyType***REMOVED***field_id: 'value'}`.
  message CreateStruct ***REMOVED***
    // Represents an entry.
...
message SourcePosition ***REMOVED***
