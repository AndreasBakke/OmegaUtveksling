...
message Key ***REMOVED***
  option (google.api.resource) = ***REMOVED***
    ...
    pattern: "projects/***REMOVED***project}/locations/***REMOVED***location}/keys/***REMOVED***key}"
    plural: "keys"
    singular: "key"
...
message Restrictions ***REMOVED***
  ...
  oneof client_restrictions ***REMOVED***
...
// The HTTP referrers (websites) that are allowed to use the key.
message BrowserKeyRestrictions ***REMOVED***
...
// The IP addresses of callers that are allowed to use the key.
message ServerKeyRestrictions ***REMOVED***
...
// The Android apps that are allowed to use the key.
message AndroidKeyRestrictions ***REMOVED***
...
message AndroidApplication ***REMOVED***
...
// The iOS apps that are allowed to use the key.
message IosKeyRestrictions ***REMOVED***
