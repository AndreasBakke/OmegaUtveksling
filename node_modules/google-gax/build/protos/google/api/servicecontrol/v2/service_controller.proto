...
service ServiceController ***REMOVED***
  ...
  rpc Check(CheckRequest) returns (CheckResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2/services/***REMOVED***service_name}:check"
      body: "*"
  ***REMOVED***;
***REMOVED***
  ...
  rpc Report(ReportRequest) returns (ReportResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v2/services/***REMOVED***service_name}:report"
      body: "*"
  ***REMOVED***;
***REMOVED***
}
...
message ResourceInfo ***REMOVED***
  ...
  // The resource type in the format of "***REMOVED***service}/***REMOVED***kind}".
  string type = 2;

  // The resource permission needed for this request.
  // The format must be "***REMOVED***service}/***REMOVED***plural}.***REMOVED***verb}".
  string permission = 3;
