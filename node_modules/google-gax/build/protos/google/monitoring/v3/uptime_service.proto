...
service UptimeCheckService ***REMOVED***
  ...
  rpc ListUptimeCheckConfigs(ListUptimeCheckConfigsRequest)
      returns (ListUptimeCheckConfigsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v3/***REMOVED***parent=projects/*}/uptimeCheckConfigs"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc GetUptimeCheckConfig(GetUptimeCheckConfigRequest)
      returns (UptimeCheckConfig) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v3/***REMOVED***name=projects/*/uptimeCheckConfigs/*}"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc CreateUptimeCheckConfig(CreateUptimeCheckConfigRequest)
      returns (UptimeCheckConfig) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v3/***REMOVED***parent=projects/*}/uptimeCheckConfigs"
...
***REMOVED***
  ...
  rpc UpdateUptimeCheckConfig(UpdateUptimeCheckConfigRequest)
      returns (UptimeCheckConfig) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      patch: "/v3/***REMOVED***uptime_check_config.name=projects/*/uptimeCheckConfigs/*}"
      body: "uptime_check_config"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc DeleteUptimeCheckConfig(DeleteUptimeCheckConfigRequest)
    ...
    option (google.api.http) = ***REMOVED***
      delete: "/v3/***REMOVED***name=projects/*/uptimeCheckConfigs/*}"
  ***REMOVED***;
    option (google.api.method_signature) = "name";
***REMOVED***
  ...
  rpc ListUptimeCheckIps(ListUptimeCheckIpsRequest)
      returns (ListUptimeCheckIpsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
