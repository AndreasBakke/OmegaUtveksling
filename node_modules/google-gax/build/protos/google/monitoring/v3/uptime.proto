...
message UptimeCheckConfig ***REMOVED***
  option (google.api.resource) = ***REMOVED***
    ...
    pattern: "projects/***REMOVED***project}/uptimeCheckConfigs/***REMOVED***uptime_check_config}"
    pattern: "organizations/***REMOVED***organization}/uptimeCheckConfigs/***REMOVED***uptime_check_config}"
    pattern: "folders/***REMOVED***folder}/uptimeCheckConfigs/***REMOVED***uptime_check_config}"
    pattern: "*"
***REMOVED***;
...
***REMOVED***
  ...
  message ContentMatcher ***REMOVED***
    ...
    enum ContentMatcherOption ***REMOVED***
