...
service QueryService ***REMOVED***
  ...
  rpc QueryTimeSeries(QueryTimeSeriesRequest) returns (QueryTimeSeriesResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v3/***REMOVED***name=projects/*}/timeSeries:query"
      body: "*"
  ***REMOVED***;
***REMOVED***
}
