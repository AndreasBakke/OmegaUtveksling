...
message Service ***REMOVED***
  option (google.api.resource) = ***REMOVED***
    type: "monitoring.googleapis.com/Service"
    pattern: "projects/***REMOVED***project}/services/***REMOVED***service}"
    pattern: "organizations/***REMOVED***organization}/services/***REMOVED***service}"
    pattern: "folders/***REMOVED***folder}/services/***REMOVED***service}"
    pattern: "*"
***REMOVED***;

  // Custom view of service telemetry. Currently a place-holder pending final
  // design.
  message Custom ***REMOVED***

***REMOVED***

  // App Engine service. Learn more at https://cloud.google.com/appengine.
  message AppEngine ***REMOVED***
...
***REMOVED***
  ...
  message CloudEndpoints ***REMOVED***
...
***REMOVED***
  ...
  message IstioCanonicalService ***REMOVED***
...
message ServiceLevelObjective ***REMOVED***
  option (google.api.resource) = ***REMOVED***
    type: "monitoring.googleapis.com/ServiceLevelObjective"
    pattern: "projects/***REMOVED***project}/services/***REMOVED***service}/serviceLevelObjectives/***REMOVED***service_level_objective}"
    pattern: "organizations/***REMOVED***organization}/services/***REMOVED***service}/serviceLevelObjectives/***REMOVED***service_level_objective}"
    pattern: "folders/***REMOVED***folder}/services/***REMOVED***service}/serviceLevelObjectives/***REMOVED***service_level_objective}"
    pattern: "*"
...
// fast-enough queries.
message ServiceLevelIndicator ***REMOVED***
...
// this service.
message BasicSli ***REMOVED***
  // Future parameters for the availability SLI.
  message AvailabilityCriteria ***REMOVED***

***REMOVED***

  // Parameters for a latency threshold SLI.
  message LatencyCriteria ***REMOVED***
...
// directly.
message RequestBasedSli ***REMOVED***
...
message TimeSeriesRatio ***REMOVED***
...
message DistributionCut ***REMOVED***
  // A [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
...
message WindowsBasedSli ***REMOVED***
  // A `PerformanceThreshold` is used when each window is good when that window
  // has a sufficiently high `performance`.
  message PerformanceThreshold ***REMOVED***
...
***REMOVED***
  ...
  oneof window_criterion ***REMOVED***
    // A [monitoring filter](https://cloud.google.com/monitoring/api/v3/filters)
