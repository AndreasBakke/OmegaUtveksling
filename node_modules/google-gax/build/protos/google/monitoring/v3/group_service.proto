...
service GroupService ***REMOVED***
  ...
  rpc ListGroups(ListGroupsRequest) returns (ListGroupsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v3/***REMOVED***name=projects/*}/groups"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc CreateGroup(CreateGroupRequest) returns (Group) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v3/***REMOVED***name=projects/*}/groups"
      body: "group"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc UpdateGroup(UpdateGroupRequest) returns (Group) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      put: "/v3/***REMOVED***group.name=projects/*/groups/*}"
      body: "group"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc DeleteGroup(DeleteGroupRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      delete: "/v3/***REMOVED***name=projects/*/groups/*}"
  ***REMOVED***;
    option (google.api.method_signature) = "name";
***REMOVED***
  ...
  rpc ListGroupMembers(ListGroupMembersRequest) returns (ListGroupMembersResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v3/***REMOVED***name=projects/*/groups/*}/members"
  ***REMOVED***;
    option (google.api.method_signature) = "name";
***REMOVED***
}
...
message ListGroupsRequest ***REMOVED***
  ...
  ***REMOVED***
  ...
  oneof filter ***REMOVED***
    ...
    string children_of_group = 2 [(google.api.resource_reference) = ***REMOVED***
    ...
    string ancestors_of_group = 3 [(google.api.resource_reference) = ***REMOVED***
                                     type: "monitoring.googleapis.com/Group"
                                 ***REMOVED***];
    ...
    string descendants_of_group = 4 [(google.api.resource_reference) = ***REMOVED***
                                       type: "monitoring.googleapis.com/Group"
                                   ***REMOVED***];
***REMOVED***
