...
function static_target(root, options, callback) ***REMOVED***
    ...
    try ***REMOVED***
        ...
        if (aliases.length) ***REMOVED***
            if (config.comments)
                push("// Common aliases");
            push((config.es6 ? "const " : "var ") + aliases.map(function(name) ***REMOVED*** return "$" + name + " = $protobuf." + name; }).join(", ") + ";");
            push("");
      ***REMOVED***
      ...
      ***REMOVED***
        ...
        push((config.es6 ? "const" : "var") + " $root = $protobuf.roots" + rootProp + " || ($protobuf.roots" + rootProp + " = ***REMOVED***});");
...
function buildNamespace(ref, ns) ***REMOVED***
  ...
  ***REMOVED*** else if (ns instanceof Service)
        ...
        push((config.es6 ? "const" : "var") + " " + escapeName(ns.name) + " = ***REMOVED***};");
  ***REMOVED***
...
function buildFunction(type, functionName, gen, scope) ***REMOVED***
  ...
  ***REMOVED***);
    if (isCtor)
        ...
        push("};})(" + Object.keys(scope).map(function(key) ***REMOVED*** return scope[key]; }).join(", ") + ");");
    else
        push("};");
}
...
function buildType(ref, type) ***REMOVED***
    ...
    if (config.comments) ***REMOVED***
        ...
        type.fieldsArray.forEach(function(field) ***REMOVED***
            ...
            if (field.optional)
                jsType = jsType + "|null";
            typeDef.push("@property ***REMOVED***" + jsType + "} " + (field.optional ? "[" + prop + "]" : prop) + " " + (field.comment || type.name + " " + field.name));
      ***REMOVED***);
        push("");
        pushComment(typeDef);
  ***REMOVED***
    ...
    pushComment([
        ...
        "@constructor",
        "@param ***REMOVED***" + exportName(type, true) + "=} [" + (config.beautify ? "properties" : "p") + "] Properties to set"
    ]);
    ...
    type.fieldsArray.forEach(function(field) ***REMOVED***
        ...
        if (config.comments) ***REMOVED***
            ...
            pushComment([
                ...
                "@member ***REMOVED***" + jsType + "} " + field.name,
    ...
    type.oneofsArray.forEach(function(oneof) ***REMOVED***
      ...
      ***REMOVED***
        ...
        pushComment([
            ...
            "@member ***REMOVED***" + oneof.oneof.map(JSON.stringify).join("|") + "|undefined} " + escapeName(oneof.name),
            "@memberof " + exportName(type),
            "@instance"
        ]);
  ...
  ***REMOVED***);
    ...
    if (config.create) ***REMOVED***
        ...
        pushComment([
            ...
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***" + exportName(type, true) + "=} [properties] Properties to set",
            "@returns ***REMOVED***" + exportName(type) + "} " + type.name + " instance"
        ]);
  ...
  ***REMOVED***
    ...
    if (config.encode) ***REMOVED***
        push("");
        pushComment([
            "Encodes the specified " + type.name + " message. Does not implicitly ***REMOVED***@link " + exportName(type) + ".verify|verify} messages.",
            "@function encode",
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***" + exportName(type, !config.forceMessage) + "} " + (config.beautify ? "message" : "m") + " " + type.name + " message or plain object to encode",
            "@param ***REMOVED***$protobuf.Writer} [" + (config.beautify ? "writer" : "w") + "] Writer to encode to",
        ...
        if (config.delimited) ***REMOVED***
            push("");
            pushComment([
                "Encodes the specified " + type.name + " message, length delimited. Does not implicitly ***REMOVED***@link " + exportName(type) + ".verify|verify} messages.",
                "@function encodeDelimited",
                "@memberof " + exportName(type),
                "@static",
                "@param ***REMOVED***" + exportName(type, !config.forceMessage) + "} message " + type.name + " message or plain object to encode",
  ...
  ***REMOVED***
    ...
    if (config.decode) ***REMOVED***
        ...
        pushComment([
            ...
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***$protobuf.Reader|Uint8Array} " + (config.beautify ? "reader" : "r") + " Reader or buffer to decode from",
            "@param ***REMOVED***number} [" + (config.beautify ? "length" : "l") + "] Message length if known beforehand",
            "@returns ***REMOVED***" + exportName(type) + "} " + type.name,
  ...
  ***REMOVED***
    ...
    if (config.verify) ***REMOVED***
        ...
        pushComment([
            ...
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***Object.<string,*>} " + (config.beautify ? "message" : "m") + " Plain object to verify",
  ...
  ***REMOVED***
    ...
    if (config.convert) ***REMOVED***
        ...
        pushComment([
            ...
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***Object.<string,*>} " + (config.beautify ? "object" : "d") + " Plain object",
            "@returns ***REMOVED***" + exportName(type) + "} " + type.name
        ]);
        ...
        pushComment([
            ...
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***" + exportName(type) + "} " + (config.beautify ? "message" : "m") + " " + type.name,
            "@param ***REMOVED***$protobuf.IConversionOptions} [" + (config.beautify ? "options" : "o") + "] Conversion options",
  ...
  ***REMOVED***
    ...
    if (config.typeurl) ***REMOVED***
        ...
        pushComment([
            ...
            "@memberof " + exportName(type),
            "@static",
            "@param ***REMOVED***string} [typeUrlPrefix] your custom typeUrlPrefix(default \"type.googleapis.com\")",
            "@returns ***REMOVED***string} The default type url"
        ]);
        push(escapeName(type.name) + ".getTypeUrl = function getTypeUrl(typeUrlPrefix) ***REMOVED***");
        ++indent;
            push("if (typeUrlPrefix === undefined) ***REMOVED***");
            ++indent;
...
function buildService(ref, service) ***REMOVED***
    ...
    if (config.create) ***REMOVED***
        ...
        pushComment([
            ...
            "@param ***REMOVED***boolean} [requestDelimited=false] Whether requests are length-delimited",
            "@param ***REMOVED***boolean} [responseDelimited=false] Whether responses are length-delimited",
            "@returns ***REMOVED***" + escapeName(service.name) + "} RPC service. Useful where requests and/or responses are streamed."
        ]);
  ...
  ***REMOVED***
    ...
    service.methodsArray.forEach(function(method) ***REMOVED***
        ...
        push("");
        pushComment([
            "Callback as used by ***REMOVED***@link " + exportName(service) + "#" + escapeName(lcName) + "}.",
            ...
            "@param ***REMOVED***" + exportName(method.resolvedResponseType) + "} [response] " + method.resolvedResponseType.name
        ]);
        push("");
        pushComment([
            ...
            "@memberof " + exportName(service),
            "@instance",
            "@param ***REMOVED***" + exportName(method.resolvedRequestType, !config.forceMessage) + "} request " + method.resolvedRequestType.name + " message or plain object",
            "@param ***REMOVED***" + exportName(service) + "." + cbName + "} callback Node-style callback called with the error, if any, and " + method.resolvedResponseType.name,
            "@returns ***REMOVED***undefined}",
            "@variation 1"
        ]);
        push("Object.defineProperty(" + escapeName(service.name) + ".prototype" + util.safeProp(lcName) + " = function " + escapeName(lcName) + "(request, callback) ***REMOVED***");
            ++indent;
            push("return this.rpcCall(" + escapeName(lcName) + ", $root." + exportName(method.resolvedRequestType) + ", $root." + exportName(method.resolvedResponseType) + ", request, callback);");
            --indent;
        push("}, \"name\", ***REMOVED*** value: " + JSON.stringify(method.name) + " });");
        if (config.comments)
            push("");
        pushComment([
            method.comment || "Calls " + method.name + ".",
            ...
            "@instance",
            "@param ***REMOVED***" + exportName(method.resolvedRequestType, !config.forceMessage) + "} request " + method.resolvedRequestType.name + " message or plain object",
            "@returns ***REMOVED***Promise<" + exportName(method.resolvedResponseType) + ">} Promise",
            "@variation 2"
        ]);
  ***REMOVED***);
}
...
function buildEnum(ref, enm) ***REMOVED***
    ...
    var comment = [
        ...
        config.forceEnumString ? "@enum ***REMOVED***string}" : "@enum ***REMOVED***number}",
    ];
    Object.keys(enm.values).forEach(function(key) ***REMOVED***
        var val = config.forceEnumString ? key : enm.values[key];
        comment.push((config.forceEnumString ? "@property ***REMOVED***string} " : "@property ***REMOVED***number} ") + key + "=" + val + " " + (enm.comments[key] || key + " value"));
  ***REMOVED***);
    pushComment(comment);
    if (!ref && config.es6)
        push("export const " + escapeName(enm.name) + " = " + escapeName(ref) + "." + escapeName(enm.name) + " = (() => ***REMOVED***");
    else
        push(escapeName(ref) + "." + escapeName(enm.name) + " = (function() ***REMOVED***");
    ++indent;
        push((config.es6 ? "const" : "var") + " valuesById = ***REMOVED***}, values = Object.create(valuesById);");
        var aliased = [];
        Object.keys(enm.values).forEach(function(key) ***REMOVED***
