...
deflate.outgoing(***REMOVED*** data: large }, function() ***REMOVED***
  console.log(1, 'large');
});

deflate.outgoing(***REMOVED*** data: small }, function() ***REMOVED***
  console.log(2, 'small');
});
...
var stream  = require('stream'),
    session = new stream.Transform(***REMOVED*** objectMode: true });
...
functor.call(***REMOVED*** data: large }, function() ***REMOVED***
  console.log(1, 'large');
});

functor.call(***REMOVED*** data: small }, function() ***REMOVED***
  console.log(2, 'small');
});
