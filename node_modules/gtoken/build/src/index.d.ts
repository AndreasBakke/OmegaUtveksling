 ...
 */
import ***REMOVED*** GaxiosOptions, GaxiosPromise } from 'gaxios';
export interface Transporter ***REMOVED***
...
export interface TokenData ***REMOVED***
...
export interface TokenOptions ***REMOVED***
    keyFile?: string;
    key?: string;
    email?: string;
    iss?: string;
...
export declare class GoogleToken ***REMOVED***
