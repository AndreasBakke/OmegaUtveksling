...
describe('maxUses', () => ***REMOVED***
  ...
  ***REMOVED***)
  ...
  it(
    ...
    co.wrap(function* () ***REMOVED***
      const pool = new Pool(***REMOVED*** max: 1, maxUses: 2 })
      expect(pool.waitingCount).to.equal(0)
      const client1 = yield pool.connect()
      pool.connect().then((client2) => ***REMOVED***
        ...
        client2.release()
    ***REMOVED***)
      const client3Promise = pool.connect().then((client3) => ***REMOVED***
  ...
  ***REMOVED***)
  ...
  it(
    ...
    co.wrap(function* () ***REMOVED***
      const messages = []
      const log = function (msg) ***REMOVED***
        messages.push(msg)
    ***REMOVED***
      const pool = new Pool(***REMOVED*** maxUses: 1, log })
      const client = yield pool.connect()
      client.release()
