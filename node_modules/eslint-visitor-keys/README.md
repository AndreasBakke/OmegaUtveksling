...
> type: `***REMOVED*** [type: string]: string[] | undefined }`
...
const node = ***REMOVED***
    ...
    left: ***REMOVED*** type: "Identifier", name: "foo" },
    right: ***REMOVED*** type: "Literal", value: 0 }
}
...
> type: `(additionalKeys: object) => ***REMOVED*** [type: string]: string[] | undefined }`
...
```js
console.log(evk.unionWith(***REMOVED***
    MethodDefinition: ["decorators"]
})) // → ***REMOVED*** ..., MethodDefinition: ["decorators", "key", "value"], ... }
```
