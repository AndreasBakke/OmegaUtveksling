...
```javascript
import ***REMOVED*** v4 as uuidv4 } from 'uuid';
...
```javascript
const ***REMOVED*** v4: uuidv4 } = require('uuid');
...
```javascript
import ***REMOVED*** NIL as NIL_UUID } from 'uuid';
...
```javascript
import ***REMOVED*** parse as uuidParse } from 'uuid';
...
```javascript
import ***REMOVED*** stringify as uuidStringify } from 'uuid';
...
```javascript
import ***REMOVED*** v1 as uuidv1 } from 'uuid';
...
```javascript
import ***REMOVED*** v5 as uuidv5 } from 'uuid';
...
```javascript
import ***REMOVED*** validate as uuidValidate } from 'uuid';
...
```javascript
import ***REMOVED*** version as uuidVersion } from 'uuid';
import ***REMOVED*** validate as uuidValidate } from 'uuid';

function uuidValidateV4(uuid) ***REMOVED***
...
```html
<script type="module">
  import ***REMOVED*** v4 as uuidv4 } from 'https://jspm.dev/uuid';
