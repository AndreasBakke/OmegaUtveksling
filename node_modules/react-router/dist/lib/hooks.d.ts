...
import type ***REMOVED*** Blocker, BlockerFunction, Location, ParamParseKey, Params, Path, PathMatch, PathPattern, Router as RemixRouter, To } from "@remix-run/router";
import ***REMOVED*** Action as NavigationType } from "@remix-run/router";
import type ***REMOVED*** NavigateOptions, RouteContextObject, RouteMatch, RouteObject, RelativeRoutingType } from "./context";
/**
 ...
 */
export declare function useHref(to: To, ***REMOVED*** relative }?: ***REMOVED***
 ...
 */
export declare function useResolvedPath(to: To, ***REMOVED*** relative }?: ***REMOVED***
    relative?: RelativeRoutingType;
}): Path;
/**
...
declare type RenderErrorBoundaryProps = React.PropsWithChildren<***REMOVED***
    location: Location;
    error: any;
    component: React.ReactNode;
    routeContext: RouteContextObject;
}>;
declare type RenderErrorBoundaryState = ***REMOVED***
    location: Location;
    error: any;
};
export declare class RenderErrorBoundary extends React.Component<RenderErrorBoundaryProps, RenderErrorBoundaryState> ***REMOVED***
    constructor(props: RenderErrorBoundaryProps);
    static getDerivedStateFromError(error: any): ***REMOVED***
        error: any;
  ***REMOVED***;
    static getDerivedStateFromProps(props: RenderErrorBoundaryProps, state: RenderErrorBoundaryState): ***REMOVED***
        error: any;
        location: Location;
  ***REMOVED***;
 ...
 */
export declare function useRevalidator(): ***REMOVED***
    revalidate: () => void;
 ...
 */
export declare function useMatches(): ***REMOVED***
    id: string;
    pathname: string;
