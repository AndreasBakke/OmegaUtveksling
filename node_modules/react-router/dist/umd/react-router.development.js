...
(function (global, factory) ***REMOVED***
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactRouter = ***REMOVED***}, global.RemixRouter, global.React));
})(this, (function (exports, router, React) ***REMOVED*** 'use strict';
  ...
  getServerSnapshot) ***REMOVED***
    ***REMOVED***
      if (!didWarnOld18Alpha) ***REMOVED***
        if ("startTransition" in React__namespace) ***REMOVED***
...
***REMOVED***
  ...
  const RouteContext = /*#__PURE__*/React__namespace.createContext(***REMOVED***
    outlet: null,
    matches: []
***REMOVED***);
...
***REMOVED***
  ...
  function useHref(to, _temp) ***REMOVED***
    let ***REMOVED***
      relative
  ***REMOVED*** = _temp === void 0 ? ***REMOVED***} : _temp;
    ...
    let ***REMOVED***
      basename,
      navigator
  ***REMOVED*** = React__namespace.useContext(NavigationContext);
    let ***REMOVED***
      hash,
      pathname,
      search
...
***REMOVED***
  ...
  ***REMOVED*** = React__namespace.useContext(NavigationContext);
    let ***REMOVED***
      matches
  ***REMOVED*** = React__namespace.useContext(RouteContext);
    let ***REMOVED***
  ...
  ***REMOVED***);
    let navigate = React__namespace.useCallback(function (to, options) ***REMOVED***
...
***REMOVED***
  ...
  function useOutlet(context) ***REMOVED***
    ...
    if (outlet) ***REMOVED***
      return /*#__PURE__*/React__namespace.createElement(OutletContext.Provider, ***REMOVED***
        value: context
    ***REMOVED***, outlet);
  ***REMOVED***
...
***REMOVED***
  ...
  function useResolvedPath(to, _temp2) ***REMOVED***
    let ***REMOVED***
      relative
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    let matches = router.matchRoutes(routes, ***REMOVED***
  ...
  ***REMOVED***)), parentMatches, dataRouterStateContext || undefined); // When a user passes in a `locationArg`, the associated routes need to
    ...
    if (locationArg && renderedMatches) ***REMOVED***
      return /*#__PURE__*/React__namespace.createElement(LocationContext.Provider, ***REMOVED***
        value: ***REMOVED***
          location: _extends(***REMOVED***
            pathname: "/",
            search: "",
            hash: "",
            state: null,
...
***REMOVED***
  ...
  ***REMOVED***;
    let codeStyles = ***REMOVED***
      ...
      backgroundColor: lightgrey
  ***REMOVED***;
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("h2", null, "Unhandled Thrown Error!"), /*#__PURE__*/React__namespace.createElement("h3", ***REMOVED***
      style: ***REMOVED***
        fontStyle: "italic"
    ***REMOVED***
  ***REMOVED***, message), stack ? /*#__PURE__*/React__namespace.createElement("pre", ***REMOVED***
      style: preStyles
  ***REMOVED***, stack) : null, /*#__PURE__*/React__namespace.createElement("p", null, "\uD83D\uDCBF Hey developer \uD83D\uDC4B"), /*#__PURE__*/React__namespace.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own\xA0", /*#__PURE__*/React__namespace.createElement("code", ***REMOVED***
      style: codeStyles
  ***REMOVED***, "errorElement"), " props on\xA0", /*#__PURE__*/React__namespace.createElement("code", ***REMOVED***
      style: codeStyles
  ***REMOVED***, "<Route>")));
***REMOVED***

  class RenderErrorBoundary extends React__namespace.Component ***REMOVED***
  ...
  ***REMOVED***
    ...
    render() ***REMOVED***
      return this.state.error ? /*#__PURE__*/React__namespace.createElement(RouteContext.Provider, ***REMOVED***
        value: this.props.routeContext
    ***REMOVED***, /*#__PURE__*/React__namespace.createElement(RouteErrorContext.Provider, ***REMOVED***
...
***REMOVED***
  ...
  function RenderedRoute(_ref) ***REMOVED***
    let ***REMOVED***
      routeContext,
      match,
      children
  ...
  ***REMOVED***
    ...
    return /*#__PURE__*/React__namespace.createElement(RouteContext.Provider, ***REMOVED***
      value: routeContext
  ***REMOVED***, children);
***REMOVED***

  function _renderMatches(matches, parentMatches, dataRouterState) ***REMOVED***
    if (parentMatches === void 0) ***REMOVED***
      parentMatches = [];
  ***REMOVED***

    if (matches == null) ***REMOVED***
      if (dataRouterState != null && dataRouterState.errors) ***REMOVED***
  ...
  ***REMOVED***
    ...
    return renderedMatches.reduceRight((outlet, match, index) => ***REMOVED***
      ...
      let getChildren = () => /*#__PURE__*/React__namespace.createElement(RenderedRoute, ***REMOVED***
        match: match,
    ...
    ***REMOVED***, error ? errorElement : match.route.element !== undefined ? match.route.element : outlet); // Only wrap in an error boundary within data router usages when we have an
      ...
      return dataRouterState && (match.route.errorElement || index === 0) ? /*#__PURE__*/React__namespace.createElement(RenderErrorBoundary, ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED*** = useDataRouterState(DataRouterStateHook.UseMatches);
    return React__namespace.useMemo(() => matches.map(match => ***REMOVED***
      let ***REMOVED***
        pathname,
        params
...
***REMOVED***
  ...
  function useActionData() ***REMOVED***
    ...
    return Object.values((state == null ? void 0 : state.actionData) || ***REMOVED***})[0];
***REMOVED***
  /**
...
***REMOVED*** // useBlocker() is a singleton for now since we don't have any compelling use
  ...
  ***REMOVED*** = useDataRouterContext(DataRouterHook.UseBlocker);
    let blockerFunction = React__namespace.useCallback(args => ***REMOVED***
      return typeof shouldBlock === "function" ? !!shouldBlock(args) : !!shouldBlock;
  ***REMOVED***, [shouldBlock]);
    let blocker = router.getBlocker(blockerKey, blockerFunction); // Cleanup on unmount

    React__namespace.useEffect(() => () => router.deleteBlocker(blockerKey), [router]);
    return blocker;
***REMOVED***
...
***REMOVED***
   ...
   */
  function RouterProvider(_ref) ***REMOVED***
    let ***REMOVED***
      fallbackElement,
      router
  ***REMOVED*** = _ref;
    ...
    () => router.state);
    let navigator = React__namespace.useMemo(() => ***REMOVED***
      return ***REMOVED***
  ...
  ***REMOVED***, [router]);
    ...
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement(DataRouterContext.Provider, ***REMOVED***
      value: ***REMOVED***
        router,
        navigator,
        static: false,
        ...
        basename
    ***REMOVED***
  ***REMOVED***, /*#__PURE__*/React__namespace.createElement(DataRouterStateContext.Provider, ***REMOVED***
      value: state
  ***REMOVED***, /*#__PURE__*/React__namespace.createElement(Router, ***REMOVED***
      basename: router.basename,
      location: router.state.location,
      navigationType: router.state.historyAction,
      navigator: navigator
  ***REMOVED***, router.state.initialized ? /*#__PURE__*/React__namespace.createElement(Routes, null) : fallbackElement))), null);
***REMOVED***
   ...
   */
  function MemoryRouter(_ref2) ***REMOVED***
    let ***REMOVED***
      basename,
      children,
      initialEntries,
  ...
  ***REMOVED*** = _ref2;
    ...
    if (historyRef.current == null) ***REMOVED***
      historyRef.current = router.createMemoryHistory(***REMOVED***
        initialEntries,
        initialIndex,
        v5Compat: true
    ***REMOVED***);
  ...
  ***REMOVED***);
    ...
    return /*#__PURE__*/React__namespace.createElement(Router, ***REMOVED***
      basename: basename,
      children: children,
      location: state.location,
...
***REMOVED***
   ...
   */
  function Navigate(_ref3) ***REMOVED***
    let ***REMOVED***
      to,
      replace,
      state,
...
***REMOVED***
  ...
  ***REMOVED*** = _ref4;
    ...
    let navigationContext = React__namespace.useMemo(() => (***REMOVED***
      basename,
      navigator,
      static: staticProp
  ...
  ***REMOVED*** = locationProp;
    let location = React__namespace.useMemo(() => ***REMOVED***
  ...
  ***REMOVED***
    ...
    return /*#__PURE__*/React__namespace.createElement(NavigationContext.Provider, ***REMOVED***
      value: navigationContext
  ***REMOVED***, /*#__PURE__*/React__namespace.createElement(LocationContext.Provider, ***REMOVED***
      children: children,
      value: ***REMOVED***
        location,
        navigationType
...
***REMOVED***
   ...
   */
  function Await(_ref6) ***REMOVED***
    let ***REMOVED***
      children,
      errorElement,
      resolve
  ***REMOVED*** = _ref6;
    return /*#__PURE__*/React__namespace.createElement(AwaitErrorBoundary, ***REMOVED***
      resolve: resolve,
      errorElement: errorElement
  ***REMOVED***, /*#__PURE__*/React__namespace.createElement(ResolveAwait, null, children));
***REMOVED***
...
***REMOVED***)(AwaitRenderStatus || (AwaitRenderStatus = ***REMOVED***}));

  const neverSettledPromise = new Promise(() => ***REMOVED***});

  class AwaitErrorBoundary extends React__namespace.Component ***REMOVED***
    constructor(props) ***REMOVED***
      super(props);
      this.state = ***REMOVED***
        error: null
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      if (status === AwaitRenderStatus.error && promise._error instanceof router.AbortedDeferredError) ***REMOVED***
    ...
    ***REMOVED***
      ...
      if (status === AwaitRenderStatus.error) ***REMOVED***
        ...
        return /*#__PURE__*/React__namespace.createElement(AwaitContext.Provider, ***REMOVED***
          value: promise,
...
***REMOVED***
  ...
  function ResolveAwait(_ref7) ***REMOVED***
    let ***REMOVED***
      children
  ***REMOVED*** = _ref7;
...
***REMOVED*** ///////////////////////////////////////////////////////////////////////////////
  ...
  ***REMOVED***
    ...
    let routes = [];
    React__namespace.Children.forEach(children, (element, index) => ***REMOVED***
      if (! /*#__PURE__*/React__namespace.isValidElement(element)) ***REMOVED***
        // Ignore non-elements. This allows people to more easily inline
        // conditionals in their route config.
        return;
    ***REMOVED***

      if (element.type === React__namespace.Fragment) ***REMOVED***
...
***REMOVED***
  ...
  function enhanceManualRouteObjects(routes) ***REMOVED***
    return routes.map(route => ***REMOVED***
      let routeClone = _extends(***REMOVED***}, route);
...
***REMOVED***
  ...
  function createMemoryRouter(routes, opts) ***REMOVED***
    return router.createRouter(***REMOVED***
      ...
      history: router.createMemoryHistory(***REMOVED***
...
***REMOVED*** ///////////////////////////////////////////////////////////////////////////////
  ...
  Object.defineProperty(exports, 'AbortedDeferredError', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.AbortedDeferredError; }
***REMOVED***);
  Object.defineProperty(exports, 'NavigationType', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.Action; }
***REMOVED***);
  Object.defineProperty(exports, 'createPath', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.createPath; }
***REMOVED***);
  Object.defineProperty(exports, 'defer', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.defer; }
***REMOVED***);
  Object.defineProperty(exports, 'generatePath', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.generatePath; }
***REMOVED***);
  Object.defineProperty(exports, 'isRouteErrorResponse', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.isRouteErrorResponse; }
***REMOVED***);
  Object.defineProperty(exports, 'json', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.json; }
***REMOVED***);
  Object.defineProperty(exports, 'matchPath', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.matchPath; }
***REMOVED***);
  Object.defineProperty(exports, 'matchRoutes', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.matchRoutes; }
***REMOVED***);
  Object.defineProperty(exports, 'parsePath', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.parsePath; }
***REMOVED***);
  Object.defineProperty(exports, 'redirect', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.redirect; }
***REMOVED***);
  Object.defineProperty(exports, 'resolvePath', ***REMOVED***
    enumerable: true,
    get: function () ***REMOVED*** return router.resolvePath; }
***REMOVED***);
  exports.Await = Await;
