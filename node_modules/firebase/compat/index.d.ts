...
declare namespace firebase ***REMOVED***
  ...
  interface FirebaseError ***REMOVED***
     ...
     * ***REMOVED***@link https://firebase.google.com/support/ Firebase Support} to help
...
***REMOVED***
   ...
   * @hidden
   */
  interface Observer<T, E = Error> ***REMOVED***
    next: NextFn<T>;
    error: ErrorFn<E>;
    complete: CompleteFn;
***REMOVED***
   ...
   */
  function onLog(
    logCallback: (callbackParams: ***REMOVED***
      /**
  ...
  ***REMOVED***
  ...
  interface User extends firebase.UserInfo ***REMOVED***
     ...
     * ***REMOVED***@link firebase.User.reauthenticateWithCredential}.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/requires-recent-login</dt>
     * <dd>Thrown if the user's last sign-in time does not meet the security
     *     threshold. Use ***REMOVED***@link firebase.User.reauthenticateWithCredential} to
     ...
     *     <code>error.credential</code> (***REMOVED***@link firebase.auth.AuthCredential})
     ...
     *     via ***REMOVED***@link firebase.auth.Auth.signInWithCredential}.</dd>
     ...
     *     (***REMOVED***@link firebase.auth.AuthCredential}) fields are also provided.
     *     You have to link the credential to the existing user with that email if
     *     you wish to continue signing in with that credential. To do so, call
     *     ***REMOVED***@link firebase.auth.Auth.fetchSignInMethodsForEmail}, sign in to
     *     <code>error.email</code> via one of the providers returned and then
     *     ***REMOVED***@link firebase.User.linkWithCredential} the original credential to that
     ...
     *     ***REMOVED***@link firebase.auth.EmailAuthProvider.credential} is invalid.</dd>
     * <dt>auth/wrong-password</dt>
     * <dd>Thrown if the password used in a
     *     ***REMOVED***@link firebase.auth.EmailAuthProvider.credential} is not correct or
     ...
     *     ***REMOVED***@link firebase.auth.PhoneAuthProvider.credential} and the verification
     ...
     * ***REMOVED***@link firebase.User.linkWithCredential} instead.
     *
     ...
     *     ***REMOVED***@link firebase.auth.Auth.signInWithCredential}.</dd>
     * <dt>auth/operation-not-allowed</dt>
     ...
     *     (***REMOVED***@link firebase.auth.AuthCredential}) fields are also provided. You can
    ...
    /**
     * The ***REMOVED***@link firebase.User.MultiFactorUser} object corresponding to the current user.
     ...
     * such as ***REMOVED***@link firebase.User.updatePassword} that require tokens from recent
     * sign-in attempts.
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     * <dt>auth/wrong-password</dt>
     * <dd>Thrown if the password used in a
     *     ***REMOVED***@link firebase.auth.EmailAuthProvider.credential} is not correct or when
     ...
     * ***REMOVED***@link firebase.User.reauthenticateWithCredential} instead.
     *
     * @param credential
     */
     ...
     * ***REMOVED***@link firebase.auth.Auth.applyActionCode}
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     * user.updateProfile(***REMOVED***photoURL: null}).then(function() ***REMOVED***
     *   // Profile updated successfully!
  ...
  ***REMOVED***): Promise<void>;
     ...
     * process by calling ***REMOVED***@link firebase.auth.Auth.applyActionCode}.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/missing-android-pkg-name</dt>
...
***REMOVED***
  ...
  /**
   * Retrieves a Firebase ***REMOVED***@link firebase.app.App app} instance.
   *
  ...
  /**
   * Gets the ***REMOVED***@link firebase.auth.Auth `Auth`} service for the default app or a
   * given app.
   *
   * `firebase.auth()` can be called with no arguments to access the default app's
   * ***REMOVED***@link firebase.auth.Auth `Auth`} service or as `firebase.auth(app)` to
   * access the ***REMOVED***@link firebase.auth.Auth `Auth`} service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the ***REMOVED***@link firebase.database.Database `Database`} service for the
   * default app or a given app.
   *
   * `firebase.database()` can be called with no arguments to access the default
   * app's ***REMOVED***@link firebase.database.Database `Database`} service or as
   * `firebase.database(app)` to access the
   * ***REMOVED***@link firebase.database.Database `Database`} service associated with a
   * specific app.
   *
  ...
  /**
   * Creates and initializes a Firebase ***REMOVED***@link firebase.app.App app} instance.
   *
   * See
   * ***REMOVED***@link
   ...
   * var otherApp = firebase.initializeApp(***REMOVED***
   *   apiKey: "AIza....",
   ...
   *
   * @return ***REMOVED***!firebase.app.App} The initialized app.
   */
  function initializeApp(options: Object, name?: string): firebase.app.App;

  /**
   * Gets the ***REMOVED***@link firebase.messaging.Messaging `Messaging`} service for the
   * default app or a given app.
   *
   * `firebase.messaging()` can be called with no arguments to access the default
   * app's ***REMOVED***@link firebase.messaging.Messaging `Messaging`} service or as
   * `firebase.messaging(app)` to access the
   * ***REMOVED***@link firebase.messaging.Messaging `Messaging`} service associated with a
   * specific app.
   *
  ...
  /**
   * Gets the ***REMOVED***@link firebase.storage.Storage `Storage`} service for the default
   * app or a given app.
   *
   * `firebase.storage()` can be called with no arguments to access the default
   * app's ***REMOVED***@link firebase.storage.Storage `Storage`} service or as
   * `firebase.storage(app)` to access the
   * ***REMOVED***@link firebase.storage.Storage `Storage`} service associated with a
   * specific app.
   *
   * @example
   * ```javascript
  ...
  /**
   * Gets the ***REMOVED***@link firebase.performance.Performance `Performance`} service.
   *
   * `firebase.performance()` can be called with no arguments to access the default
   * app's ***REMOVED***@link firebase.performance.Performance `Performance`} service.
   * The ***REMOVED***@link firebase.performance.Performance `Performance`} service does not work with
   * any other app.
   *
   * @webonly
   *
  ...
  /**
   * Gets the ***REMOVED***@link firebase.remoteConfig.RemoteConfig `RemoteConfig`} instance.
   *
   * @webonly
   *
   * @example
  ...
  /**
   * Gets the ***REMOVED***@link firebase.analytics.Analytics `Analytics`} service.
   *
   * `firebase.analytics()` can be called with no arguments to access the default
   * app's ***REMOVED***@link firebase.analytics.Analytics `Analytics`} service.
   *
   * @webonly
   *
   * @example
...
declare namespace firebase.app ***REMOVED***
   ...
   * ***REMOVED***@link firebase.initializeApp|`firebase.initializeApp()`} to create an app.
   *
   */
  interface App ***REMOVED***
    /**
     * Gets the ***REMOVED***@link firebase.auth.Auth `Auth`} service for the current app.
     *
     * @example
     * ```javascript
     * var auth = app.auth();
    ...
    delete(): Promise<any>;
    /**
     * Gets the ***REMOVED***@link firebase.installations.Installations `Installations`} service for the
     * current app.
     *
     * @webonly
     *
     ...
     * parameters given in
     * ***REMOVED***@link firebase.initializeApp `firebase.initializeApp()`}.
     *
     * @example
     * ```javascript
    ...
    options: Object;
    /**
     * Gets the ***REMOVED***@link firebase.storage.Storage `Storage`} service for the current
    ...
    /**
     * Gets the ***REMOVED***@link firebase.performance.Performance `Performance`} service for the
    ...
    /**
     * Gets the ***REMOVED***@link firebase.analytics.Analytics `Analytics`} service for the
     * current app. If the current app is not the default one, throws an error.
     *
     * @webonly
     *
 ...
 * @webonly
 */
declare namespace firebase.appCheck ***REMOVED***
  /**
   * Result returned by
   * ***REMOVED***@link firebase.appCheck.AppCheck.getToken `firebase.appCheck().getToken()`}.
   */
  interface AppCheckTokenResult ***REMOVED***
    token: string;
***REMOVED***
  /*
   * reCAPTCHA v3 token provider.
   */
  class ReCaptchaV3Provider ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  class ReCaptchaEnterpriseProvider ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  interface CustomProviderOptions ***REMOVED***
    /**
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.appCheck `firebase.appCheck()`}.
   */
  export interface AppCheck ***REMOVED***
    /**
     * Activate AppCheck
    ...
    activate(
      provider:
        ...
        | CustomProvider
        | AppCheckProvider
        | ***REMOVED*** getToken: () => AppCheckToken }
        | string,
     ...
     * ***REMOVED***@link firebase.appCheck.AppCheckTokenResult `AppCheckTokenResult`}
     ...
     */
    onTokenChanged(observer: ***REMOVED***
...
***REMOVED***
   ...
   */
  interface AppCheckProvider ***REMOVED***
    /**
...
***REMOVED***
  ...
  /**
   * The token returned from an ***REMOVED***@link firebase.appCheck.AppCheckProvider `AppCheckProvider`}.
   */
  interface AppCheckToken ***REMOVED***
    /**
 ...
 * @webonly
 */
declare namespace firebase.installations ***REMOVED***
  /**
   * The Firebase Installations service interface.
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.installations `firebase.installations()`}.
   */
  export interface Installations ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Installations` service
     * instance.
     *
     * @example
     * ```javascript
 ...
 * @webonly
 */
declare namespace firebase.performance ***REMOVED***
  /**
   * The Firebase Performance Monitoring service interface.
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.performance `firebase.performance()`}.
   */
  export interface Performance ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Performance` service
     * instance.
     *
     * @example
     * ```javascript
    ...
    app: firebase.app.App;
    /**
     * Creates an uninitialized instance of ***REMOVED***@link firebase.performance.Trace `trace`} and returns
     * it.
     *
...
***REMOVED***
  ...
  export interface Trace ***REMOVED***
    /**
     * Starts the timing for the ***REMOVED***@link firebase.performance.Trace `trace`} instance.
     */
    start(): void;
    /**
     * Stops the timing of the ***REMOVED***@link firebase.performance.Trace `trace`} instance and logs the
     * data of the instance.
     */
    stop(): void;
    /**
     * Records a ***REMOVED***@link firebase.performance.Trace `trace`} from given parameters. This provides a
     * direct way to use ***REMOVED***@link firebase.performance.Trace `trace`} without a need to start/stop.
     * This is useful for use cases in which the ***REMOVED***@link firebase.performance.Trace `trace`} cannot
    ...
    record(
      ...
      duration: number,
      options?: ***REMOVED***
        metrics?: ***REMOVED*** [key: string]: number };
        attributes?: ***REMOVED*** [key: string]: string };
    ***REMOVED***
    ): void;
    /**
     ...
     * a metric with that name already exists on the ***REMOVED***@link firebase.performance.Trace `trace`}
     * instance or not.
     *
    ...
    /**
     * Set a custom attribute of a ***REMOVED***@link firebase.performance.Trace `trace`} to a certain value.
     *
    ...
    /**
     * Removes the specified custom attribute from a ***REMOVED***@link firebase.performance.Trace `trace`}
     * instance.
     *
     * @param attr Name of the custom attribute.
     */
    ...
    /**
     * Returns a map of all custom attributes of a ***REMOVED***@link firebase.performance.Trace `trace`}
     * instance.
     */
    getAttributes(): ***REMOVED*** [key: string]: string };
***REMOVED***
}
 ...
 * @webonly
 */
declare namespace firebase.remoteConfig ***REMOVED***
  /**
   * The Firebase Remote Config service interface.
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.remoteConfig `firebase.remoteConfig()`}.
   */
  export interface RemoteConfig ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Performance` service
     * instance.
     *
     ...
     */
    defaultConfig: ***REMOVED*** [key: string]: string | number | boolean };

    /**
     * The Unix timestamp in milliseconds of the last <i>successful</i> fetch, or negative one if
     * the ***REMOVED***@link RemoteConfig} instance either hasn't fetched or initialization
     * is incomplete.
     */
     ...
     * Gets all config.
     */
    getAll(): ***REMOVED*** [key: string]: Value };
...
***REMOVED***
   ...
   */
  export interface Value ***REMOVED***
    /**
    ...
    /**
     * Gets the ***REMOVED***@link ValueSource} for the given key.
     */
...
***REMOVED***
   ...
   *
   * <ul>
   *   <li>"no-fetch-yet" indicates the ***REMOVED***@link RemoteConfig} instance has not yet attempted
   ...
   *
   * It returns a `Promise` which resolves to true if a ***REMOVED***@link RemoteConfig} instance
   * can be initialized in this environment, or false if it cannot.
   */
  export function isSupported(): Promise<boolean>;
}

declare namespace firebase.functions ***REMOVED***
  /**
   * An HttpsCallableResult wraps a single result from a function call.
   */
  export interface HttpsCallableResult ***REMOVED***
    readonly data: any;
***REMOVED***
  /**
   ...
   */
  export interface HttpsCallable ***REMOVED***
    (data?: any): Promise<HttpsCallableResult>;
***REMOVED***
  export interface HttpsCallableOptions ***REMOVED***
    timeout?: number;
***REMOVED***
  /**
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.functions `firebase.functions()`}.
   */
  export class Functions ***REMOVED***
    private constructor();
...
***REMOVED***
  ...
  export type FunctionsErrorCode =
    ...
    | 'data-loss'
    | 'unauthenticated';
  export interface HttpsError extends Error ***REMOVED***
    /**
...
declare namespace firebase.auth ***REMOVED***
  ...
  class ActionCodeURL ***REMOVED***
     ...
     * of the types from ***REMOVED***@link firebase.auth.ActionCodeInfo}.
     */
...
***REMOVED***
  /**
   * A response from ***REMOVED***@link firebase.auth.Auth.checkActionCode}.
   */
  interface ActionCodeInfo ***REMOVED***
    /**
     ...
     * `multiFactorInfo` is a ***REMOVED***@link firebase.auth.PhoneMultiFactorInfo} object,
  ...
  ***REMOVED***;
     ...
     *     ***REMOVED***@link firebase.auth.Auth.sendSignInLinkToEmail}.</li>
     * <li>`PASSWORD_RESET`: password reset code generated via
     *     ***REMOVED***@link firebase.auth.Auth.sendPasswordResetEmail}.</li>
     * <li>`RECOVER_EMAIL`: email change revocation code generated via
     *     ***REMOVED***@link firebase.User.updateEmail}.</li>
     * <li>`REVERT_SECOND_FACTOR_ADDITION`: revert second factor addition
     *     code generated via
     *     ***REMOVED***@link firebase.User.MultiFactorUser.enroll}.</li>
     * <li>`VERIFY_AND_CHANGE_EMAIL`: verify and change email code generated
     *     via ***REMOVED***@link firebase.User.verifyBeforeUpdateEmail}.</li>
     * <li>`VERIFY_EMAIL`: email verification code generated via
     *     ***REMOVED***@link firebase.User.sendEmailVerification}.</li>
     * </ul>
     */
    operation: string;
***REMOVED***
...
***REMOVED***;
   ...
   * only implementation is ***REMOVED***@link firebase.auth.RecaptchaVerifier}.
   */
...
***REMOVED***
   ...
   */
  interface AuthSettings ***REMOVED***
    /**
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/auth/web/phone-auth#test-with-whitelisted-phone-numbers
...
***REMOVED***
   ...
   */
  export interface EmulatorConfig ***REMOVED***
    /**
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.auth `firebase.auth()`}.
   *
   * See
   * ***REMOVED***@link https://firebase.google.com/docs/auth/ Firebase Authentication}
  ...
  interface Auth ***REMOVED***
    ...
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Auth` service
     * instance.
     *
     * @example
     * ```javascript
     ...
     *   if (errorCode == 'auth/weak-password') ***REMOVED***
     ...
     *     ***REMOVED***@link firebase.auth.Auth.fetchSignInMethodsForEmail} with the error.email
     ...
     *     ***REMOVED***@link firebase.User.linkWithCredential} to prevent the user from signing
     ...
     *     ***REMOVED***@link firebase.auth.GoogleAuthProvider.credential} depending on the
     ...
     *     auth.fetchSignInMethodsForEmail(email).then(function(providers) ***REMOVED***
     ...
     *
     * To keep the old behavior, see ***REMOVED***@link firebase.auth.Auth.onIdTokenChanged}.
     *
     * @example
     * ```javascript
     ...
     * behavior as ***REMOVED***@link firebase.auth.Auth.onAuthStateChanged} had prior to 4.0.0.
     *
     * @example
     * ```javascript
     * firebase.auth().onIdTokenChanged(function(user) ***REMOVED***
     *   if (user) ***REMOVED***
     ...
     * ***REMOVED***@link firebase.auth.Auth.signInWithEmailLink} with the email address and
     ...
     * ***REMOVED***@link firebase.auth.Auth.confirmPasswordReset} with the code supplied in the
     ...
     * <dd>Thrown if there already exists an account with the email address
     *     asserted by the credential. Resolve this by calling
     *     ***REMOVED***@link firebase.auth.Auth.fetchSignInMethodsForEmail} and then asking the
     ...
     *     ***REMOVED***@link firebase.User.linkWithCredential}.</dd>
     * <dt>auth/invalid-credential</dt>
     ...
     *     ***REMOVED***@link firebase.auth.EmailAuthProvider.credential} and there is no user
     *     corresponding to the given email. </dd>
     * <dt>auth/wrong-password</dt>
     * <dd>Thrown if signing in with a credential from
     *     ***REMOVED***@link firebase.auth.EmailAuthProvider.credential} and the password is
     ...
     * @deprecated
     * This method is deprecated. Use
     * ***REMOVED***@link firebase.auth.Auth.signInWithCredential} instead.
     *
     * @example
     * ```javascript
     * firebase.auth().signInAndRetrieveDataWithCredential(credential)
     *     .then(function(userCredential) ***REMOVED***
     ...
     * @example
     * ```javascript
     * firebase.auth().signInAnonymously().catch(function(error) ***REMOVED***
     *   // Handle Errors here.
     *   var errorCode = error.code;
     *   var errorMessage = error.message;
     *
     *   if (errorCode === 'auth/operation-not-allowed') ***REMOVED***
     ...
     * @example
     * ```javascript
     * firebase.auth().signInWithCredential(credential).catch(function(error) ***REMOVED***
     *   // Handle Errors here.
     *   var errorCode = error.code;
     *   var errorMessage = error.message;
     ...
     *   var credential = error.credential;
     *   if (errorCode === 'auth/account-exists-with-different-credential') ***REMOVED***
     ...
     * @example
     * ```javascript
     * firebase.auth().signInWithCustomToken(token).catch(function(error) ***REMOVED***
     *   // Handle Errors here.
     *   var errorCode = error.code;
     *   var errorMessage = error.message;
     *   if (errorCode === 'auth/invalid-custom-token') ***REMOVED***
     ...
     *
     * See also: ***REMOVED***@link firebase.auth.Auth.createUserWithEmailAndPassword}.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/invalid-email</dt>
     ...
     * ***REMOVED***@link firebase.auth.ConfirmationResult}. After the user provides the code
     * sent to their phone, call ***REMOVED***@link firebase.auth.ConfirmationResult.confirm}
     * with the code to sign the user in.
     *
     * For abuse prevention, this method also requires a
     * ***REMOVED***@link firebase.auth.ApplicationVerifier}. The Firebase Auth SDK includes
     * a reCAPTCHA-based implementation, ***REMOVED***@link firebase.auth.RecaptchaVerifier}.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/captcha-check-failed</dt>
     ...
     *     .then(function(confirmationResult) ***REMOVED***
     ...
     * ***REMOVED***@link firebase.auth.Auth.isSignInWithEmailLink}.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/expired-action-code</dt>
     ...
     * `currentUser`.
     *
     * This will trigger ***REMOVED***@link firebase.auth.Auth.onAuthStateChanged} and
     * ***REMOVED***@link firebase.auth.Auth.onIdTokenChanged} listeners like other sign in
     * methods.
     *
...
***REMOVED***
   ...
   *
   */
  abstract class AuthCredential ***REMOVED***
    /**
     ...
     * ***REMOVED***@link firebase.auth.Auth.fetchSignInMethodsForEmail}.
     */
    signInMethod: string;
    /**
     * Returns a JSON-serializable representation of this object.
     ...
     * ***REMOVED***@link firebase.auth.AuthCredential}. Input can be either Object or the
...
***REMOVED***
   ...
   *
   */
  class OAuthCredential extends AuthCredential ***REMOVED***
    private constructor();
    /**
...
***REMOVED***
   ...
   *
   * To authenticate: ***REMOVED***@link firebase.auth.Auth.createUserWithEmailAndPassword}
   * and ***REMOVED***@link firebase.auth.Auth.signInWithEmailAndPassword}.
   */
...
***REMOVED***
   ...
   * message, use ***REMOVED***@link firebase.auth.Error.message}.
   ...
   * specific errors. Refer to ***REMOVED***@link firebase.auth.Auth.signInWithPopup} for more
   * information.
   *
...
***REMOVED***
   ...
   * Refer to ***REMOVED***@link firebase.auth.Auth.signInWithPopup} for more information.
   *
   * <h4>Common Error Codes</h4>
   * <dl>
   * <dt>auth/account-exists-with-different-credential</dt>
   ...
   * </dl>
   */
  interface AuthError extends firebase.auth.Error ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.auth.AuthCredential} that can be used to resolve the
     * error.
     */
    credential?: firebase.auth.AuthCredential;
    /**
     ...
     * ***REMOVED***@link firebase.auth.Auth.signInWithRedirect} to sign in, you have to
...
***REMOVED***
   ...
   * This error provides a ***REMOVED***@link firebase.auth.MultiFactorResolver} object,
   ...
   *   ***REMOVED***)
   *     .catch(function(error) ***REMOVED***
   *       if (error.code == 'auth/multi-factor-auth-required') ***REMOVED***
   ...
   * ```
   */
  interface MultiFactorError extends firebase.auth.AuthError ***REMOVED***
    /**
...
***REMOVED***
   ...
   * firebase.auth().getRedirectResult().then(function(result) ***REMOVED***
   *   if (result.credential) ***REMOVED***
   ...
   * var provider = new firebase.auth.FacebookAuthProvider();
   * provider.addScope('user_birthday');
   * firebase.auth().signInWithPopup(provider).then(function(result) ***REMOVED***
   ...
   * ```
   *
   * @see ***REMOVED***@link firebase.auth.Auth.onAuthStateChanged} to receive sign in state
   * changes.
   */
...
***REMOVED***
  ...
  class FacebookAuthProvider_Instance implements firebase.auth.AuthProvider ***REMOVED***
     ...
     * ***REMOVED***@link https://goo.gl/pve4fo Facebook}
     * documentation.
...
***REMOVED***
  ...
  class GithubAuthProvider extends GithubAuthProvider_Instance ***REMOVED***
     ...
     * @return ***REMOVED***!firebase.auth.OAuthCredential} The auth provider credential.
     */
    static credential(token: string): firebase.auth.OAuthCredential;
***REMOVED***
  /**
  ...
  class GithubAuthProvider_Instance implements firebase.auth.AuthProvider ***REMOVED***
     ...
     * For a detailed list, check the
     * ***REMOVED***@link https://developer.github.com/v3/oauth/ GitHub} documentation.
     * Reserved required OAuth 2.0 parameters such as 'client_id', 'redirect_uri',
     * 'scope', 'response_type' and 'state' are not allowed and will be ignored.
     * @param customOAuthParameters The custom OAuth parameters to pass
     *     in the OAuth request.
...
***REMOVED***
  ...
  class GoogleAuthProvider_Instance implements firebase.auth.AuthProvider ***REMOVED***
     ...
     * and 'prompt'.
     * For a detailed list, check the
     * ***REMOVED***@link https://goo.gl/Xo01Jm Google}
     * documentation.
     * Reserved required OAuth 2.0 parameters such as 'client_id', 'redirect_uri',
     * 'scope', 'response_type' and 'state' are not allowed and will be ignored.
     * @param customOAuthParameters The custom OAuth parameters to pass
...
***REMOVED***
   ...
   */
  class OAuthProvider implements firebase.auth.AuthProvider ***REMOVED***
     ...
     * var provider = new firebase.auth.OAuthProvider('google.com');
     * var credential = provider.credential(***REMOVED***
...
***REMOVED***
  ...
  class SAMLAuthProvider implements firebase.auth.AuthProvider ***REMOVED***
    constructor(providerId: string);
    providerId: string;
***REMOVED***
   ...
   * ***REMOVED***@link firebase.User.getIdTokenResult}. It contains the ID token JWT string
   ...
   * claims.
   */
  interface IdTokenResult ***REMOVED***
    /**
...
***REMOVED***
   ...
   * ***REMOVED***@link firebase.auth.OAuthCredential}. For ID tokens with nonce claim,
   * the raw nonce has to also be provided.
   */
  interface OAuthCredentialOptions ***REMOVED***
    /**
...
***REMOVED***
   ...
   *
   */
  abstract class MultiFactorAssertion ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  class PhoneMultiFactorAssertion extends firebase.auth.MultiFactorAssertion ***REMOVED***
    private constructor();
***REMOVED***

  /**
   * The class used to initialize ***REMOVED***@link firebase.auth.PhoneMultiFactorAssertion}.
   */
  class PhoneMultiFactorGenerator ***REMOVED***
    private constructor();
    /**
    ...
    /**
     * Initializes the ***REMOVED***@link firebase.auth.PhoneMultiFactorAssertion} to confirm ownership
...
***REMOVED***
   ...
   */
  interface MultiFactorInfo ***REMOVED***
    /**
...
***REMOVED***
   ...
   * ***REMOVED***@link firebase.auth.PhoneMultiFactorGenerator.FACTOR_ID}.
   */
  interface PhoneMultiFactorInfo extends firebase.auth.MultiFactorInfo ***REMOVED***
    /**
...
***REMOVED***
   ...
   * required.
   */
  interface PhoneSingleFactorInfoOptions ***REMOVED***
    phoneNumber: string;
***REMOVED***
   ...
   */
  interface PhoneMultiFactorEnrollInfoOptions ***REMOVED***
    phoneNumber: string;
...
***REMOVED***
   ...
   */
  interface PhoneMultiFactorSignInInfoOptions ***REMOVED***
...
***REMOVED***
   ...
   * ***REMOVED***@link firebase.auth.MultiFactorError} when a user needs to provide a second
   * factor to sign in.
   *
   * @example
   * ```javascript
   ...
   *   phoneInfoOptions,
   *   appVerifier
   * ).then(function(verificationId) ***REMOVED***
  ...
  class MultiFactorResolver ***REMOVED***
     ...
     * using an ***REMOVED***@link firebase.auth.MultiFactorAssertion} confirming the user
...
***REMOVED***
   ...
   */
  class MultiFactorSession ***REMOVED***
    private constructor();
***REMOVED***

  /**
   * Classes that represents the Phone Auth credentials returned by a
   * ***REMOVED***@link firebase.auth.PhoneAuthProvider}.
   *
   */
  class PhoneAuthCredential extends AuthCredential ***REMOVED***
    private constructor();
***REMOVED***
   ...
   *           verificationCode);
   *   ***REMOVED***)
   *     .then(function(phoneCredential) ***REMOVED***
  ...
  class PhoneAuthProvider extends PhoneAuthProvider_Instance ***REMOVED***
     ...
     * ***REMOVED***@link firebase.auth.PhoneAuthProvider.verifyPhoneNumber} and the code
     * that was sent to the user's mobile device.
     *
     * <h4>Error Codes</h4>
     * <dl>
     ...
     *     ***REMOVED***@link firebase.auth.PhoneAuthProvider.verifyPhoneNumber}.
...
***REMOVED***
  ...
  class PhoneAuthProvider_Instance implements firebase.auth.AuthProvider ***REMOVED***
     ...
     * ***REMOVED***@link firebase.auth.PhoneAuthProvider.credential} to identify this flow.
     *
     * For abuse prevention, this method also requires a
     * ***REMOVED***@link firebase.auth.ApplicationVerifier}. The Firebase Auth SDK includes
     * a reCAPTCHA-based implementation, ***REMOVED***@link firebase.auth.RecaptchaVerifier}.
     ...
     * </dl>
     *
     * @param phoneInfoOptions The user's ***REMOVED***@link firebase.auth.PhoneInfoOptions}.
...
***REMOVED***
  ...
  /**
   * An ***REMOVED***@link https://www.google.com/recaptcha/ reCAPTCHA}-based application
   * verifier.
   *
   * @webonly
   *
   ...
   *     thrown.
   */
  class RecaptchaVerifier extends RecaptchaVerifier_Instance ***REMOVED***}
  /**
   * @webonly
   * @hidden
   */
 ...
 * @webonly
 */
declare namespace firebase.analytics ***REMOVED***
  /**
   * The Firebase Analytics service interface.
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.analytics `firebase.analytics()`}.
   */
  export interface Analytics ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Analytics` service
     * instance.
     *
     * @example
     * ```javascript
...
***REMOVED***
   ...
   */
  export interface AnalyticsCallOptions ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  export interface SettingsOptions ***REMOVED***
...
***REMOVED***
   ...
   * ***REMOVED***@link https://developers.google.com/gtagjs/reference/parameter
   * the gtag.js documentation on parameters}.
   */
  export interface ControlParams ***REMOVED***
...
***REMOVED***
   ...
   * the gtag.js documentation on parameters}.
   */
  export interface EventParams ***REMOVED***
...
***REMOVED***
   ...
   */
  export interface CustomParams ***REMOVED***
    [key: string]: any;
***REMOVED***
...
***REMOVED***
  ...
  export interface Promotion ***REMOVED***
    creative_name?: string;
    creative_slot?: string;
    id?: string;
    name?: string;
...
declare namespace firebase.User ***REMOVED***
  /**
   * This is the interface that defines the multi-factor related properties and
   * operations pertaining to a ***REMOVED***@link firebase.User}.
   */
  interface MultiFactorUser ***REMOVED***
    /**
     ...
     * ***REMOVED***@link firebase.auth.MultiFactorAssertion} for the current user.
     ...
     *     .then(function(multiFactorSession) ***REMOVED***
     ...
     *   ***REMOVED***).then(function(verificationId) ***REMOVED***
     *       // Store verificationID and show UI to let user enter verification code.
     *   ***REMOVED***);
     *
     * var phoneAuthCredential =
     ...
     * ***REMOVED***@link firebase.auth.MultiFactorSession}.
     *
     * <h4>Error Codes</h4>
     * <dl>
     * <dt>auth/user-token-expired</dt>
     ...
     * a ***REMOVED***@link firebase.auth.MultiFactorInfo} object
...
declare namespace firebase.auth.ActionCodeInfo ***REMOVED***
...
declare namespace firebase.database ***REMOVED***
  ...
  interface DataSnapshot ***REMOVED***
     ...
     *     var name = snapshot.child("name").val(); // ***REMOVED***first:"Ada",last:"Lovelace"}
     ...
     * ref.set(***REMOVED*** name: "Ada", age: 36 })
     *   .then(function() ***REMOVED***
     *    return ref.once("value");
     * ***REMOVED***)
     *   .then(function(snapshot) ***REMOVED***
     *     var data = snapshot.val();
     *     // data is ***REMOVED*** "name": "Ada", "age": 36 }
     *     // data.name === "Ada"
     *     // data.age === 36
     * ***REMOVED***);
     * ```
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.database `firebase.database()`}.
   *
   * See
   * ***REMOVED***@link
  ...
  interface Database ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Database` service
     * instance.
     *
     * @example
     * ```javascript
...
***REMOVED***
  ...
  interface OnDisconnect ***REMOVED***
     ...
     * ***REMOVED***@link firebase.database.Reference.update `update()`}.
     *
     * @example
     * ```javascript
     * var ref = firebase.database().ref("users/ada");
...
***REMOVED***
  ...
  interface Query ***REMOVED***
     ...
     * var ref = firebase.database().ref("dinosaurs");
     * ref.orderByKey().endBefore("pterodactyl").on("child_added", function(snapshot) ***REMOVED***
     *   console.log(snapshot.key);
     * });
     *
     ...
     * @example
     * ```javascript
     * var onValueChange = function(dataSnapshot) ***REMOVED***  ... };
     ...
     * var onValueChange = ref.on('value', function(dataSnapshot) ***REMOVED*** ... });
     * // Sometime later...
     * ref.off('value', onValueChange);
     * ```
     *
     ...
     * listening.
     *
     * This is equivalent to calling ***REMOVED***@link firebase.database.Query.on `on()`}, and
     * then calling ***REMOVED***@link firebase.database.Query.off `off()`} inside the callback
     * function. See ***REMOVED***@link firebase.database.Query.on `on()`} for details on the
     * event types.
     *
     * @example
     * ```javascript
     ...
     * var ref = firebase.database().ref("dinosaurs");
     * ref.orderByChild("height").startAfter(3).on("child_added", function(snapshot) ***REMOVED***
     *   console.log(snapshot.key)
     * });
     * ```
     *
...
***REMOVED***
  ...
  interface Reference extends firebase.database.Query ***REMOVED***
     ...
     * @example
     * ```javascript
     * adaNameRef.set(***REMOVED*** first: 'Ada', last: 'Lovelace' });
     ...
     *     return ***REMOVED*** name: ***REMOVED*** first: 'Ada', last: 'Lovelace' } };
     * ***REMOVED*** else ***REMOVED***
     *     console.log('User ada already exists.');
     *     return; // Abort the transaction.
     * ***REMOVED***
     * }, function(error, committed, snapshot) ***REMOVED***
     *   if (error) ***REMOVED***
     ...
     * adaNameRef.update(***REMOVED*** first: 'Ada', last: 'Lovelace' });
     * ```
     *
     * @param values Object containing multiple values.
     * @param onComplete Callback called when write to server is
...
***REMOVED***
  ...
  interface TransactionResult ***REMOVED***
    /**
...
***REMOVED***
  ...
  interface ThenableReference
    extends firebase.database.Reference,
      Pick<Promise<Reference>, 'then' | 'catch'> ***REMOVED***}
...
declare namespace firebase.messaging ***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.messaging `firebase.messaging()`}.
   *
   * See ***REMOVED***@link https://firebase.google.com/docs/cloud-messaging/js/client
  ...
  interface Messaging ***REMOVED***
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/cloud-messaging/js/client#configure_web_credentials_with_fcm Configure Web Credentials with FCM}.
     * See
     * ***REMOVED***@link https://developers.google.com/web/fundamentals/push-notifications/web-push-protocol The Web Push Protocol}
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/cloud-messaging/js/client#retrieve-the-current-registration-token Retrieve the current registration token}
     * for more details.
     *
     * @return The promise resolves with an FCM registration token.
     *
     */
    getToken(options?: ***REMOVED***
      vapidKey?: string;
...
***REMOVED***
   ...
   * ***REMOVED***@link firebase.messaging.NotificationPayload} and the data payload that contains an arbitrary
   * number of key-value pairs sent by developers through the
   * ***REMOVED***@link https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#notification Send API}
   */
  export interface MessagePayload ***REMOVED***
    /**
     * See ***REMOVED***@link firebase.messaging.NotificationPayload}.
     */
     ...
     */
    data?: ***REMOVED*** [key: string]: string };

    /**
     * See ***REMOVED***@link firebase.messaging.FcmOptions}.
     */
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/cloud-messaging/concept-options#collapsible_and_non-collapsible_messages
...
***REMOVED***
   ...
   * ***REMOVED***@link https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#webpushfcmoptions
   * WebpushFcmOptions}.
   */
  export interface FcmOptions ***REMOVED***
    /**
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/cloud-messaging/understand-delivery#adding-analytics-labels-to-messages
...
***REMOVED***
   ...
   */
  export interface NotificationPayload ***REMOVED***
    /**
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#notification
...
declare namespace firebase.storage ***REMOVED***
  ...
  interface FullMetadata extends firebase.storage.UploadMetadata ***REMOVED***
     ...
     * @see ***REMOVED***@link https://cloud.google.com/storage/docs/generations-preconditions}
     */
    generation: string;
    /**
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.storage `firebase.storage()`}.
   *
   * See
   * ***REMOVED***@link
  ...
  interface Storage ***REMOVED***
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with the `Storage` service
     * instance.
     *
     * @example
     * ```javascript
     ...
     * @see ***REMOVED***@link firebase.storage.Storage.maxOperationRetryTime}
     */
    setMaxOperationRetryTime(time: number): any;
    /**
     * @param time The new maximum upload retry time in milliseconds.
     * @see ***REMOVED***@link firebase.storage.Storage.maxUploadRetryTime}
     */
...
***REMOVED***;
   ...
   * @enum ***REMOVED***string}
   * @see ***REMOVED***@link firebase.storage.UploadTask.on}
   */
  ...
  var TaskEvent: ***REMOVED***
     ...
     *       ***REMOVED***@link firebase.storage.UploadTaskSnapshot} as the first
     *       argument.</li>
...
***REMOVED***
   ...
   */
  interface FirebaseStorageError extends FirebaseError ***REMOVED***
    serverResponse: string | null;
***REMOVED***

  interface StorageObserver<T> ***REMOVED***
    next?: NextFn<T> | null;
...
***REMOVED***
  ...
  interface UploadTask ***REMOVED***
     ...
     * ```javascript
     * var next = function(snapshot) ***REMOVED***};
...
declare namespace firebase.firestore ***REMOVED***
   ...
   * mapped to values.
   */
  export type DocumentData = ***REMOVED*** [field: string]: any };
   ...
   */
  export type UpdateData = ***REMOVED*** [fieldPath: string]: any };
...
***REMOVED***
   ...
   */
  export interface PersistenceSettings ***REMOVED***
    /**
...
***REMOVED***
   ...
   *   toFirestore(post: Post): firebase.firestore.DocumentData ***REMOVED***
   ...
   * ```
   */
  export interface FirestoreDataConverter<T> ***REMOVED***
    /**
...
***REMOVED***
   ...
   *
   * Do not call this constructor directly. Instead, use
   * ***REMOVED***@link firebase.firestore `firebase.firestore()`}.
   */
  export class Firestore ***REMOVED***
    ...
    ***REMOVED***
    ...
    /**
     * The ***REMOVED***@link firebase.app.App app} associated with this `Firestore` service
     * instance.
     */
    app: firebase.app.App;
     ...
     * call to ***REMOVED***@link firebase.firestore.Firestore.disableNetwork
     * `disableNetwork()`}.
     *
     ...
     * ***REMOVED***@link firebase.firestore.Firestore.enableNetwork `enableNetwork()`}. While
     ...
     * listener.
     */
    onSnapshotsInSync(observer: ***REMOVED***
  ...
  ***REMOVED***): () => void;
     ...
     * @hidden
     */
    INTERNAL: ***REMOVED*** delete: () => Promise<void> };
***REMOVED***
   ...
   */
  export interface LoadBundleTask extends PromiseLike<LoadBundleTaskProgress> ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  export interface LoadBundleTaskProgress ***REMOVED***
...
***REMOVED***
   ...
   */
  export class Timestamp ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  export interface SnapshotListenOptions ***REMOVED***
    /**
...
***REMOVED***
   ...
   * ***REMOVED***@link firebase.firestore.DocumentReference.set DocumentReference}, ***REMOVED***@link
   * firebase.firestore.WriteBatch.set WriteBatch} and ***REMOVED***@link
...
***REMOVED***
   ...
   */
  export interface GetOptions ***REMOVED***
    /**
...
***REMOVED***
   ...
   */
  export class DocumentReference<T = DocumentData> ***REMOVED***
    private constructor();
    ...
    /**
     * The ***REMOVED***@link firebase.firestore.Firestore} the document is in.
...
***REMOVED***
   ...
   */
  export class DocumentSnapshot<T = DocumentData> ***REMOVED***
...
***REMOVED***
  ...
  export class QueryDocumentSnapshot<
    T = DocumentData
  > extends DocumentSnapshot<T> ***REMOVED***
    private constructor();
...
***REMOVED***
   ...
   */
  export class Query<T = DocumentData> ***REMOVED***
    protected constructor();
...
***REMOVED***
   ...
   * properties.
   */
  export class QuerySnapshot<T = DocumentData> ***REMOVED***
    private constructor();
...
***REMOVED***
   ...
   */
  export interface DocumentChange<T = DocumentData> ***REMOVED***
...
***REMOVED***
   ...
   */
  export class CollectionReference<T = DocumentData> extends Query<T> ***REMOVED***
    private constructor();
