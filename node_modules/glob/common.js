...
function ignoreMap (pattern) ***REMOVED***
  ...
  if (pattern.slice(-3) === '/**') ***REMOVED***
    ...
    gmatcher = new Minimatch(gpattern, ***REMOVED*** dot: true })
***REMOVED***

  return ***REMOVED***
    matcher: new Minimatch(pattern, ***REMOVED*** dot: true }),
    gmatcher: gmatcher
***REMOVED***
}
...
***REMOVED***
  ...
  if (self.windowsPathsNoEscape) ***REMOVED***
...
***REMOVED***
  ...
  // e.g. ***REMOVED*** cwd: '/test', root: __dirname } === path.join(__dirname, '/test')
