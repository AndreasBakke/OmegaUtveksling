import ***REMOVED*** GroupedTag, Sheet, SheetOptions } from './types';
declare type SheetConstructorArgs = ***REMOVED***
    isServer?: boolean;
    useCSSOMInjection?: boolean;
    target?: HTMLElement;
};
declare type GlobalStylesAllocationMap = ***REMOVED***
    [key: string]: number;
};
declare type NamesAllocationMap = Map<string, Set<string>>;
/** Contains the main stylesheet logic for stringification and caching */
export default class StyleSheet implements Sheet ***REMOVED***
