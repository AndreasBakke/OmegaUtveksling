 ...
 *
 * @param ***REMOVED***String|Number} val
 * @param ***REMOVED***Object} [options]
 * @throws ***REMOVED***Error} throw an error if val is not a non-empty string or a number
 * @return ***REMOVED***String|Number}
 * @api public
 */
...
module.exports = function (val, options) ***REMOVED***
  ...
  if (type === 'string' && val.length > 0) ***REMOVED***
    return parse(val);
***REMOVED*** else if (type === 'number' && isFinite(val)) ***REMOVED***
