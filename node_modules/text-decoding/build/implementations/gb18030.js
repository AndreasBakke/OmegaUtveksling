...
const index = require('../indexes'); const ***REMOVED***
...
***REMOVED***
  ...
  handler(stream, bite) ***REMOVED***
    ...
    if (bite === end_of_stream && this.gb18030_first === 0x00 &&
        this.gb18030_second === 0x00 && this.gb18030_third === 0x00) ***REMOVED***
      return finished
  ***REMOVED***
    ...
    if (bite === end_of_stream &&
        (this.gb18030_first !== 0x00 || this.gb18030_second !== 0x00 ||
          this.gb18030_third !== 0x00)) ***REMOVED***
      this.gb18030_first = 0x00
      this.gb18030_second = 0x00
      this.gb18030_third = 0x00
  ...
  ***REMOVED***
    ...
    if (this.gb18030_third !== 0x00) ***REMOVED***
      ...
      if (inRange(bite, 0x30, 0x39)) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (this.gb18030_second !== 0x00) ***REMOVED***
      // 1. If byte is in the range 0x81 to 0xFE, inclusive, set
      // gb18030 third to byte and return continue.
      if (inRange(bite, 0x81, 0xFE)) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (this.gb18030_first !== 0x00) ***REMOVED***
...
***REMOVED***
  ...
  constructor(options = ***REMOVED***}, gbk_flag = false) ***REMOVED***
