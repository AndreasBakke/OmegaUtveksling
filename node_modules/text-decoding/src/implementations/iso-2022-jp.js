import ***REMOVED*** inRange, decoderError, encoderError, isASCIICodePoint,
  end_of_stream, finished, floor } from '../utils'
import index, ***REMOVED*** indexCodePointFor, indexPointerFor } from '../indexes'
 ...
 */
export class ISO2022JPDecoder ***REMOVED***
...
***REMOVED***
   ...
   */
  handler(stream, bite) ***REMOVED***
  // switching on iso-2022-jp decoder state:
    switch (this.iso2022jp_decoder_state) ***REMOVED***
    default:
    ...
    ***REMOVED***
      ...
      if (inRange(bite, 0x00, 0x7F) && bite !== 0x0E && bite !== 0x0F
        && bite !== 0x1B && bite !== 0x5C && bite !== 0x7E) ***REMOVED***
      // Unset the iso-2022-jp output flag and return a code point
      // whose value is byte.
        this.iso2022jp_output_flag = false
        return bite
    ...
    ***REMOVED***
      ...
      // 0x21 to 0x5F
      if (inRange(bite, 0x21, 0x5F)) ***REMOVED***
      // Unset the iso-2022-jp output flag and return a code point
    ...
    ***REMOVED***
      ...
      // 0x21 to 0x7E
      if (inRange(bite, 0x21, 0x7E)) ***REMOVED***
    ...
    ***REMOVED***
    ...
    // Escape start
      ...
      // continue.
      if (bite === 0x24 || bite === 0x28) ***REMOVED***
        this.iso2022jp_lead = bite
    ...
    ***REMOVED***
    ...
    case this.states.Escape: ***REMOVED***
    // Escape
 ...
 */
export class ISO2022JPEncoder ***REMOVED***
  constructor() ***REMOVED***
...
***REMOVED***
   ...
   */
  handler(stream, code_point) ***REMOVED***
  // 1. If code point is end-of-stream and iso-2022-jp encoder
  // state is not ASCII, prepend code point to stream, set
  // iso-2022-jp encoder state to ASCII, and return three bytes
  // 0x1B 0x28 0x42.
    if (code_point === end_of_stream &&
      this.iso2022jp_state !== this.states.ASCII) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (this.iso2022jp_state === this.states.Roman &&
      ...
      (code_point == 0x00A5 || code_point == 0x203E))) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if ((code_point === 0x00A5 || code_point === 0x203E) &&
      this.iso2022jp_state !== this.states.Roman) ***REMOVED***
      stream.prepend(code_point)
      this.iso2022jp_state = this.states.Roman
  ...
  ***REMOVED***
    ...
    if (this.iso2022jp_state !== this.states.jis0208) ***REMOVED***
      stream.prepend(code_point)
