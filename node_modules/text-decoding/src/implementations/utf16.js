import ***REMOVED*** inRange, decoderError, end_of_stream, finished, convertCodeUnitToBytes } from '../utils'
 ...
 */
export class UTF16Decoder ***REMOVED***
  /**
   * @param ***REMOVED***boolean} utf16_be True if big-endian, false if little-endian.
   * @param ***REMOVED******REMOVED***fatal: boolean}} options
   */
  constructor(utf16_be, options) ***REMOVED***
...
***REMOVED***
  ...
  // utf-16 lead surrogate to null, and return error.
    if (bite === end_of_stream && (this.utf16_lead_byte !== null ||
                            this.utf16_lead_surrogate !== null)) ***REMOVED***
  ...
  ***REMOVED***
    ...
    // and return continue.
    if (this.utf16_lead_byte === null) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (this.utf16_lead_surrogate !== null) ***REMOVED***
      ...
      if (inRange(code_unit, 0xDC00, 0xDFFF)) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (inRange(code_unit, 0xD800, 0xDBFF)) ***REMOVED***
 ...
 */
export class UTF16Encoder ***REMOVED***
  /**
   * @param ***REMOVED***boolean} [utf16_be] True if big-endian, false if little-endian.
   */
  constructor(utf16_be = false) ***REMOVED***
    this.utf16_be = utf16_be
***REMOVED***
  /**
