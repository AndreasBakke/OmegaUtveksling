...
- [`getEncoding(label: string): ***REMOVED*** name: string, labels: Array<string> }`](#getencodinglabel-string--name-string-labels-arraystring-)
- [Encodings](#encodings)
- [Copyright](#copyright)
...
```js
import ***REMOVED*** TextEncoder, TextDecoder, EncodingIndexes, getEncoding } from 'text-decoding'
```
...
```js
import ***REMOVED*** TextDecoder } from 'text-decoding'
...
```js
import ***REMOVED*** TextEncoder } from 'text-decoding'

const uint8array = new TextEncoder(
  'windows-1252', ***REMOVED*** NONSTANDARD_allowLegacyEncoding: true })
  .encode('hello world')
...
## `getEncoding(`<br/>&nbsp;&nbsp;`label: string,`<br/>`): ***REMOVED*** name: string, labels: Array<string> }`
...
```js
import ***REMOVED*** getEncoding } from 'text-decoding'
