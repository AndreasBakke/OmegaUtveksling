...
```js
const ast = espree.parse('let foo = "bar"', ***REMOVED*** ecmaVersion: 6 });
console.log(ast);
```
...
const tokens = espree.tokenize('let foo = "bar"', ***REMOVED*** ecmaVersion: 6 });
console.log(tokens);
```
...
```
Token ***REMOVED*** type: 'Keyword', value: 'let', start: 0, end: 3 },
Token ***REMOVED*** type: 'Identifier', value: 'foo', start: 4, end: 7 },
Token ***REMOVED*** type: 'Punctuator', value: '=', start: 8, end: 9 },
Token ***REMOVED*** type: 'String', value: '"bar"', start: 10, end: 15 }
```
