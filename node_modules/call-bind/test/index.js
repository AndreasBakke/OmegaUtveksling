...
var functionsHaveConfigurableLengths = !!(
	...
	&& Object.getOwnPropertyDescriptor(bind.call(function () ***REMOVED***}), 'length').configurable
);

test('callBind', function (t) ***REMOVED***
	var sentinel = ***REMOVED*** sentinel: true };
	...
	t.equal(bound.length, func.length + 1, 'function length is preserved', ***REMOVED*** skip: !functionsHaveConfigurableLengths });
	...
	t.equal(boundR.length, func.length, 'function length is preserved', ***REMOVED*** skip: !functionsHaveConfigurableLengths });
	t.deepEqual(boundR(), [sentinel, undefined, undefined], 'bound func with receiver, with too few args');
	t.deepEqual(boundR(1, 2), [sentinel, 1, 2], 'bound func with receiver, with right args');
	t.deepEqual(boundR(1, 2, 3), [sentinel, 1, 2], 'bound func with receiver, with too many args');

	var boundArg = callBind(func, sentinel, 1);
	t.equal(boundArg.length, func.length - 1, 'function length is preserved', ***REMOVED*** skip: !functionsHaveConfigurableLengths });
