 ...
 * @private
 * @param ***REMOVED***string} uri The request uri
 * @param ***REMOVED***Options} reqOpts The request options
 * @returns ***REMOVED***HttpAnyAgent|undefined}
 */
