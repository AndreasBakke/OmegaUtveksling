...
var autoDestroy = function (self, err) ***REMOVED***
...
var toStreams2 = function(rs) ***REMOVED***
  return new (stream.Readable)(***REMOVED***objectMode:true, highWaterMark:16}).wrap(rs)
}
...
***REMOVED***
  ...
  var self = this
  var unend = eos(writable, ***REMOVED***writable:true, readable:false}, destroyer(this, this._forwardEnd))
...
***REMOVED***
  ...
  var self = this
  var unend = eos(readable, ***REMOVED***writable:false, readable:true}, destroyer(this))
...
Duplexify.prototype.destroy = function(err, cb) ***REMOVED***
  if (!cb) cb = noop
