 ...
 *
 * @param o The object.
 * @throws ***REMOVED***TypeError} If `o` is neither `Iterable`, nor an `ArrayLike`.
 */
 ...
 *
 * @param o The object.
 * @throws ***REMOVED***TypeError} If `o` is neither `AsyncIterable`, `Iterable`, nor an `ArrayLike`.
 */
 ...
 *
 * ```js
 * import Default, ***REMOVED*** Named, Other } from "mod";
 * // or
 * import ***REMOVED*** default as Default, Named, Other } from "mod";
 * ```
 *
 ...
 * @param mod The CommonJS module exports object.
 */
export declare function __importDefault<T>(mod: T): T | ***REMOVED*** default: T };
 ...
 *
 * @throws ***REMOVED***TypeError} If `state` doesn't have an entry for `receiver`.
 */
export declare function __classPrivateFieldGet<T extends object, V>(
    receiver: T,
    state: ***REMOVED*** has(o: T): boolean, get(o: T): V | undefined },
    kind?: "f"
): V;
 ...
 *
 * @throws ***REMOVED***TypeError} If `receiver` is not `state`.
 */
...
export declare function __classPrivateFieldSet<T extends object, V>(
    receiver: T,
    state: ***REMOVED*** has(o: T): boolean, set(o: T, value: V): unknown },
    value: V,
    kind?: "f"
): V;
...
export declare function __classPrivateFieldIn(
    state: (new (...args: any[]) => unknown) | ***REMOVED*** has(o: any): boolean },
    receiver: unknown,
): boolean;
