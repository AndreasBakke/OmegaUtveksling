...
const wrapAnsi16 = (fn, offset) => function () ***REMOVED***
	...
	return `\u001B[$***REMOVED***code + offset}m`;
};

const wrapAnsi256 = (fn, offset) => function () ***REMOVED***
	const code = fn.apply(colorConvert, arguments);
	return `\u001B[$***REMOVED***38 + offset};5;$***REMOVED***code}m`;
};

const wrapAnsi16m = (fn, offset) => function () ***REMOVED***
	const rgb = fn.apply(colorConvert, arguments);
	return `\u001B[$***REMOVED***38 + offset};2;$***REMOVED***rgb[0]};$***REMOVED***rgb[1]};$***REMOVED***rgb[2]}m`;
};
...
function assembleStyles() ***REMOVED***
	...
	for (const groupName of Object.keys(styles)) ***REMOVED***
		...
		for (const styleName of Object.keys(group)) ***REMOVED***
			...
			styles[styleName] = ***REMOVED***
				open: `\u001B[$***REMOVED***style[0]}m`,
				close: `\u001B[$***REMOVED***style[1]}m`
			};
	...
	styles.color.ansi = ***REMOVED***
		ansi: wrapAnsi16(ansi2ansi, 0)
	};
	styles.color.ansi256 = ***REMOVED***
	...
	styles.bgColor.ansi = ***REMOVED***
		ansi: wrapAnsi16(ansi2ansi, 10)
	};
	styles.bgColor.ansi256 = ***REMOVED***
	...
	for (let key of Object.keys(colorConvert)) ***REMOVED***
