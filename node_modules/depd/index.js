...
function convertDataDescriptorToAccessor (obj, prop, message) ***REMOVED***
  ...
  descriptor.get = function getter () ***REMOVED*** return value }

  if (descriptor.writable) ***REMOVED***
    descriptor.set = function setter (val) ***REMOVED*** return (value = val) }
***REMOVED***
...
function eehaslisteners (emitter, type) ***REMOVED***
