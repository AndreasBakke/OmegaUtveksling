...
import ***REMOVED*** ListModelsOptions, ModelOptions } from './machine-learning-api-client';
/** Response object for a listModels operation. */
export interface ListModelsResult ***REMOVED***
 ...
 * defined.
 */
export interface TFLiteModel ***REMOVED***
 ...
 */
export declare class MachineLearning ***REMOVED***
 ...
 */
export declare class Model ***REMOVED***
    private model;
    private readonly client?;
    /** The ID of the model. */
    get modelId(): string;
