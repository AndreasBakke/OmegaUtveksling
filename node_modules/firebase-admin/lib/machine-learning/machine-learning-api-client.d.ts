 ...
 */
export interface ModelOptionsBase ***REMOVED***
    displayName?: string;
    tags?: string[];
}
export interface GcsTfliteModelOptions extends ModelOptionsBase ***REMOVED***
    tfliteModel: ***REMOVED***
        gcsTfliteUri: string;
  ***REMOVED***;
}
 ...
 */
export interface AutoMLTfliteModelOptions extends ModelOptionsBase ***REMOVED***
    tfliteModel: ***REMOVED***
        automlModel: string;
  ***REMOVED***;
}
 ...
 */
export interface ListModelsOptions ***REMOVED***
    /**
...
export interface StatusErrorResponse ***REMOVED***
    readonly code: number;
    readonly message: string;
}
export declare type ModelUpdateOptions = ModelOptions & ***REMOVED***
    state?: ***REMOVED***
        published?: boolean;
  ***REMOVED***;
};
export declare function isGcsTfliteModelOptions(options: ModelOptions): options is GcsTfliteModelOptions;
export interface ModelContent ***REMOVED***
  ...
  ***REMOVED***;
    readonly tfliteModel?: ***REMOVED***
        readonly gcsTfliteUri?: string;
        readonly automlModel?: string;
        readonly sizeBytes: number;
  ***REMOVED***;
}
export interface ModelResponse extends ModelContent ***REMOVED***
...
export interface ListModelsResponse ***REMOVED***
    readonly models?: ModelResponse[];
    readonly nextPageToken?: string;
}
export interface OperationResponse ***REMOVED***
    readonly name?: string;
    readonly metadata?: ***REMOVED***
        [key: string]: any;
  ***REMOVED***;
