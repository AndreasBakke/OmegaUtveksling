...
import ***REMOVED*** AndroidApp, ShaCertificate } from './android-app';
import ***REMOVED*** IosApp } from './ios-app';
import ***REMOVED*** AppMetadata } from './app-metadata';
/**
 * The Firebase ProjectManagement service interface.
 */
export declare class ProjectManagement ***REMOVED***
    readonly app: App;
