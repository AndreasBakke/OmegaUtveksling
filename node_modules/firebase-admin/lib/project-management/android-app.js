 ...
 *
 * Do not call this constructor directly. Instead, use ***REMOVED***@link ProjectManagement.androidApp}.
 */
class AndroidApp ***REMOVED***
    /**
     * @internal
     */
    constructor(appId, requestHandler) ***REMOVED***
      ...
      ***REMOVED***
        this.resourceName = `projects/-/androidApps/$***REMOVED***appId}`;
  ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    getShaCertificates() ***REMOVED***
        return this.requestHandler.getAndroidShaCertificates(this.resourceName)
            ...
            if (!responseData.certificates) ***REMOVED***
                return [];
          ***REMOVED***
            ...
            return responseData.certificates.map((certificateJson) => ***REMOVED***
                requiredFieldsList.forEach((requiredField) => ***REMOVED***
                    (0, project_management_api_request_internal_1.assertServerResponse)(validator.isNonEmptyString(certificateJson[requiredField]), responseData, `getShaCertificates()'s responseData.certificates[].$***REMOVED***requiredField} must be a `
                        + 'non-empty string.');
              ***REMOVED***);
  ...
  ***REMOVED***
     ...
     */
    addShaCertificate(certificateToAdd) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    deleteShaCertificate(certificateToDelete) ***REMOVED***
        if (!certificateToDelete.resourceName) ***REMOVED***
...
class ShaCertificate ***REMOVED***
     ...
     * @internal
     */
    constructor(shaHash, resourceName) ***REMOVED***
        this.shaHash = shaHash;
        this.resourceName = resourceName;
        if (/^[a-fA-F0-9]***REMOVED***40}$/.test(shaHash)) ***REMOVED***
            this.certType = 'sha1';
      ***REMOVED***
        else if (/^[a-fA-F0-9]***REMOVED***64}$/.test(shaHash)) ***REMOVED***
