...
export declare namespace messaging ***REMOVED***
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#Messaging}.
     */
    type Messaging = TMessaging;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#AndroidConfig}.
     */
    type AndroidConfig = TAndroidConfig;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#AndroidFcmOptions}.
     */
    type AndroidFcmOptions = TAndroidFcmOptions;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#AndroidNotification}.
     */
    type AndroidNotification = TAndroidNotification;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#ApnsConfig}.
     */
    type ApnsConfig = TApnsConfig;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#ApnsFcmOptions}.
     */
    type ApnsFcmOptions = TApnsFcmOptions;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#ApnsPayload}.
     */
    type ApnsPayload = TApnsPayload;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#Aps}.
     */
    type Aps = TAps;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#ApsAlert}.
     */
    type ApsAlert = TApsAlert;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#BatchResponse}.
     */
    type BatchResponse = TBatchResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#CriticalSound}.
     */
    type CriticalSound = TCriticalSound;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#ConditionMessage}.
     */
    type ConditionMessage = TConditionMessage;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#FcmOptions}.
     */
    type FcmOptions = TFcmOptions;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#LightSettings}.
     */
    type LightSettings = TLightSettings;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#Message}.
     */
    type Message = TMessage;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingTopicManagementResponse}.
     */
    type MessagingTopicManagementResponse = TMessagingTopicManagementResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MulticastMessage}.
     */
    type MulticastMessage = TMulticastMessage;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#Notification}.
     */
    type Notification = TNotification;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#SendResponse}.
     */
    type SendResponse = TSendResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#TokenMessage}.
     */
    type TokenMessage = TTokenMessage;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#TopicMessage}.
     */
    type TopicMessage = TTopicMessage;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#WebpushConfig}.
     */
    type WebpushConfig = TWebpushConfig;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#WebpushFcmOptions}.
     */
    type WebpushFcmOptions = TWebpushFcmOptions;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#WebpushNotification}.
     */
    type WebpushNotification = TWebpushNotification;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#DataMessagePayload}.
     */
    type DataMessagePayload = TDataMessagePayload;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingConditionResponse}.
     */
    type MessagingConditionResponse = TMessagingConditionResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingDeviceGroupResponse}.
     */
    type MessagingDeviceGroupResponse = TMessagingDeviceGroupResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingDeviceResult}.
     */
    type MessagingDeviceResult = TMessagingDeviceResult;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingDevicesResponse}.
     */
    type MessagingDevicesResponse = TMessagingDevicesResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingOptions}.
     */
    type MessagingOptions = TMessagingOptions;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingPayload}.
     */
    type MessagingPayload = TMessagingPayload;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#MessagingTopicResponse}.
     */
    type MessagingTopicResponse = TMessagingTopicResponse;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.messaging#NotificationMessagePayload}.
     */
