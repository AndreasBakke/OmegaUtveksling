...
export declare namespace remoteConfig ***REMOVED***
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#ExplicitParameterValue}.
     */
    type ExplicitParameterValue = TExplicitParameterValue;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#InAppDefaultValue}.
     */
    type InAppDefaultValue = TInAppDefaultValue;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#ListVersionsOptions}.
     */
    type ListVersionsOptions = TListVersionsOptions;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#ListVersionsResult}.
     */
    type ListVersionsResult = TListVersionsResult;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#ParameterValueType}.
     */
    type ParameterValueType = TParameterValueType;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfig}.
     */
    type RemoteConfig = TRemoteConfig;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfigCondition}.
     */
    type RemoteConfigCondition = TRemoteConfigCondition;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfigParameter}.
     */
    type RemoteConfigParameter = TRemoteConfigParameter;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfigParameterGroup}.
     */
    type RemoteConfigParameterGroup = TRemoteConfigParameterGroup;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfigParameterValue}.
     */
    type RemoteConfigParameterValue = TRemoteConfigParameterValue;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfigTemplate}.
     */
    type RemoteConfigTemplate = TRemoteConfigTemplate;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#RemoteConfigUser}.
     */
    type RemoteConfigUser = TRemoteConfigUser;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#TagColor}.
     */
    type TagColor = TTagColor;
    /**
     * Type alias to ***REMOVED***@link firebase-admin.remote-config#Version}.
     */
