...
import ***REMOVED*** ListVersionsOptions, ListVersionsResult, RemoteConfigTemplate } from './remote-config-api';
/**
 * The Firebase `RemoteConfig` service interface.
 */
export declare class RemoteConfig ***REMOVED***
    readonly app: App;
    private readonly client;
    /**
     * Gets the current active version of the ***REMOVED***@link RemoteConfigTemplate} of the project.
     *
     * @returns A promise that fulfills with a `RemoteConfigTemplate`.
     */
    getTemplate(): Promise<RemoteConfigTemplate>;
    /**
     * Gets the requested version of the ***REMOVED***@link RemoteConfigTemplate} of the project.
     *
    ...
    /**
     * Validates a ***REMOVED***@link RemoteConfigTemplate}.
     *
     ...
     *      See ***REMOVED***@link https://firebase.google.com/docs/remote-config/use-config-rest#etag_usage_and_forced_updates |
     *      ETag usage and forced updates}.
     *
     * @returns A Promise that fulfills with the published `RemoteConfigTemplate`.
     */
    publishTemplate(template: RemoteConfigTemplate, options?: ***REMOVED***
        force: boolean;
  ***REMOVED***): Promise<RemoteConfigTemplate>;
    /**
