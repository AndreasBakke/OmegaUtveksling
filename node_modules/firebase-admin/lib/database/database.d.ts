...
import ***REMOVED*** FirebaseDatabase } from '@firebase/database-types';
import ***REMOVED*** App } from '../app';
/**
 * The Firebase Database service interface. Extends the
 * ***REMOVED***@link https://firebase.google.com/docs/reference/js/firebase.database.Database | Database}
 * interface provided by the `@firebase/database` package.
 */
export interface Database extends FirebaseDatabase ***REMOVED***
    /**
...
export declare class DatabaseService ***REMOVED***
