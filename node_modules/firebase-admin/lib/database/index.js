...
/**
 * Gets the ***REMOVED***@link Database} service for the default
 * app or a given app.
 *
 ...
 */
function getDatabase(app) ***REMOVED***
    return getDatabaseInstance(***REMOVED*** app });
}
 ...
 * app's ***REMOVED***@link Database} service or as `getDatabaseWithUrl(app)` to access the
 * ***REMOVED***@link Database} service associated with a specific app.
 *
 * @example
 * ```javascript
 * // Get the Database service for the default app
 ...
 *   is provided or the `Database` service associated with the provided app.
 */
function getDatabaseWithUrl(url, app) ***REMOVED***
    return getDatabaseInstance(***REMOVED*** url, app });
}
exports.getDatabaseWithUrl = getDatabaseWithUrl;
function getDatabaseInstance(options) ***REMOVED***
    let ***REMOVED*** app } = options;
