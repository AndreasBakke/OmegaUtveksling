...
import ***REMOVED*** TenantManager } from './tenant-manager';
import ***REMOVED*** BaseAuth } from './base-auth';
import ***REMOVED*** ProjectConfigManager } from './project-config-manager';
/**
 * Auth service bound to the provided app.
 * An Auth instance can have multiple tenants.
 */
export declare class Auth extends BaseAuth ***REMOVED***
