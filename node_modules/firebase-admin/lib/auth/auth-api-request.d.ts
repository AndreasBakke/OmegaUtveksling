 ...
 */
import ***REMOVED*** App } from '../app/index';
import ***REMOVED*** UserImportOptions, UserImportRecord, UserImportResult } from './user-import-builder';
import ***REMOVED*** TenantServerResponse, CreateTenantRequest, UpdateTenantRequest } from './tenant';
import ***REMOVED*** ProjectConfigServerResponse, UpdateProjectConfigRequest } from './project-config';
...
declare class AuthResourceUrlBuilder ***REMOVED***
    protected app: App;
...
interface BatchDeleteErrorInfo ***REMOVED***
    index?: number;
    localId?: string;
    message?: string;
}
export interface BatchDeleteAccountsResponse ***REMOVED***
 ...
 */
export declare class AuthRequestHandler extends AbstractAuthRequestHandler ***REMOVED***
     ...
     */
    listTenants(maxResults?: number, pageToken?: string): Promise<***REMOVED***
 ...
 */
export declare class TenantAwareAuthRequestHandler extends AbstractAuthRequestHandler ***REMOVED***
