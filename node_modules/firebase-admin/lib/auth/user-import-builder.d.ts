...
import ***REMOVED*** FirebaseArrayIndexError } from '../app/index';
import ***REMOVED*** UpdateMultiFactorInfoRequest, MultiFactorUpdateSettings } from './auth-config';
...
/**
   ...
   * ***REMOVED***@link BaseAuth.importUsers} method. This is used to
   * provide the password hashing algorithm information.
   */
export interface UserImportOptions ***REMOVED***
    /**
 ...
 * ***REMOVED***@link BaseAuth.importUsers} method.
 */
export interface UserImportRecord ***REMOVED***
    /**
     * The user's `uid`.
     */
    uid: string;
 ...
 */
export interface UserMetadataRequest ***REMOVED***
    /**
 ...
 */
export interface UserProviderRequest ***REMOVED***
    /**
...
/**
   ...
   * ***REMOVED***@link BaseAuth.importUsers} method for batch
   * importing users to Firebase Auth.
   */
export interface UserImportResult ***REMOVED***
    /**
...
export interface AuthFactorInfo ***REMOVED***
...
interface UploadAccountUser ***REMOVED***
    localId: string;
    email?: string;
    emailVerified?: boolean;
    displayName?: string;
    ...
    photoUrl?: string;
    phoneNumber?: string;
    providerUserInfo?: Array<***REMOVED***
        rawId: string;
        providerId: string;
        email?: string;
        displayName?: string;
...
export interface UploadAccountOptions ***REMOVED***
...
export interface UploadAccountRequest extends UploadAccountOptions ***REMOVED***
 ...
 */
export declare class UserImportBuilder ***REMOVED***
     ...
     */
    buildResponse(failedUploads: Array<***REMOVED***
        index: number;
        message: string;
  ***REMOVED***>): UserImportResult;
    /**
