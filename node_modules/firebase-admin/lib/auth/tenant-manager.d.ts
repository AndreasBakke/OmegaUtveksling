 ...
 */
import ***REMOVED*** BaseAuth, SessionCookieOptions } from './base-auth';
import ***REMOVED*** Tenant, CreateTenantRequest, UpdateTenantRequest } from './tenant';
import ***REMOVED*** DecodedIdToken } from './token-verifier';
/**
 * Interface representing the object returned from a
 * ***REMOVED***@link TenantManager.listTenants}
 * operation.
 * Contains the list of tenants for the current batch and the next page token if available.
 */
export interface ListTenantsResult ***REMOVED***
    /**
     * The list of ***REMOVED***@link Tenant} objects for the downloaded batch.
     */
    tenants: Tenant[];
    /**
 ...
 * ***REMOVED***@link TenantManager.authForTenant}.
 */
export declare class TenantAwareAuth extends BaseAuth ***REMOVED***
    /**
    ...
    /**
     * ***REMOVED***@inheritdoc BaseAuth.verifyIdToken}
     */
    verifyIdToken(idToken: string, checkRevoked?: boolean): Promise<DecodedIdToken>;
    /**
     * ***REMOVED***@inheritdoc BaseAuth.createSessionCookie}
     */
    createSessionCookie(idToken: string, sessionCookieOptions: SessionCookieOptions): Promise<string>;
    /**
     * ***REMOVED***@inheritdoc BaseAuth.verifySessionCookie}
     */
 ...
 * </ul>
 */
export declare class TenantManager ***REMOVED***
