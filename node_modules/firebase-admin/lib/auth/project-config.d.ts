...
import ***REMOVED*** SmsRegionConfig } from './auth-config';
/**
 * Interface representing the properties to update on the provided project config.
 */
export interface UpdateProjectConfigRequest ***REMOVED***
    /**
 ...
 */
export interface ProjectConfigServerResponse ***REMOVED***
    smsRegionConfig?: SmsRegionConfig;
}
/**
 ...
 * This object currently exposes only the SMS Region config.
 */
export interface ProjectConfigClientRequest ***REMOVED***
    smsRegionConfig?: SmsRegionConfig;
}
/**
* Represents a project configuration.
*/
export declare class ProjectConfig ***REMOVED***
    /**
