 ...
 */
class TenantAwareAuth extends base_auth_1.BaseAuth ***REMOVED***
    /**
  ...
  ***REMOVED***
    ...
    verifyIdToken(idToken, checkRevoked = false) ***REMOVED***
        return super.verifyIdToken(idToken, checkRevoked)
            .then((decodedClaims) => ***REMOVED***
            // Validate tenant ID.
            if (decodedClaims.firebase.tenant !== this.tenantId) ***REMOVED***
  ...
  ***REMOVED***
    ...
    createSessionCookie(idToken, sessionCookieOptions) ***REMOVED***
        ...
        if (!validator.isNonEmptyString(idToken)) ***REMOVED***
...
class TenantManager ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    authForTenant(tenantId) ***REMOVED***
      ...
      ***REMOVED***
        if (typeof this.tenantsMap[tenantId] === 'undefined') ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    listTenants(maxResults, pageToken) ***REMOVED***
        return this.authRequestHandler.listTenants(maxResults, pageToken)
            ...
            response.tenants.forEach((tenantResponse) => ***REMOVED***
