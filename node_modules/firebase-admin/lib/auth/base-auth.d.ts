 ...
 */
import ***REMOVED*** FirebaseArrayIndexError } from '../app';
import ***REMOVED*** DecodedIdToken, DecodedAuthBlockingToken } from './token-verifier';
import ***REMOVED*** AuthProviderConfig, AuthProviderConfigFilter, ListProviderConfigResults, UpdateAuthProviderRequest, CreateRequest, UpdateRequest } from './auth-config';
import ***REMOVED*** UserRecord } from './user-record';
import ***REMOVED*** UserIdentifier } from './identifier';
import ***REMOVED*** UserImportOptions, UserImportRecord, UserImportResult } from './user-import-builder';
import ***REMOVED*** ActionCodeSettings } from './action-code-settings-builder';
/** Represents the result of the ***REMOVED***@link BaseAuth.getUsers} API. */
export interface GetUsersResult ***REMOVED***
    /**
 ...
 * ***REMOVED***@link BaseAuth.listUsers} operation. Contains the list
 * of users for the current batch and the next page token if available.
 */
export interface ListUsersResult ***REMOVED***
    /**
     * The list of ***REMOVED***@link UserRecord} objects for the
...
/**
 * Represents the result of the ***REMOVED***@link BaseAuth.deleteUsers}.
 * API.
 */
export interface DeleteUsersResult ***REMOVED***
    /**
     ...
     * the return value of ***REMOVED***@link DeleteUsersResult.failureCount}.
     */
    errors: FirebaseArrayIndexError[];
}
/**
 * Interface representing the session cookie options needed for the
 * ***REMOVED***@link BaseAuth.createSessionCookie} method.
 */
export interface SessionCookieOptions ***REMOVED***
    /**
 ...
 */
export declare abstract class BaseAuth ***REMOVED***
    /**
