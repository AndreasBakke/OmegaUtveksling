 ...
 */
import ***REMOVED*** EmailSignInConfigServerRequest, MultiFactorAuthServerConfig, MultiFactorConfig, EmailSignInProviderConfig, SmsRegionConfig } from './auth-config';
/**
 * Interface representing the properties to update on the provided tenant.
 */
export interface UpdateTenantRequest ***REMOVED***
    /**
...
export interface TenantOptionsServerRequest extends EmailSignInConfigServerRequest ***REMOVED***
    displayName?: string;
...
export interface TenantServerResponse ***REMOVED***
    name: string;
    displayName?: string;
 ...
 */
export declare class Tenant ***REMOVED***
    /**
     ...
     */
    readonly testPhoneNumbers?: ***REMOVED***
        [phoneNumber: string]: string;
  ***REMOVED***;
