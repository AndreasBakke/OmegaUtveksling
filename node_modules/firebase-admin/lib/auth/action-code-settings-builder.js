 ...
 * @internal
 */
class ActionCodeSettingsBuilder ***REMOVED***
    /**
     * ActionCodeSettingsBuilder constructor.
     *
     * @param ***REMOVED***ActionCodeSettings} actionCodeSettings The ActionCodeSettings
     *     object used to initiliaze this server request builder.
     * @constructor
     */
    constructor(actionCodeSettings) ***REMOVED***
        if (!validator.isNonNullObject(actionCodeSettings)) ***REMOVED***
      ...
      ***REMOVED***
        if (typeof actionCodeSettings.url === 'undefined') ***REMOVED***
            throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.MISSING_CONTINUE_URI);
      ***REMOVED***
        else if (!validator.isURL(actionCodeSettings.url)) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (typeof actionCodeSettings.handleCodeInApp !== 'undefined' &&
            !validator.isBoolean(actionCodeSettings.handleCodeInApp)) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (typeof actionCodeSettings.dynamicLinkDomain !== 'undefined' &&
            !validator.isNonEmptyString(actionCodeSettings.dynamicLinkDomain)) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (typeof actionCodeSettings.iOS !== 'undefined') ***REMOVED***
            if (!validator.isNonNullObject(actionCodeSettings.iOS)) ***REMOVED***
          ...
          ***REMOVED***
            else if (typeof actionCodeSettings.iOS.bundleId === 'undefined') ***REMOVED***
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.MISSING_IOS_BUNDLE_ID);
          ***REMOVED***
            else if (!validator.isNonEmptyString(actionCodeSettings.iOS.bundleId)) ***REMOVED***
      ...
      ***REMOVED***
        if (typeof actionCodeSettings.android !== 'undefined') ***REMOVED***
            if (!validator.isNonNullObject(actionCodeSettings.android)) ***REMOVED***
          ...
          ***REMOVED***
            else if (typeof actionCodeSettings.android.packageName === 'undefined') ***REMOVED***
                throw new error_1.FirebaseAuthError(error_1.AuthClientErrorCode.MISSING_ANDROID_PACKAGE_NAME);
          ***REMOVED***
            else if (!validator.isNonEmptyString(actionCodeSettings.android.packageName)) ***REMOVED***
          ...
          ***REMOVED***
                ...
                !validator.isNonEmptyString(actionCodeSettings.android.minimumVersion)) ***REMOVED***
          ...
          ***REMOVED***
                ...
                !validator.isBoolean(actionCodeSettings.android.installApp)) ***REMOVED***
    ...
    buildRequest() ***REMOVED***
      ...
      ***REMOVED***;
        ...
        for (const key in request) ***REMOVED***
            if (Object.prototype.hasOwnProperty.call(request, key)) ***REMOVED***
                if (typeof request[key] === 'undefined' || request[key] === null) ***REMOVED***
                    delete request[key];
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
