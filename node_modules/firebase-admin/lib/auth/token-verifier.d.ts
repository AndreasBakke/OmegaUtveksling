 ...
 * ***REMOVED***@link BaseAuth.verifyIdToken} method.
 *
 ...
 */
export interface DecodedIdToken ***REMOVED***
    /**
...
/** @alpha */
export interface DecodedAuthBlockingSharedUserInfo ***REMOVED***
    uid: string;
    display_name?: string;
    email?: string;
    photo_url?: string;
...
/** @alpha */
export interface DecodedAuthBlockingMetadata ***REMOVED***
    creation_time?: number;
    last_sign_in_time?: number;
}
/** @alpha */
export interface DecodedAuthBlockingUserInfo extends DecodedAuthBlockingSharedUserInfo ***REMOVED***
    provider_id: string;
}
/** @alpha */
export interface DecodedAuthBlockingMfaInfo ***REMOVED***
    uid: string;
    display_name?: string;
    phone_number?: string;
...
/** @alpha */
export interface DecodedAuthBlockingEnrolledFactors ***REMOVED***
    enrolled_factors?: DecodedAuthBlockingMfaInfo[];
}
/** @alpha */
export interface DecodedAuthBlockingUserRecord extends DecodedAuthBlockingSharedUserInfo ***REMOVED***
    email_verified?: boolean;
    disabled?: boolean;
...
/** @alpha */
export interface DecodedAuthBlockingToken ***REMOVED***
    aud: string;
    exp: number;
    iat: number;
    iss: string;
