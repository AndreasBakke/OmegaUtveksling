 ...
 *
 * @deprecated Use ***REMOVED***@link firebase-admin.installations#Installations} instead.
 */
class InstanceId ***REMOVED***
    /**
  ...
  ***REMOVED***
     ...
     * ***REMOVED***@link https://firebase.google.com/support/privacy/manage-iids#delete_an_instance_id |
     ...
     */
    deleteInstanceId(instanceId) ***REMOVED***
        return (0, installations_1.getInstallations)(this.app).deleteInstallation(instanceId)
            .catch((err) => ***REMOVED***
            if (err instanceof error_1.FirebaseInstallationsError) ***REMOVED***
                let code = err.code.replace('installations/', '');
                if (code === error_1.InstallationsClientErrorCode.INVALID_INSTALLATION_ID.code) ***REMOVED***
                    code = error_1.InstanceIdClientErrorCode.INVALID_INSTANCE_ID.code;
              ***REMOVED***
                throw new error_1.FirebaseInstanceIdError(***REMOVED*** code, message: err.message });
          ***REMOVED***
            throw err;
      ***REMOVED***);
  ***REMOVED***
