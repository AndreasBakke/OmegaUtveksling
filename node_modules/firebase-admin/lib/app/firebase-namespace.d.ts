 ...
 */
import ***REMOVED*** AppStore } from './lifecycle';
import ***REMOVED*** app, appCheck, auth, messaging, machineLearning, storage, firestore, database, instanceId, installations, projectManagement, securityRules, remoteConfig, AppOptions } from '../firebase-namespace-api';
import ***REMOVED*** cert, refreshToken, applicationDefault } from './credential-factory';
import App = app.App;
...
export interface FirebaseServiceNamespace<T> ***REMOVED***
    (app?: App): T;
    [key: string]: any;
}
/**
 ...
 */
export declare class FirebaseNamespaceInternals ***REMOVED***
 ...
 */
export declare class FirebaseNamespace ***REMOVED***
    __esModule: boolean;
    credential: ***REMOVED***
        cert: typeof cert;
