 ...
 */
class ServiceAccountCredential ***REMOVED***
    /**
     ...
     * @constructor
     */
    constructor(serviceAccountPathOrObject, httpAgent, implicit = false) ***REMOVED***
  ...
  ***REMOVED***
    getAccessToken() ***REMOVED***
        ...
        const request = ***REMOVED***
            method: 'POST',
            url: `https://$***REMOVED***GOOGLE_AUTH_TOKEN_HOST}$***REMOVED***GOOGLE_AUTH_TOKEN_PATH}`,
            headers: ***REMOVED***
  ...
  ***REMOVED***
    ...
    createAuthJwt_() ***REMOVED***
      ...
      ***REMOVED***;
        ...
        return jwt.sign(claims, this.privateKey, ***REMOVED***
 ...
 */
class ServiceAccount ***REMOVED***
    constructor(json) ***REMOVED***
        if (!util.isNonNullObject(json)) ***REMOVED***
      ...
      ***REMOVED***
        ...
        let errorMessage;
        if (!util.isNonEmptyString(this.projectId)) ***REMOVED***
            errorMessage = 'Service account object must contain a string "project_id" property.';
      ***REMOVED***
        else if (!util.isNonEmptyString(this.privateKey)) ***REMOVED***
            errorMessage = 'Service account object must contain a string "private_key" property.';
      ***REMOVED***
        else if (!util.isNonEmptyString(this.clientEmail)) ***REMOVED***
      ...
      ***REMOVED***
  ***REMOVED***
    static fromPath(filePath) ***REMOVED***
        try ***REMOVED***
 ...
 */
class ComputeEngineCredential ***REMOVED***
    constructor(httpAgent) ***REMOVED***
        this.httpClient = new api_request_1.HttpClient();
        this.httpAgent = httpAgent;
  ***REMOVED***
    getAccessToken() ***REMOVED***
  ...
  ***REMOVED***
    ...
    */
    getIDToken(audience) ***REMOVED***
        const request = this.buildRequest(`$***REMOVED***GOOGLE_METADATA_SERVICE_IDENTITY_PATH}?audience=$***REMOVED***audience}`);
  ...
  ***REMOVED***
    getProjectId() ***REMOVED***
      ...
      ***REMOVED***)
            ...
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_CREDENTIAL, `Failed to determine project ID: $***REMOVED***detail}`);
      ***REMOVED***);
  ***REMOVED***
    getServiceAccountEmail() ***REMOVED***
      ...
      ***REMOVED***)
            .catch((err) => ***REMOVED***
            const detail = (err instanceof api_request_1.HttpError) ? getDetailFromResponse(err.response) : err.message;
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_CREDENTIAL, `Failed to determine service account email: $***REMOVED***detail}`);
      ***REMOVED***);
  ***REMOVED***
    buildRequest(urlPath) ***REMOVED***
        return ***REMOVED***
            method: 'GET',
            url: `http://$***REMOVED***GOOGLE_METADATA_SERVICE_HOST}$***REMOVED***urlPath}`,
            headers: ***REMOVED***
 ...
 */
class RefreshTokenCredential ***REMOVED***
    /**
     ...
     * @constructor
     */
    constructor(refreshTokenPathOrObject, httpAgent, implicit = false) ***REMOVED***
        this.httpAgent = httpAgent;
        this.implicit = implicit;
  ...
  ***REMOVED***
    getAccessToken() ***REMOVED***
        ...
        const request = ***REMOVED***
            method: 'POST',
            url: `https://$***REMOVED***REFRESH_TOKEN_HOST}$***REMOVED***REFRESH_TOKEN_PATH}`,
            headers: ***REMOVED***
                'Content-Type': 'application/x-www-form-urlencoded',
          ***REMOVED***,
            data: postData,
...
class RefreshToken ***REMOVED***
    constructor(json) ***REMOVED***
        ...
        let errorMessage;
        if (!util.isNonEmptyString(this.clientId)) ***REMOVED***
            errorMessage = 'Refresh token must contain a "client_id" property.';
      ***REMOVED***
        else if (!util.isNonEmptyString(this.clientSecret)) ***REMOVED***
            errorMessage = 'Refresh token must contain a "client_secret" property.';
      ***REMOVED***
        else if (!util.isNonEmptyString(this.refreshToken)) ***REMOVED***
            errorMessage = 'Refresh token must contain a "refresh_token" property.';
      ***REMOVED***
        else if (!util.isNonEmptyString(this.type)) ***REMOVED***
 ...
 */
class ImpersonatedServiceAccountCredential ***REMOVED***
    /**
     ...
     * @constructor
     */
    constructor(impersonatedServiceAccountPathOrObject, httpAgent, implicit = false) ***REMOVED***
        this.httpAgent = httpAgent;
        this.implicit = implicit;
 ...
 */
class ImpersonatedServiceAccount ***REMOVED***
    constructor(json) ***REMOVED***
        const sourceCredentials = json['source_credentials'];
        if (sourceCredentials) ***REMOVED***
 ...
 */
function isApplicationDefault(credential) ***REMOVED***
...
function getApplicationDefault(httpAgent) ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (GCLOUD_CREDENTIAL_PATH) ***REMOVED***
 ...
 */
function requestAccessToken(client, request) ***REMOVED***
    return client.send(request).then((resp) => ***REMOVED***
        const json = resp.data;
        if (!json.access_token || !json.expires_in) ***REMOVED***
            throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_CREDENTIAL, `Unexpected response while fetching access token: $***REMOVED***JSON.stringify(json)}`);
      ***REMOVED***
        return json;
 ...
 */
function requestIDToken(client, request) ***REMOVED***
    return client.send(request).then((resp) => ***REMOVED***
 ...
 */
function getErrorMessage(err) ***REMOVED***
    const detail = (err instanceof api_request_1.HttpError) ? getDetailFromResponse(err.response) : err.message;
    return `Error fetching access token: $***REMOVED***detail}`;
}
/**
 ...
 */
function getDetailFromResponse(response) ***REMOVED***
    if (response.isJson() && response.data.error) ***REMOVED***
...
function credentialFromFile(filePath, httpAgent, ignoreMissing) ***REMOVED***
    const credentialsFile = readCredentialFile(filePath, ignoreMissing);
    if (typeof credentialsFile !== 'object' || credentialsFile === null) ***REMOVED***
        if (ignoreMissing) ***REMOVED***
            return null;
      ***REMOVED***
  ...
  ***REMOVED***
    if (credentialsFile.type === 'service_account') ***REMOVED***
        return new ServiceAccountCredential(credentialsFile, httpAgent, true);
  ***REMOVED***
    if (credentialsFile.type === 'authorized_user') ***REMOVED***
        return new RefreshTokenCredential(credentialsFile, httpAgent, true);
  ***REMOVED***
    if (credentialsFile.type === 'impersonated_service_account') ***REMOVED***
...
function readCredentialFile(filePath, ignoreMissing) ***REMOVED***
    let fileText;
    try ***REMOVED***
  ...
  ***REMOVED***
        ...
        if (ignoreMissing) ***REMOVED***
            return null;
      ***REMOVED***
        throw new error_1.FirebaseAppError(error_1.AppErrorCodes.INVALID_CREDENTIAL, `Failed to read credentials from file $***REMOVED***filePath}: ` + error);
  ***REMOVED***
    try ***REMOVED***
