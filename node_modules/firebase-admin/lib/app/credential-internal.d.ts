...
import ***REMOVED*** Credential, GoogleOAuthAccessToken } from './credential';
/**
 * Implementation of Credential that uses a service account.
 */
export declare class ServiceAccountCredential implements Credential ***REMOVED***
 ...
 */
export declare class ComputeEngineCredential implements Credential ***REMOVED***
    private readonly httpClient;
    private readonly httpAgent?;
    private projectId?;
    private accountId?;
 ...
 */
export declare class RefreshTokenCredential implements Credential ***REMOVED***
    private readonly httpAgent?;
    readonly implicit: boolean;
 ...
 */
export declare class ImpersonatedServiceAccountCredential implements Credential ***REMOVED***
    private readonly httpAgent?;
    readonly implicit: boolean;
