...
const globalCertCreds = ***REMOVED***};
const globalRefreshTokenCreds = ***REMOVED***};
/**
 ...
 */
function applicationDefault(httpAgent) ***REMOVED***
 ...
 */
function cert(serviceAccountPathOrObject, httpAgent) ***REMOVED***
 ...
 *   provided service account that can be used to initialize an app.
 */
function refreshToken(refreshTokenPathOrObject, httpAgent) ***REMOVED***
 ...
 */
function clearGlobalAppDefaultCred() ***REMOVED***
