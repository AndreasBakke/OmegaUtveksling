...
class Storage ***REMOVED***
    ...
    constructor(app) ***REMOVED***
        if (!validator.isNonNullObject(app) || !('options' in app)) ***REMOVED***
          ...
          ***REMOVED***);
      ***REMOVED***
        if (!process.env.STORAGE_EMULATOR_HOST && process.env.FIREBASE_STORAGE_EMULATOR_HOST) ***REMOVED***
            const firebaseStorageEmulatorHost = process.env.FIREBASE_STORAGE_EMULATOR_HOST;
            if (firebaseStorageEmulatorHost.match(/https?:\/\//)) ***REMOVED***
                throw new error_1.FirebaseError(***REMOVED***
                    code: 'storage/invalid-emulator-host',
                    message: 'FIREBASE_STORAGE_EMULATOR_HOST should not contain a protocol (http or https).',
              ***REMOVED***);
          ***REMOVED***
            process.env.STORAGE_EMULATOR_HOST = `http://$***REMOVED***process.env.FIREBASE_STORAGE_EMULATOR_HOST}`;
      ***REMOVED***
        let storage;
        try ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (credential instanceof credential_internal_1.ServiceAccountCredential) ***REMOVED***
            this.storageClient = new storage(***REMOVED***
  ...
  ***REMOVED***
     ...
     * @returns A ***REMOVED***@link https://cloud.google.com/nodejs/docs/reference/storage/latest/Bucket | Bucket}
