 ...
 */
class IAMSigner ***REMOVED***
    constructor(httpClient, serviceAccountId) ***REMOVED***
        this.algorithm = ALGORITHM_RS256;
        if (!httpClient) ***REMOVED***
            throw new CryptoSignerError(***REMOVED***
                code: CryptoSignerErrorCode.INVALID_ARGUMENT,
                message: 'INTERNAL ASSERT: Must provide a HTTP client to initialize IAMSigner.',
          ***REMOVED***);
      ***REMOVED***
        if (typeof serviceAccountId !== 'undefined' && !validator.isNonEmptyString(serviceAccountId)) ***REMOVED***
            throw new CryptoSignerError(***REMOVED***
                code: CryptoSignerErrorCode.INVALID_ARGUMENT,
  ...
  ***REMOVED***
     ...
     */
    sign(buffer) ***REMOVED***
        return this.getAccountId().then((serviceAccount) => ***REMOVED***
            const request = ***REMOVED***
                method: 'POST',
                url: `https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/$***REMOVED***serviceAccount}:signBlob`,
                data: ***REMOVED*** payload: buffer.toString('base64') },
          ***REMOVED***;
  ...
  ***REMOVED***
     ...
     */
    getAccountId() ***REMOVED***
        if (validator.isNonEmptyString(this.serviceAccountId)) ***REMOVED***
      ...
      ***REMOVED***;
        ...
        return client.send(request).then((response) => ***REMOVED***
      ...
      ***REMOVED***).catch((err) => ***REMOVED***
            throw new CryptoSignerError(***REMOVED***
                ...
                message: 'Failed to determine service account. Make sure to initialize ' +
                    ...
                    `account with iam.serviceAccounts.signBlob permission. Original error: $***REMOVED***err}`,
          ***REMOVED***);
      ***REMOVED***);
  ***REMOVED***
}
 ...
 */
function cryptoSignerFromApp(app) ***REMOVED***
 ...
 * @constructor
 */
class CryptoSignerError extends Error ***REMOVED***
    constructor(errorInfo) ***REMOVED***
 ...
 */
class CryptoSignerErrorCode ***REMOVED***
}
