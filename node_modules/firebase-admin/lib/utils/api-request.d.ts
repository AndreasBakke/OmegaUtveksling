...
/// <reference types="node" />
/// <reference types="node" />
import ***REMOVED*** FirebaseApp } from '../app/firebase-app';
 ...
 */
export interface HttpRequestConfig ***REMOVED***
    method: HttpMethod;
 ...
 */
export interface HttpResponse ***REMOVED***
...
export declare class HttpError extends Error ***REMOVED***
 ...
 */
export interface RetryConfig ***REMOVED***
...
export declare class HttpClient ***REMOVED***
...
export declare class AuthorizedHttpClient extends HttpClient ***REMOVED***
 ...
 * @constructor
 */
export declare class ApiSettings ***REMOVED***
    private endpoint;
    private httpMethod;
 ...
 * ```
 */
export declare class ExponentialBackoffPoller<T> extends EventEmitter ***REMOVED***
