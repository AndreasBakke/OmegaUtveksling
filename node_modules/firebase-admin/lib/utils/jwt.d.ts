...
import ***REMOVED*** Agent } from 'http';
export declare const ALGORITHM_RS256: jwt.Algorithm;
export declare type Dictionary = ***REMOVED***
    [key: string]: any;
};
export declare type DecodedToken = ***REMOVED***
    header: Dictionary;
    payload: Dictionary;
};
export interface SignatureVerifier ***REMOVED***
    verify(token: string): Promise<void>;
}
interface KeyFetcher ***REMOVED***
    fetchPublicKeys(): Promise<***REMOVED***
        [key: string]: string;
  ***REMOVED***>;
}
export declare class JwksFetcher implements KeyFetcher ***REMOVED***
    private publicKeys;
 ...
 */
export declare class UrlKeyFetcher implements KeyFetcher ***REMOVED***
 ...
 */
export declare class PublicKeySignatureVerifier implements SignatureVerifier ***REMOVED***
    private keyFetcher;
 ...
 */
export declare class EmulatorSignatureVerifier implements SignatureVerifier ***REMOVED***
    verify(token: string): Promise<void>;
}
/**
 ...
 * @constructor
 */
export declare class JwtError extends Error ***REMOVED***
 ...
 * JWT error codes.
 */
export declare enum JwtErrorCode ***REMOVED***
