...
import ***REMOVED*** ServiceAccountCredential } from '../app/credential-internal';
import ***REMOVED*** AuthorizedHttpClient } from './api-request';
import ***REMOVED*** Algorithm } from 'jsonwebtoken';
import ***REMOVED*** ErrorInfo } from '../utils/error';
/**
 * CryptoSigner interface represents an object that can be used to sign JWTs.
 */
export interface CryptoSigner ***REMOVED***
    /**
 ...
 */
export declare class ServiceAccountSigner implements CryptoSigner ***REMOVED***
 ...
 */
export declare class IAMSigner implements CryptoSigner ***REMOVED***
    algorithm: Algorithm;
 ...
 */
export interface ExtendedErrorInfo extends ErrorInfo ***REMOVED***
    cause?: Error;
}
/**
 ...
 * @constructor
 */
export declare class CryptoSignerError extends Error ***REMOVED***
    private errorInfo;
 ...
 */
export declare class CryptoSignerErrorCode ***REMOVED***
