...
import ***REMOVED*** Installations as TInstallations } from './installations';
/**
 * Gets the ***REMOVED***@link firebase-admin.installations#Installations} service for the
 * default app or a given app.
 *
 * `admin.installations()` can be called with no arguments to access the default
 * app's ***REMOVED***@link firebase-admin.installations#Installations} service or as
 * `admin.installations(app)` to access the
 * ***REMOVED***@link firebase-admin.installations#Installations} service associated with a
 * specific app.
 *
 * @example
 * ```javascript
...
export declare namespace installations ***REMOVED***
    /**
     * Type alias to ***REMOVED***@link firebase-admin.installations#Installations}.
     */
