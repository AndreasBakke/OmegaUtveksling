 ...
 */
export interface DelayDelivery ***REMOVED***
    /**
 ...
 */
export interface AbsoluteDelivery ***REMOVED***
    /**
 ...
 * `DeliverySchedule` is a union type of ***REMOVED***@link DelayDelivery} and ***REMOVED***@link AbsoluteDelivery} types.
 */
export declare type DeliverySchedule = DelayDelivery | AbsoluteDelivery;
/**
 * Type representing task options.
 */
export declare type TaskOptions = DeliverySchedule & TaskOptionsExperimental & ***REMOVED***
    /**
 ...
 */
export interface TaskOptionsExperimental ***REMOVED***
    /**
