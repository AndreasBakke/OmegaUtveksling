...
class Extensions ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @returns A new ***REMOVED***@link Runtime} object.
     */
    runtime() ***REMOVED***
...
class Runtime ***REMOVED***
    ...
    constructor(client) ***REMOVED***
        ...
        if (!validator.isNonEmptyString(process.env['EXT_INSTANCE_ID'])) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (!validator.isNonNullObject(client) || !('updateRuntimeData' in client)) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * correctly, use ***REMOVED***@link Runtime.setFatalError} instead.
     *
     ...
     */
    async setProcessingState(state, detailMessage) ***REMOVED***
        await this.client.updateRuntimeData(this.projectId, this.extensionInstanceId, ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    async setFatalError(errorMessage) ***REMOVED***
        if (!validator.isNonEmptyString(errorMessage)) ***REMOVED***
