 ...
 * @returns The default ***REMOVED***@link https://googleapis.dev/nodejs/firestore/latest/Firestore.html | Firestore}
 ...
 * const otherFirestore = initializeFirestore(app, ***REMOVED***preferRest: true});
 * ```
 *
 * @param App - which `Firestore` service to
 *   return. If not provided, the default `Firestore` service will be returned.
