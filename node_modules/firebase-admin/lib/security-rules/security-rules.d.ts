 ...
 * ***REMOVED***@link SecurityRules.createRulesFileFromSource} method to create new instances of this type.
 */
export interface RulesFile ***REMOVED***
 ...
 */
export interface RulesetMetadata ***REMOVED***
    /**
     * Name of the `Ruleset` as a short string. This can be directly passed into APIs
     * like ***REMOVED***@link SecurityRules.getRuleset} and ***REMOVED***@link SecurityRules.deleteRuleset}.
     */
    readonly name: string;
    /**
 ...
 */
export declare class RulesetMetadataList ***REMOVED***
    /**
 ...
 */
export declare class Ruleset implements RulesetMetadata ***REMOVED***
    /**
     * ***REMOVED***@inheritdoc RulesetMetadata.name}
     */
    readonly name: string;
    /**
     * ***REMOVED***@inheritdoc RulesetMetadata.createTime}
     */
    readonly createTime: string;
 ...
 */
export declare class SecurityRules ***REMOVED***
    readonly app: App;
