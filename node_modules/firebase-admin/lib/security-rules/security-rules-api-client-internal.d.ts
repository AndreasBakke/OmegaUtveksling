...
export interface Release ***REMOVED***
    readonly name: string;
    readonly rulesetName: string;
    readonly createTime?: string;
    readonly updateTime?: string;
}
export interface RulesetContent ***REMOVED***
    readonly source: ***REMOVED***
        readonly files: Array<***REMOVED***
            name: string;
            content: string;
      ***REMOVED***>;
  ***REMOVED***;
}
export interface RulesetResponse extends RulesetContent ***REMOVED***
    readonly name: string;
    readonly createTime: string;
}
export interface ListRulesetsResponse ***REMOVED***
    readonly rulesets: Array<***REMOVED***
        name: string;
        createTime: string;
  ***REMOVED***>;
 ...
 * @private
 */
export declare class SecurityRulesApiClient ***REMOVED***
