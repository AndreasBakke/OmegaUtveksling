 ...
 */
export interface AppCheckToken ***REMOVED***
    /**
 ...
 */
export interface AppCheckTokenOptions ***REMOVED***
    /**
 ...
 * ***REMOVED***@link AppCheck.verifyToken} method.
 */
export interface DecodedAppCheckToken ***REMOVED***
    /**
     * The issuer identifier for the issuer of the response.
     * This value is a URL with the format
     * `https://firebaseappcheck.googleapis.com/<PROJECT_NUMBER>`, where `<PROJECT_NUMBER>` is the
     * same project number specified in the ***REMOVED***@link DecodedAppCheckToken.aud | aud} property.
     */
    iss: string;
    /**
     * The Firebase App ID corresponding to the app the token belonged to.
     * As a convenience, this value is copied over to the ***REMOVED***@link DecodedAppCheckToken.app_id | app_id} property.
     */
    sub: string;
    /**
     ...
     * convenience, and is set as the value of the ***REMOVED***@link DecodedAppCheckToken.sub | sub} property.
     */
    app_id: string;
    [key: string]: any;
}
 ...
 */
export interface VerifyAppCheckTokenResponse ***REMOVED***
    /**
     * The App ID corresponding to the App the App Check token belonged to.
     */
    appId: string;
