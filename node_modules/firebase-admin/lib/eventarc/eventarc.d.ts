...
import ***REMOVED*** CloudEvent } from './cloudevent';
/**
 * Channel options interface.
 */
export interface ChannelOptions ***REMOVED***
    /**
 ...
 */
export declare class Eventarc ***REMOVED***
     ...
     *     `projects/***REMOVED***project}/locations/***REMOVED***location}/channels/***REMOVED***channel-id}`
     *
     * - A partial resource name with location and channel ID, in which case
     *     the runtime project ID of the function is used:
     *     `locations/***REMOVED***location}/channels/***REMOVED***channel-id}`
     *
 ...
 * Eventarc Channel.
 */
export declare class Channel ***REMOVED***
