 ...
 */
function callFunction(targetPath, parentModule, func) ***REMOVED***
  if (!func) ***REMOVED***
    return '';
***REMOVED***
...
exports.before = function before(targetPath, parentModule, options) ***REMOVED***
  return callFunction(targetPath, parentModule, options.before);
};

exports.after = function after(targetPath, parentModule, options) ***REMOVED***
