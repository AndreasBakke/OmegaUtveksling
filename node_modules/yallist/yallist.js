...
Yallist.prototype.splice = function (start, deleteCount, ...nodes) ***REMOVED***
...
***REMOVED***
  ...
  for (var i = 0, walker = this.head; walker !== null && i < start; i++) ***REMOVED***
    walker = walker.next
***REMOVED***

  var ret = []
  for (var i = 0; walker && i < deleteCount; i++) ***REMOVED***
    ret.push(walker.value)
    walker = this.removeNode(walker)
***REMOVED***
  if (walker === null) ***REMOVED***
    walker = this.tail
***REMOVED***

  if (walker !== this.head && walker !== this.tail) ***REMOVED***
    walker = walker.prev
***REMOVED***
...
function insert (self, node, value) ***REMOVED***
  var inserted = node === self.head ?
    new Node(value, null, node, self) :
    new Node(value, node, node.next, self)

  if (inserted.next === null) ***REMOVED***
    self.tail = inserted
***REMOVED***
  if (inserted.prev === null) ***REMOVED***
    self.head = inserted
***REMOVED***
