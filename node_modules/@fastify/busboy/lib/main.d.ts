...
import ***REMOVED*** Readable, Writable } from 'stream';
export ***REMOVED*** Dicer } from "../deps/dicer/lib/dicer";

export const Busboy: BusboyConstructor;
export default Busboy;

export interface BusboyConfig ***REMOVED***
    /**
...
export type BusboyHeaders = ***REMOVED*** 'content-type': string } & http.IncomingHttpHeaders;
...
export interface Busboy extends Writable ***REMOVED***
...
export interface BusboyEvents ***REMOVED***
    /**
...
export interface BusboyConstructor ***REMOVED***
