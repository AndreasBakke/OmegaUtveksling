...
var path = (function () ***REMOVED*** try ***REMOVED*** return require('path') } catch (e) ***REMOVED***}}()) || ***REMOVED***
  sep: '/'
}
...
***REMOVED***
  m.Minimatch.defaults = function defaults (options) ***REMOVED***
    return orig.defaults(ext(def, options)).Minimatch
***REMOVED***

  m.filter = function filter (pattern, options) ***REMOVED***
    return orig.filter(pattern, ext(def, options))
***REMOVED***

  m.defaults = function defaults (options) ***REMOVED***
    return orig.defaults(ext(def, options))
***REMOVED***

  m.makeRe = function makeRe (pattern, options) ***REMOVED***
    return orig.makeRe(pattern, ext(def, options))
***REMOVED***

  m.braceExpand = function braceExpand (pattern, options) ***REMOVED***
    return orig.braceExpand(pattern, ext(def, options))
***REMOVED***

  m.match = function (list, pattern, options) ***REMOVED***
...
***REMOVED***
  ...
  if (!options.allowWindowsEscape && path.sep !== '/') ***REMOVED***
...
***REMOVED***
  ...
  if (options.debug) this.debug = function debug() ***REMOVED*** console.error.apply(console, arguments) }
...
var assertValidPattern = function (pattern) ***REMOVED***
...
***REMOVED***
  ...
  for (pl = patternListStack.pop(); pl; pl = patternListStack.pop()) ***REMOVED***
    ...
    tail = tail.replace(/((?:\\***REMOVED***2})***REMOVED***0,64})(\\?)\|/g, function (_, $1, $2) ***REMOVED***
      if (!$2) ***REMOVED***
...
Minimatch.prototype.match = function match (f, partial) ***REMOVED***
