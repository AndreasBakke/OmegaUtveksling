...
hash(***REMOVED***foo: 'bar'}) // => '67b69634f9880a282c14a0f0cb7ba20cf5d677e9'
...
* `excludeValues` ***REMOVED***true|false} hash object keys, values ignored. default: false
* `encoding` hash encoding, supports 'buffer', 'hex', 'binary', 'base64'. default: hex
* `ignoreUnknown` ***REMOVED***true|*false} ignore unknown object types. default: false
* `replacer` optional function that replaces values before hashing. default: accept all values
* `respectFunctionProperties` ***REMOVED***true|false} Whether properties on functions are considered when hashing. default: true
* `respectFunctionNames` ***REMOVED***true|false} consider `name` property of functions for hashing. default: true
* `respectType` ***REMOVED***true|false} Whether special type attributes (`.prototype`, `.__proto__`, `.constructor`)
   are hashed. default: true
* `unorderedArrays` ***REMOVED***true|false} Sort all arrays before hashing. Note that this affects *all* collections,
   i.e. including typed arrays, Sets, Maps, etc. default: false
* `unorderedSets` ***REMOVED***true|false} Sort `Set` and `Map` instances before hashing, i.e. make
  `hash(new Set([1, 2])) == hash(new Set([2, 1]))` return `true`. default: true
* `unorderedObjects` ***REMOVED***true|false} Sort objects before hashing, i.e. make `hash(***REMOVED*** x: 1, y: 2 }) === hash(***REMOVED*** y: 2, x: 1 })`. default: true
...
*Sugar method, equivalent to* `hash(value, ***REMOVED***algorithm: 'sha1'})`

## hash.keys(value)

Hash object keys using the sha1 algorithm, values ignored.

*Sugar method, equivalent to* `hash(value, ***REMOVED***excludeValues: true})`
...
*Sugar method, equivalent to* `hash(value, ***REMOVED***algorithm: 'md5'})`
...
*Sugar method, equivalent to* `hash(value, ***REMOVED***algorithm: 'md5', excludeValues: true})`
...
```js
hash.writeToStream(***REMOVED***foo: 'bar', a: 42}, ***REMOVED***respectType: false}, process.stdout)
...
<script>
  var hash = objectHash.sha1(***REMOVED***foo:'bar'});
...
var peter = ***REMOVED*** name: 'Peter', stapler: false, friends: ['Joanna', 'Michael', 'Samir'] };
var michael = ***REMOVED*** name: 'Michael', stapler: false, friends: ['Peter', 'Samir'] };
var bob = ***REMOVED*** name: 'Bob', stapler: true, friends: [] };
 ...
 */
hash(peter, ***REMOVED*** excludeValues: true });
// 48f370a772c7496f6c9d2e6d92e920c87dd00a5c
hash(michael, ***REMOVED*** excludeValues: true });
// 48f370a772c7496f6c9d2e6d92e920c87dd00a5c
hash.keys(bob);
// 48f370a772c7496f6c9d2e6d92e920c87dd00a5c
 ...
 * md5 base64 encoding
 */
hash(peter, ***REMOVED*** algorithm: 'md5', encoding: 'base64' });
// 6rkWaaDiG3NynWw4svGH7g==
hash(michael, ***REMOVED*** algorithm: 'md5', encoding: 'base64' });
// djXaWpuWVJeOF8Sb6SFFNg==
hash(bob, ***REMOVED*** algorithm: 'md5', encoding: 'base64' });
