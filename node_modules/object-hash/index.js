 ...
 *  - `excludeValues` ***REMOVED***true|*false} hash object keys, values ignored
 *  - `encoding` hash encoding, supports 'buffer', '*hex', 'binary', 'base64'
 *  - `ignoreUnknown` ***REMOVED***true|*false} ignore unknown object types
 *  - `replacer` optional function that replaces values before hashing
 *  - `respectFunctionProperties` ***REMOVED****true|false} consider function properties when hashing
 *  - `respectFunctionNames` ***REMOVED****true|false} consider 'name' property of functions for hashing
 *  - `respectType` ***REMOVED****true|false} Respect special properties (prototype, constructor)
 *    when hashing to distinguish between types
 *  - `unorderedArrays` ***REMOVED***true|*false} Sort all arrays before hashing
 *  - `unorderedSets` ***REMOVED****true|false} Sort `Set` and `Map` instances before hashing
 *  * = default
 *
 * @param ***REMOVED***object} object value to hash
 * @param ***REMOVED***object} options hashing options
 * @return ***REMOVED***string} hash value
 * @api public
 */
...
exports.keys = function(object)***REMOVED***
  return objectHash(object, ***REMOVED***excludeValues: true, algorithm: 'sha1', encoding: 'hex'});
};
exports.MD5 = function(object)***REMOVED***
  return objectHash(object, ***REMOVED***algorithm: 'md5', encoding: 'hex'});
};
exports.keysMD5 = function(object)***REMOVED***
  return objectHash(object, ***REMOVED***algorithm: 'md5', encoding: 'hex', excludeValues: true});
};
...
function applyDefaults(object, sourceOptions)***REMOVED***
  sourceOptions = sourceOptions || ***REMOVED***};
...
function isNativeFunction(f) ***REMOVED***
  if ((typeof f) !== 'function') ***REMOVED***
    return false;
***REMOVED***
  var exp = /^function\s+\w*\s*\(\s*\)\s****REMOVED***\s+\[native code\]\s+}$/i;
 ...
 *
 * @param ***REMOVED***object} object  Value to serialize
 * @param ***REMOVED***object} options  Options, as for hash()
 * @param ***REMOVED***object} stream  A stream to write the serializiation to
 * @api public
 */
...
***REMOVED***;
    ...
    ***REMOVED***else***REMOVED***
      ...
      ***REMOVED***
        ...
        if (options.excludeKeys) ***REMOVED***
          keys = keys.filter(function(key) ***REMOVED*** return !options.excludeKeys(key); });
      ***REMOVED***
  ...
  ***REMOVED***,
    ...
    ***REMOVED***
      ...
      // i.e. ***REMOVED***a:1} < ***REMOVED***a:2} and ***REMOVED***a:1} > ***REMOVED***a:2} are both false,
  ...
  ***REMOVED***,
    _domwindow: function() ***REMOVED*** return write('domwindow'); },
    _bigint: function(number)***REMOVED***
      return write('bigint:' + number.toString());
  ***REMOVED***,
    /* Node.js standard native objects */
    _process: function() ***REMOVED*** return write('process'); },
    _timer: function() ***REMOVED*** return write('timer'); },
    _pipe: function() ***REMOVED*** return write('pipe'); },
    _tcp: function() ***REMOVED*** return write('tcp'); },
    _udp: function() ***REMOVED*** return write('udp'); },
    _tty: function() ***REMOVED*** return write('tty'); },
    _statwatcher: function() ***REMOVED*** return write('statwatcher'); },
    _securecontext: function() ***REMOVED*** return write('securecontext'); },
    _connection: function() ***REMOVED*** return write('connection'); },
    _zlib: function() ***REMOVED*** return write('zlib'); },
    _context: function() ***REMOVED*** return write('context'); },
    _nodescript: function() ***REMOVED*** return write('nodescript'); },
    _httpparser: function() ***REMOVED*** return write('httpparser'); },
    _dataview: function() ***REMOVED*** return write('dataview'); },
    _signal: function() ***REMOVED*** return write('signal'); },
    _fsevent: function() ***REMOVED*** return write('fsevent'); },
    _tlswrap: function() ***REMOVED*** return write('tlswrap'); },
***REMOVED***;
}
