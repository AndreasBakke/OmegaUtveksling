 ...
 *
 * @param ***REMOVED***Function} fn - the function to deprecate
 * @param ***REMOVED***String} msg - the string to print to the console when `fn` is invoked
 * @returns ***REMOVED***Function} a new "deprecated" version of `fn`
 * @api public
 */
