...
export interface Event ***REMOVED***
     ...
     */
    readonly target: EventTarget<***REMOVED***}, ***REMOVED***}, "standard"> | null

    /**
     * The current target of this event.
     */
    readonly currentTarget: EventTarget<***REMOVED***}, ***REMOVED***}, "standard"> | null
     ...
     */
    composedPath(): EventTarget<***REMOVED***}, ***REMOVED***}, "standard">[]
...
export type EventTargetConstructor<
    TEvents extends EventTarget.EventDefinition = ***REMOVED***},
    TEventAttributes extends EventTarget.EventDefinition = ***REMOVED***},
...
export type EventTarget<
    ...
    TEventAttributes extends EventTarget.EventDefinition = ***REMOVED***},
    TMode extends EventTarget.Mode = "loose"
> = EventTarget.EventAttributes<TEventAttributes> & ***REMOVED***
    /**
...
export const EventTarget: EventTargetConstructor & ***REMOVED***
    /**
     ...
     *
     * @example
     * const signal = new EventTarget<***REMOVED*** abort: Event }, ***REMOVED*** onabort: Event }>()
     ...
     *
     * @example
     * class AbortSignal extends EventTarget<***REMOVED*** abort: Event }, ***REMOVED*** onabort: Event }>("abort") ***REMOVED***
     *      abort(): void ***REMOVED***}
     * }
     *
...
export namespace EventTarget ***REMOVED***
    /**
     * Options of `removeEventListener()` method.
     */
    export interface RemoveOptions ***REMOVED***
        /**
  ...
  ***REMOVED***
     ...
     */
    export interface AddOptions extends RemoveOptions ***REMOVED***
        /**
  ...
  ***REMOVED***
     ...
     */
    export interface FunctionListener<TEvent> ***REMOVED***
        (event: TEvent): void
  ***REMOVED***
     ...
     */
    export interface ObjectListener<TEvent> ***REMOVED***
  ...
  ***REMOVED***
     ...
     * Event definition.
     */
    export type EventDefinition = ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    export type EventAttributes<TEventAttributes extends EventDefinition> = ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    export type NonStandardEvent = ***REMOVED***
        [key: string]: any
        type: string
  ***REMOVED***
 ...
 */
export type Type<T extends string> = ***REMOVED*** type: T }
