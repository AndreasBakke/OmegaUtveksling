...
- JS has no keyword arguments support.
  -  Pass options instead: `new ArgumentParser(***REMOVED*** description: 'example', add_help: true })`.
- JS has no python's types `int`, `float`, ...
  - Use string-typed names: `.add_argument('-b', ***REMOVED*** type: 'int', help: 'help' })`.
...
const ***REMOVED*** ArgumentParser } = require('argparse');
const ***REMOVED*** version } = require('./package.json');

const parser = new ArgumentParser(***REMOVED***
  description: 'Argparse example'
});

parser.add_argument('-v', '--version', ***REMOVED*** action: 'version', version });
parser.add_argument('-f', '--foo', ***REMOVED*** help: 'foo bar' });
parser.add_argument('-b', '--bar', ***REMOVED*** help: 'bar foo' });
parser.add_argument('--baz', ***REMOVED*** help: 'baz bar' });
