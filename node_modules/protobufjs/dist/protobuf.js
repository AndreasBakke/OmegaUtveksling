...
},***REMOVED***"16":16,"24":24,"37":37}],24:[function(require,module,exports)***REMOVED***
"use strict";
...
function parse(source, root, options) ***REMOVED***
  ...
  ***REMOVED***
    ...
    function parseOptionValue(parent, name) ***REMOVED***
        if (skip("***REMOVED***", true)) ***REMOVED*** // ***REMOVED*** a: "foo" b ***REMOVED*** c: "bar" } }
            var result = ***REMOVED***};
  ...
  ***REMOVED***
    ...
    function cmnt(trailingLine) ***REMOVED***
        ...
        if (trailingLine === undefined) ***REMOVED***
            if (commentLine === line - 1 && (alternateCommentMode || commentType === "*" || commentLineEmpty)) ***REMOVED***
                ret = commentIsLeading ? commentText : null;
          ***REMOVED***
      ***REMOVED*** else ***REMOVED***
            /* istanbul ignore else */
            if (commentLine < trailingLine) ***REMOVED***
                peek();
          ***REMOVED***
            if (commentLine === trailingLine && !commentLineEmpty && (alternateCommentMode || commentType === "/")) ***REMOVED***
