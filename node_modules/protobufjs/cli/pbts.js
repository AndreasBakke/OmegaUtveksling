...
exports.main = function(args, callback) ***REMOVED***
  ...
  ***REMOVED***
    ...
    function callJsdoc() ***REMOVED***
        ...
        var cmd = "\"" + nodePath + "\" \"" + require.resolve("jsdoc/jsdoc.js") + "\" -c \"" + path.join(basedir, "lib", "tsd-jsdoc.json") + "\" -q \"module=" + encodeURIComponent(moduleName) + "&comments=" + Boolean(argv.comments) + "\" " + files.map(function(file) ***REMOVED*** return "\"" + file + "\""; }).join(" ");
      ...
      ***REMOVED***);
        ...
        child.on("close", function(code) ***REMOVED***
            ...
            try ***REMOVED*** cleanup.forEach(fs.unlinkSync); } catch(e) ***REMOVED***/**/} cleanup = [];
      ...
      ***REMOVED***);
        ...
        function getImportName(importItem) ***REMOVED***
            return path.basename(importItem, ".js").replace(/([-_~.+]\w)/g, function(match) ***REMOVED***
        ...
        function finish() ***REMOVED***
            ...
            if (!argv.main) ***REMOVED***
                ...
                var imports = ***REMOVED***
                    $protobuf: "protobufjs"
              ***REMOVED***;
                importArray.forEach(function(importItem) ***REMOVED***
                    imports[getImportName(importItem)] = importItem;
              ***REMOVED***);

                // Write out the imports
                Object.keys(imports).forEach(function(key) ***REMOVED***
