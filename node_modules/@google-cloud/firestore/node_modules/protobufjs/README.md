...
* **Message.create**(properties: `Object`): `Message`<br />
  ...
  ```js
  var message = AwesomeMessage.create(***REMOVED*** awesomeField: "AwesomeString" });
  ```
...
* **Message.fromObject**(object: `Object`): `Message`<br />
  ...
  ```js
  var message = AwesomeMessage.fromObject(***REMOVED*** awesomeField: 42 });
...
protobuf.load("awesome.proto", function(err, root) ***REMOVED***
    ...
    // Exemplary payload
    var payload = ***REMOVED*** awesomeField: "AwesomeString" };
...
AwesomeMessage.customStaticMethod = function() ***REMOVED*** ... };
AwesomeMessage.prototype.customInstanceMethod = function() ***REMOVED*** ... };
...
const Client = grpc.makeGenericClientConstructor(***REMOVED***})
const client = new Client(
  grpcServerUrl,
  grpc.credentials.createInsecure()
)

const rpcImpl = function(method, requestData, callback) ***REMOVED***
...
service Greeter ***REMOVED***
    rpc SayHello (HelloRequest) returns (HelloReply) ***REMOVED***}
}
...
greeter.sayHello(***REMOVED*** name: 'you' }, function(err, response) ***REMOVED***
...
```js
greeter.sayHello(***REMOVED*** name: 'you' })
...
```ts
import ***REMOVED*** load } from "protobufjs"; // respectively "./node_modules/protobufjs"
...
load("awesome.proto", function(err, root) ***REMOVED***
  ...
  let message = AwesomeMessage.create(***REMOVED*** awesomeField: "hello" });
  console.log(`message = $***REMOVED***JSON.stringify(message)}`);

  let buffer = AwesomeMessage.encode(message).finish();
  console.log(`buffer = $***REMOVED***Array.prototype.toString.call(buffer)}`);

  let decoded = AwesomeMessage.decode(buffer);
  console.log(`decoded = $***REMOVED***JSON.stringify(decoded)}`);
});
```
...
```ts
import ***REMOVED*** AwesomeMessage } from "./bundle.js";
...
```ts
import ***REMOVED*** Message, Type, Field, OneOf } from "protobufjs/light"; // respectively "./node_modules/protobufjs/light.js"
...
// example code
let message = new AwesomeMessage(***REMOVED*** awesomeField: "hello" });
let buffer  = AwesomeMessage.encode(message).finish();
let decoded = AwesomeMessage.decode(buffer);
```
...
* **MapField.d&lt;T extends ***REMOVED*** [key: string]: any }>(fieldId: `number`, fieldKeyType: `string`, fieldValueType. `string | Constructor<***REMOVED***}>`)**<br />
