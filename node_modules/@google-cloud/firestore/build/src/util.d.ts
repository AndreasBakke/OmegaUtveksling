 ...
 */
import ***REMOVED*** DocumentData } from '@google-cloud/firestore';
import type ***REMOVED*** GoogleError } from 'google-gax';
import type ***REMOVED*** BackoffSettings } from 'google-gax/build/src/gax';
/**
 ...
 * @private
 * @internal
 * @returns ***REMOVED***string} A unique 20-character wide identifier.
 */
 ...
 * @private
 * @internal
 * @returns ***REMOVED***string} A random 5-character wide identifier.
 */
 ...
 * @internal
 */
export declare function isObject(value: unknown): value is ***REMOVED***
    [k: string]: unknown;
};
/**
 ...
 * @internal
 */
export declare function isEmpty(value: ***REMOVED***}): boolean;
/**
