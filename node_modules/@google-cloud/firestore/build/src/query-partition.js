 ...
 */
class QueryPartition ***REMOVED***
    /** @private */
    constructor(_firestore, _collectionId, _converter, _startAt, _endBefore) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    get startAt() ***REMOVED***
        if (this._startAt && !this._memoizedStartAt) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    get endBefore() ***REMOVED***
        if (this._endBefore && !this._memoizedEndBefore) ***REMOVED***
  ...
  ***REMOVED***
    ...
    toQuery() ***REMOVED***
        ...
        queryOptions = queryOptions.with(***REMOVED***
            fieldOrders: [new reference_1.FieldOrder(path_1.FieldPath.documentId())],
      ***REMOVED***);
        if (this._startAt !== undefined) ***REMOVED***
            queryOptions = queryOptions.with(***REMOVED***
                startAt: ***REMOVED*** before: true, values: this._startAt },
          ***REMOVED***);
      ***REMOVED***
        if (this._endBefore !== undefined) ***REMOVED***
            queryOptions = queryOptions.with(***REMOVED***
                endAt: ***REMOVED*** before: true, values: this._endBefore },
          ***REMOVED***);
      ***REMOVED***
