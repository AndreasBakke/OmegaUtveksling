...
import ***REMOVED*** Readable } from 'stream';
import ***REMOVED*** GoogleError } from 'google-gax';
import * as protos from '../protos/firestore_v1_proto_api';
import ***REMOVED*** DocumentSnapshot, QueryDocumentSnapshot } from './document';
import ***REMOVED*** DocumentChange } from './document-change';
import ***REMOVED*** Firestore } from './index';
import ***REMOVED*** FieldPath, ResourcePath } from './path';
import ***REMOVED*** Serializable, Serializer } from './serializer';
import ***REMOVED*** Timestamp } from './timestamp';
import ***REMOVED*** WriteResult } from './write-batch';
 ...
 */
export declare class DocumentReference<T = firestore.DocumentData> implements Serializable, firestore.DocumentReference<T> ***REMOVED***
 ...
 * @class
 */
export declare class FieldOrder ***REMOVED***
 ...
 * @class
 */
declare class FieldFilter ***REMOVED***
 ...
 * @class QuerySnapshot
 */
export declare class QuerySnapshot<T = firestore.DocumentData> implements firestore.QuerySnapshot<T> ***REMOVED***
 ...
 * the result set.
 */
declare enum LimitType ***REMOVED***
    First = 0,
    Last = 1
}
/**
 ...
 * @internal
 */
export declare class QueryOptions<T> ***REMOVED***
 ...
 * @class Query
 */
export declare class Query<T = firestore.DocumentData> implements firestore.Query<T> ***REMOVED***
    /** @private */
 ...
 * @extends Query
 */
export declare class CollectionReference<T = firestore.DocumentData> extends Query<T> implements firestore.CollectionReference<T> ***REMOVED***
    /**
     * @private
     *
 ...
 */
export declare class AggregateQuery<T extends firestore.AggregateSpec> implements firestore.AggregateQuery<T> ***REMOVED***
    private readonly _query;
 ...
 */
export declare class AggregateQuerySnapshot<T extends firestore.AggregateSpec> implements firestore.AggregateQuerySnapshot<T> ***REMOVED***
    private readonly _query;
    private readonly _readTime;
