...
import ***REMOVED*** google } from '../protos/firestore_v1_proto_api';
import ***REMOVED*** Firestore } from './index';
import ***REMOVED*** FieldPath } from './path';
import ***REMOVED*** Timestamp } from './timestamp';
import ***REMOVED*** FirestoreUnaryMethod } from './types';
import ***REMOVED*** RequiredArgumentOptions } from './validate';
 ...
 * @class WriteResult
 */
export declare class WriteResult implements firestore.WriteResult ***REMOVED***
     ...
     *
     * documentRef.set(***REMOVED***foo: 'bar'}).then(writeResult => ***REMOVED***
     *   console.log(`Document written at: $***REMOVED***writeResult.writeTime.toDate()}`);
     * });
     * ```
     */
...
export declare class WriteBatch implements firestore.WriteBatch ***REMOVED***
     ...
     * @returns ***REMOVED***WriteBatch} This WriteBatch instance. Used for chaining
     * method calls.
     *
     * @example
     * ```
     ...
     *
     * writeBatch.create(documentRef, ***REMOVED***foo: 'bar'});
     *
     ...
     * @param ***REMOVED***boolean= } precondition.exists If set to true, enforces that the target
     ...
     * let documentRef = firestore.doc('col/doc');
     *
     * writeBatch.update(documentRef, ***REMOVED***foo: 'bar'});
     *
     * writeBatch.commit().then(() => ***REMOVED***
     *   console.log('Successfully executed batch.');
     * });
     * ```
     */
    update<T = firestore.DocumentData>(documentRef: firestore.DocumentReference<T>, dataOrField: firestore.UpdateData<T> | string | firestore.FieldPath, ...preconditionOrValues: Array<***REMOVED***
        lastUpdateTime?: firestore.Timestamp;
  ***REMOVED*** | unknown | string | firestore.FieldPath>): WriteBatch;
    /**
     * Atomically commits all pending operations to the database and verifies all
     * preconditions. Fails the entire write if any precondition is not met.
     *
     * @returns ***REMOVED***Promise.<Array.<WriteResult>>} A Promise that resolves
     ...
     * let documentRef = firestore.doc('col/doc');
     *
     * writeBatch.set(documentRef, ***REMOVED***foo: 'bar'});
     *
     * writeBatch.commit().then(() => ***REMOVED***
     *   console.log('Successfully executed batch.');
     * });
     ...
     */
    _commit<Req extends api.ICommitRequest, Resp>(commitOptions?: ***REMOVED***
        transactionId?: Uint8Array;
        requestTag?: string;
        retryCodes?: number[];
        methodName?: FirestoreUnaryMethod;
  ***REMOVED***): Promise<Resp>;
    /**
