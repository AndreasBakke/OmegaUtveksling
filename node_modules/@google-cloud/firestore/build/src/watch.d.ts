...
import ***REMOVED*** QueryDocumentSnapshot } from './document';
import ***REMOVED*** DocumentChange } from './document-change';
import ***REMOVED*** DocumentReference, Firestore, Query } from './index';
 ...
 * @returns ***REMOVED***Array.<QueryDocumentSnapshot>} An ordered list of documents.
 */
/**
 * @private
 * @internal
 * @callback changeCallback
 * @returns ***REMOVED***Array.<DocumentChange>} An ordered list of document
 * changes.
 */
/**
 ...
 *
 * @param ***REMOVED***Timestamp} readTime The time at which this snapshot was obtained.
 * @param ***REMOVED***number} size The number of documents in the result set.
 * @param ***REMOVED***docsCallback} docs A callback that returns the ordered list of
 * documents stored in this snapshot.
 * @param ***REMOVED***changeCallback} changes A callback that returns the list of
 ...
 * @internal
 */
declare abstract class Watch<T = firestore.DocumentData> ***REMOVED***
 ...
 * @internal
 */
export declare class DocumentWatch<T = firestore.DocumentData> extends Watch<T> ***REMOVED***
 ...
 * @internal
 */
export declare class QueryWatch<T = firestore.DocumentData> extends Watch<T> ***REMOVED***
