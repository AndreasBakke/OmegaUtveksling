 ...
 * [runTransaction()]***REMOVED***@link Firestore#runTransaction}.
 *
 * @class Transaction
 */
class Transaction ***REMOVED***
     ...
     * this transaction.
     */
    constructor(firestore, requestTag) ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param ***REMOVED***DocumentReference|Query} refOrQuery The document or query to
     * return.
     * @returns ***REMOVED***Promise} A Promise that resolves with a DocumentSnapshot or
     ...
     *       transaction.update(documentRef, ***REMOVED*** count: doc.get('count') + 1 });
    ...
    get(refOrQuery) ***REMOVED***
      ...
      ***REMOVED***
        if (refOrQuery instanceof reference_1.DocumentReference) ***REMOVED***
      ...
      ***REMOVED***
        if (refOrQuery instanceof reference_1.Query) ***REMOVED***
            return refOrQuery._get(this._transactionId);
      ***REMOVED***
        if (refOrQuery instanceof (reference_1.AggregateQuery)) ***REMOVED***
            return refOrQuery._get(this._transactionId);
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * firestore.runTransaction(transaction => ***REMOVED***
     *   return transaction.getAll(firstDoc, secondDoc).then(docs => ***REMOVED***
     *     transaction.set(resultDoc, ***REMOVED***
    ...
    getAll(...documentRefsOrReadOptions) ***REMOVED***
      ...
      ***REMOVED***
        ...
        const ***REMOVED*** documents, fieldMask } = parseGetAllArguments(documentRefsOrReadOptions);
  ...
  ***REMOVED***
     ...
     * [DocumentReference]***REMOVED***@link DocumentReference}. The operation will
     * fail the transaction if a document exists at the specified location.
     *
     * @param ***REMOVED***DocumentReference} documentRef A reference to the document to be
     * created.
     * @param ***REMOVED***DocumentData} data The object data to serialize as the document.
     * @returns ***REMOVED***Transaction} This Transaction instance. Used for
     ...
     *   return transaction.get(documentRef).then(doc => ***REMOVED***
     *     if (!doc.exists) ***REMOVED***
     *       transaction.create(documentRef, ***REMOVED*** foo: 'bar' });
     *   ***REMOVED***
     * ***REMOVED***);
     * });
     * ```
  ...
  ***REMOVED***
     ...
     * [DocumentReference]***REMOVED***@link DocumentReference}. If the document
     * does not exist yet, it will be created. If you pass
     * [SetOptions]***REMOVED***@link SetOptions}, the provided data can be merged into the
     * existing document.
     *
     * @param ***REMOVED***DocumentReference} documentRef A reference to the document to be
     * set.
     * @param ***REMOVED***T|Partial<T>} data The object to serialize as the document.
     * @param ***REMOVED***SetOptions=} options An object to configure the set behavior.
     * @param ***REMOVED***boolean=} options.merge - If true, set() merges the values
     ...
     * firestore.runTransaction(transaction => ***REMOVED***
     *   let documentRef = firestore.doc('col/doc');
     *   transaction.set(documentRef, ***REMOVED*** foo: 'bar' });
  ...
  ***REMOVED***
     ...
     * [DocumentReference]***REMOVED***@link DocumentReference}. The update will
     ...
     * @param ***REMOVED***DocumentReference} documentRef A reference to the document to be
     * updated.
     * @param ***REMOVED***UpdateData|string|FieldPath} dataOrField An object
  ...
  ***REMOVED***
     ...
     * ***REMOVED***@link DocumentReference}.
     *
     * @param ***REMOVED***DocumentReference} documentRef A reference to the document to be
     * deleted.
  ...
  ***REMOVED***
     ...
     * @internal
     */
    begin(readOnly, readTime) ***REMOVED***
        var _a;
      ...
      ***REMOVED***;
        if (readOnly) ***REMOVED***
          ...
          ***REMOVED***;
      ***REMOVED***
        else if (this._transactionId) ***REMOVED***
            request.options = ***REMOVED***
                readWrite: ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    async runTransaction(updateFunction, options) ***REMOVED***
        let result;
        let lastError = undefined;
        for (let attempt = 0; attempt < options.maxAttempts; ++attempt) ***REMOVED***
            try ***REMOVED***
          ...
          ***REMOVED***
                ...
                lastError = err;
                if (!this._transactionId || !isRetryableTransactionError(err)) ***REMOVED***
                    break;
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    async maybeBackoff(error) ***REMOVED***
        if ((error === null || error === void 0 ? void 0 : error.code) === 8 /* StatusCode.RESOURCE_EXHAUSTED */) ***REMOVED***
 ...
 */
function parseGetAllArguments(documentRefsOrReadOptions) ***REMOVED***
    let documents;
    let readOptions = undefined;
    if (Array.isArray(documentRefsOrReadOptions[0])) ***REMOVED***
  ...
  ***REMOVED***
    if (documentRefsOrReadOptions.length > 0 &&
        (0, util_1.isPlainObject)(documentRefsOrReadOptions[documentRefsOrReadOptions.length - 1])) ***REMOVED***
  ...
  ***REMOVED***
    validateReadOptions('options', readOptions, ***REMOVED*** optional: true });
    const fieldMask = readOptions && readOptions.fieldMask
        ...
        : null;
    return ***REMOVED*** fieldMask, documents };
}
 ...
 */
function validateReadOptions(arg, value, options) ***REMOVED***
    if (!(0, validate_1.validateOptional)(value, options)) ***REMOVED***
        if (!(0, util_1.isObject)(value)) ***REMOVED***
            throw new Error(`$***REMOVED***(0, validate_1.invalidArgumentMessage)(arg, 'read option')} Input is not an object.'`);
      ***REMOVED***
        const options = value;
        if (options.fieldMask !== undefined) ***REMOVED***
            if (!Array.isArray(options.fieldMask)) ***REMOVED***
                throw new Error(`$***REMOVED***(0, validate_1.invalidArgumentMessage)(arg, 'read option')} "fieldMask" is not an array.`);
          ***REMOVED***
            for (let i = 0; i < options.fieldMask.length; ++i) ***REMOVED***
                try ***REMOVED***
                    (0, path_1.validateFieldPath)(i, options.fieldMask[i]);
              ***REMOVED***
                catch (err) ***REMOVED***
                    throw new Error(`$***REMOVED***(0, validate_1.invalidArgumentMessage)(arg, 'read option')} "fieldMask" is not valid: $***REMOVED***err.message}`);
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
  ***REMOVED***
}
function isRetryableTransactionError(error) ***REMOVED***
