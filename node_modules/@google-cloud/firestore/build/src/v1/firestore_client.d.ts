...
import type ***REMOVED*** Callback, CallOptions, Descriptors, ClientOptions, PaginationCallback, LocationsClient, LocationProtos } from 'google-gax';
...
export declare class FirestoreClient ***REMOVED***
  ...
  ***REMOVED***>;
     ...
     *   The first element of the array is an object representing [Document]***REMOVED***@link google.firestore.v1.Document}.
     *   Please see the
    ...
    getDocument(request: protos.google.firestore.v1.IGetDocumentRequest, options: CallOptions, callback: Callback<protos.google.firestore.v1.IDocument, protos.google.firestore.v1.IGetDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    getDocument(request: protos.google.firestore.v1.IGetDocumentRequest, callback: Callback<protos.google.firestore.v1.IDocument, protos.google.firestore.v1.IGetDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
     * Updates or inserts a document.
     *
     * @param ***REMOVED***Object} request
     *   The request object that will be sent.
     * @param ***REMOVED***google.firestore.v1.Document} request.document
     *   Required. The updated document.
     *   Creates the document if it does not already exist.
     * @param ***REMOVED***google.firestore.v1.DocumentMask} request.updateMask
     ...
     *   If the document has a field that is not present in this mask, that field
     *   will not be returned in the response.
     * @param ***REMOVED***google.firestore.v1.Precondition} request.currentDocument
    ...
    updateDocument(request: protos.google.firestore.v1.IUpdateDocumentRequest, options: CallOptions, callback: Callback<protos.google.firestore.v1.IDocument, protos.google.firestore.v1.IUpdateDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    updateDocument(request: protos.google.firestore.v1.IUpdateDocumentRequest, callback: Callback<protos.google.firestore.v1.IDocument, protos.google.firestore.v1.IUpdateDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
     * Deletes a document.
     *
     * @param ***REMOVED***Object} request
    ...
    deleteDocument(request: protos.google.firestore.v1.IDeleteDocumentRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.firestore.v1.IDeleteDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    deleteDocument(request: protos.google.firestore.v1.IDeleteDocumentRequest, callback: Callback<protos.google.protobuf.IEmpty, protos.google.firestore.v1.IDeleteDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
     ...
     * @param ***REMOVED***google.firestore.v1.TransactionOptions} request.options
     *   The options for the transaction.
     *   Defaults to a read-write transaction.
     * @param ***REMOVED***object} [options]
     *   Call options. See ***REMOVED***@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns ***REMOVED***Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [BeginTransactionResponse]***REMOVED***@link google.firestore.v1.BeginTransactionResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
    ...
    beginTransaction(request: protos.google.firestore.v1.IBeginTransactionRequest, options: CallOptions, callback: Callback<protos.google.firestore.v1.IBeginTransactionResponse, protos.google.firestore.v1.IBeginTransactionRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    beginTransaction(request: protos.google.firestore.v1.IBeginTransactionRequest, callback: Callback<protos.google.firestore.v1.IBeginTransactionResponse, protos.google.firestore.v1.IBeginTransactionRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
     ...
     *   Call options. See ***REMOVED***@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns ***REMOVED***Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [CommitResponse]***REMOVED***@link google.firestore.v1.CommitResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
    ...
    commit(request: protos.google.firestore.v1.ICommitRequest, options: CallOptions, callback: Callback<protos.google.firestore.v1.ICommitResponse, protos.google.firestore.v1.ICommitRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    commit(request: protos.google.firestore.v1.ICommitRequest, callback: Callback<protos.google.firestore.v1.ICommitResponse, protos.google.firestore.v1.ICommitRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
    ...
    rollback(request: protos.google.firestore.v1.IRollbackRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.firestore.v1.IRollbackRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    rollback(request: protos.google.firestore.v1.IRollbackRequest, callback: Callback<protos.google.protobuf.IEmpty, protos.google.firestore.v1.IRollbackRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
     ...
     * ***REMOVED***@link google.firestore.v1.BatchWriteResponse|BatchWriteResponse} for the success status of each write.
     *
     * If you require an atomically applied set of writes, use
     * ***REMOVED***@link google.firestore.v1.Firestore.Commit|Commit} instead.
     *
     * @param ***REMOVED***Object} request
     *   The request object that will be sent.
     * @param ***REMOVED***string} request.database
     ...
     *   Call options. See ***REMOVED***@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns ***REMOVED***Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing [BatchWriteResponse]***REMOVED***@link google.firestore.v1.BatchWriteResponse}.
     *   Please see the
     *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
     *   for more details and examples.
    ...
    batchWrite(request: protos.google.firestore.v1.IBatchWriteRequest, options: CallOptions, callback: Callback<protos.google.firestore.v1.IBatchWriteResponse, protos.google.firestore.v1.IBatchWriteRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    batchWrite(request: protos.google.firestore.v1.IBatchWriteRequest, callback: Callback<protos.google.firestore.v1.IBatchWriteResponse, protos.google.firestore.v1.IBatchWriteRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
    ...
    createDocument(request: protos.google.firestore.v1.ICreateDocumentRequest, options: CallOptions, callback: Callback<protos.google.firestore.v1.IDocument, protos.google.firestore.v1.ICreateDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    createDocument(request: protos.google.firestore.v1.ICreateDocumentRequest, callback: Callback<protos.google.firestore.v1.IDocument, protos.google.firestore.v1.ICreateDocumentRequest | null | undefined, ***REMOVED***} | null | undefined>): void;
    /**
     ...
     *   Call options. See ***REMOVED***@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns ***REMOVED***Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Document]***REMOVED***@link google.firestore.v1.Document}.
     ...
     *   Call options. See ***REMOVED***@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns ***REMOVED***Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of [Cursor]***REMOVED***@link google.firestore.v1.Cursor}.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed and will merge results from all the pages into this array.
     *   Note that it can affect your quota.
