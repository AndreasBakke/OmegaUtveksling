...
import type ***REMOVED*** GoogleError } from 'google-gax';
import ***REMOVED*** FieldPath, Firestore } from '.';
import ***REMOVED*** RateLimiter } from './rate-limiter';
import ***REMOVED*** Timestamp } from './timestamp';
import ***REMOVED*** WriteBatch, WriteResult } from './write-batch';
 ...
 * @internal
 */
declare class BulkWriterOperation ***REMOVED***
 ...
 * @internal
 */
declare class BulkCommitBatch extends WriteBatch ***REMOVED***
 ...
 */
export declare class BulkWriterError extends Error ***REMOVED***
 ...
 * @class BulkWriter
 */
export declare class BulkWriter ***REMOVED***
     ...
     * created.
     * @param ***REMOVED***T} data The object to serialize as the document.
     * @throws ***REMOVED***Error} If the provided input is not a valid Firestore document.
     * @returns ***REMOVED***Promise<WriteResult>} A promise that resolves with the result of
     ...
     *
     * bulkWriter
     *  .create(documentRef, ***REMOVED***foo: 'bar'})
     *  .then(result => ***REMOVED***
     ...
     * @param ***REMOVED***...(Precondition|*|string|FieldPath)} preconditionOrValues - An
     ...
     *
     * bulkWriter
     *  .update(documentRef, ***REMOVED***foo: 'bar'})
     *  .then(result => ***REMOVED***
     *    console.log('Successfully executed write at: ', result);
     ****REMOVED***)
     *  .catch(err => ***REMOVED***
     ...
     * ```
     */
    update<T>(documentRef: firestore.DocumentReference<T>, dataOrField: firestore.UpdateData<T> | string | FieldPath, ...preconditionOrValues: Array<***REMOVED***
        lastUpdateTime?: Timestamp;
  ***REMOVED*** | unknown | string | FieldPath>): Promise<WriteResult>;
    /**
     * Callback function set by ***REMOVED***@link BulkWriter#onWriteResult} that is run
     * every time a ***REMOVED***@link BulkWriter} operation successfully completes.
     *
     * @callback BulkWriter~successCallback
     * @param ***REMOVED***DocumentReference} documentRef The document reference the
     * operation was performed on
     * @param ***REMOVED***WriteResult} result The server write time of the operation.
     */
    /**
     * Attaches a listener that is run every time a BulkWriter operation
     * successfully completes.
     *
     * @param ***REMOVED***BulkWriter~successCallback} successCallback A callback to be
     ...
     *
     * bulkWriter
     *   .onWriteResult((documentRef, result) => ***REMOVED***
     *     console.log(
    ...
    /**
     * Callback function set by ***REMOVED***@link BulkWriter#onWriteError} that is run when
     * a write fails in order to determine whether ***REMOVED***@link BulkWriter} should
     * retry the operation.
     *
     * @callback BulkWriter~shouldRetryCallback
     * @param ***REMOVED***BulkWriterError} error The error object with information about the
     * operation and error.
     * @returns ***REMOVED***boolean} Whether or not to retry the failed operation. Returning
     ...
     *
     * @param shouldRetryCallback ***REMOVED***BulkWriter~shouldRetryCallback} A callback to
     ...
     *
     * @return ***REMOVED***Promise<void>} A promise that resolves when all enqueued writes
     ...
     * let bulkWriter = firestore.bulkWriter();
     *
     * bulkWriter.create(documentRef, ***REMOVED***foo: 'bar'});
     * bulkWriter.update(documentRef2, ***REMOVED***foo: 'bar'});
     * bulkWriter.delete(documentRef3);
     * await flush().then(() => ***REMOVED***
