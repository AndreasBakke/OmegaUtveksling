...
class RateLimiter ***REMOVED***
     ...
     */
    constructor(initialCapacity, multiplier, multiplierMillis, maximumCapacity, startTimeMillis = Date.now()) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    tryMakeRequest(numOperations, requestTimeMillis = Date.now()) ***REMOVED***
        this.refillTokens(requestTimeMillis);
        if (numOperations <= this.availableTokens) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    getNextRequestDelayMs(numOperations, requestTimeMillis = Date.now()) ***REMOVED***
        this.refillTokens(requestTimeMillis);
        if (numOperations < this.availableTokens) ***REMOVED***
            return 0;
      ***REMOVED***
        const capacity = this.calculateCapacity(requestTimeMillis);
        if (capacity < numOperations) ***REMOVED***
            return -1;
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    refillTokens(requestTimeMillis) ***REMOVED***
        if (requestTimeMillis >= this.lastRefillTimeMillis) ***REMOVED***
            const elapsedTime = requestTimeMillis - this.lastRefillTimeMillis;
            const capacity = this.calculateCapacity(requestTimeMillis);
            const tokensToAdd = Math.floor((elapsedTime * capacity) / 1000);
            if (tokensToAdd > 0) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    // Visible for testing.
    calculateCapacity(requestTimeMillis) ***REMOVED***
        ...
        if (operationsPerSecond !== this.previousCapacity) ***REMOVED***
            (0, logger_1.logger)('RateLimiter.calculateCapacity', null, `New request capacity: $***REMOVED***operationsPerSecond} operations per second.`);
      ***REMOVED***
