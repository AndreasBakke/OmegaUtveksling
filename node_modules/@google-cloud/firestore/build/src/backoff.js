 ...
 * @private
 * @internal
 * @param ***REMOVED***function} handler A handler than matches the API of `setTimeout()`.
 */
function setTimeoutHandler(handler) ***REMOVED***
    exports.delayExecution = (f, ms) => ***REMOVED***
        handler(f, ms);
        const timeout = ***REMOVED***
            hasRef: () => ***REMOVED***
...
class ExponentialBackoff ***REMOVED***
  ...
  ***REMOVED***
    ...
    backoffAndWait() ***REMOVED***
        if (this.awaitingBackoffCompletion) ***REMOVED***
            return Promise.reject(new Error('A backoff operation is already in progress.'));
      ***REMOVED***
        if (this.retryCount > exports.MAX_RETRY_ATTEMPTS) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (this.currentBaseMs > 0) ***REMOVED***
            (0, logger_1.logger)('ExponentialBackoff.backoffAndWait', null, `Backing off for $***REMOVED***delayWithJitterMs} ms ` +
      ...
      ***REMOVED***
        ...
        return new Promise(resolve => ***REMOVED***
            ...
            (0, exports.delayExecution)(() => ***REMOVED***
                this.awaitingBackoffCompletion = false;
                resolve();
  ...
  ***REMOVED***
     ...
     * factor.
     *
     * @returns ***REMOVED***number} The jitter to apply based on the current delay.
     * @private
     * @internal
     */
