...
class ClientPool ***REMOVED***
     ...
     * disposed of.
     */
    constructor(concurrentOperationLimit, maxIdleClients, clientFactory, clientDestructor = () => Promise.resolve()) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    acquire(requestTag, requiresGrpc) ***REMOVED***
        ...
        for (const [client, metadata] of this.activeClients) ***REMOVED***
            ...
            if (!this.failedClients.has(client) &&
                ...
                (metadata.grpcEnabled || !requiresGrpc)) ***REMOVED***
                selectedClient = client;
                selectedClientRequestCount = metadata.activeRequestCount;
          ***REMOVED***
      ***REMOVED***
        if (selectedClient) ***REMOVED***
      ...
      ***REMOVED***
        this.activeClients.set(selectedClient, ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    shouldGarbageCollectClient(client) ***REMOVED***
        const clientMetadata = this.activeClients.get(client);
        if (clientMetadata.activeRequestCount !== 0) ***REMOVED***
            // Don't garbage collect clients that have active requests.
            return false;
      ***REMOVED***
        if (this.grpcEnabled !== clientMetadata.grpcEnabled) ***REMOVED***
      ...
      ***REMOVED***
        ...
        // collected.
        if (this.failedClients.has(client)) ***REMOVED***
            return true;
      ***REMOVED***
        ...
        for (const [, metadata] of this.activeClients) ***REMOVED***
            idleCapacityCount +=
  ...
  ***REMOVED***
     ...
     * @internal
     */
    run(requestTag, requiresGrpc, op) ***REMOVED***
      ...
      ***REMOVED***
        ...
        return op(client)
            .catch(async (err) => ***REMOVED***
            var _a;
            if ((_a = err.message) === null || _a === void 0 ? void 0 : _a.match(/RST_STREAM/)) ***REMOVED***
  ...
  ***REMOVED***
    async terminate() ***REMOVED***
      ...
      ***REMOVED***
        for (const [client] of this.activeClients) ***REMOVED***
            this.activeClients.delete(client);
            await this.clientDestructor(client);
      ***REMOVED***
  ***REMOVED***
