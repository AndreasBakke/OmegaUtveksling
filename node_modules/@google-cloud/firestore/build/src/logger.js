 ...
 * @internal
 */
function logger(methodName, requestTag, logMessage, ...additionalArgs) ***REMOVED***
    requestTag = requestTag || '#####';
    if (logFunction) ***REMOVED***
        const formattedMessage = util.format(logMessage, ...additionalArgs);
        const time = new Date().toISOString();
        logFunction(`Firestore ($***REMOVED***libVersion}) $***REMOVED***time} $***REMOVED***requestTag} [$***REMOVED***methodName}]: ` +
            formattedMessage);
  ***REMOVED***
}
 ...
 */
function setLogFunction(logger) ***REMOVED***
    if (logger !== null)
 ...
 * @internal
 */
function setLibVersion(version) ***REMOVED***
    libVersion = version;
}
