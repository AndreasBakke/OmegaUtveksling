...
class DocumentReader ***REMOVED***
     ...
     */
    constructor(firestore, allDocuments) ***REMOVED***
        this.firestore = firestore;
        this.allDocuments = allDocuments;
        this.outstandingDocuments = new Set();
        this.retrievedDocuments = new Map();
        for (const docRef of this.allDocuments) ***REMOVED***
    ...
    async get(requestTag) ***REMOVED***
        ...
        for (const docRef of this.allDocuments) ***REMOVED***
          ...
          ***REMOVED***
                ...
                throw new Error(`Did not receive document for "$***REMOVED***docRef.path}".`);
          ***REMOVED***
      ***REMOVED***
        return orderedDocuments;
  ***REMOVED***
    async fetchDocuments(requestTag) ***REMOVED***
        if (!this.outstandingDocuments.size) ***REMOVED***
            return;
      ***REMOVED***
      ...
      ***REMOVED***
        ...
        try ***REMOVED***
            ...
            stream.resume();
            for await (const response of stream) ***REMOVED***
                let snapshot;
