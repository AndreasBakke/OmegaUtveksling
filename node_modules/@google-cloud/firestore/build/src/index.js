...
Object.defineProperty(exports, "CollectionGroup", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return collection_group_1.CollectionGroup; } });
const recursive_delete_1 = require("./recursive-delete");
var reference_2 = require("./reference");
Object.defineProperty(exports, "CollectionReference", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return reference_2.CollectionReference; } });
Object.defineProperty(exports, "DocumentReference", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return reference_2.DocumentReference; } });
Object.defineProperty(exports, "QuerySnapshot", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return reference_2.QuerySnapshot; } });
Object.defineProperty(exports, "Query", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return reference_2.Query; } });
var bulk_writer_2 = require("./bulk-writer");
Object.defineProperty(exports, "BulkWriter", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return bulk_writer_2.BulkWriter; } });
var document_2 = require("./document");
Object.defineProperty(exports, "DocumentSnapshot", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return document_2.DocumentSnapshot; } });
Object.defineProperty(exports, "QueryDocumentSnapshot", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return document_2.QueryDocumentSnapshot; } });
var field_value_1 = require("./field-value");
Object.defineProperty(exports, "FieldValue", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return field_value_1.FieldValue; } });
var write_batch_2 = require("./write-batch");
Object.defineProperty(exports, "WriteBatch", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return write_batch_2.WriteBatch; } });
Object.defineProperty(exports, "WriteResult", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return write_batch_2.WriteResult; } });
var transaction_2 = require("./transaction");
Object.defineProperty(exports, "Transaction", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return transaction_2.Transaction; } });
var timestamp_2 = require("./timestamp");
Object.defineProperty(exports, "Timestamp", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return timestamp_2.Timestamp; } });
var document_change_1 = require("./document-change");
Object.defineProperty(exports, "DocumentChange", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return document_change_1.DocumentChange; } });
var path_2 = require("./path");
Object.defineProperty(exports, "FieldPath", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return path_2.FieldPath; } });
var geo_point_1 = require("./geo-point");
Object.defineProperty(exports, "GeoPoint", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return geo_point_1.GeoPoint; } });
var query_partition_1 = require("./query-partition");
Object.defineProperty(exports, "QueryPartition", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return query_partition_1.QueryPartition; } });
var logger_2 = require("./logger");
Object.defineProperty(exports, "setLogFunction", ***REMOVED*** enumerable: true, get: function () ***REMOVED*** return logger_2.setLogFunction; } });
 ...
 * [set()]***REMOVED***@link DocumentReference#set}) consisting of fields mapped
 * to values.
 *
 * @typedef ***REMOVED***Object.<string, *>} DocumentData
 */
/**
 * Converter used by [withConverter()]***REMOVED***@link Query#withConverter} to transform
 ...
 *
 * ```
 * @property ***REMOVED***Function} toFirestore Called by the Firestore SDK to convert a
 * custom model object of type T into a plain Javascript object (suitable for
 * writing directly to the Firestore database).
 * @property ***REMOVED***Function} fromFirestore Called by the Firestore SDK to convert
 * Firestore data into an object of type T.
 * @typedef ***REMOVED***Object} FirestoreDataConverter
 */
/**
 * Update data (for use with [update]***REMOVED***@link DocumentReference#update})
 ...
 * documentRef.set(***REMOVED***a1: ***REMOVED***a2: 'val'}, b1: ***REMOVED***b2: 'val'}, c1: ***REMOVED***c2: 'val'}});
 * documentRef.update(***REMOVED***
 *  b1: ***REMOVED***b3: 'val'},
 *  'c1.c3': 'val',
 * });
 * // Value is ***REMOVED***a1: ***REMOVED***a2: 'val'}, b1: ***REMOVED***b3: 'val'}, c1: ***REMOVED***c2: 'val', c3: 'val'}}
 *
 * ```
 * @typedef ***REMOVED***Object.<string, *>} UpdateData
 */
/**
 * An options object that configures conditional behavior of
 * [update()]***REMOVED***@link DocumentReference#update} and
 * [delete()]***REMOVED***@link DocumentReference#delete} calls in
 * [DocumentReference]***REMOVED***@link DocumentReference},
 * [WriteBatch]***REMOVED***@link WriteBatch}, [BulkWriter]***REMOVED***@link BulkWriter}, and
 * [Transaction]***REMOVED***@link Transaction}. Using Preconditions, these calls
 ...
 * const documentRef = firestore.doc('coll/doc');
 *
 * documentRef.get().then(snapshot => ***REMOVED***
 *   const updateTime = snapshot.updateTime;
 *
 *   console.log(`Deleting document at update time: $***REMOVED***updateTime.toDate()}`);
 *   return documentRef.delete(***REMOVED*** lastUpdateTime: updateTime });
 * });
 *
 * ```
 * @property ***REMOVED***Timestamp} lastUpdateTime The update time to enforce. If set,
 ...
 * @property ***REMOVED***boolean} exists If set, enforces that the target document must
 * or must not exist.
 * @typedef ***REMOVED***Object} Precondition
 */
/**
 * An options object that configures the behavior of
 * [set()]***REMOVED***@link DocumentReference#set} calls in
 * [DocumentReference]***REMOVED***@link DocumentReference},
 * [WriteBatch]***REMOVED***@link WriteBatch}, and
 * [Transaction]***REMOVED***@link Transaction}. These calls can be
 * configured to perform granular merges instead of overwriting the target
 * documents in their entirety by providing a SetOptions object with
 * ***REMOVED*** merge : true }.
 *
 * @property ***REMOVED***boolean} merge Changes the behavior of a set() call to only
 * replace the values specified in its data argument. Fields omitted from the
 * set() call remain untouched.
 * @property ***REMOVED***Array<(string|FieldPath)>} mergeFields Changes the behavior of
 ...
 * @typedef ***REMOVED***Object} SetOptions
 */
/**
 * An options object that can be used to configure the behavior of
 * [getAll()]***REMOVED***@link Firestore#getAll} calls. By providing a `fieldMask`, these
 * calls can be configured to only return a subset of fields.
 *
 * @property ***REMOVED***Array<(string|FieldPath)>} fieldMask Specifies the set of fields
 ...
 * @typedef ***REMOVED***Object} ReadOptions
 */
/**
 ...
 *
 * @property ***REMOVED***boolean|Object} throttling Whether to disable or enable
 * throttling. Throttling is enabled by default, if the field is set to `true`
 * or if any custom throttling options are provided. `***REMOVED*** initialOpsPerSecond:
 ...
 * operations per second. `***REMOVED*** maxOpsPerSecond: number }` sets the maximum number
 * of operations per second allowed by the throttler. If `maxOpsPerSecond` is
 * not set, no maximum is enforced.
 * @typedef ***REMOVED***Object} BulkWriterOptions
 */
/**
 * An error thrown when a BulkWriter operation fails.
 *
 * The error used by ***REMOVED***@link BulkWriter~shouldRetryCallback} set in
 * ***REMOVED***@link BulkWriter#onWriteError}.
 *
 * @property ***REMOVED***GrpcStatus} code The status code of the error.
 * @property ***REMOVED***string} message The error message of the error.
 * @property ***REMOVED***DocumentReference} documentRef The document reference the
 * operation was performed on.
 * @property ***REMOVED***'create' | 'set' | 'update' | 'delete'} operationType The type
 * of operation performed.
 * @property ***REMOVED***number} failedAttempts How many times this operation has been
 * attempted unsuccessfully.
 * @typedef ***REMOVED***Error} BulkWriterError
 */
/**
 ...
 *
 * @enum ***REMOVED***number}
 * @typedef ***REMOVED***Object} GrpcStatus
 */
/**
 * The Firestore client represents a Firestore Database and is the entry point
 * for all Firestore operations.
 *
 * @see [Firestore Documentation]***REMOVED***@link https://firebase.google.com/docs/firestore/}
 *
 * @class
 *
 ...
 * ```
 * var firestore = new Firestore(***REMOVED*** projectId:
...
class Firestore ***REMOVED***
    /**
     * @param ***REMOVED***Object=} settings [Configuration object](#/docs).
     * @param ***REMOVED***string=} settings.projectId The project ID from the Google
     ...
     * ***REMOVED***@link https://cloud.google.com/docs/authentication Application Default
     * Credentials}
     * @param ***REMOVED***string=} settings.keyFilename Local file containing the Service
     ...
     * @param ***REMOVED******REMOVED***client_email:string=, private_key:string=}=} settings.credentials
     * The `client_email` and `private_key` properties of the service account
     * to use with your Firestore project. Can be omitted in environments that
     * support ***REMOVED***@link https://cloud.google.com/docs/authentication Application
     * Default Credentials}. If your credentials are stored in a JSON file, you
     * can specify a `keyFilename` instead.
     * @param ***REMOVED***string=} settings.host The host to connect to.
     * @param ***REMOVED***boolean=} settings.ssl Whether to use SSL when connecting.
     * @param ***REMOVED***number=} settings.maxIdleChannels The maximum number of idle GRPC
     ...
     * Defaults to 1.
     * @param ***REMOVED***boolean=} settings.ignoreUndefinedProperties Whether to skip nested
     ...
     * @param ***REMOVED***boolean=} settings.preferRest Whether to force the use of HTTP/1.1 REST
    ...
    constructor(settings) ***REMOVED***
        ...
        const libraryHeader = ***REMOVED***
            libName: 'gccl',
            libVersion,
      ***REMOVED***;
        if (settings && settings.firebaseVersion) ***REMOVED***
            libraryHeader.libVersion += ' fire/' + settings.firebaseVersion;
      ***REMOVED***
        this.validateAndApplySettings(***REMOVED*** ...settings, ...libraryHeader });
        const retryConfig = serviceConfig.retry_params.default;
        this._backoffSettings = ***REMOVED***
      ...
      ***REMOVED***;
        ...
        /* clientFactory= */ (requiresGrpc) => ***REMOVED***
            var _a;
            let client;
          ...
          ***REMOVED***
              ...
              ***REMOVED***
          ***REMOVED***
            if (this._settings.ssl === false) ***REMOVED***
          ...
          ***REMOVED***
                ...
                client = new module.exports.v1(***REMOVED***
                    ...this._settings,
                    fallback: useFallback,
              ***REMOVED***, gax);
          ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    getBulkWriter() ***REMOVED***
        if (!this._bulkWriter) ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * @param ***REMOVED***object} settings The settings to use for all Firestore operations.
     */
    settings(settings) ***REMOVED***
        (0, validate_1.validateObject)('settings', settings);
        (0, validate_1.validateString)('settings.projectId', settings.projectId, ***REMOVED*** optional: true });
        (0, validate_1.validateString)('settings.databaseId', settings.databaseId, ***REMOVED***
            optional: true,
      ***REMOVED***);
        if (this._settingsFrozen) ***REMOVED***
            throw new Error('Firestore has already been initialized. You can only call ' +
                ...
                'Firestore object.');
      ***REMOVED***
        const mergedSettings = ***REMOVED*** ...this._settings, ...settings };
        this.validateAndApplySettings(mergedSettings);
        this._settingsFrozen = true;
  ***REMOVED***
    validateAndApplySettings(settings) ***REMOVED***
        var _a;
        if (settings.projectId !== undefined) ***REMOVED***
            (0, validate_1.validateString)('settings.projectId', settings.projectId);
            this._projectId = settings.projectId;
      ***REMOVED***
        if (settings.databaseId !== undefined) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (process.env.FIRESTORE_EMULATOR_HOST) ***REMOVED***
            ...
            settings = ***REMOVED***
                ...
                ssl: false,
          ***REMOVED***;
            url = new url_1.URL(`http://$***REMOVED***settings.host}`);
      ***REMOVED***
        else if (settings.host !== undefined) ***REMOVED***
        ...
        if (url !== null) ***REMOVED***
            if ((settings.servicePath !== undefined &&
                ...
                (settings.apiEndpoint !== undefined &&
                    settings.apiEndpoint !== url.hostname)) ***REMOVED***
                // eslint-disable-next-line no-console
                console.warn(`The provided host ($***REMOVED***url.hostname}) in "settings" does not ` +
                    `match the existing host ($***REMOVED***(_a = settings.servicePath) !== null && _a !== void 0 ? _a : settings.apiEndpoint}). Using the provided host.`);
          ***REMOVED***
            settings.servicePath = url.hostname;
            if (url.port !== '' && settings.port === undefined) ***REMOVED***
      ...
      ***REMOVED***
        if (settings.maxIdleChannels !== undefined) ***REMOVED***
            (0, validate_1.validateInteger)('settings.maxIdleChannels', settings.maxIdleChannels, ***REMOVED***
                minValue: 0,
          ***REMOVED***);
      ***REMOVED***
        this._settings = settings;
        this._settings.toJson = function () ***REMOVED***
            const temp = Object.assign(***REMOVED***}, this);
            if (temp.credentials) ***REMOVED***
                temp.credentials = ***REMOVED*** private_key: '***', client_email: '***' };
          ***REMOVED***
            return temp;
      ***REMOVED***;
  ...
  ***REMOVED***
    ...
    get projectId() ***REMOVED***
        if (this._projectId === undefined) ***REMOVED***
  ...
  ***REMOVED***
    ...
    get formattedName() ***REMOVED***
        return `projects/$***REMOVED***this.projectId}/databases/$***REMOVED***this.databaseId}`;
  ***REMOVED***
    /**
     ...
     * @returns ***REMOVED***DocumentReference} The
     * [DocumentReference]***REMOVED***@link DocumentReference} instance.
     *
     * @example
     * ```
     * let documentRef = firestore.doc('collection/document');
     * console.log(`Path of document is $***REMOVED***documentRef.path}`);
     * ```
     */
  ...
  ***REMOVED***
     ...
     * @returns ***REMOVED***CollectionReference} The
     * [CollectionReference]***REMOVED***@link CollectionReference} instance.
     *
     * @example
     * ```
     ...
     * collectionRef.add(***REMOVED***foo: 'bar'}).then((documentRef) => ***REMOVED***
     *   console.log(`Added document at $***REMOVED***documentRef.path})`);
     * });
     * ```
     */
  ...
  ***REMOVED***
     ...
     * given collectionId.
     *
     * @param ***REMOVED***string} collectionId Identifies the collections to query over.
     * Every collection or subcollection with this ID as the last segment of its
     * path will be included. Cannot contain a slash.
     * @returns ***REMOVED***CollectionGroup} The created CollectionGroup.
     *
     * @example
     * ```
     * let docA = firestore.doc('mygroup/docA').set(***REMOVED***foo: 'bar'});
     * let docB = firestore.doc('abc/def/mygroup/docB').set(***REMOVED***foo: 'bar'});
     *
     * Promise.all([docA, docB]).then(() => ***REMOVED***
     *    let query = firestore.collectionGroup('mygroup');
     *    query = query.where('foo', '==', 'bar');
     *    return query.get().then(snapshot => ***REMOVED***
     *       console.log(`Found $***REMOVED***snapshot.size} documents.`);
     *  ***REMOVED***);
     * });
     * ```
     */
    collectionGroup(collectionId) ***REMOVED***
        if (collectionId.indexOf('/') !== -1) ***REMOVED***
            throw new Error(`Invalid collectionId '$***REMOVED***collectionId}'. Collection IDs must not contain '/'.`);
      ***REMOVED***
        return new collection_group_1.CollectionGroup(this, collectionId, /* converter= */ undefined);
  ***REMOVED***
    /**
     * Creates a [WriteBatch]***REMOVED***@link WriteBatch}, used for performing
     * multiple writes as a single atomic operation.
     *
     * @returns ***REMOVED***WriteBatch} A WriteBatch that operates on this Firestore
     * client.
     *
     * @example
     * ```
  ...
  ***REMOVED***
    /**
     * Creates a [BulkWriter]***REMOVED***@link BulkWriter}, used for performing
     * multiple writes in parallel. Gradually ramps up writes as specified
     * by the 500/50/5 rule.
     *
     * If you pass [BulkWriterOptions]***REMOVED***@link BulkWriterOptions}, you can
     * configure the throttling rates for the created BulkWriter.
     *
     * @see [500/50/5 Documentation]***REMOVED***@link https://firebase.google.com/docs/firestore/best-practices#ramping_up_traffic}
     *
     * @param ***REMOVED***BulkWriterOptions=} options BulkWriter options.
     * @returns ***REMOVED***BulkWriter} A BulkWriter that operates on this Firestore
     * client.
     *
     * @example
     * ```
     ...
     *
     * bulkWriter.create(firestore.doc('col/doc1'), ***REMOVED***foo: 'bar'})
     *   .then(res => ***REMOVED***
     *     console.log(`Added document at $***REMOVED***res.writeTime}`);
     * ***REMOVED***);
     * bulkWriter.update(firestore.doc('col/doc2'), ***REMOVED***foo: 'bar'})
     *   .then(res => ***REMOVED***
     *     console.log(`Updated document at $***REMOVED***res.writeTime}`);
     * ***REMOVED***);
     * bulkWriter.delete(firestore.doc('col/doc3'))
     *   .then(res => ***REMOVED***
     *     console.log(`Deleted document at $***REMOVED***res.writeTime}`);
     * ***REMOVED***);
     * await bulkWriter.close().then(() => ***REMOVED***
     *   console.log('Executed all writes');
     * });
     * ```
     */
    bulkWriter(options) ***REMOVED***
  ...
  ***REMOVED***
    ...
    snapshot_(documentOrName, readTime, encoding) ***REMOVED***
        ...
        let convertFields;
        if (encoding === undefined || encoding === 'protobufJS') ***REMOVED***
            convertTimestamp = data => data;
            convertFields = data => data;
      ***REMOVED***
        else if (encoding === 'json') ***REMOVED***
      ...
      ***REMOVED***
            ...
            throw new Error('Unsupported encoding format. Expected "json" or "protobufJS", ' +
                `but was "$***REMOVED***encoding}".`);
      ***REMOVED***
        let ref;
        let document;
        if (typeof documentOrName === 'string') ***REMOVED***
  ...
  ***REMOVED***
    /**
     * Function executed by ***REMOVED***@link Firestore#runTransaction} within the transaction
     * context.
     *
     * @callback Firestore~updateFunction
     * @template T
     * @param ***REMOVED***Transaction} transaction The transaction object for this
     * transaction.
     * @returns ***REMOVED***Promise<T>} The promise returned at the end of the transaction.
     * This promise will be returned by ***REMOVED***@link Firestore#runTransaction} if the
     * transaction completed successfully.
     */
    /**
     * Options object for ***REMOVED***@link Firestore#runTransaction} to configure a
     * read-only transaction.
     *
     * @param ***REMOVED***true} readOnly Set to true to indicate a read-only transaction.
     * @param ***REMOVED***Timestamp=} readTime If specified, documents are read at the given
     * time. This may not be more than 60 seconds in the past from when the
     * request is processed by the server.
     * @typedef ***REMOVED***Object} Firestore~ReadOnlyTransactionOptions
     */
    /**
     * Options object for ***REMOVED***@link Firestore#runTransaction} to configure a
     * read-write transaction.
     *
     * @param ***REMOVED***false=} readOnly Set to false or omit to indicate a read-write
     * transaction.
     * @param ***REMOVED***number=} maxAttempts The maximum number of attempts for this
     * transaction. Defaults to 5.
     * @typedef ***REMOVED***Object} Firestore~ReadWriteTransactionOptions
     */
    /**
     ...
     *
     * @template T
     * @param ***REMOVED***Firestore~updateFunction} updateFunction The user function to
     * execute within the transaction context.
     * @param ***REMOVED***
     * Firestore~ReadWriteTransactionOptions|Firestore~ReadOnlyTransactionOptions=
     * } transactionOptions Transaction options.
     * @returns ***REMOVED***Promise<T>} If the transaction completed successfully or was
     ...
     *     ***REMOVED***
     *       transaction.update(documentRef, ***REMOVED*** count: ++count });
     *       return Promise.resolve(count);
     *   ***REMOVED***
     *
     *     transaction.create(documentRef, ***REMOVED*** count: 1 });
     *     return Promise.resolve(1);
     * ***REMOVED***);
     * });
     *
     * counterTransaction.then(res => ***REMOVED***
     *   console.log(`Count updated to $***REMOVED***res}`);
     * });
     * ```
     */
    runTransaction(updateFunction, transactionOptions) ***REMOVED***
        ...
        let readOnly = false;
        let readTime;
        if (transactionOptions) ***REMOVED***
            (0, validate_1.validateObject)('transactionOptions', transactionOptions);
            (0, validate_1.validateBoolean)('transactionOptions.readOnly', transactionOptions.readOnly, ***REMOVED*** optional: true });
            if (transactionOptions.readOnly) ***REMOVED***
                (0, validate_1.validateTimestamp)('transactionOptions.readTime', transactionOptions.readTime, ***REMOVED*** optional: true });
                readOnly = true;
                readTime = transactionOptions.readTime;
                maxAttempts = 1;
          ***REMOVED***
            else ***REMOVED***
                (0, validate_1.validateInteger)('transactionOptions.maxAttempts', transactionOptions.maxAttempts, ***REMOVED*** optional: true, minValue: 1 });
                maxAttempts =
      ...
      ***REMOVED***
        ...
        return this.initializeIfNeeded(tag).then(() => transaction.runTransaction(updateFunction, ***REMOVED***
            maxAttempts,
            readOnly,
            readTime,
      ***REMOVED***));
  ***REMOVED***
     ...
     * @example
     * ```
     * firestore.listCollections().then(collections => ***REMOVED***
     *   for (let collection of collections) ***REMOVED***
     *     console.log(`Found collection with id: $***REMOVED***collection.id}`);
     * ***REMOVED***
     * });
     * ```
     */
  ...
  ***REMOVED***
     ...
     *
     * @param ***REMOVED***...DocumentReference|ReadOptions} documentRefsOrReadOptions The
     * `DocumentReferences` to receive, followed by an optional field mask.
     * @returns ***REMOVED***Promise<Array.<DocumentSnapshot>>} A Promise that
     ...
     *
     * firestore.getAll(docRef1, docRef2, ***REMOVED*** fieldMask: ['user'] }).then(docs => ***REMOVED***
     *   console.log(`First document: $***REMOVED***JSON.stringify(docs[0])}`);
     *   console.log(`Second document: $***REMOVED***JSON.stringify(docs[1])}`);
     * });
     * ```
     */
    getAll(...documentRefsOrReadOptions) ***REMOVED***
        (0, validate_1.validateMinNumberOfArguments)('Firestore.getAll', documentRefsOrReadOptions, 1);
        const ***REMOVED*** documents, fieldMask } = (0, transaction_1.parseGetAllArguments)(documentRefsOrReadOptions);
        const tag = (0, util_1.requestTag)();
  ...
  ***REMOVED***
     ...
     * @internal
     */
    _incrementBulkWritersCount() ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    _decrementBulkWritersCount() ***REMOVED***
        this.bulkWritersCount -= 1;
  ***REMOVED***
    /**
     ...
     * ```
     */
    recursiveDelete(ref, bulkWriter) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    // Visible for testing
    _recursiveDelete(ref, maxPendingOps, minPendingOps, bulkWriter) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    terminate() ***REMOVED***
        if (this.registeredListenersCount > 0 || this.bulkWritersCount > 0) ***REMOVED***
            return Promise.reject('All onSnapshot() listeners must be unsubscribed, and all BulkWriter ' +
                ...
                `There are $***REMOVED***this.registeredListenersCount} active listeners and ` +
                `$***REMOVED***this.bulkWritersCount} open BulkWriter instances.`);
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    toJSON() ***REMOVED***
        return ***REMOVED*** projectId: this._projectId };
  ***REMOVED***
    /**
     ...
     */
    async initializeIfNeeded(requestTag) ***REMOVED***
        this._settingsFrozen = true;
        if (this._settings.ssl === false) ***REMOVED***
            ...
            // precedence).
            this._settings.customHeaders = ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @internal
     */
    createCallOptions(methodName, retryCodes) ***REMOVED***
        var _a;
        const callOptions = ***REMOVED***
            otherArgs: ***REMOVED***
                headers: ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @returns ***REMOVED***Promise} A Promise indicating the function's success.
     */
    /**
     ...
     */
    async _retry(methodName, requestTag, func) ***REMOVED***
        const backoff = new backoff_1.ExponentialBackoff();
        let lastError = undefined;
        for (let attempt = 0; attempt < exports.MAX_REQUEST_RETRIES; ++attempt) ***REMOVED***
            if (lastError) ***REMOVED***
          ...
          ***REMOVED***
                ...
                lastError = err;
                if ((0, util_1.isPermanentRpcError)(err, methodName)) ***REMOVED***
                    break;
              ***REMOVED***
          ***REMOVED***
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     * `backendStream`.
     */
    _initializeStream(backendStream, lifetime, requestTag, request) ***REMOVED***
        const resultStream = new stream_1.PassThrough(***REMOVED*** objectMode: true });
        resultStream.pause();
        /**
        ...
        return new Promise((resolve, reject) => ***REMOVED***
          ...
          ***REMOVED***
            ...
            if (request) ***REMOVED***
                ...
                backendStream.write(request, 'utf-8', err => ***REMOVED***
                    if (err) ***REMOVED***
                        streamFailed(err);
                  ***REMOVED***
                    else ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    request(methodName, request, requestTag, retryCodes) ***REMOVED***
        const callOptions = this.createCallOptions(methodName, retryCodes);
        return this._clientPool.run(requestTag, 
        /* requiresGrpc= */ false, async (gapicClient) => ***REMOVED***
            try ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    requestStream(methodName, bidrectional, request, requestTag) ***REMOVED***
        const callOptions = this.createCallOptions(methodName);
        const bidirectional = methodName === 'listen';
        return this._retry(methodName, requestTag, () => ***REMOVED***
            const result = new util_1.Deferred();
            this._clientPool.run(requestTag, bidrectional, async (gapicClient) => ***REMOVED***
                ...
                try ***REMOVED***
                    ...
                    const logStream = new stream_1.Transform(***REMOVED***
                        objectMode: true,
 ...
 * @param ***REMOVED***string} Log message
 */
// tslint:disable-next-line:no-default-export
/**
 * The default export of the `@google-cloud/firestore` package is the
 * ***REMOVED***@link Firestore} class.
 *
 * See ***REMOVED***@link Firestore} and ***REMOVED***@link ClientConfig} for client methods and
 * configuration options.
 *
 * @module ***REMOVED***Firestore} @google-cloud/firestore
...
/**
 * ***REMOVED***@link v1beta1} factory function.
 *
 * @private
 * @internal
 ...
 * @type ***REMOVED***function}
 */
Object.defineProperty(module.exports, 'v1', ***REMOVED***
    // The v1 module is very large. To avoid pulling it in from static
    // scope, we lazy-load  the module.
    get: () => require('./v1'),
});
/**
 * ***REMOVED***@link Status} factory function.
 *
 * @private
 * @internal
 ...
 * @type ***REMOVED***function}
 */
Object.defineProperty(module.exports, 'GrpcStatus', ***REMOVED***
