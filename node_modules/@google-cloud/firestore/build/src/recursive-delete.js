...
class RecursiveDelete ***REMOVED***
     ...
     */
    constructor(firestore, writer, ref, maxLimit, minLimit) ***REMOVED***
  ...
  ***REMOVED***
    ...
    setupStream() ***REMOVED***
      ...
      ***REMOVED***)
            ...
            if (streamedDocsCount < this.minPendingOps) ***REMOVED***
                this.onQueryEnd();
          ***REMOVED***
            else if (this.pendingOpsCount === 0) ***REMOVED***
                this.setupStream();
          ***REMOVED***
      ***REMOVED***);
  ***REMOVED***
     ...
     * @private
     * @internal
     * @return ***REMOVED***Stream<QueryDocumentSnapshot>} Stream of descendant documents.
     */
    getAllDescendants(ref) ***REMOVED***
        ...
        if (ref instanceof _1.CollectionReference) ***REMOVED***
      ...
      ***REMOVED***
        if (this.lastDocumentSnap) ***REMOVED***
  ...
  ***REMOVED***
    ...
    onQueryEnd() ***REMOVED***
        ...
        if (this.ref instanceof _1.DocumentReference) ***REMOVED***
            this.writer.delete(this.ref).catch(err => this.incrementErrorCount(err));
      ***REMOVED***
        this.writer.flush().then(async () => ***REMOVED***
            var _a;
            if (this.lastError === undefined) ***REMOVED***
                this.completionDeferred.resolve();
          ***REMOVED***
            else ***REMOVED***
                let error = new (require('google-gax/build/src/fallback').GoogleError)(`$***REMOVED***this.errorCount} ` +
                    `$***REMOVED***this.errorCount !== 1 ? 'deletes' : 'delete'} ` +
                    'failed. The last delete failed with: ');
                if (this.lastError.code !== undefined) ***REMOVED***
    ...
    deleteRef(docRef) ***REMOVED***
      ...
      ***REMOVED***)
            ...
            if (this.documentsPending &&
                ...
                this.pendingOpsCount < this.minPendingOps) ***REMOVED***
                this.setupStream();
          ***REMOVED***
      ***REMOVED***);
  ***REMOVED***
    incrementErrorCount(err) ***REMOVED***
        this.errorCount++;
        this.lastError = err;
  ***REMOVED***
}
