...
import ***REMOVED*** FieldTransform } from './field-value';
import ***REMOVED*** FieldPath } from './path';
import ***REMOVED*** DocumentReference } from './reference';
import ***REMOVED*** Serializer } from './serializer';
import ***REMOVED*** Timestamp } from './timestamp';
import ***REMOVED*** ApiMapValue, UpdateMap } from './types';
 ...
 * @internal
 */
export declare class DocumentSnapshotBuilder<T = firestore.DocumentData> ***REMOVED***
 ...
 */
export declare class DocumentSnapshot<T = firestore.DocumentData> implements firestore.DocumentSnapshot<T> ***REMOVED***
    /** @private */
 ...
 */
export declare class QueryDocumentSnapshot<T = firestore.DocumentData> extends DocumentSnapshot<T> implements firestore.QueryDocumentSnapshot<T> ***REMOVED***
    /**
 ...
 * @internal
 */
export declare class DocumentMask ***REMOVED***
 ...
 * @class
 */
export declare class DocumentTransform<T = firestore.DocumentData> ***REMOVED***
