 ...
 * @class
 */
declare abstract class Path<T> ***REMOVED***
 ...
 * @internal
 */
export declare class ResourcePath extends Path<ResourcePath> ***REMOVED***
    /**
 ...
 * @internal
 */
export declare class QualifiedResourcePath extends ResourcePath ***REMOVED***
    /**
 ...
 * @class
 */
export declare class FieldPath extends Path<FieldPath> implements firestore.FieldPath ***REMOVED***
    /**
     ...
     *
     * @param ***REMOVED***...string} segments Sequence of field names that form this path.
     *
     * @example
     * ```
     ...
     *     console.log(`Document contains ***REMOVED***'f.o.o' : ***REMOVED***'bar' : 42}}`);
     * ***REMOVED***);
     * });
     * ```
     */
     ...
     *
     * @returns ***REMOVED***FieldPath}
     */
    static documentId(): FieldPath;
    /**
     * Turns a field path argument into a [FieldPath]***REMOVED***@link FieldPath}.
     * Supports FieldPaths as input (which are passed through) and dot-separated
     * strings.
     *
     * @private
     * @internal
     * @param ***REMOVED***string|FieldPath} fieldPath The FieldPath to create.
     * @returns ***REMOVED***FieldPath} A field path representation.
     */
     ...
     * @internal
     * @override
     * @returns ***REMOVED***string} The representation as expected by the API.
     */
    get formattedName(): string;
    /**
     ...
     * @internal
     * @override
     * @param ***REMOVED***string} fieldPath The path to split.
     * @returns ***REMOVED***Array.<string>} - The split path segments.
     */
     ...
     * @return ***REMOVED***boolean} true if this `FieldPath` is equal to the provided value.
     */
