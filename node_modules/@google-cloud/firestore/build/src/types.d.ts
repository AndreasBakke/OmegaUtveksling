...
import ***REMOVED*** FirestoreDataConverter } from '@google-cloud/firestore';
import ***REMOVED*** CallOptions } from 'google-gax';
 ...
 */
export interface ApiMapValue ***REMOVED***
 ...
 */
export interface GapicClient ***REMOVED***
 ...
 * @internal
 */
export interface ValidationOptions ***REMOVED***
 ...
 * @internal
 */
export interface ProtobufJsValue extends api.IValue ***REMOVED***
    valueType?: string;
}
