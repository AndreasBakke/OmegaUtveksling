...
message Database ***REMOVED***
  option (google.api.resource) = ***REMOVED***
    ...
    pattern: "projects/***REMOVED***project}/databases/***REMOVED***database}"
...
***REMOVED***
  ...
  enum AppEngineIntegrationMode ***REMOVED***
    // Not used.
...
***REMOVED***
  ...
  // Format: `projects/***REMOVED***project}/databases/***REMOVED***database}`
  string name = 1;
