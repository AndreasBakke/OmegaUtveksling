...
service Firestore ***REMOVED***
  ...
  rpc GetDocument(GetDocumentRequest) returns (Document) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v1/***REMOVED***name=projects/*/databases/*/documents/*/**}"
  ***REMOVED***;
***REMOVED***
  ...
  rpc ListDocuments(ListDocumentsRequest) returns (ListDocumentsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      get: "/v1/***REMOVED***parent=projects/*/databases/*/documents/*/**}/***REMOVED***collection_id}"
...
***REMOVED***
  ...
  rpc UpdateDocument(UpdateDocumentRequest) returns (Document) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      patch: "/v1/***REMOVED***document.name=projects/*/databases/*/documents/*/**}"
      body: "document"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc DeleteDocument(DeleteDocumentRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      delete: "/v1/***REMOVED***name=projects/*/databases/*/documents/*/**}"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc BatchGetDocuments(BatchGetDocumentsRequest) returns (stream BatchGetDocumentsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:batchGet"
      body: "*"
  ***REMOVED***;
***REMOVED***
  ...
  rpc BeginTransaction(BeginTransactionRequest) returns (BeginTransactionResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:beginTransaction"
      body: "*"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc Commit(CommitRequest) returns (CommitResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:commit"
      body: "*"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc Rollback(RollbackRequest) returns (google.protobuf.Empty) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:rollback"
      body: "*"
  ***REMOVED***;
...
***REMOVED***
  ...
  rpc RunQuery(RunQueryRequest) returns (stream RunQueryResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***parent=projects/*/databases/*/documents}:runQuery"
      body: "*"
      additional_bindings ***REMOVED***
        post: "/v1/***REMOVED***parent=projects/*/databases/*/documents/*/**}:runQuery"
        body: "*"
...
***REMOVED***
  ...
  // ```
  rpc RunAggregationQuery(RunAggregationQueryRequest) returns (stream RunAggregationQueryResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***parent=projects/*/databases/*/documents}:runAggregationQuery"
      body: "*"
      additional_bindings ***REMOVED***
        post: "/v1/***REMOVED***parent=projects/*/databases/*/documents/*/**}:runAggregationQuery"
        body: "*"
...
***REMOVED***
  ...
  rpc PartitionQuery(PartitionQueryRequest) returns (PartitionQueryResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***parent=projects/*/databases/*/documents}:partitionQuery"
      body: "*"
      additional_bindings ***REMOVED***
        post: "/v1/***REMOVED***parent=projects/*/databases/*/documents/*/**}:partitionQuery"
        body: "*"
...
***REMOVED***
  ...
  rpc Write(stream WriteRequest) returns (stream WriteResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:write"
      body: "*"
  ***REMOVED***;
***REMOVED***
  ...
  rpc Listen(stream ListenRequest) returns (stream ListenResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:listen"
      body: "*"
  ***REMOVED***;
***REMOVED***
  ...
  rpc ListCollectionIds(ListCollectionIdsRequest) returns (ListCollectionIdsResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***parent=projects/*/databases/*/documents}:listCollectionIds"
      body: "*"
      additional_bindings ***REMOVED***
        post: "/v1/***REMOVED***parent=projects/*/databases/*/documents/*/**}:listCollectionIds"
        body: "*"
...
***REMOVED***
  ...
  rpc BatchWrite(BatchWriteRequest) returns (BatchWriteResponse) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***database=projects/*/databases/*}/documents:batchWrite"
      body: "*"
  ***REMOVED***;
***REMOVED***
  ...
  rpc CreateDocument(CreateDocumentRequest) returns (Document) ***REMOVED***
    option (google.api.http) = ***REMOVED***
      post: "/v1/***REMOVED***parent=projects/*/databases/*/documents/**}/***REMOVED***collection_id}"
      body: "document"
  ***REMOVED***;
***REMOVED***
}
...
message RunQueryResponse ***REMOVED***
  ...
  oneof continuation_selector ***REMOVED***
...
message RunAggregationQueryRequest ***REMOVED***
  // Required. The parent resource name. In the format:
  // `projects/***REMOVED***project_id}/databases/***REMOVED***database_id}/documents` or
  // `projects/***REMOVED***project_id}/databases/***REMOVED***database_id}/documents/***REMOVED***document_path}`.
  // For example:
...
message RunAggregationQueryResponse ***REMOVED***
...
message PartitionQueryRequest ***REMOVED***
  // Required. The parent resource name. In the format:
...
message PartitionQueryResponse ***REMOVED***
  // Partition results.
...
message BatchWriteRequest ***REMOVED***
  // Required. The database name. In the format:
  // `projects/***REMOVED***project_id}/databases/***REMOVED***database_id}`.
  string database = 1 [(google.api.field_behavior) = REQUIRED];
...
message BatchWriteResponse ***REMOVED***
  // The result of applying the writes.
  //
  // This i-th write result corresponds to the i-th write in the
  // request.
