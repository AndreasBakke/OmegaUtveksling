...
* add support for serialization to BigInt `(via settings(***REMOVED***useBigInt: true})` (#1016)
...
* support Objects created with Object.create(***REMOVED***}) ([#842](https://www.github.com/googleapis/nodejs-firestore/issues/842)) ([a85f0c3](https://www.github.com/googleapis/nodejs-firestore/commit/a85f0c32eca5d8cf677d621a8ff326623ad5266e))
...
### New Features
- feature: Added `FieldValue.increment()`, which can be used in `create()`, `update()` and `set(..., ***REMOVED***merge:true})` to 
