...
declare namespace FirebaseFirestore ***REMOVED***
   ...
   * mapped to values.
   */
  export type DocumentData = ***REMOVED***[field: string]: DocumentFieldValue};
  ...
  export type PartialWithFieldValue<T> =
    ...
    | (T extends Primitive
        ? T
        : T extends ***REMOVED***}
        ? ***REMOVED***[K in keyof T]?: PartialWithFieldValue<T[K]> | FieldValue}
        : never);
  ...
  export type WithFieldValue<T> =
    ...
    | (T extends Primitive
        ? T
        : T extends ***REMOVED***}
        ? ***REMOVED***[K in keyof T]: WithFieldValue<T[K]> | FieldValue}
        : never);
  ...
  export type UpdateData<T> = T extends Primitive
    ? T
    : T extends ***REMOVED***}
    ? ***REMOVED***[K in keyof T]?: UpdateData<T[K]> | FieldValue} & NestedUpdateFields<T>
    : Partial<T>;
  ...
  export type NestedUpdateFields<T extends Record<string, unknown>> =
    ...
    ***REMOVED***[keyof T & string] // Also include the generated prefix-string keys.
    >;
  ...
  > =
    ...
    ***REMOVED***[K in keyof T & string as `$***REMOVED***Prefix}.$***REMOVED***K}`]+?: T[K]};
...
***REMOVED***
  ...
  export interface Settings ***REMOVED***
     ...
     */
    credentials?: ***REMOVED***client_email?: string; private_key?: string};
...
***REMOVED***
  ...
  export interface ReadOnlyTransactionOptions ***REMOVED***
...
***REMOVED***
  ...
  export interface ReadWriteTransactionOptions ***REMOVED***
...
***REMOVED***
  ...
  export class Firestore ***REMOVED***
     ...
     * ***REMOVED***@link https://firebase.google.com/docs/firestore/}
     */
     ...
     *
     * @param ***REMOVED***object} settings The settings to use for all Firestore
     * operations.
     */
     ...
     *
     * @param ***REMOVED***Array.<DocumentReference|ReadOptions>} documentRefsOrReadOptions
...
***REMOVED***
   ...
   * @class
   */
  export class BulkWriter ***REMOVED***
    private constructor();
     ...
     * [BulkWriterError]***REMOVED***@link BulkWriterError}.
     */
    create<T>(
      documentRef: DocumentReference<T>,
      data: WithFieldValue<T>
     ...
     * [DocumentReference]***REMOVED***@link DocumentReference}. If the document does not
     ...
     * [DocumentReference]***REMOVED***@link DocumentReference}. If the document doesn't yet
...
***REMOVED***
   ...
   */
  export interface BulkWriterOptions ***REMOVED***
    /**
    ...
    readonly throttling?:
      | boolean
      | ***REMOVED***initialOpsPerSecond?: number; maxOpsPerSecond?: number};
***REMOVED***

  /**
   * The error thrown when a BulkWriter operation fails.
   */
  export class BulkWriterError extends Error ***REMOVED***
...
***REMOVED***
   ...
   */
  export interface ReadOptions ***REMOVED***
    /**
...
***REMOVED***
  ...
  export class Query<T = DocumentData> ***REMOVED***
     ...
     * returned query.
     */
    count(): AggregateQuery<***REMOVED***count: AggregateField<number>}>;
...
***REMOVED***
   ...
   */
  export class CollectionGroup<T = DocumentData> extends Query<T> ***REMOVED***
    private constructor();
     ...
     *   .withConverter(postConverter)
     *   .get();
     * for (const doc of querySnapshot.docs) ***REMOVED***
     *   const post = doc.data();
     *   post.title; // string
     *   post.toString(); // Should be defined
     *   post.someNonExistentProperty; // TS error
...
***REMOVED***
   ...
   */
  export class QueryPartition<T = DocumentData> ***REMOVED***
    private constructor();
     ...
     *
     * @return Cursor values that can be used with ***REMOVED***@link Query#startAt} or
     ...
     *
     * @return Cursor values that can be used with ***REMOVED***@link Query#endBefore} or
     ...
     *
     * @return A query partitioned by a ***REMOVED***@link Query#startAt} and ***REMOVED***@link
...
***REMOVED***
  ...
  export class AggregateField<T> ***REMOVED***
    private constructor();
***REMOVED***
   ...
   */
  export interface AggregateSpec ***REMOVED***
...
***REMOVED***
   ...
   */
  export type AggregateSpecData<T extends AggregateSpec> = ***REMOVED***
...
***REMOVED***;
   ...
   */
  export class AggregateQuery<T extends AggregateSpec> ***REMOVED***
    private constructor();
...
***REMOVED***
   ...
   */
  export class AggregateQuerySnapshot<T extends AggregateSpec> ***REMOVED***
    private constructor();
...
***REMOVED***
  ...
  export class FieldValue ***REMOVED***
    ...
    /**
     * Returns a sentinel for use with update() or set() with ***REMOVED***merge:true} to
...
***REMOVED***
   ...
   */
  export class BundleBuilder ***REMOVED***
...
***REMOVED***;
   ...
   */
  export enum GrpcStatus ***REMOVED***
    OK = 0,
    CANCELLED = 1,
    UNKNOWN = 2,
    INVALID_ARGUMENT = 3,
