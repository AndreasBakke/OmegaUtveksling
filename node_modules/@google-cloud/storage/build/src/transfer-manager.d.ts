 ...
 */
import ***REMOVED*** Bucket, UploadOptions, UploadResponse } from './bucket';
import ***REMOVED*** DownloadOptions, DownloadResponse, File } from './file';
export interface UploadManyFilesOptions ***REMOVED***
    concurrencyLimit?: number;
    skipIfExists?: boolean;
    prefix?: string;
    passthroughOptions?: Omit<UploadOptions, 'destination'>;
}
export interface DownloadManyFilesOptions ***REMOVED***
    concurrencyLimit?: number;
    prefix?: string;
    stripPrefix?: string;
    passthroughOptions?: DownloadOptions;
}
export interface DownloadFileInChunksOptions ***REMOVED***
    concurrencyLimit?: number;
 ...
 * @experimental
 */
export declare class TransferManager ***REMOVED***
    bucket: Bucket;
