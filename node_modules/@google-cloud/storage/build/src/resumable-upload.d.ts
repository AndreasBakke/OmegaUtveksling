...
import ***REMOVED*** GoogleAuthOptions } from 'google-auth-library';
import ***REMOVED*** Writable } from 'stream';
import ***REMOVED*** RetryOptions, PreconditionOptions } from './storage';
export declare const PROTOCOL_REGEX: RegExp;
export interface ErrorWithCode extends Error ***REMOVED***
    code: number;
}
export type CreateUriCallback = (err: Error | null, uri?: string) => void;
export interface Encryption ***REMOVED***
    key: ***REMOVED***};
    hash: ***REMOVED***};
}
export type PredefinedAcl = 'authenticatedRead' | 'bucketOwnerFullControl' | 'bucketOwnerRead' | 'private' | 'projectPrivate' | 'publicRead';
export interface QueryParameters extends PreconditionOptions ***REMOVED***
...
export interface UploadConfig ***REMOVED***
    /**
...
export interface ConfigMetadata ***REMOVED***
    [key: string]: any;
    /**
...
export interface GoogleInnerError ***REMOVED***
    reason?: string;
}
export interface ApiError extends Error ***REMOVED***
    code?: number;
    errors?: GoogleInnerError[];
}
export declare class Upload extends Writable ***REMOVED***
    bucket: string;
    file: string;
    apiEndpoint: string;
    baseURI: string;
