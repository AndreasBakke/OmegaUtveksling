 ...
 * ***REMOVED***@link Storage} (ES6) class, which should be instantiated with `new`.
 *
 * See ***REMOVED***@link Storage} and ***REMOVED***@link ClientConfig} for client methods and
 * configuration options.
 *
 * @module ***REMOVED***Storage} @google-cloud/storage
 ...
 * credentials</a>:
 * ```
 * const storage = new Storage(***REMOVED*** projectId:
