...
/**
 * Attach functionality to a ***REMOVED***@link Storage.acl} instance. This will add an
 ...
 * @private
 */
class AclRoleAccessorMethods ***REMOVED***
    constructor() ***REMOVED***
        this.owners = ***REMOVED***};
         ...
         * }, function(err, aclObject) ***REMOVED***});
         *
         * //-
  ...
  ***REMOVED***
    _assignAccessMethods(role) ***REMOVED***
        ...
        this[roleGroup] = entities.reduce((acc, entity) => ***REMOVED***
            const isPrefix = entity.charAt(entity.length - 1) === '-';
            accessMethods.forEach(accessMethod => ***REMOVED***
              ...
              ***REMOVED***
                ...
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                acc[method] = (entityId, options, callback) => ***REMOVED***
                    let apiEntity;
 ...
 * ***REMOVED***@link http://goo.gl/6qBBPO| About Access Control Lists}.
 *
 * @constructor Acl
 * @mixin
 * @param ***REMOVED***object} options Configuration options.
 */
class Acl extends AclRoleAccessorMethods ***REMOVED***
  ...
  ***REMOVED***
    /**
     * @typedef ***REMOVED***array} AddAclResponse
     * @property ***REMOVED***object} 0 The Acl Objects.
     * @property ***REMOVED***object} 1 The full API response.
     */
    /**
     * @callback AddAclCallback
     * @param ***REMOVED***?Error} err Request error, if any.
     * @param ***REMOVED***object} acl The Acl Objects.
     * @param ***REMOVED***object} apiResponse The full API response.
     */
    /**
     * Add access controls on a ***REMOVED***@link Bucket} or ***REMOVED***@link File}.
     *
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/bucketAccessControls/insert| BucketAccessControls: insert API Documentation}
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/objectAccessControls/insert| ObjectAccessControls: insert API Documentation}
     *
     * @param ***REMOVED***object} options Configuration options.
     * @param ***REMOVED***string} options.entity Whose permissions will be added.
     * @param ***REMOVED***string} options.role Permissions allowed for the defined entity.
     *     See ***REMOVED***@link https://cloud.google.com/storage/docs/access-control Access
     * Control}.
     * @param ***REMOVED***number} [options.generation] **File Objects Only** Select a specific
     ...
     * @param ***REMOVED***AddAclCallback} [callback] Callback function.
     * @returns ***REMOVED***Promise<AddAclResponse>}
     *
     * @example
     * ```
     * const storage = require('@google-cloud/storage')();
     ...
     *   role: gcs.acl.OWNER_ROLE,
     *   generation: 1
     * }, function(err, aclObject, apiResponse) ***REMOVED***});
     *
     * //-
     * // If the callback is omitted, we'll return a Promise.
     * //-
  ...
  ***REMOVED***
    /**
     * @typedef ***REMOVED***array} RemoveAclResponse
     ...
     */
    /**
     * Delete access controls on a ***REMOVED***@link Bucket} or ***REMOVED***@link File}.
     *
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/bucketAccessControls/delete| BucketAccessControls: delete API Documentation}
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/objectAccessControls/delete| ObjectAccessControls: delete API Documentation}
     *
     * @param ***REMOVED***object} options Configuration object.
     * @param ***REMOVED***string} options.entity Whose permissions will be revoked.
     * @param ***REMOVED***int} [options.generation] **File Objects Only** Select a specific
     *     revision of this file (as opposed to the latest version, the default).
     * @param ***REMOVED***string} [options.userProject] The ID of the project which will be
     *     billed for the request.
     * @param ***REMOVED***RemoveAclCallback} callback The callback function.
     * @returns ***REMOVED***Promise<RemoveAclResponse>}
     *
     * @example
     * ```
     * const storage = require('@google-cloud/storage')();
     ...
     * Example of removing an owner from a bucket:
     */
    delete(options, callback) ***REMOVED***
        const query = ***REMOVED***};
        if (options.generation) ***REMOVED***
            query.generation = options.generation;
      ***REMOVED***
  ...
  ***REMOVED***
    /**
     * @typedef ***REMOVED***array} GetAclResponse
     * @property ***REMOVED***object|object[]} 0 Single or array of Acl Objects.
     * @property ***REMOVED***object} 1 The full API response.
     */
    /**
     * @callback GetAclCallback
     * @param ***REMOVED***?Error} err Request error, if any.
     * @param ***REMOVED***object|object[]} acl Single or array of Acl Objects.
     * @param ***REMOVED***object} apiResponse The full API response.
     */
    /**
     * Get access controls on a ***REMOVED***@link Bucket} or ***REMOVED***@link File}. If
     * an entity is omitted, you will receive an array of all applicable access
     * controls.
     *
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/bucketAccessControls/get| BucketAccessControls: get API Documentation}
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/objectAccessControls/get| ObjectAccessControls: get API Documentation}
     *
     * @param ***REMOVED***object|function} [options] Configuration options. If you want to
     *     receive a list of all access controls, pass the callback function as
     * the only argument.
     * @param ***REMOVED***string} [options.entity] Whose permissions will be fetched.
     * @param ***REMOVED***number} [options.generation] **File Objects Only** Select a specific
     *     revision of this file (as opposed to the latest version, the default).
     * @param ***REMOVED***string} [options.userProject] The ID of the project which will be
     *     billed for the request.
     * @param ***REMOVED***GetAclCallback} [callback] Callback function.
     * @returns ***REMOVED***Promise<GetAclResponse>}
     *
     * @example
     * ```
     * const storage = require('@google-cloud/storage')();
  ...
  ***REMOVED***
    /**
     * @typedef ***REMOVED***array} UpdateAclResponse
     * @property ***REMOVED***object} 0 The updated Acl Objects.
     * @property ***REMOVED***object} 1 The full API response.
     */
    /**
     * @callback UpdateAclCallback
     * @param ***REMOVED***?Error} err Request error, if any.
     * @param ***REMOVED***object} acl The updated Acl Objects.
     * @param ***REMOVED***object} apiResponse The full API response.
     */
    /**
     * Update access controls on a ***REMOVED***@link Bucket} or ***REMOVED***@link File}.
     *
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/bucketAccessControls/update| BucketAccessControls: update API Documentation}
     * See ***REMOVED***@link https://cloud.google.com/storage/docs/json_api/v1/objectAccessControls/update| ObjectAccessControls: update API Documentation}
     *
     * @param ***REMOVED***object} options Configuration options.
     * @param ***REMOVED***string} options.entity Whose permissions will be updated.
     * @param ***REMOVED***string} options.role Permissions allowed for the defined entity.
     *     See ***REMOVED***@link Storage.acl}.
     * @param ***REMOVED***number} [options.generation] **File Objects Only** Select a specific
     *     revision of this file (as opposed to the latest version, the default).
     * @param ***REMOVED***string} [options.userProject] The ID of the project which will be
     *     billed for the request.
     * @param ***REMOVED***UpdateAclCallback} [callback] Callback function.
     * @returns ***REMOVED***Promise<UpdateAclResponse>}
     *
     * @example
     * ```
     * const storage = require('@google-cloud/storage')();
     ...
     * ```
     */
    update(options, callback) ***REMOVED***
        const query = ***REMOVED***};
        if (options.generation) ***REMOVED***
            query.generation = options.generation;
      ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @private
     */
    makeAclObject_(accessControlObject) ***REMOVED***
        const obj = ***REMOVED***
  ...
  ***REMOVED***
     ...
     * @private
     *
     * @param ***REMOVED***string} method Action.
     * @param ***REMOVED***string} path Request path.
     * @param ***REMOVED****} query Request query object.
     * @param ***REMOVED****} body Request body contents.
     * @param ***REMOVED***function} callback Callback function.
     */
 ...
 */
(0, promisify_1.promisifyAll)(Acl, ***REMOVED***
    exclude: ['request'],
});
