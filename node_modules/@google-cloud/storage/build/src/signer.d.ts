...
interface GetCredentialsResponse ***REMOVED***
    client_email?: string;
}
export interface AuthClient ***REMOVED***
    sign(blobToSign: string): Promise<string>;
    getCredentials(): Promise<GetCredentialsResponse>;
}
export interface BucketI ***REMOVED***
    name: string;
}
export interface FileI ***REMOVED***
    name: string;
}
export interface Query ***REMOVED***
    [key: string]: string;
}
export interface GetSignedUrlConfigInternal ***REMOVED***
    expiration: number;
    accessibleAt?: Date;
    method: string;
...
export interface SignerGetSignedUrlConfig ***REMOVED***
...
export interface GetSignedUrlCallback ***REMOVED***
    (err: Error | null, url?: string): void;
}
export declare enum SignerExceptionMessages ***REMOVED***
...
export declare class URLSigner ***REMOVED***
    private authClient;
    private bucket;
    private file?;
 ...
 * @private
 */
export declare class SigningError extends Error ***REMOVED***
    name: string;
}
export ***REMOVED***};
