...
var __classPrivateFieldSet = (this && this.__classPrivateFieldSet) || function (receiver, state, value, kind, f) ***REMOVED***
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
    return (kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value)), value;
};
var __classPrivateFieldGet = (this && this.__classPrivateFieldGet) || function (receiver, state, kind, f) ***REMOVED***
...
/**
 * Ported from ***REMOVED***@link https://github.com/google/crc32c/blob/21fc8ef30415a635e7351ffa0e5d5367943d4a94/src/crc32c_portable.cc#L16-L59 github.com/google/crc32c}
 */
...
const CRC32C_EXCEPTION_MESSAGES = ***REMOVED***
    INVALID_INIT_BASE64_RANGE: (l) => `base64-encoded data expected to equal 4 bytes, not $***REMOVED***l}`,
    INVALID_INIT_BUFFER_LENGTH: (l) => `Buffer expected to equal 4 bytes, not $***REMOVED***l}`,
    INVALID_INIT_INTEGER: (l) => `Number expected to be a safe, unsigned 32-bit integer, not $***REMOVED***l}`,
};
exports.CRC32C_EXCEPTION_MESSAGES = CRC32C_EXCEPTION_MESSAGES;
class CRC32C ***REMOVED***
    /**
     ...
     */
    constructor(initialValue = 0) ***REMOVED***
  ...
  ***REMOVED***
     ...
     * - ***REMOVED***@link https://github.com/google/crc32c/blob/21fc8ef30415a635e7351ffa0e5d5367943d4a94/src/crc32c_portable.cc github.com/google/crc32c}
     * - ***REMOVED***@link https://github.com/googleapis/python-crc32c/blob/a595e758c08df445a99c3bf132ee8e80a3ec4308/src/google_crc32c/python.py github.com/googleapis/python-crc32c}
     * - ***REMOVED***@link https://github.com/googleapis/java-storage/pull/1376/files github.com/googleapis/java-storage}
     *
     * @param data The `Buffer` to generate the CRC32C from
     */
    update(data) ***REMOVED***
        let current = __classPrivateFieldGet(this, _CRC32C_crc32c, "f") ^ 0xffffffff;
        for (const d of data) ***REMOVED***
  ...
  ***REMOVED***
    ...
    validate(input) ***REMOVED***
      ...
      ***REMOVED***
        else if (Buffer.isBuffer(input)) ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * See ***REMOVED***@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify `JSON#stringify`}
     */
    toJSON() ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * See ***REMOVED***@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/toString `Object#toString`}
     */
    toString() ***REMOVED***
  ...
  ***REMOVED***
     ...
     *
     * See ***REMOVED***@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/valueOf `Object#valueOf`}
     */
    valueOf() ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    static fromBuffer(value) ***REMOVED***
        let buffer;
        if (Buffer.isBuffer(value)) ***REMOVED***
            buffer = value;
      ***REMOVED***
        else if ('buffer' in value) ***REMOVED***
            // `ArrayBufferView`
      ...
      ***REMOVED***
        if (buffer.byteLength !== 4) ***REMOVED***
  ...
  ***REMOVED***
    static async fromFile(file) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    static fromString(value) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    static fromNumber(value) ***REMOVED***
        if (!Number.isSafeInteger(value) || value > 2 ** 32 || value < -(2 ** 32)) ***REMOVED***
  ...
  ***REMOVED***
    ...
    static from(value) ***REMOVED***
      ...
      ***REMOVED***
        else if ('byteLength' in value) ***REMOVED***
