...
if (args.includes('--version') || args.includes('-v') || args.includes('--v')) ***REMOVED***
  console.log(pkg.version);
  process.exit(0);
} else if (args.includes('--name') || args.includes('-n') || args.includes('--n')) ***REMOVED***
  console.log(pkg.name);
  process.exit(0);
} else if (args.includes('--help') || args.includes('-h') || args.includes('--h')) ***REMOVED***
