...
import ***REMOVED*** ResourceStream } from './resource-stream';
export interface ParsedArguments extends TransformOptions ***REMOVED***
    /**
 ...
 * `nextQuery`.
 */
export declare class Paginator ***REMOVED***
    /**
     ...
     */
    streamify<T = any>(methodName: string): (this: ***REMOVED***
        [index: string]: Function;
  ***REMOVED***, ...args: any[]) => ResourceStream<T>;
    /**
...
export ***REMOVED*** paginator };
export ***REMOVED*** ResourceStream };
