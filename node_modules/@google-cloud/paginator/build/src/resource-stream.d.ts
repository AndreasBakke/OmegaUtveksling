...
import ***REMOVED*** Transform, Writable } from 'stream';
import ***REMOVED*** ParsedArguments } from './';
interface ResourceEvents<T> ***REMOVED***
...
export declare class ResourceStream<T> extends Transform implements ResourceEvents<T> ***REMOVED***
    _ended: boolean;
    _maxApiCalls: number;
    _nextQuery: ***REMOVED***} | null;
    _reading: boolean;
    _requestFn: Function;
