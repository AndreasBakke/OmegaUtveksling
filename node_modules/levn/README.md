...
parse('***REMOVED***a: String, b: Number}', '***REMOVED***a: str, b: 2}'); // ***REMOVED***a: 'str', b: 2}

// at the top level, you can ommit surrounding delimiters
parse('[Number]', '1,2,3');                      // [1,2,3]
parse('(String, Boolean)', 'hi, false');         // ['hi', false]
parse('***REMOVED***a: String, b: Number}', 'a: str, b: 2'); // ***REMOVED***a: 'str', b: 2}

// wildcard - auto choose type
parse('*', '[hi,(null,[42]),***REMOVED***k: true}]'); // ['hi', [null, [42]], ***REMOVED***k: true}]
```
## Usage
...
* `***REMOVED***key1: val1, key2: val2, ...}` is an Object, and the casting procedure is recursively applied to each property. Eg. `***REMOVED***a: 1, b: 2}` is `***REMOVED***a: 1, b: 2}`.
...
* If an Object is expected, and it is the root node (at the top level), the opening `***REMOVED***` and closing `}` can be omitted. Eg `a: 1, b: 2` is `***REMOVED***a: 1, b: 2}`.
...
```js
parse('RegExp', 're', ***REMOVED***explicit: false});          // /re/
parse('RegExp', 're', ***REMOVED***explicit: true});           // Error: ... does not type check...
parse('RegExp | String', 're', ***REMOVED***explicit: true});  // 're'
```
  ...
  customTypes: ***REMOVED***
    Even: ***REMOVED***
      ...
      validate: function (x) ***REMOVED***
        return x % 2 === 0;
    ***REMOVED***,
      cast: function (x) ***REMOVED***
        return ***REMOVED***type: 'Just', value: parseInt(x)};
    ***REMOVED***
  ***REMOVED***
***REMOVED***
}
  ...
  customTypes: ***REMOVED***
    Person: ***REMOVED***
      ...
      validate: function (x) ***REMOVED***
        x instanceof Person;
    ***REMOVED***,
      cast: function (value, options, typesCast) ***REMOVED***
        var name, age;
        if (***REMOVED***}.toString.call(value).slice(8, -1) !== 'Object') ***REMOVED***
          return ***REMOVED***type: 'Nothing'};
      ***REMOVED***
        name = typesCast(value.name, [***REMOVED***type: 'String'}], options);
        age = typesCast(value.age, [***REMOVED***type: 'Numger'}], options);
        return ***REMOVED***type: 'Just', value: new Person(name, age)};
  ***REMOVED***
***REMOVED***
}
parse('Person', '***REMOVED***name: Laura, age: 25}', options); // Person ***REMOVED***name: 'Laura', age: 25}
```
...
`cast` is a function which receives three arguments, the value under question, options, and the typesCast function. In `cast`, attempt to cast the value into the specified type. If you are successful, return an object in the format `***REMOVED***type: 'Just', value: CAST-VALUE}`, if you know it won't work, return `***REMOVED***type: 'Nothing'}`.  You can use the `typesCast` function to cast any child values. Remember to pass `options` to it. In your function you can also check for `options.explicit` and act accordingly.
