...
```
```javascript
var x=***REMOVED***o:0,_:1,l:function()***REMOVED***return this._+this.o}};x.t=2,x.o=3,console.log(x.l());
```
...
```
```javascript
var x=***REMOVED***o:0,foo_:1,_:function()***REMOVED***return this.foo_+this.o}};x.bar_=2,x.o=3,console.log(x._());
```
...
```
```javascript
var x=***REMOVED***o:0,_:1,calc:function()***REMOVED***return this._+this.o}};x.l=2,x.o=3,console.log(x.calc());
```
...
```
```javascript
var x=***REMOVED***o:0,_:1,calc:function()***REMOVED***return this._+this.o}};x.bar_=2,x.o=3,console.log(x.calc());
```
...
```
```javascript
var o=***REMOVED***foo:1,o:3};o.foo+=o.o,console.log(o.foo);
```
...
```
```javascript
var o=***REMOVED***_$foo$_:1,_$bar$_:3};o._$foo$_+=o._$bar$_,console.log(o._$foo$_);
```
...
```javascript
var code = "function add(first, second) ***REMOVED*** return first + second; }";
var result = UglifyJS.minify(code);
console.log(result.error); // runtime error, or `undefined` if no error
console.log(result.code);  // minified output: function add(n,d)***REMOVED***return n+d}
```
...
```javascript
var code = ***REMOVED***
    "file1.js": "function add(first, second) ***REMOVED*** return first + second; }",
    "file2.js": "console.log(add(1 + 2, 3 + 4));"
};
var result = UglifyJS.minify(code);
console.log(result.code);
// function add(d,n)***REMOVED***return d+n}console.log(add(3,7));
```
...
var options = ***REMOVED*** toplevel: true };
...
var result1 = UglifyJS.minify(***REMOVED***
    "file1.js": "function add(first, second) ***REMOVED*** return first + second; }"
}, options);
var result2 = UglifyJS.minify(***REMOVED***
    "file2.js": "console.log(add(1 + 2, 3 + 4));"
}, options);
console.log(result1.code);
// function n(n,r)***REMOVED***return n+r}
...
fs.writeFileSync("part1.js", UglifyJS.minify(***REMOVED***
    "file1.js": fs.readFileSync("file1.js", "utf8"),
    "file2.js": fs.readFileSync("file2.js", "utf8")
}, options).code, "utf8");
fs.writeFileSync("part2.js", UglifyJS.minify(***REMOVED***
...
To produce warnings:
```javascript
var code = "function f()***REMOVED*** var u; return 2 + 3; }";
var options = ***REMOVED*** warnings: true };
var result = UglifyJS.minify(code, options);
console.log(result.error);    // runtime error, `undefined` in this case
console.log(result.warnings); // [ 'Dropping unused variable u [0:1,18]' ]
console.log(result.code);     // function f()***REMOVED***return 5}
```

An error example:
```javascript
var result = UglifyJS.minify(***REMOVED***"foo.js" : "if (0) else console.log(1);"});
console.log(JSON.stringify(result.error));
// ***REMOVED***"message":"Unexpected token: keyword (else)","filename":"foo.js","line":1,"col":7,"pos":7}
```
...
```javascript
var result = UglifyJS.minify(***REMOVED***"file1.js": "var a = function() ***REMOVED***};"}, ***REMOVED***
    sourceMap: ***REMOVED***
        filename: "out.js",
        url: "out.js.map"
  ***REMOVED***
...
```javascript
var result = UglifyJS.minify(***REMOVED***"compiled.js": "compiled code"}, ***REMOVED***
    sourceMap: ***REMOVED***
...
- `hoist_props` (default: `true`) — hoist properties from constant object and
  ...
  `var o=***REMOVED***p:1, q:2}; f(o.p, o.q);` is converted to `f(1, 2);`. Note: `hoist_props`
...
- `templates` (default: `true`) — compact template literals by embedding expressions
  and/or converting to string literals, e.g. `` `foo $***REMOVED***42}` → "foo 42"``
...
// test.js
var globalVar;
function funcName(firstLongName, anotherLongName) ***REMOVED***
...
UglifyJS.minify(code, ***REMOVED*** mangle: ***REMOVED*** reserved: ['firstLongName'] } }).code;
// 'function funcName(firstLongName,a)***REMOVED***}var globalVar;'

UglifyJS.minify(code, ***REMOVED*** mangle: ***REMOVED*** toplevel: true } }).code;
...
```javascript
var result = UglifyJS.minify(fs.readFileSync("input.js", "utf8"), ***REMOVED***
    compress: ***REMOVED***
        dead_code: true,
        global_defs: ***REMOVED***
            DEBUG: false
...
```javascript
UglifyJS.minify("alert('hello');", ***REMOVED***
    compress: ***REMOVED***
        global_defs: ***REMOVED***
            "@alert": "console.log"
      ***REMOVED***
...
var result = UglifyJS.minify(code, ***REMOVED***
    parse: ***REMOVED***},
    compress: false,
    mangle: false,
    output: ***REMOVED***
...
var result = UglifyJS.minify(ast, ***REMOVED***
    compress: ***REMOVED***},
    mangle: ***REMOVED***},
    output: ***REMOVED***
        ast: true,
...
```javascript
UglifyJS.minify(code, ***REMOVED*** compress: false, mangle: true });
```
...
- When `toplevel` is enabled, UglifyJS effectively assumes input code is wrapped
  within `function()***REMOVED*** ... }`, thus forbids aliasing of declared global variables:
  ```javascript
  A = "FAIL";
  var B = "FAIL";
  // can be `global`, `self`, `window` etc.
  var top = function() ***REMOVED***
      return this;
***REMOVED***();
  // "PASS"
  top.A = "PASS";
...
- Use of `arguments` alongside destructuring as function parameters, e.g.
  `function(***REMOVED***}, arguments) ***REMOVED***}` will result in `SyntaxError` in earlier versions
...
- Later versions of JavaScript will throw `SyntaxError` with the following:
  ...
  try ***REMOVED***
      // ...
***REMOVED*** catch (***REMOVED*** message: a }) ***REMOVED***
      var a;
***REMOVED***
  // SyntaxError: Identifier 'a' has already been declared
  ```
...
- Some versions of Chrome and Node.js will throw `ReferenceError` with the
  following:
  ```javascript
  console.log(((a, b = function() ***REMOVED***
      return a;
      // ReferenceError: a is not defined
***REMOVED***()) => b)());
  ```
...
- Some versions of Chrome and Node.js will give incorrect results with the
  ...
  console.log(***REMOVED***
    ...
    ***REMOVED***,
***REMOVED***);
  // Expected: ***REMOVED*** '42': 'PASS' }
  // Actual:   ***REMOVED*** '42': undefined }
  ```
  UglifyJS may modify the input which in turn may suppress those errors.
- Later versions of JavaScript will throw `SyntaxError` with the following:
  ```javascript
...
- Later versions of JavaScript will throw `SyntaxError` with the following:
  ```javascript
  "use strict";
  console.log(function f() ***REMOVED***
      return f = "PASS";
***REMOVED***());
  // Expected: "PASS"
