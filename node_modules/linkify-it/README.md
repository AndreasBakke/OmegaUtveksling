...
linkify
  ...
  .set(***REMOVED*** fuzzyIP: true });        // Enable IPs in fuzzy links (without schema)

console.log(linkify.test('Site github.com!'));  // true

console.log(linkify.match('Site github.com!')); // [ ***REMOVED***
                                                //   schema: "",
                                                //   index: 5,
                                                //   lastIndex: 15,
                                                //   raw: "github.com",
...
linkify.add('@', ***REMOVED***
  validate: function (text, pos, self) ***REMOVED***
    ...
    if (!self.re.twitter) ***REMOVED***
      self.re.twitter =  new RegExp(
        '^([a-zA-Z0-9_])***REMOVED***1,15}(?!_)(?=$|' + self.re.src_ZPCc + ')'
      );
  ***REMOVED***
    if (self.re.twitter.test(tail)) ***REMOVED***
      // Linkifier allows punctuation chars before prefix,
      // but we additionally disable `@` ("@@mention" is invalid)
      if (pos >= 2 && tail[pos - 2] === '@') ***REMOVED***
        return false;
    ***REMOVED***
  ...
  ***REMOVED***
    return 0;
***REMOVED***,
  normalize: function (match) ***REMOVED***
