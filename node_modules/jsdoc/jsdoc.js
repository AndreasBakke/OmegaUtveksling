...
(() => ***REMOVED***
    ...
    require = require('requizzle')(***REMOVED***
  ...
  ***REMOVED***);
    ...
    if ( fs.statSync(jsdocPath).isSymbolicLink() ) ***REMOVED***
...
(() => ***REMOVED***
  ...
  ***REMOVED***
    ...
    if (env.opts.debug) ***REMOVED***
         ...
         * @name dump
         * @private
         * @param ***REMOVED***...*} obj - Object(s) to print to stdout.
         */
        global.dump = (...args) => ***REMOVED***
