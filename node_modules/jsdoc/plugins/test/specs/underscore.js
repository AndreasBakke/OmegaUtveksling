...
describe('underscore plugin', function () ***REMOVED***
    ...
    it('should not mark normal, public properties as private', function() ***REMOVED***
        // Base line tests
  ...
  ***REMOVED***);
    ...
    it('should hide doclet for symbols beginning with an underscore under normal circumstances', function () ***REMOVED***
        var hidden = docSet.getByLongname('_hidden');
        expect(hidden[0].access).toEqual('private');
  ***REMOVED***);

    it('picks up "this"', function() ***REMOVED***
