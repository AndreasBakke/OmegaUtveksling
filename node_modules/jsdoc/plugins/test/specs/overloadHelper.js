...
describe('plugins/overloadHelper', function() ***REMOVED***
  ...
  ***REMOVED***);
    ...
    it('should export a "parseComplete" handler', function() ***REMOVED***
  ...
  ***REMOVED***);
    ...
    describe('newDoclet handler', function() ***REMOVED***
        it('should not add unique longnames to constructors', function() ***REMOVED***
      ...
      ***REMOVED***);
        ...
        it('should add unique longnames to methods', function() ***REMOVED***
      ...
      ***REMOVED***);
        ...
        it('should update the "variation" property of the method', function() ***REMOVED***
      ...
      ***REMOVED***);
        ...
        it('should not add to or change existing variations that are unique', function() ***REMOVED***
      ...
      ***REMOVED***);
        ...
        it('should not duplicate the names of existing numeric variations', function() ***REMOVED***
      ...
      ***REMOVED***);
        ...
        it('should replace identical variations with new, unique variations', function() ***REMOVED***
  ...
  ***REMOVED***);
    ...
    describe('parseComplete handler', function() ***REMOVED***
        // disabled because on the second run, each comment is being parsed twice; who knows why...
        xit('should not retain parse results between parser runs', function() ***REMOVED***
            parser.clear();
            docSet = jasmine.getDocSetFromFile('plugins/test/fixtures/overloadHelper.js', parser);
