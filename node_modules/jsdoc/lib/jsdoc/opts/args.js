...
function parseQuery(str) ***REMOVED***
 ...
 * @throws ***REMOVED***Error} Illegal arguments will throw errors.
 * @param ***REMOVED***string|String[]} args The command line arguments for this app.
 */
exports.parse = (args = []) => ***REMOVED***
    if (typeof args === 'string' || args.constructor === String) ***REMOVED***
 ...
 * Get a named option.
 * @variation name
 * @param ***REMOVED***string} name The name of the option.
 * @return ***REMOVED***string} The value associated with the given name.
 *//**
* Get all the options for this app.
* @return ***REMOVED***Object} A collection of key/values representing all the options.
*/
exports.get = name => ***REMOVED***
    if (typeof name === 'undefined') ***REMOVED***
        return ourOptions;
  ***REMOVED***
    else if ( hasOwnProp.call(ourOptions, name) ) ***REMOVED***
