 ...
 */
import ***REMOVED*** XmlElement } from "xmlcreate";
import ***REMOVED*** IOptions } from "./options";
export ***REMOVED*** IOptions, IDeclarationOptions, IDtdOptions, IFormatOptions, ITypeHandlers, IWrapHandlers, } from "./options";
/**
 * Indicates that an object of a particular type should be suppressed from the
 * XML output.
 *
 * See the `typeHandlers` property in ***REMOVED***@link IOptions} for more details.
 */
export declare class Absent ***REMOVED***
 ...
 * XML declaration or DTD, and the associated options in ***REMOVED***@link IOptions} are
