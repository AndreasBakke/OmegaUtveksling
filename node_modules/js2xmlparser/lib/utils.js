...
function isSet(val) ***REMOVED***
    return Object.prototype.toString.call(val) === "[object Set]";
}
exports.isSet = isSet;
function isMap(val) ***REMOVED***
...
function stringify(value) ***REMOVED***
    if (!isUndefined(value) && !isNull(value)) ***REMOVED***
        if (isFunction(value === null || value === void 0 ? void 0 : value.toString)) ***REMOVED***
