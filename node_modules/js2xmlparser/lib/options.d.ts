 ...
 * XML.
 */
export interface IOptions ***REMOVED***
    /**
     ...
     *
     * If one of these functions returns the sole instance of ***REMOVED***@link Absent},
     * then the value will be suppressed from the XML output altogether.
     *
     * For example, if `typeHandlers` is:
     * ```javascript
     * ***REMOVED***
     *     "[object Date]": function(value) ***REMOVED***
     *         return value.getYear();
     *   ***REMOVED***,
     *     "[object Null]": function(value) ***REMOVED***
     ...
     * ```javascript
     * ***REMOVED***
     *     "abc": function(key, value) ***REMOVED***
     *         return "def";
     *   ***REMOVED***
     * }
     * ```
 ...
 * to fields.
 */
export declare class Options implements IOptions ***REMOVED***
    aliasString: string;
    attributeString: string;
    cdataInvalidChars: boolean;
    cdataKeys: string[];
 ...
 * ```
 */
export interface IDeclarationOptions ***REMOVED***
    /**
 ...
 * values to fields.
 */
export declare class DeclarationOptions implements IDeclarationOptions ***REMOVED***
    include: boolean;
    encoding?: string;
    standalone?: string;
    version?: string;
 ...
 * ```
 */
export interface IDtdOptions ***REMOVED***
    /**
 ...
 * to fields.
 */
export declare class DtdOptions implements IDtdOptions ***REMOVED***
    include: boolean;
    name?: string;
    sysId?: string;
    pubId?: string;
 ...
 * The options associated with the formatting of the XML document.
 */
export interface IFormatOptions ***REMOVED***
    /**
 ...
 * to fields.
 */
export declare class FormatOptions implements IFormatOptions ***REMOVED***
    doubleQuotes?: boolean;
    indent?: string;
    newline?: string;
    pretty?: boolean;
...
/**
 * Map for the `typeHandlers` property in the ***REMOVED***@link IOptions} interface.
 */
export interface ITypeHandlers ***REMOVED***
    /**
 ...
 * to fields.
 */
export declare class TypeHandlers implements ITypeHandlers ***REMOVED***
    [type: string]: (value: any) => unknown;
    constructor(typeHandlers?: ITypeHandlers);
}
/**
 * Map for the `wrapHandlers` property in the ***REMOVED***@link IOptions} interface.
 */
export interface IWrapHandlers ***REMOVED***
    /**
 ...
 * to fields.
 */
export declare class WrapHandlers implements IWrapHandlers ***REMOVED***
    [key: string]: (key: string, value: any) => string | null;
