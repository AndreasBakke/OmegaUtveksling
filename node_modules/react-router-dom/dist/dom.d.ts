import type ***REMOVED*** FormEncType, FormMethod } from "@remix-run/router";
...
export declare function getFormSubmissionInfo(target: HTMLFormElement | HTMLButtonElement | HTMLInputElement | FormData | URLSearchParams | ***REMOVED***
    [name: string]: string;
} | null, defaultAction: string, options: SubmitOptions): ***REMOVED***
    url: URL;
    method: string;
    encType: string;
    formData: FormData;
