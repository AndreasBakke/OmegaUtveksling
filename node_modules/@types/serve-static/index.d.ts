...
declare namespace serveStatic ***REMOVED***
    var mime: typeof m;
    interface ServeStaticOptions<R extends http.ServerResponse = http.ServerResponse> ***REMOVED***
        /**
  ...
  ***REMOVED***
    ...
    interface RequestHandler<R extends http.ServerResponse> ***REMOVED***
        (request: http.IncomingMessage, response: R, next: () => void): any;
  ***REMOVED***

    interface RequestHandlerConstructor<R extends http.ServerResponse> ***REMOVED***
