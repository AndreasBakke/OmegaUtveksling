...
import ***REMOVED*** KeyObject } from 'crypto';

export class JsonWebTokenError extends Error ***REMOVED***
    inner: Error;

    constructor(message: string, error?: Error);
}

export class TokenExpiredError extends JsonWebTokenError ***REMOVED***
    expiredAt: Date;
 ...
 */
export class NotBeforeError extends JsonWebTokenError ***REMOVED***
    date: Date;

    constructor(message: string, date: Date);
}

export interface SignOptions ***REMOVED***
    /**
...
export interface VerifyOptions ***REMOVED***
    ...
    /** return an object with the decoded `***REMOVED*** payload, header, signature }` instead of only the usual content of the payload. */
...
export interface DecodeOptions ***REMOVED***
    complete?: boolean | undefined;
...
export interface JwtHeader ***REMOVED***
...
export type Secret =
    ...
    | Buffer
    | KeyObject
    | ***REMOVED*** key: string | Buffer; passphrase: string };
 ...
 */
export function verify(token: string, secretOrPublicKey: Secret, options: VerifyOptions & ***REMOVED*** complete: true }): Jwt;
export function verify(token: string, secretOrPublicKey: Secret, options?: VerifyOptions & ***REMOVED*** complete?: false }): JwtPayload | string;
...
export function verify(
    token: string,
    secretOrPublicKey: Secret | GetPublicKeyOrSecret,
    options: VerifyOptions & ***REMOVED*** complete: true },
    callback?: VerifyCallback<Jwt>,
): void;
export function verify(
    token: string,
    secretOrPublicKey: Secret | GetPublicKeyOrSecret,
    options?: VerifyOptions & ***REMOVED*** complete?: false },
    callback?: VerifyCallback<JwtPayload | string>,
): void;
export function verify(
    token: string,
 ...
 * returns - The decoded Token
 */
export function decode(token: string, options: DecodeOptions & ***REMOVED*** complete: true }): null | Jwt;
export function decode(token: string, options: DecodeOptions & ***REMOVED*** json: true }): null | JwtPayload;
