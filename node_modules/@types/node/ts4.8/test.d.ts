 ...
 */
declare module 'node:test' ***REMOVED***
    /**
     * Programmatically start the test runner.
     * @since v18.9.0
     * @param options Configuration options for running tests.
     * @returns A ***REMOVED***@link TapStream} that emits events about the test execution.
     */
     ...
     *
     * The ***REMOVED***@link TestContext} object passed to the fn argument can be used to perform actions
     * related to the current test. Examples include skipping the test, adding additional TAP
     * diagnostic information, or creating subtests.
     *
     * `test()` returns a ***REMOVED***@link Promise} that resolves once the test completes. The return value
     ...
     *
     * ```js
     * test('top level test', async (t) => ***REMOVED***
     *   // The setTimeout() in the following subtest would cause it to outlive its
     *   // parent test if 'await' is removed on the next line. Once the parent test
     *   // completes, it will cancel any outstanding subtests.
     *   await t.test('longer running subtest', async (t) => ***REMOVED***
     ...
     *    ***REMOVED***@link TestContext} object. If the test uses callbacks, the callback function is
     *    passed as the second argument. Default: A no-op function.
     * @returns A ***REMOVED***@link Promise} resolved with `undefined` once the test completes.
     */
    ...
    namespace describe ***REMOVED***
        // Shorthand for skipping a suite, same as `describe([name], ***REMOVED*** skip: true }[, fn])`.
        ...
        // Shorthand for marking a suite as `TODO`, same as `describe([name], ***REMOVED*** todo: true }[, fn])`.
  ...
  ***REMOVED***
    ...
    namespace it ***REMOVED***
        // Shorthand for skipping a test, same as `it([name], ***REMOVED*** skip: true }[, fn])`.
        ...
        // Shorthand for marking a test as `TODO`, same as `it([name], ***REMOVED*** todo: true }[, fn])`.
  ...
  ***REMOVED***
     ...
     * ***REMOVED***@link TestContext} object. If the test uses callbacks, the callback function is passed as
     * the second argument.
     */
  ...
  ***REMOVED***
     ...
     * @since v18.9.0
     */
    interface TapStream extends NodeJS.ReadableStream ***REMOVED***
  ...
  ***REMOVED***
    ...
    interface TestContext ***REMOVED***
         ...
         * the same fashion as the top level ***REMOVED***@link test} function.
         * @since v18.0.0
         * @param name The name of the test, which is displayed when reporting test results.
         *    Default: The `name` property of fn, or `'<anonymous>'` if `fn` does not have a name.
         * @param options Configuration options for the test
  ...
  ***REMOVED***
    ...
    export ***REMOVED*** test as default, run, test, describe, it, before, after, beforeEach, afterEach };
}
