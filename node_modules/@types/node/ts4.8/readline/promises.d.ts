 ...
 * @since v17.0.0
 */
declare module 'readline/promises' ***REMOVED***
    import ***REMOVED*** Interface as _Interface, ReadLineOptions, Completer, AsyncCompleter, Direction } from 'node:readline';
    import ***REMOVED*** Abortable } from 'node:events';

    class Interface extends _Interface ***REMOVED***
        /**
         ...
         * }, ***REMOVED*** once: true });
         *
         * const answer = await rl.question('What is your favorite food? ', ***REMOVED*** signal });
         * console.log(`Oh, so your favorite food is $***REMOVED***answer}`);
         * ```
         *
         * @since v17.0.0
  ...
  ***REMOVED***
    ...
    class Readline ***REMOVED***
        /**
         * @param stream A TTY stream.
         */
        constructor(stream: NodeJS.WritableStream, options?: ***REMOVED*** autoCommit?: boolean });
        /**
  ...
  ***REMOVED***
     ...
     * const rl = readlinePromises.createInterface(***REMOVED***
     *   input: process.stdin,
     ...
     *
     * ```js
     * function completer(line) ***REMOVED***
     ...
     *
     * ```js
     * async function completer(linePartial) ***REMOVED***
     *   await someAsyncWork();
...
declare module 'node:readline/promises' ***REMOVED***
