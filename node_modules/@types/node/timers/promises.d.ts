 ...
 * @since v15.0.0
 */
declare module 'timers/promises' ***REMOVED***
    import ***REMOVED*** TimerOptions } from 'node:timers';
    /**
     * ```js
     * import ***REMOVED***
     *   setTimeout,
     ...
     *
     * const interval = 100;
     * for await (const startTime of setInterval(interval, Date.now())) ***REMOVED***
     *   const now = Date.now();
     *   console.log(now);
    ...
    interface Scheduler ***REMOVED***
        /**
         * ```js
         * import ***REMOVED*** scheduler } from 'node:timers/promises';
         *
...
declare module 'node:timers/promises' ***REMOVED***
