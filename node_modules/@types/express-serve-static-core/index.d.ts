...
import ***REMOVED*** Options as RangeParserOptions, Result as RangeParserResult, Ranges as RangeParserRanges } from 'range-parser';
import ***REMOVED*** ParsedQs } from 'qs';

export ***REMOVED***};

export type Query = ParsedQs;

export interface NextFunction ***REMOVED***
    (err?: any): void;
    /**
     * "Break-out" of a router by calling ***REMOVED***next('router')};
     * @see ***REMOVED***https://expressjs.com/en/guide/using-middleware.html#middleware.router}
     */
    (deferToNext: 'router'): void;
    /**
     * "Break-out" of a route by calling ***REMOVED***next('route')};
     * @see ***REMOVED***https://expressjs.com/en/guide/using-middleware.html#middleware.application}
     */
    (deferToNext: 'route'): void;
}

export interface Dictionary<T> ***REMOVED***
    [key: string]: T;
}

export interface ParamsDictionary ***REMOVED***
    [key: string]: string;
}
...
type RemoveTail<S extends string, Tail extends string> = S extends `$***REMOVED***infer P}$***REMOVED***Tail}` ? P : S;
type GetRouteParameter<S extends string> = RemoveTail<
    RemoveTail<RemoveTail<S, `/$***REMOVED***string}`>, `-$***REMOVED***string}`>,
    `.$***REMOVED***string}`
>;
...
export type RouteParameters<Route extends string> = string extends Route
    ? ParamsDictionary
    : Route extends `$***REMOVED***string}($***REMOVED***string}`
        ? ParamsDictionary //TODO: handling for regex parameters
        : Route extends `$***REMOVED***string}:$***REMOVED***infer Rest}`
            ? (
            GetRouteParameter<Rest> extends never
                ? ParamsDictionary
                : GetRouteParameter<Rest> extends `$***REMOVED***infer ParamName}?`
                    ? ***REMOVED*** [P in ParamName]?: string }
                    : ***REMOVED*** [P in GetRouteParameter<Rest>]: string }
            ) &
            (Rest extends `$***REMOVED***GetRouteParameter<Rest>}$***REMOVED***infer Next}`
...
export interface IRouterHandler<T, Route extends string = string> ***REMOVED***
...
export interface IRouter extends RequestHandler ***REMOVED***
    /**
...
export interface IRoute<Route extends string = string> ***REMOVED***
    path: string;
    stack: any;
...
export interface CookieOptions ***REMOVED***
...
export interface ByteRange ***REMOVED***
    start: number;
    end: number;
}
...
> extends http.IncomingMessage,
     ...
     *  - Checks body params, ex: id=12, ***REMOVED***"id":12}
    ...
    //body: ***REMOVED*** username: string; password: string; remember: boolean; title: string; };
    body: ReqBody;

    //cookies: ***REMOVED*** string; remember: boolean; };
    cookies: any;
...
export interface MediaType ***REMOVED***
    value: string;
    quality: number;
    type: string;
    subtype: string;
...
> extends http.ServerResponse,
     ...
     *    res.set(***REMOVED*** Accept: 'text/plain', 'X-API-Key': 'tobi' });
     *
     ...
     *    res.cookie('rememberme', '1', ***REMOVED*** expires: new Date(Date.now() + 900000), httpOnly: true });
     *
     *    // save as above
     *    res.cookie('rememberme', '1', ***REMOVED*** maxAge: 900000, httpOnly: true })
     */
...
export interface Application<
    Locals extends Record<string, any> = Record<string, any>
> extends EventEmitter, IRouter, Express.Application ***REMOVED***
    /**
     ...
     * Example:
     *
     *    app.render('email', ***REMOVED*** name: 'Tobi' }, function(err, html)***REMOVED***
     *      // ...
     *  ***REMOVED***)
     */
...
export interface Express extends Application ***REMOVED***
    request: Request;
    response: Response;
}
