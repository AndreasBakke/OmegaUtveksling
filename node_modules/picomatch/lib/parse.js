...
const syntaxError = (type, char) => ***REMOVED***
  return `Missing $***REMOVED***type}: "$***REMOVED***char}" - use "\\\\$***REMOVED***char}" to match literal characters`;
};

/**
 * Parse the given input string.
 * @param ***REMOVED***String} input
...
***REMOVED***
  ...
  const opts = ***REMOVED*** ...options };
  const max = typeof opts.maxLength === 'number' ? Math.min(MAX_LENGTH, opts.maxLength) : MAX_LENGTH;

  let len = input.length;
  if (len > max) ***REMOVED***
    throw new SyntaxError(`Input length: $***REMOVED***len}, exceeds maximum allowed length: $***REMOVED***max}`);
***REMOVED***

  const bos = ***REMOVED*** type: 'bos', value: '', output: opts.prepend || '' };
  const tokens = [bos];
...
***REMOVED*** = PLATFORM_CHARS;
  ...
  const globstar = opts => ***REMOVED***
    return `($***REMOVED***capture}(?:(?!$***REMOVED***START_ANCHOR}$***REMOVED***opts.dot ? DOTS_SLASH : DOT_LITERAL}).)*?)`;
***REMOVED***;
...
***REMOVED***;
  ...
  const extglobOpen = (type, value) => ***REMOVED***
    const token = ***REMOVED*** ...EXTGLOB_CHARS[value], conditions: 1, inner: '' };
    ...
    increment('parens');
    push(***REMOVED*** type, value, output: state.output ? '' : ONE_CHAR });
    push(***REMOVED*** type: 'paren', extglob: true, value: advance(), output });
    extglobs.push(token);
***REMOVED***;
  ...
  const extglobClose = token => ***REMOVED***
    ...
    ***REMOVED***
      ...
      if (extglobStar !== star || eos() || /^\)+$/.test(remaining())) ***REMOVED***
        output = token.close = `)$))$***REMOVED***extglobStar}`;
    ***REMOVED***

      if (token.inner.includes('*') && (rest = remaining()) && /^\.[^\\/.]+$/.test(rest)) ***REMOVED***
        // Any non-magical string (`.ts`) or even nested expression (`.***REMOVED***ts,tsx}`) can follow after the closing parenthesis.
        // In this case, we need to parse the string and use it in the output of the original pattern.
        // Suitable patterns: `/!(*.d).ts`, `/!(*.d).***REMOVED***ts,tsx}`, `**/!(*-dbg).@(js)`.
        //
        // Disabling the `fastpaths` option due to a problem with parsing strings as `.ts` in the pattern like `**/!(*.d).ts`.
        const expression = parse(rest, ***REMOVED*** ...options, fastpaths: false }).output;

        output = token.close = `)$***REMOVED***expression})$***REMOVED***extglobStar})`;
    ***REMOVED***
  ...
  ***REMOVED***
    ...
    push(***REMOVED*** type: 'paren', extglob: true, value, output });
    decrement('parens');
***REMOVED***;
  ...
  if (opts.fastpaths !== false && !/(^[*!]|[/()[\]***REMOVED***}"])/.test(input)) ***REMOVED***
...
***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      push(***REMOVED*** type: 'paren', value, output: state.parens ? ')' : '\\)' });
      decrement('parens');
      continue;
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      push(***REMOVED*** type: 'bracket', value });
      continue;
  ***REMOVED***

    if (value === ']') ***REMOVED***
      if (opts.nobracket === true || (prev && prev.type === 'bracket' && prev.value.length === 1)) ***REMOVED***
        push(***REMOVED*** type: 'text', value, output: `\\$***REMOVED***value}` });
        continue;
    ***REMOVED***
    ...
    ***REMOVED***
      ...
      prev.value = `($***REMOVED***capture}$***REMOVED***escaped}|$***REMOVED***prev.value})`;
  ...
  ***REMOVED***
    ...
    if (value === '}') ***REMOVED***
      ...
      if (opts.nobrace === true || !brace) ***REMOVED***
        push(***REMOVED*** type: 'text', value, output: value });
        continue;
    ***REMOVED***
    ...
    ***REMOVED***
      ...
      push(***REMOVED*** type: 'brace', value, output });
      decrement('braces');
      braces.pop();
      continue;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      push(***REMOVED*** type: 'comma', value, output });
      continue;
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      push(***REMOVED*** type: 'slash', value, output: SLASH_LITERAL });
      continue;
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      if ((state.braces + state.parens) === 0 && prev.type !== 'bos' && prev.type !== 'slash') ***REMOVED***
        push(***REMOVED*** type: 'text', value, output: DOT_LITERAL });
        continue;
    ***REMOVED***

      push(***REMOVED*** type: 'dot', value, output: DOT_LITERAL });
      continue;
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      ***REMOVED***
        ...
        push(***REMOVED*** type: 'text', value, output });
        continue;
    ***REMOVED***

      if (opts.dot !== true && (prev.type === 'slash' || prev.type === 'bos')) ***REMOVED***
        push(***REMOVED*** type: 'qmark', value, output: QMARK_NO_DOT });
        continue;
    ***REMOVED***

      push(***REMOVED*** type: 'qmark', value, output: QMARK });
      continue;
  ***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      if ((prev && prev.value === '(') || opts.regex === false) ***REMOVED***
        push(***REMOVED*** type: 'plus', value, output: PLUS_LITERAL });
        continue;
    ***REMOVED***

      if ((prev && (prev.type === 'bracket' || prev.type === 'paren' || prev.type === 'brace')) || state.parens > 0) ***REMOVED***
        push(***REMOVED*** type: 'plus', value });
        continue;
    ***REMOVED***

      push(***REMOVED*** type: 'plus', value: PLUS_LITERAL });
      continue;
  ***REMOVED***
    ...
    if (value === '@') ***REMOVED***
      if (opts.noextglob !== true && peek() === '(' && peek(2) !== '?') ***REMOVED***
        push(***REMOVED*** type: 'at', extglob: true, value, output: '' });
        continue;
    ***REMOVED***
  ...
  ***REMOVED***
    ...
    ***REMOVED***
      ...
      if (opts.bash === true && (!isStart || (rest[0] && rest[0] !== '/'))) ***REMOVED***
        push(***REMOVED*** type: 'star', value, output: '' });
        continue;
    ***REMOVED***
    ...
    ***REMOVED***
      ...
      if (prior.type === 'slash' && prior.prev.type !== 'bos' && !afterStar && eos()) ***REMOVED***
        ...
        prior.output = `(?:$***REMOVED***prior.output}`;
    ...
    ***REMOVED***
      ...
      if (prior.type === 'slash' && prior.prev.type !== 'bos' && rest[0] === '/') ***REMOVED***
        ...
        prev.type = 'globstar';
        prev.output = `$***REMOVED***globstar(opts)}$***REMOVED***SLASH_LITERAL}|$***REMOVED***SLASH_LITERAL}$***REMOVED***end})`;
        prev.value += value;
        ...
        push(***REMOVED*** type: 'slash', value: '/', output: '' });
        continue;
    ***REMOVED***
      ...
      if (prior.type === 'bos' && rest[0] === '/') ***REMOVED***
        prev.type = 'globstar';
        prev.value += value;
        prev.output = `(?:^|$***REMOVED***SLASH_LITERAL}|$***REMOVED***globstar(opts)}$***REMOVED***SLASH_LITERAL})`;
        state.output = prev.output;
        state.globstar = true;
        consume(value + advance());
        push(***REMOVED*** type: 'slash', value: '/', output: '' });
  ...
  ***REMOVED***
    ...
    const token = ***REMOVED*** type: 'star', value, output: star };
...
***REMOVED***
  ...
  if (opts.strictSlashes !== true && (prev.type === 'star' || prev.type === 'bracket')) ***REMOVED***
    push(***REMOVED*** type: 'maybe_slash', value: '', output: `$***REMOVED***SLASH_LITERAL}?` });
***REMOVED***
...
***REMOVED*** = constants.globChars(win32);
  ...
  const capture = opts.capture ? '' : '?:';
  const state = ***REMOVED*** negated: false, prefix: '' };
...
***REMOVED***;
  ...
  const create = str => ***REMOVED***
    switch (str) ***REMOVED***
      case '*':
        return `$***REMOVED***nodot}$***REMOVED***ONE_CHAR}$***REMOVED***star}`;

      case '.*':
        return `$***REMOVED***DOT_LITERAL}$***REMOVED***ONE_CHAR}$***REMOVED***star}`;

      case '*.*':
        return `$***REMOVED***nodot}$***REMOVED***star}$***REMOVED***DOT_LITERAL}$***REMOVED***ONE_CHAR}$***REMOVED***star}`;

      case '*/*':
        return `$***REMOVED***nodot}$***REMOVED***star}$***REMOVED***SLASH_LITERAL}$***REMOVED***ONE_CHAR}$***REMOVED***slashDot}$***REMOVED***star}`;

      case '**':
        return nodot + globstar(opts);

      case '**/*':
        return `(?:$***REMOVED***nodot}$***REMOVED***globstar(opts)}$***REMOVED***SLASH_LITERAL})?$***REMOVED***slashDot}$***REMOVED***ONE_CHAR}$***REMOVED***star}`;

      case '**/*.*':
        return `(?:$***REMOVED***nodot}$***REMOVED***globstar(opts)}$***REMOVED***SLASH_LITERAL})?$***REMOVED***slashDot}$***REMOVED***star}$***REMOVED***DOT_LITERAL}$***REMOVED***ONE_CHAR}$***REMOVED***star}`;

      case '**/.*':
        return `(?:$***REMOVED***nodot}$***REMOVED***globstar(opts)}$***REMOVED***SLASH_LITERAL})?$***REMOVED***DOT_LITERAL}$***REMOVED***ONE_CHAR}$***REMOVED***star}`;
