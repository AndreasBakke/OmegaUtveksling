...
exports.escapeLast = (input, char, lastIdx) => ***REMOVED***
  ...
  return `$***REMOVED***input.slice(0, idx)}\\$***REMOVED***input.slice(idx)}`;
};

exports.removePrefix = (input, state = ***REMOVED***}) => ***REMOVED***
  let output = input;
...
exports.wrapOutput = (input, state = ***REMOVED***}, options = ***REMOVED***}) => ***REMOVED***
  const prepend = options.contains ? '' : '^';
  const append = options.contains ? '' : '$';

  let output = `$***REMOVED***prepend}(?:$***REMOVED***input})$***REMOVED***append}`;
