 ...
 * ***REMOVED*** isGlob: true, input: 'foo/bar/*.js', base: 'foo/bar', glob: '*.js' }
 * ```
 * @param ***REMOVED***String} `str`
 * @param ***REMOVED***Object} `options`
 * @return ***REMOVED***Object} Returns an object with tokens and regex source string.
 * @api public
 */
...
const scan = (input, options) => ***REMOVED***
  ...
  let prev;
  let code;
  let token = ***REMOVED*** value: '', depth: 0, isGlob: false };
...
***REMOVED***;
  ...
  ***REMOVED***
    ...
    if (code === CHAR_FORWARD_SLASH) ***REMOVED***
      slashes.push(index);
      tokens.push(token);
      token = ***REMOVED*** value: '', depth: 0, isGlob: false };
