...
import ***REMOVED*** GaxiosOptions, GaxiosResponse } from 'gaxios';
import * as stream from 'stream';
import ***REMOVED*** DefaultTransporter, Transporter } from '../transporters';
import ***REMOVED*** Compute } from './computeclient';
import ***REMOVED*** CredentialBody, ImpersonatedJWTInput, JWTInput } from './credentials';
import ***REMOVED*** IdTokenClient } from './idtokenclient';
import ***REMOVED*** GCPEnv } from './envDetect';
import ***REMOVED*** JWT, JWTOptions } from './jwtclient';
import ***REMOVED*** Headers, OAuth2ClientOptions, RefreshOptions } from './oauth2client';
import ***REMOVED*** UserRefreshClient, UserRefreshClientOptions } from './refreshclient';
import ***REMOVED*** Impersonated, ImpersonatedOptions } from './impersonated';
import ***REMOVED*** ExternalAccountClientOptions } from './externalclient';
import ***REMOVED*** BaseExternalAccountClient } from './baseexternalclient';
...
export interface ProjectIdCallback ***REMOVED***
    (err?: Error | null, projectId?: string | null): void;
}
export interface CredentialCallback ***REMOVED***
    (err: Error | null, result?: JSONClient): void;
}
export interface ADCCallback ***REMOVED***
    (err: Error | null, credential?: AuthClient, projectId?: string | null): void;
}
export interface ADCResponse ***REMOVED***
    credential: AuthClient;
    projectId: string | null;
}
export interface GoogleAuthOptions<T extends AuthClient = JSONClient> ***REMOVED***
    /**
...
export declare class GoogleAuth<T extends AuthClient = JSONClient> ***REMOVED***
...
export interface SignBlobResponse ***REMOVED***
    keyId: string;
    signedBlob: string;
}
