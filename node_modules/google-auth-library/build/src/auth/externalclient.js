 ...
 */
class ExternalAccountClient ***REMOVED***
    constructor() ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    static fromJSON(options, additionalOptions) ***REMOVED***
        var _a, _b;
        if (options && options.type === baseexternalclient_1.EXTERNAL_ACCOUNT_TYPE) ***REMOVED***
            if ((_a = options.credential_source) === null || _a === void 0 ? void 0 : _a.environment_id) ***REMOVED***
                return new awsclient_1.AwsClient(options, additionalOptions);
          ***REMOVED***
            else if ((_b = options.credential_source) === null || _b === void 0 ? void 0 : _b.executable) ***REMOVED***
