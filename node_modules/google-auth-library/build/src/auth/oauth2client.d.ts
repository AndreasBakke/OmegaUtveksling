import ***REMOVED*** GaxiosError, GaxiosOptions, GaxiosPromise, GaxiosResponse } from 'gaxios';
import ***REMOVED*** JwkCertificate } from '../crypto/crypto';
import ***REMOVED*** BodyResponseCallback } from '../transporters';
import ***REMOVED*** AuthClient } from './authclient';
import ***REMOVED*** Credentials } from './credentials';
import ***REMOVED*** LoginTicket } from './loginticket';
/**
 * The results from the `generateCodeVerifierAsync` method.  To learn more,
 * See the sample:
 * https://github.com/googleapis/google-auth-library-nodejs/blob/main/samples/oauth2-codeVerifier.js
 */
export interface CodeVerifierResults ***REMOVED***
    /**
...
export interface Certificates ***REMOVED***
    [index: string]: string | JwkCertificate;
}
export interface PublicKeys ***REMOVED***
    [index: string]: string;
}
export interface Headers ***REMOVED***
    [index: string]: string;
}
export declare enum CodeChallengeMethod ***REMOVED***
    Plain = "plain",
    S256 = "S256"
}
export declare enum CertificateFormat ***REMOVED***
    PEM = "PEM",
    JWK = "JWK"
}
export interface GetTokenOptions ***REMOVED***
    code: string;
    codeVerifier?: string;
    /**
...
export interface TokenInfo ***REMOVED***
    /**
...
export interface AccessTokenResponse ***REMOVED***
    access_token: string;
    expiry_date: number;
}
export interface GetRefreshHandlerCallback ***REMOVED***
    (): Promise<AccessTokenResponse>;
}
export interface GetTokenCallback ***REMOVED***
    (err: GaxiosError | null, token?: Credentials | null, res?: GaxiosResponse | null): void;
}
export interface GetTokenResponse ***REMOVED***
    tokens: Credentials;
    res: GaxiosResponse | null;
}
export interface GetAccessTokenCallback ***REMOVED***
    (err: GaxiosError | null, token?: string | null, res?: GaxiosResponse | null): void;
}
export interface GetAccessTokenResponse ***REMOVED***
    token?: string | null;
    res?: GaxiosResponse | null;
}
export interface RefreshAccessTokenCallback ***REMOVED***
    (err: GaxiosError | null, credentials?: Credentials | null, res?: GaxiosResponse | null): void;
}
export interface RefreshAccessTokenResponse ***REMOVED***
    credentials: Credentials;
    res: GaxiosResponse | null;
}
export interface RequestMetadataResponse ***REMOVED***
    headers: Headers;
    res?: GaxiosResponse<void> | null;
}
export interface RequestMetadataCallback ***REMOVED***
    (err: GaxiosError | null, headers?: Headers, res?: GaxiosResponse<void> | null): void;
}
export interface GetFederatedSignonCertsCallback ***REMOVED***
    (err: GaxiosError | null, certs?: Certificates, response?: GaxiosResponse<void> | null): void;
}
export interface FederatedSignonCertsResponse ***REMOVED***
    certs: Certificates;
    format: CertificateFormat;
    res?: GaxiosResponse<void> | null;
}
export interface GetIapPublicKeysCallback ***REMOVED***
    (err: GaxiosError | null, pubkeys?: PublicKeys, response?: GaxiosResponse<void> | null): void;
}
export interface IapPublicKeysResponse ***REMOVED***
    pubkeys: PublicKeys;
    res?: GaxiosResponse<void> | null;
}
export interface RevokeCredentialsResult ***REMOVED***
    success: boolean;
}
export interface VerifyIdTokenOptions ***REMOVED***
    idToken: string;
    audience?: string | string[];
    maxExpiry?: number;
}
export interface OAuth2ClientOptions extends RefreshOptions ***REMOVED***
    clientId?: string;
    clientSecret?: string;
    redirectUri?: string;
}
export interface RefreshOptions ***REMOVED***
