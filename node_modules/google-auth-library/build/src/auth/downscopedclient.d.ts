 ...
 */
interface DownscopedAccessTokenResponse extends GetAccessTokenResponse ***REMOVED***
    expirationTime?: number | null;
}
/**
 * Defines an upper bound of permissions available for a GCP credential.
 */
export interface CredentialAccessBoundary ***REMOVED***
...
interface AccessBoundaryRule ***REMOVED***
 ...
 */
interface AvailabilityCondition ***REMOVED***
    expression: string;
    title?: string;
    description?: string;
}
 ...
 * resources.
 */
export declare class DownscopedClient extends AuthClient ***REMOVED***
