import ***REMOVED*** ExecutableResponse } from './executable-response';
/**
 * Defines the options used for the PluggableAuthHandler class.
 */
export interface PluggableAuthHandlerOptions ***REMOVED***
    /**
 ...
 */
export declare class PluggableAuthHandler ***REMOVED***
