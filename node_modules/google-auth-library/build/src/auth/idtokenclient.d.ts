import ***REMOVED*** OAuth2Client, RequestMetadataResponse } from './oauth2client';
export interface IdTokenOptions ***REMOVED***
    /**
...
export interface IdTokenProvider ***REMOVED***
    fetchIdToken: (targetAudience: string) => Promise<string>;
}
export declare class IdTokenClient extends OAuth2Client ***REMOVED***
    targetAudience: string;
    idTokenProvider: IdTokenProvider;
    /**
