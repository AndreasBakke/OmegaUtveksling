 ...
 */
export interface ExecutableResponseJson ***REMOVED***
    /**
 ...
 */
export declare class ExecutableResponse ***REMOVED***
    /**
 ...
 */
export declare class ExecutableResponseError extends Error ***REMOVED***
    constructor(message: string);
}
/**
 * An error thrown when the 'version' field in an executable response is missing or invalid.
 */
export declare class InvalidVersionFieldError extends ExecutableResponseError ***REMOVED***
}
/**
 * An error thrown when the 'success' field in an executable response is missing or invalid.
 */
export declare class InvalidSuccessFieldError extends ExecutableResponseError ***REMOVED***
}
/**
 * An error thrown when the 'expiration_time' field in an executable response is missing or invalid.
 */
export declare class InvalidExpirationTimeFieldError extends ExecutableResponseError ***REMOVED***
}
/**
 * An error thrown when the 'token_type' field in an executable response is missing or invalid.
 */
export declare class InvalidTokenTypeFieldError extends ExecutableResponseError ***REMOVED***
}
/**
 * An error thrown when the 'code' field in an executable response is missing or invalid.
 */
export declare class InvalidCodeFieldError extends ExecutableResponseError ***REMOVED***
}
/**
 * An error thrown when the 'message' field in an executable response is missing or invalid.
 */
export declare class InvalidMessageFieldError extends ExecutableResponseError ***REMOVED***
}
/**
 * An error thrown when the subject token in an executable response is missing or invalid.
 */
export declare class InvalidSubjectTokenError extends ExecutableResponseError ***REMOVED***
}
