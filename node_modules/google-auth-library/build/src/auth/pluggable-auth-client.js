 ...
 */
class ExecutableError extends Error ***REMOVED***
    constructor(message, code) ***REMOVED***
        super(`The executable failed with exit code: $***REMOVED***code} and error message: $***REMOVED***message}.`);
        this.code = code;
 ...
 */
class PluggableAuthClient extends baseexternalclient_1.BaseExternalAccountClient ***REMOVED***
    /**
    ...
    constructor(options, additionalOptions) ***REMOVED***
        ...
        if (!options.credential_source.executable) ***REMOVED***
            throw new Error('No valid Pluggable Auth "credential_source" provided.');
      ***REMOVED***
        this.command = options.credential_source.executable.command;
        if (!this.command) ***REMOVED***
            throw new Error('No valid Pluggable Auth "credential_source" provided.');
      ***REMOVED***
        // Check if the provided timeout exists and if it is valid.
        if (options.credential_source.executable.timeout_millis === undefined) ***REMOVED***
            this.timeoutMillis = DEFAULT_EXECUTABLE_TIMEOUT_MILLIS;
      ***REMOVED***
        else ***REMOVED***
            this.timeoutMillis = options.credential_source.executable.timeout_millis;
            if (this.timeoutMillis < MINIMUM_EXECUTABLE_TIMEOUT_MILLIS ||
                this.timeoutMillis > MAXIMUM_EXECUTABLE_TIMEOUT_MILLIS) ***REMOVED***
                throw new Error(`Timeout must be between $***REMOVED***MINIMUM_EXECUTABLE_TIMEOUT_MILLIS} and ` +
                    `$***REMOVED***MAXIMUM_EXECUTABLE_TIMEOUT_MILLIS} milliseconds.`);
          ***REMOVED***
      ***REMOVED***
        this.outputFile = options.credential_source.executable.output_file;
        this.handler = new pluggable_auth_handler_1.PluggableAuthHandler(***REMOVED***
  ...
  ***REMOVED***
    ...
    async retrieveSubjectToken() ***REMOVED***
        ...
        if (process.env[GOOGLE_EXTERNAL_ACCOUNT_ALLOW_EXECUTABLES] !== '1') ***REMOVED***
      ...
      ***REMOVED***
        if (executableResponse.version > MAXIMUM_EXECUTABLE_VERSION) ***REMOVED***
            throw new Error(`Version of executable is not currently supported, maximum supported version is $***REMOVED***MAXIMUM_EXECUTABLE_VERSION}.`);
      ***REMOVED***
        // Check that response was successful.
        if (!executableResponse.success) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (this.outputFile) ***REMOVED***
            if (!executableResponse.expirationTime) ***REMOVED***
                throw new executable_response_1.InvalidExpirationTimeFieldError('The executable response must contain the `expiration_time` field for successful responses when an output_file has been specified in the configuration.');
          ***REMOVED***
      ***REMOVED***
        // Check that response is not expired.
        if (executableResponse.isExpired()) ***REMOVED***
