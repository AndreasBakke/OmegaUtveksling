import ***REMOVED*** GaxiosResponse } from 'gaxios';
import ***REMOVED*** Headers } from './oauth2client';
import ***REMOVED*** ClientAuthentication, OAuthClientAuthHandler } from './oauth2common';
/**
 ...
 */
export interface StsCredentialsOptions ***REMOVED***
    /**
 ...
 */
export interface StsSuccessfulResponse ***REMOVED***
    access_token: string;
 ...
 * https://tools.ietf.org/html/rfc8693
 */
export declare class StsCredentials extends OAuthClientAuthHandler ***REMOVED***
     ...
     *   Example: `&options=$***REMOVED***encodeUriComponent(JSON.stringified(options))}`
     * @return A promise that resolves with the token exchange response containing
     *   the requested token and its expiration time.
     */
    exchangeToken(stsCredentialsOptions: StsCredentialsOptions, additionalHeaders?: Headers, options?: ***REMOVED***
        [key: string]: any;
  ***REMOVED***): Promise<StsSuccessfulResponse>;
}
