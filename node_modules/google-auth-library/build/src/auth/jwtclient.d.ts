...
import ***REMOVED*** GoogleToken } from 'gtoken';
import * as stream from 'stream';
import ***REMOVED*** CredentialBody, Credentials, JWTInput } from './credentials';
import ***REMOVED*** IdTokenProvider } from './idtokenclient';
import ***REMOVED*** GetTokenResponse, OAuth2Client, RefreshOptions, RequestMetadataResponse } from './oauth2client';
export interface JWTOptions extends RefreshOptions ***REMOVED***
    email?: string;
    keyFile?: string;
    key?: string;
    keyId?: string;
    ...
    subject?: string;
    additionalClaims?: ***REMOVED***};
}
export declare class JWT extends OAuth2Client implements IdTokenProvider ***REMOVED***
    email?: string;
    keyFile?: string;
    key?: string;
    keyId?: string;
