 ...
 */
class BaseExternalAccountClient extends authclient_1.AuthClient ***REMOVED***
    /**
    ...
    constructor(options, additionalOptions) ***REMOVED***
        var _a, _b;
        super();
        if (options.type !== exports.EXTERNAL_ACCOUNT_TYPE) ***REMOVED***
            throw new Error(`Expected "$***REMOVED***exports.EXTERNAL_ACCOUNT_TYPE}" type but ` +
                `received "$***REMOVED***options.type}"`);
      ***REMOVED***
        this.clientAuth = options.client_id
          ...
          ***REMOVED***
            : undefined;
        if (!this.validateGoogleAPIsUrl('sts', options.token_url)) ***REMOVED***
            throw new Error(`"$***REMOVED***options.token_url}" is not a valid token url.`);
      ***REMOVED***
        ...
        if (this.workforcePoolUserProject &&
            !this.audience.match(workforceAudiencePattern)) ***REMOVED***
      ...
      ***REMOVED***
        if (typeof options.service_account_impersonation_url !== 'undefined' &&
            !this.validateGoogleAPIsUrl('iamcredentials', options.service_account_impersonation_url)) ***REMOVED***
            throw new Error(`"$***REMOVED***options.service_account_impersonation_url}" is ` +
  ...
  ***REMOVED***
    ...
    getServiceAccountEmail() ***REMOVED***
        var _a;
        if (this.serviceAccountImpersonationUrl) ***REMOVED***
  ...
  ***REMOVED***
    ...
    async getAccessToken() ***REMOVED***
        ...
        if (!this.cachedAccessToken || this.isExpired(this.cachedAccessToken)) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    async getProjectId() ***REMOVED***
        const projectNumber = this.projectNumber || this.workforcePoolUserProject;
        if (this.projectId) ***REMOVED***
            // Return previously determined project ID.
            return this.projectId;
      ***REMOVED***
        else if (projectNumber) ***REMOVED***
            // Preferable not to use request() to avoid retrial policies.
            const headers = await this.getRequestHeaders();
            const response = await this.transporter.request(***REMOVED***
                headers,
                url: `$***REMOVED***exports.CLOUD_RESOURCE_MANAGER}$***REMOVED***projectNumber}`,
                responseType: 'json',
          ***REMOVED***);
    ...
    async refreshAccessTokenAsync() ***REMOVED***
      ...
      ***REMOVED***;
        ...
        const additionalOptions = !this.clientAuth && this.workforcePoolUserProject
            ? ***REMOVED*** userProject: this.workforcePoolUserProject }
            : undefined;
      ...
      ***REMOVED***
        else if (stsResponse.expires_in) ***REMOVED***
            // Save response in cached access token.
            this.cachedAccessToken = ***REMOVED***
  ...
  ***REMOVED***
     ...
     *   returned.
     */
    getProjectNumber(audience) ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    async getImpersonatedAccessToken(token) ***REMOVED***
        const opts = ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    getScopesArray() ***REMOVED***
        // Since scopes can be provided as string or array, the type should
        // be normalized.
        if (typeof this.scopes === 'string') ***REMOVED***
            return [this.scopes];
      ***REMOVED***
        else if (typeof this.scopes === 'undefined') ***REMOVED***
  ...
  ***REMOVED***
     ...
     */
    validateGoogleAPIsUrl(apiName, url) ***REMOVED***
        let parsedUrl;
      ...
      ***REMOVED***
        ...
        if (parsedUrl.protocol !== 'https:') ***REMOVED***
            return false;
      ***REMOVED***
        ...
        for (const googleAPIsDomainPattern of googleAPIsDomainPatterns) ***REMOVED***
            if (urlDomain.match(googleAPIsDomainPattern)) ***REMOVED***
                return true;
          ***REMOVED***
      ***REMOVED***
        return false;
