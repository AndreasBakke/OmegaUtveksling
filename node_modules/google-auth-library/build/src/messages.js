...
var WarningTypes;
(function (WarningTypes) ***REMOVED***
    WarningTypes["WARNING"] = "Warning";
    WarningTypes["DEPRECATION"] = "DeprecationWarning";
})(WarningTypes = exports.WarningTypes || (exports.WarningTypes = ***REMOVED***}));
function warn(warning) ***REMOVED***
    // Only show a given warning once
    if (warning.warned) ***REMOVED***
        return;
  ***REMOVED***
    warning.warned = true;
    if (typeof process !== 'undefined' && process.emitWarning) ***REMOVED***
