...
function getJsxTokens(acorn) ***REMOVED***
  ...
  ***REMOVED***;
    const tokTypes = ***REMOVED***
      ...
      jsxText: new TokenType('jsxText', ***REMOVED***beforeExpr: true}),
      jsxTagStart: new TokenType('jsxTagStart', ***REMOVED***startsExpr: true}),
  ...
  ***REMOVED***;
    ...
    acornJsx = ***REMOVED*** tokContexts: tokContexts, tokTypes: tokTypes };
        ...
        case 125: // '}'
          this.raise(
            ...
            "Unexpected token `" + this.input[this.pos] + "`. Did you mean `" +
              (ch === 62 ? "&gt;" : "&rbrace;") + "` or " + "`***REMOVED***\"" + this.input[this.pos] + "\"}" + "`?"
          );
