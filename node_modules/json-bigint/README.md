...
var json = '***REMOVED*** "value" : 9223372036854775807, "v2": 123 }';
...
```
Input: ***REMOVED*** "value" : 9223372036854775807, "v2": 123 }

node.js built-in JSON:
JSON.parse(input).value :  9223372036854776000
JSON.stringify(JSON.parse(input)): ***REMOVED***"value":9223372036854776000,"v2":123}


big number JSON:
JSONbig.parse(input).value :  9223372036854775807
JSONbig.stringify(JSONbig.parse(input)): ***REMOVED***"value":9223372036854775807,"v2":123}
```
...
```js
var JSONbig = require('json-bigint');
var JSONstrict = require('json-bigint')(***REMOVED*** strict: true });

var dupkeys = '***REMOVED*** "dupkey": "value 1", "dupkey": "value 2"}';
...
Input: ***REMOVED*** "dupkey": "value 1", "dupkey": "value 2"}
JSON.parse(dupkeys).dupkey: value 2
Succesfully catched expected exception on duplicate keys: ***REMOVED***"name":"SyntaxError","message":"Duplicate key \"dupkey\"","at":33,"text":"***REMOVED*** \"dupkey\": \"value 1\", \"dupkey\": \"value 2\"}"}
...
```js
var JSONbig = require('json-bigint');
var JSONbigString = require('json-bigint')(***REMOVED*** storeAsString: true });
var key = '***REMOVED*** "key": 1234567890123456789 }';
...
```
Storing the BigInt as a string, instead of a BigNumber
Input: ***REMOVED*** "key": 1234567890123456789 }
...
```js
var JSONbig = require('json-bigint');
var JSONbigNative = require('json-bigint')(***REMOVED*** useNativeBigInt: true });
var key = '***REMOVED*** "key": 993143214321423154315154321 }';
...
```
Storing the Number as native BigInt, instead of a BigNumber
Input: ***REMOVED*** "key": 993143214321423154315154321 }
...
```js
var JSONbig = require('json-bigint');
var JSONbigAlways = require('json-bigint')(***REMOVED*** alwaysParseAsBig: true });
var key = '***REMOVED*** "key": 123 }'; // there is no need for BigNumber by default, but we're forcing it
...
```js
var JSONbig = require('json-bigint')(***REMOVED***
...
```js
var JSONbigAlways = require('json-bigint')(***REMOVED*** protoAction: 'ignore' });
const user = JSONbig.parse('***REMOVED*** "__proto__": ***REMOVED*** "admin": true }, "id": 12345 }');
// => result is ***REMOVED*** id: 12345 }
```
