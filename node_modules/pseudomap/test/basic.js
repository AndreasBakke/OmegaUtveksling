...
function runTests (Map) ***REMOVED***
  ...
  var akey = ***REMOVED***}
  var bkey = ***REMOVED***}
  m.set(akey, ***REMOVED*** some: 'data' })
  m.set(bkey, ***REMOVED*** some: 'other data' })
  t.same(m.get(akey), ***REMOVED*** some: 'data' })
  t.same(m.get(bkey), ***REMOVED*** some: 'other data' })
  t.equal(m.size, 4)
  ...
  var expect = [
    ***REMOVED*** value: 'number 1', key: 1 },
    ***REMOVED*** value: 'string 1', key: '1' },
    ***REMOVED*** value: ***REMOVED*** some: 'data' }, key: ***REMOVED***} },
    ***REMOVED*** value: ***REMOVED*** some: 'other data' }, key: ***REMOVED***} },
    ***REMOVED*** value: 'x again', key: /x/ },
    ***REMOVED*** value: 'y regex', key: /x/ },
    ***REMOVED*** value: 'stringie nan', key: 'NaN' }
  ]
  var actual = []

  m.forEach(function (value, key) ***REMOVED***
    actual.push(***REMOVED*** value: value, key: key })
***REMOVED***)
