...
function toProto3JSON(obj, options) ***REMOVED***
    ...
    for (const [key, value] of Object.entries(obj)) ***REMOVED***
      ...
      ***REMOVED***
        if (field.map) ***REMOVED***
          ...
          ***REMOVED***
            ...
            continue;
      ***REMOVED***
        if (fieldFullyQualifiedTypeName === '.google.protobuf.NullValue') ***REMOVED***
            result[key] = null;
            continue;
      ***REMOVED***
        if (fieldResolvedType && 'values' in fieldResolvedType && value !== null) ***REMOVED***
            if (options === null || options === void 0 ? void 0 : options.numericEnums) ***REMOVED***
      ...
      ***REMOVED***
        if (typeof value === 'string' ||
            ...
            value === null) ***REMOVED***
            if (typeof value === 'number' && !Number.isFinite(value)) ***REMOVED***
          ...
          ***REMOVED***
            ...
            continue;
      ***REMOVED***
        if (Buffer.isBuffer(value) || value instanceof Uint8Array) ***REMOVED***
            result[key] = (0, bytes_1.bytesToProto3JSON)(value);
            continue;
      ***REMOVED***
        // The remaining case is Long, everything else is an internal error
        (0, util_1.assert)(value.constructor.name === 'Long', `toProto3JSON: don't know how to convert field $***REMOVED***key} with value $***REMOVED***value}`);
        result[key] = value.toString();
        continue;
  ***REMOVED***
    return result;
