...
import type ***REMOVED*** SourceMapV3, DecodedSourceMap, EncodedSourceMap, InvalidOriginalMapping, OriginalMapping, InvalidGeneratedMapping, GeneratedMapping, SourceMapInput, Needle, SourceNeedle, SourceMap, EachMapping } from './types';
export type ***REMOVED*** SourceMapSegment } from './sourcemap-segment';
export type ***REMOVED*** SourceMapInput, SectionedSourceMapInput, DecodedSourceMap, EncodedSourceMap, SectionedSourceMap, InvalidOriginalMapping, OriginalMapping as Mapping, OriginalMapping, InvalidGeneratedMapping, GeneratedMapping, EachMapping, } from './types';
 ...
 */
export declare let decodedMap: (map: TraceMap) => Omit<DecodedSourceMap, 'mappings'> & ***REMOVED***
...
export ***REMOVED*** AnyMap } from './any-map';
export declare class TraceMap implements SourceMap ***REMOVED***
