...
const tracer = new TraceMap(***REMOVED***
  version: 3,
  sources: ['input.js'],
...
const traced = originalPositionFor(tracer, ***REMOVED*** line: 1, column: 5 });
assert.deepEqual(traced, ***REMOVED***
  source: 'input.js',
  line: 42,
  column: 4,
  name: 'foo',
...
const generated = generatedPositionFor(tracer, ***REMOVED***
  source: 'input.js',
  line: 42,
  column: 4,
});
...
```typescript
import ***REMOVED*** traceSegment } from '@jridgewell/trace-mapping';
...
```typescript
import ***REMOVED*** AnyMap } from '@jridgewell/trace-mapping';
const fooOutput = 'foo';
const barOutput = 'bar';
const output = [fooOutput, barOutput].join('\n');

const sectioned = new AnyMap(***REMOVED***
  version: 3,
  sections: [
    ***REMOVED***
      // 0-base line and column
      offset: ***REMOVED*** line: 0, column: 0 },
  ...
  ***REMOVED***,
    ***REMOVED***
      ...
      offset: ***REMOVED*** line: 1, column: 0 },
      map: ***REMOVED***
        version: 3,
        sources: ['bar.js'],
        names: ['bar'],
...
const traced = originalPositionFor(sectioned, ***REMOVED***
  line: 2,
  column: 0,
});
