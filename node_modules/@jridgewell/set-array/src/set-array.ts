 ...
 */
export class SetArray ***REMOVED***
  private declare _indexes: ***REMOVED*** [key: string]: number | undefined };
  declare array: readonly string[];

  constructor() ***REMOVED***
    this._indexes = ***REMOVED*** __proto__: null } as any;
    this.array = [];
***REMOVED***
  ...
  static ***REMOVED***
    ...
    put = (strarr, key) => ***REMOVED***
      // The key may or may not be present. If it is present, it's a number.
      const index = get(strarr, key);
      if (index !== undefined) return index;

      const ***REMOVED*** array, _indexes: indexes } = strarr;
