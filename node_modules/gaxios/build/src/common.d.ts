...
export declare class GaxiosError<T = any> extends Error ***REMOVED***
    code?: string;
...
export interface GaxiosXMLHttpRequest ***REMOVED***
    responseURL: string;
}
export interface GaxiosResponse<T = any> ***REMOVED***
    config: GaxiosOptions;
    data: T;
    status: number;
    statusText: string;
 ...
 */
export interface GaxiosOptions ***REMOVED***
    /**
...
export interface FetchRequestInit ***REMOVED***
    method?: string;
}
export interface FetchHeaders ***REMOVED***
