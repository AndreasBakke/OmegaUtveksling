...
import ***REMOVED*** createPrivateKey, createPublicKey, createSecretKey } from 'crypto';
import ***REMOVED*** decode as base64url } from './base64url.js';
import ***REMOVED*** JOSENotSupported } from '../util/errors.js';
import ***REMOVED*** setCurve } from './get_named_curve.js';
import ***REMOVED*** setModulusLength } from './check_modulus_length.js';
import Asn1SequenceEncoder from './asn1_sequence_encoder.js';
import ***REMOVED*** jwkImport } from './flags.js';
const parse = (jwk) => ***REMOVED***
    if (jwkImport && jwk.kty !== 'oct') ***REMOVED***
        return jwk.d
            ? createPrivateKey(***REMOVED*** format: 'jwk', key: jwk })
            : createPublicKey(***REMOVED*** format: 'jwk', key: jwk });
  ***REMOVED***
      ...
      ***REMOVED***
        case 'EC': ***REMOVED***
            ...
            if (isPrivate) ***REMOVED***
                ...
                enc.add(f3);
                const der = enc.end();
                const keyObject = createPrivateKey(***REMOVED*** key: der, format: 'der', type: 'pkcs8' });
          ...
          ***REMOVED***
            ...
            enc.bitStr(pub);
            const der = enc.end();
            const keyObject = createPublicKey(***REMOVED*** key: der, format: 'der', type: 'spki' });
            setCurve(keyObject, jwk.crv);
            return keyObject;
      ***REMOVED***
        case 'OKP': ***REMOVED***
            ...
            if (isPrivate) ***REMOVED***
                ...
                enc.add(f);
                const der = enc.end();
                return createPrivateKey(***REMOVED*** key: der, format: 'der', type: 'pkcs8' });
          ***REMOVED***
            const enc$1 = new Asn1SequenceEncoder();
            enc$1.oidFor(jwk.crv);
            enc.add(enc$1.end());
            ...
            const der = enc.end();
            return createPublicKey(***REMOVED*** key: der, format: 'der', type: 'spki' });
      ***REMOVED***
        default:
