...
async function importSPKI(spki, alg, options) ***REMOVED***
...
async function importX509(x509, alg, options) ***REMOVED***
...
async function importPKCS8(pkcs8, alg, options) ***REMOVED***
...
async function importJWK(jwk, alg, octAsKeyObject) ***REMOVED***
    var _a;
  ...
  ***REMOVED***
    switch (jwk.kty) ***REMOVED***
        case 'oct':
          ...
          ***REMOVED***
            ...
            if (octAsKeyObject) ***REMOVED***
                return (0, jwk_to_key_js_1.default)(***REMOVED*** ...jwk, alg, ext: (_a = jwk.ext) !== null && _a !== void 0 ? _a : false });
          ***REMOVED***
        ...
        case 'EC':
        case 'OKP':
            return (0, jwk_to_key_js_1.default)(***REMOVED*** ...jwk, alg });
        default:
