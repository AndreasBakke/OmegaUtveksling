...
const encodeLength = (len) => ***REMOVED***
    if (len < 128)
...
class DumbAsn1Encoder ***REMOVED***
  ...
  ***REMOVED***
    one() ***REMOVED***
        ...
        this.length += 3;
  ***REMOVED***
    unsignedInteger(integer) ***REMOVED***
        if (integer[0] & 0x80) ***REMOVED***
