...
function isJWKSLike(jwks) ***REMOVED***
    return (jwks &&
        typeof jwks === 'object' &&
    ...
    async getKey(protectedHeader, token) ***REMOVED***
      ...
      ***REMOVED***
        ...
        if (cached[alg] === undefined) ***REMOVED***
            const keyObject = await (0, import_js_1.importJWK)(***REMOVED*** ...jwk, ext: true }, alg);
...
function createLocalJWKSet(jwks) ***REMOVED***
