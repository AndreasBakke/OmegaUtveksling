 ...
 */
export interface GetKeyFunction<T, T2> ***REMOVED***
 ...
 */
export interface FlattenedJWSInput ***REMOVED***
  /**
 ...
 * signature validation.
 */
export interface GeneralJWSInput ***REMOVED***
  /**
   * The "payload" member MUST be present and contain the value BASE64URL(JWS Payload). When RFC7797
   * "b64": false is used the value passed may also be a Uint8Array.
   */
 ...
 */
export interface FlattenedJWS extends Partial<FlattenedJWSInput> ***REMOVED***
  payload: string
  signature: string
}
 ...
 */
export interface GeneralJWS ***REMOVED***
  payload: string
  signatures: Omit<FlattenedJWSInput, 'payload'>[]
}

export interface JoseHeaderParameters ***REMOVED***
...
export interface JWSHeaderParameters extends JoseHeaderParameters ***REMOVED***
...
export interface JWEKeyManagementHeaderParameters ***REMOVED***
  apu?: Uint8Array
  apv?: Uint8Array
  /**
...
export interface FlattenedJWE ***REMOVED***
  /**
...
export interface GeneralJWE extends Omit<FlattenedJWE, 'encrypted_key' | 'header'> ***REMOVED***
  recipients: Pick<FlattenedJWE, 'encrypted_key' | 'header'>[]
}

/** Recognized JWE Header Parameters, any other Header members may also be present. */
export interface JWEHeaderParameters extends JoseHeaderParameters ***REMOVED***
...
export interface CritOption ***REMOVED***
  /**
...
export interface DecryptOptions extends CritOption ***REMOVED***
...
/** JWE Deflate option. */
export interface DeflateOption ***REMOVED***
  /**
...
export interface EncryptOptions extends CritOption, DeflateOption ***REMOVED***}

/** JWT Claims Set verification options. */
export interface JWTClaimVerificationOptions ***REMOVED***
...
export interface VerifyOptions extends CritOption ***REMOVED***
  /**
...
/** JWS Signing options. */
export interface SignOptions extends CritOption ***REMOVED***}

/** Recognized JWT Claims Set members, any other members may also be present. */
export interface JWTPayload ***REMOVED***
  /**
   * JWT Issuer
   *
 ...
 */
export interface DeflateFunction ***REMOVED***
 ...
 */
export interface InflateFunction ***REMOVED***
  (input: Uint8Array): Promise<Uint8Array>
}

export interface FlattenedDecryptResult ***REMOVED***
  /** JWE AAD. */
...
export interface GeneralDecryptResult extends FlattenedDecryptResult ***REMOVED***}

export interface CompactDecryptResult ***REMOVED***
  /** Plaintext. */
  plaintext: Uint8Array
...
export interface FlattenedVerifyResult ***REMOVED***
  /** JWS Payload. */
  payload: Uint8Array
...
export interface GeneralVerifyResult extends FlattenedVerifyResult ***REMOVED***}

export interface CompactVerifyResult ***REMOVED***
  /** JWS Payload. */
  payload: Uint8Array
...
export interface JWTVerifyResult ***REMOVED***
  /** JWT Claims Set. */
  payload: JWTPayload
...
export interface JWTDecryptResult ***REMOVED***
  /** JWT Claims Set. */
  payload: JWTPayload
...
export interface ResolvedKey ***REMOVED***
  /** Key resolved from the key resolver function. */
  key: KeyLike | Uint8Array
}

/** Recognized Compact JWS Header Parameters, any other Header Members may also be present. */
export interface CompactJWSHeaderParameters extends JWSHeaderParameters ***REMOVED***
  alg: string
}

/** Recognized Signed JWT Header Parameters, any other Header Members may also be present. */
export interface JWTHeaderParameters extends CompactJWSHeaderParameters ***REMOVED***
  b64?: true
}

/** Recognized Compact JWE Header Parameters, any other Header Members may also be present. */
export interface CompactJWEHeaderParameters extends JWEHeaderParameters ***REMOVED***
  alg: string
  enc: string
}

/** JSON Web Key Set */
export interface JSONWebKeySet ***REMOVED***
  keys: JWK[]
}
