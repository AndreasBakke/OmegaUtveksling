import type ***REMOVED*** KeyLike } from '../types';
export interface GenerateKeyPairResult ***REMOVED***
    /** The generated Private Key. */
    privateKey: KeyLike;
    /** Public Key corresponding to the generated Private Key. */
    publicKey: KeyLike;
}
export interface GenerateKeyPairOptions ***REMOVED***
    /**
 ...
 *
 * ```js
 * const ***REMOVED*** publicKey, privateKey } = await jose.generateKeyPair('PS256')
