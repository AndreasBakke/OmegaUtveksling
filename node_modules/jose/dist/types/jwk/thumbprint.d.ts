import type ***REMOVED*** JWK } from '../types';
/**
 ...
 *
 * ```js
 * const thumbprint = await jose.calculateJwkThumbprint(***REMOVED***
 *   kty: 'EC',
 *   crv: 'P-256',
 ...
 *
 * ```js
 * const thumbprintUri = await jose.calculateJwkThumbprintUri(***REMOVED***
 *   kty: 'EC',
 *   crv: 'P-256',
 *   x: 'jJ6Flys3zK9jUhnOHf6G49Dyp5hah6CNP84-gY-n9eo',
 *   y: 'nhI6iD5eFXgBTLt_1p3aip-5VbZeMhxeFSpjfEAf7Ww',
