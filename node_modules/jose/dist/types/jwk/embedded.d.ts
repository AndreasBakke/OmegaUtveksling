import type ***REMOVED*** FlattenedJWSInput, JWSHeaderParameters } from '../types';
/**
 ...
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.jwtVerify(jwt, jose.EmbeddedJWK, ***REMOVED***
