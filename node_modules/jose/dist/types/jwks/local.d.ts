import type ***REMOVED*** KeyLike, JWSHeaderParameters, JSONWebKeySet, FlattenedJWSInput, GetKeyFunction } from '../types';
/** @private */
export declare function isJWKSLike(jwks: unknown): jwks is JSONWebKeySet;
/** @private */
export declare class LocalJWKSet ***REMOVED***
 ...
 *
 * ```js
 * const JWKS = jose.createLocalJWKSet(***REMOVED***
 *   keys: [
 *     ***REMOVED***
 *       kty: 'RSA',
 *       e: 'AQAB',
