import type ***REMOVED*** KeyLike, VerifyOptions, JWTClaimVerificationOptions, JWTHeaderParameters, GetKeyFunction, FlattenedJWSInput, JWTVerifyResult, ResolvedKey } from '../types';
/** Combination of JWS Verification options and JWT Claims Set verification options. */
export interface JWTVerifyOptions extends VerifyOptions, JWTClaimVerificationOptions ***REMOVED***
}
/**
 ...
 */
export interface JWTVerifyGetKey extends GetKeyFunction<JWTHeaderParameters, FlattenedJWSInput> ***REMOVED***
}
/**
 ...
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.jwtVerify(jwt, secret, ***REMOVED***
 ...
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.jwtVerify(jwt, publicKey, ***REMOVED***
 *   issuer: 'urn:example:issuer',
 *   audience: 'urn:example:audience',
 * })
 *
 ...
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.jwtVerify(jwt, JWKS, ***REMOVED***
 *   issuer: 'urn:example:issuer',
 *   audience: 'urn:example:audience',
 * })
 * console.log(protectedHeader)
