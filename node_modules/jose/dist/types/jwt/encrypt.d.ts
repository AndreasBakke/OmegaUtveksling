import type ***REMOVED*** EncryptOptions, CompactJWEHeaderParameters, JWEKeyManagementHeaderParameters, KeyLike } from '../types';
import ***REMOVED*** ProduceJWT } from './produce';
/**
 ...
 * const jwt = await new jose.EncryptJWT(***REMOVED*** 'urn:example:claim': true })
 *   .setProtectedHeader(***REMOVED*** alg: 'dir', enc: 'A128CBC-HS256' })
 *   .setIssuedAt()
 ...
 * ```
 */
export declare class EncryptJWT extends ProduceJWT ***REMOVED***
    private _cek;
    private _iv;
