import type ***REMOVED*** JWTHeaderParameters, KeyLike, SignOptions } from '../types';
 ...
 * const alg = 'HS256'
 *
 * const jwt = await new jose.SignJWT(***REMOVED*** 'urn:example:claim': true })
 *   .setProtectedHeader(***REMOVED*** alg })
 *   .setIssuedAt()
 ...
 * ```
 */
export declare class SignJWT extends ProduceJWT ***REMOVED***
