import type ***REMOVED*** FlattenedVerifyResult, KeyLike, FlattenedJWSInput, JWSHeaderParameters, VerifyOptions, GetKeyFunction, ResolvedKey } from '../../types';
/**
 ...
 */
export interface FlattenedVerifyGetKey extends GetKeyFunction<JWSHeaderParameters | undefined, FlattenedJWSInput> ***REMOVED***
}
/**
 ...
 * }
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.flattenedVerify(jws, publicKey)
 *
