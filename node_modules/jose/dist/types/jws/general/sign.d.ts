import type ***REMOVED*** KeyLike, GeneralJWS, JWSHeaderParameters, SignOptions } from '../../types';
export interface Signature ***REMOVED***
    /**
 ...
 *   .setProtectedHeader(***REMOVED*** alg: 'ES256' })
 *   .addSignature(rsaPrivateKey)
 *   .setProtectedHeader(***REMOVED*** alg: 'PS256' })
 *   .sign()
 *
 * console.log(jws)
 * ```
 */
export declare class GeneralSign ***REMOVED***
    private _payload;
    private _signatures;
