import type ***REMOVED*** GeneralJWSInput, GeneralVerifyResult, FlattenedJWSInput, GetKeyFunction, JWSHeaderParameters, KeyLike, VerifyOptions, ResolvedKey } from '../../types';
/**
 ...
 */
export interface GeneralVerifyGetKey extends GetKeyFunction<JWSHeaderParameters, FlattenedJWSInput> ***REMOVED***
}
/**
 ...
 * }
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.generalVerify(jws, publicKey)
 *
