import type ***REMOVED*** CompactVerifyResult, FlattenedJWSInput, GetKeyFunction, CompactJWSHeaderParameters, KeyLike, VerifyOptions, ResolvedKey } from '../../types';
/**
 ...
 */
export interface CompactVerifyGetKey extends GetKeyFunction<CompactJWSHeaderParameters, FlattenedJWSInput> ***REMOVED***
}
/**
 ...
 *
 * const ***REMOVED*** payload, protectedHeader } = await jose.compactVerify(jws, publicKey)
 *
