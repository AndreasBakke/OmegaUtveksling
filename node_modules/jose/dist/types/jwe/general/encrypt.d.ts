import type ***REMOVED*** KeyLike, GeneralJWE, JWEHeaderParameters, CritOption, DeflateOption } from '../../types';
export interface Recipient ***REMOVED***
    /**
 ...
 * )
 *   .setProtectedHeader(***REMOVED*** enc: 'A256GCM' })
 *   .addRecipient(ecPublicKey)
 *   .setUnprotectedHeader(***REMOVED*** alg: 'ECDH-ES+A256KW' })
 *   .addRecipient(rsaPublicKey)
 *   .setUnprotectedHeader(***REMOVED*** alg: 'RSA-OAEP-384' })
 *   .encrypt()
 *
 * console.log(jwe)
 * ```
 */
export declare class GeneralEncrypt ***REMOVED***
    private _plaintext;
    private _recipients;
