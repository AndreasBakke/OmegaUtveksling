import type ***REMOVED*** KeyLike, JWEKeyManagementHeaderParameters, CompactJWEHeaderParameters, EncryptOptions } from '../../types';
/**
 ...
 * ```
 */
export declare class CompactEncrypt ***REMOVED***
    private _flattened;
