import ***REMOVED*** FlattenedEncrypt, unprotected } from '../flattened/encrypt.js';
...
export class GeneralEncrypt ***REMOVED***
    ...
    async encrypt(options) ***REMOVED***
      ...
      ***REMOVED***
        ...
        for (let i = 0; i < this._recipients.length; i++) ***REMOVED***
            ...
            if (!isDisjoint(this._protectedHeader, this._unprotectedHeader, recipient.unprotectedHeader)) ***REMOVED***
          ...
          ***REMOVED***;
            ...
            if (i === 0) ***REMOVED***
              ...
              ***REMOVED***);
                ...
                continue;
          ***REMOVED***
            const ***REMOVED*** encryptedKey, parameters } = await encryptKeyManagement(((_a = recipient.unprotectedHeader) === null || _a === void 0 ? void 0 : _a.alg) ||
