...
export async function generateSecret(alg, options) ***REMOVED***
    ...
    switch (alg) ***REMOVED***
        ...
        case 'HS512':
            ...
            algorithm = ***REMOVED*** name: 'HMAC', hash: `SHA-$***REMOVED***length}`, length };
        ...
        case 'A256KW':
            ...
            algorithm = ***REMOVED*** name: 'AES-KW', length };
        ...
        case 'A256GCM':
            length = parseInt(alg.slice(1, 4), 10);
            algorithm = ***REMOVED*** name: 'AES-GCM', length };
...
function getModulusLengthOption(options) ***REMOVED***
    var _a;
    ...
    switch (alg) ***REMOVED***
        ...
        case 'ECDH-ES+A256KW': ***REMOVED***
            ...
            switch (crv) ***REMOVED***
                ...
                case 'P-384':
                case 'P-521': ***REMOVED***
                    algorithm = ***REMOVED*** name: 'ECDH', namedCurve: crv };
                    break;
              ***REMOVED***
                case 'X25519':
                case 'X448':
